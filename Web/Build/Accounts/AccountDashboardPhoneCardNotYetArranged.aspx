<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountDashboardPhoneCardNotYetArranged.aspx.cs" Inherits="Accounts_AccountDashboardPhoneCardNotYetArranged" %>
...
<%--            <table width="100%">
            ...
            <eluc:TabStrip ID="MenuBondReq" runat="server" OnTabStripCommand="MenuBondReq_TabStripCommand" Visible="false"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvPhonReq" Height="100%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" 
                OnItemCommand="gvPhonReq_ItemCommand" OnItemDataBound="gvPhonReq_ItemDataBound" EnableViewState="false"
