<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsAdvanceRemittance.aspx.cs"
    Inherits="AccountsAdvanceRemittance" %>
...
<body>
    ...
    <asp:UpdatePanel runat="server" ID="pnlRemittance">
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div id="divGrid" style="position: relative; z-index: 0; width: 100%;">
                    <asp:GridView ID="gvRemittence" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowCommand="gvRemittence_RowCommand" OnRowDataBound="gvRemittence_ItemDataBound"
                        OnRowCancelingEdit="gvRemittence_RowCancelingEdit" OnRowDeleting="gvRemittence_RowDeleting"
                        AllowSorting="true" OnRowEditing="gvRemittence_RowEditing" EnableViewState="false"
                        OnSorting="gvRemittence_Sorting" DataKeyNames="FLDREMITTANCEID">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Voucher Number">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="lnkRemittenceid" runat="server" CommandName="EDIT" CommandArgument='<%# Container.DataItemIndex%>'
