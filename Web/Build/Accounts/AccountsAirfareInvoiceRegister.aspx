<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsAirfareInvoiceRegister.aspx.cs" Inherits="AccountsAirfareInvoiceRegister" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <table cellpadding="2" cellspacing="1" style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <eluc:UserControlDate ID="ucDepartureDate" runat="server" CssClass="readonlytextbox" ReadOnly="true" Width="120px" />
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblArrivalDate" runat="server" Text="Arrival Date"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:UserControlDate ID="ucArrivalDate" runat="server" CssClass="readonlytextbox" ReadOnly="true" Width="120px" />
                    </td>
                </tr>
                <tr>
                    <td>
