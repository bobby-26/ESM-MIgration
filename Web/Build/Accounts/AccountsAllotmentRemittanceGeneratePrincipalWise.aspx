<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsAllotmentRemittanceGeneratePrincipalWise.aspx.cs" Inherits="AccountsAllotmentRemittanceGeneratePrincipalWise" %>
    ...
    <form id="frmPurchaseForm" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlorderform" Height="100%">
            ...
            <table>
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblTotalSelectedAmount" Text="Selected Principals Total Amount(USD)" runat="server"></telerik:RadLabel>
                    </td>
                    <td>
                        <asp:TextBox ID="txtTotalSelectedAmount" runat="server" CssClass="readonlytextbox" Width="150px" Enabled="false"></asp:TextBox>
                    </td>
                </tr>
            </table>
            ...
            <telerik:RadGrid ID="gvVoucherDetails" runat="server" AutoGenerateColumns="False" Font-Size="11px" OnItemDataBound="gvVoucherDetails_ItemDataBound"
                Width="100%" Height="75%" CellPadding="3" AllowSorting="true" OnSortCommand="gvVoucherDetails_Sorting" OnNeedDataSource="gvVoucherDetails_NeedDataSource"
                OnItemCommand="gvVoucherDetails_InsertCommand" AllowCustomPaging="true" AllowPaging="true" EnableHeaderContextMenu="true" GroupingEnabled="false">
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDPRINCIPALID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Principal" AllowSorting="true" ShowSortIcon="true" SortExpression="FLDPRINCIPALNAME" DataField="FLDPRINCIPALNAME" UniqueName="FLDPRINCIPALNAME">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblprincipalid" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPRINCIPALID") %>'></telerik:RadLabel>
