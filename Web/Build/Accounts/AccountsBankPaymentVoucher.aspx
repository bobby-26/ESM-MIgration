<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsBankPaymentVoucher.aspx.cs"
    Inherits="AccountsBankPaymentVoucher" EnableEventValidation="true" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="1" cellspacing="1" style="width: 100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtVoucherNumber" runat="server" MaxLength="50" ReadOnly="true"
                            Width="270px" CssClass="readonlytextbox">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtVoucherType" Text="Bank Payment Voucher" CssClass="readonlytextbox"
                            ReadOnly="true" Width="270px">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblBankAC" runat="server" Text="Bank A/C"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:UserControlBankAccount ID="ddlBankAccount" Width="270px"
                ...
                <tr>
                    ...
                    <td>
                        <eluc:UserControlDate ID="ucDueDate" runat="server" />
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblStatus" runat="server" Text="Status"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtStatus" CssClass="readonlytextbox" Width="270px"></telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    <td>
