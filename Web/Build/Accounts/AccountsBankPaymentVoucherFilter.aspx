<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsBankPaymentVoucherFilter.aspx.cs"
    Inherits="AccountsBankPaymentVoucherFilter" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlAddressEntry">
                    <table id="tblExchangeRate" width="95%">
                        <tr>
                            <td width="10%">
                        ...
                        <tr>
                            ...
                            <td>
                                <eluc:UserControlBankAccount ID="ddlBankAccount"
                                    AppendDataBoundItems="true" runat="server" CssClass="input" AutoPostBack="true"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
