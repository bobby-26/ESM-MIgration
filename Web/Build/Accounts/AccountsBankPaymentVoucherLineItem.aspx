<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsBankPaymentVoucherLineItem.aspx.cs"
    Inherits="AccountsBankPaymentVoucherLineItem" MaintainScrollPositionOnPostback="true" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="2" cellspacing="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        <span id="spnPickListExpenseAccount">
                            <telerik:RadTextBox ID="txtAccountCode" runat="server" CssClass="input_mandatory" ReadOnly="false" InputType="Text"
                                MaxLength="20" Width="30%" OnTextChanged="txtAccountCode_changed">
                            </telerik:RadTextBox>
                            &nbsp;
                            <telerik:RadTextBox ID="txtAccountDescription" runat="server" CssClass="input_mandatory" InputType="Text"
                            ...
                            <telerik:RadTextBox ID="txtBudgetName" InputType="Text" runat="server" Width="55%" CssClass="input"></telerik:RadTextBox>
                            ...
                            <%--<img runat="server" id="imgShowBudget" style="cursor: pointer; vertical-align: top"
                                        src="<%$ PhoenixTheme:images/picklist.png %>" onclick="" />--%>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Decimal ID="txtPrimeAmoutEdit" runat="server" DecimalPlace="2" Width="160px" IsPositive="true" CssClass="input_mandatory txtNumber" />

                        <%-- <eluc:Number ID="txtPrimeAmoutEdit" runat="server" CssClass="input_mandatory txtNumber"
                            Width="160px"></eluc:Number>--%>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <%--                           <eluc:mask runat="server" ID="MaskedEditExtender1" style="text-align: right;" Width="80px" MaskText="#,###,###.##" CssClass="input_mandatory"></eluc:mask>--%>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txt2ndExchangeRate" runat="server" CssClass="input_mandatory txtNumber"
                            Width="160px" AutoPostBack="true" OnTextChanged="txt2ndExchangeRate_TextChanged">
                        </telerik:RadTextBox>
                        <%--    <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender2" runat="server" AutoComplete="true"
                                        InputDirection="RightToLeft" Mask="99999.99999999999999999" MaskType="Number" OnInvalidCssClass="MaskedEditError"
                                        TargetControlID="txt2ndExchangeRate" />--%>
                        <%--                          <eluc:mask runat="server" ID="MaskedEditExtender2" style="text-align: right;" Width="80px" MaskText="#,###,###.##" CssClass="input_mandatory"></eluc:mask>--%>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtRemarks" runat="server" Width="270px" TextMode="MultiLine" Resize="Both"
                            Height="50px" CssClass="input">
                        </telerik:RadTextBox>
                    </td>
                </tr>
