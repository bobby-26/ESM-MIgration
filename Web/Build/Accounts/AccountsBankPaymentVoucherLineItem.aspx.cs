...
public partial class AccountsBankPaymentVoucherLineItem : PhoenixBasePage
{
    ...
    protected void Reset()
    {
        ...
        imgShowBudget.Attributes.Add("onclick", "return showSubAccountPickList('spnPickListExpenseAccount', 'codehelp1', '','../Common/CommonPickListSubAccount.aspx&frameName=ifMoreInfo', true);");
    ...
    protected void VoucherLineEdit(Guid gLineId)
    {
        ...
        if (ds.Tables.Count > 0)
        {
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (dr["FLDVOUCHERLINEITEMNO"].ToString() == "10")
                {
            ...
            if ((lblvesselid.Text != null) && lblvesselid.Text != string.Empty)
                ...
                imgShowAccount1.Enabled = false;
            if (!SessionUtil.CanAccess(this.ViewState, imgShowAccount1.CommandName))
            {
                imgShowAccount1.Visible = false;
            }
            ...
            //else
            //{
            //    imgShowBudget.Attributes.Add("onclick", "return showSubAccountPickList('spnPickListExpenseAccount', 'codehelp1', '','../Common/CommonPickListSubAccount.aspx', true);");
            //}          
        }
    }
