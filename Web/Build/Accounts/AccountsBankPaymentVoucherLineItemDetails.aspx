<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsBankPaymentVoucherLineItemDetails.aspx.cs"
    Inherits="AccountsBankPaymentVoucherLineItemDetails" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function PaneResized(sender, args) {
                ...
                grid._gridDataDiv.style.height = (contentPane._contentElement.offsetHeight - 65) + "px";
            }
            function pageLoad() {
                PaneResized();
            }
            ...
            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
                ...
                <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvLineItem" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnItemCommand="gvLineItem_ItemCommand" OnItemDataBound="gvLineItem_RowDataBound"
                        ...
                        OnRowCreated="gvLineItem_RowCreated" ShowHeader="true" ShowFooter="true" GroupingEnabled="false" EnableHeaderContextMenu="true"
                        EnableViewState="false" AllowSorting="true" OnPageIndexChanged="gvLineItem_PageIndexChanged">
                        ...
                        <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn HeaderText="Row Number" AllowSorting="true" SortExpression="FLDVOUCHERLINEITEMNO">
                                    <ItemTemplate>
