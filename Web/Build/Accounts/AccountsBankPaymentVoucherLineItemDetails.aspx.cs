...
public partial class AccountsBankPaymentVoucherLineItemDetails : PhoenixBasePage
{
    string _reportfile = "";
    string _filename = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsBankPaymentVoucherLineItemDetails.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvLineItem')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Accounts/AccountsBankPaymentVoucherLineItemDetails.aspx", "Report", "task-list.png", "REPORT");
            toolbargrid.AddImageButton("../Accounts/AccountsBankPaymentVoucherLineItemDetails.aspx", "Voucher Print", "pdf.png", "REPORTPR");
            toolbargrid.AddImageButton("../Accounts/AccountsBankPaymentVoucherLineItemDetails.aspx", "Voucher Upload", "download_1.png", "UPLOAD");
            ...
            if (!IsPostBack)
            {
                MenuLineItem.Title = "Bank Payment Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
                ...
                // ViewState["PAGEURL"] = "../Accounts/AccountsBankPaymentVoucherLineItem.aspx?voucherid=";
                ...
                //Title1.Text = "Bank Payment Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
                if (Request.QueryString["qvouchercode"] != null)
                {
                    ifMoreInfo.Attributes["src"] = "AccountsBankPaymentVoucherLineItem.aspx?qvouchercode=" + ViewState["voucherid"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
                }
                else
                {
                    ifMoreInfo.Attributes["src"] = "AccountsBankPaymentVoucherLineItem.aspx";
                }
            }
    ...
    private void BindPageURL(int rowindex)
    {
        try
        {
            ...
            ifMoreInfo.Attributes["src"] = "../Accounts/AccountsBankPaymentVoucherLineItem.aspx?qvouchercode=" + ViewState["voucherid"].ToString() + "&voucherlineitemcode=" + ViewState["voucherlineitemcode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
        }
    ...
    protected void MenuLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Accounts/AccountsBankPaymentVoucherMaster.aspx?voucherid=" + ViewState["voucherid"].ToString() + "&type=" + ViewState["type"]);
            }
    ...
    private void BindData()
    {
        ...
        if (ViewState["voucherid"] != null)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    ViewState["PAGEURL"] = "../Accounts/AccountsBankPaymentVoucherLineItem.aspx?qvouchercode=";
                }
                {
                    if (ViewState["voucherlineitemcode"] != null)
                    {
                        ...
                        ifMoreInfo.Attributes["src"] = "../Accounts/AccountsBankPaymentVoucherLineItem.aspx?qvouchercode=" + ViewState["voucherid"].ToString() + "&voucherlineitemcode=" + ViewState["voucherlineitemcode"].ToString() + "&rowno=" + strRowno + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
                    }
                    else
                        ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + ViewState["voucherid"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
                }
            ...
            if (ViewState["ISPERIODLOCKED"] != null)
            {
                if (int.Parse(ViewState["ISPERIODLOCKED"].ToString()) == 1)
                {
                    ...
                    {
                        GridTableRow gvRow = gvLineItem.MasterTableView.Items[0];
