<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsBankPaymentVoucherMaster.aspx.cs"
    Inherits="AccountsBankPaymentVoucherMaster" %>
        ...
        <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
            ...
            <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvFormDetails" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                    ...
                    AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvFormDetails_NeedDataSource" OnPageIndexChanged="gvFormDetails_PageIndexChanged"
                    OnPreRender="gvFormDetails_PreRender"
                    AllowSorting="true" EnableViewState="false" GroupingEnabled="false" EnableHeaderContextMenu="true"
                    ...
                    <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Voucher Number" AllowSorting="true" SortExpression="FLDVOUCHERID">
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblVoucherNumber" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDVOUCHERID") %>'></telerik:RadLabel>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Reference No">
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container,"DataItem.FLDREFERENCEDOCUMENTNO") %>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Bank A/C">
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
