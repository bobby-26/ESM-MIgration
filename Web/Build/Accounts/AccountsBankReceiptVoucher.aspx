<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsBankReceiptVoucher.aspx.cs"
    Inherits="AccountsBankReceiptVoucher" EnableEventValidation="true" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="1" cellspacing="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtVoucherType" Text="Bank Receipt Voucher" CssClass="readonlytextbox"
