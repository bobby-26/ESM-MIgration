...
public partial class AccountsBankReceiptVoucher : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        MenuVoucher.AccessRights = this.ViewState;
        MenuVoucher.Title = "Bank Receipt Voucher      (" + txtVoucherNumber.Text + ")     ";
    ...
    protected void Voucher_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsBankReceiptVoucherList.aspx");
        }
        if (CommandName.ToUpper().Equals("DETAILS"))
        {
            Response.Redirect("../Accounts/AccountsBankReceiptVoucherLineItem.aspx?qvouchercode=" + ViewState["VOUCHERID"].ToString());
        }
        ...
        if (CommandName.ToUpper().Equals("ADD"))
        {
            ...
            try
            {
                ...
                if (Request.QueryString["type"] == "1" && Request.QueryString["Lineitemid"] != null)
                {
                    ...
                    Response.Redirect("../Accounts/AccountsBankReceiptVoucherMaster.aspx", false);
                }
                else
                {
    ...
    protected void Reset()
    {
        ...
        if (ViewState["VOUCHERID"] != null)
        {
           ...
           // ttlVoucher.Text = "Bank Receipt Voucher      ()     ";
        }
        else
        {
            txtVoucherNumber.Text = "";
