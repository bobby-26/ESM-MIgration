<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsBankReceiptVoucherFilter.aspx.cs"
    Inherits="AccountsBankReceiptVoucherFilter" %>
...
<%--                <telerik:RadLabel runat="server" ID="lblCaption" Font-Bold="true" Text="Voucher"></telerik:RadLabel>--%>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlAddressEntry">
                    <table id="tblExchangeRate">
                        ...
                        <tr>
                            ...
                            <td>
                                <eluc:UserControlBankAccount ID="ddlBankAccount" AutoPostBack="true"
