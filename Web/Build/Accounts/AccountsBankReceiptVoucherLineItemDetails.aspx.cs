...
public partial class AccountsBankReceiptVoucherLineItemDetails : PhoenixBasePage
{
    string _reportfile = "";
    string _filename = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsBankReceiptVoucherLineItemDetails.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvLineItem')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Accounts/AccountsBankReceiptVoucherLineItemDetails.aspx", "Report", "task-list.png", "REPORT");
            toolbargrid.AddImageButton("../Accounts/AccountsBankReceiptVoucherLineItemDetails.aspx", "Voucher Print", "pdf.png", "REPORTPR");
            toolbargrid.AddImageButton("../Accounts/AccountsBankReceiptVoucherLineItemDetails.aspx", "Voucher Upload", "download_1.png", "UPLOAD");
            ...
            MenuLineItem.Title = "Bank Receipt Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
            ...
            if (!IsPostBack)
            {
                ...
                //Title1.Text = "Bank Receipt Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
                if (Request.QueryString["qvouchercode"] != null)
                {
                    ifMoreInfo.Attributes["src"] = "AccountsBankReceiptVoucherLineItem.aspx?qvouchercode=" + Request.QueryString["qvouchercode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
                }
                else
                {
                    ifMoreInfo.Attributes["src"] = "AccountsBankReceiptVoucherLineItem.aspx";
                }
            }
    ...
    protected void MenuLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ViewState["PAGEURL"] = "../Accounts/AccountsBankReceiptVoucherLineItem.aspx?voucherid=";
            }
            else if (CommandName.ToUpper().Equals("VOUCHER"))
            {
                Response.Redirect("../Accounts/AccountsBankReceiptVoucherMaster.aspx?voucherid=" + ViewState["voucherid"].ToString() + "&type=" + ViewState["type"]);
            }
    ...
    private void BindData()
    {
        ...
        if (ViewState["voucherid"] != null)
        {
            ...
            {
                ViewState["PAGEURL"] = "../Accounts/AccountsBankReceiptVoucherLineItem.aspx?qvouchercode=";
            }
            {
                if (ViewState["voucherlineitemcode"] != null)
                {
    ...
    protected void gvLineItem_RowCommand(object sender, GridCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToUpper().Equals("EDIT"))
        {
            ...
            try
            {
                ...
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsBankReceiptVoucherLineItem.aspx?qvouchercode=" + ViewState["voucherid"].ToString() + "&voucherlineitemcode=" + ViewState["voucherlineitemcode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
            }
            catch (Exception ex)
            {
                ucError.ErrorMessage = ex.Message;
