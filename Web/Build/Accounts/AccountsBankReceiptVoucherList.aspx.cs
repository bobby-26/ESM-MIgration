...
public partial class AccountsBankReceiptVoucherList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbargrid.AddImageButton("../Accounts/AccountsBankReceiptVoucherList.aspx", "Export to Excel", "icon_xls.png", "Excel");
        toolbargrid.AddImageLink("javascript:CallPrint('gvVoucher')", "Print Grid", "icon_print.png", "PRINT");
        toolbargrid.AddImageLink("../Accounts/AccountsBankReceiptVoucherList.aspx", "Find", "search.png", "FIND");
    ...
    protected void VoucherNavItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsBankReceiptVoucher.aspx");
        }
    }
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixAccountsVoucher.VoucherSearch(   PhoenixSecurityContext.CurrentSecurityContext.CompanyID,69
    ...
    protected void VoucherClick(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("../Accounts/AccountsBankReceiptVoucher.aspx?VOUCHERID=" + ViewState["VOUCHERCODE"].ToString());
    }
