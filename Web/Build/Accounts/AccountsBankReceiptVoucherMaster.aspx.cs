...
public partial class AccountsBankReceiptVoucherMaster : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsBankReceiptVoucherMaster.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvVoucher')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageLink("javascript:openNewWindow('codehelp1','', '" + Session["sitepath"] + "/Accounts/AccountsBankReceiptVoucherFilter.aspx'); return false;", "Find", "search.png", "FIND");
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["voucherid"] != null)
                {
                    ...
                    ifMoreInfo.Attributes["src"] = "../Accounts/AccountsBankReceiptVoucher.aspx?voucherid=" + ViewState["voucherid"] + "&type=" + ViewState["type"];
                }
            }
        }
        catch (Exception ex)
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsBankReceiptVoucher.aspx?voucherid=" + ViewState["voucherid"];
            }
            if (CommandName.ToUpper().Equals("LINEITEM") && ViewState["voucherid"] != null && ViewState["voucherid"].ToString() != string.Empty)
            {
                Response.Redirect("../Accounts/AccountsBankReceiptVoucherLineItemDetails.aspx?qvouchercode=" + ViewState["voucherid"] + "&type=" + ViewState["type"]);
            }
            else
                MenuOrderFormMain.SelectedMenuIndex = 1;
        }
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixAccountsVoucher.BankVoucherSearch(PhoenixSecurityContext.CurrentSecurityContext.CompanyID, 69
    ...
    private void BindData()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsBankReceiptVoucher.aspx?voucherid=" + ViewState["voucherid"].ToString() + "&type=" + ViewState["type"].ToString();
            }
            SetRowSelection();
        }
        else
        {
            if (ViewState["PAGEURL"] == null)
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsBankReceiptVoucher.aspx?voucherid=";
            }
    ...
    protected void gvFormDetails_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridEditableItem)
        {
            ...
            {
                cmdAttachment.Attributes.Add("onclick", "javascript:Openpopup('codehelp1','','../Accounts/AccountsFileAttachment.aspx?dtkey=" + lblDtkey + "&mod=" + PhoenixModule.ACCOUNTS + "&voucherid=" + ViewState["voucherid"] + "&mimetype=.pdf" + "&source=voucher" + "');return true;");
            ...
            {
                cmdNoAttachment.Attributes.Add("onclick", "javascript:Openpopup('codehelp1','','../Accounts/AccountsFileAttachment.aspx?dtkey=" + lblDtkey + "&mod=" + PhoenixModule.ACCOUNTS + "&voucherid=" + ViewState["voucherid"] + "&mimetype=.pdf" + "&source=voucher" + "');return true;");
    ...
    private void BindPageURL(int rowindex)
    {
        try
        {
            ...
            PhoenixAccountsVoucher.VoucherNumber = item.GetDataKeyValue("FLDVOUCHERNUMBER").ToString();
            ifMoreInfo.Attributes["src"] = "../Accounts/AccountsBankReceiptVoucher.aspx?voucherid=" + ViewState["voucherid"].ToString();
        }
        catch (Exception ex)
        {
            ucError.ErrorMessage = ex.Message;
