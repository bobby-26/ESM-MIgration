...
public partial class Accounts_AccountsBankReconUploadLineItem : PhoenixBasePage
{
    ...
    private void BindData()
    {
        ...
        ds = PhoenixAccountsBankStatementReconUpload.BankStatementReconLineItemList(new Guid(ViewState["UPLOADID"].ToString()), (int)ViewState["PAGENUMBER"], General.ShowRecords(null), ref iRowCount, ref iTotalPageCount, ref iTotalAmount);
