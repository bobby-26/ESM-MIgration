<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsBankStatementReconExcelUploadFilter.aspx.cs" Inherits="Accounts_AccountsBankStatementReconExcelUploadFilter" %>
    ...
    <telerik:RadAjaxPanel runat="server" ID="pnlAddressEntry">
                <table id="tblbankstatement">
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:Currency runat="server" ID="ucCurrency"  ActiveCurrency="true" Width="150px"
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:Hard runat="server" ID="ucMonth" AppendDataBoundItems="true"  Width="150"
                                HardTypeCode="55" />
                        </td>
                       <%-- <td>
