<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsCaptainCashSplit.aspx.cs"
    Inherits="AccountsCaptainCashSplit" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="94%">
            ...
            <table cellpadding="1" cellspacing="1" width="50%">
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Number ID="txtAmount1" runat="server" CssClass="input" DecimalPlace="2" IsPositive="true" Width="80px" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <eluc:Number ID="txtAmount2" runat="server" CssClass="input" DecimalPlace="2" IsPositive="true" Width="80px" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <telerik:RadLabel ID="Split3" runat="server" Text="Split 3"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Number ID="txtAmount3" runat="server" CssClass="input" DecimalPlace="2" IsPositive="true" Width="80px" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <eluc:Number ID="txtAmount4" runat="server" CssClass="input" DecimalPlace="2" IsPositive="true" Width="80px" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <eluc:Number ID="txtAmount5" runat="server" CssClass="input" DecimalPlace="2" IsPositive="true" Width="80px" />
                    </td>
                </tr>
            </table>
