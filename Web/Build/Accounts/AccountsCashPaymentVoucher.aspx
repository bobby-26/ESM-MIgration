<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsCashPaymentVoucher.aspx.cs"
    Inherits="AccountsCashPaymentVoucher" EnableEventValidation="true" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="1" cellspacing="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtVoucherType" Text="Cash Payment Voucher" CssClass="readonlytextbox"
