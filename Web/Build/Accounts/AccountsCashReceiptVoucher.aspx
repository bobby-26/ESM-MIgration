<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsCashReceiptVoucher.aspx.cs"
    Inherits="AccountsCashReceiptVoucher" EnableEventValidation="true" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="1" cellspacing="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtVoucherType" Text="Cash Receipt Voucher" CssClass="readonlytextbox"
                            ReadOnly="true" Width="240px">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                        <telerik:RadLabel runat="server" ID="txtCurrency" Text="Cash Account Currency"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadComboBox ID="ddlCurrency" runat="server" AutoPostBack="true" CssClass="input_mandatory"
                            DataTextField="FLDCURRENCYCODE" DataValueField="FLDCURRENCYID" OnDataBound="ddlCurrency_DataBound" OnTextChanged="ddlCurrency_TextChanged">
                        </telerik:RadComboBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 50%">
                        <span id="spnPickListCashAccount">
                            <telerik:RadTextBox ID="txtAccountCode" runat="server" CssClass="readonlytextbox" MaxLength="20"
                                Width="20%">
                            </telerik:RadTextBox>
                            <telerik:RadTextBox ID="txtAccountDescription" runat="server" CssClass="readonlytextbox"
                                MaxLength="50" Width="36%">
                            </telerik:RadTextBox>
                            <img runat="server" id="imgShowAccount" style="cursor: pointer; vertical-align: top"
                                src="<%$ PhoenixTheme:images/picklist.png %>" onclick="return showPickList('spnPickListCashAccount', 'codehelp1', '', '../Common/CommonPickListCashAccount.aspx',true); " visible="false" />
                ...
                <tr>
                   ...
                   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <telerik:RadCheckBox ID="chkLocked" runat="server" />
                    </td>
                </tr>
            </table>
            <br />
