...
public partial class AccountsCashReceiptVoucher : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                //ttlVoucher.Text = "Cash Receipt Voucher      (" + PhoenixAccountsVoucher.VoucherNumber + ")     ";
            }
        }
        ...
        MenuVoucher.Title = "Cash Receipt Voucher      (" + txtVoucherNumber.Text + ")     ";
    ...
    protected void Voucher_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsCashReceiptVoucherList.aspx");
        }
        if (CommandName.ToUpper().Equals("DETAILS"))
        {
            Response.Redirect("../Accounts/AccountsCashReceiptVoucherLineItem.aspx?qvouchercode=" + ViewState["VOUCHERID"].ToString());
        }
    ...
    protected void Reset()
    {
        if (ViewState["VOUCHERID"] != null)
        {
            ...
            txtStatus.Text = "";
            ucDueDate.Text = "";
            //   ttlVoucher.Text = "Cash Receipt Voucher      ()     ";
            BindCashAccountCurrency();
            txtRemarks.Text = "";
        }
    }
