<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsCashReceiptVoucherLineItemDetails.aspx.cs"
    Inherits="AccountsCashReceiptVoucherLineItemDetails" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlStockItemEntry">
            ...
            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
                <telerik:RadPane ID="navigationPane" runat="server" Scrolling="None">
                    <iframe runat="server" id="ifMoreInfo" scrolling="no" style="min-height: 380px; width: 99%"></iframe>
                </telerik:RadPane>
                ...
                <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvLineItem" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        OnRowCancelingEdit="gvLineItem_RowCancelingEdit" OnRowDeleting="gvLineItem_RowDeleting" GroupingEnabled="false" EnableHeaderContextMenu="true"
                        OnRowCreated="gvLineItem_RowCreated" ShowHeader="true" AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvLineItem_NeedDataSource"
                        ...
                        <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Prime Amount" HeaderStyle-Width="10%">
                                    ...
                                    <FooterTemplate>
                                        <b>
                                            <asp:Literal ID="lblDebitsTotal" runat="server" Text="Debits Total"></asp:Literal>&nbsp;:&nbsp;&nbsp; </b>
                                        <br />
                                        <b>
                                            <asp:Literal ID="lblCreditsTotal" runat="server" Text="Credits Total :"></asp:Literal>&nbsp;&nbsp; </b>
                                    </FooterTemplate>
                                </telerik:GridTemplateColumn>
                                <telerik:GridTemplateColumn HeaderText="Base Amount" HeaderStyle-Width="10%">
                                    <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                    <FooterStyle Wrap="False" HorizontalAlign="Right" />
                                    <HeaderTemplate>
