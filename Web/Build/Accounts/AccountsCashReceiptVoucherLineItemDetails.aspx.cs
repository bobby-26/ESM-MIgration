...
public partial class AccountsCashReceiptVoucherLineItemDetails : PhoenixBasePage
{
    string _reportfile = "";
    string _filename = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsCashReceiptVoucherLineItemDetails.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvLineItem')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Accounts/AccountsCashReceiptVoucherLineItemDetails.aspx", "Report", "task-list.png", "REPORT");
            toolbargrid.AddImageButton("../Accounts/AccountsCashReceiptVoucherLineItemDetails.aspx", "Voucher Print", "pdf.png", "REPORTPR"); 
            toolbargrid.AddImageButton("../Accounts/AccountsCashReceiptVoucherLineItemDetails.aspx", "Voucher Upload", "download_1.png", "UPLOAD");
           ...
           // MenuOrderLineItem.SetTrigger(pnlStockItemEntry);
            ...
            MenuLineItem.Title = "Cash Receipt Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
            ...
            if (!IsPostBack)
            {
                ...
                //Title1.Text = "Cash Receipt Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
                if (Request.QueryString["qvouchercode"] != null)
                {
                    ifMoreInfo.Attributes["src"] = "AccountsCashReceiptVoucherLineItem.aspx?qvouchercode=" + Request.QueryString["qvouchercode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
                }
                else
                {
                    ifMoreInfo.Attributes["src"] = "AccountsCashReceiptVoucherLineItem.aspx";
                }
            }
    ...
    protected void MenuLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ViewState["PAGEURL"] = "../Accounts/AccountsCashReceiptVoucherLineItem.aspx?voucherid=";
            }
            else if (CommandName.ToUpper().Equals("VOUCHER"))
            {
                Response.Redirect("../Accounts/AccountsCashReceiptVoucherMaster.aspx?voucherid=" + ViewState["voucherid"].ToString());
            }
    ...
    private void BindPageURL(int rowindex)
    {
        try
        {
            ...
            ifMoreInfo.Attributes["src"] = "../Accounts/AccountsCashReceiptVoucherLineItem.aspx?voucherid=" + ViewState["voucherid"].ToString() + "&voucherlineitemcode=" + ViewState["voucherlineitemcode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
        }
        catch (Exception ex)
        {
            ucError.ErrorMessage = ex.Message;
    ...
    private void BindData()
    {
        ...
        if (ViewState["voucherid"] != null)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0 && ViewState["voucherlineitemcode"] == null)
            {
                ...
                {
                    ViewState["PAGEURL"] = "../Accounts/AccountsCashReceiptVoucherLineItem.aspx?qvouchercode=";
                }
                {
                    if (ViewState["voucherlineitemcode"] != null)
                    {
