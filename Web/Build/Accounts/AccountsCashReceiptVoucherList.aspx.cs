...
public partial class AccountsCashReceiptVoucherList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbargrid.AddImageButton("../Accounts/AccountsCashReceiptVoucherList.aspx", "Export to Excel", "icon_xls.png", "Excel");
        toolbargrid.AddImageLink("javascript:CallPrint('gvVoucher')", "Print Grid", "icon_print.png", "PRINT");
        toolbargrid.AddImageLink("../Accounts/AccountsCashReceiptVoucherList.aspx", "Find", "search.png", "FIND");
    ...
    protected void VoucherNavItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsCashReceiptVoucher.aspx");
        }
    }
    ...
    protected void VoucherClick(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("../Accounts/AccountsCashReceiptVoucher.aspx?VOUCHERID=" + ViewState["VOUCHERCODE"].ToString());
    }
