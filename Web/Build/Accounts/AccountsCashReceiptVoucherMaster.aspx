<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsCashReceiptVoucherMaster.aspx.cs"
    Inherits="AccountsCashReceiptVoucherMaster" %>
            ...
            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
                ...
                <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvFormDetails" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        OnDeleteCommand="gvFormDetails_RowDeleting" AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvFormDetails_NeedDataSource" OnPageIndexChanged="gvFormDetails_PageIndexChanged"
