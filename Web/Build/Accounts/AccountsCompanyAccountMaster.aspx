<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsCompanyAccountMaster.aspx.cs"
    Inherits="AccountsCompanyAccountMaster" %>
...
<head id="Head1" runat="server">
    <title>Accounts Master</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body onresize="resizeFrame(document.getElementById('ifMoreInfo'));" onload="resizeFrame(document.getElementById('ifMoreInfo'));">
    ...
    <telerik:RadAjaxPanel runat="server" ID="pnlAccountMaster" Height="100%">
                <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
<%--                    <eluc:Title runat="server" ID="Title1" Text=" Chart of Accounts"></eluc:Title>--%>
                    <asp:Button runat="server" ID="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" />
                    <eluc:TabStrip ID="MenuAccountMaster" runat="server" OnTabStripCommand="AccountMaster_TabStripCommand"
