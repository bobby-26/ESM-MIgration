<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsCreditNoteVoucher.aspx.cs"
    Inherits="AccountsCreditNoteVoucher" EnableEventValidation="true" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="1" cellspacing="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtVoucherType" Text="Credit Note Voucher" CssClass="readonlytextbox"
