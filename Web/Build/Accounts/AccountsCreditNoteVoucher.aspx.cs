...
public partial class AccountsCreditNoteVoucher : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                //ttlVoucher.Text = "Credit Note Voucher      (" + PhoenixAccountsVoucher.VoucherNumber + ")     ";
            }
        }
        ...
        MenuVoucher.Title = "Credit Note Voucher      (" + txtVoucherNumber.Text + ")     ";
    ...
    protected void Voucher_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsCreditNoteVoucherList.aspx");
        }
        if (CommandName.ToUpper().Equals("DETAILS"))
        {
            Response.Redirect("../Accounts/AccountsCreditNoteVoucherLineItem.aspx?qvouchercode=" + ViewState["VOUCHERID"].ToString());
        }
    ...
    protected void Reset()
    {
        if (ViewState["VOUCHERID"] != null)
        {
            ...
            ucDueDate.Text = "";
            txtRemarks.Text = "";
            //     ttlVoucher.Text = "Credit Note Voucher      ()     ";
        }
    }
