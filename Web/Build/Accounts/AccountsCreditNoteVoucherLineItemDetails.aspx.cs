...
public partial class AccountsCreditNoteVoucherLineItemDetails : PhoenixBasePage
{
    string _reportfile = "";
    string _filename = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsCreditNoteVoucherLineItemDetails.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvLineItem')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Accounts/AccountsCreditNoteVoucherLineItemDetails.aspx", "Report", "task-list.png", "REPORT");
            toolbargrid.AddImageButton("../Accounts/AccountsCreditNoteVoucherLineItemDetails.aspx", "Voucher Print", "pdf.png", "REPORTPR");
            toolbargrid.AddImageButton("../Accounts/AccountsCreditNoteVoucherLineItemDetails.aspx", "Voucher Upload", "download_1.png", "UPLOAD");
            ...
            MenuLineItem.Title = "Credit Note Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
            ...
            if (!IsPostBack)
            {
                ...
                //   Title1.Text = "Credit Note Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
                if (Request.QueryString["qvouchercode"] != null)
                {
                    ifMoreInfo.Attributes["src"] = "AccountsCreditNoteVoucherLineItem.aspx?qvouchercode=" + Request.QueryString["qvouchercode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
                }
                else
                {
                    ifMoreInfo.Attributes["src"] = "AccountsCreditNoteVoucherLineItem.aspx";
                }
            }
    ...
    protected void MenuLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ViewState["PAGEURL"] = "../Accounts/AccountsCreditNoteVoucherLineItem.aspx?voucherid=";
            }
            else if (CommandName.ToUpper().Equals("VOUCHER"))
            {
                Response.Redirect("../Accounts/AccountsCreditNoteVoucherMaster.aspx?voucherid=" + ViewState["voucherid"].ToString());
            }
    ...
    private void BindPageURL(int rowindex)
    {
        try
        {
            ...
            ifMoreInfo.Attributes["src"] = "../Accounts/AccountsCreditNoteVoucherLineItem.aspx?qvouchercode=" + ViewState["voucherid"].ToString() + "&voucherlineitemcode=" + ViewState["voucherlineitemcode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
        }
    ...
    private void BindData()
    {
        ...
        if (ViewState["voucherid"] != null)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0 && ViewState["voucherlineitemcode"] == null)
            {
                ...
                //s gvLineItem.SelectedIndex = 0;
            }

            if (ViewState["PAGEURL"] == null)
            {
                ViewState["PAGEURL"] = "../Accounts/AccountsCreditNoteVoucherLineItem.aspx?qvouchercode=";
            }
            {
                if (ViewState["voucherlineitemcode"] != null)
                {
