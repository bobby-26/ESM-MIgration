<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsDashboardAdvancePayment.aspx.cs" Inherits="Accounts_AccountsDashboardAdvancePayment" %>
                ...
                <telerik:RadGrid ID="gvAdvancePayment" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                    ...
                    <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Payment Status" Visible="false">
                                <itemstyle wrap="False" horizontalalign="Left"></itemstyle>
                                <itemtemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Invoice number" Visible="false">
                                <itemstyle wrap="False" horizontalalign="Left"></itemstyle>
                                <itemtemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Invoice status" Visible="false">
                                <itemstyle wrap="False" horizontalalign="Left"></itemstyle>
                                <itemtemplate>
