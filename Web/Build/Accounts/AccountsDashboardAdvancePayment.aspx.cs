...
public partial class Accounts_AccountsDashboardAdvancePayment : PhoenixBasePage
{
    string status;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsDashboardAdvancePayment.aspx", "Export to Excel", "icon_xls.png", "Excel");
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsDashboardAdvancePayment.aspx", "Clear", "clear-filter.png", "CLEAR");
