<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsDashboardCtmRequestArrangementGeneral.aspx.cs" Inherits="Accounts_AccountsDashboardCtmRequestArrangementGeneral" %>
        ...
        <asp:UpdatePanel runat="server" ID="pnlNTBRManager">
            <ContentTemplate>--%>
                    ...
                    <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
                        ...
                        <eluc:TabStrip ID="MenuCTMMain" runat="server" OnTabStripCommand="MenuCTMMain_TabStripCommand" Visible="false"
                            TabStrip="true">
                        </eluc:TabStrip>
