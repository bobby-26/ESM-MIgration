...
public partial class Accounts_AccountsDashboardCtmRequestArrangementGeneral : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ViewState["vesselid"] = "";
                ViewState["CaptainCashID"] = "";

                if (Request.QueryString["vesselid"] != null)
                    ViewState["vesselid"] = Request.QueryString["vesselid"].ToString();

                if (Request.QueryString["CaptainCashID"] != null)
                    ViewState["CTMID"] = Request.QueryString["CaptainCashID"].ToString();
