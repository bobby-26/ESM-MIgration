<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsDashboardDebitNoteReferenceHistory.aspx.cs" Inherits="Accounts_AccountsDashboardDebitNoteReferenceHistory" %>
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="Radcodeblock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvInvoiceHistory.ClientID %>"));
                }, 200);
            }
...
<body>
    <form id="frmPurchaseForm" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvInvoiceHistory" runat="server" Height="80%" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
