...
public partial class Accounts_AccountsDashboardDepositList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsDashboardDepositList.aspx", "Export to Excel", "icon_xls.png", "Excel");
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsDashboardDepositList.aspx", "Clear", "clear-filter.png", "CLEAR");
