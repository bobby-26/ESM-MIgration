...
public partial class Accounts_AccountsDashboardInvoiceGeneratePMV : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsDashboardInvoiceGeneratePMV.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void gvVoucherDetails_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        {
            PhoenixAccountsInvoicePaymentVoucher.PaymentVoucherRecalculate(General.GetNullableGuid(e.Item.ItemIndex.ToString()));
            Rebind();
        }
