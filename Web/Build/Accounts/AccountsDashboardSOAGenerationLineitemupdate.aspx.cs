...
public partial class Accounts_AccountsDashboardSOAGenerationLineitemupdate : PhoenixBasePage
{
    ...
    protected void MenuGeneral_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("HISTORY"))
            {
                ...
                Response.Redirect("../Accounts/AccountsDashboardDebitNoteReferenceHistory.aspx?DebitNoteReferenceid=" + ViewState["debitnotereferenceid"] + "&qfrom=SOAGeneration"+ "&status=" + ViewState["status"].ToString() +
                    "&type=" + ViewState["type"].ToString() + "&month=" + ViewState["month"].ToString() + "&year=" + ViewState["year"].ToString() + "&Condition=1");
            }
    ...
    protected void MenuGenralSub_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Accounts/AccountsDashboardSOAGenerationLineitemupdate.aspx?debitnotereference=" + ViewState["debitnotereference"] + "&accountid=" + ViewState["accountid"] + "&Ownerid=" + ViewState["Ownerid"] + "&voucherdetailid=" + ViewState["FLDVOUCHERDETAILID"] + "&VesselId=" + Request.QueryString["VesselId"].ToString(), true);
            }
            if (CommandName.ToUpper().Equals("DETAILS"))
            {
                Response.Redirect("../Accounts/AccountsDashboardSoaGenerationLineItems.aspx?debitnotereference=" + ViewState["debitnotereference"].ToString() + "&accountid=" + ViewState["accountid"].ToString() + "&Ownerid=" + ViewState["Ownerid"] + "&debitnoteid=" + ViewState["debitnotereferenceid"] +
                    "&status=" + ViewState["status"].ToString() + "&type=" + ViewState["type"].ToString() + "&month=" + ViewState["month"].ToString() + "&year=" + ViewState["year"].ToString() + "&Condition=1", true);
