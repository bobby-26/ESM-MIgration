...
public partial class Accounts_AccountsDashboardVesselAccountsPettyCashGeneral : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["DATE"] != null && Request.QueryString["DATE"].ToString() != "")
                    ViewState["ENDDATE"] = Request.QueryString["DATE"].ToString();
                ...
                if (Request.QueryString["STARTdate"] != null && Request.QueryString["STARTdate"].ToString() != "")
                    ViewState["STARTdate"] = Request.QueryString["STARTdate"].ToString();
              ...
              //  ViewState["vesselid"] = Filter.CurrentMenuCodeSelection == "VAC-PBL-PTC" ? PhoenixSecurityContext.CurrentSecurityContext.VesselID.ToString() : Request.QueryString["Vesselid"];
                ...
                {
                    txtFromDate.Text = ViewState["STARTdate"].ToString();
                    txtToDate.Text = ViewState["ENDDATE"].ToString();
                ...
                {
                    txtFromDate.Text = Request.QueryString["STARTdate"].ToString();
