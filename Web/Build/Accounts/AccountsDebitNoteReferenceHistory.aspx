<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsDebitNoteReferenceHistory.aspx.cs" Inherits="AccountsDebitNoteReferenceHistory" %>
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                ...
                <div id="divGrid" style="position: relative; z-index: 1; width: 100%; height: 35%; overflow: auto">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvInvoiceHistory" runat="server" Height="500px" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
