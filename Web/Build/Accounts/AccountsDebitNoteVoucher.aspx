<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsDebitNoteVoucher.aspx.cs"
    Inherits="AccountsDebitNoteVoucher" EnableEventValidation="true" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="1" cellspacing="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtVoucherType" Text="Debit Note Voucher" CssClass="readonlytextbox"
