...
public partial class AccountsDebitNoteVoucher : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // MenuVoucher.SetTrigger(pnlVoucher);
        ...
        if (!IsPostBack)
        {
            ...
            {
                //ttlVoucher.Text = "Debit Note Voucher      (" + PhoenixAccountsVoucher.VoucherNumber + ")     ";
            }
        }
        ...
        MenuVoucher.Title = "Debit Note Voucher      (" + txtVoucherNumber.Text + ")     ";
    ...
    protected void Voucher_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsDebitNoteVoucherList.aspx");
        }
        if (CommandName.ToUpper().Equals("DETAILS"))
        {
            Response.Redirect("../Accounts/AccountsDebitNoteVoucherLineItem.aspx?qvouchercode=" + ViewState["VOUCHERID"].ToString());
        }
    ...
    protected void Reset()
    {
        if (ViewState["VOUCHERID"] != null)
        {
            ...
            ucDueDate.Text = "";
            txtRemarks.Text = "";
            //  ttlVoucher.Text = "Debit Note Voucher      ()     ";
        }
    }
