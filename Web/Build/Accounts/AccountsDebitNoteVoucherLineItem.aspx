<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsDebitNoteVoucherLineItem.aspx.cs"
    Inherits="AccountsDebitNoteVoucherLineItem" MaintainScrollPositionOnPostback="true" %>
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        <span id="spnPickListExpenseAccount">
                            ...
                            <asp:ImageButton runat="server" ID="imgShowAccount" OnClick="cmdHiddenPick_Click"
