...
public partial class AccountsDebitNoteVoucherLineItemDetails : PhoenixBasePage
{
    string _reportfile = "";
    string _filename = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsDebitNoteVoucherLineItemDetails.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvLineItem')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Accounts/AccountsDebitNoteVoucherLineItemDetails.aspx", "Report", "task-list.png", "REPORT");
            toolbargrid.AddImageButton("../Accounts/AccountsDebitNoteVoucherLineItemDetails.aspx", "Voucher Print", "pdf.png", "REPORTPR");
            toolbargrid.AddImageButton("../Accounts/AccountsDebitNoteVoucherLineItemDetails.aspx", "Voucher Upload", "download_1.png", "UPLOAD");
           ...
           // MenuOrderLineItem.SetTrigger(pnlStockItemEntry);
            ...
            MenuOrderLineItem.AccessRights = this.ViewState;
            MenuLineItem.Title = "Debit Note Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
            ...
            if (!IsPostBack)
            {
                ...
                //Title1.Text = "Debit Note Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
                if (Request.QueryString["qvouchercode"] != null)
                {
                    ifMoreInfo.Attributes["src"] = "AccountsDebitNoteVoucherLineItem.aspx?qvouchercode=" + Request.QueryString["qvouchercode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
                }
                else
                {
                    ifMoreInfo.Attributes["src"] = "AccountsDebitNoteVoucherLineItem.aspx";
                }
            }
    ...
    protected void MenuLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ViewState["PAGEURL"] = "../Accounts/AccountsDebitNoteVoucherLineItem.aspx?voucherid=";
            }
            else if (CommandName.ToUpper().Equals("VOUCHER"))
            {
                Response.Redirect("../Accounts/AccountsDebitNoteVoucherMaster.aspx?voucherid=" + ViewState["voucherid"].ToString());
            }
    ...
    private void BindPageURL(int rowindex)
    {
        try
        {
            ...
            ifMoreInfo.Attributes["src"] = "../Accounts/AccountsDebitNoteVoucherLineItem.aspx?qvouchercode=" + ViewState["voucherid"].ToString() + "&voucherlineitemcode=" + ViewState["voucherlineitemcode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
    ...
    private void BindData()
    {
        ...
        if (ViewState["voucherid"] != null)
        {
...

            {
                ...
                {
                    ViewState["PAGEURL"] = "../Accounts/AccountsDebitNoteVoucherLineItem.aspx?qvouchercode=";
                }
                {
                    if (ViewState["voucherlineitemcode"] != null)
                    {
