<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsDebitNoteVoucherMaster.aspx.cs"
    Inherits="AccountsDebitNoteVoucherMaster" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlOrderForm">
            ...
            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
                ...
                <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                    ...
                    <%--                    <iframe runat="server" id="ifMoreInfo" scrolling="no" style="min-height: 300px; width: 99%"></iframe>--%>
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvFormDetails" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnItemCommand="gvFormDetails_RowCommand" OnItemDataBound="gvFormDetails_ItemDataBound" GroupingEnabled="false" EnableHeaderContextMenu="true"
                        OnDeleteCommand="gvFormDetails_RowDeleting" AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvFormDetails_NeedDataSource"
                        AllowSorting="true" EnableViewState="false"
                        OnSortCommand="gvFormDetails_Sorting" OnPreRender="gvFormDetails_PreRender" OnPageIndexChanged="gvFormDetails_PageIndexChanged" OnPageSizeChanged="gvFormDetails_PageSizeChanged">
                        ...
                        <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn HeaderText="Voucher Number" AllowFiltering="true" SortExpression="FLDVOUCHERNUMBER">
