...
public partial class AccountsDebitNoteVoucherMaster : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsDebitNoteVoucherMaster.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvVoucher')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageLink("javascript:openNewWindow('codehelp1','', '" + Session["sitepath"] + "/Accounts/AccountsDebitNoteVoucherFilter.aspx'); return false;", "Find", "search.png", "FIND");
            ...
            if (!IsPostBack)
            {
               ...
               // ViewState["URL"] = "../Accounts/AccountsDebitNoteVoucher.aspx?voucherid=";
                ...
                if (Request.QueryString["voucherid"] != null)
                {
                    ...
                    ifMoreInfo.Attributes["src"] = "../Accounts/AccountsDebitNoteVoucher.aspx?voucherid=" + ViewState["voucherid"];
                }
            }
       }
        catch (Exception ex)
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Accounts/AccountsDebitNoteVoucherLineItemDetails.aspx?qvouchercode=" + ViewState["voucherid"]);
            }
            else
    ...
    private void BindData()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsDebitNoteVoucher.aspx?voucherid=" + ViewState["voucherid"].ToString();
            }
            SetRowSelection();
        }
        else
        {
            if (ViewState["PAGEURL"] == null)
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsDebitNoteVoucher.aspx?voucherid=";
            }
        }
    }
    ...
    private void SetRowSelection()
    {
        ...
        foreach (GridDataItem item in gvFormDetails.Items)
        {
            ...
            if (item.GetDataKeyValue("FLDVOUCHERID").ToString() == (ViewState["voucherid"].ToString()))
            {
    ...
    protected void gvFormDetails_PageSizeChanged(object sender, GridPageSizeChangedEventArgs e)
    {
        ViewState["voucherid"] = null;
    }
