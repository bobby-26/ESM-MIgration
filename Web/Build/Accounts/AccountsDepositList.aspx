<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsDepositList.aspx.cs"
    Inherits="Accounts_AccountsDepositList" %>
                    ...
                    <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Deposit No" UniqueName="DEPOSITNO" SortExpression="FLDDEPOSITNUMBER" AllowSorting="true">
                                <HeaderStyle Width="87px" HorizontalAlign="Left" />
                            ...
                            <telerik:GridTemplateColumn HeaderText="Deposit Status">
                                <HeaderStyle Width="152px" HorizontalAlign="Left" />
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Payment Voucher">
                                <HeaderStyle Width="121px" HorizontalAlign="Left" />
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Credit Note status">
                                <HeaderStyle Width="121px" HorizontalAlign="Left" />
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
