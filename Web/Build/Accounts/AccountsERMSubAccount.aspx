<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsERMSubAccount.aspx.cs"
    Inherits="AccountsERMSubAccount" %>
...
<body>
    <form id="frmERMSubAccount" runat="server">
        <telerik:RadScriptManager runat="server" ID="ToolkitScriptManager1" />
        <telerik:RadAjaxPanel runat="server" ID="pnlERMSubAccount" Height="100%" EnableAJAX="false">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadLabel ID="lblCompany" Text="Sub Account Description" runat="server"></telerik:RadLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="RadLabel1" Text=" Account Description" runat="server"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadTextBox runat="server" ID="Accountdescription" CssClass="input" Width="95%"></telerik:RadTextBox></td>
                    <td>
                        <telerik:RadLabel ID="RadLabel2" Text="Account Name" runat="server"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadTextBox runat="server" ID="AccountName" CssClass="input" Width="95%"></telerik:RadTextBox></td>
                </tr>
                <tr>
                    <td>
                        <telerik:RadLabel ID="RadLabel3" Text="Mapped Account" runat="server"></telerik:RadLabel>
                    </td>
                    <td>
            ...
            <eluc:TabStrip ID="MenuERMSubAccount" runat="server" OnTabStripCommand="MenuERMSubAccount_TabStripCommand"></eluc:TabStrip>
                <telerik:RadGrid RenderMode="Lightweight" ID="gvERMSubAccount" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                    Width="100%" CellPadding="3" OnItemCommand="gvERMSubAccount_ItemCommand" OnItemDataBound="gvERMSubAccount_ItemDataBound"
                    AllowPaging="true" AllowCustomPaging="true" Height="78%" AllowSorting="true" EnableViewState="false" ShowFooter="true"
                    OnNeedDataSource="gvERMSubAccount_NeedDataSource" OnSortCommand="gvERMSubAccount_Sorting"
                    ...
                    <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Mapped ERM Code" AllowSorting="true">
                                ...
                                <FooterTemplate>
                                    <telerik:RadTextBox ID="txtMappedERMCodeAdd" runat="server" CssClass="gridinput_mandatory" Width="95%" MaxLength="200"
                                        ToolTip="Enter Mapped ERM Code">
                                    </telerik:RadTextBox>
                                </FooterTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="ERM Account Name" AllowSorting="true">
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblERMAccountName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDERMACCOUNTNAME") %>'></telerik:RadLabel>
                                </ItemTemplate>

                                <EditItemTemplate>
                                    <telerik:RadTextBox ID="txtERMAccountNameEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDERMACCOUNTNAME") %>'
                                        CssClass="gridinput_mandatory" MaxLength="200">
                                    </telerik:RadTextBox>
                                </EditItemTemplate>

                                <FooterTemplate>
                                    <telerik:RadTextBox ID="txtERMAccountNameAdd" runat="server" CssClass="gridinput_mandatory" Width="95%" MaxLength="200"
                                        ToolTip="Enter ERM Account Name">
                                    </telerik:RadTextBox>
                                </FooterTemplate>
                            </telerik:GridTemplateColumn>
