<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsERMVoucherAdvancedFilter.aspx.cs"
        ...
        <div id="divFind">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtVoucherNumber" runat="server"  MaxLength="200" Width="150px"></telerik:RadTextBox>
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblShowEntriesforPublishedSOA" runat="server" Text="Show Entries for Published SOA"></telerik:RadLabel>
                    </td>
                    <td>
