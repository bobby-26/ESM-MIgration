<%@ Page Language="C#" AutoEventWireup="True" CodeFile="AccountsERMVoucherDetail.aspx.cs"
    Inherits="AccountsERMVoucherDetail" %>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Amount" HeaderStyle-Width="100px">
                         ...
                         <telerik:GridTemplateColumn HeaderText="Report Amount" HeaderStyle-Width="100px">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblReportAmount" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREPORTAMOUNT","{0:n}") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
