<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsGenerateRemittanceFilter.aspx.cs" Inherits="Accounts_AccountsGenerateRemittanceFilter" %>
...
<%--                <telerik:RadLabel runat="server" ID="lblCaption" Font-Bold="true" Text="Generate Remittance Filter"></telerik:RadLabel>--%>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlAddressEntry">
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                <telerik:RadTextBox runat="server" ID="txtVoucherNumberSearch" CssClass="input" OnTextChanged="txtVoucherNumberSearch_TextChanged" TextMode ="MultiLine"
...
<%--                             <telerik:RadTextBox ID="txtVoucherTodateSearch" runat="server" Width="90px" CssClass="input"></telerik:RadTextBox>--%>
                        ...
                        <tr runat="server" visible ="false">
                            <td>
                                <telerik:RadLabel ID="lblInvoiceNumber" runat="server" Text="Invoice Number"></telerik:RadLabel></td>
                            <td>
                                <telerik:RadTextBox ID="txtInvoiceNumber" runat="server" CssClass="input"
                                    MaxLength="200" Width="150px"></telerik:RadTextBox>
                            </td>
                            <td>
                                <telerik:RadLabel ID="lblPurchaseInvoiceVoucherNumber" runat="server" Text="Purchase Invoice Voucher Number"></telerik:RadLabel></td>
                            <td>
                        ...
                        <tr runat="server" visible ="false">
                            ...
                            <td>
                                <eluc:Hard ID="ddlSource" runat="server" AppendDataBoundItems="true" CssClass="input"
                                    HardTypeCode="221" ShortNameFilter="CTM,APT,INV,DEP,ICT,IOT,TCL,EAD"/>
                            </td>
                            <td>
                            ...
                            <td>
                                <eluc:Hard ID="ddlType" runat="server" AppendDataBoundItems="true" CssClass="input"
                                    HardTypeCode="213" ShortNameFilter="HCY,RME,OWN,AVN,PCD,SPI,MDL,ROL,BNP,QTY,LIC,CAS,GAR,PAR,SAS,VCP,CRW,AGY,OFC,OBV,WKG,LTR,TAD"/>
                            </td>
                        </tr>
                        <tr runat="server" visible ="false">
                            ...
                            <td>
                                <telerik:RadComboBox ID="ddlAllocationStatus" runat="server" CssClass="input">
                                    <Items>
                                    <telerik:RadComboBoxItem Text="All" Value="0"></telerik:RadComboBoxItem>
                                    <telerik:RadComboBoxItem Text="Allocated" Value="1"></telerik:RadComboBoxItem>
                                    <telerik:RadComboBoxItem Text="Not Yet Allocated" Value="2"></telerik:RadComboBoxItem>
                                        </Items>
                                </telerik:RadComboBox>
                            </td>
                        </tr>
