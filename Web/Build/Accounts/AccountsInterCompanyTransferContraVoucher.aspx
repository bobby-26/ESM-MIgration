<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInterCompanyTransferContraVoucher.aspx.cs" Inherits="AccountsInterCompanyTransferContraVoucher" %>
...
<body>
    <form id="frmInterCompanyContraVoucher" runat="server">
                ...
                <eluc:Status runat="server" ID="ucStatus" />
                    ...
                    <table cellpadding="1" cellspacing="1" style="width: 100%">
                        <tr>
                            ...
                            <td>
                                  <telerik:RadDropDownList ID="ddlVoucherType" runat="server" AutoPostBack="True" 
                        ...
                        <tr>
                            ...
                            <td style="width: 50%">
                                <span id="spnPickListCashAccount">
                                    <telerik:RadTextBox ID="txtAccountCode" runat="server" CssClass="input"  MaxLength="20" Width="20%"></telerik:RadTextBox>
                        ...
                        <tr>
                            <td rowspan="2">
                                <telerik:RadLabel ID="lblLongDescription" runat="server" Text="Long Description"></telerik:RadLabel></td>
                            <td rowspan="2">
                                <telerik:RadTextBox ID="txtLongDescription" runat="server" CssClass="input" 
                                    Height="45px" TextMode="MultiLine" Width="270px"></telerik:RadTextBox>
                            </td>
                            <td>
                                <telerik:RadLabel ID="lblLastUpdatedBy" runat="server" Text="Last Updated By"></telerik:RadLabel></td>
                            <td>
                                <telerik:RadTextBox ID="txtUpdatedBy" runat="server" CssClass="readonlytextbox" 
                                    ReadOnly="true" Width="160px"></telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblLastUpdatedDate" runat="server" Text="Last Updated Date"></telerik:RadLabel></td>
                            <td>
                                <telerik:RadTextBox ID="txtUpdatedDate" runat="server" CssClass="readonlytextbox" 
                                    ReadOnly="true" Width="160px"></telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblTargetCompany" runat="server" Text="Target Company"></telerik:RadLabel></td>
                            <td>
                                <telerik:RadTextBox ID="txttargetCompany" runat="server" CssClass="readonlytextbox" 
                                    ReadOnly="true" Width="160px"></telerik:RadTextBox>
                            </td>
                            <td>
                                &nbsp;</td>
