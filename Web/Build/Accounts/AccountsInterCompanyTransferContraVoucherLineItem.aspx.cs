...
public partial class AccountsInterCompanyTransferContraVoucherLineItem : PhoenixBasePage
{
    ...
    protected void Voucher_SetExchangeRate(object sender, EventArgs e)
    {
        ...
        if (ddlCurrencyCode.SelectedCurrency.ToUpper() != "DUMMY")
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                if (Session["INTERCONTRAVOUCHERCURRENCYID" + ddlCurrencyCode.SelectedCurrency + "Rate"] != null)
                {
                    System.Collections.Hashtable ht = new System.Collections.Hashtable();
                    ht = (System.Collections.Hashtable)Session["INTERCONTRAVOUCHERCURRENCYID" + ddlCurrencyCode.SelectedCurrency + "Rate"];
                ...
                else
                {
                    ...
                    Session["INTERCONTRAVOUCHERCURRENCYID" + ddlCurrencyCode.SelectedCurrency + "INITIALRate"] = htInitialRate;
                }
            }
        }
        else
    ...
    protected void Reset()
    {
        ...
        txtBudgetCode.Text = "";
        txtBudgetName.Text = "";
        if (Session["SelectedInterAccountId"] != null)
            Session.Remove("SelectedInterAccountId");
        if (Session["InterContraAccountCode"] != null)
            Session.Remove("InterContraAccountCode");
        if (Session["InterContraAccountCodeDescription"] != null)
            Session.Remove("InterContraAccountCodeDescription");
        if (ViewState["FLDCONTRAVOUCHERTYPEID"] != null && Convert.ToInt32(ViewState["FLDCONTRAVOUCHERTYPEID"].ToString()) != 69 && Convert.ToInt32(ViewState["FLDCONTRAVOUCHERTYPEID"].ToString()) != 71)
        {
    ...
    protected void VoucherLineEdit(Guid gLineId)
    {
        ...
        if (ds.Tables.Count > 0)
        {
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                Session["SelectedInterAccountId"] = dr["FLDACCOUNTID"].ToString();
    ...
    {
        Session["InterContraAccountCode"] = txtAccountCode.Text;
        Session["InterContraAccountCodeDescription"] = txtAccountDescription.Text;
        Session["InterContraSubAccountId"] = txtBudgetCode.Text;
    }
    ...
    protected void txtExchangeRate_TextChanged(object sender, EventArgs e)
    {
        System.Collections.Hashtable ht = new System.Collections.Hashtable();
        System.Collections.Hashtable htInitialRate = new System.Collections.Hashtable();
        if (Session["INTERCONTRAVOUCHERCURRENCYID" + ddlCurrencyCode.SelectedCurrency + "INITIALRate"] != null)
        {
            htInitialRate = (System.Collections.Hashtable)Session["INTERCONTRAVOUCHERCURRENCYID" + ddlCurrencyCode.SelectedCurrency + "INITIALRate"];
            if ((txtExchangeRate.Text != "") && (txtExchangeRate.Text != htInitialRate["INITIALEXCHANGERATE"].ToString()))
            {
                ...
                Session["INTERCONTRAVOUCHERCURRENCYID" + ddlCurrencyCode.SelectedCurrency + "Rate"] = ht;
            }
        }
    }
    protected void txt2ndExchangeRate_TextChanged(object sender, EventArgs e)
    {
        Session["INTERCONTRAVOUCHERCURRENCYID" + ddlCurrencyCode.SelectedCurrency] = ddlCurrencyCode.SelectedCurrency;
        System.Collections.Hashtable ht = new System.Collections.Hashtable();
        System.Collections.Hashtable htInitialRate = new System.Collections.Hashtable();
        if (Session["INTERCONTRAVOUCHERCURRENCYID" + ddlCurrencyCode.SelectedCurrency + "INITIALRate"] != null)
        {
