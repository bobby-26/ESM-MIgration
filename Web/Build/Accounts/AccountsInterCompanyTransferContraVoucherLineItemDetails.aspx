<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInterCompanyTransferContraVoucherLineItemDetails.aspx.cs" Inherits="AccountsInterCompanyTransferContraVoucherLineItemDetails" %>
        ...
        <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel" runat="server"></telerik:RadAjaxLoadingPanel>
            ...
            <telerik:RadPane ID="listPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                    <eluc:TabStrip ID="MenuOrderLineItem" runat="server" OnTabStripCommand="MenuOrderLineItem_TabStripCommand">
                        ...
                        <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator2" runat="server" DecorationZoneID="gvLineItem" DecoratedControls="All" EnableRoundedCorners="true" />
                    ...
                    AutoGenerateColumns="false" >               
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Row Number">
                                ...
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblNewVoucherId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDNEWVOUCHERID") %>' Visible="false"></telerik:RadLabel>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Action">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:ImageButton ID="hlnkSplit" runat="Server" Text="View" ImageUrl='<%$ PhoenixTheme:images/annexure.png%>'
                                        ToolTip="Allocation"  Visible ="false" CommandName="Sort"></asp:ImageButton>
