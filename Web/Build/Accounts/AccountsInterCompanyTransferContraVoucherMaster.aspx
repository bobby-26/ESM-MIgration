<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInterCompanyTransferContraVoucherMaster.aspx.cs" Inherits="AccountsInterCompanyTransferContraVoucherMaster" %>
     ...
     <%: Scripts.Render("~/bundles/js") %>
        ...
        <script type="text/javascript">
            ...
            function PaneResized(sender, args) {
                ...
                var grid = $find("gvInterCompanyContraVoucherMaster");
    ...
    <form id="frmPurchaseForm" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="gvInterCompanyContraVoucherMaster">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gvInterCompanyContraVoucherMaster" />
                        <telerik:AjaxUpdatedControl ControlID="ifMoreInfo" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
        ...
        <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel" runat="server"></telerik:RadAjaxLoadingPanel>
            ...
            <telerik:RadPane ID="generalPane" runat="server" Scrolling="None">
                <iframe runat="server" id="ifMoreInfo" scrolling="no" style="min-height: 450px; width: 100%">
                </iframe>
                   </telerik:RadPane>
            ...
            <telerik:RadPane ID="listPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                    ...
                    <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator2" runat="server" DecorationZoneID="gvInterCompanyContraVoucherMaster" DecoratedControls="All" EnableRoundedCorners="true" />
                <telerik:RadGrid RenderMode="Lightweight" ID="gvInterCompanyContraVoucherMaster" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" OnNeedDataSource="gvInterCompanyContraVoucherMaster_NeedDataSource" AllowMultiRowSelection="true" FilterType="CheckList"
                EnableViewState="false" EnableHeaderContextMenu="true" Width="100%" Height="100%"  OnSelectedIndexChanging="gvInterCompanyContraVoucherMaster_SelectedIndexChanging"
                OnItemDataBound="gvInterCompanyContraVoucherMaster_ItemDataBound" OnItemCommand="gvInterCompanyContraVoucherMaster_ItemCommand"
                ShowFooter="false" ShowHeader="true" OnSortCommand="gvInterCompanyContraVoucherMaster_SortCommand">
