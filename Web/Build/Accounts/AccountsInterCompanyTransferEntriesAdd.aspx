<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInterCompanyTransferEntriesAdd.aspx.cs" Inherits="AccountsInterCompanyTransferEntriesAdd" %>
...
<body>
    <form id="frmInterCompanyTransferAdd" runat="server">
                    ...
                    <tr>
                        ...
                        <td rowspan="2">
                            <span id="spnPickListExpenseAccount">
                                ...
                                <br />
                                <asp:TextBox ID="txtBudgetCode" runat="server" Width="60px" CssClass="input_mandatory"
                                    Enabled="False"></asp:TextBox>
                                <asp:TextBox ID="txtBudgetName" runat="server" Width="160px" CssClass="input_mandatory"
                                    Enabled="False"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:UserControlCurrency ID="ddlCurrencyCode" runat="server" AppendDataBoundItems="true"
                                AutoPostBack="true" CssClass="readonlytextbox" CurrencyList="<%# PhoenixRegistersCurrency.ListCurrency(1)%>"
