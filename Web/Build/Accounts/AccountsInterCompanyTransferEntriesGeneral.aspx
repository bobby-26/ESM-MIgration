<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInterCompanyTransferEntriesGeneral.aspx.cs" Inherits="AccountsInterCompanyTransferEntriesGeneral" %>
...
<head runat="server">
    <title>Inter Company Transfer Entries General</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    <form id="formInterCompanyTransferEntriesGeneral" runat="server">
                ...
                <table cellpadding="2" cellspacing="1" style="width: 100%">
                    <tr>
                        <td colspan="4" align="left">
                            <b><asp:Literal ID="lblEntryToBeTransfer" runat="server" Text="Entry To Be Transfer:"></asp:Literal></b>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:Literal ID="lblTargetCompany" runat="server" Text="Target Company"></asp:Literal></td>
                        <td>
                            <asp:TextBox ID="txtTargetCompany" runat="server" CssClass="readonlytextbox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:UserControlCurrency ID="ddlCurrencyCode" CurrencyList='<%# PhoenixRegistersCurrency.ListCurrency(1)%>'
                                CssClass="readonlytextbox" runat="server" AppendDataBoundItems="true" Enabled="false" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Literal ID="lblContraReferenceNumber" runat="server" Text="Reference Number"></asp:Literal>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            &nbsp;<asp:Literal ID="lblContraLongDescription" runat="server" Text="Long Description"></asp:Literal>
                        </td>
                        <td>
