<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInterCompanyTransferEntriesList.aspx.cs"
    Inherits="AccountsInterCompanyTransferEntriesList" %>
...
<head runat="server">
    <title>Inter Company Entries List</title>
    ...
    <form id="frmInterCompanyTransferList" runat="server">
        ...
        <%-- <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
            <AjaxSettings>
                ...
                <telerik:AjaxSetting AjaxControlID="gvInterCompanyList">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gvInterCompanyList" />
                        <telerik:AjaxUpdatedControl ControlID="ifMoreInfo" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
                ...
                <telerik:AjaxSetting AjaxControlID="MenuInterCompanyList">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="MenuInterCompanyList" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
        ...
        <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
            ...
            <telerik:RadPane ID="listPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvInterCompanyList" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                    ...
                    <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Prime Number">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle HorizontalAlign="Right" Wrap="False" />
                                <ItemTemplate>
