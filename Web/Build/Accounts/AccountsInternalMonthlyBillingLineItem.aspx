<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInternalMonthlyBillingLineItem.aspx.cs"
    Inherits="AccountsInternalMonthlyBillingLineItem" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtPortagebillStartDate" runat="server" CssClass="input" ReadOnly="true" Width="90px"></telerik:RadTextBox>
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblEndDate" runat="server" Text="End Date"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadTextBox ID="txtPortagebillEndDate" runat="server" CssClass="input" ReadOnly="true" Width="90px"></telerik:RadTextBox>
                    </td>
                </tr>
            </table>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvMonthlyBillingCrew" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                EnableViewState="false" EnableHeaderContextMenu="true" Width="100%" GroupingEnabled="false" OnSelectedIndexChanging="gvMonthlyBillingCrew_SelectedIndexChanging"
                OnItemCommand="gvMonthlyBillingCrew_ItemCommand" OnItemDataBound="gvMonthlyBillingCrew_ItemDataBound"
                ShowFooter="false" ShowHeader="true" OnSortCommand="gvMonthlyBillingCrew_SortCommand">
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="S.No">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lblPostedYN" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPOSTEDYN") %>'></telerik:RadLabel>
                            </ItemTemplate>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvMonthlyBillingItem" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                ShowFooter="false" ShowHeader="true" OnSortCommand="gvMonthlyBillingItem_SortCommand">
                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDPORTAGEBILLID">
                    <Columns>
            ...
            <asp:Button ID="ucConfirmDelete" runat="server" Text="Delete" OnClick="ucConfirmDelete_Click" CssClass="hidden" />
