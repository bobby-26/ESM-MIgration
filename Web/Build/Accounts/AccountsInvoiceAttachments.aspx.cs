...
public partial class AccountsInvoiceAttachments : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddButton("Queries", "QUERIES");
    ...
    protected void Invoice_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsInvoiceLineItemDetails.aspx?qinvoicecode=" + ViewState["invoicecode"].ToString());
        }
        ...
        {
            Response.Redirect("../Accounts/AccountsInvoiceHistory.aspx?qinvoicecode=" + ViewState["invoicecode"].ToString() + "&qfrom=" + ViewState["ReceivedFrom"], false);
        }
        if (CommandName.ToUpper().Equals("QUERIES") && ViewState["invoicecode"] != null && ViewState["invoicecode"].ToString() != string.Empty)
        {
            Response.Redirect("../Accounts/AccountsInvoiceQueryMaster.aspx?qinvoicecode=" + ViewState["invoicecode"].ToString() + "&qcallfrom=" + ViewState["ReceivedFrom"], false);
        }
    }
