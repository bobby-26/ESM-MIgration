<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInvoiceAttachmentsRWAForPurchase.aspx.cs"
    Inherits="AccountsInvoiceAttachmentsRWAForPurchase" %>
...
<body>
    <form id="frmInvoice" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlInvoice">
            ...
            <eluc:TabStrip ID="MenuMain" runat="server" OnTabStripCommand="MenuMain_TabStripCommand" Visible="false"></eluc:TabStrip>
