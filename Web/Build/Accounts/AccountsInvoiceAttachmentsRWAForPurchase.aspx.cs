...
public partial class AccountsInvoiceAttachmentsRWAForPurchase : PhoenixBasePage
{
    ...
    protected void Invoice_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsInvoiceLineItemDetailsRWAForPurchase.aspx?qinvoicecode=" + ViewState["invoicecode"] + "&qcallfrom=" + ViewState["ReceivedFrom"]);
        }
        ...
        {
            Response.Redirect("../Accounts/AccountsInvoiceLineItemDetailsRWAForPurchase.aspx?qinvoicecode=" + ViewState["invoicecode"].ToString());
        }
        ...
        {
            Response.Redirect("../Accounts/AccountsInvoiceLineItemDetailsRWAForPurchase.aspx?qinvoicecode=" + ViewState["invoicecode"].ToString() + "&qcallfrom=" + ViewState["ReceivedFrom"]);
        }
        ...
        {
            Response.Redirect("../Accounts/AccountsInvoiceAttachmentsRWAForPurchase.aspx?qinvoicecode=" + ViewState["invoicecode"].ToString() + "&qfrom=" + ViewState["ReceivedFrom"]);
        }
        else if (CommandName.ToUpper().Equals("HISTORY"))
        {
            Response.Redirect("../Accounts/AccountsInvoiceHistoryRWAForPurchase.aspx?qinvoicecode=" + ViewState["invoicecode"].ToString() + "&qfrom=" + ViewState["ReceivedFrom"], false);
        }
    }
