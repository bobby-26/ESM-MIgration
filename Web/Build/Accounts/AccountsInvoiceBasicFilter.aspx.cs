...
public partial class AccountsInvoiceBasicFilter : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Filter.InvRegAdvFilterYN == "Y")
            {
                ckAdvancedYN.Checked = true;
                MyAccordion.SelectedIndex = 0;
                MyAccordion.Enabled = true;
            ...
            imgPIC.Attributes.Add("onclick", "return showPickList('spnPIC', 'codehelp1', '', '../Common/CommonPICAdminUser.aspx', true); ");
            txtUserId.Attributes.Add("style", "visibility:hidden");
            txtEmail.Attributes.Add("style", "visibility:hidden");
            txtUserDesignation.Attributes.Add("style", "visibility:hidden");

            if (ViewState["CALLFROM"].ToString() == "POSTINVOICE")
            {
                ucInvoiceStatus.SelectedHard = "243";
                ucInvoiceStatus.Enabled = false;
            }
        }
    }
    private void BindVesselPurchaserList()
    {
        ...
        ddlPurchaserList.Items.Insert(0, new DropDownListItem("--Select--", "Dummy"));
    }
    ...
    protected void OfficeFilterMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("GO"))
        {
            ...
            criteria.Add("ddlPurchaserList", ddlPurchaserList.SelectedValue);
            criteria.Add("ddlSuptList", ddlSuptList.SelectedValue);
            criteria.Add("ucPIC", txtUserId.Text);
            criteria.Add("chkPortList", "");
    ...
    //}
    protected void chkAdvancedYN_CheckedChanged(object sender, EventArgs e)
    {
        if (ckAdvancedYN.Checked)
        {
            Filter.InvRegAdvFilterYN = "Y";
            MyAccordion.SelectedIndex = 0;
            MyAccordion.Enabled = true;
            AccordionPane4.Enabled = true;
        }
        ...
        {
            Filter.InvRegAdvFilterYN = "N";
            MyAccordion.SelectedIndex = -1;
            MyAccordion.Enabled = false;
