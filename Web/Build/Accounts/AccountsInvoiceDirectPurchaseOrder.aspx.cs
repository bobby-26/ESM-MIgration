    ...
    public void BindData()
    {
        ...
        try
        {
            ...
            DataTable dt = PhoenixAccountsInvoice.InvoiceDirectPurchaseOrderFilterSearch(null
                ...
                , nvc != null ? General.GetNullableInteger(nvc.Get("ddlAccountDetails")) : null
                , nvc != null ? General.GetNullableInteger(nvc.Get("txtBudgetCodeId")) : null
                , nvc != null ? General.GetNullableInteger(nvc.Get("ucBudgetGroup")) : null
                );
