...
public partial class AccountsInvoiceHistory : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsInvoiceHistory.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Accounts/AccountsInvoiceLineItemDetails.aspx?qinvoicecode=" + ViewState["invoicecode"] + "&qcallfrom=" + ViewState["qfrom"].ToString());
            }
            ...
            {
                Response.Redirect("../Accounts/AccountsInvoiceAttachments.aspx?qinvoicecode=" + ViewState["invoicecode"].ToString() + "&qfrom=" + ViewState["qfrom"].ToString());
            }
            if (CommandName.ToUpper().Equals("QUERIES") && ViewState["invoicecode"] != null && ViewState["invoicecode"].ToString() != string.Empty)
            {
                Response.Redirect("../Accounts/AccountsInvoiceQueryMaster.aspx?qinvoicecode=" + ViewState["invoicecode"] + "&qcallfrom=" + ViewState["qfrom"].ToString(), false);
            }
            else
                MenuOrderFormMain.SelectedMenuIndex = 4;
        }
