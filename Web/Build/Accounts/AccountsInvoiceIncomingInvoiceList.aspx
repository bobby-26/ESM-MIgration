<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInvoiceIncomingInvoiceList.aspx.cs"
    Inherits="AccountsInvoiceIncomingInvoiceList" MaintainScrollPositionOnPostback="true" %>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Dispatch Date" AllowSorting="true">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="lblDespatchdate" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDATEOFDISPATCH") %>'></asp:Label>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Received Date" AllowSorting="true">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="lblReceiveDate" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDRECEIVEDATE") %>'></asp:Label>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Invoice List" AllowSorting="true">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="lblInvoiceList" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDINVOICECODELIST") %>'></asp:Label>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Originating Company code" AllowSorting="true">
                            <HeaderStyle Width="35%" />
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <asp:Label ID="lblOriginatingcompany" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDORIGINATIONGCOMPANYCODE") %>'></asp:Label>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
