<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInvoiceLineItem.aspx.cs"
    Inherits="AccountsInvoiceLineItem" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmInvoice" runat="server">
        ...
        <eluc:TabStrip ID="TitleTab" runat="server"></eluc:TabStrip>
        ...
        <table cellpadding="1" cellspacing="1" style="width: 100%">
            <tr>
                ...
                <td>
                    <eluc:Hard runat="server" ID="ucStoreType" CssClass="input" AutoPostBack="true" AppendDataBoundItems="true"
                        HardTypeCode="97" />
                </td>
                <td>
        ...
        <br />
        <telerik:RadGrid RenderMode="Lightweight" ID="gvInvoice" Height="50%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            CellSpacing="0" GridLines="None" OnItemCommand="gvInvoice_ItemCommand" OnNeedDataSource="gvInvoice_NeedDataSource"
