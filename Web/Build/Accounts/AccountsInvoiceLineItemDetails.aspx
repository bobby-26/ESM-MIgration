<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInvoiceLineItemDetails.aspx.cs"
    Inherits="AccountsInvoiceLineItemDetails" %>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="PO Committed" AllowSorting="true">
                            <HeaderStyle Width="83px" HorizontalAlign="Right" />
                        ...
                        <telerik:GridTemplateColumn HeaderText="Invoice Payable Amount:  PO Payable Amount. " AllowSorting="true">
                            <HeaderStyle Width="99px" HorizontalAlign="Right" />
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <HeaderTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="GST On PO Payable" AllowSorting="true">
                            <HeaderStyle Width="65px" HorizontalAlign="Right" />
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Total Discount Amount" AllowSorting="true">
                            <HeaderStyle Width="66px" HorizontalAlign="Right" />
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" AllowSorting="true">
                            <HeaderStyle HorizontalAlign="Center" Width="299px" VerticalAlign="Middle"></HeaderStyle>
                            ...
                            <ItemTemplate>
                                ...
                                ID="cmdshippedquantity" Visible="false" ToolTip="Shipped Quantity"></asp:ImageButton>
