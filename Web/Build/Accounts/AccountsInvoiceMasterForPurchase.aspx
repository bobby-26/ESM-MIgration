<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInvoiceMasterForPurchase.aspx.cs"
    Inherits="AccountsInvoiceMasterForPurchase" %>
            ...
            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
                ...
                <telerik:RadPane ID="RadPane1" runat="server" Scrolling="None">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvInvoice" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        OnRowDeleting="gvFormDetails_RowDeleting" AllowPaging="true" AllowCustomPaging="true" Height="90%" OnPageIndexChanged="gvInvoice_PageIndexChanged"
                        ...
                        OnSortCommand="gvInvoice_Sorting" OnSelectedIndexChanging="gvInvoice_SelectedIndexChanging">
