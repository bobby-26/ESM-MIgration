                    ...
                    <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderStyle-Width="50px">
                                ...
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblPOpayableisorginal" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPOPAYABLEISORIGINALPOAMOUNT") %>'></telerik:RadLabel>
                                    <asp:ImageButton runat="server" AlternateText="MatchingwithOriginalPOIssued" ImageUrl="<%$ PhoenixTheme:images/alert.png %>"
                                        CommandName="MATCHINGWITHPO" Visible="false" CommandArgument='<%# Container.DataItem %>'
                                        ID="cmdMachingwithorginalpo" ToolTip="Matching with Original PO Issued"></asp:ImageButton>
                                    <asp:ImageButton runat="server" AlternateText="shippedqty" ImageUrl="<%$ PhoenixTheme:images/cargo-ship.png %>"
                                        CommandName="SHIPPEDQTY" Visible="false" CommandArgument='<%# Container.DataItem %>'
                                        ID="cmdshippedqty" ToolTip="Shipped Qty based Clearance"></asp:ImageButton>
                            ...
                            <telerik:GridTemplateColumn HeaderText="PO Number">
                                ...
                                <ItemTemplate>
                                    ...
                                    <telerik:RadLabel ID="lblshippeddate" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSHIPPEDDATE") %>'></telerik:RadLabel>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Invoice Amount (USD)">
                                <HeaderStyle HorizontalAlign="Right" />
                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblInvoiceAmountusd" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDINVOICEAMOUNTINUSD","{0:n2}") %>'></telerik:RadLabel>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Last Approver Name">
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lbllastapprovarname" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDLASTAPPROVARNAME") %>'></telerik:RadLabel>
                                    <telerik:RadLabel ID="lblrejectedyn" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREJECTEDYN") %>'></telerik:RadLabel>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>

                            <telerik:GridTemplateColumn HeaderText="PIC Name">
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblPICname" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPOPICNAME") %>'></telerik:RadLabel>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Action">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:ImageButton runat="server" AlternateText="Approval History" ImageUrl="<%$ PhoenixTheme:images/approve.png %>"
                                        CommandName="REAPPROVALREMARKS" CommandArgument='<%# Container.DataItem %>'
                                        ID="cmdreapprovalremarks" Visible="false" ToolTip="Re-approve PO"></asp:ImageButton>
                                    ...
                                    <asp:HyperLink ID="lnkInvoiceattachment" Target="_blank" Text="Invoice" runat="server"
                                        ImageUrl="<%$ PhoenixTheme:images/attachment.png%>" Visible="true" ToolTip="Invoice">
                                    </asp:HyperLink>
                                    <img id="Img3" runat="server" alt="" src="<%$ PhoenixTheme:images/spacer.png%>" width="3" />
                                    <asp:ImageButton runat="server" AlternateText="Approval History" ImageUrl="<%$ PhoenixTheme:images/te_del.png %>"
                                        CommandName="REJECTREMARKS" CommandArgument='<%# Container.DataItem %>'
                                        ID="cmdapprovalhistoryremarks" ToolTip="Reject Remarks"></asp:ImageButton>
