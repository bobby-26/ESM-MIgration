...
public partial class AccountsInvoiceOutgoingInvoiceList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Accounts/AccountsInvoiceOutgoingInvoiceList.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("javascript:CallPrint('gvCompany')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageButton("../Accounts/AccountsInvoiceOutgoingInvoiceList.aspx", "Find", "search.png", "FIND");
            toolbar.AddImageLink("javascript:openNewWindow('codehelp1','','" + Session["sitepath"] + "/Accounts/AccountsInvoiceOutgoingInvoice.aspx')", "Add", "add.png", "ADDDISPATCH");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDAIRWAYBILLNUMBER", "FLDDATEOFDISPATCH", "FLDINVOICECODELIST", "FLDEARMARKCOMPANYCODE" };
        string[] alCaptions = { "Airway Bill number", "Dispatch date", "Invoice List", "Earmark Company code" };
    ...
    protected void dgDispatch_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridEditableItem)
        {
            if (!e.Equals(DataControlRowState.Alternate | DataControlRowState.Edit) && !e.Equals(DataControlRowState.Edit))
            {
                ...
                lb.Attributes.Add("onclick", "Openpopup('codehelp1', '', '../Accounts/AccountsInvoiceOutgoingInvoice.aspx?qEarmarkId=" + l.Text + "');return false;");

                ImageButton db1 = (ImageButton)e.Item.FindControl("cmdEdit");
                db1.Attributes.Add("onclick", "Openpopup('codehelp1', '', '../Accounts/AccountsInvoiceOutgoingInvoice.aspx?qEarmarkId=" + l.Text + "');return false;");
