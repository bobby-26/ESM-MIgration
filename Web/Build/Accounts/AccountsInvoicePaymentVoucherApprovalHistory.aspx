<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsInvoicePaymentVoucherApprovalHistory.aspx.cs" Inherits="AccountsInvoicePaymentVoucherApprovalHistory" %>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Date">
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container, "DataItem.FLDAPPROVEDDATE", "{0:dd/MMM/yyyy HH:mm:ss}")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
