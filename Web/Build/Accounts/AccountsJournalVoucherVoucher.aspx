<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsJournalVoucherVoucher.aspx.cs"
    Inherits="AccountsJournalVoucherVoucher" EnableEventValidation="true" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="1" cellspacing="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtVoucherType" Text="Journal Voucher" CssClass="readonlytextbox"
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:Quick ID="ucSubType" runat="server" CssClass="input" AppendDataBoundItems="true" />
                        </td>
