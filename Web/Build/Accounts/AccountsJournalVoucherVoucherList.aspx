<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsJournalVoucherVoucherList.aspx.cs"
    Inherits="AccountsJournalVoucherVoucherList" %>
                            ...
                            <asp:TemplateField HeaderText="Locked YN">
                                ...
                                <HeaderTemplate>
                                    <asp:Label ID="lblCurrencyHeader" runat="server">
                                     <asp:Literal ID="lblLockedYN" runat="server" Text="Locked YN"></asp:Literal>
                                    </asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
