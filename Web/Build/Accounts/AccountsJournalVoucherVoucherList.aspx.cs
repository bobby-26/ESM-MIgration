...
public partial class AccountsJournalVoucherVoucherList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbargrid.AddImageButton("../Accounts/AccountsJournalVoucherVoucherList.aspx", "Export to Excel", "icon_xls.png", "Excel");
        toolbargrid.AddImageLink("javascript:CallPrint('gvVoucher')", "Print Grid", "icon_print.png", "PRINT");
        toolbargrid.AddImageLink("../Accounts/AccountsJournalVoucherVoucherList.aspx", "Find", "search.png", "FIND");
    ...
    protected void VoucherNavItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsJournalVoucherVoucher.aspx");
        }
    }
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixAccountsVoucher.VoucherSearch(   PhoenixSecurityContext.CurrentSecurityContext.CompanyID,76
    ...
    protected void VoucherClick(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("../Accounts/AccountsJournalVoucherVoucher.aspx?VOUCHERID=" + ViewState["VOUCHERCODE"].ToString());
    }
