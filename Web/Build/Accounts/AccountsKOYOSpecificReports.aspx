<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsKOYOSpecificReports.aspx.cs"
    Inherits="Accounts_AccountsKOYOSpecificReports" %>
...
<body>
    <form id="frmOwnersAccounts" runat="server" autocomplete="off">
         <telerik:RadScriptManager runat="server" ID="RadScriptManager1">
           ...
           <%--     <eluc:Title runat="server" ID="frmTitle" Text="KOYO Specific Reports" ShowMenu="false"></eluc:Title>--%>
