...
public partial class Accounts_AccountsKOYOSpecificReports : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbarowneraccounts.AddImageButton("../Accounts/AccountsKOYOSpecificReports.aspx", "Find", "search.png", "FIND");
