...
public partial class AccountsLeaveBalance : PhoenixBasePage
{    
    ...
    private void BindData()
    {
        try
        {
            ...
            DataTable dt = PhoenixAccountsLeave.SearchLeaveBalance(null,null,null
    ...
    protected void gvLVP_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
           ...
           else if (e.CommandName.ToUpper().Equals("SELECT"))
            {
                ...
                Script += "parent.document.getElementById('txtHidden').value='" + empid + "';";
                Script += "parent.document.getElementById('cmdHiddenSubmit').click();";
                Script += "</script>" + "\n";
