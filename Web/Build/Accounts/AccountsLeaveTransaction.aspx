<%@ Page Language="C#" AutoEventWireup="True" CodeFile="AccountsLeaveTransaction.aspx.cs"
    Inherits="AccountsLeaveTransaction" %>
...
<head id="Head1" runat="server">
    <title>Leave Transaction History</title>
...
<body>
    ...
    <form id="frmLeaveTrans" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvLVP" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                ShowFooter="false" ShowHeader="true" OnItemCommand="gvLVP_ItemCommand">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Contract<br/> Commence Date">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Leave Type">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container, "DataItem.FLDLEAVETYPE").ToString() == "1" ? "Leave Senior"
                                        : (DataBinder.Eval(Container, "DataItem.FLDLEAVETYPE").ToString() == "2" ? "Leave Junior" : "BTB") %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Transaction Date">
                            <HeaderStyle Width="150px" />
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <%# string.Format("{0:dd/MMM/yyyy}", DataBinder.Eval(Container, "DataItem.FLDTRANSACTIONDATE"))%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Transaction Type">
