...
public partial class AccountsOffSettingContraVocLineDetailsSubAccount : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsOffSettingContraVocLineDetailsSubAccount.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void MenuLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Accounts/AccountsOffSettingContraVocMasterSubAccount.aspx?voucherid=" + ViewState["contravoucherid"] + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"] + "&contravoucherid=" + ViewState["contravoucherid"]);
            }
            if (CommandName.ToUpper().Equals("OFFSETTINGENTRIES"))
            {
                Response.Redirect("../Accounts/AccountsOffSettingEntriesListSubAccount.aspx?voucherid=" + ViewState["contravoucherid"] + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"]);
            }
    ...
    private void BindData()
    {
        ...
        {           
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    ViewState["PAGEURL"] = "../Accounts/AccountsOffSettingContraVocLineSubAccount.aspx?offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"]+"&qvouchercode=";
                }
                {
                    if (ViewState["voucherlineitemcode"] != null)
                    {
    ...
    //    ImageButton imgbtn = (ImageButton)sender;
    //    int rownumber = int.Parse(imgbtn.CommandArgument);
    //    RadTextBox tb1 = (RadTextBox)gvLineItem.Rows[rownumber].FindControl("txtAccountCode");
    //    Session["sOffsetAccountCode"] = tb1.Text;
    //}
