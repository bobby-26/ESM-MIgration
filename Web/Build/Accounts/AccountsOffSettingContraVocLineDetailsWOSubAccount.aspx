<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingContraVocLineDetailsWOSubAccount.aspx.cs" Inherits="AccountsOffSettingContraVocLineDetailsWOSubAccount" %>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Account Code">
                                ...
                                <EditItemTemplate>
                                    <span id="spnPickListCompanyAccountEdit">
                                        <telerik:RadLabel ID="txtAccountCode" runat="server" CssClass="input_mandatory" Text='<%# DataBinder.Eval(Container,"DataItem.FLDACCOUNTCODE") %>'
                                            MaxLength="20" Width="80px"></telerik:RadLabel>
                                        <telerik:RadLabel ID="txtAccountDescription" runat="server" CssClass="input_mandatory"
                                            Enabled="False" MaxLength="50" Width="10px"></telerik:RadLabel>
