<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingContraVocLineWOSubAccount.aspx.cs" Inherits="AccountsOffSettingContraVocLineWOSubAccount" %>
...
<body>
    <form id="frmInvoice" runat="server">
       ...
       <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" Height="90%">
                ...
                <eluc:Status runat="server" ID="ucStatus" />
                    ...
                    <table cellpadding="2" cellspacing="1" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <eluc:Number ID="txtPrimeAmoutEdit" runat="server"  Width="120px"></eluc:Number>
                               <%-- <asp:TextBox ID="txtPrimeAmoutEdit" runat="server" CssClass="input_mandatory txtNumber"
                                ...
                                <telerik:RadLabel ID="lblAmountSign" runat="server" Visible="false"></telerik:RadLabel>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                 <eluc:Number ID="txtExchangeRate" runat="server"  Width="120px"></eluc:Number>
                            ...
                            <td>
                                  <eluc:Number ID="txt2ndExchangeRate" runat="server"  Width="120px"></eluc:Number>
