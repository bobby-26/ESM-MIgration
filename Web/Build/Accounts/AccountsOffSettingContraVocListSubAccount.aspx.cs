...
public partial class AccountsOffSettingContraVocListSubAccount : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbargrid.AddImageButton("../Accounts/AccountsOffSettingContraVocListSubAccount.aspx", "Export to Excel", "icon_xls.png", "Excel");
        toolbargrid.AddImageLink("javascript:CallPrint('gvContraVoucherList')", "Print Grid", "icon_print.png", "PRINT");
        toolbargrid.AddImageLink("../Accounts/AccountsOffSettingContraVocListSubAccount.aspx", "Add", "add.png", "ADD");
    ...
    protected void MenuContraVoucherList_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            ClientScript.RegisterStartupScript(GetType(), "Load", "<script type='text/javascript'>window.parent.location.href = '../Accounts/AccountsOffSettingContraVocMasterSubAccount.aspx?" + "offsettinglineitemid=" + ViewState["offsettinglineitemid"] + "&contravoucherid=" + ViewState["voucherid"] + "';  </script>");
            BindData();
        }       
    }
