<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingContraVocListWOSubAccount.aspx.cs" Inherits="AccountsOffSettingContraVocListWOSubAccount" %>
         ...
         <telerik:RadScriptManager runat="server" ID="RadScriptManager1">
             ...
             <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" Height="100%">
               ...
               <telerik:RadGrid RenderMode="Lightweight" ID="gvContraVoucherList" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                EnableViewState="false" EnableHeaderContextMenu="true" Width="100%" Height="93%" OnDeleteCommand="gvContraVoucherList_DeleteCommand"
                OnItemDataBound="gvContraVoucherList_ItemDataBound" OnItemCommand="gvContraVoucherList_ItemCommand"  OnSelectedIndexChanging="gvContraVoucherList_SelectedIndexChanging"
                ShowFooter="false" ShowHeader="true" OnSortCommand="gvContraVoucherList_SortCommand">
                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDCONTRAVOUCHERID,FLDVOUCHERID" >
