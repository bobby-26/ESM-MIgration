<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingContraVocMasterSubAccount.aspx.cs" Inherits="AccountsOffSettingContraVocMasterSubAccount" %>
    ...
    <form id="frmPurchaseForm" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel" runat="server"></telerik:RadAjaxLoadingPanel>
            ...
            <telerik:RadPane ID="generalPane" runat="server" Scrolling="None">
                <iframe runat="server" id="ifMoreInfo" scrolling="no" style="min-height: 400px; width: 100%">
                </iframe>
              </telerik:RadPane>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvFormDetails" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                EnableViewState="false" EnableHeaderContextMenu="true" Width="100%" Height="100%" OnSelectedIndexChanging="gvFormDetails_SelectedIndexChanging"
