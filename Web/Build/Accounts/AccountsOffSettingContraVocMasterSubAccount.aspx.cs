...
public partial class AccountsOffSettingContraVocMasterSubAccount : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsOffSettingContraVocMasterSubAccount.aspx", "Export to Excel", "icon_xls.png", "Excel");
         ...
         //   MenuOrderForm.SetTrigger(pnlOrderForm);
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["voucherid"] != null)
                {
                    ...
                    ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVocSubAccount.aspx?voucherid=" + ViewState["voucherid"] + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"]+ "&offsetisposted=" + ViewState["offsetisposted"];
                }
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Accounts/AccountsOffSettingEntriesListSubAccount.aspx?voucherid=" + ViewState["voucherid"] + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"], false);
            }  
            ...
            {
                Response.Redirect("../Accounts/AccountsOffSettingContraVocLineDetailsSubAccount.aspx?qvouchercode=" + ViewState["voucherid"] + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"] + "&offsetisposted=" + ViewState["offsetisposted"] + "&contravoucherid=" + ViewState["contravoucherid"], false);
            }              
            else
                MenuOrderFormMain.SelectedMenuIndex = 1;
        }
    ...
    private void BindData()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVocSubAccount.aspx?voucherid=" + ViewState["voucherid"].ToString() + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"] + "&offsetisposted=" + ViewState["offsetisposted"];
            }                       
        }
        else
        {
            if (ViewState["PAGEURL"] == null)
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVocSubAccount.aspx?offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"] + "&offsetisposted=" + ViewState["offsetisposted"] + "&voucherid=";
            }
