...
public partial class AccountsOffSettingContraVocMasterWOSubAccount : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsOffSettingContraVocMasterWOSubAccount.aspx", "Export to Excel", "icon_xls.png", "Excel");
          ...
          //  MenuOrderFormMain.SetTrigger(pnlOrderForm);
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["voucherid"] != null)
                {
                    ...
                    ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVocListWOSubAccount.aspx?voucherid=" + ViewState["voucherid"] + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"]+ "&offsetisposted=" + ViewState["offsetisposted"];
                }
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Accounts/AccountsOffSettingEntriesListWOSubAccount.aspx?voucherid=" + ViewState["voucherid"] + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"], false);
            }  
            if (CommandName.ToUpper().Equals("VOUCHER"))
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVocWOSubAccount.aspx?voucherid=" + ViewState["voucherid"] + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"] + "&offsetisposted=" + ViewState["offsetisposted"];
            }
            if (CommandName.ToUpper().Equals("LINEITEMS") && ViewState["voucherid"] != null && ViewState["voucherid"].ToString() != string.Empty)
            {
                Response.Redirect("../Accounts/AccountsOffSettingContraVocLineDetailsWOSubAccount.aspx?qvouchercode=" + ViewState["voucherid"] + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"] + "&offsetisposted=" + ViewState["offsetisposted"] + "&contravoucherid=" + ViewState["contravoucherid"], false);
            }              
            else
                MenuOrderFormMain.SelectedMenuIndex = 1;
        }
    ...
    private void BindData()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
           ...
           // BindPageURL(gvFormDetails.SelectedIndex);
            ...
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVocWOSubAccount.aspx?voucherid=" + ViewState["voucherid"].ToString() + "&offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"] + "&offsetisposted=" + ViewState["offsetisposted"];
            }                       
        }
        else
        {
            if (ViewState["PAGEURL"] == null)
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVocWOSubAccount.aspx?offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"] + "&offsetisposted=" + ViewState["offsetisposted"] + "&voucherid=";
            }
    ...
    //    ViewState["voucherid"] = ((LinkButton)gvFormDetails.Rows[e.NewSelectedIndex].FindControl("lnkVoucherId")).CommandArgument;
