...
public partial class AccountsOffSettingContraVocSubAccount : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            posted = int.Parse(ViewState["offsetisposted"] != null ? ViewState["offsetisposted"].ToString() : "0");
