<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingContraVocWOSubAccount.aspx.cs" Inherits="AccountsOffSettingContraVocWOSubAccount" %>
                    ...
                    <eluc:Status runat="server" ID="ucStatus" />
                        ...
                        <table cellpadding="1" cellspacing="1" style="width: 100%">
                            ...
                            <tr>
                                <td>
                                    <b>
                                        <telerik:RadLabel ID="lblEntryToBeOffset" runat="server" Text="Entry To Be Off-set:"></telerik:RadLabel></b>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
