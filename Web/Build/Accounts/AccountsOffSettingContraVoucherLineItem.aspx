<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingContraVoucherLineItem.aspx.cs" Inherits="AccountsOffSettingContraVoucherLineItem" %>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div>
                    <table cellpadding="2" cellspacing="1" style="width: 100%">
                        ...
                        <tr>
                            <td>
                                <asp:Literal ID="lblChequeRemittanceNo" runat="server" Text="Cheque/Remittance No"></asp:Literal>
                            </td>
                            <td>
                                <asp:TextBox ID="txtChequeno" runat="server" CssClass="input" MaxLength="100" Width="150px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <asp:Label ID="lblAmountSign" runat="server" Visible="false"></asp:Label>   
                            </td>
                        </tr>
                        <tr>
                            <td>
