<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingContraVoucherMaster.aspx.cs" Inherits="AccountsOffSettingContraVoucherMaster" %>
       ...
       <telerik:RadScriptManager runat="server" ID="RadScriptManager1">
        ...
        <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel" runat="server"></telerik:RadAjaxLoadingPanel>
           ...
           <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
            ...
            <iframe runat="server" id="ifMoreInfo" scrolling="no" style="min-height: 400px; width: 100%"></iframe>
           </telerik:RadPane>
