...
public partial class AccountsOffSettingContraVouchersList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbargrid.AddImageButton("../Accounts/AccountsOffSettingContraVouchersList.aspx", "Export to Excel", "icon_xls.png", "Excel");
        toolbargrid.AddImageLink("javascript:CallPrint('gvContraVoucherList')", "Print Grid", "icon_print.png", "PRINT");
        toolbargrid.AddImageLink("../Accounts/AccountsOffSettingContraVouchersList.aspx", "Add", "add.png", "ADD");
    ...
    protected void MenuContraVoucherList_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            ClientScript.RegisterStartupScript(GetType(), "Load", "<script type='text/javascript'>window.parent.location.href = '../Accounts/AccountsOffSettingContraVoucherMaster.aspx?" + "offsettinglineitemid=" + ViewState["offsettinglineitemid"] + "&contravoucherid=" + ViewState["voucherid"] + "';  </script>");
    ...
    protected void gvContraVoucherList_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            if (!e.Equals(DataControlRowState.Alternate | DataControlRowState.Edit) && !e.Equals(DataControlRowState.Edit))
            {
                ...
                RadLabel lblIsPosted = (RadLabel)e.Item.FindControl("lblIsPosted");
                //lnkVoucherId.Attributes.Add("onclick", "parent.Openpopup('codehelp1', '', 'AccountsOffSettingContraVoucherDetails.aspx?voucherid=" + lnkVoucherId.CommandArgument + "');return false;");
                ...
                cmdEdit.Attributes.Add("onclick", "parent.Openpopup('codehelp1', '', 'AccountsOffSettingContraVoucher.aspx?voucherid=" + lnkVoucherId.CommandArgument + "&offsettinglineitemid=" + ViewState["offsettinglineitemid"] + "&callfrom=OFFSET" + "&offsetisposted=" +posted+ "');return false;");               
            }
    ...
    //protected void gvContraVoucherList_OnRowDeleting(object sender, GridViewDeleteEventArgs e)
    //{
    //    try
    //    {
