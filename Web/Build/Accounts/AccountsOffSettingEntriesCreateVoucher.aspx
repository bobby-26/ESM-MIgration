<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingEntriesCreateVoucher.aspx.cs"
    Inherits="AccountsOffSettingEntriesCreateVoucher" %>
...
<head id="Head1" runat="server">
    <title>Create Voucher</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    <form id="frmCreateVoucher" runat="server">
