...
public partial class AccountsOffSettingEntriesCreateVoucher : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddImageButton("../Accounts/AccountsOffSettingEntriesCreateVoucher.aspx", "Export to Excel", "icon_xls.png", "Excel");
        toolbar.AddImageLink("javascript:CallPrint('gvCreateVoucher')", "Print Grid", "icon_print.png", "PRINT");
        //toolbar.AddImageButton("../Accounts/AccountsOffSettingEntriesCreateVoucher.aspx", "Find", "search.png", "FIND");
        toolbar.AddImageLink("../Accounts/AccountsOffSettingEntriesCreateVoucher.aspx", "Add", "add.png", "ADD");
        MenuCreateVoucher.AccessRights = this.ViewState;
        MenuCreateVoucher.MenuList = toolbar.Show();

        PhoenixToolbar toolbarmain = new PhoenixToolbar();
        toolbarmain.AddButton("Off-Setting Entries", "OFFSETTING");
    ...
    private void BindData()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingEntriesGeneral.aspx?VOUCHERLINEITEMID=" + ViewState["VOUCHERLINEITEMID"].ToString() + "&TotalVoucherAmount=" + ViewState["totalamount"].ToString();
        ...
        else
        {
            DataTable dt = ds.Tables[0];
            ShowNoRecordsFound(dt, gvCreateVoucher);
            ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingEntriesGeneral.aspx";
        }
        General.SetPrintOptions("gvCreateVoucher", "Off-Setting Contra Voucher Line Items", alCaptions, alColumns, Session["printDs"] != null ? (DataSet)Session["printDs"] : ds);
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDVOUCHERLINEITEMNO", "FLDACCOUNTCODE", "FLDACCOUNTDESCRIPTION", "FLDBUDGETCODE", "FLDCURRENCYNAME", "FLDAMOUNT"
                                 , "FLDBASEEXCHANGERATE", "FLDREPORTEXCHANGERATE", "FLDLONGDESCRIPTION" };
    ...
    protected void MenuCreateVoucher_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsOffSettingEntriesAdd.aspx?VOUCHERLINEITEMID=" + ViewState["VOUCHERLINEITEMID"].ToString() + "&VoucherID=" + ViewState["VoucherID"] + "&CurrencyId=" + ViewState["CurrencyID"] + "&BaseRate=" + ViewState["BaseRate"] + "&ReportRate=" + ViewState["ReportRate"] + "&CurrencyName=" + ViewState["CurrencyName"]);
            BindData();            
        }
    }
    protected void MenuCreateVoucherGeneral_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //else
            //{
            //    Response.Redirect("../Accounts/AccountsOffSettingEntriesList.aspx");
            //}
