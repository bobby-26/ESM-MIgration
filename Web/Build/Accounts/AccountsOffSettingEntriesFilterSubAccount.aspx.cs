...
public partial class AccountsOffSettingEntriesFilterSubAccount : PhoenixBasePage
{    
    ...
    protected void OfficeFilterMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("GO"))
        {
            ...
            Response.Redirect("../Accounts/AccountsOffSettingEntriesListSubAccount.aspx", false);
        }
