<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingEntriesFilterWOSubAccount.aspx.cs" Inherits="AccountsOffSettingEntriesFilterWOSubAccount" %>
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           <%-- <asp:TextBox ID="txtAmountFrom" runat="server" CssClass="input" Width="100px"></asp:TextBox>
                        ...
                        <td>
                           ...
                           <%-- <asp:TextBox ID="txtAmountTo" runat="server" CssClass="input" Width="100px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <div id="dvCurrencyList" runat="server" class="input" style="overflow: auto; width: 40%;
                                height: 100px">
                        ...
                        <td>
                            <div id="dvUsersList" runat="server" class="input" style="overflow: auto; width: 62%;
                                height: 100px">
                    ...
                    <tr>
                        ...
                        <td>
                            <%-- <div id="dvCurrencyList" runat="server" class="input" style="overflow: auto; width: 70%;
                                height: 100px">
                                <asp:CheckBoxList ID="chkCurrencyList" runat="server" Height="100%" RepeatColumns="1"
                                    RepeatDirection="Horizontal" RepeatLayout="Flow">
                                </asp:CheckBoxList>
