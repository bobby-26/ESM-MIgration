<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingEntriesList.aspx.cs"
    Inherits="AccountsOffSettingEntriesList" %>
                    ...
                    <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Account" AllowSorting="true" SortExpression="FLDACCOUNTCODE">
                                ...
                                <%-- <HeaderTemplate>
                                        <asp:LinkButton ID="lnkAccount" runat="server" CommandName="Sort" CommandArgument="FLDACCOUNTCODE"
                            ...
                            <telerik:GridTemplateColumn HeaderText="Prime Amount" AllowSorting="true" SortExpression="FLDAMOUNT">
                                ...
                                <%--<HeaderTemplate>
                                        <asp:LinkButton ID="lnkAmount" runat="server" CommandName="Sort" CommandArgument="FLDAMOUNT"
                                            ForeColor="White">Prime Amount&nbsp;</asp:LinkButton>
