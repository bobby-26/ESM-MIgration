...
public partial class AccountsOffSettingEntriesList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Accounts/AccountsOffSettingEntriesList.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("javascript:CallPrint('gvOffSettingList')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageButton("../Accounts/AccountsOffSettingEntriesFilter.aspx", "Find", "search.png", "FIND");           
          ...
          //  MenuOffSettingList.SetTrigger(pnlOffSettingList);
            ...
            {                                
                ...
                {
                    ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVouchersList.aspx?offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"];
                }
    ...
    protected void ShowExcel()
    {
        ...
        {            
            ds = PhoenixAccountsOffSettingEntries.OffSettingVoucherSearch(
    ...
    private void BindData()
    {
        ...
        else
        {
            if (ViewState["PAGEURL"] == null)
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVouchersList.aspx?offsettinglineitemid=";
            }
