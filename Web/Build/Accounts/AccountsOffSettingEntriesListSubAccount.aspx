<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOffSettingEntriesListSubAccount.aspx.cs" Inherits="AccountsOffSettingEntriesListSubAccount" %>
        ...
        <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
            ...
            <telerik:RadPane ID="listPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvOffSettingList" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                    ...
                    EnableViewState="false" EnableHeaderContextMenu="true" Width="100%" Height="88%"
                    OnItemCommand="gvOffSettingList_ItemCommand" OnSelectedIndexChanging="gvOffSettingList_SelectedIndexChanging"
                    ...
                    <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Voucher Number">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkVoucherNo" runat="server" CommandName="Select" Text='<%# DataBinder.Eval(Container,"DataItem.FLDVOUCHERNUMBER") %>'></asp:LinkButton>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Account" AllowSorting="true" SortExpression="FLDDESCRIPTION">
                                <%--<HeaderTemplate>
                                        <asp:LinkButton ID="lnkAccount" runat="server" CommandName="Sort" CommandArgument="FLDDESCRIPTION"
                                            ForeColor="White">Account&nbsp;</asp:LinkButton>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Sub Account">
                                ...
                                <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblSubAccountCode" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDBUDGETCODE") %>'></telerik:RadLabel>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
