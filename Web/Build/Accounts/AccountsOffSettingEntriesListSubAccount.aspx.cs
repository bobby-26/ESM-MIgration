...
public partial class AccountsOffSettingEntriesListSubAccount : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Accounts/AccountsOffSettingEntriesListSubAccount.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("javascript:CallPrint('gvOffSettingList')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageButton("../Accounts/AccountsOffSettingEntriesFilterSubAccount.aspx", "Find", "search.png", "FIND");           
          ...
          //  MenuOffSettingList.SetTrigger(pnlOffSettingList);
            ...
            {                                
                ...
                {
                    ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVocListSubAccount.aspx?offsettinglineitemid=" + ViewState["OFFSETTINGLINEITEMID"];
                }                                             
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDVOUCHERNUMBER", "FLDVOUCHERLINEITEMNO", "FLDDESCRIPTION","FLDBUDGETCODE", "FLDREFERENCEDOCUMENTNO", "FLDCURRENCYNAME", "FLDTRANSACTIONAMOUNT"
                                 , "FLDPREVIOUSVOUCHERAMOUNT", "FLDBALANCEAMOUNT", "FLDOFFSETVOUCHERSTATUS", "FLDCREATEDBYUSERNAME", "FLDLONGDESCRIPTION"};

        string[] alCaptions = { "Voucher Number","Voucher LineItemNo", "Account","Sub Account", "Reference Document No", "Currency Name", "Prime Amount", "Allocated Voucher Amount"
        ...
        {            
            ds = PhoenixAccountsOffSettingEntries.OffSettingVoucherSearchWithSubAccount(
    ...
    private void BindData()
    {
        ...
        else
        {
            if (ViewState["PAGEURL"] == null)
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOffSettingContraVocListSubAccount.aspx?offsettinglineitemid=";
            }
    ...
    protected void gvOffSettingList_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        gvOffSettingList.SelectedIndexes.Add(e.NewSelectedIndex);
