<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOfficeDebitCreditNoteGenerateRegister.aspx.cs" Inherits="AccountsOfficeDebitCreditNoteGenerateRegister" %>
...
<body>
    <form id="frmDebitCreditNote" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="99%">
            ...
            <eluc:Title runat="server" ID="ucTitle" Text="Office Fund Request" ShowMenu="false" Visible="false"></eluc:Title>
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Voucher No." HeaderStyle-Width="5%">
                         ...
                         <telerik:GridTemplateColumn HeaderText="Project Code" HeaderStyle-Width="5%">
                            <ItemTemplate>
