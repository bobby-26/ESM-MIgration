...
public partial class AccountsOfficeDebitCreditNoteGenerateRegister : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsOfficeDebitCreditNoteGenerateRegister.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvDebitCreditNote')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Accounts/AccountsOfficeDebitCreditNoteGenerateSearch.aspx", "Find", "search.png", "FIND");
            toolbargrid.AddImageLink("javascript:openNewWindow('codehelp1','','" + Session["sitepath"] + "/Accounts/AccountsOfficeDebitCreditNoteGenerate.aspx?OfficeDebitCreditNoteId=')", "Add", "add.png", "ADD");
    ...
    protected void gvDebitCreditNote_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridEditableItem)
        {
            ...
            if (cmdEditopen != null)
            {
                cmdEditopen.Attributes.Add("onclick", "openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Accounts/AccountsOfficeDebitCreditNoteGenerate.aspx?OfficeDebitCreditNoteId=" + lblDebitCreditNoteId.Text + "'); return true;");
            }
    ...
    private void BindData()
    {
        try
        {
            ...
            string[] alColumns = { "FLDSUBJECT", "FLDDATE", "FLDREFERENCENUMBER", "FLDSHORTCODE", "FLDTYPENAME", "FLDBANKDESCRIPTION", "FLDLINEITEM", "FLDCURRENCYCODE", "FLDAMOUNT", "FLDRECEIVEDAMOUNT", "FLDDIFFERENCE", "FLDRECEIVEDDATE", "FLDRECEIVEDSTATUSNAME", "FLDREMARKS", "FLDOPENCLOSE", "FLDVOUCHERNUMBER", "FLDATTACHMENT" , "FLDPROJECTCODE" };
            string[] alCaptions = { "Subject", "Date", "Reference No.", "Billing Company", "Type", "Bank Receiving Funds", "	Line Item", "Currecny", "Amount", "Received Amount", "Difference", "Received Date", "Received Status", "Remarks", "Open/Close", "Voucher No.", "Attachment Exists" ,"Project Code" };

            NameValueCollection nvc = Filter.OfficeDebitCreditNote;

            DataSet ds = PhoenixAccountsOfficeDebitCreditNoteGenerate.OfficeDebitCreditNoteList(nvc != null ? General.GetNullableString(nvc.Get("txtSubject")) : null
