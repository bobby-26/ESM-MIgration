<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOfficePortageBillList.aspx.cs" Inherits="AccountsOfficePortageBillList" %>
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" UniqueName="Name" HeaderStyle-Width="220px">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                 <telerik:RadLabel ID="lblPortageBill" runat="server" Visible="false" Text='<%# ((DataRowView)Container.DataItem)["FLDPORTAGEBILLID"]%>'></telerik:RadLabel>
                                 ...
                                 <telerik:RadLabel ID="lblSignOnOfId" runat="server" Visible="false" Text='<%# ((DataRowView)Container.DataItem)["FLDSIGNONOFFID"]%>'></telerik:RadLabel>
