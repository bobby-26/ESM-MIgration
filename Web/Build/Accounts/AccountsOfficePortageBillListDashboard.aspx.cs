...
public partial class Accounts_AccountsOfficePortageBillListDashboard : PhoenixBasePage
{
    bool isExport = false;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    toolbargrid.AddFontAwesomeButton(Session["sitepath"] + "/Accounts/AccountsOfficePortageBillListDashboard.aspx?" + Request.QueryString.ToString(), "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            MenuPBExcel.AccessRights = this.ViewState;
            MenuPBExcel.MenuList = toolbargrid.Show();
            PhoenixToolbar toolbar = new PhoenixToolbar();
            toolbar.AddButton("Confirm Portage Bill", "CPORTAGEBILL",ToolBarDirection.Right);
    ...
    protected void MenuPB_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("CPORTAGEBILL"))
            {
                PhoenixAccountsOfficePortageBill.PopulateVesselPortageBillData(int.Parse(Request.QueryString["vslid"]), new Guid(Request.QueryString["pbid"]));
                PhoenixAccountsOfficePortageBill.FinalizeOfficePortageBill(int.Parse(Request.QueryString["vslid"]), new Guid(Request.QueryString["pbid"]));

                gvPB.Rebind();

            }
            ucStatus.Text = "Portage Bill confirmed successfully";
    ...
    {
        //if (e.CommandName.ToUpper().Equals("CPORTAGEBILL"))
        //{
        //    PhoenixAccountsOfficePortageBill.PopulateVesselPortageBillData(int.Parse(Request.QueryString["vslid"]), new Guid(Request.QueryString["pbid"]));
        //    PhoenixAccountsOfficePortageBill.FinalizeOfficePortageBill(int.Parse(Request.QueryString["vslid"]), new Guid(Request.QueryString["pbid"]));
        //}
