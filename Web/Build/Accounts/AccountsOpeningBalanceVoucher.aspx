<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOpeningBalanceVoucher.aspx.cs"
    Inherits="AccountsOpeningBalanceVoucher" EnableEventValidation="true" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="1" cellspacing="1" style="width: 100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtVoucherNumber" runat="server" MaxLength="50" ReadOnly="true"
                            Width="170px" CssClass="readonlytextbox">
                        </telerik:RadTextBox>
                    </td>
                    <%--<td>
                    ...
                    <td>
                        <eluc:Quick runat="server" ID="ucFinancialyear" CssClass="input_mandatory" QuickTypeCode="55"
                            QuickList='<%# PhoenixRegistersQuick.ListQuick(1, 55)%>' AppendDataBoundItems="true" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtStatus" CssClass="readonlytextbox" Width="200px"></telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtLongDescription" TextMode="MultiLine" Width="270px" Resize="Both"
                            Height="65px" CssClass="input">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblLastUpdatedBy" runat="server" Text="Updated By/ Date"></telerik:RadLabel>
                    </td>
                    <td>
