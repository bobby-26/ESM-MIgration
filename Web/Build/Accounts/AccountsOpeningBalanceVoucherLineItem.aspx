<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOpeningBalanceVoucherLineItem.aspx.cs"
    Inherits="AccountsOpeningBalanceVoucherLineItem" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="frmInvoice" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="2" cellspacing="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td rowspan="2">
                        <span id="spnPickListExpenseAccount">
                            ...
                            <telerik:RadTextBox ID="txtAccountId" runat="server" CssClass="input" MaxLength="20" Width="10px"></telerik:RadTextBox><br />
                            ...
                            <br />
                            <telerik:RadTextBox ID="txtBudgetCode" runat="server" Width="30%" CssClass="input_mandatory" OnTextChanged="txtBudgetId_Changed"></telerik:RadTextBox>&nbsp;&nbsp;
                            ...
                            <asp:ImageButton ID="imgShowBudget" runat="server" ImageUrl="<%$ PhoenixTheme:images/picklist.png %>" OnClick="cmdHiddenPick_Click"
                                ImageAlign="AbsMiddle" OnClientClick="return showSubAccountPickList('spnPickListExpenseAccount', 'codehelp1', '', '../Common/CommonPickListSubAccount.aspx?callfrom=openingbalance',true); " />
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblChequeRemittanceNo" runat="server" Text="Cheque/Remittance"></telerik:RadLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblLongDescription" runat="server" Text=" Description"></telerik:RadLabel>
                    </td>
                    <td>
                    ...
                    <td>
                        <telerik:RadLabel ID="lblUpdatedBy" runat="server" Text="Updated By/ Date"></telerik:RadLabel>
                    </td>
                    <td>
