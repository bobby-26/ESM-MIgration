...
public partial class AccountsOpeningBalanceVoucherLineItem : PhoenixBasePage
{
    ...
    )
    {
        try
        {
            PhoenixAccountsVoucher.OpeningBalanceVoucherLineItemInsert(
                iVoucherId,
                iAccountId,
                iCurrencyCode,
                dBaseExchangeRate,
    ...
    )
    {
        try
        {
            PhoenixAccountsVoucher.OpeningBalanceVoucherLineItemUpdate(
                gVoucherLineItemId
