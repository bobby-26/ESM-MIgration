...
public partial class AccountsOpeningBalanceVoucherLineItemDetails : PhoenixBasePage
{
    string _reportfile = "";
    string _filename = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsOpeningBalanceVoucherLineItemDetails.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvLineItem')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Accounts/AccountsOpeningBalanceVoucherLineItemDetails.aspx", "Report", "task-list.png", "REPORT");
            toolbargrid.AddImageButton("../Accounts/AccountsOpeningBalanceVoucherLineItemDetails.aspx", "Voucher Print", "pdf.png", "REPORTPR");
            toolbargrid.AddImageButton("../Accounts/AccountsOpeningBalanceVoucherLineItemDetails.aspx", "Voucher Upload", "download_1.png", "UPLOAD");
            ...
            MenuLineItem.Title = "Opening Balance Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
            ...
            if (!IsPostBack)
            {
                ...
                //Title1.Text = "Opening Balance Voucher Items    (  " + PhoenixAccountsVoucher.VoucherNumber + "     )";
                if (Request.QueryString["qvouchercode"] != null)
                {
                    ifMoreInfo.Attributes["src"] = "AccountsOpeningBalanceVoucherLineItem.aspx?qvouchercode=" + Request.QueryString["qvouchercode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
                }
                else
                {
                    ifMoreInfo.Attributes["src"] = "AccountsOpeningBalanceVoucherLineItem.aspx";
                }
            }
    ...
    protected void MenuLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ViewState["PAGEURL"] = "../Accounts/AccountsOpeningBalanceVoucherLineItem.aspx?voucherid=";
            }
            else if (CommandName.ToUpper().Equals("VOUCHER"))
            {
                Response.Redirect("../Accounts/AccountsOpeningBalanceVoucherMaster.aspx?voucherid=" + ViewState["voucherid"].ToString());
            }
    ...
    private void BindData()
    {
        ...
        if (ViewState["voucherid"] != null)
        {
            ...
            {
                ViewState["PAGEURL"] = "../Accounts/AccountsOpeningBalanceVoucherLineItem.aspx?qvouchercode=";
            }
            {
                if (ViewState["voucherlineitemcode"] != null)
                {
    ...
    private void BindPageURL(int rowindex)
    {
        try
        {
            ...
            ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOpeningBalanceVoucherLineItem.aspx?qvouchercode=" + ViewState["voucherid"].ToString() + "&voucherlineitemcode=" + ViewState["voucherlineitemcode"].ToString() + "&lastAddedlineitemid=" + ViewState["LASTADDEDLINEITEMID"];
