<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOpeningBalanceVoucherMaster.aspx.cs"
    Inherits="AccountsOpeningBalanceVoucherMaster" %>
            ...
            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
                ...
                <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvFormDetails" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        AllowSorting="true" EnableViewState="false" GroupingEnabled="false" EnableHeaderContextMenu="true" OnPageIndexChanged="gvFormDetails_PageIndexChanged"
                        OnSortCommand="gvFormDetails_Sorting" OnPreRender="gvFormDetails_PreRender">
