...
public partial class AccountsOpeningBalanceVoucherMaster : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsOpeningBalanceVoucherMaster.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvVoucher')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageLink("javascript:openNewWindow('codehelp1','', '" + Session["sitepath"] + "/Accounts/AccountsOpeningBalanceVoucherFilter.aspx'); return false;", "Find", "search.png", "FIND");
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["voucherid"] != null)
                {
                    ...
                    ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOpeningBalanceVoucher.aspx?voucherid=" + ViewState["voucherid"];
                }
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ViewState["URL"] = "../Accounts/AccountsOpeningBalanceVoucher.aspx?voucherid=";
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOpeningBalanceVoucher.aspx?voucherid=" + ViewState["voucherid"];
            }
            if (CommandName.ToUpper().Equals("LINEITEM") && ViewState["voucherid"] != null && ViewState["voucherid"].ToString() != string.Empty)
            {
                Response.Redirect("../Accounts/AccountsOpeningBalanceVoucherLineItemDetails.aspx?qvouchercode=" + ViewState["voucherid"]);
            }
            else
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixAccountsVoucher.VoucherSearch(PhoenixSecurityContext.CurrentSecurityContext.CompanyID, 75
    ...
    private void BindData()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOpeningBalanceVoucher.aspx?voucherid=" + ViewState["voucherid"].ToString();
            }
            SetRowSelection();
        }
        else
        {
            if (ViewState["PAGEURL"] == null)
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsOpeningBalanceVoucher.aspx?voucherid=";
            }
        }
    }
