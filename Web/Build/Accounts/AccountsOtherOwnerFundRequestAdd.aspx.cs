...
public partial class AccountsOtherOwnerFundRequestAdd : PhoenixBasePage
{
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                if (ViewState["OfficeDebitCreditNoteId"] == null || ViewState["OfficeDebitCreditNoteId"].ToString() == string.Empty)
                {
                    ...
                    PhoenixAccountsOfficeDebitCreditNoteGenerate.OfficeDebitCreditNoteInsert(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                                        ...
                                                                                        , null
                                                                                        , General.GetNullableInteger(ddlfundtype.SelectedValue));
                    ViewState["OfficeDebitCreditNoteId"] = iOfficeDebitCreditId;
                    ucStatus.Text = "Other Owner Debit/Credit note saved.";
                ...
                else
                {
                    PhoenixAccountsOfficeDebitCreditNoteGenerate.OfficeDebitCreditNoteUpdate(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                                        ...
                                                                                        , txtAddressee.Text
                                                                                        , txtVoucherLineItemDesc.Text);
                    ucStatus.Text = "Other Owner Debit/Credit note updated.";
    ...
    private bool IsValidData(string subject, string type, string billingCompany, string account, string bank, string budgetId, string ownerBudgetCode,
        string date, string currency, string referenceNo, string addressee)
    {
