<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOwnerDebitCreditNoteGenerate.aspx.cs"
    Inherits="AccountsOwnerDebitCreditNoteGenerate" %>
    ...
    <form id="frmDebitCreditNote" runat="server" submitdisabledcontrols="true">
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                ...
                <table cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadComboBox ID="ddlSubtype" runat="server" CssClass="dropdown_mandatory" DataSource='<%# PhoenixRegistersQuick.ListQuick(1, 154)%>'
							 ...
							 <telerik:RadLabel ID="lblCAccounts" runat="server" Visible="false"></telerik:RadLabel>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadLabel ID="lblOwner" runat="server" Text="Owner"></telerik:RadLabel>
 							<telerik:RadLabel ID="lbl1" runat="server" Text="/"></telerik:RadLabel>
                            <telerik:RadLabel ID="lbladdresses" runat="server" Text="Address"></telerik:RadLabel>                       
						</td>
                        <td>
							...
							<telerik:RadLabel ID="lbl2" runat="server" Text="/"></telerik:RadLabel>
                            <telerik:RadTextBox ID="txtaddressed" runat="server" CssClass="input_mandatory" TextMode="MultiLine" Enabled="false" Width="240px"></telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadTextBox ID="txtReferenceNo" runat="server" Width="240px" MaxLength="50" ></telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
      ...
      <telerik:GridTemplateColumn HeaderText="Description" HeaderStyle-Width="300px">
                                    ...
                                    <telerik:RadTextBox ID="txtDescriptionEdit" runat="server" CssClass="input_mandatory" Width="100%"
                                        TextMode="MultiLine" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDESCRIPTION") %>'></telerik:RadTextBox>
                                </edititemtemplate>
                                    <footertemplate>
