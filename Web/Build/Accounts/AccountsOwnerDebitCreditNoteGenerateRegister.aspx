<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOwnerDebitCreditNoteGenerateRegister.aspx.cs"
    Inherits="AccountsOwnerDebitCreditNoteGenerateRegister" %>
    ...
    <form id="frmDebitCreditNote" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                ...
                <%--            <div id="divScroll" style="position: relative; z-index: 0; width: 100%; height: 290px; overflow: auto;"
                    onscroll="javascript:setScroll('divScroll', 'hdnScroll');">--%>

                <%--<asp:GridView ID="gvDebitCreditNote" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            Width="100%" CellPadding="3" OnRowDataBound="gvDebitCreditNote_ItemDataBound"
                            ShowHeader="true" EnableViewState="false" OnRowCommand="gvDebitCreditNote_RowCommand"
                            OnRowCancelingEdit="gvDebitCreditNote_RowCancelingEdit" OnRowUpdating="gvDebitCreditNote_RowUpdating"
                            OnRowEditing="gvDebitCreditNote_RowEditing" OnSelectedIndexChanging="gvDebitCreditNote_SelectedIndexChanging"
                            DataKeyNames="FLDOWNERDEBITCREDITNOTEID" OnRowDeleting="gvDebitCreditNote_RowDeleting">
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvDebitCreditNote" runat="server" Height="300px" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                    ...
                    <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Project code" HeaderStyle-Width="100px">
