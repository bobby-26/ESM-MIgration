...
public partial class AccountsOwnerDebitCreditNoteGenerateRegister : PhoenixBasePage
{
    ...
    private void BindData()
    {
        try
        {
            ...
            string[] alColumns = { "FLDVESSELNAME", "FLDDATE", "FLDREFERENCENUMBER", "FLDSHORTCODE", "FLDTYPENAME", "FLDSUBTYPE", "FLDBANKDESCRIPTION", "FLDLINEITEM", "FLDAMOUNTINUSD", "FLDCURRENCYCODE", "FLDRECEIVEDAMOUNT", "FLDDIFFERENCE", "FLDRECEIVEDDATE", "FLDRECEIVEDSTATUSNAME", "FLDREMARKS", "FLDOPENCLOSE", "FLDVOUCHERNUMBER", "FLDATTACHMENT", "FLDPROJECTCODE" };
            string[] alCaptions = { "Vessel", "Date", "Reference No.", "Billing Company", "Type", "SubType", "Bank Receiving Funds", "Line Item", "Amount", "Currency", "Received Amount", "Difference", "Received Date", "Received Status", "Remarks", "Open/Close", "Voucher No.", "Attachment Exists", "Project Code" };
    ...
    {
        //gvDebitCreditNote.EditIndex = -1;
        //gvDebitCreditNote.SelectedIndex = -1;
        BindData();
    ...
    protected void gvDebitCreditNote_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            {
                //if (!IsValidLineItem(((TextBox)e.Item.FindControl("txtDescriptionEdit")).Text
            ...
            if (e.CommandName.ToUpper().Equals("HISTORY"))
            {
                ...
                //string DebitCreditNoteIdItem = (((RadLabel)e.Item.FindControl("lblDebitCreditNoteId")).Text);
                //String scriptpopup = String.Format(
                // "javascript:parent.Openpopup('codehelp1', '', '../Accounts/AccountsOwnerFundRequestHistory.aspx?DebitCreditNoteIdItem=" + DebitCreditNoteIdItem + "');");
