<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOwnerFundPosition.aspx.cs"
    Inherits="Accounts_AccountsOwnerFundPosition" %>
            ...
            <HeaderTemplate>
                <table class="Grid" cellspacing="0" rules="all" border="1">
                    <tr>
                        ...
                        <th scope="col" align="center" style="width: 150px">Owner
                        </th>
                            ...
                            <asp:Repeater ID="rptOrders" runat="server" OnItemDataBound="rptOrders_OnItemDataBound">
                                <HeaderTemplate>
                                    <table class="ChildGrid" cellspacing="0" rules="all" border="1">
                                        <tr>
                                            <th scope="col" align="center" style="width: 150px">Vessel
                                            </th>
                                            <th scope="col" align="center" style="width: 150px">Ledger Balance
                                            </th>
                                            <th scope="col" align="center" style="width: 150px">Excluded Vouchers
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <asp:HiddenField ID="hfPrincipalId" runat="server" Value='<%# Eval("FLDPRINCIPALID") %>' />
                                    </td>--%>
                                        <td>
