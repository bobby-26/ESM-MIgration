<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsOwnerFundsReceived.aspx.cs" Inherits="AccountsOwnerFundsReceived" %>
...
<body>
    <form id="frmOwnerFund" runat="server">
        <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server" DecoratedControls="All" EnableRoundedCorners="true" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="99%">
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
            <eluc:Status runat="server" ID="ucStatus" />
            <eluc:Title runat="server" ID="ucTitle" Text="Owner Funds Received" ShowMenu="false" Visible="false"></eluc:Title>
            <asp:Button runat="server" ID="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" Visible="false"/>
            <eluc:TabStrip ID="MenuOwnerFund" runat="server" OnTabStripCommand="MenuOwnerFund_TabStripCommand" TabStrip="true"></eluc:TabStrip>
            <table width="50%">
                <tr>
                    <td>
            ...
            <eluc:TabStrip ID="MenuOwnerFundGrid" runat="server" OnTabStripCommand="MenuOwnerFundGrid_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvFundReceived" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                Height="82%" Width="100%" CellPadding="3" OnItemDataBound="gvFundReceived_ItemDataBound" ShowHeader="true" AllowPaging="true" AllowCustomPaging="true"
                EnableViewState="false" AllowSorting="true" OnItemCommand="gvFundReceived_ItemCommand" EnableHeaderContextMenu="true" GroupingEnabled="false"
                OnNeedDataSource="gvFundReceived_NeedDataSource" OnSelectedIndexChanging="gvFundReceived_SelectedIndexChanging">
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" TableLayout="Fixed" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Left" HeaderStyle-Wrap="true" DataKeyNames="FLDOWNEROFFICEFUNDID">
                    <NoRecordsTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Bank Account" HeaderStyle-Width="22%">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Long Description" HeaderStyle-Width="19%">
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Voucher Status" HeaderStyle-Width="8%">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
