...
public partial class Accounts_AccountsProjectCodeFundRequest : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsProjectCodeFundRequest.aspx", "Export to Excel", "icon_xls.png", "Excel"); ;
            toolbargrid.AddImageLink("javascript:CallPrint('gvFundRequest')", "Print Grid", "icon_print.png", "PRINT");
            //toolbargrid.AddImageLink("../Accounts/AccountsProjectCodeFundRequest.aspx", "Filter", "search.png", "FIND");
            ...
            toolbargrid.AddImageLink("javascript:openNewWindow('codehelp1','','" + Session["sitepath"] + "/Accounts/AccountsProjectCodeDebitCreditNoteGenerateShipOwners.aspx?OwnerDebitCreditNoteId=&ID=" + ViewState["PROJECTID"].ToString() + "')", "Add", "add.png", "ADD");
    ...
    protected void MenuOrderLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else if (CommandName.ToUpper().Equals("FIND"))
            {
                if (ViewState["PROJECTID"] != null)
                {
                    Response.Redirect("../Accounts/AccountsProjectLineItemConfirmationFilter.aspx?id=" + ViewState["PROJECTID"].ToString());
                }
            }
            else if (CommandName.ToUpper().Equals("EXCEL"))
            {
                ...
                DataTable dt = PhoenixAccountProjectPurchaseLineItem.ProjectcodeFundRequestList(null, null, null, null, null, null, null, null, null
    ...
    private void BindData()
    {
        try
        {
            ...
            if (ViewState["PROJECTID"] != null)
            {
                ...
                General.SetPrintOptions("gvFundRequest", "Fund Request(Ship Owner)", alCaptions, alColumns, ds);
    ...
    protected void ProjectCodeEdit()
    {
        ...
        if (ds.Tables.Count > 0)
        {
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                txtFundReqRev1.Text = dr["FLDFUNDREQUESTAMOUNT"].ToString();
                txtFundReqRev2.Text = dr["FLDFUNDRECEIVEDAMOUNT"].ToString();
                txtEstFundPosition1.Text = dr["FLDVOUCHERLINEITEMAMOUNT"].ToString();
