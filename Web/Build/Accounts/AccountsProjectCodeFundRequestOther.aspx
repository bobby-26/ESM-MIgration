<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsProjectCodeFundRequestOther.aspx.cs" Inherits="Accounts_AccountsProjectCodeFundRequestOther" %>
    ...
    <form id="frmAwaitingOrderFormItemDetails" runat="server">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvFundRequest" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowPaging="true" AllowCustomPaging="true"
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    <telerik:GridTemplateColumn HeaderText="Account Code" HeaderStyle-Width="15%">
                    ...
                    <telerik:GridTemplateColumn HeaderText="Ref No:" HeaderStyle-Width="20%">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="RadLabel1" Visible="false" runat="server" CommandName="EDIT" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREFERENCENUMBER") %>'></asp:LinkButton>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Type" HeaderStyle-Width="20%">
                        <ItemStyle HorizontalAlign="Left" Wrap="true" />
                        <ItemTemplate>
