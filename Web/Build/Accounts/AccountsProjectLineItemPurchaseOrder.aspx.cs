...
public partial class Accounts_AccountsProjectLineItemPurchaseOrder : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsProjectLineItemPurchaseOrder.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvLineItem')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageLink("../Accounts/AccountsProjectLineItemPurchaseOrder.aspx", "Filter", "search.png", "FIND");
            toolbargrid.AddImageButton("../Accounts/AccountsProjectLineItemPurchaseOrder.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            toolbargrid.AddImageButton("../Accounts/AccountsProjectLineItemPurchaseOrder.aspx", "Add", "Add.png", "ADD");
    ...
    protected void MenuOrderLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                String scriptpopup = String.Format("javascript:parent.openNewWindow('codehelp1','','" + Session["sitepath"] + "/Accounts/AccountsProjectLineItemPurchaseOrderAdd.aspx?id=" + ViewState["PROJECTID"].ToString() + "&accountid=" + ViewState["ACCOUNTID"].ToString() + ", false ');");
            ...
            else if (CommandName.ToUpper().Equals("FIND"))
            {
                if (ViewState["PROJECTID"] != null)
                {
                    Response.Redirect("../Accounts/AccountsProjectLineItemPurchaseOrderFilter.aspx?id=" + ViewState["PROJECTID"].ToString() + "&accountid=" + ViewState["ACCOUNTID"].ToString());
                }
            }
            ...
            else if (CommandName.ToUpper().Equals("EXCEL"))
            {
                ...
                DataTable dt = PhoenixAccountProjectPurchaseLineItem.PurchaseLineItemSearch(General.GetNullableInteger(ViewState["PROJECTID"].ToString())
    ...
    protected void gvLineItem_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToUpper() == "DELETE")
        {
            ...
            {
                PhoenixAccountProjectPurchaseLineItem.DeletePurchaseLineiTem(new Guid(lblPurchaseLineItemId));
            }
    ...
    protected void PendingPoEdit()
    {
        if (ViewState["PROJECTID"] != null)
        {
            DataTable dt = PhoenixAccountProjectPurchaseLineItem.PurchasePoPendingAmount(int.Parse(ViewState["PROJECTID"].ToString()));
            if (dt.Rows.Count > 0)
            {
