...
public partial class Accounts_AccountsProjectLineItemPurchaseOrderFilter : PhoenixBasePage
{
    ...
    protected void ProjectCodeList_TabStripCommand(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../Accounts/AccountsProjectLineItemPurchaseOrder.aspx?id=" + ViewState["PROJECTID"].ToString() + "&accountid=" + ViewState["ACCOUNTID"].ToString(), false);
    }
}