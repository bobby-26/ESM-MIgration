...
public partial class Accounts_AccountsProjectLineItemVoucherRegisterAdd : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsProjectLineItemVoucherRegisterAdd.aspx", "Filter", "search.png", "FIND");
            toolbargrid.AddImageButton("../Accounts/AccountsProjectLineItemVoucherRegisterAdd.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void gvGrid_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.ToUpper() == "ADD")
            {
                ...
                {
                    PhoenixAccountProjectVoucher.InsertVoucherLineItem(new Guid(lblVoucherLineItemid), General.GetNullableInteger(ViewState["PROJECTID"].ToString()));
    ...
    protected void BindData()
    {
        ...
        dt = PhoenixAccountProjectVoucher.VoucherLineItemAddSearch(General.GetNullableInteger(ViewState["PROJECTID"].ToString())
                                                               , General.GetNullableString(txtVoucherNumber.Text.Trim())
                                                               , General.GetNullableDateTime(txtCreatedDate.Text)
                                                               , General.GetNullableString(txtVoucherDescription.Text)
