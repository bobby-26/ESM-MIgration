<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsPurchaseInvoiceVoucher.aspx.cs"
    Inherits="AccountsPurchaseInvoiceVoucher" EnableEventValidation="true" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVoucher">
            ...
            <table cellpadding="1" cellspacing="1" style="width: 100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtVoucherType" Text="Purchase Invoice Voucher" CssClass="readonlytextbox"
