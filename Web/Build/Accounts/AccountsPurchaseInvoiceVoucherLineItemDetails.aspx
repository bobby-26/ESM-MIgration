<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsPurchaseInvoiceVoucherLineItemDetails.aspx.cs"
    Inherits="AccountsPurchaseInvoiceVoucherLineItemDetails" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlStockItemEntry" Height="100%">
            ...
            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
                <telerik:RadPane ID="navigationPane" runat="server" Scrolling="None">
                    <iframe runat="server" id="ifMoreInfo" scrolling="no" style="min-height: 355px; width: 99%"></iframe>
                </telerik:RadPane>
                ...
                <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvLineItem" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Height="30%" Width="100%" CellPadding="3" OnItemCommand="gvLineItem_RowCommand" OnItemDataBound="gvLineItem_RowDataBound"
                        OnDeleteCommand="gvLineItem_RowDeleting" OnNeedDataSource="gvLineItem_NeedDataSource" AllowPaging="true" AllowCustomPaging="true"
                        OnRowCreated="gvLineItem_RowCreated" ShowHeader="true"
                        ShowFooter="true" EnableViewState="false" AllowSorting="true" OnPageIndexChanged="gvLineItem_PageIndexChanged">
                        ...
                        <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Account" HeaderStyle-Width="8%">
                                ...
                                <telerik:GridTemplateColumn HeaderText="Sub Account" HeaderStyle-Width="12%">
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Owner Budget" HeaderStyle-Width="8%">
