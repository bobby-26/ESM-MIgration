<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsPurchaseInvoiceVoucherMaster.aspx.cs"
    Inherits="AccountsPurchaseInvoiceVoucherMaster" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlOrderForm">
            ...
            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
                ...
                <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                    ...
                    <%--                    <iframe runat="server" id="ifMoreInfo" scrolling="no" style="min-height: 350px; width: 99%"></iframe>--%>
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvFormDetails" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        OnDeleteCommand="gvFormDetails_DeleteCommand" AllowPaging="true" AllowCustomPaging="true" OnPreRender="gvFormDetails_PreRender1"
                        AllowSorting="true" EnableViewState="false" OnNeedDataSource="gvFormDetails_NeedDataSource"
                        OnSortCommand="gvFormDetails_Sorting" OnPageIndexChanged="gvFormDetails_PageIndexChanged">
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn HeaderText="Voucher Number" AllowSorting="true" SortExpression="FLDVOUCHERNUMBER">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <telerik:RadLabel ID="lblInvoiceCode" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDINVOICECODE") %>'></telerik:RadLabel>
