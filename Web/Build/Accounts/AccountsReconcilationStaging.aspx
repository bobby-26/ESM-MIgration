<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsReconcilationStaging.aspx.cs"
    Inherits="AccountsReconcilationStaging" MaintainScrollPositionOnPostback="true"
...
<body>
    ...
    <form id="frmPurchaseSatging" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuSubmitForApproval" runat="server" Visible="false" OnTabStripCommand="MenuSubmitForApproval_TabStripCommand"></eluc:TabStrip>
                ...
                <td>
                    <span id="spnPickListFleetManager1">
                        ...
                        <asp:ImageButton runat="server" ID="imgPIC" Style="cursor: pointer; vertical-align: top"
                            ...
                            ToolTip="Select PIC" />
                        <telerik:RadTextBox runat="server" ID="txtpicid" Width="0px" CssClass="hidden"></telerik:RadTextBox>
                        <telerik:RadTextBox runat="server" ID="txtmail" CssClass="hidden" Width="0px"></telerik:RadTextBox>
                    </span>
                    <asp:ImageButton runat="server" AlternateText="ChangeVessel" ImageUrl="<%$ PhoenixTheme:images/refresh.png %>"
                            CommandName="POPicUpdate" ID="imgpicupdate" ToolTip="PIC Update"
                            OnClick="POPicUpdate"></asp:ImageButton>
                   <%-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp

                    <telerik:RadLabel ID="RadLabel1" runat="server" Text="Approver History"></telerik:RadLabel>
                     &nbsp
					     <asp:ImageButton runat="server" AlternateText="Approver" ImageUrl="<%$ PhoenixTheme:images/document_view.png %>"
                            CommandName="Approver" ID="imgapproverhistory" ToolTip="Approver History"
                            OnClick="ApproverHistory"></asp:ImageButton>--%>
                </td>
                 </tr>
                <tr>
                    <td>
                            <telerik:RadLabel ID="RadLabel2" runat="server" Text="Approver History"></telerik:RadLabel>
