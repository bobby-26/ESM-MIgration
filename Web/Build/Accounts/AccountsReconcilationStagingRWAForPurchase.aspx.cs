...
public partial class AccountsReconcilationStagingRWAForPurchase : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsReconcilationStagingRWAForPurchase.aspx", "Export to Excel", "icon_xls.png", "Excel");
            ...
            toolgrid.AddImageButton("../Accounts/AccountsReconcilationStagingRWAForPurchase.aspx", "Export to Excel", "icon_xls.png", "Excel");
          ...
          //  toolbarmain.AddButton("Approver History", "HISTORY", ToolBarDirection.Right);
    ...
    private void BindVendorInfo()
    {
        ...
        if (dsVendor.Tables[0].Rows.Count > 0)
        {
            ...
            txtlastapprovername.Text = dr["FLDLASTAPPROVARNAME"].ToString();
    ...
    protected void MenuLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Accounts/AccountsInvoiceLineItemDetailsRWAForPurchase.aspx?qinvoicecode=" + ViewState["invoicecode"] + "&qcallfrom=" + ViewState["callfrom"].ToString());
            }
            ...
            {
                Response.Redirect("../Accounts/AccountsInvoiceAttachmentsRWAForPurchase.aspx?qinvoicecode=" + ViewState["invoicecode"].ToString() + "&qfrom=invoice");
            }
    ...
    {
        String scriptpopup = String.Format("javascript:parent.openNewWindow('codehelp2','','" + Session["sitepath"] + "/Accounts/AccountsRWAApprovalHistory.aspx?orderID=" + ViewState["ORDERID"].ToString() + "&Showall=1" + "');");
        ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "script", scriptpopup, true);
