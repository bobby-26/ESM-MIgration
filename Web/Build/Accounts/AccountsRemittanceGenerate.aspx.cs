...
public partial class AccountsRemittanceGenerate : PhoenixBasePage
{
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            if (CommandName.ToUpper().Equals("NEW"))
            {
                ...
                //foreach (GridViewRow gvr in gvVoucherDetails.Rows)
                //{
                //    CheckBox chkSelect = (CheckBox)gvr.FindControl("chkSelect");
                //    Label lblPaymentVoucherID = (Label)gvr.FindControl("lblPaymentVoucherID");
                //    Label lblPaymentVoucherType = (Label)gvr.FindControl("lblPaymentVoucherType");

                //    if (chkSelect.Checked == true && lblPaymentVoucherType.Text == PhoenixCommonRegisters.GetHardCode(1, 221, "CTM").ToString())
                //    {
                //        selectedCtm = selectedCtm + lblPaymentVoucherID.Text + ",";
                //    }

                //    if (chkSelect.Checked == true && lblPaymentVoucherType.Text != PhoenixCommonRegisters.GetHardCode(1, 221, "CTM").ToString())
                //    {
                //        selectedOthers = selectedOthers + lblPaymentVoucherID.Text + ",";
                //    }
                //}

                if (SelectedPvs.Count > 0)
                {
                    //PhoenixAccountsRemittance.AllocateAdvancePaymentVouchers(PhoenixSecurityContext.CurrentSecurityContext.CompanyID, PhoenixSecurityContext.CurrentSecurityContext.UserCode, selectedagents.Length > 1 ? selectedagents : null);
