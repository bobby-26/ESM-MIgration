...
public partial class AccountsRemittanceInstructionLineItem : PhoenixBasePage
{
    ...
    {
        DataSet ds = PhoenixAccountsRemittance.Listremittance(ViewState["Remittenceid"].ToString());
    ...
    private void BindData()
    {
        ...
        ds = PhoenixAccountsRemittance.RemittanceInstructionLineItemSearch(remittanceid);
