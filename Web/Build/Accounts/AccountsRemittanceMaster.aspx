<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsRemittanceMaster.aspx.cs"
    Inherits="AccountsRemittanceMaster" %>
...
<body>
    <form id="frmPurchaseForm" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:Title runat="server" ID="frmTitle" Text="Remittance" Visible="false"></eluc:Title>
            <asp:Button ID="cmdHiddenSubmit" runat="server" Text="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" />
            <iframe runat="server" id="ifMoreInfo" scrolling="no" style="min-height: 300px; width: 99.9%; border-left-width: 1px; border-left-style: solid; border-right-width: 1px; border-right-style: solid; border-bottom-width: 1px; border-bottom-style: solid; border-top-width: 1px; border-top-style: solid; margin-left: 0px;"></iframe>
            <eluc:TabStrip ID="MenuOrderForm" runat="server" OnTabStripCommand="MenuOrderForm_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRemittence" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowPaging="true" AllowCustomPaging="true"
                Height="39%" Width="100%" CellPadding="3" OnItemCommand="gvRemittence_ItemCommand" OnItemDataBound="gvRemittence_ItemDataBound" EnableHeaderContextMenu="true" GroupingEnabled="false"
                AllowSorting="true" EnableViewState="false" OnNeedDataSource="gvRemittence_NeedDataSource">
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false" DataKeyNames="FLDREMITTANCEID"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Number" AllowSorting="true" SortExpression="FLDREMITTANCENUMBER" ShowSortIcon="true" HeaderStyle-Width="9%">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Supplier Code" HeaderStyle-Width="9%">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Amount" HeaderStyle-Width="7%">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Payment Mode" HeaderStyle-Width="7%">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Bank Charge Basis" HeaderStyle-Width="8%">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Account Code" HeaderStyle-Width="8%">
                            ...
                            <ItemTemplate>
                                ...
                                <eluc:ToolTip ID="ucToolTiplblAccountName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDESCRIPTION") %>' />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Account Description" Visible="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-Width="7%">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:ImageButton runat="server" AlternateText="On Hold" ImageUrl="<%$ PhoenixTheme:images/waiting-approve.png %>"
                                    CommandName="OnHold" CommandArgument='<%# Container.DataItem %>' ID="cmdOnHold" Visible="false"
