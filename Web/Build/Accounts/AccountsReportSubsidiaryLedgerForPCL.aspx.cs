...
public partial class AccountsReportSubsidiaryLedgerForPCL : PhoenixBasePage
{
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("ANNUALEDGER"))
            {
                ...
                else
                {
                    ...
                    {
                        Response.Redirect("../Reports/ReportsView.aspx?applicationcode=5&reportcode=SUBSIDARYLEDGERFORPCL&accountcode=" + criteria.Get("rblAccount") + "&fromdate=" + criteria.Get("ucFromDate") + "&todate=" + criteria.Get("ucToDate") + "&subaccount=" + criteria.Get("cblSubAccount"), false);
                    }
                    else if (ddlType.SelectedValue == "2")
                    {
                        Response.Redirect("../Reports/ReportsView.aspx?applicationcode=5&reportcode=SUBSIDARYLEDGERREPORTCURRENCYFORPCL&accountcode=" + criteria.Get("rblAccount") + "&fromdate=" + criteria.Get("ucFromDate") + "&todate=" + criteria.Get("ucToDate") + "&subaccount=" + criteria.Get("cblSubAccount"), false);
                    }
                    else if (ddlType.SelectedValue == "3")
                    {
                        if (ucCurrency.SelectedCurrency == "Dummy")
                        {
                            Response.Redirect("../Reports/ReportsView.aspx?applicationcode=5&reportcode=SUBSIDARYLEDGERREPORTPRIMECURRENCYPCL&accountcode=" + criteria.Get("rblAccount") + "&fromdate=" + criteria.Get("ucFromDate") + "&todate=" + criteria.Get("ucToDate") + "&subaccount=" + criteria.Get("cblSubAccount") + "&currency=" + criteria.Get("ucCurrency"), false);
                        }
                        else
                        {
                            Response.Redirect("../Reports/ReportsView.aspx?applicationcode=5&reportcode=SUBSIDARYLEDGERREPORTPRIMEWITHCURRENCYPCL&accountcode=" + criteria.Get("rblAccount") + "&fromdate=" + criteria.Get("ucFromDate") + "&todate=" + criteria.Get("ucToDate") + "&subaccount=" + criteria.Get("cblSubAccount") + "&currency=" + criteria.Get("ucCurrency"), false);
                        }
                    }
                }
            }
    ...
    protected void SelectAccount()
    {
        ...
        foreach (ButtonListItem item in rblAccount.Items)
        {
