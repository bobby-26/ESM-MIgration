<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsReportTrialBalanceBaseCurrency.aspx.cs" Inherits="AccountsReportTrialBalanceBaseCurrency" %>
...
<head runat="server">
    <title>Trial Balance Reporting Currency</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body onload="resizeFrame()">
    ...
    <div class="navigation" id="Div2" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader" style="position: relative">
            <eluc:Title runat="server" ID="Title3" Text="Trial Balance Base Currency Report" ShowMenu="true">
            </eluc:Title>
        ...
        <div>
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="ucDate" runat="server" CssClass="input_mandatory"></asp:TextBox>
