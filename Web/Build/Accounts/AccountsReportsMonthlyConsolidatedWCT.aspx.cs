...
public partial class AccountsReportsMonthlyConsolidatedWCT : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=5&reportcode=MONTHLYCONSOLIDATEDWCT&month=null&year=null&showmenu=0";
        }
        catch (Exception ex)
        {
    ...
    protected void Menuledger_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            if (CommandName.ToUpper().Equals("SHOWREPORT"))
            {
                ...
                {
                    ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=5&reportcode=MONTHLYCONSOLIDATEDWCT&month=" + ddlMonth.SelectedValue + "&year=" + ucFinancialYear.SelectedQuick + "&showmenu=0";
                }
            }
        }
        catch (Exception ex)
