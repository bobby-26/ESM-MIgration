...
public partial class AccountsRevenueVoucher : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                //      ttlVoucher.Text = "Revenue Voucher      (" + PhoenixAccountsVoucher.VoucherNumber + ")     ";
            }
        }
        ...
        MenuVoucher.Title = "Revenue Voucher      (" + txtVoucherNumber.Text + ")     ";
    ...
    protected void Voucher_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Accounts/AccountsRevenueVoucherList.aspx");
        }
        if (CommandName.ToUpper().Equals("DETAILS"))
        {
            Response.Redirect("../Accounts/AccountsRevenueVoucherLineItem.aspx?qvouchercode=" + ViewState["VOUCHERID"].ToString());
        }
