...
public partial class AccountsRevenueVoucherMaster : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsRevenueVoucherMaster.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvVoucher')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageLink("javascript:openNewWindow('codehelp1','', '" + Session["sitepath"] + "/Accounts/AccountsRevenueVoucherFilter.aspx'); return false;", "Find", "search.png", "FIND");
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["voucherid"] != null)
                {
                    ...
                    ifMoreInfo.Attributes["src"] = "../Accounts/AccountsRevenueVoucher.aspx?voucherid=" + ViewState["voucherid"];
                }
            }
        }
        catch (Exception ex)
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                ViewState["URL"] = "../Accounts/AccountsRevenueVoucher.aspx?voucherid=";
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsRevenueVoucher.aspx?voucherid=" + ViewState["voucherid"];
            }
            if (CommandName.ToUpper().Equals("LINEITEM") && ViewState["voucherid"] != null && ViewState["voucherid"].ToString() != string.Empty)
            {
                Response.Redirect("../Accounts/AccountsRevenueVoucherLineItemDetails.aspx?qvouchercode=" + ViewState["voucherid"]);
            }
            else
    ...
    private void BindData()
    {
        ...
        NameValueCollection nvc = Filter.CurrentInvoiceSelection;
        ds = PhoenixAccountsVoucher.VoucherSearch(PhoenixSecurityContext.CurrentSecurityContext.CompanyID, 77
                                                   , nvc != null ? General.GetNullableString(nvc.Get("txtVoucherNumberSearch")) : string.Empty
                                                   , nvc != null ? General.GetNullableDateTime(nvc.Get("txtVoucherFromdateSearch")) : null
                                                   , nvc != null ? General.GetNullableDateTime(nvc.Get("txtVoucherTodateSearch")) : null
                                                   , null
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsRevenueVoucher.aspx?voucherid=" + ViewState["voucherid"].ToString();
            }
            SetRowSelection();
        }
        else
        {
            if (ViewState["PAGEURL"] == null)
            {
                ifMoreInfo.Attributes["src"] = "../Accounts/AccountsRevenueVoucher.aspx?voucherid=";
            }
        }
    }
