...
public partial class AccountsSOAGeneration : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Accounts/AccountsSOAGeneration.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("javascript:CallPrint('gvDebitReference')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageLink("../Accounts/AccountsSOAGeneration.aspx", "Find", "search.png", "FIND");
            toolbar.AddImageButton("../Accounts/AccountsSOAGeneration.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            ...
            //MenuFormMain.SelectedMenuIndex = 0;
            ...
            if (!IsPostBack)
            {
                ...
                //toolbarsub.AddButton("SOA Reference", "SOAREFERENCE");
    ...
    protected void ShowExcel()
    {
        ...
        NameValueCollection nvc = Filter.CurrentSOAGeneration;

        ds = PhoenixAccountsSOAGeneration.DebitNoteReferenceSearchForSOAGeneration(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                    , sortexpression, sortdirection, (int)ViewState["PAGENUMBER"], PhoenixGeneralSettings.CurrentGeneralSetting.ExcelRecordsCount
                                    , ref iRowCount, ref iTotalPageCount, General.GetNullableString(txtDebitRefernce.Text),
                                    nvc != null ? General.GetNullableString(nvc.Get("rblStatus")) : General.GetNullableString(rblStatus.SelectedValue)
                                    , nvc != null ? General.GetNullableInteger(nvc.Get("rblAccount")) : General.GetNullableInteger(rblAccount.SelectedValue)
                                    , nvc != null ? General.GetNullableInteger(nvc.Get("ucMonth")) : month
                                    , nvc != null ? General.GetNullableInteger(nvc.Get("ucYear")) : year
                                    , nvc != null ? General.GetNullableString(nvc.Get("ddlReportType")) : General.GetNullableString(ddlReportType.SelectedValue)
                                    , nvc != null ? General.GetNullableInteger(nvc.Get("txtVendorId")) : General.GetNullableInteger(txtVendorId.Text));
    ...
    protected void MenuDebitReference_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("FIND"))
            {
                ...
                //gvDebitReference.EditIndex = -1;
                //gvDebitReference.SelectedIndex = -1;
                ViewState["PAGENUMBER"] = 1;
    ...
    private void BindData()
    {
        ...
        ds = PhoenixAccountsSOAGeneration.DebitNoteReferenceSearchForSOAGeneration(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                    , sortexpression, sortdirection, (int)ViewState["PAGENUMBER"], gvDebitReference.PageSize, ref iRowCount,
                                    ref iTotalPageCount, General.GetNullableString(txtDebitRefernce.Text),
                                    nvc != null ? General.GetNullableString(nvc.Get("rblStatus")) : General.GetNullableString(rblStatus.SelectedValue)
                                    , nvc != null ? General.GetNullableInteger(nvc.Get("rblAccount")) : General.GetNullableInteger(rblAccount.SelectedValue)
                                    , nvc != null ? General.GetNullableInteger(nvc.Get("ucMonth")) : month
                                    , nvc != null ? General.GetNullableInteger(nvc.Get("ucYear")) : year
    ...
    //protected void gvDebitReference_RowCreated(object sender, GridViewRowEventArgs e)
    //{
    //    if (e.Item.RowType == DataControlRowType.DataRow
    //        && e.Item.RowState != (DataControlRowState.Edit | DataControlRowState.Selected | DataControlRowState.Alternate)
    //        && e.Item.RowState != (DataControlRowState.Edit | DataControlRowState.Selected | DataControlRowState.Normal))
    //    {
    //        e.Item.TabIndex = -1;
    //        e.Item.Attributes["onclick"] = Page.ClientScript.GetPostBackEventReference(gvDebitReference, "Edit$" + e.Item.RowIndex.ToString(), false);
    ...
    protected void vesselAccount()
    {
        ...
        try
        {
            ...
            //PhoenixRegistersAccount.vesselaccount(txtAccountSearch.Text);
    ...
    protected void gvDebitReference_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName.ToUpper().Equals("SELECT"))
            {
                ...
                Response.Redirect("../Accounts/AccountsSoaGenerationLineItems.aspx?debitnotereference=" + lblStatementReference.Text + "&accountid=" + lblAccountId.Text + "&Ownerid=" + lblOwnerID.Text + "&debitnoteid=" + lblDebitReferenceId.Text, true);
            ...
            if (e.CommandName.ToUpper().Equals("BULKSAVE"))
            {
                ...
                Response.Redirect("../Accounts/AccountsDebitReferenceUpdateSOAGeneration.aspx?debitnotereferenceID=" + lblDebitReferenceId.Text + "&AccountID=" + lblAccountId.Text + "&AccountCode=" + lblAccountCode.Text + "&r=" + 1 + "&AccountDesc=" + lblAccount.Text, true);
            }
