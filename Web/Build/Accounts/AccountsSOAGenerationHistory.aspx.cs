...
public partial class AccountsSOAGenerationHistory : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Accounts/AccountsSOAGenerationHistory.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect(ViewState["URL"].ToString() + ViewState["DebitNoteReferencecode"] + "&qcallfrom=DebitNoteReference");
            }
            //else
    ...
    private void SetRedirectURL()
    {
        if (ViewState["qfrom"] != null)
        {
            ...
            {
                ViewState["URL"] = "../Accounts/AccountsSOAGeneration.aspx?DebitNoteReferenceid=";
            }
        }
    }
    ...
    private void BindReferenceNumber(string DebitNoteReferencenumber)
    {
        if (General.GetNullableGuid(DebitNoteReferencenumber) != null)
        {
            ...
            if (dsInvoice.Tables[0].Rows.Count > 0)
            {
                ...
                //frmTitle.Text = frmTitle.Text + " - " + dsInvoice.Tables[0].Rows[0]["FLDDEBITNOTEREFERENCE"].ToString();
            }
        }
    }
