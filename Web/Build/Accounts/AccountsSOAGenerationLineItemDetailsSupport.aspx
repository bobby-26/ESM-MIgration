<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsSOAGenerationLineItemDetailsSupport.aspx.cs"
    Inherits="AccountsSOAGenerationLineItemDetailsSupport" %>
                            ...
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:Label ID="lblBudgetCodeDescription" runat="server"></asp:Label>
                                                ...
                                                <tr>
                                <td colspan="4">
                                    <b><asp:Literal ID="lblESMBudgetcode" runat="server" Text="Budget Code"></asp:Literal></b>
                                </td>
                                <td colspan="4">
                                    <asp:Label ID="lblESMBudgetcodedescription" runat="server"></asp:Label>
                                </td>
                            </tr>
