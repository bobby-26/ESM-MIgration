...
public partial class Accounts_AccountsSOAGenerationVoucherLevelFileAttachments : PhoenixBasePage
{
            ...
            else if (e.CommandName.ToUpper() == "DELETE")
            {
                ...
                if (Request.QueryString["MOD"].ToString().ToUpper() == "ACCOUNTS")
                {
                    ...
                    if (ViewState["SOAStatus"] != null && ViewState["LineYN"] == null)
                    {
                        ...
                        confirmMessage.Text = "Select the below option to delete";
                        ...
                        //RadWindowManager1.Localization.OK = "Remove only for this Voucher line item";
                        //RadWindowManager1.Localization.Cancel = "Remove from the entire voucher and all lineitems";
                        //RadWindowManager1.Localization.Close = " ";
                        //RadWindowManager1.RadConfirm("Please note that removing attachment from voucher level might affect other voucher lineitems in this voucher.Are sure want to proceed?", "order", 600, 150, null, "Confirm");
                        //ucConfirmMsg.HeaderMessage = "";
    ...
    protected void voucherlineitem_Click(object sender, EventArgs e)
    {
        try
        {
