<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsSignOnMovementUpdate.aspx.cs" Inherits="Accounts_AccountsSignOnMovementUpdate" %>
       ...
       <%-- <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" MaxHeight="330px" MaxWidth="225px" OnClientShow="OpenRadWindow">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <table width="100%" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblsignondate" runat="server" Text="Signon Date">
                        </telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Date ID="txtsignondate" runat="server" CssClass="input" Enabled="false" Width="180px" />
                    </td>
                </tr>
                <tr>
                    <td>
