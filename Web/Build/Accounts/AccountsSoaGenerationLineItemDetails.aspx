<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsSoaGenerationLineItemDetails.aspx.cs"
    Inherits="AccountsSoaGenerationLineItemDetails" %>
        ...
        <br />
         <div class="subHeader">
            <div class="divFloat" style="clear: right">
                <eluc:TabStrip ID="MenuSOALineItems" runat="server" OnTabStripCommand="MenuSOALineItems_TabStripCommand">
                </eluc:TabStrip>
            </div>
        </div>
