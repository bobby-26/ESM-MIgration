...
public partial class AccountsSoaGenerationLineItems : PhoenixBasePage
{
    ...
    //protected void gvOwnersAccount_RowUpdating(object sender, GridViewUpdateEventArgs e)
    //{
    //    try
    //    {
    //        GridView _gridView = (GridView)sender;
    ...
    //protected void gvOwnersAccount_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
    //{
    //    GridView _gridView = (GridView)sender;
    //    _gridView.EditIndex = -1;
    //    BindData();
    ...
    //    {
    //        RadLabel lbl = ((RadLabel)gvOwnersAccount.Rows[nCurrentRow].FindControl("lblVoucherId"));
    //        ViewState["FLDVOUCHERDETAILID"] = lbl.Text;
    //        ViewState["DtKey"] = ((RadLabel)_gridView.Rows[nCurrentRow].FindControl("lblDtKey")).Text;
    //        ViewState["VoucherDtKey"] = ((RadLabel)_gridView.Rows[nCurrentRow].FindControl("lblVoucherDtKey")).Text;
    //        ifMoreInfo.Attributes["src"] = "../Accounts/AccountsSOAGenerationLineItemDetailsSupport.aspx?debitnotereference=" + ViewState["debitnotereference"] + "&accountid=" + ViewState["accountid"] + "&Ownerid=" + ViewState["Ownerid"] + "&dtkey=" + ViewState["DtKey"] + "&voucherdtkey=" + ViewState["VoucherDtKey"] + "&debitnoteid=" + ViewState["debitnotereferenceid"];
    //        SetRowSelection();
    //    }
    ...
    //    {
    //        RadLabel lbl = ((RadLabel)gvOwnersAccount.Rows[nCurrentRow].FindControl("lblVoucherId"));
    //        int chkYN = (((CheckBox)_gridView.Rows[nCurrentRow].FindControl("chkIncludeEdit")).Checked) ? 1 : 0;
    ...
    //protected void gvOwnersAccount_RowCreated(object sender, GridViewRowEventArgs e)
    //{
    ...
    //    {
    //        e.Row.TabIndex = -1;
    //        e.Row.Attributes["onclick"] = Page.ClientScript.GetPostBackEventReference(gvOwnersAccount, "Select$" + e.Row.RowIndex.ToString(), false);
    //    }
    //}
