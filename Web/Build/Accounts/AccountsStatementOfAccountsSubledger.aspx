<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsStatementOfAccountsSubledger.aspx.cs"
    Inherits="AccountsStatementOfAccountsSubledger" %>
...
<head id="Head1" runat="server">
    <title>Statement of Accounts By Sub Ledger</title>
        ...
        <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
            ...
            <div>
                <table cellpadding="2" cellspacing="1" style="width: 100%">
                    ...
                    <tr>
                        <td>
                            <telerik:RadLabel ID="lblSubAccount" runat="server" Text="Sub Account From"></telerik:RadLabel>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <telerik:RadLabel ID="lblToAccount" runat="server" Text="Sub Account To"></telerik:RadLabel>
                        </td>
                        <td>
