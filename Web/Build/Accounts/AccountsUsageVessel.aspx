<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsUsageVessel.aspx.cs"
    Inherits="AccountsUsageVessel" %>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtAccountDescription" runat="server" MaxLength="10" Width="200px"
                            ReadOnly="true" CssClass="readonlytextbox"></telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RadioButtonList ID="rblAccountType" runat="server" RepeatDirection="Horizontal"
                            Width="200px" RepeatLayout="Table" CssClass="input_mandatory">
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <eluc:Hard ID="ucHard" runat="server" CssClass="input_mandatory" AppendDataBoundItems="true" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblBudgetedExpense" runat="server" Text="Budgeted Expense"></telerik:RadLabel>
                    </td>
                    <td>
                        <asp:CheckBox ID="chkBudgetedExpense" runat="server"></asp:CheckBox>
                    </td>
                </tr>
            </table>
            <br />
            <eluc:TabStrip ID="MenuRegistersBudget" runat="server" OnTabStripCommand="RegistersBudgetMenu_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gdBudget" Height="40%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText=" Budgeted Expense">
                            <HeaderStyle Width="35%" />
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
