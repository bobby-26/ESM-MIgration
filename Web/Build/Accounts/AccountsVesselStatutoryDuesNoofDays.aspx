<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsVesselStatutoryDuesNoofDays.aspx.cs"
    Inherits="AccountsVesselStatutoryDuesNoofDays" %>
...
<head id="Head1" runat="server">
    <title>Statutory Dues For Month</title>
        ...
        <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
            ...
            <table width="75%" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadLabel ID="lbloffrating" runat="server" Text="Officer/Rating"></telerik:RadLabel></td>
                    <td>
                        <eluc:Hard ID="ddlHard" runat="server" CssClass="input" AppendDataBoundItems="true"
                            HardTypeCode="50" ShortNameFilter="OFF,RAT" Width="250px" />
                    </td>
                </tr>
            </table>
            <br />
        ...
        <%--    <asp:GridView ID="gvStock" runat="server" AutoGenerateColumns="false" Font-Size="11px"
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvStock" runat="server" Height="" AllowCustomPaging="false" AllowSorting="true" AllowPaging="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="To" ItemStyle-Width="10%">
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
                            <%# SouthNests.Phoenix.Framework.General.GetDateTimeToString(DataBinder.Eval(Container, "DataItem.FLDTODATE", "{0:dd/MMM/yyyy}")) %>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="No. of days" ItemStyle-Width="10%">
                        <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                        <ItemTemplate>
                            <%# ((DataRowView)Container.DataItem)["FLDDAYSONBOARD"] %>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
