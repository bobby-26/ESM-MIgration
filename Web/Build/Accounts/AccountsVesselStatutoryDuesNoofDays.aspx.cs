...
public partial class AccountsVesselStatutoryDuesNoofDays : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            MenuStatoryDuesMain.SelectedMenuIndex = 1;
            ...
            toolbar.AddImageButton("../Accounts/AccountsVesselStatutoryDuesNoofDays.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageButton("../Accounts/AccountsVesselStatutoryDuesNoofDays.aspx", "Find", "search.png", "FIND");
            MenuStock.AccessRights = this.ViewState;
            MenuStock.MenuList = toolbar.Show();

            if (!IsPostBack)
            {
                ViewState["CALUNIT"] = PhoenixCommonRegisters.GetHardCode(PhoenixSecurityContext.CurrentSecurityContext.UserCode, 113, "ATC");
