...
public partial class AccountsVesselStatutoryDuesSignOffFormat1 : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Accounts/AccountsVesselStatutoryDuesSignOffFormat1.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageButton("../Accounts/AccountsVesselStatutoryDuesSignOffFormat1.aspx", "Find", "search.png", "FIND");
            ...
            if (!IsPostBack)
            {
                ...
                ViewState["CALUNIT"] = PhoenixCommonRegisters.GetHardCode(PhoenixSecurityContext.CurrentSecurityContext.UserCode, 113, "ARS");
                ddlComponent.Items.Clear();
                ddlComponent.Items.Insert(0, new Telerik.Web.UI.RadComboBoxItem("-- No Component Found --", ""));
            }
    ...
    protected void MenuStock_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            else if (CommandName.ToUpper().Equals("EXCEL"))
            {
                ...
                stringwriter.Write("<td><h3>" + ddlVessel.SelectedVesselName + "</h3></td>");
    ...
    protected void gvStock_RowCreated(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.Header)
        {
            ...
            HeaderCell = new TableCell();
            HeaderCell.Text = "Amount in"+ ViewState["CURRCODE"];
    ...
    protected void gvStock_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        BindData();
    }

    protected void gvStock_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        if (drv != null)
        {
            ...
            if (e.Item is GridHeaderItem)
            {
                ...
                gvStock.MasterTableView.GetItems(GridItemType.Header)[0].Cells[9].Text = "Rate Per Month (" + drv["FLDCURRENCYCODE"].ToString() + ")";
                gvStock.MasterTableView.GetItems(GridItemType.Header)[0].Cells[11].Text = "Contribution (" + drv["FLDCURRENCYCODE"].ToString() + ")";
                ViewState["CURRCODE"] = drv["FLDCURRENCYCODE"].ToString();
            }
