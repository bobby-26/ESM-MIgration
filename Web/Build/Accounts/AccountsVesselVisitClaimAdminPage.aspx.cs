...
public partial class AccountsVesselvisitClaimAdminPage : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbargrid.AddImageButton("../Accounts/AccountsVesselvisitClaimAdminPage.aspx", "Excel", "icon_xls.png", "EXCEL");
        toolbargrid.AddImageButton("../Accounts/AccountsVesselvisitClaimAdminPage.aspx", "Find", "search.png", "FIND");
    ...
    private void BindData()
    {
        try
        {
            ...
            ds = PhoenixAccountsVesselVisitITSuperintendentRegister.VisitAdvanceList(null,
                  ...
                  gvAttachment.CurrentPageIndex + 1,
    ...
    protected void ShowExcel()
    {
        ...
        DataSet ds = new DataSet();
        string[] alColumns = { "FLDFORMNUMBER", "FLDEMPLOYEENAME", "FLDVESSELNAME", "FLDCLAIMSTATUS" };
    ...
    protected void gvAttachment_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        {
            if (((UserControlQuick)e.Item.FindControl("ucClaimstatus")).SelectedValue.ToString().ToUpper().Equals("DUMMY"))
            {
            ...
            PhoenixAccountsVesselVisitITSuperintendentRegister.VisitClaimStatusUpdate(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                new Guid(((RadLabel)e.Item.FindControl("lblvisitidEdit")).Text),
                General.GetNullableInteger(((UserControlQuick)e.Item.FindControl("ucClaimstatus")).SelectedValue.ToString()));
    ...
    protected void gvAttachment_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            UserControlQuick ucClaimstatus = (UserControlQuick)e.Item.FindControl("ucClaimstatus");
            if (ucClaimstatus != null)
            {
                ucClaimstatus.QuickList = PhoenixRegistersQuick.ListQuick(1, 132);
            }
