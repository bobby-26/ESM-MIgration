<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsVesselVisitClaimApprovalRevokalHistory.aspx.cs" Inherits="AccountsVesselVisitClaimApprovalRevokalHistory" %>
...
<body>
    <form id="frmApproval" runat="server">
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Date">
                        <ItemStyle HorizontalAlign="Left" Wrap="False" />
                        <ItemTemplate>
                            <asp:Label ID="lblDate" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDUPDATEDATE","{0:dd/MMM/yyyy HH:mm:ss}")%>'></asp:Label>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
     ...
     <%--       <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="true" ReorderColumnsOnClient="true" AllowColumnHide="true" ColumnsReorderMethod="Reorder">
        ...
        <br />
        <telerik:RadLabel ID="lblah" runat="server" Text="Approval History" Font-Bold="true"></telerik:RadLabel>
        <telerik:RadGrid RenderMode="Lightweight" ID="gvApprovaHistory" runat="server" AutoGenerateColumns="False" Width="100%"
            EnableHeaderContextMenu="true" GroupingEnabled="false"
            CellPadding="3" ShowFooter="false" ShowHeader="true" EnableViewState="false" OnNeedDataSource="gvApprovaHistory_NeedDataSource">
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                AutoGenerateColumns="false">
                <NoRecordsTemplate>
                    <table runat="server" width="100%" border="0">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Date">
                        <ItemStyle HorizontalAlign="Left" Wrap="False" />
                        <ItemTemplate>
                            <asp:Label ID="lblApprovedDate" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDAPPROVEDDATE", "{0:dd/MMM/yyyy HH:mm:ss}")%>'></asp:Label>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <%-- <telerik:GridTemplateColumn HeaderText="Remarks">
                                <ItemStyle Wrap="true" HorizontalAlign="Left" Width="300px" />
                                <ItemTemplate>
                                    <asp:Label ID="lblRemarks" runat="server" Width="300px" Style="word-wrap: break-word;" 
