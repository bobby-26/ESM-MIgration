<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsVesselVisitITSuperintendentAdvanceSearch.aspx.cs" Inherits="AccountsVesselVisitITSuperintendentAdvanceSearch" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%" cellpadding="1" cellspacing="1" style="z-index: 2;">
            <tr>
                <td>
                    <telerik:RadLabel ID="lblEmpId" runat="server" Text="Employee Id"></telerik:RadLabel>
                </td>
                <td>
                    <telerik:RadTextBox ID="txtEmpId" runat="server" MaxLength="100"
                        Width="62%">
                    </telerik:RadTextBox>
                </td>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadLabel ID="lblPICName" runat="server" Text="PIC Name"></telerik:RadLabel>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadLabel ID="lblVisitType" runat="server" Text="Type"></telerik:RadLabel>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <%--    <telerik:RadLabel ID="Literal1" runat="server" Text="Visit Type"></telerik:RadLabel>--%>
                </td>
                <td>

                    <%--    <asp:DropDownList ID="ddlbudgeted" runat="server">
                                        <asp:ListItem Text="--Select--" Value="Dummy"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="Budgeted"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="Non-budgeted"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="Dry Dock"></asp:ListItem>
                                        <asp:ListItem Value="4" Text="Predelivery"></asp:ListItem>
                                    </asp:DropDownList>--%>
