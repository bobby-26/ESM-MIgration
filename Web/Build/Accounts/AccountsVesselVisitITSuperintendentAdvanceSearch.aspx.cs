...
public partial class AccountsVesselVisitITSuperintendentAdvanceSearch : PhoenixBasePage
{
    ...
    protected void MenuFilterMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("GO"))
        {
            ...
            criteria.Add("txtEmpId", txtEmpId.Text.Trim());
            ...
            criteria.Add("txtPICName", txtPICName.Text.Trim());
            //criteria.Add("ddlbudgeted", ddlbudgeted.SelectedValue);
            criteria.Add("find", "ADVANCE");
