<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsVesselvisitClaimAdminPage.aspx.cs" Inherits="AccountsVesselvisitClaimAdminPage" %>
...
<body>
    <form id="frmInvoiceAdminPage" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="99%">
            ...
            <eluc:Title runat="server" ID="Attachment" Text="Vessel Visit Claim Admin" Visible="false"></eluc:Title>
            <eluc:Status runat="server" ID="ucStatus" />
            <eluc:TabStrip ID="MenuLineItem" runat="server" OnTabStripCommand="MenuLineItem_TabStripCommand" Title="Vessel Visit Claim Admin"
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvAttachment" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowPaging="true" AllowCustomPaging="true"
                Height="64%" Width="100%" CellPadding="3" ShowHeader="true" EnableViewState="false" OnItemDataBound="gvAttachment_ItemDataBound" EnableHeaderContextMenu="true" GroupingEnabled="false"
                OnItemCommand="gvAttachment_ItemCommand" AllowSorting="true" OnNeedDataSource="gvAttachment_NeedDataSource">
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="20%" HeaderText="Employee Name">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Claim Status" HeaderStyle-Width="15%">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <HeaderStyle Wrap="false" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblVisitStatus" runat="server" Text='<%# (DataBinder.Eval(Container,"DataItem.FLDCLAIMSTATUS")) %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <telerik:RadLabel ID="lblvisitidEdit" runat="server" Text='<%# (DataBinder.Eval(Container,"DataItem.FLDVISITID")) %>'
                                    Visible="false">
                                </telerik:RadLabel>
                                <eluc:Quick ID="ucClaimstatus" runat="server" SelectedQuick='<%# DataBinder.Eval(Container,"DataItem.FLDCLAIMCODE") %>'
                                    AppendDataBoundItems="true" QuickTypeCode="132" />
                            </EditItemTemplate>
                        </telerik:GridTemplateColumn>
