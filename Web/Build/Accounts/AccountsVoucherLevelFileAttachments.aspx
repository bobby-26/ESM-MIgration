<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsVoucherLevelFileAttachments.aspx.cs" Inherits="Accounts_AccountsVoucherLevelFileAttachments" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvAttachment" runat="server" AutoGenerateColumns="False" Font-Size="11px"
            Width="100%" CellPadding="3" ShowHeader="true" EnableViewState="false" OnUpdateCommand="gvAttachment_RowUpdating" Height="71%"
            ...
            OnDeleteCommand="gvAttachment_RowDeleting" OnItemCommand="gvAttachment_ItemCommand" GroupingEnabled="false" EnableHeaderContextMenu="true"
