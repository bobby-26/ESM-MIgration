<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountsVoucherRegisterFileAttachments.aspx.cs" Inherits="Accounts_AccountsVoucherRegisterFileAttachments" %>
        ...
        <table id="tblFiles">
            ...
            <tr>
                <td colspan="3" align="right">
                    <a href="#" onclick="return addFile();"><asp:Literal ID="lblAddFile" runat="server" Text="Add File"></asp:Literal></a>
                </td>
            </tr>
        </table>
        <hr />
