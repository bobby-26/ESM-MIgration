<%@ Page Language="C#" AutoEventWireup="True" CodeFile="AccountsWCTRegister.aspx.cs" Inherits="AccountsWCTRegister"
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvWCTRegister.ClientID %>"));
               }, 200);
           }
...
<body>
    <form id="frmRegistersState" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlStateEntry">
            ...
            <%--                        <eluc:Title runat="server" ID="ucTitle" Text="WCT Register" />--%>
            <eluc:TabStrip ID="MenuRegister" runat="server" OnTabStripCommand="MenuRegister_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvWCTRegister" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                Width="100%" CellPadding="3" OnItemCommand="gvWCTRegister_RowCommand" OnItemDataBound="gvWCTRegister_ItemDataBound" GroupingEnabled="false" EnableHeaderContextMenu="true"
                OnRowCreated="gvWCTRegister_RowCreated" AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvWCTRegister_NeedDataSource"
                OnDeleteCommand="gvWCTRegister_RowDeleting" OnUpdateCommand="gvWCTRegister_RowUpdating"
                ShowFooter="true" ShowHeader="true" OnSortCommand="gvWCTRegister_Sorting" AllowSorting="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn FooterText="Type of Payment" HeaderText="Type of Payment">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                             <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lblPaymentId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDWCTPAYMENTID") %>' Visible="false"></telerik:RadLabel>
                            </ItemTemplate>
                            <FooterTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="WCT">
                            <HeaderStyle  HorizontalAlign="Right"/>
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <FooterStyle HorizontalAlign="Right" />
                             <ItemTemplate>
                                <telerik:RadLabel ID="lblWCTItem" runat="server" Text='<%#DataBinder.Eval(Container,"DataItem.FLDWCT") %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <eluc:Number ID="ucWCTEdit" runat="server" Text='<%#DataBinder.Eval(Container,"DataItem.FLDWCT") %>' CssClass="gridinput_mandatory" Mask="99.999" />
                            </EditItemTemplate>
                            <FooterTemplate>
                                <eluc:Number ID="ucWCTAdd" runat="server" CssClass="gridinput_mandatory" Mask="99.999" />
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
