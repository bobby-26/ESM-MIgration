<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardAccountsOwnerDebitCreditNoteFundReceived.aspx.cs" Inherits="Accounts_DashboardAccountsOwnerDebitCreditNoteFundReceived" %>
...
<head runat="server">
    <title>Funds Received in Last 7 Days</title>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvDebitCreditNote" runat="server" Height="300px" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                    ...
                    <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="FLDOWNERDEBITCREDITNOTEID" CommandItemDisplay="None">
                        <NoRecordsTemplate>
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Vessel" HeaderStyle-Width="100px" Visible="false">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Billing Company" HeaderStyle-Width="80px" Visible="false">

                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblBillingCompany" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSHORTCODE") %>'></telerik:RadLabel>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Type" HeaderStyle-Width="100px" Visible="false">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Sub Type" HeaderStyle-Width="150px" Visible="false">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Bank Receiving Funds" HeaderStyle-Width="200px" Visible="false">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Line Time" HeaderStyle-Width="200px" Visible="false">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Received Amt" HeaderStyle-Width="100px">
                                ...
                                <EditItemTemplate>
                                    <eluc:Number ID="txtAmountEdit" runat="server" CssClass="input_mandatory txtNumber" Visible="false"
                                        Text='<%# DataBinder.Eval(Container,"DataItem.FLDRECEIVEDAMOUNT") %>' Width="100%"></eluc:Number>
                                </EditItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Difference" HeaderStyle-Width="100px" Visible="false">
                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Received Date" HeaderStyle-Width="150px" Visible="false">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Received Status" HeaderStyle-Width="100px">
                                ...
                                <EditItemTemplate>
                                    <telerik:RadComboBox ID="ddlReceivedStatus" runat="server" CssClass="dropdown_mandatory" Visible="false"
                            ...
                            <telerik:GridTemplateColumn HeaderText="Voucher No." HeaderStyle-Width="100px" Visible="false">
                            ...
                            <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-Width="200px">
                                ...
                                <ItemTemplate>
                                    ...
                                    <img id="Img1" alt="" runat="server" src="<%$ PhoenixTheme:images/spacer.png %>" visible="false"
                                        width="3" />--%>
                                    ...
                                    <img id="Img5" alt="" runat="server" src="<%$ PhoenixTheme:images/spacer.png %>" visible="false"
                                        width="3" />--%>
                                    <%--    <asp:ImageButton runat="server" AlternateText="Reject" ImageUrl="<%$ PhoenixTheme:images/te_del.png %>" Visible="false"
                                        CommandName="Delete" CommandArgument='<%# Container.DataSetIndex %>' ID="cmdDelete"
                                        ToolTip="Delete"></asp:ImageButton>
                                    <img id="Img4" runat="server" alt="" src="<%$ PhoenixTheme:images/spacer.png%>" width="3" visible="false"/>--%>
                                    <%--          <asp:ImageButton ID="cmdHistory" runat="server" AlternateText="History" CommandArgument='<%# Container.DataSetIndex %>' Visible="false"
                                        CommandName="History" ImageUrl="<%$ PhoenixTheme:images/te_pqtes.png%>" ToolTip="History" />
                                    <img id="Img3" runat="server" alt="" src="<%$ PhoenixTheme:images/spacer.png%>" width="3" visible="false" />--%>
                                </ItemTemplate>
                                <EditItemTemplate>
