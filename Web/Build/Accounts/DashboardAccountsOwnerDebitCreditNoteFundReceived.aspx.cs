...
public partial class Accounts_DashboardAccountsOwnerDebitCreditNoteFundReceived : PhoenixBasePage
{
        ...
        try
        {
          ...
          //  NameValueCollection nvc = Filter.OwnerDebitCreditNote;
            ...
            DataSet ds = PhoenixAccountsOwnerDebitCreditNoteGenerate.OwnerDebitCreditNoteList(
                                                              ...
                                                              ,  null
                                                              ,  null
                                                              , General.GetNullableString(ViewState["ReferenceNo"].ToString())
                                                              ,  null
                                                              ,  null
                                                              ,  null
                                                              ,  null
