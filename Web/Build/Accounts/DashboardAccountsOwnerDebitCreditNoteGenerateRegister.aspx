<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardAccountsOwnerDebitCreditNoteGenerateRegister.aspx.cs" Inherits="Accounts_DashboardAccountsOwnerDebitCreditNoteGenerateRegister" %>
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                ...
                <asp:Button ID="cmdHiddenSubmit" runat="server" Text="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click"
                    CssClass="hidden" />
                <eluc:TabStrip ID="MenuDebitCreditNoteGrid" runat="server" OnTabStripCommand="MenuDebitCreditNoteGrid_TabStripCommand" Visible="false"></eluc:TabStrip>
                <eluc:TabStrip ID="Menuback" runat="server" OnTabStripCommand="Menuback_TabStripCommand"></eluc:TabStrip>
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvDebitCreditNote" runat="server" Height="300px" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                    ...
                    <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="true" ReorderColumnsOnClient="true" AllowColumnHide="true" ColumnsReorderMethod="Reorder">
                        ...
                        <Scrolling AllowScroll="true" UseStaticHeaders="true" SaveScrollPosition="true" FrozenColumnsCount="0" EnableNextPrevFrozenColumns="false" ScrollHeight="" />
