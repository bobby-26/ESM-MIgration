<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UACCSpecificReport.aspx.cs" Inherits="Accounts_UACCSpecificReport" %>
...
<body>
    ...
    <div class="navigation" id="Div2" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader" style="position: relative">
            <eluc:Title runat="server" ID="Title3" Text="UACC Specific Report" ShowMenu="true">
            </eluc:Title>
            <asp:Button runat="server" ID="cmdHiddenSubmit" />
        </div>
        <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
            <eluc:TabStrip ID="UACCSpecificReport" runat="server" OnTabStripCommand="UACCSpecificReport_TabStripCommand"
                ...
                <td>
                    <div class="subHeader" style="position: relative;">
                        <span class="navSelect" style="margin-top: 0px; float: right; width: auto;">
                            <eluc:TabStrip ID="UACCSpecific" runat="server" OnTabStripCommand="UACCSpecific_TabStripCommand">
                            </eluc:TabStrip>
                        </span>
                    </div>
                </td>
