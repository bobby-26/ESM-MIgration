<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonFileAttachment.aspx.cs" Inherits="CommonFileAttachment" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <eluc:Error ID="ucError" runat="server" Text="" Visible="false" EnableViewState="false"></eluc:Error>
        ...
        <table id="tblFiles" runat="server" style="width: 100%">
            <tr>
                <td colspan="2">
                    ...
                    <asp:Literal ID="spnAllowedFileType" runat="server"></asp:Literal>.
                    <strong>Allowed overall upload size:</strong>
                    <asp:Literal ID="spnUploadSize" runat="server"></asp:Literal>.
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvAttachment" runat="server" AutoGenerateColumns="False" Width="100%" ShowHeader="true" EnableViewState="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Action">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton runat="server" AlternateText="Convert2PDF" CommandName="CONVERTTOPDF" CommandArgument="<%# Container.DataSetIndex %>" ID="cmdConvert" ToolTip="Convert to PDF">
                                    <span class="icon"><i class="fas fa-file-pdf"></i></span>
                            </asp:LinkButton>
                            <asp:LinkButton runat="server" AlternateText="PDFDOWNLOAD" CommandName="PDFDOWNLOAD" CommandArgument="<%# Container.DataSetIndex %>" ID="cmdDownload" ToolTip="Download Pdf">
