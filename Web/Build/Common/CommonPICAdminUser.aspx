<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPICAdminUser.aspx.cs" Inherits="CommonPICAdminUser" %>
        ...
        <ContentTemplate>                
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <eluc:Title runat="server" ID="ucTitle" Text="Invoice PIC" ShowMenu="false" /><asp:Button ID="cmdHiddenSubmit" runat="server" OnClick="cmdHiddenSubmit_Click" />
                    </div>
                </div>
                ...
                <div id="divFind" style="position: relative; z-index: 2">
                    <table id="tblConfigureUser" width="75%">
                        <tr>
                            <td>
                                <asp:Literal ID="lblUserName" runat="server" Text="User Name"></asp:Literal>
                            </td>
                            <td>
                                <asp:TextBox ID="txtSearch" runat="server" MaxLength="100" CssClass="input" Width="200px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:Literal ID="lblName" runat="server" Text="Name"></asp:Literal>
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="txtFullName" MaxLength="100" CssClass="input" Width="200px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <eluc:Department runat="server" ID="ucDepartment" Width="200px" CssClass="input" AutoPostBack="true" AppendDataBoundItems="true" />
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField >
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:LinkButton ID="lblUserNameHeader" runat="server" CommandName="Sort" CommandArgument="FLDUSERNAME" ForeColor="White">Username&nbsp;</asp:LinkButton>
