<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPhoenixAuditChanges.aspx.cs" Inherits="CommonPhoenixAuditChanges" %>
...
<head runat="server">
    <title>Audit Changes</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvAuditTrail" runat="server" AllowCustomPaging="false" AllowSorting="true" AllowPaging="false"
                        ...
                        <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                           AutoGenerateColumns="false"  TableLayout="Fixed">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel RenderMode="Lightweight" runat="server" ID="lblDate" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDDATE") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>   
                        <telerik:GridTemplateColumn HeaderText="Field">
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <ItemTemplate>
                                <telerik:RadLabel RenderMode="Lightweight" runat="server" ID="lblCaption" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDTCAPTION") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>   
                        <telerik:GridTemplateColumn HeaderText="Modified By">
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <ItemTemplate>
                                <telerik:RadLabel RenderMode="Lightweight" runat="server" ID="lblModifiedBy" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDMODIFIEDBY") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>                                                                    
                        <telerik:GridTemplateColumn HeaderText="New Value">
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <ItemTemplate>
                                <telerik:RadLabel RenderMode="Lightweight" runat="server" ID="lblNewValue" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDCHANGED") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>                                                                    
                        <telerik:GridTemplateColumn HeaderText="Old Value">
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <ItemTemplate>
                                <telerik:RadLabel RenderMode="Lightweight" runat="server" ID="lblOldValue" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDORIGINAL") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn> 
                                 </Columns>
