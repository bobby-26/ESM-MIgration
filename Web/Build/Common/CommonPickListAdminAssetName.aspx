<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListAdminAssetName.aspx.cs" Inherits="Common_CommonPickListAdminAssetName" %>
...
<head runat="server">
    <title>Asset Name List</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="subHeader" style="position: relative">
            <div id="divHeading">
                <eluc:Title runat="server" ID="ucTitle" Text="Asset List" />
            </div>
        </div>
                    ...
                    <asp:GridView ID="gvAssetName" runat="server" AutoGenerateColumns="False" CellPadding="3"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField FooterStyle-HorizontalAlign="Center">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" AlternateText="Item List" ImageUrl="<%$ PhoenixTheme:images/annexure.png %>"
                                        CommandName="ITEMLIST" CommandArgument="<%# Container.DataItemIndex %>" ID="cmdItem"
                                        ToolTip="Item List"></asp:ImageButton>
                                </ItemTemplate>
                        </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
