...
public partial class Common_CommonPickListAdminItemName : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Request.QueryString["ASSEMBLYPARENTID"] != string.Empty)
            {
                ViewState["ASSEMBLYPARENTID"] = Request.QueryString["ASSEMBLYPARENTID"];
            }
            else
            {
                ViewState["ASSEMBLYPARENTID"] = string.Empty;
            }
    ...
    protected void Asset_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../Common/CommonPickListAdminAssetName.aspx?CategoryType=" + string.Empty + "&ZoneId=" + ViewState["COMPANYID"].ToString());
            }
        }
        catch (Exception ex)
        {
    ...
    private void BindData()
    {
        ...
        ds = PhoenixCommonAdministration.ItemNameSearch(
            txtAssetName.Text.Trim()
            , new Guid (ViewState["ASSEMBLYPARENTID"].ToString())
    ...
    protected void gvAssetName_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToUpper().Equals("RELATION"))
        {
            ...
            Response.Redirect("../Common/CommonPickListAdminItemName.aspx?ASSETID=" + lblAssetId.Text);
        }
    }
