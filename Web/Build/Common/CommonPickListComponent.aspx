<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListComponent.aspx.cs" Inherits="CommonPickListComponent" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvComponent" runat="server" Height="80%" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" EnableViewState="false" GridLines="None"  Font-Size="11px" OnItemCommand="gvComponent_ItemCommand" OnSortCommand="gvComponent_SortCommand"
