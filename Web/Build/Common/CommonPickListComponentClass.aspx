<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListComponentClass.aspx.cs"
    Inherits="CommonPickListComponentClass" %>
...
<body>
    ...
    <br clear="all" />
    <asp:UpdatePanel runat="server" ID="pnlComponentClass">
        <ContentTemplate>
                ...
                <asp:GridView ID="gvStockClass" runat="server" AutoGenerateColumns="False" CellPadding="3"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            ...
                            <HeaderTemplate>
                                <asp:LinkButton ID="lblComponentClassHeader" runat="server" CommandName="Sort" CommandArgument="FLDQUICKNAME"
                                    ForeColor="White">Component Class&nbsp;</asp:LinkButton>
                                <img id="FLDQUICKNAME" runat="server" visible="false" />
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblComponentClassId" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDQUICKCODE") %>'
                                    Visible="false"></asp:Label>
                                <asp:LinkButton ID="lnkComponentClass" runat="server" CommandArgument='<%# Container.DataItemIndex %>'
                        ...
                        <asp:TemplateField>
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <HeaderTemplate>
                                <asp:Label ID="lblShortComponentNameHeader" runat="server">Short Name</asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:Label ID="lblShortComponentName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSHORTNAME") %>'
                                    Visible="false"></asp:Label>
