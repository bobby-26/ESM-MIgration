<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListCrewOnboardMultiSelect.aspx.cs" Inherits="CommonPickListCrewOnboardMultiSelect" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <eluc:TabStrip ID="MenuConfirm" runat="server" OnTabStripCommand="Confirm_TabStripCommand"></eluc:TabStrip>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="90%" CssClass="scrolpan">
            ...
            </table><%--OnItemCommand="gvCrewList_ItemCommand"--%>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false" GroupsDefaultExpanded="true"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="">
                            ...
                            <HeaderTemplate>
                                <telerik:RadCheckBox ID="chkAllEmployee" runat="server" Text="Check All" AutoPostBack="true"
