<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListDailyWorkPlanRAExtn.aspx.cs" Inherits="CommonPickListDailyWorkPlanRAExtn" %>
                ...
                <tr>
                    ...
                    <td width="35%">
                        <telerik:RadRadioButtonList ID="rblType" runat="server" CssClass="input" Direction="Horizontal"
                            ...
                            <Items>
                                <telerik:ButtonListItem Text="Process" Value="0" />
                                <telerik:ButtonListItem Text="Generic" Value="1" />
                                <telerik:ButtonListItem Text="Machinery" Value="3" />
                                <telerik:ButtonListItem Text="Navigation" Value="2" />
                                <telerik:ButtonListItem Text="Cargo" Value="4" />
                            </Items>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Activity/Condition">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblActivity" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPROCESSNAME")  %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Reference No" HeaderStyle-Width="20%">
