<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListDesignedForm.aspx.cs" Inherits="Common_CommonPickListDesignedForm" %>
...
<head runat="server">
    <title>Designed Form List</title>
        ...
        <telerik:RadAjaxPanel ID="pnlCategory" runat="server" Height="94%">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <telerik:RadLabel ID="lblCategory" runat="server" Text="Form Builder Category"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadDropDownList ID="ddlParentCategory" runat="server" CssClass="input" Width="300px" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlParentCategory_Changed"
                            DataTextField="FLDFORMCATEGORYNAME" DataValueField="FLDFORMCATEGORYID" AutoPostBack="true" />
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCategory" runat="server" AllowPaging="true" AllowCustomPaging="true" AllowSorting="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true"
                    AllowNaturalSort="false" AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="FLDFORMID">
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn Visible="false">
                            ...
                            <headertemplate>
                                    ...
                                    <img id="FLDCATEGORYNUMBER" runat="server" visible="false" />
                                </headertemplate>
                            <itemtemplate>
                                    <telerik:RadLabel runat="server" ID="lblFormId" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDFORMID") %>'
                                        Visible="false"></telerik:RadLabel>
                                    <telerik:RadLabel runat="server" ID="lblFormNumber" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDFORMNAME") %>'></telerik:RadLabel>
                                </itemtemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn>
                            <itemstyle horizontalalign="Left" wrap="False" />
                            <headertemplate>
                                    <telerik:RadLabel ID="lblCategoryNameHeader" runat="server">Form Name</telerik:RadLabel>
                                </headertemplate>
                            <itemtemplate>
                                    <asp:LinkButton ID="lnkFormName" runat="server" CommandName="SELECT" CommandArgument='<%# Container.DataItem %>'
                                        Text='<%# DataBinder.Eval(Container,"DataItem.FLDFORMNAME") %>'></asp:LinkButton>
                                </itemtemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn>
                            <headertemplate>
                                    <telerik:RadLabel ID="lblActive" runat="server">Active (Y/N)</telerik:RadLabel>
                                </headertemplate>
                            <itemtemplate>
                                    <telerik:RadLabel runat="server" ID="lblActiveYN" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDACTIVEYN") %>'></telerik:RadLabel>
                                </itemtemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn>
                            <headertemplate>
                                    <telerik:RadLabel ID="lblhdStatus" runat="server">Status</telerik:RadLabel>
                                </headertemplate>
                            <itemtemplate>
