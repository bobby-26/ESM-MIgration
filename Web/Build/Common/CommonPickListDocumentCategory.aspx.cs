...
public partial class CommonPickListDocumentCategory : PhoenixBasePage
{
    ...
    private void BindData()
    {
        try
        {
            ...
            ds = PhoenixCommonDocumentManagement.DocumentChildCategorySearch(General.GetNullableGuid(ddlParentCategory.SelectedValue.ToString()), 
                txtNameSearch.Text,
