<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListDocumentManagementTree.aspx.cs" Inherits="CommonPickListDocumentManagementTree" %>
    ...
    <script type="text/javascript">
        ...
        function SetSourceURL(type, name, selectednode) {
            ...
            if (type != 2 && type != 3 && type != 5 && type != 6) {
                alert('Please select either documents, sections, forms, posters.');
                return false;
            }
            else {
