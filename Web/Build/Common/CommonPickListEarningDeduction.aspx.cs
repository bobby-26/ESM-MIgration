...
public partial class CommonPickListEarningDeduction : PhoenixBasePage
{
    ...
    private void BindData()
    {
        try
        {
            ...
            DataTable dt = PhoenixCommonVesselAccounts.SearchTempVesselEarningDeduction(PhoenixSecurityContext.CurrentSecurityContext.VesselID, new Guid(ViewState["UID"].ToString())
