<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListGlobalComponent.aspx.cs" Inherits="CommonPickListGlobalComponent" %>
...
<head runat="server">
    <title>Global Component List</title>
            ...
            <div id="search">
                <table width ="100%">
                    <tr>
                        ...
                        <td width="40%">
                            <telerik:RadTextBox ID="txtNumberSearch" CssClass="input" runat="server" Width="180px"></telerik:RadTextBox>
                        </td>
                        <td width="10%">
                            <telerik:RadLabel ID="lblComponentName" runat="server" Text="Name"></telerik:RadLabel>
                        </td>
                        <td width="40%">
                            <telerik:RadTextBox runat="server" CssClass="input" ID="txtComponentNameSearch" Width="180px"></telerik:RadTextBox>
                        </td>
                    </tr>
                </table>
            </div>
