...
public partial class CommonPickListGlobalLocation : PhoenixBasePage
{
    ...
    private void BindData()
    {
        try
        {
            ...
            ds = PhoenixInventoryComponent.LocationComponentSearch(General.GetNullableString(txtNumber.Text),
