<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListPreSeaCourseUser.aspx.cs" Inherits="CommonPickListPreSeaCourseUser" %>
        ...
        <ContentTemplate>                
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <eluc:Title runat="server" ID="ucTitle" Text="Users" ShowMenu="false" /><asp:Button ID="cmdHiddenSubmit" runat="server" OnClick="cmdHiddenSubmit_Click" />
                    </div>
                </div>
                ...
                <div id="divFind" style="position: relative; z-index: 2">
                    <table id="tblConfigureUser" width="100%">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtFullName" MaxLength="100" CssClass="input" Width="360px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <eluc:Department runat="server" ID="ucDepartment" CssClass="input" AutoPostBack="true" AppendDataBoundItems="true" />
                            </td>
                        </tr>
                    </table>
                </div>
