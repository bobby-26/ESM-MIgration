...
public partial class CommonPickListStockClass : PhoenixBasePage
{
    ...
    protected void gvStockClass_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (Request.QueryString["mode"] == "custom")
        {
            ...
            Label lbl = (Label)_gridView.Rows[nCurrentRow].FindControl("lblStockClassId");
            nvc.Add(lbl.ID, lbl.Text);
            LinkButton lb = (LinkButton)_gridView.Rows[nCurrentRow].FindControl("lnkStockClass");
