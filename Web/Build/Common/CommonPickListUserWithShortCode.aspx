<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListUserWithShortCode.aspx.cs" Inherits="CommonPickListUserWithShortCode" %>
                        ...
                        <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Short Code">
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="lblusershortCode" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSHORTCODE") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
