...
public partial class CommonPickListUserWithShortCode : PhoenixBasePage
{
    ...
    protected void gvUser_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (Request.QueryString["mode"] == "custom")
        {
            ...
            Label lblMiddleName = (Label)_gridView.Rows[nCurrentRow].FindControl("lblMiddleName");
        ...
        else
        {
            ...
            nvc = Filter.CurrentPickListSelection;
             Label lblusershortCode = (Label)_gridView.Rows[nCurrentRow].FindControl("lblusershortCode");
            Label lblFirstName = (Label)_gridView.Rows[nCurrentRow].FindControl("lblFirstName");
            Label lblMiddleName = (Label)_gridView.Rows[nCurrentRow].FindControl("lblMiddleName");
            Label lblLastName = (Label)_gridView.Rows[nCurrentRow].FindControl("lblLastName");
            nvc.Set(nvc.GetKey(1), lblusershortCode.Text);
            nvc.Set(nvc.GetKey(2), lblFirstName.Text + " " + lblMiddleName.Text + " " + lblLastName.Text);
            Label lblUserCode = (Label)_gridView.Rows[nCurrentRow].FindControl("lblUserCode");
            ...
            Label lblDesignation = (Label)_gridView.Rows[nCurrentRow].FindControl("lblDesignation");
            nvc.Set(nvc.GetKey(5), lblDesignation.Text);
