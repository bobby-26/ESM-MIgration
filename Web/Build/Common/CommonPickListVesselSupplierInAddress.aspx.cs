...
public partial class CommonPickListVesselSupplierInAddress : PhoenixBasePage
{
    ...
    private void BindData()
    {
        try
        {
            ...
            ds = PhoenixCommonRegisters.VesselSupplierAddressSearch(int.Parse(ViewState["VESSELID"].ToString()), null
    ...
    protected void gvAddress_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (Request.QueryString["mode"] == "custom")
        {
            ...
            LinkButton lb = (LinkButton)_gridView.Rows[nCurrentRow].FindControl("lnkSupplierName");
            nvc.Add(lb.ID, lb.Text.ToString());
            Label lbl = (Label)_gridView.Rows[nCurrentRow].FindControl("lblSupplierAddressCode");
