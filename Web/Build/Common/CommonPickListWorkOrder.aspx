<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CommonPickListWorkOrder.aspx.cs"
    Inherits="CommonPickListWorkOrder" %>
            ...
            <div id="search">
                <table>
                    <tr>
                        ...
                        <td>
                            <telerik:RadTextBox ID="txtOrderNumber" CssClass="input" runat="server" Text=""></telerik:RadTextBox>
                        </td>
                        <td>
