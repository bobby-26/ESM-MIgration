...
public partial class FileDownload : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["filename"]) && !string.IsNullOrEmpty(Request.QueryString["filepath"]) && !string.IsNullOrEmpty(Request.QueryString["mod"]))
            {
                ...
                fileDownload(filename, path+@"\EmailAttachments" + filepath);
            }
        }
        catch (Exception ex)
        {
