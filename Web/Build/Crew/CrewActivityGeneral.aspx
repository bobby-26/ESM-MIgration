<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewActivityGeneral.aspx.cs"
    Inherits="CrewActivityGeneral" %>
...
<body onload="resize();" onresize="resize();">
    <form id="form1" runat="server">
        ...
        <eluc:TabStrip ID="CrewActivity" runat="server" OnTabStripCommand="CrewActivity_TabStripCommand" TabStrip="true"></eluc:TabStrip>
        ...
        <div style="width: 100%; height: 91%; overflow: hidden;">
            <iframe runat="server" id="ifMoreInfo" frameborder="0" scrolling="yes" width="100%"></iframe>
        </div>
    </form>
</body>
</html>
