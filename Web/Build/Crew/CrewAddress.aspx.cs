...
public partial class CrewAddress : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dt = PhoenixCrewPortalDetailsConfirmation.ListEmployeeAddressBySeafarer(Convert.ToInt32(Filter.CurrentCrewSelection), General.GetNullableInteger("1"));
            if (dt.Rows.Count > 0 && Request.QueryString["portal"] == null)
                toolbarmain.AddButton("Approve Details", "APPROVE", ToolBarDirection.Right);

            CrewAddressMain.AccessRights = this.ViewState;
            CrewAddressMain.MenuList = toolbarmain.Show();
            if (!IsPostBack)
            {
    ...
    protected void CrewAddressMain_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                String script = String.Format("javascript:openNewWindow('spnPickListVendor', 'codehelp1', '" + Session["sitepath"] + "/CrewOffshore/CrewOffshoreEmployeeAddressConfirmationEdit.aspx?empid=" + General.GetNullableInteger(Filter.CurrentCrewSelection) + "');");
    ...
    public void SaveEmployeeAddress()
    {
        try
        {
            ...
            int Permanentaddressid = PhoenixCrewAddress.InsertEmployeeAddress(PhoenixSecurityContext.CurrentSecurityContext.UserCode
            ...
            int localaddressid = PhoenixCrewAddress.InsertEmployeeAddress(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                               , Convert.ToInt32(Filter.CurrentCrewSelection)
    ...
    public void UpdateEmployeeAddress()
    {
        try
        {
            ...
            int Permanentaddressid = PhoenixCrewAddress.UpdateEmployeeAddress(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                            , Convert.ToInt32(Filter.CurrentCrewSelection)
            ...
            int localaddressid = PhoenixCrewAddress.UpdateEmployeeAddress(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                            , Convert.ToInt32(Filter.CurrentCrewSelection)
