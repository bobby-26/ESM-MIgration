...
public partial class CrewCompanyExperienceList : PhoenixBasePage 
{
    ...
    protected void EditCrewCompanyExperience(int companyexperienceid)
    {
		...
		if (ds.Tables[0].Rows.Count > 0)
		{
            ...
            if (dr["FLDPROMOTEDSIGNOFF"].ToString() == "1")
            {
                ViewState["PROMOTEDONBOARDYN"] = "1";
                txtPromotedReason.Text = "Promtd Onbd";
                txtPromotedReason.Visible = true;
                ucSignOffReason.Visible = false;
                ucSignOffPort.CssClass = "input";
            }
            else
            {
                ViewState["PROMOTEDONBOARDYN"] = "";
                txtPromotedReason.Visible = false;
                ucSignOffReason.Visible = true;
            }
            ...
            txtSignOnRemarks.Text = dr["FLDSIGNONREMARKS"].ToString();
            txtSignOffRemarks.Text = dr["FLDSIGNOFFREMARKS"].ToString();
            ...
            chkPromtedyn.Checked = dr["FLDPROMOTEDSIGNOFF"].ToString() == "1" ? true : false;
            ...
            txtRelieverName.Text = dr["FLDRELIEVERNAME"].ToString();
            txtRelieverRank.Text = dr["FLDRELIEVERRANK"].ToString();
    ...
    private void SetEditable(bool canedit)
    {
        ...
        txtSignOnRemarks.Enabled = canedit;
        txtSignOffRemarks.Enabled = canedit;
                ...
                if (IsValidCrewCompanyExperience())
                {
                    ...
                    if (Request.QueryString["CrewCompanyExperienceId"] != null)
                    {
                        if (PhoenixSecurityContext.CurrentSecurityContext.DatabaseCode.ToUpper().Equals("OFFSHORE"))
                        {
                           ...
                           , General.GetNullableInteger(Request.QueryString["sid"])
	...
	protected void DisableSignoffReason(object sender,EventArgs e)
	{
		if (chkPromtedyn.Checked == true)
		{
			ucSignOffPort.CssClass = "";
		}
		else
		{
			ucSignOffPort.CssClass = "dropdown_mandatory";
		}
	}
}
