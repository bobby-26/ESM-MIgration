<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewContractReport.aspx.cs" Inherits="Crew_CrewContractReport" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
                ...
                <telerik:RadGrid ID="gvCrew" runat="server" AutoGenerateColumns="False" Font-Size="11px" onsorting="gvCrew_Sorting"
                                 ...
                                 <telerik:GridTemplateColumn HeaderText="Rank">
                                  ...
                                  <telerik:GridTemplateColumn HeaderText="Principal">
                                   ...
                                   <telerik:GridTemplateColumn HeaderText="Sign Off">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Short Contract YN">

                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDSHORTCONTRACT") %>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                  <telerik:GridTemplateColumn HeaderText="Contract Month">

                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDCONTRACTMONTHS") %>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                      </Columns>
