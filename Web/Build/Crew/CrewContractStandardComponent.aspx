<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewContractStandardComponent.aspx.cs"
    Inherits="CrewContractStandardComponent" ValidateRequest="false" %>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading" style="vertical-align: top">
                        <eluc:Title runat="server" ID="ucTitle" Text="Standard" ShowMenu="false" />
                    </div>
                </div>
                ...
                <table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Literal ID="lblStandardWageComponents" runat="server" Text="Standard Component"></asp:Literal>
                            </td>
                            <td>
                                <asp:TextBox ID="txtStandardWageComponents" runat="server" CssClass="input readonlytextbox"
