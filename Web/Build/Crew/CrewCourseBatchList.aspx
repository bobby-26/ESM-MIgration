<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewCourseBatchList.aspx.cs"
    Inherits="CrewCourseBatchList" MaintainScrollPositionOnPostback="true" %>
        ...
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div id="divFind" style="position: relative; z-index: 2">
                    <table id="tblConfigureBatchList" width="100%" cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCourse" runat="server" DataTextField="FLDDOCUMENTNAME" DataValueField="FLDDOCUMENTID"
                                    OnDataBound="ddlCourse_DataBound" CssClass="dropdown_mandatory" AutoPostBack="true"
                    ...
                    <asp:GridView ID="gvBatchList" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField FooterStyle-HorizontalAlign="Center">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" AlternateText="Batch Details" ImageUrl="<%$ PhoenixTheme:images/course-request.png %>"
                                        CommandName="BATCH" CommandArgument="<%# Container.DataItemIndex %>" ID="cmdBatchDetails"
                                        ToolTip="Batch Details"></asp:ImageButton>
                                </ItemTemplate>
