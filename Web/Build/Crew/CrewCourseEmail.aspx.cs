...
public partial class CrewCourseEmail : PhoenixBasePage
{
    ...
    private void CourseMail()
    {
        ...
        if (dt.Rows.Count >= 1)
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                {
                    filepath = PhoenixGeneralSettings.CurrentGeneralSetting.AttachmentPath + "/" + dt1.Rows[i]["FLDFILEPATH"].ToString().ToString();
