<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewCourseEnrollment.aspx.cs"
    Inherits="CrewCourseEnrollment" %>
...
<body onload="resize()" onresize="resize()">
    <form id="frmCourseEnrollment" runat="server">
    ...
    <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader" style="position: relative">
            <div id="divHeading">
                <eluc:Title runat="server" ID="ucTitle" Text="Course Enrollment"></eluc:Title>
            </div>
        </div>
        <div style="top: 0px; right: 0px; position: absolute">
            <eluc:TabStrip ID="MenuCourseEnrollment" runat="server" OnTabStripCommand="CourseEnrollment_TabStripCommand"
