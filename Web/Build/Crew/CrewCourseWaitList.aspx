<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewCourseWaitList.aspx.cs"
    Inherits="CrewCourseWaitList" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmCrewWaitList" runat="server" submitdisabledcontrols="true">
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" CombineScripts="false">
    </ajaxToolkit:ToolkitScriptManager>
    <asp:UpdatePanel runat="server" ID="pnlWaitList">
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div id="divFind" style="position: relative; z-index: 2">
                    <table id="tblConfigureWaitList" width="100%">
                        <tr>
                            <td>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td>
                                <asp:Literal ID="lblStatusWaitList" runat="server" Text="Wait List"></asp:Literal>
                            </td>
                            <td>
                ...
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuCrewWaitList" runat="server" OnTabStripCommand="CrewWaitList_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="divGrid" style="position: relative; z-index: 0">
                    <asp:GridView ID="gvWaitList" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowCommand="gvWaitList_RowCommand" OnRowDataBound="gvWaitList_ItemDataBound"
                        OnSorting="gvWaitList_Sorting" AllowSorting="true" OnRowEditing="gvWaitList_RowEditing" OnRowDeleting="gvWaitList_RowDeleting"
                        ...
                        <asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Literal ID="lblOnWaitListSince" runat="server" Text="On Wait List Since"></asp:Literal>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField FooterStyle-HorizontalAlign="Center">
                                ...
                                <ItemTemplate>
                                   <asp:ImageButton runat="server" AlternateText="Move to Participant List" ImageUrl="<%$ PhoenixTheme:images/45.png %>"
                                     CommandName="PARTICIPANTLIST" CommandArgument='<%# Container.DataItemIndex %>' ID="cmdWL"
                ...
                <eluc:Confirm ID="ucConfirm" runat="server" OnConfirmMesage="btn_Click" OKText="Yes" CancelText="No" /> 
            </div>
        </ContentTemplate>
        <Triggers>
            <asp:PostBackTrigger ControlID="gvWaitList" />
        </Triggers>
    </asp:UpdatePanel>
    </form>
</body>
