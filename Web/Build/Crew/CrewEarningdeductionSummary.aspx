<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewEarningdeductionSummary.aspx.cs"
    Inherits="CrewEarningdeductionSummary" %>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div id="divGrid" style="position: relative; z-index: 0; width: 100%;">
                    <asp:GridView ID="gvCrewSearch" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" onrowcreated="gvCrewSearch_RowCreated" OnRowDataBound="gvCrewSearch_RowDataBound" GridLines="None">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Earning / Deduction" ItemStyle-Width="20%" HeaderStyle-Width="20%">
                                <ItemStyle Wrap="False" HorizontalAlign="Left" Width="100px"></ItemStyle>
                                <ItemTemplate>   <asp:Label ID="lblType" Visible="false" runat="server" Text='<%#((DataRowView)Container.DataItem)["FLDCOMPONENTNAME"]%>'></asp:Label>
                                    <asp:Label ID="lblea" runat="server" Text='<%#((DataRowView)Container.DataItem)["FLDEARNINGDEDUCTION"] %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Purpose"  ItemStyle-Width="35%" HeaderStyle-Width="35%">
                                <ItemStyle Wrap="False" HorizontalAlign="Left" Width="100px"></ItemStyle>
                                <ItemTemplate>
                                    <asp:Label ID="lblPurposeText" runat="server" Text='<%#((DataRowView)Container.DataItem)["FLDPURPOSE"] %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                           
                            <asp:TemplateField HeaderText="Month & Year" ItemStyle-Width="15%" HeaderStyle-Width="15%">
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                    <%#((DataRowView)Container.DataItem)["FLDMONTHYEAR"] %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Date" ItemStyle-Width="15%" HeaderStyle-Width="15%">
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                    <%#string.Format("{0:dd/MM/yyyy}", ((DataRowView)Container.DataItem)["FLDDATE"]) %>
                                </ItemTemplate>
                            </asp:TemplateField> 
                            <asp:TemplateField HeaderText="Amount" ItemStyle-Width="15%" HeaderStyle-Width="15%">
                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                <ItemTemplate>
                                      <asp:Label ID="lblAmount" runat="server" Text='<%#((DataRowView)Container.DataItem)["FLDAMOUNT"]%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
