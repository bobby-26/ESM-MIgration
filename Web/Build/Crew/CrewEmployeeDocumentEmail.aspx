<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewEmployeeDocumentEmail.aspx.cs" Inherits="CrewEmployeeDocumentEmail" %>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadRadioButtonList ID="rblEmailTo" runat="server" Layout="Flow" Columns="2" Direction="Horizontal" 
                            ...
                            <Items>
                                <telerik:ButtonListItem Value="1" Text="User"  Selected="true" />
                                <telerik:ButtonListItem Value="2" Text="Employee"/>
                            </Items>
...
<%--                <tr >
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadFileExplorer RenderMode="Lightweight" runat="server" ID="FileExplorer1" Width="698px" Height="100px" DisplayUpFolderItem="false"
            ...
            <table>
                <tr>
                    <td>
                        <telerik:RadEditor ID="edtBody" runat="server" Width="99%" RenderMode="Lightweight" SkinID="DefaultSetOfTools" OnClientLoad="OnClientLoad">                         
                        </telerik:RadEditor>
                    </td>
                </tr>
            </table>
