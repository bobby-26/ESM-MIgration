<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewEmployeeSignOnOffGanttChart.aspx.cs" Inherits="CrewEmployeeSignOnOffGanttChart" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGantt RenderMode="Lightweight" runat="server" ID="RadGantt1" Height="300px" ListWidth="250px" AllowColumnResize="true"
            ...
            <Columns>
                ...
                <telerik:GanttBoundColumn DataField="Title" DataType="String" Width="130px" HeaderText="Name"></telerik:GanttBoundColumn>
                <telerik:GanttBoundColumn DataField="Start" DataType="DateTime" DataFormatString="dd/MM/yy"  HeaderText="Start"></telerik:GanttBoundColumn>
                <telerik:GanttBoundColumn DataField="End" DataType="DateTime" DataFormatString="dd/MM/yy"  HeaderText="End"></telerik:GanttBoundColumn>
            </Columns>

            <DataBindings>
                <TasksDataBindings
                    IdField="FLDID" TitleField="FLDNAME" 
                    StartField="FLDSTARTDATE" EndField="FLDENDDATE" />
