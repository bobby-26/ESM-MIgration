<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewFormat.aspx.cs" Inherits="Crew_CrewFormat" %>
...
<body>
    <form id="frmReportCrewList" runat="server">
        ...
        <eluc:TabStrip ID="MenuCrewOCIMF" runat="server" TabStrip="false" OnTabStripCommand="MenuCrewOCIMF_TabStripCommand"></eluc:TabStrip>
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <div>
                <iframe runat="server" id="ifMoreInfo" scrolling="auto" style="height: 530px; width: 99.5%;"></iframe>
            </div>
