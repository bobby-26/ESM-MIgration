<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewInstituteFacultyPlanner.aspx.cs" Inherits="Crew_CrewInstituteFacultyPlanner" %>
...
<head runat="server">
    <title>Faculty Planner Add</title>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <table id="tblFacultySearch" width="100%" cellpadding="1" cellspacing="1">
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblName" runat="server" Text="Faculty"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadTextBox ID="txtFaculty" runat="server" Width="350px" ReadOnly="true" CssClass="readonlytextbox"></telerik:RadTextBox>
                        <telerik:RadTextBox ID="txtinstitutefacultyId" runat="server" Width="100px"></telerik:RadTextBox>
                    </td>
                    <td>
            ...
            <br />
                ...
                <telerik:RadScheduler ID="cldFacultyPlanner" runat="server" SelectedView="MonthView" MonthView-UserSelectable="false" 
                    ShowNavigationPane="true"  OnNavigationCommand="cldFacultyPlanner_NavigationCommand" OnNavigationComplete="cldFacultyPlanner_NavigationComplete" 
                    OnAppointmentDelete="cldFacultyPlanner_AppointmentDelete" OnAppointmentDataBound="cldFacultyPlanner_AppointmentDataBound" 
                OnTimeSlotCreated="cldFacultyPlanner_TimeSlotCreated" MonthView-MinimumRowHeight="1" Height="70%" OnFormCreating="cldFacultyPlanner_FormCreating">
