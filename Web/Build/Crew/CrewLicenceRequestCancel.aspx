<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewLicenceRequestCancel.aspx.cs" Inherits="CrewLicenceRequestCancel" %>
...
<head runat="server">
      <title>Crew Licence Request Cancel</title>
...
<body>
    <form id="frmLicReqCancel" runat="server">
        ...
        <div class="subHeader">
            <eluc:Title runat="server" ID="CrewLicenceRequest" Text="Crew Licence Request Cancel" ShowMenu="false"></eluc:Title>
            <asp:Button runat="server" ID="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" />
        </div>
        
        
         <div id="divGrid" style="position: relative; z-index: 0; width: 100%;">
            <asp:GridView ID="gvLicReqCancel" runat="server" AutoGenerateColumns="False" Font-Size="11px"
