<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewMovementLog.aspx.cs" Inherits="Crew_CrewMovementLog" %>
...
<body>
    <form id="frmRegistersMovementLog" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid ID="gvMovementLog" Height="85%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" OnItemCommand="gvMovementLog_ItemCommand" OnNeedDataSource="gvMovementLog_NeedDataSource" OnItemDataBound="gvMovementLog_ItemDataBound"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Amount" AllowSorting="true" SortExpression="FLDTOTALAMOUNT">
                            ...
                            <ItemTemplate>
                               <%# DataBinder.Eval(Container,"DataItem.FLDCURRENCYCODE") %> <%# DataBinder.Eval(Container,"DataItem.FLDTOTALAMOUNT") %> 
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
