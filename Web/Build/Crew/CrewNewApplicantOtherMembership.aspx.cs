...
public partial class CrewNewApplicantOtherMembership : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Crew/CrewNewApplicantOtherMembership.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvOtherDocument')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageLink("javascript:parent.Openpopup('NAFA','','CrewTravelDocumentArchived.aspx?empid=" + Filter.CurrentNewApplicantSelection + "&type=2&t=n'); return false;", "Show Archived", "show-archive.png", "ARCHIVED");
            ...
            if (!IsPostBack)
            {
                ...
                MenuOtherMembership.AccessRights = this.ViewState;
                MenuOtherMembership.MenuList = toolbar.Show();
                MenuOtherMembership.SelectedMenuIndex = 1;
    ...
    protected void MenuOtherMembership_TabStripCommand(object sender, EventArgs e)
    {
        DataListCommandEventArgs dce = (DataListCommandEventArgs)e;

        if (dce.CommandName.ToUpper().Equals("ODOC"))
        {
            Response.Redirect("../Crew/CrewNewApplicantOtherDocument.aspx");
        }
    }
    ...
    protected void ShowExcel()
    {
        ...
        DataSet ds = PhoenixCrewTravelDocument.SearchEmployeeOtherDocument(Convert.ToInt32(Filter.CurrentNewApplicantSelection), null, 1, 1,
    ...
    protected void gvOtherDocument_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                string id = ((Label)_gridView.Rows[nCurrentRow].FindControl("lbltraveldocumentid")).Text;
    ...
    protected void gvOtherDocument_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
              ...
              && !e.Row.RowState.Equals(DataControlRowState.Selected | DataControlRowState.Edit) && !e.Row.RowState.Equals(DataControlRowState.Alternate | DataControlRowState.Selected | DataControlRowState.Edit))
            {
                ...
                img.Attributes.Add("onclick", "parent.Openpopup('MoreInfo','','CrewMoreInfo.aspx?id=" + lbl.Text + "&type=" + PhoenixCrewAttachmentType.DOCUMENTS + "','xlarge')");
