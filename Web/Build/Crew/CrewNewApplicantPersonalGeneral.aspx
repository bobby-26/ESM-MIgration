<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewNewApplicantPersonalGeneral.aspx.cs"
    Inherits="CrewNewApplicantPersonalGeneral" %>
...
<body onload="resize();" onresize="resize();">
    ...
    <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <%--<div class="subHeader" style="position: relative">
            <div id="divHeading">
                <eluc:Title runat="server" ID="Title1" Text="New Applicant" ShowMenu="<%# Title1.ShowMenu %>">
                </eluc:Title>
            </div>
        </div>--%>
