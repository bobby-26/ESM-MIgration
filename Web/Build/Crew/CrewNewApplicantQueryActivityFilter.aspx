<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewNewApplicantQueryActivityFilter.aspx.cs"
    Inherits="Crew_CrewNewApplicantQueryActivityFilter" %>
...
<head runat="server">
    <title>New Applicant Filter</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlNewApplicantEntry">
            <table cellpadding="2" cellspacing="2" width="100%">              
                ...
                <tr>
                    ...
                    <td>
                        <eluc:UserControlVesselTypeList ID="ddlVesselTypeList" runat="server" AppendDataBoundItems="true" Width="240px" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadDropDownList ID="ddlInActive" runat="server"  AppendDataBoundItems="true" Width="240px"
                            AutoPostBack="true" OnSelectedIndexChanged="ddlInActive_SelectedIndex" EnableDirectionDetection="true">
                            <Items>
                                ...
                                <telerik:DropDownListItem Text="Deleted" Value="2" />
                            </Items>
                    ...
                    <td>
                        <telerik:RadListBox ID="lstStatus" runat="server"  SelectionMode="Multiple" Width="240px"
                            DataTextField="FLDHARDNAME" DataValueField="FLDHARDCODE" Height="80px"></telerik:RadListBox>
                    </td>
                </tr>
            </table>
