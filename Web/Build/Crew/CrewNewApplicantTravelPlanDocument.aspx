<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewNewApplicantTravelPlanDocument.aspx.cs" Inherits="CrewNewApplicantTravelPlanDocument" %>
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            gvCrewTravelPlan.GridDataDiv.style.height = (Math.round(height / 3) - gvCrewTravelPlanPagerHeight - 13) + "px";
            gvHistory.GridDataDiv.style.height = (Math.round(height / 3) - gvHistoryPagerHeight - 13) + "px";
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <table width="100%" cellpadding="1" cellspacing="1">
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtName" CssClass="readonlytextbox" ReadOnly="true" Width="50%"></telerik:RadTextBox>
                    </td>
                    <td>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrewTravelPlan" runat="server" EnableViewState="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Departure Date" HeaderStyle-Width="75px">
                            <HeaderStyle HorizontalAlign="left" VerticalAlign="Middle"></HeaderStyle>
                            <HeaderTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Arrival Date" HeaderStyle-Width="75px">
                            <HeaderStyle HorizontalAlign="left" VerticalAlign="Middle"></HeaderStyle>
                            <HeaderTemplate>
                ...
                <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="true" ReorderColumnsOnClient="true" AllowColumnHide="true" ColumnsReorderMethod="Reorder">
                    ...
                    <Scrolling AllowScroll="true" UseStaticHeaders="true" SaveScrollPosition="true" ScrollHeight="120px" />
