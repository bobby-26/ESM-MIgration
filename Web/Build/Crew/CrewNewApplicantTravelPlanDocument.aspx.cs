...
public partial class CrewNewApplicantTravelPlanDocument : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            PhoenixToolbar toolbarmenu = new PhoenixToolbar();
            toolbarmenu.AddFontAwesomeButton("../Crew/CrewNewApplicantTravelPlanDocument.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            toolbar.AddFontAwesomeButton("../Crew/CrewNewApplicantTravelPlanDocument.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvHistory')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("../Crew/CrewNewApplicantTravelPlanDocument.aspx", "Add Travel History", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
    ...
    public void SetEmployeePrimaryDetails()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                txtName.Text = dt.Rows[0]["FLDFIRSTNAME"].ToString();
    ...
    private void BindData()
    {
        try
        {
            ...
            DataSet ds = PhoenixCrewTravelDocument.SearchCrewTravelPlanDocument(Convert.ToInt32(Filter.CurrentNewApplicantSelection),
    ...
    protected void MenuCrewTravelPlan_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                String scriptpopup = String.Format("javascript:openNewWindow('codehelp2','','" + Session["sitepath"] + "/Crew/CrewTravelPlanHistoryAdd.aspx?empid=" + Filter.CurrentNewApplicantSelection + "');");
    ...
    protected void gvCrewTravelPlan_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridEditableItem)
        {
            ...
            if (cme != null)
            {
                ...
                cme.Attributes.Add("onclick", "parent.openNewWindow('codehelp1', '','" + Session["sitepath"] + "/Crew/CrewTravelPlanHistoryAdd.aspx?TravelHistoryId=" + lblTravelHistoryId.Text + "&empid=" + Filter.CurrentNewApplicantSelection + "');return false;");
            }
    ...
    protected void CrewTravelHistory_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("EXCEL"))
            {
                ...
                DataSet ds = PhoenixCrewTravelDocument.SearchCrewTravelHistory(Convert.ToInt32(Filter.CurrentNewApplicantSelection),
                                                                          sortexpression, sortdirection,
