<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewPlanDetailOffSignerTravel.aspx.cs" Inherits="CrewPlanDetailOffSignerTravel" %>
...
<head id="Head1" runat="server">
    <title>Event Off-Signer Travel</title>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCCPlan" runat="server" AllowCustomPaging="true" AllowSorting="true" OnItemDataBound="gvCCPlan_ItemDataBound"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" DataKeyNames="FLDCREWEVENTDETAILID" HeaderStyle-Font-Bold="true"
                ...
                <Columns>
                    <telerik:GridTemplateColumn HeaderText="OffSigner" UniqueName="OFFSIGNER">
                        ...
                        <ItemTemplate>
                            ...
                            <telerik:RadLabel ID="lnkOffSigner" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDOFFSIGNERNAME") %>'></telerik:RadLabel>
                        </ItemTemplate>
                        <EditItemTemplate>
                            ...
                            <telerik:RadLabel ID="lblOffSignerIdEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDOFFSIGNERID") %>'
                                Visible="false">
                            </telerik:RadLabel>
                        </EditItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="Origin" UniqueName="FLDORIGINCITYID" DataField="FLDORIGINCITYID">
                        <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle"></HeaderStyle>
                        <ItemTemplate>
                            <eluc:MUCCity ID="ucOriginCity" runat="server" CssClass="dropdown_mandatory" Width="100%" Text='<%# DataBinder.Eval(Container,"DataItem.FLDORIGINCITYNAME") %>' />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
