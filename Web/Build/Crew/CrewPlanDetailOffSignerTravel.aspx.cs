...
public partial class CrewPlanDetailOffSignerTravel : PhoenixBasePage
{
    ...
    protected void CrewTab_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                PhoenixCrewChangeEventDetail.CrewEventOffsignerTravelReq(detailid
                                   , strorigincity
                                   , strdestinationcity
                ...
                PhoenixCrewChangeEventDetail.CrewEventOffsignerTravelReqInsert(new Guid(ViewState["creweventid"].ToString()));
    ...
    private void BindData()
    {
        try
        {
            ...
            ds = PhoenixCrewChangeEventDetail.CrewEventOffsignerTravelReqSearch(
                                                                  strcrewplanlist
    ...
    protected void gvCCPlan_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (ucOriginCity != null)
            {
                ...
                ucOriginCity.Text = "";
                ucOriginCity.SelectedValue = drv["FLDORIGINCITYID"].ToString();
                ucOriginCity.Text = drv["FLDORIGINCITYNAME"].ToString();
            }
