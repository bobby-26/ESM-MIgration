...
public partial class CrewPlanEventCrew : PhoenixBasePage
{
            ...
            if (CommandName.ToUpper() == "ADDPLAN")
            {
                ...
                if (gvPlan.MasterTableView.Items.Count > 0)
                {
                    foreach (GridDataItem gvr in gvPlan.MasterTableView.Items)
                    {
                        ...
                        {
                            RadLabel lblPlanId = (RadLabel)gvr.FindControl("lblCrewPlanID");
                ...
                PhoenixCrewChangeEventDetail.CrewPlanAdd(
    ...
    private void BindData()
    {
        try
        {
            ...
            DataSet ds = PhoenixCrewChangeEventDetail.CrewEventPlanSearch(int.Parse(Vesselid)
