<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewPlanEventOnboardCrew.aspx.cs" Inherits="CrewPlanEventOnboardCrew" %>
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Sign On" >
                            ...
                            <HeaderTemplate>
                                <telerik:RadLabel ID="lblSignonDateHeader" runat="server">Sign On</telerik:RadLabel>
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Relief Due" >
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <HeaderTemplate>
                                <telerik:RadLabel ID="lblReliefDateHeader" runat="server">Relief Due</telerik:RadLabel>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblReliefDate" runat="server" Text='<%#General.GetDateTimeToString(DataBinder.Eval(Container, "DataItem.FLDRELIEFDUEDATE", "{0:dd/MMM/yyyy}")) %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
