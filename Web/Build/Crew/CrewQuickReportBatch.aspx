<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewQuickReportBatch.aspx.cs"
    Inherits="Crew_CrewQuickReportBatch" %>
            ...
            <table cellpadding="0" cellspacing="0" > 
                <tr>
                   ...
                   <td style="padding-right:20px">
                    ...
                    <td style="padding-right:20px">
                        <eluc:BatchList ID="ucBatch" AppendDataBoundItems="true" runat="server" Width="270px" />
                    </td>
                </tr>
            </table>
