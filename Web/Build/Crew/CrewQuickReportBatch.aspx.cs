...
public partial class Crew_CrewQuickReportBatch : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewQuickReportBatch.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewQuickReportBatch.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixCrewQuickReports.CrewQuickBatch(General.GetNullableString(txtname.Text.Trim())
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=BatchQuickReport.xls");
        ...
        Response.Write("<tr><td style='font-family:Arial; font-size:10px;' colspan='" + (alColumns.Length).ToString() + "'><h5><center>Batch</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        string[] alCaptions = { "SNo.", "File No.", "	Name", "Rank", "Batch", "Zone", "Last Vessel", "Sign-Off Date", "Present Vessel", "Sign-On Date", "Remarks", "Availability", "Last Contact",  "Status", "Requirement" };
        ucBatch.SelectedList = ucBatch.SelectedList.ToString().Contains("Dummy,") ? ucBatch.SelectedList.ToString().Replace("Dummy,", "") : ucBatch.SelectedList;
        DataSet ds = PhoenixCrewQuickReports.CrewQuickBatch(General.GetNullableString(txtname.Text.Trim())
             , General.GetNullableString(txtFileNo.Text.Trim())
             , General.GetNullableString(ucBatch.SelectedList)
        ...
        General.SetPrintOptions("gvCrew", "Batch", alCaptions, alColumns, ds);
