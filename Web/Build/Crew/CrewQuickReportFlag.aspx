<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewQuickReportFlag.aspx.cs"
    Inherits="Crew_CrewQuickReportFlag" %>
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <table cellpadding="0" cellspacing="0">
                <tr >
                    ...
                    <td style="padding-right: 10px">&nbsp&nbsp&nbsp&nbsp<telerik:RadLabel  ForeColor="Black"  ID="lblname" runat="server" Text="Name"></telerik:RadLabel>
                    </td>
                    <td style="padding-right: 25px">
                        <telerik:RadTextBox ID="txtname" runat="server" Width="140px"></telerik:RadTextBox>
                    </td>
                    ...
                    <td style="padding-right: 25px">
                        <telerik:RadTextBox ID="txtFileNo" runat="server" Width="140px"></telerik:RadTextBox>
                    </td>
                    <td style="padding-right: 10px">
                        <telerik:RadLabel  ForeColor="Black"  ID="lblCountry" runat="server" Text="Country"></telerik:RadLabel>
                    </td>
                    <td >
                        <eluc:CountryList ID="ucCountryList" runat="server" AppendDataBoundItems="true" Width="240px"  />
                    </td>
                </tr>
            </table>
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Flag">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel  ForeColor="Black"  ID="lblcountry" Visible="true" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOUNTRYNAME") %>' />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Remarks">

                            <ItemTemplate>
                                <asp:LinkButton runat="server" ID="imgToolTip">
