<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewQuickReportLicenceDCE.aspx.cs"
    Inherits="Crew_CrewQuickReportLicenceDCE" %>
                ...
                <tr>
                    ...
                    <td >
                        <table>
                            <tr>
                                <td>
                                <eluc:Date ID="ucSignOnFromDate" runat="server" CssClass="input_mandatory" /></td>
                            </tr>
                            <tr><td>
                                <eluc:Date ID="ucSignOnToDate" runat="server" CssClass="input_mandatory" /></td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td>
                        <telerik:RadListBox ID="lstLicence" runat="server" SelectionMode="Multiple" Height="80px" Width="210px"
                            DataTextField="FLDDOCUMENTNAME" DataValueField="FLDDOCUMENTID">
                        </telerik:RadListBox>
                    </td>
                    <td>
                    ...
                    <td style="padding-right: 10px">
                        <eluc:Nationality ID="ucNationality1" runat="server" AppendDataBoundItems="true" Width="210px" />
                    </td>
                </tr>
            </table>
