...
public partial class Crew_CrewQuickReportMedical : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewQuickReportMedical.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewQuickReportMedical.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    private string MedicalSelectedList()
    {
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDROW", "FLDFILENO", "FLDNAME", "FLDRANKCODE", "FLDBATCH", "FLDZONENAME", "FLDLASTVESSELNAME", "FLDLASTSIGNOFFDATE", "FLDPRESENTVESSELNAME", "FLDPRESENTSIGNONDATE", "FLDLASTNOTESDESCRIPTION", "FLDDOA", "FLDLASTCONTACTDATE", "FLDSTATUS", "FLDSEAFARERREQUIREMENT", "FLDMEDICALNAME", "FLDISSUEDDATE", "FLDRESULT" };
        string[] alCaptions = { "SNo.", "File No.", "	Name", "Rank", "Batch", "Zone", "Last Vessel", "Sign-Off Date", "Present Vessel", "Sign-On Date", "Remarks", "Availability", "Last Contact", "Status", "Requirement" ,"Medical Name"  ,"Date of Issue" ,"Result"  };

        ds = PhoenixCrewQuickReports.CrewQuickMedicalTest(General.GetNullableString(txtname.Text.Trim())
                                                            , General.GetNullableString(txtFileNo.Text.Trim())
                                                            , General.GetNullableString(MedicalSelectedList())
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=MedicalTestQuickReport.xls");
        ...
        Response.Write("<tr><td style='font-family:Arial; font-size:10px;' colspan='" + (alColumns.Length).ToString() + "'><h5><center>MEDICAL TEST</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        string[] alColumns = { "FLDROW", "FLDFILENO", "FLDNAME", "FLDRANKCODE", "FLDBATCH", "FLDZONENAME", "FLDLASTVESSELNAME", "FLDLASTSIGNOFFDATE", "FLDPRESENTVESSELNAME", "FLDPRESENTSIGNONDATE", "FLDLASTNOTESDESCRIPTION", "FLDDOA", "FLDLASTCONTACTDATE", "FLDSTATUS", "FLDSEAFARERREQUIREMENT", "FLDMEDICALNAME", "FLDISSUEDDATE", "FLDRESULT" };
        string[] alCaptions = { "SNo.", "File No.", "	Name", "Rank", "Batch", "Zone", "Last Vessel", "Sign-Off Date", "Present Vessel", "Sign-On Date", "Remarks", "Availability", "Last Contact", "Status", "Requirement", "Medical Name", "Date of Issue", "Result" };
        DataSet ds = PhoenixCrewQuickReports.CrewQuickMedicalTest(General.GetNullableString(txtname.Text.Trim())
                                                                , General.GetNullableString(txtFileNo.Text.Trim())
                                                                , General.GetNullableString(MedicalSelectedList())
                                                                , General.GetNullableDateTime(ucSignOnFromDate.Text)
                                                                , General.GetNullableDateTime(ucSignOnToDate.Text)
        ...
        General.SetPrintOptions("gvCrew", "Medical Test", alCaptions, alColumns, ds);
