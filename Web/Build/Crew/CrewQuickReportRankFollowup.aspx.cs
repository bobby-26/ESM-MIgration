...
public partial class Crew_CrewQuickReportRankFollowup : PhoenixBasePage
{
       protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewQuickReportRankFollowup.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
            toolbar1.AddFontAwesomeButton("../Crew/CrewQuickReportRankFollowup.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixCrewQuickReports.CrewQuickRankFollowup(General.GetNullableString(txtname.Text.Trim())
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=RankFollowUpQuickReport.xls");
        ...
        Response.Write("<tr><td style='font-family:Arial; font-size:10px;' colspan='" + (alColumns.Length).ToString() + "'><h5><center>Rank Follow Up</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        string[] alCaptions = { "SNo.", "File No.", "	Name", "Rank", "Batch", "Zone", "Last Vessel", "Sign-Off Date", "Present Vessel", "Sign-On Date", "Remarks", "Availability", "Follow Up", "Last Contact", "Experience", "Status", "Requirement" };
        ucRank.selectedlist = ucRank.selectedlist.ToString().Contains("Dummy,") ? ucRank.selectedlist.ToString().Replace("Dummy,", "") : ucRank.selectedlist;
        DataSet ds = PhoenixCrewQuickReports.CrewQuickRankFollowup(General.GetNullableString(txtname.Text.Trim())
             , General.GetNullableString(txtFileNo.Text.Trim())
             , General.GetNullableDecimal(txtExperience.Text.Trim())
             , General.GetNullableString(ucRank.selectedlist)
             , General.GetNullableDateTime(ucSignOnFromDate.Text)
        ...
        General.SetPrintOptions("gvCrew", "Rank Follow Up", alCaptions, alColumns, ds);
