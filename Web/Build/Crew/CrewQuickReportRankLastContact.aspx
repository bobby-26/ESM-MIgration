<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewQuickReportRankLastContact.aspx.cs"
    Inherits="Crew_CrewQuickReportRankLastContact" %>
            ...
            <table cellpadding="0" cellspacing="0" >
                <tr>
                      ...
                      <td style="padding-right:10px">
                        <eluc:Date ID="ucSignOnFromDate" runat="server" CssClass="input_mandatory" /><br />
                     ...
                     <td style="padding-right:10px">
                       ...
                       <td style="padding-right:10px;padding-top:12px">
                        <eluc:Number runat="server" ID="txtExperience" MaxLength="4" Text="" />
                        (in months.)
                    </td>

                       <td style="padding-right:10px">&nbsp;<telerik:RadLabel ID="lblRank" runat="server" Text="Rank"></telerik:RadLabel>
                        <br />
