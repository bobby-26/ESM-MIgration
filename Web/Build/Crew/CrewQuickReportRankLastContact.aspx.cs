...
public partial class Crew_CrewQuickReportRankLastContact : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewQuickReportRankLastContact.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
            toolbar1.AddFontAwesomeButton("../Crew/CrewQuickReportRankLastContact.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDROW", "FLDFILENO", "FLDNAME", "FLDRANKCODE", "FLDBATCH", "FLDZONENAME", "FLDLASTVESSELNAME", "FLDLASTSIGNOFFDATE", "FLDPRESENTVESSELNAME", "FLDPRESENTSIGNONDATE", "FLDLASTNOTESDESCRIPTION", "FLDDOA", "FLDLASTCONTACTDATE", "FLDEXPERIENCE", "FLDSTATUS", "FLDSEAFARERREQUIREMENT" };
        string[] alCaptions = { "SNo.", "File No.", "	Name", "Rank", "Batch", "Zone", "Last Vessel", "Sign-Off Date", "Present Vessel", "Sign-On Date", "Remarks", "Availability", "Last Contact", "Experience", "Status", "Requirement" };
        ...
        ds = PhoenixCrewQuickReports.CrewQuickRankLastContact(General.GetNullableString(txtname.Text.Trim())
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=RankLastContactquickReport.xls");
        ...
        Response.Write("<tr><td style='font-family:Arial; font-size:10px;' colspan='" + (alColumns.Length).ToString() + "'><h5><center>Rank Last Contact</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        string[] alCaptions = { "SNo.", "File No.", "	Name", "Rank", "Batch", "Zone", "Last Vessel", "Sign-Off Date", "Present Vessel", "Sign-On Date", "Remarks", "Availability", "Last Contact", "Experience", "Status", "Requirement" };
        ucRank.selectedlist = ucRank.selectedlist.ToString().Contains("Dummy,") ? ucRank.selectedlist.ToString().Replace("Dummy,", "") : ucRank.selectedlist;
        DataSet ds = PhoenixCrewQuickReports.CrewQuickRankLastContact(General.GetNullableString(txtname.Text.Trim())
             , General.GetNullableString(txtFileNo.Text.Trim())
             , General.GetNullableDecimal(txtExperience.Text.Trim())
             , General.GetNullableString(ucRank.selectedlist)
             , General.GetNullableDateTime(ucSignOnFromDate.Text)
        ...
        General.SetPrintOptions("gvCrew", "Rank Last Contact", alCaptions, alColumns, ds);
