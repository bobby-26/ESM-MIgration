<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewQuickReportStatus.aspx.cs"
    Inherits="Crew_CrewQuickReportStatus" %>
                    ...
                    <eluc:TabStrip ID="MenuReportsFilter" runat="server" OnTabStripCommand="ReportsFilter_TabStripCommand"
                        TabStrip="false"></eluc:TabStrip>
                            ...
                            <table cellpadding="0" cellspacing="0" >
                                  ...
                                  <td style="padding-right:15px">
                                   <telerik:RadLabel    ForeColor="Black"   ID="lblSeafarerStatus" Text="Seafarer Status" runat="server"></telerik:RadLabel>
                                    </td>
                                              <td style="padding-right:30px">

                                    <telerik:RadListBox ID="lstStatus" runat="server"  SelectionMode="Multiple" Height="70px" Width="210px"
