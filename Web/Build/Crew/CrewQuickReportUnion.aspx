<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewQuickReportUnion.aspx.cs"
    Inherits="Crew_CrewQuickReportUnion" %>
            ...
            <table cellpadding="0" cellspacing="0">
                <tr> 
                    <td style="padding-left:10px;padding-right:15px">
                        <telerik:RadLabel ID="lblname" runat="server" Text="Name" ForeColor="Black" ></telerik:RadLabel>
                    </td>
                    ...
                    <td style="padding-right:25px">
                        <eluc:Rank ID="ucRank" Width="270px" runat="server" AppendDataBoundItems="true" />
                    </td>
                    <td style="padding-right:15px">
                                <telerik:RadLabel  ForeColor="Black" ID="lblunion" runat="server" Text="Union"></telerik:RadLabel>
                    </td>

                    <td style="padding-right:25px">
                        <telerik:RadListBox ID="lstUnion" runat="server" SelectionMode="Multiple" AppendDataBoundItems="true" Height="80px" Width="270px"></telerik:RadListBox>
                    </td>
                </tr>
            </table>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Remarks">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel  ForeColor="Black" ID="lblremarks" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDLASTNOTESDESCRIPTION") %>'
                                    Width="50px">
                                </telerik:RadLabel>
