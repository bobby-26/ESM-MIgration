<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewQuickReportVesselType.aspx.cs"
    Inherits="Crew_CrewQuickReportVesselType" %>
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <table cellpadding="0" cellspacing="0" >
                <tr>
                   ...
                   <td style="padding-left:10px;padding-right:15px"><telerik:RadLabel ID="lblVesselType" runat="server" Text="Vessel Type"></telerik:RadLabel>
                        </td><td>
