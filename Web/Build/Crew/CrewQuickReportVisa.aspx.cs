...
public partial class Crew_CrewQuickReportVisa : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewQuickReportVisa.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
            toolbar1.AddFontAwesomeButton("../Crew/CrewQuickReportVisa.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDROW", "FLDFILENO", "FLDNAME", "FLDRANKCODE", "FLDBATCH", "FLDZONENAME", "FLDLASTVESSELNAME", "FLDLASTSIGNOFFDATE", "FLDPRESENTVESSELNAME", "FLDPRESENTSIGNONDATE", "FLDLASTNOTESDESCRIPTION", "FLDDOA", "FLDLASTCONTACTDATE", "FLDSTATUS", "FLDSEAFARERREQUIREMENT", "FLDCOUNTRYNAME", "FLDDATEOFISSUE", "FLDDATEOFEXPIRY", "FLDNOOFENTRYNAME" };
        string[] alCaptions = { "SNo.", "File No.", "	Name", "Rank", "Batch", "Zone", "Last Vessel", "Sign-Off Date", "Present Vessel", "Sign-On Date", "Remarks", "Availability", "Last Contact", "Status", "Requirement", "Visa Country", "Date of Issue", "Date of Expire", "No of Entry" };
        ds = PhoenixCrewQuickReports.CrewQuickVisa(General.GetNullableString(txtname.Text.Trim())
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=VisaQuickReport.xls");
        ...
        Response.Write("<tr><td style='font-family:Arial; font-size:10px;' colspan='" + (alColumns.Length).ToString() + "'><h5><center>Visa</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        string[] alColumns = { "FLDROW", "FLDFILENO", "FLDNAME", "FLDRANKCODE", "FLDBATCH", "FLDZONENAME", "FLDLASTVESSELNAME", "FLDLASTSIGNOFFDATE", "FLDPRESENTVESSELNAME", "FLDPRESENTSIGNONDATE", "FLDLASTNOTESDESCRIPTION", "FLDDOA", "FLDLASTCONTACTDATE", "FLDSTATUS", "FLDSEAFARERREQUIREMENT", "FLDCOUNTRYNAME", "FLDDATEOFISSUE", "FLDDATEOFEXPIRY", "FLDNOOFENTRYNAME" };
        string[] alCaptions = { "SNo.", "File No.", "	Name", "Rank", "Batch", "Zone", "Last Vessel", "Sign-Off Date", "Present Vessel", "Sign-On Date", "Remarks", "Availability", "Last Contact", "Status", "Requirement", "Visa Country", "Date of Issue", "Date of Expire", "No of Entry" };
        DataSet ds = PhoenixCrewQuickReports.CrewQuickVisa(General.GetNullableString(txtname.Text.Trim())
                                                            , General.GetNullableString(txtFileNo.Text.Trim())
                                                          , (ucCountryList.selectedlist) == "" ? null : General.GetNullableString(ucCountryList.selectedlist)
        ...
        General.SetPrintOptions("gvCrew", "Visa", alCaptions, alColumns, ds);
