<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewQuickReportZoneDOA.aspx.cs"
    Inherits="Crew_CrewQuickReportZoneDOA" %>
            ...
            <table cellpadding="0" cellspacing="0" >
                <tr>
                    <td style="padding-left:10px;padding-right:15px">
                        ...
                        <telerik:radlabel ID="lblFromDate1" runat="server" Text="Availability"></telerik:radlabel>
                    </td>
                    ...
                    <td style="padding-right:15px">
                        <asp:TextBox ID="txtFileNo" runat="server"    Width="120px"  ></asp:TextBox>
                    </td>
