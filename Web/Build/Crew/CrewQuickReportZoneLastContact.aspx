<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewQuickReportZoneLastContact.aspx.cs"
    Inherits="Crew_CrewQuickReportZoneLastContact" %>
                        ...
                        TabStrip="false"></eluc:TabStrip>
                            ...
                            <tr>
                                            <td style="padding-left:10px;padding-right:15px">
                                                ...
                                                <telerik:radlabel ID="lblFromDate1" runat="server" Text="Last Contact"></telerik:radlabel>
                                            </td>
                                            <td style="padding-right:30px">
                                                <eluc:Date ID="ucSignOnFromDate" runat="server" CssClass="input_mandatory"   Width="120px"  />
                                                <br /><br />
                                        ...
                                        <td style="padding-right:30px;padding-top:12px">
                                                <eluc:Number runat="server" ID="txtExperience" MaxLength="4" Text=""  Width="120px" />
                                                <br />(in months.)
                                            </td>
                                        
                              
                               <td style="padding-right:15px">
                                    <telerik:radlabel ID="lblZone" runat="server" Text="Zone"></telerik:radlabel> </td>
                               <td style="padding-right:15px">
                                    <eluc:Zone runat="server" ID="ucZone" AppendDataBoundItems="true"   Width="180px"  />
                                </td>
                            </tr>
                        </table>
