<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReliefDelayReportVisual.aspx.cs" Inherits="Crew_CrewReliefDelayReportVisual" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <div>
            <div id="crwrlfdlyrank-chart-1"></div>
            <div id="crwrlfdlyyrbyquarter-chart-2"></div>
            <div id="crwrlfdlyyrbymonth-chart-3"></div>
            <div id="crwrlfmostdelaybyvt-chart-4"></div>
            <div id="crwrlfdlynoofdelay-chart-4"></div>
            <div id="crewrlfempdetail-table-1"></div>
        </div>
    </form>
</body>
</html>
