<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportAllExpiringDocuments.aspx.cs"
    Inherits="CrewReportAllExpiringDocuments" %>
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvCrewCourse.ClientID %>"));
                }, 200);
            }
            window.onresize = window.onload = Resize;
        </script>
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvCrewMedical.ClientID %>"));
                }, 200);
            }
            window.onresize = window.onload = Resize;
        </script>
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvCrewOtherDoc.ClientID %>"));
                }, 200);
            }
            window.onresize = window.onload = Resize;
        </script>
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvCrewTravel.ClientID %>"));
                }, 200);
            }
            window.onresize = window.onload = Resize;
        </script>
...
<body>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1"
            ...
            <tr valign="top">
                <td>
                    <table>
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblStatus" Text="Status" runat="server">
                                </telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblDocuments" Text="Documents Expiring In Next" runat="server">
                                </telerik:RadLabel>
                            </td>
                            <td>
                ...
                <td>
                    <table cellpadding="0" cellspacing="0">
                        <tr valign="top">
                            ...
                            <td>
                                <telerik:RadLabel ID="lblCourseNationality" Text="Course Nationality" runat="server">
                                </telerik:RadLabel>
                                <br />
                                <eluc:Nationality ID="ucNationality1" runat="server" AppendDataBoundItems="true" />
                            </td>
                            <td>
                                <telerik:RadLabel ID="lblNationality" Text="Nationality" runat="server">
                                </telerik:RadLabel>
                                <br />
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" EnableViewState="false"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Licence Nationality" AllowSorting="false"
            ...
            <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="true" ReorderColumnsOnClient="true"
                ...
                <Scrolling AllowScroll="true" UseStaticHeaders="true" SaveScrollPosition="true" FrozenColumnsCount="4"
                    EnableNextPrevFrozenColumns="true" ScrollHeight="" />
        ...
        &nbsp;<b>Course(s)</b>
        <br />
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrewCourse" runat="server" EnableViewState="false"
            AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0"
            GridLines="None" GroupingEnabled="false" OnNeedDataSource="gvCrewCourse_NeedDataSource"
            EnableHeaderContextMenu="true" OnItemDataBound="gvCrewCourse_ItemDataBound" OnSortCommand="gvCrewCourse_SortCommand"
            OnItemCommand="gvCrewCourse_ItemCommand" ShowFooter="False" AutoGenerateColumns="false">
            <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
            <GroupingSettings ShowUnGroupButton="true"></GroupingSettings>
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Course Type" AllowSorting="false" HeaderStyle-Width="120px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle Wrap="true" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
        ...
        <br />
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrewOtherDoc" runat="server" EnableViewState="false"
            AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0"
            GridLines="None" GroupingEnabled="false" OnNeedDataSource="gvCrewOtherDoc_NeedDataSource"
            EnableHeaderContextMenu="true" OnItemDataBound="gvCrewOtherDoc_ItemDataBound"
            OnSortCommand="gvCrewOtherDoc_SortCommand" OnItemCommand="gvCrewOtherDoc_ItemCommand"
        ...
        <br />
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrewTravel" runat="server" EnableViewState="false"
            AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0"
            GridLines="None" GroupingEnabled="false" OnNeedDataSource="gvCrewTravel_NeedDataSource"
            EnableHeaderContextMenu="true" OnItemDataBound="gvCrewTravel_ItemDataBound" OnSortCommand="gvCrewTravel_SortCommand"
            OnItemCommand="gvCrewTravel_ItemCommand" ShowFooter="False" AutoGenerateColumns="false">
            <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
            <GroupingSettings ShowUnGroupButton="true"></GroupingSettings>
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Nationality" AllowSorting="false" HeaderStyle-Width="120px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle Wrap="true" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrewMedical" runat="server" EnableViewState="false"
            AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0"
            GridLines="None" GroupingEnabled="false" OnNeedDataSource="gvCrewMedical_NeedDataSource"
            EnableHeaderContextMenu="true" OnItemDataBound="gvCrewMedical_ItemDataBound"
            OnSortCommand="gvCrewMedical_SortCommand" OnItemCommand="gvCrewMedical_ItemCommand"
            ShowFooter="False" AutoGenerateColumns="false">
            <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
            <GroupingSettings ShowUnGroupButton="true"></GroupingSettings>
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Nationality" AllowSorting="false" HeaderStyle-Width="60px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
