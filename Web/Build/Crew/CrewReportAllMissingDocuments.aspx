<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportAllMissingDocuments.aspx.cs"
    Inherits="CrewReportAllMissingDocuments" %>
...
<head id="Head1" runat="server">
    <title>CrewMissingDocumentList</title>
...
<body>
    <form id="frmCrewMissingDocumentList" runat="server" submitdisabledcontrols="true">
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
    <telerik:RadSkinManager ID="RadSkinManager1" runat="server" />
    <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server"
        EnableShadow="true">
    </telerik:RadWindowManager>
    <telerik:RadFormDecorator ID="RadformDecortor" DecorationZoneID="tblConfigure" runat="server"
        DecoratedControls="All" EnableRoundedCorners="true" />
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1"
        Height="100%">
        <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
        <eluc:TabStrip ID="MenuCrewMissingDocList" runat="server" OnTabStripCommand="MenuCrewMissingDocList_TabStripCommand">
        </eluc:TabStrip>
        ...
        &nbsp;<b>Licence(s)</b>
        <br />
        <eluc:TabStrip ID="MenuCrewMissingDocs" runat="server" OnTabStripCommand="MenuCrewMissingDocs_TabStripCommand"
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" EnableViewState="false"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Document" AllowSorting="false" HeaderStyle-Width="60px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Center" />
