<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportDGSignOff.aspx.cs"
    Inherits="Crew_CrewReportDGSignOff" %>
...
<head runat="server">
    <title>DG Shipping Sign Off</title>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                ...
                <eluc:TabStrip ID="CrewMenuGeneral" runat="server" Title="Sign Off Across Fleet" OnTabStripCommand="CrewMenuGeneral_TabStripCommand"></eluc:TabStrip>
                    ...
                    <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Sign-Off" ColumnGroupName="date">
                                <HeaderStyle Width="75px" />
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblDateOfSignOff" Visible="true" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSIGNOFFDATE") %>' />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Contract Complete/ Arriving India" ColumnGroupName="date">
                                <HeaderStyle Width="80px" />
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblDateOfCOntract" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOMPLETIONOFCONTRACT") %>'></telerik:RadLabel>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Remarks">
                                <HeaderStyle Width="175px" />
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblRemarks" Visible="true" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREASON") %>' />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                        </Columns>
