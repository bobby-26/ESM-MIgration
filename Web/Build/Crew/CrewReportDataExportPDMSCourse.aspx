<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportDataExportPDMSCourse.aspx.cs" Inherits="Crew_CrewReportDataExportPDMSCourse" %>
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                               ...
                               <telerik:gridtemplatecolumn headertext="Title">
                                ...
                                <ItemTemplate>
                                    <telerik:radlabel ID="lblTitle" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOURSETITLE") %>' />
                                </ItemTemplate>
                            </telerik:gridtemplatecolumn>
                               ...
                               <telerik:gridtemplatecolumn headertext="Cert Code">
                                ...
                                <ItemTemplate>
                                    <telerik:radlabel ID="lblCertCode" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOURSECERTCODE") %>' />
                                </ItemTemplate>
                            </telerik:gridtemplatecolumn>
                               ...
                               <telerik:gridtemplatecolumn headertext="Institute">
                                ...
                                <ItemTemplate>
                                    <telerik:radlabel ID="lblInstitute" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOURSEINSTITUTE") %>'></telerik:radlabel>
                                </ItemTemplate>
                            </telerik:gridtemplatecolumn>
                            
                               <telerik:gridtemplatecolumn headertext="Start Date">
                               <ItemTemplate>
                                    <telerik:radlabel ID="lblStartDate" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOURSEISSUEDATE") %>' />
                                </ItemTemplate>
                            </telerik:gridtemplatecolumn>
                               ...
                               <telerik:gridtemplatecolumn headertext="End Date">
                                ...
                                <ItemTemplate>
                                    <telerik:radlabel ID="lblEndDate" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOURSEEXPIRYDATE") %>'></telerik:radlabel>
                                </ItemTemplate>
                            </telerik:gridtemplatecolumn>
                               ...
                               <telerik:gridtemplatecolumn headertext="Country Code">
                                ...
                                <ItemTemplate>
                                    <telerik:radlabel ID="lblCountryCode" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOURSECOUNTRYCODE") %>'></telerik:radlabel>
                                </ItemTemplate>
                            </telerik:gridtemplatecolumn>
