...
public partial class Crew_CrewReportDataExportPDMSCourse : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportDataExportPDMSCourse.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportDataExportPDMSCourse.aspx", "Export to Text", "<i class=\"fas fa-list-alt-picklist\"></i>", "TEXT");
    ...
    protected void ShowText()
    {
        ...
        ds = PhoenixCrewReportsDataExport.DataExportDetailsSearch(ucPool.SelectedPool,3, null,
                                                            1,
                                                            gvCrew.PageSize,
                                                            ref iRowCount,
                                                            ref iTotalPageCount);
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=DataExportCourse.txt");
