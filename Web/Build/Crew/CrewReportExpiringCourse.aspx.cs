...
public partial class Crew_CrewReportExpiringCourse : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportExpiringCourse.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportExpiringCourse.aspx", "Clear Filter", "<i class=\"fa fa-ban fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDFILENO", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDBATCH", "FLDVESSELNAME", "FLDSIGNONDATE", "FLDRELIEFDUEDATE", "FLDCOURSETYPE", "FLDCOURSE", "FLDDOCNATIONALITY", "FLDEXPIRYDATE" };
        string[] alCaptions = { "File No", "Name", "Rank", "Batch", "Vessel", "Sign On Date", "Relief Due", "Course Type", "Document", "Course Nationality", "Expiry date" };
        string[] FilteralColumns = { "FLDSELECTEDCOURSE", "FLDSELECTEDNATIONALITY", "FLDSELECTEDSTATUS", "FLDSELECTEDVESSEL", "FLDSELECTEDTRAININGBATCH", "FLDSELECTEDDAYS" };
        string[] FilteralCaptions = { "Course Nationality", "Nationality", "Status", "Vessel", "Training batch", "Documents Expiring In Next" };
        ...
        ds = CrewReportExpiringSearch.CrewReportExpiringCourse(
                           ...
                           General.GetNullableInteger(ddlSelectFrom.SelectedHard),
                            ...
                            , (ddlCourse.SelectedCourse) == "Dummy" ? null : General.GetNullableInteger(ddlCourse.SelectedCourse));

        Response.AddHeader("Content-Disposition", "attachment; filename=Expiring Course.xls");
        ...
        Response.Write("<tr><td colspan='" + (alColumns.Length).ToString() + "'><h5><center>Expiring Course Documents</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        DataSet ds = new DataSet();
        string[] alColumns = { "FLDFILENO", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDBATCH", "FLDVESSELNAME", "FLDSIGNONDATE", "FLDRELIEFDUEDATE", "FLDCOURSETYPE", "FLDCOURSE", "FLDDOCNATIONALITY", "FLDEXPIRYDATE" };
        string[] alCaptions = { "File No", "Emp Name", "Rank", "FLDBATCH", "Vessel", "Sign On Date", "Relief Due", "Course Type", "Document", "Course Nationality", "Expiry date" };
        ...
        General.SetPrintOptions("gvCrew", "Expiring Course", alCaptions, alColumns, ds);
