<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportExpiringLicense.aspx.cs"
    Inherits="Crew_CrewReportExpiringLicense" %>
...
<head runat="server">
    <title>Crew Report Expiring License</title>
                        ...
                        <tr valign="top">
                            <td>
                                ...
                                <eluc:Hard ID="ddlSelectFrom" runat="server" HardTypeCode="54" ShortNameFilter="ONB,ONL,PLN"
                                    Width="120px" AppendDataBoundItems="true" CssClass="dropdown_mandatory" SortByShortName="true" />
                            </td>
                            <td>
                                ...
                                <telerik:RadLabel ID="lblDays" runat="server" Text="Days">
                                </telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <eluc:Vessel ID="ucVessel" AppendDataBoundItems="true" runat="server" VesselsOnly="true"
                                    Width="250px" EntityType="VSL" AssignedVessel="true" />
                            </td>
                            <td>
                            ...
                            <td>
                                <telerik:RadLabel ID="lblNationality" runat="server" Text="Seafarer Nationality">
                                </telerik:RadLabel>
                                <br />
