<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportExpiringMedical.aspx.cs"
    Inherits="Crew_CrewReportExpiringMedical" %>
...
<head runat="server">
    <title>Crew Report Expiring Medical</title>
                ...
                <td valign="top">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="ddlMedicalTest" runat="server" Width="100%" EmptyMessage="Type to select Medical Test"
