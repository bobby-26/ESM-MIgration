...
public partial class Crew_CrewReportExpiringMedical : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportExpiringMedical.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportExpiringMedical.aspx", "Clear Filter", "<i class=\"fa fa-ban fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alCaptions = { "File No", "Name", "Rank", "Batch", "Vessel", "Sign On Date", "Relief Due", "Document", "Nationality", "Expiry date" };
        ...
        ds = CrewReportExpiringSearch.CrewReportExpiringMedical(
                           ...
                           , (ddlMedicalTest.SelectedValue) == "" ? null : General.GetNullableInteger(ddlMedicalTest.SelectedValue));

        Response.AddHeader("Content-Disposition", "attachment; filename=Expiring_Medical.xls");
        ...
        Response.Write("<tr><td colspan='" + (alColumns.Length).ToString() + "'><h5><center>Expiring Medical Documents</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        DataSet ds = new DataSet();
        string[] alColumns = { "FLDFILENO", "FLDBATCH", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDVESSELNAME", "FLDSIGNONDATE", "FLDRELIEFDUEDATE", "FLDDOCUMENTNAME", "FLDDOCNATIONALITY", "FLDEXPIRYDATE" };
        string[] alCaptions = { "EmpNo", "Batch", "Emp Name", "Rank", "Vessel", "Sign On Date", "Relief Due", "Document", "Nationality", "Expiry date" };
        ...
        General.SetPrintOptions("gvCrew", "Expiring Medical Documents", alCaptions, alColumns, ds);
