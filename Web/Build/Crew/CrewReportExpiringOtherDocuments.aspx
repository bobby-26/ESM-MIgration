<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportExpiringOtherDocuments.aspx.cs"
    Inherits="Crew_CrewReportExpiringOtherDocuments" %>
...
<head runat="server">
    <title>Crew Report Expiring Other Documents</title>
        ...
        <table>
           <tr style="color: Blue">
                ...
                <telerik:RadToolTip RenderMode="Lightweight" runat="server" ID="GuidlinesTooltip"
                    ...
                    HideDelay="5000" Text="Please note: <br/> 1) For onboard, the Documents which are going to expire in given no. of days from sign on date will be determin <br/> 2) For onleave and planned, the Documents which are going to expire in given no. of days from current date will be determined.">
                </telerik:RadToolTip>
            </tr>
        </table>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <eluc:Vessel ID="ucVessel" AppendDataBoundItems="true" runat="server" VesselsOnly="true" Width="100%"
