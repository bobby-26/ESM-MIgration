...
public partial class Crew_CrewReportExpiringTravelDocuments : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportExpiringTravelDocuments.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportExpiringTravelDocuments.aspx", "Clear Filter", "<i class=\"fa fa-ban fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=Expiring_Travel_Documents.xls");
        ...
        Response.Write("<tr><td colspan='" + (alColumns.Length).ToString() + "'><h5><center>Expiring Travel Documents</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        string[] alColumns = { "FLDFILENO", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDBATCH", "FLDVESSELNAME", "FLDSIGNONDATE", "FLDRELIEFDUEDATE", "FLDDOCUMENTNAME", "FLDDOCNATIONALITY", "FLDEXPIRYDATE" };
        string[] alCaptions = { "File No", "Emp Name", "Rank", "Batch", "Vessel", "Sign On Date", "Relief Due", "Document", "Nationality", "Expiry date" };
        ...
        General.SetPrintOptions("gvCrew", "Expiring Travel Documents", alCaptions, alColumns, ds);
