<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportMedicalTest.aspx.cs"
    Inherits="CrewReportMedicalTest" %>
...
<body>
    <form id="frmMedicalTest" runat="server">
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblnote" runat="server" CssClass="guideline_text" >
                            <font color="blue" size="1px">Note:Period of Test between is not mandatory when Either Sign-On or Sign-Off date
                        is entered</font>
                        </telerik:RadLabel>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <telerik:RadLabel ID="lblFromDate" runat="Server" Text="Period of Test Between">
                                    </telerik:RadLabel>
                                </td>
                                <td>
                                ...
                                <td>
                                    <telerik:RadLabel ID="lblToDate1" runat="Server" Text="Sign Off Between">
                                    </telerik:RadLabel>
                                </td>
                                <td>
                                ...
                                <td>
                                    <telerik:RadLabel ID="lblIncludearchivedData" Text="Include archived data" runat="server">
                                    </telerik:RadLabel>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadLabel ID="lblStaus" runat="server" Text="Status">
                                    </telerik:RadLabel>
                                </td>
                                <td>
                                    <eluc:Hard runat="server" ID="ddlStatus" AppendDataBoundItems="true"
                                        Width="200PX" HardTypeCode="105" />
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td>
                                    <telerik:RadLabel ID="lblMedicalTest" runat="server" Text="Medical Test">
                                    </telerik:RadLabel>

                                    <telerik:RadListBox ID="lstMedicalTest" SelectionMode="Multiple" AppendDataBoundItems="true"
                                        runat="server" Width="280px" Height="100px">
                                        <Items>
                                ...
                                <td>
                                    ...
                                    <telerik:RadListBox ID="lstStatus" runat="server" SelectionMode="Multiple"
                                        DataTextField="FLDHARDNAME" DataValueField="FLDHARDCODE" Width="280px" Height="100px">
                                    </telerik:RadListBox>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Sign On" AllowSorting="false" HeaderStyle-Width="65px"
                            ShowSortIcon="true">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Sign Off" AllowSorting="false" HeaderStyle-Width="65px"
                            ShowSortIcon="true">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Test" AllowSorting="false" HeaderStyle-Width="60px"
                            ShowSortIcon="true">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container, "DataItem.FLDMEDICALNAME")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Date" AllowSorting="false" HeaderStyle-Width="60px"
                            ShowSortIcon="true">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Done after/last sign off" AllowSorting="false"
                            HeaderStyle-Width="50px" ShowSortIcon="true">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container, "DataItem.FLDAFTERSIGNONOFF")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Result" AllowSorting="false" HeaderStyle-Width="60px"
                            ShowSortIcon="true">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container, "DataItem.FLDRESULT")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Remarks" AllowSorting="false" HeaderStyle-Width="55px"
                            ShowSortIcon="true">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblRemarks" runat="server" Width="220px" Text='<%# DataBinder.Eval(Container, "DataItem.FLDREMARKS")%>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
