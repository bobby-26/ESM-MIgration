<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportMissingCourse.aspx.cs"
    Inherits="Crew_CrewReportMissingCourse" %>
...
<head runat="server">
    <title>Crew Report Missing Search</title>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                ...
                                <br />
                                <eluc:Nationality ID="ucCourseNationality" runat="server" AppendDataBoundItems="true"
                                    />
                            </td>
                        </tr>
                    </table>
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Nationality" AllowSorting="false" HeaderStyle-Width="80px"
                        ...
                        <ItemStyle Wrap="true" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblCourseNationality" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOURSENATIONALITY") %>'>
                            </telerik:RadLabel>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                </Columns>
