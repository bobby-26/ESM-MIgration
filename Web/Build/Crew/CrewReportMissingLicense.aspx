<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportMissingLicense.aspx.cs"
    Inherits="Crew_CrewReportMissingLicense" %>
...
<head runat="server">
    <title>Crew Report Missing Licence</title>
                ...
                <td>
                    <table cellpadding="0" cellspacing="5">
                        <tr>
                            ...
                            <td>
                                <telerik:RadLabel ID="lblLicence" runat="server" Text="Licence">
                                </telerik:RadLabel>
                            </td>
                            <td>
                                <eluc:Documents ID="ddlLicence" runat="server" AppendDataBoundItems="true" Width="100%"
                                    DocumentType="LICENCE" DocumentList="<%# PhoenixRegistersDocumentLicence.ListDocumentLicence(null,null,1,null,null) %>" />
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <eluc:Principal ID="ucPrincipal" runat="server" AppendDataBoundItems="true" AddressType="128"
                                    OnTextChangedEvent="ucPrincipal_TextChange" AutoPostBack="true" />
                            </td>
                            <td>
                                ...
                                <eluc:Vessel ID="ucVessel" AppendDataBoundItems="true" runat="server" VesselsOnly="true"
                                    Width="480px" EntityType="VSL" ActiveVessels="true" AssignedVessels="true" />
                            </td>
                            <td>
                            ...
                            <td>
                                <telerik:RadLabel ID="lblLicenceNationality" runat="server" Text="Licence Nationality">
                                </telerik:RadLabel>
                                <br />
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" EnableViewState="false"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Document" AllowSorting="false" HeaderStyle-Width="150px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
