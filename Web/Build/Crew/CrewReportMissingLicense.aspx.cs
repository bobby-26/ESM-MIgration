...
public partial class Crew_CrewReportMissingLicense : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportMissingLicense.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportMissingLicense.aspx", "Clear Filter", "<i class=\"fa fa-ban fa-eraser\"></i>", "CLEAR");
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SHOWREPORT"))
            {
                ...
                else
                {
                    ...
                    criteria.Add("ucNationality1", ucNationality1.SelectedList);
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDFILENO", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDBATCH", "FLDVESSELNAME", "FLDSIGNONDATE", "FLDRELIEFDUEDATE", "FLDLICENCE" };
        ...
        ds = PhoenixCrewMissingSearch.CrewReportMissingLicense(
                           ...
                           , General.GetNullableString(ucRank.selectedlist == "Dummy" ? null : ucRank.selectedlist)
                           , General.GetNullableString(ucNationality1.SelectedList == "Dummy" ? null : ucNationality1.SelectedList)
                           , General.GetNullableInteger(ddlLicence.SelectedDocument));


        Response.AddHeader("Content-Disposition", "attachment; filename=Missing_Licence.xls");
        ...
        Response.Write("<tr><td colspan='" + (alColumns.Length).ToString() + "'><h5><center>Missing Licence Documents</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        General.SetPrintOptions("gvCrew", "Missing Licence", alCaptions, alColumns, ds);
