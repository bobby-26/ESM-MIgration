<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportMissingMedical.aspx.cs"
    Inherits="Crew_CrewReportMissingMedical" %>
...
<head runat="server">
    <title>Crew Report Missing Medical</title>
                ...
                <td>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="ddlMedicalTest" CssClass="dropdown_mandatory" runat="server" EmptyMessage="Type to select medical" Filter="Contains" MarkFirstMatch="true"
                                    Width="100%">
                                </telerik:RadComboBox>
                            </td>
                        </tr>
