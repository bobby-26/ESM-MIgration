...
public partial class CrewReportOtherDocument : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportOtherDocument.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportOtherDocument.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
            ...
            if (!IsPostBack)
            {
                ...
                lstOtherDocument.DataSource = PhoenixRegistersDocumentOther.ListDocumentOther(((int)PhoenixDocumentType.OTHER_DOC_NONE).ToString());
                lstOtherDocument.Items.Insert(0, new RadListBoxItem("--Select--", "Dummy"));
                lstOtherDocument.DataBind();
    ...
    protected void CrewShowExcel_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("CLEAR"))
            {
                ...
                lstOtherDocument.Items.Clear();
                lstOtherDocument.DataSource = PhoenixRegistersDocumentOther.ListDocumentOther(((int)PhoenixDocumentType.OTHER_DOC_NONE).ToString());
                lstOtherDocument.Items.Insert(0, new RadListBoxItem("--Select--", "Dummy"));
                lstOtherDocument.DataBind();
                lstOtherDocument.SelectedIndex = -1;
    ...
    protected void MenuReports_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../Crew/CrewReportCorrespondence.aspx", false);
            }
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDROW", "FLDFILENO", "FLDEMPLOYEENAME", "FLDRANKCODE","FLDVESSELNAME", "FLDSIGNONDATE",
                                                "FLDLASTVESSELNAME", "FLDLASTSIGNOFFDATE","FLDDOCUMENTNUMBER","FLDDOCUMENTNAME", "FLDREMARKS", "FLDDATEENTERED" };
        string[] alCaptions = { "Sl No", "Emp Code", "Name", "Rank", "Vsl on", "S/on Date", "Last Vsl", " S/Off Date", "Doc Number", "Other Docs", "Remarks", "Date Entered" };
        ...
        foreach (RadListBoxItem item in lstOtherDocument.Items)
        {
        ...
        ds = PhoenixCrewReports.CrewOtherDocumentReport(
                        ...
                        General.GetNullableString(s.ToString()),
                        ...
                        null,//(ucPrincipal.SelectedAddress) == "Dummy" ? null : General.GetNullableInteger(ucPrincipal.SelectedAddress),
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=CrewReportOtherDocument.xls");
    ...
    private void ShowReport()
    {
        ...
        ucPool.SelectedPool = ucPool.SelectedPool.ToString().Contains("Dummy,") ? ucPool.SelectedPool.ToString().Replace("Dummy,", "") : ucPool.SelectedPool;
        ucRank.selectedlist = ucRank.selectedlist.ToString().Contains("Dummy,") ? ucRank.selectedlist.ToString().Replace("Dummy,", "") : ucRank.selectedlist;
        DataSet ds = PhoenixCrewReports.CrewOtherDocumentReport(
                        (ucVesselType.SelectedVesseltype.ToString()) == "Dummy" ? null : General.GetNullableString(ucVesselType.SelectedVesseltype.ToString()),
                        (ucPool.SelectedPool.ToString()) == "Dummy" ? null : General.GetNullableString(ucPool.SelectedPool.ToString()),
                        General.GetNullableString(s.ToString()),
                        General.GetNullableDateTime(ucSignOnFromDate.Text),
    ...
    protected void gvCrew_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridEditableItem)
        {
            ...
            string remarks = HttpUtility.HtmlDecode(dr["FLDREMARKS"].ToString());
            lbtn.Text = (remarks.Length > 25) ? remarks.Substring(0, 25) + "..." : remarks;
            uct.Text = remarks;
