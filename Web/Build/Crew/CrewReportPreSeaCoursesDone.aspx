<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportPreSeaCoursesDone.aspx.cs"
    Inherits="CrewReportPreSeaCoursesDone" %>
    ...
    <form id="frmPreSeaCoursesDone" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <table id="tblGuidance">
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblcourse" runat="server" CssClass="mlabel" ForeColor="Black">
                            Note:
                            <br />
                            &nbsp 1.Vessel filter is applicable only if the status is selected as Onboard or Onleave.<br />
                            &nbsp 
                            2.Either Sign on from and to dates are mandatory or sign off from and to dates are mandatory or Issued from and to dates are mandatory.<br />
                        </telerik:RadLabel>
                    </td>
                </tr>
            </table>
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="ddlStatus" runat="server" Width="300px" Filter="Contains" MarkFirstMatch="true" EmptyMessage="Type to select Status">
                            <Items>
                ...
                <tr>
                    <td style="padding-right: 40px">SignOn Date
                    </td>
                    <td>
                        <table>
                            <tr>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Address ID="ucManager" runat="server" AddressType="126" AppendDataBoundItems="true" Width="300px" />
                    </td>
                </tr>
                <tr>
                    <td>Issued Date
                    ...
                    <td>
                        <telerik:RadLabel ForeColor="Black" ID="lblShowLast" runat="server" Text="Show Last"></telerik:RadLabel>
                        <br />
                        <br />
                        <telerik:RadLabel ForeColor="Black" ID="lblShowFirst" runat="server" Text="Show First"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Number ID="ucShowLast" runat="server" MaxLength="3" Width="300px" />
                        &nbsp;&nbsp;<telerik:RadLabel ForeColor="Black" ID="lblLstRanks" runat="server" Text="Ranks"></telerik:RadLabel>
                        <br />
                        <br />
                        <eluc:Number ID="ucShowFirst" runat="server" MaxLength="3" Width="300px" />
                        &nbsp;&nbsp;<telerik:RadLabel ForeColor="Black" ID="lblFstRanks" runat="server" Text="Ranks"></telerik:RadLabel>
                    </td>
                </tr>
            </table>
            ...
            <telerik:RadGrid ID="gvCrewPreSeaCoursesDone" runat="server" AutoGenerateColumns="False" Font-Size="11px" OnSorting="gvCrewPreSeaCoursesDone_Sorting"
                CellPadding="3" RowStyle-Wrap="false" ShowHeader="true" EnableViewState="false" OnItemCommand="gvCrewPreSeaCoursesDone_ItemCommand" OnSelectedIndexChanging="gvCrewPreSeaCoursesDone_SelectedIndexChanging"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Emp Code" HeaderStyle-Width="110px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Rank" AllowSorting="true" SortExpression="FLDRANK" HeaderStyle-Width="90px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Qualification" HeaderStyle-Width="150px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Institution" HeaderStyle-Width="160px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="From" HeaderStyle-Width="90px">

                            <ItemTemplate>
                                <%# General.GetDateTimeToString(DataBinder.Eval(Container, "DataItem.FLDFROMDATE"))%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="To" HeaderStyle-Width="90px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Status" HeaderStyle-Width="110px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Grade" HeaderStyle-Width="90px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="S/on Date" HeaderStyle-Width="90px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Course Name" HeaderStyle-Width="120px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Issue Date" AllowSorting="true" SortExpression="FLDDATE" HeaderStyle-Width="90px">
