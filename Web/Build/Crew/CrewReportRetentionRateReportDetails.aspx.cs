...
public partial class CrewReportRetentionRateReportDetails : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Crew/CrewReportRetentionRateReportDetails.aspx?principal=" + Request.QueryString["principal"] + "&batch=" + Request.QueryString["batch"] + "&fromdate=" + Request.QueryString["fromdate"] + "&todate=" + Request.QueryString["todate"] + "&vesseltype=" + Request.QueryString["vesseltype"] + "&pool=" + Request.QueryString["pool"] + "&manager=" + Request.QueryString["manager"] + "&rank=" + Request.QueryString["rank"] + "&type=" + Request.QueryString["type"] + "&zone=" + Request.QueryString["zone"], "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDROW", "FLDNAME", "FLDRANKNAME", "FLDBATCH", "FLDSTATUS", "FLDLASTVESSELNAME", "FLDLASTSIGNOFFDATE", "FLDPRESENTVESSELNAME", "FLDPRESENTSIGNONDATE", "FLDFIRSTJOINDATE" };
        string[] alCaptions = { "Sl No", "Name", "Rank", "Batch", "Present Status", "Last Vessel", "Sign-Off Date", "Present Vessel", "Sign-On Date", "First Join Date" };
        ...
        ds = PhoenixCrewReportRetentionRate.RetentionRateDetailsSearch(General.GetNullableString(Request.QueryString["principal"].ToString()),
                                                                        General.GetNullableString(Request.QueryString["batch"].ToString()),
                                                                        ...
                                                                        General.GetNullableString(Request.QueryString["manager"].ToString()),
