<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportRevisedCrewList.aspx.cs" Inherits="CrewReportRevisedCrewList" %>
             ...
             <eluc:TabStrip ID="MenuReportsFilter" runat="server" OnTabStripCommand="ReportsFilter_TabStripCommand" TabStrip ="false">
                ...
                <table width="100%">
                   <tr>                  
                       ...
                       <td>
                           <eluc:SeaPort ID="ucSeaPort" AppendDataBoundItems="true" CssClass="dropdown_mandatory" runat="server" />
                       </td>
                       <td>
