<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportSpecificList1.aspx.cs"
    Inherits="CrewReportSpecificList1" %>
...
<body onload="resizeFrame()">
    ...
    <telerik:RadFormDecorator ID="RadformDecortor" DecorationZoneID="RecruitmentTarget"
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1"
        ...
        <table width="100%">
            <tr>
                ...
                <td>
                    <asp:Literal ID="lblFormats" runat="server" Text="Formats"></asp:Literal>
                </td>
                <td>
                    <telerik:RadRadioButtonList ID="rblFormats" runat="server" RepeatDirection="Horizontal"
                        Layout="Flow" Columns="2" OnSelectedIndexChanged="rblFormats_SelectedIndexChanged"
                        AutoPostBack="true">
                        <Items>
                            <telerik:ButtonListItem Text="Specific Crew List With Flag Details"></telerik:ButtonListItem>
                            <telerik:ButtonListItem Text="Specific Crew List With Licence"></telerik:ButtonListItem>
                        </Items>
