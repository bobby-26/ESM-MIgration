...
public partial class CrewReportSpecificList1 : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=4&reportcode=SPECIFICLIST1&vesselid=null&showmenu=0";
