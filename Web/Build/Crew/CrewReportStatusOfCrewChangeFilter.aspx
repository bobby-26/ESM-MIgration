<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportStatusOfCrewChangeFilter.aspx.cs" Inherits="CrewReportStatusOfCrewChangeFilter" %>
...
<head runat="server">
    <title>Status of Crew Change Report </title>
...
<body>
    ...
    <asp:UpdatePanel runat="server" ID="pnlCrewChangeReport">
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <eluc:Title runat="server" ID="ucTitle" Text="StatusOfCrewChangeReport" />
                    </div>
                </div>
                ...
                <div style="top: 0px; right: 0px; position: absolute">
                    <eluc:TabStrip ID="MenuReportsCrewChange" runat="server" OnTabStripCommand="MenuReportsCrewChange_TabStripCommand">
