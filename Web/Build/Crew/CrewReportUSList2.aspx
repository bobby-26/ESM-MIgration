<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportUSList2.aspx.cs"
    Inherits="CrewReportUSList2" %>
...
<body onload="resizeFrame()">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1"
        ...
        <iframe runat="server" id="ifMoreInfo" scrolling="auto" style="min-height: 85%; width: 100%;">
        </iframe>
