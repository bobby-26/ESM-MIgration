...
public partial class Crew_CrewReportsCrewChange : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportsCrewChange.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewReportsCrewChange.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
            ...
            if (!IsPostBack)
            {
                ...
                //{
                //    Response.Redirect("CrewReportsCrewChangeMenu.aspx?redir=yes");
                //}
            }
    ...
    protected void MenuReport_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("FORMAT3"))
            {
                Response.Redirect("CrewReportsCrewChangeFormat3.aspx", true);
    ...
    {
        string flagseaman = flagcode + " SIB";
        int iRowCount = 0;
        int iTotalPageCount = 0;
        string date = DateTime.Now.ToShortDateString();

        DataSet ds = new DataSet();
        string[] alColumns = { "FLDRANKCODE", "FLDEMPLOYEENAME", "FLDDATEOFBIRTH", "FLDDATEPLACESIGNEDON", "FLDADDRESS", "FLDPPTDOE", "FLDFLAGSIBDOIDOE", "FLDINDIANLICENCE", "FLDSIBDOIDOE" };
        string[] alCaptions = { "Rank", "Name", "DOB", "Date/Place on SD", "Address", "Passport", flagseaman, "Indian", "Seaman" };
        string[] alCaptions1 = { "", "", "", "", "", "No/DOE", "No/", "Licence No", "Book No" };
        string[] alCaptions2 = { "", "", "", "", "", "", "DOI/DOE", "DOI/DOE", "DOI/DOE" };
    ...
    private void ShowReport()
    {
        int iRowCount = 0;
        int iTotalPageCount = 0;
        string flagseaman = flagcode + "SIB No/DOI/DOE";
        DataSet ds = new DataSet();
        string[] alColumns = { "FLDRANKCODE", "FLDEMPLOYEENAME", "FLDDATEOFBIRTH", "FLDADDRESS", "FLDDATEPLACESIGNEDON", "FLDPPTDOE", "FLDFLAGSIBDOIDOE", "FLDINDIANLICENCE", "FLDSIBDOIDOE" };
        string[] alCaptions = { "Rank", "Name", "DOB", "Date/Place on SD", "Address", "Passport No/DOE", flagseaman, "Indian Licence No DOI/DOE", "Seaman Book No DOI/DOE" };
    ...
    protected void gvCrew_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridEditableItem)
        {
            ...
            RadLabel lblFlag = (RadLabel)e.Item.FindControl("lblFlagCode");

            if (lblFlag.Text != string.Empty)
            {
                flagcode = lblFlag.Text;
            }
