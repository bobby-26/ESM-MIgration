<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportsCrewChangeMenu.aspx.cs"
    Inherits="Crew_CrewReportsCrewChangeMenu" %>
...
<body onload="resizeFrame()" onresize="resizeFrame()">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1"
        ...
        <iframe runat="server" id="ifMoreInfo" style="min-height: 550px; width: 100%; border: 0"
