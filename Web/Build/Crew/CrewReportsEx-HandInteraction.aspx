<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportsEx-HandInteraction.aspx.cs"
    Inherits="Crew_CrewReportsEx_HandInteraction" %>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1"
        ...
        <table width="100%">
            <tr style="color: Blue">
                ...
                <telerik:RadToolTip RenderMode="Lightweight" runat="server" ID="GuidlinesTooltip"
                    ...
                    HideDelay="5000" Text="Please note: <br/> 1) Either Last contact Prior or Last contact After is mandatory. <br/> 2) Press Control for multiple selection. <br/> 3) If 'Include past experience' checked, the filter will search for vessel type experiece in full past experience,if not will check only last/onboard vessels">
                </telerik:RadToolTip>
  
            </tr>
        </table>
        <table border="1" width="100%" style="border-collapse: collapse; font-size= smaller;">
            <tr valign="top">
                <td>
                    <table width="100%">
                        <tr>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" Height="55%"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <ColumnGroups>
                        <telerik:GridColumnGroup HeaderText="OnBoard Vessel" Name="OnBoardVessel" HeaderStyle-HorizontalAlign="Center"></telerik:GridColumnGroup>
                        <telerik:GridColumnGroup HeaderText="Last SignOff Vessel" Name="LastSignOffVessel" HeaderStyle-HorizontalAlign="Center"></telerik:GridColumnGroup>
                ...
                <Columns>
                    <telerik:GridTemplateColumn HeaderText="S.No." AllowSorting="false" HeaderStyle-Width="52px"
                        ShowSortIcon="true">
                    ...
                    <telerik:GridTemplateColumn HeaderText="Name" AllowSorting="false" HeaderStyle-Width="168px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Name" AllowSorting="false" HeaderStyle-Width="95px" ColumnGroupName="OnBoardVessel"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Date" AllowSorting="false" HeaderStyle-Width="72px" ColumnGroupName="OnBoardVessel"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Left" />
                        <HeaderTemplate>
                            <telerik:RadLabel ID="lblVslSignonDateHeader" runat="server">
                    ...
                    <telerik:GridTemplateColumn HeaderText="Type" AllowSorting="false" HeaderStyle-Width="148px" ColumnGroupName="OnBoardVessel"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Name" AllowSorting="false" HeaderStyle-Width="95px" ColumnGroupName="LastSignOffVessel"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Date" AllowSorting="false" HeaderStyle-Width="72px" ColumnGroupName="LastSignOffVessel"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Type" AllowSorting="false" HeaderStyle-Width="148px" ColumnGroupName="LastSignOffVessel"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Remark" AllowSorting="false" HeaderStyle-Width="140px" ColumnGroupName="Last"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Contact By" AllowSorting="false" HeaderStyle-Width="120px" ColumnGroupName="Last"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="DOA" AllowSorting="false" HeaderStyle-Width="75px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Left" />
                        <ItemTemplate>
