<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportsNotRelievedOnTimeOnBoard.aspx.cs"
    Inherits="CrewReportsNotRelievedOnTimeOnBoard" %>
            ...
            <tr>
                <td>
                    <table >
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblAsOnDate" runat="server" Text="Onboard  as on date">
                                </telerik:RadLabel>
                            </td>
                            <td>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" 
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="D(0 TO +7)" AllowSorting="false" HeaderStyle-Width="45px"
                        ShowSortIcon="true">
                    ...
                    <telerik:GridTemplateColumn HeaderText="D(+31 TO +37)" AllowSorting="false" HeaderStyle-Width="45px"
                        ShowSortIcon="true">
                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="10px"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="D(+38 TO +45)" AllowSorting="false" HeaderStyle-Width="45px"
                        ShowSortIcon="true">
                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="10px"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="D(> +45)" AllowSorting="false" HeaderStyle-Width="45px"
                        ShowSortIcon="true">
                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="10px"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Total" AllowSorting="false" HeaderStyle-Width="45px"
                        ...
                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="10px"></ItemStyle>
                        <HeaderTemplate>
                            <telerik:RadLabel ID="lblTotalHeader" runat="server" Text="Total">
                            </telerik:RadLabel>
                        </HeaderTemplate>
                        <ItemTemplate>
