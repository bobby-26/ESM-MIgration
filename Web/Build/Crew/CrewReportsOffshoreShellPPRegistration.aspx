<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportsOffshoreShellPPRegistration.aspx.cs"
    Inherits="CrewReportsOffshoreShellPPRegistration" %>
        ...
        <tr>
            ...
            <td>
                <eluc:Vessel runat="server" ID="ucVessel" AppendDataBoundItems="true" VesselsOnly="true"
                    AssignedVessels="true" CssClass="dropdown_mandatory" Entitytype="VSL" />
            </td>
            <td>
            ...
            <td>
                <telerik:RadLabel ID="lblContractno" runat="server" Text="Contract no">
                </telerik:RadLabel>
            </td>
            <td>
                <telerik:RadTextBox ID="txtContractno" runat="server">
                </telerik:RadTextBox>
            </td>
        </tr>
    </table>
