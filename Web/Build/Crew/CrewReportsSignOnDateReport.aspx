<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewReportsSignOnDateReport.aspx.cs"
    Inherits="Crew_CrewReportsSignOnDateReport" %>
...
<body>
    ...
    <div class="navigation" id="Div2" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader" style="position: relative">
            <eluc:Title runat="server" ID="Title3" Text="Crew Sign On Report Filter" ShowMenu="true">
            </eluc:Title>
        ...
        <div>
            <table width="100%" class="style4">
                <tr>
                    ...
                    <td>
                        <eluc:ucAddressType runat="server" ID="ucPrincipal" AddressType="128" AppendDataBoundItems="true"
                            CssClass="input" />
                    </td>
                    <td>
