...
public partial class CrewSeagullCourseExceptionList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Crew/CrewSeagullCourseExceptionList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvSCE')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("../Crew/CrewSeagullCourseExceptionList.aspx", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDFILENAME", "FLDSHEETNAME", "FLDFILENO", "FLDCOURSE", "FLDISSUEDATE", "FLDDONEON", "FLDMESSAGE" };
        string[] alCaptions = { "File Name", "Sheet Name", "File No", "Course", "Issue Date", "Done on", "Message" };
        ...
        DataTable dt = PhoenixCrewSeagull.SearchSeagullCourseException(null, txtfilenumber.Text
                                   , 1, iRowCount
                                   , ref iRowCount, ref iTotalPageCount);

        General.ShowExcel("Seagull Course Exception List", dt, alColumns, alCaptions, sortdirection, sortexpression);
    }
    ...
    private void BindData()
    {
        ...
        DataTable dt = PhoenixCrewSeagull.SearchSeagullCourseException(General.GetNullableInteger(ddlExceptionList.SelectedValue)
                                   , txtfilenumber.Text
        ...
        ds.AcceptChanges();
        General.SetPrintOptions("gvSCE", "Seagull Course Exception List", alCaptions, alColumns, ds);
    ...
    protected void gvSCE_ItemCommand(object sender, GridCommandEventArgs e)
    {
        if (e.CommandName.ToUpper().Equals("UPDATE"))
        {
            ...
            string dateofissue = ((UserControlDate)e.Item.FindControl("txtIssueDate")).Text;
            string doneon = ((RadTextBox)e.Item.FindControl("txtDoneOn")).Text.Trim();
            ...
            PhoenixCrewSeagull.UpdateSeagullCourse(new Guid(dtkey), fileno, course, DateTime.Parse(dateofissue), doneon);
            BindData();
        }
