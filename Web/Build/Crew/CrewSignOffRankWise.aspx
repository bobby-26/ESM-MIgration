<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewSignOffRankWise.aspx.cs"
    Inherits="CrewSignOffRankWise" %>
...
<head runat="server">
    <title>Crew Sign Off Rank Wise</title>
                        ...
                        <tr>
                            ...
                            <td>
                                <eluc:Address ID="ucManager" runat="server" AddressType="126" AppendDataBoundItems="true"
                                    CssClass="dropdown_mandatory" Width="110px" />
                            </td>
                            <td>
                            ...
                            <td>
                                <eluc:Batch ID="ucBatch" runat="server" AppendDataBoundItems="true" Width="110px" />
                            </td>
                            <td colspan="2">
                ...
                <td valign="top">
                    <table cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <telerik:RadLabel ID="lblEmpFleet" runat="server" Text="Employee Fleet">
                                </telerik:RadLabel>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" EnableViewState="false"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Vessel Type" AllowSorting="false" HeaderStyle-Width="85px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblVesselType" Visible="true" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDVESSELTYPE") %>' />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
