...
public partial class CrewSignOffRankWise : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewSignOffRankWise.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewSignOffRankWise.aspx", "Clear Filter", "<i class=\"fa fa-ban fa-eraser\"></i>", "CLEAR");
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (!IsValidFilter(ucManager.SelectedAddress.ToString(), ucRank.SelectedRankValue.ToString(), ucDate.Text, ucDate1.Text))
                {
                    ucError.Visible = true;
                    return;
                }
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDFILENO", "FLDBATCH", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDMARITALSTATUS", "FLDSIGNONDATE", "FLDSIGNOFFDATE", "FLDDURATION", "FLDSEAPORTNAME", "FLDREASON", "FLDAVAILABLE", "FLDVESSELNAME", "FLDVESSELTYPE", "FLDCOURSE", "FLDAPPRAISALRECD" };
        string[] alCaptions = { "EmpNo", "Batch", "Emp Name", "Rank", "Civil Status", "Signed On", "Signed Off", "Duration", "Signed Off Port", "Reason for Sign off", "Available Date", "Vessel", "Vessel Type", "Recmd Course", "Appraisal Recd" };
        string[] FilterColumns = { "FLDSELECTEDPRINCIPAL", "FLDSELECTEDMANAGER", "FLDSELECTEDNATIONALITY", "FLDSELECTEDZONE", "FLDSELECTEDPOOL", "FLDSELECTEDFLEET", "FLDSELECTEDVESSELTYPE", "FLDSELECTEDTRAININGBATCH", "FLDSELECTEDRANK", "FLDSELECTEDSTATUS" };
        string[] FilterCaptions = { "Principal", "Manager", "Nationality", "Zone", "Pool", "Fleet", "Vessel Type", "Batch", "Rank", "Status" };
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=Crew_Sign_Off_Report_Rankwise.xls");
        ...
        Response.Write("<tr><td colspan='" + (alColumns.Length).ToString() + "'><h5><center>Sign Off Rankwise</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        string[] alColumns = { "FLDFILENO", "FLDBATCH", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDSIGNONDATE", "FLDSIGNOFFDATE", "FLDDURATION", "FLDSEAPORTNAME", "FLDREASON", "FLDAVAILABLE", "FLDVESSELNAME", "FLDVESSELTYPE", "FLDCOURSE", "FLDAPPRAISALRECD" };
        string[] alCaptions = { "EmpNo", "Batch", "Emp Name", "Rank", "Signed On", "Signed Off", "Duration", "Signed Off Port", "Reason for Sign off", "Available Date", "Vessel", "Vessel Type", "Recmd Course", "Appraisal Recd" };
        ...
        {
            if (ucRank.selectedlist.ToString().Equals("") || ucRank.selectedlist.ToString().Equals(","))
            {
                ds = PhoenixCrewSignOffReport.CrewSignOffReports(null, null, null, null, null, null, null, null, null, null, null, null, null, null, sortexpression, sortdirection,
                 Int32.Parse(ViewState["PAGENUMBER"].ToString()),
                 gvCrew.PageSize,
            ...
            else
            {
                ...
                else
                {
                    ds = PhoenixCrewSignOffReport.CrewSignOffReports(
                         ...
                         (ucNationality.SelectedList.ToUpper()) == "DUMMY" ? null : General.GetNullableString(ucNationality.SelectedList),
                         (ucManager.SelectedAddress.ToUpper()) == "DUMMY" ? null : General.GetNullableInteger(ucManager.SelectedAddress),
                         (ucRank.selectedlist.ToUpper()) == "," ? null : General.GetNullableString(ucRank.selectedlist),
                         null, null,
                         (ucPrincipal.SelectedAddress.ToUpper()) == "DUMMY" ? null : General.GetNullableString(ucPrincipal.SelectedAddress),
                         (ucVesselType.SelectedVesseltype.ToUpper()) == "DUMMY" ? null : General.GetNullableString(ucVesselType.SelectedVesseltype),
                         (ucEmpFleet.SelectedList.ToUpper()) == "DUMMY" ? null : General.GetNullableString(ucEmpFleet.SelectedList),
    ...
    public bool IsValidFilter(string managerid, string ranklist, string fromdate, string todate)
    {
        DateTime resultdate;
