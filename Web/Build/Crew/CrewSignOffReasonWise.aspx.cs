...
public partial class Crew_CrewSignOffReasonWise : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewSignOffReasonWise.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewSignOffReasonWise.aspx", "Clear Filter", "<i class=\"fa fa-ban fa-eraser\"></i>", "CLEAR");
    ...
    protected void CrewShowExcel_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("CLEAR"))
            {
                ...
                ucPrincipal.SelectedAddress = "";
                ucVesselType.SelectedVesseltype = "";
                //ucReason.SelectedReasonValue = ""; // ucReason is For ListBox
                ddlSignOffReason.SelectedSignOffReason = ""; // ddlSignOffReason is For DropDownList 
                ucPool.SelectedPoolValue = "";
                ucEmpFleet.SelectedFleetValue = "";
                ChkNoReliever.Checked = false;
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SHOWREPORT"))
            {
                ...
                if (!IsValidFilter(ucManager.SelectedAddress.ToString(), ddlSignOffReason.SelectedSignOffReason.ToString(), ucDate.Text, ucDate1.Text))
                {
                    ucError.Visible = true;
                    return;
                }
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDFILENO", "FLDBATCH", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDMARITALSTATUS", "FLDSIGNONDATE", "FLDSIGNOFFDATE", "FLDDURATION", "FLDAGE", "FLDNATIONALITY", "FLDVESSELNAME", "FLDAVAILABLE", "FLDSEAPORTNAME", "FLDRELIEVERNAME", "FLDEXPECTEDJOINDATE", "FLDSIGNONPORT", "FLDCOURSE", "FLDSIGNOFFREMARKS", "FLDAPPRAISALRECD", "FLDHARDNAME" };
        string[] alCaptions = { "EmpNo", "Batch", "Emp Name", "Rank", "Civil Status", "Sign On", "Sign Off", "Duration", "Age", "Nationality", "Vessel", "Available Date", "Signed Off Port", "Reliever Name", "Join Date", "Signed On Port", "Recmd Course", "Remarks", "Appraisal Recd", "Status" };
        string[] FilterColumns = { "FLDSELECTEDPRINCIPAL", "FLDSELECTEDMANAGER", "FLDSELECTEDNATIONALITY", "FLDSELECTEDZONE", "FLDSELECTEDPOOL", "FLDSELECTEDFLEET", "FLDSELECTEDREASON", "FLDSELECTEDVESSELTYPE", "FLDSELECTEDTRAININGBATCH", "FLDSELECTEDSTATUS" };
        string[] FilterCaptions = { "Prinicpal", "Manager", "Nationality", "Zone", "Pool", "Fleet", "Reason", "VesselType", "Batch", "Status" };
        ...
        else
        {
            ...
            if (ddlSignOffReason.SelectedSignOffReason.ToString().Equals("") || ddlSignOffReason.SelectedSignOffReason.ToString().ToUpper().Equals("DUMMY"))
            {
                ds = PhoenixCrewSignOffReport.CrewSignOffReports(null, null, null, null, null, null, null, null, null, null, null, null, null, null, sortexpression, sortdirection,
                Int32.Parse(ViewState["PAGENUMBER"].ToString()),
                iRowCount,
            ...
            else
            {
                ...
                else
                {
                    ds = PhoenixCrewSignOffReport.CrewSignOffReports(
                              ...
                              null, null,
                        //(ucReason.selectedlist) == "," ? null : General.GetNullableString(ucReason.selectedlist),
                              General.GetNullableString(ddlSignOffReason.SelectedSignOffReason),
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=Crew_Sign_Off_Report_Reasonwise.xls");
        ...
        Response.Write("<tr><td colspan='" + (alColumns.Length).ToString() + "'><h5><center>Sign Off Reasonwise</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        string[] alColumns = { "FLDFILENO", "FLDBATCH", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDSIGNONDATE", "FLDSIGNOFFDATE", "FLDDURATION", "FLDAGE", "FLDNATIONALITY", "FLDVESSELNAME", "FLDAVAILABLE", "FLDSEAPORTNAME", "FLDREASON", "FLDSIGNOFFREMARKS", "FLDCOURSE", "FLDAPPRAISALRECD" };
        string[] alCaptions = { "EmpNo", "Batch", "Emp Name", "Rank", "Signed On", "Signed Off", "Duration", "Age", "Nationality", "Vessel", "Available", "Signed Off", " Reason for", "Recmd Course", "Remarks", "Appraisal" };
    ...
    protected void gvCrew_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridEditableItem)
        {
            ...
            if (ViewState["TTO"].ToString() != drv["FLDEMPLOYEESTATUS"].ToString())
                ...
                lbr.Enabled = false;
            RadLabel relieverid = (RadLabel)e.Item.FindControl("lblOffsignerID");
    ...
    public bool IsValidFilter(string managerid, string reason, string fromdate, string todate)
    {
        DateTime resultdate;
        ...
        if (reason.Equals("") || reason.Equals("Dummy"))
        {
