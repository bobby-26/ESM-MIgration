<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewSignOffVesselWise.aspx.cs"
    Inherits="Crew_CrewSignOffVesselWise" %>
...
<head runat="server">
    <title>Crew Sign Off Vessel Wise</title>
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <telerik:RadLabel ID="lblBatchs" runat="server" Text="Batch">
                                </telerik:RadLabel>
                            </td>
                            <td>
                                <eluc:Batch ID="ucBatch" AppendDataBoundItems="true" runat="server" Width="150px" />
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <eluc:Vessel ID="ucVessel" runat="server" AppendDataBoundItems="true" CssClass="input_mandatory"
                                    Width="250px" Entitytype="VSL" AssignedVessel="true" VesselsOnly="true" ActiveVesselsOnly="true" />
                            </td>
                            <td>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" EnableViewState="false"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Duration" AllowSorting="false" HeaderStyle-Width="120px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle Wrap="true" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblOnLeaveDate" Visible="true" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDURATION") %>' />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="Signed Off Port" AllowSorting="false" HeaderStyle-Width="120px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle Wrap="true" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Ex-Vessel" AllowSorting="false" HeaderStyle-Width="120px"
                        ShowSortIcon="true">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle Wrap="true" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Remarks" AllowSorting="false" HeaderStyle-Width="120px"
                        ...
                        <ItemStyle Wrap="false" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblremarkstooltip" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSIGNOFFREMARKS") %>'
                                CssClass="tooltip" ClientIDMode="AutoID">
                            </telerik:RadLabel>
                            <eluc:Tooltip ID="ucToolTipComponent" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSIGNOFFREMARKS") %>'
