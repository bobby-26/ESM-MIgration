<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewSignOnOffFlagBasedVessel.aspx.cs"
    Inherits="CrewSignOnOffFlagBasedVessel" %>
...
<head runat="server">
    <title>Crew Sign On/Off Report Flag Based</title>
...
<body onload="resizeFrame()" onresize="resizeFrame()">
    ...
    <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader" style="position: relative">
            <div id="divHeading">
                <eluc:Title runat="server" ID="ucTitle" Text="Sign Off Report"></eluc:Title>
            </div>
        </div>
        <div style="top: 0px; right: 0px; position: absolute">
            <eluc:TabStrip ID="MenuCrewSignOffVesselType" runat="server" OnTabStripCommand="MenuCrewSignOffVesselType_TabStripCommand"
