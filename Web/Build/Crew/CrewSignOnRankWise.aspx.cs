...
public partial class CrewSignOnRankWise : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewSignOnRankWise.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewSignOnRankWise.aspx", "Clear Filter", "<i class=\"fa fa-ban fa-eraser\"></i>", "CLEAR");
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (!IsValidFilter(ucManager.SelectedAddress.ToString(), ucRank.selectedlist.ToString(), ucDate.Text, ucDate1.Text))
                {
                    ucError.Visible = true;
                    return;
                }
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDROW", "FLDFILENO", "FLDPASSPORTNO", "FLDBATCH", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDMARITALSTATUS", "FLDVESSELNAME", "FLDTRAVELDATE", "FLDSIGNONDATE", "FLDSEAPORTNAME", "FLD3AFORMYN" };
        string[] alCaptions = { "Sr.No", "EmpNo", "Passport No", "Batch", "Emp Name", "Rank", "Civil Status", "Vessel", "Travel to Vessel", "Signed On", "Signed On Port", "IIIA Y/N" };
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=Sign_On_Report_RankWise.xls");
        ...
        Response.Write("<tr><td colspan='" + (alColumns.Length).ToString() + "'><h5><center>Sign On Rankwise</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        string[] alColumns = { "FLDROW", "FLDFILENO", "FLDPASSPORTNO", "FLDBATCH", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDVESSELNAME", "FLDTRAVELDATE", "FLDSIGNONDATE", "FLDSEAPORTNAME" };
        string[] alCaptions = { "Sr.No", "EmpNo", "Passport No", "Batch", "Emp Name", "Rank", "Vessel", "Travel to Vessel", "Signed On", "Signed On Port" };
