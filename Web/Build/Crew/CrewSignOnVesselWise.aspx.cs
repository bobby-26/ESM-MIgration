...
public partial class CrewSignOnVesselWise : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewSignOnVesselWise.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrew')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewSignOnVesselWise.aspx", "Clear Filter", "<i class=\"fa fa-ban fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDROW", "FLDFILENO", "FLDPASSPORTNO", "FLDBATCH", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDMARITALSTATUS", "FLDVESSELNAME", "FLDPRINCIPAL", "FLDVESSELTYPECODE", "FLDTRAVELDATE", "FLDSIGNONDATE", "FLDSEAPORTNAME", "FLDZONE", "FLDDURATION", "FLDRELIEVED", "FLDSIGNOFFDATE", "FLDSIGNOFFPORT", "FLD3AFORMYN", "FLDSIGNOFFREASON" };
        string[] alCaptions = { "S.No.", "File No.", "Passport No.", "Batch", "Name", "Rank", "Civil Status", "Vessel", "Principal", "Type", "Travel to Vessel", "Sign On Date", "Sign On Port", "Zone", "Duration", "Relieved", "Sign off Date", "Sign off Port", "IIIA Y/N", "Sign off Reason" };
        ...
        if (!IsPostBack)
        {
            ds = PhoenixCrewSignOnReport.CrewSignOnReport(null, null, null, 0, null, null, null, null, null, 0, null, null, sortexpression, sortdirection,
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=Sign_On_Report.xls");
        ...
        Response.Write("<tr><td colspan='" + (alColumns.Length).ToString() + "'><h5><center>Sign On Vesselwise</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        string[] alColumns = { "FLDMANAGER", "FLDFILENO", "FLDPASSPORTNO", "FLDBATCH", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDVESSELNAME", "FLDPRINCIPAL", "FLDVESSELTYPECODE", "FLDTRAVELDATE", "FLDSIGNONDATE", "FLDSIGNONPORT", "FLDZONE", "FLDDURATION", "FLDRELIEVED", "FLDSIGNOFFDATE", "FLDSIGNOFFPORT", "FLDSIGNOFFREASON" };
        string[] alCaptions = { "Manager", "File No.", "Passport No.", "Batch", "Name", "Rank", "Vessel", "Principal", "Type", "Travel to Vessel", "Sign On Date", "Sign on Port", "Zone", "Duration", "Relieved", "Sign off Date", "Sign off Port", "Sign off Reason" };
        ...
        ucNationality.SelectedList = ucNationality.SelectedList.ToString().Contains("Dummy,") ? ucNationality.SelectedList.ToString().Replace("Dummy,", "") : ucNationality.SelectedList;
        //ucVessel.SelectedVessel = ucVessel.SelectedVessel.ToString().Contains("Dummy,") ? ucVessel.SelectedVessel.ToString().Replace("Dummy,", "") : ucVessel.SelectedVessel;
        string csvVessel = ucVessel.SelectedVessel;
        csvVessel = csvVessel.Replace("Dummy,", "");
        DataSet ds = new DataSet();
    ...
    public bool IsValidFilter(string managerid, string vessellist, string fromdate, string todate)
    {
        DateTime resultdate;
