...
public partial class Crew_CrewSingleVesselActual : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewSingleVesselActual.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "EXCEL");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrewSingleVessel')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewSingleVesselActual.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDEMPLOYEENAME", "FLDFILENO", "FLDRANKCODE", "FLDNATIONALITY", "FLDSTATUS", "FLDPASSPORTNO", "FLDEXPECTEDJOINDATE", "FLDORIGINALCOC", "FLDRELIEFDUEDATE", "FLDSEAMANBOOKNO" };
        string[] alCaptions = { "Name", "Emp No", "Rank", "Nationality", "Status", "Passport No", "(Exp) Join Date", "S/on Date", "Relief Due", "SMNBK No." };
        ...
        ds = PhoenixCrewSingleVessel.CrewSingleVesselActual(
            General.GetNullableInteger(ucVessel.SelectedVessel),
            ckbSailOnly.Checked.Equals(true) ? 1 : 0,
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=SingleVesselActualScale.xls");
        ...
        Response.Write("<tr><td colspan='" + (alColumns.Length).ToString() + "'><h5><center>Single Vessel Actual Scale</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        DataSet ds = PhoenixCrewSingleVessel.CrewSingleVesselActual(
             General.GetNullableInteger(ucVessel.SelectedVessel),
             ckbSailOnly.Checked.Equals(true) ? 1 : 0,
             sortexpression, sortdirection,
