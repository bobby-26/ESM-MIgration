...
public partial class Crew_CrewSingleVesselOwnerScale : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewSingleVesselOwnerScale.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "EXCEL");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrewSingleVessel')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewSingleVesselOwnerScale.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixCrewSingleVessel.CrewSingleVesselOwnerScale(
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=SingleVesselOwnerScale.xls");
        ...
        Response.Write("<tr><td colspan='" + (alColumns.Length).ToString() + "'><h5><center>Single Vessel Owner Scale</center></h5></td></tr>");
    ...
    private void ShowReport()
    {
        ...
        DataSet ds = PhoenixCrewSingleVessel.CrewSingleVesselOwnerScale(
              General.GetNullableInteger(ucVessel.SelectedVessel),
             sortexpression, sortdirection,
