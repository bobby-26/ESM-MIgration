...
public partial class CrewTravelRequestList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Crew/CrewTravelRequestList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            toolbar.AddFontAwesomeButton("../Crew/CrewTravelRequestList.aspx", "Clear Filter", " <i class=\"fa fa-ban fa-eraser\"></i>", "CLEAR");
            toolbar.AddFontAwesomeButton("../Crew/CrewTravelRequestList.aspx", "New Travel Request", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
            ...
            else if (e.CommandName.ToUpper() == "SELECT")
            {
                ...
                if (lblOfficeTravelYN != null && lblOfficeTravelYN.Text == "1")
                {
                    if (lblApprovedYN != null && lblApprovedYN.Text == "0")
                    {
                        ...
                        Response.Redirect("CrewTravelOfficeQuotation.aspx?from=travel&travelid=" + ViewState["TRAVELID"].ToString() + "&travelrequestedit=" + ViewState["EDITTRAVELREQUEST"].ToString(), false);
                }
                else
                    Response.Redirect("CrewTravelOfficeQuotation.aspx?from=travel&travelid=" + ViewState["TRAVELID"].ToString() + "&travelrequestedit=" + ViewState["EDITTRAVELREQUEST"].ToString(), false);
