<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewVisaReport.aspx.cs" Inherits="Crew_CrewVisaReport" %>
                    ...
                    <td valign="top">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <eluc:Country ID="ucCountry" runat="server" AppendDataBoundItems="true" CssClass="input_mandatory"
                                        Width="100%" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <telerik:RadLabel ID="lblNoOfEntries" runat="server" Text="No of Entries"></telerik:RadLabel>
                                </td>
                                <td>
                                    <telerik:RadComboBox ID="ddlNoofentryAdd" runat="server" AppendDataBoundItems="true" EmptyMessage="Type to select NoofEntry" Filter="Contains" MarkFirstMatch="true"
                                        Width="100%">
                                        <Items>
                                            <telerik:RadComboBoxItem Text="--Select--" Value="Dummy"></telerik:RadComboBoxItem>
                                            <telerik:RadComboBoxItem Text="Single" Value="1"></telerik:RadComboBoxItem>
                                            <telerik:RadComboBoxItem Text="Multiple" Value="2"></telerik:RadComboBoxItem>
                                        </Items>
                                    </telerik:RadComboBox>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <eluc:Vessel ID="ucVessel" runat="server" AppendDataBoundItems="true" CssClass="input_mandatory"
                                        VesselsOnly="true" Width="250px" Entitytype="VSL" AssignedVessels="true" ActiveVesselsOnly="true" />
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <br />
                                    <eluc:Manager ID="ucManager" runat="server" AddressType="126" AppendDataBoundItems="true" />
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrewVisaReport" runat="server" EnableViewState="false"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Date of Expiry" AllowSorting="false" HeaderStyle-Width="40px"
                            ShowSortIcon="true">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>

                            <ItemTemplate>
                                <asp:Label ID="lblDateofExpiry" runat="server" Text='<%# General.GetDateTimeToString(DataBinder.Eval(Container,"DataItem.FLDDATEOFEXPIRY","{0:dd/MMM/yyyy}")) %>'></asp:Label>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Relief Due" AllowSorting="false" HeaderStyle-Width="50px"
                            ...
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(DataBinder.Eval(Container, "DataItem.FLDRELIEFDUEDATE","{0:dd/MMM/yyyy}"))%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="No. of Entries" AllowSorting="false" HeaderStyle-Width="40px"
                            ShowSortIcon="true">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Zone" AllowSorting="false" HeaderStyle-Width="35px"
                            ShowSortIcon="true">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
