...
public partial class Crew_CrewVisaReportOnleavewise : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddFontAwesomeButton("../Crew/CrewVisaReportOnleavewise.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar1.AddFontAwesomeButton("javascript:CallPrint('gvCrewVisaReport')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar1.AddFontAwesomeButton("../Crew/CrewVisaReportOnleavewise.aspx", "Clear Filter", "<i class=\"fa fa-ban fa-eraser\"></i>", "CLEAR");
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                if (!IsValidFilter(ucRank.selectedlist, ucCountry.SelectedCountry.ToString()))
                {
                    ucError.Visible = true;
                    return;
                }
    ...
    protected void ReportsVisaFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../Crew/CrewVisaReport.aspx", true);
    ...
    public bool IsValidFilter(string rank, string visa)
    {
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDROWNUMBER", "FLDEMPLOYEECODE", "FLDEMPLOYEENAME", "FLDRANKCODE", "FLDVESSELNAME", "FLDSIGNOFFDATE", "FLDCOUNTRYNAME", "FLDDATEOFISSUE", "FLDDATEOFEXPIRY", "FLDNOOFENTRYNAME", "FLDZONE" };
        string[] alCaptions = { "S.No.", "File No", "Name", "Rank", "Last Vessel", "Sign-Off Date", "Visa", "Date of Issue", "Date of Expiry", "No. of Entries", "Zone" };
        ...
        ds = PhoenixCrewVisaReport.CrewVisaReportSearchByOnleave(
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=CrewVisaReport_OnLeave.xls");
    ...
    private void ShowReport()
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ds = PhoenixCrewVisaReport.CrewVisaReportSearchByOnleave(null, null, null, null, null, null
            ...
            General.SetPrintOptions("gvCrewVisaReport", "Crew Visa Report", alCaptions, alColumns, ds);
