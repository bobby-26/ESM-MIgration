<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewWorkingGearIssue.aspx.cs"
    Inherits="CrewWorkingGearIssue" %>
    ...
    <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader">
            <div class="divFloatLeft">
                <eluc:Title runat="server" ID="Title1" Text="Crew Working Gear Issue" ShowMenu="false">
                </eluc:Title>
            </div>
            <div class="divFloat">
                <eluc:TabStrip ID="CrewWorkGearIssue" runat="server" OnTabStripCommand="CrewWorkGearIssue_TabStripCommand"
