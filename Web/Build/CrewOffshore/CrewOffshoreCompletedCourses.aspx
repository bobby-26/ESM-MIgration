<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreCompletedCourses.aspx.cs" Inherits="CrewOffshoreCompletedCourses" %>
...
<head runat="server">
    <title>Completed Courses</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <eluc:Title runat="server" ID="Title1" Text="Completed Courses" ShowMenu="<%# Title1.ShowMenu %>">
                    </eluc:Title>
                ...
                <div id="divGrid" style="position: relative; z-index: 0; width: 100%;">
                    <asp:GridView ID="gvCompletedCourse" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowDataBound="gvCompletedCourse_RowDataBound" OnRowEditing="gvCompletedCourse_RowEditing"
                        ShowHeader="true" EnableViewState="false" AllowSorting="true" OnSorting="gvCompletedCourse_Sorting">
                        ...
                        <Columns>                            
                            ...
                            <asp:TemplateField HeaderText="Completed Y/N">
                                ...
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkCompletedYN" runat="server" Enabled="false" Checked='<%# (DataBinder.Eval(Container,"DataItem.FLDCOMPLETEDYN").ToString().Equals("1"))?true:false %>'>
                                    </asp:CheckBox>
                                </ItemTemplate>
                            </asp:TemplateField>
