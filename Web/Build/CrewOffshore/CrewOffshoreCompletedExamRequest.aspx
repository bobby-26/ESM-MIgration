<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreCompletedExamRequest.aspx.cs" Inherits="CrewOffshoreCompletedExamRequest" %>
        ...
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <eluc:Title runat="server" ID="Title1" Text="Completed Test Request" ShowMenu="<%# Title1.ShowMenu %>">
                    </eluc:Title>
                    ...
                    <asp:GridView ID="gvExamRequest" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        <Columns>                            
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton Visible="false" runat="server" AlternateText="Exam" ImageUrl="<%$ PhoenixTheme:images/course-request.png %>"
                                        CommandName="EXAMREQ" CommandArgument="<%# Container.DataItemIndex %>"
                                        ID="cmdExamReq" ToolTip="Exam"></asp:ImageButton>
                                    <img id="Img1" runat="server" src="<%$ PhoenixTheme:images/spacer.png %>" width="3" />
                                    <asp:ImageButton ID="imgCertificate" AlternateText="Generate Certificate" runat="server" CommandName="CERTIFICATE" ImageUrl="<%$ PhoenixTheme:images/annexure.png %>"
                                        ToolTip="Generate Certificate" Visible="false" />
                                </ItemTemplate>
                            </asp:TemplateField>                       
                        </Columns>
                    </asp:GridView>
