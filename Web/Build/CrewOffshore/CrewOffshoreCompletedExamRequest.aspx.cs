...
public partial class CrewOffshoreCompletedExamRequest : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddImageButton("../CrewOffshore/CrewOffshoreCompletedExamRequest.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void CrewQuery_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../CrewOffshore/CrewOffshoreExamRequest.aspx", true);
        }
    }
    ...
    protected void CrewQueryMenu_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("EXCEL"))
            {
                ...
                DataTable dt = PhoenixCrewOffshoreExamRequest.SearchCompletedExamRequest(null, null, null, null, null, null
    ...
    protected void gvExamRequest_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (drv["FLDEXAMRESULTNAME"].ToString().ToUpper().Equals("PASS"))
            {
                if (imgCertificate != null)
