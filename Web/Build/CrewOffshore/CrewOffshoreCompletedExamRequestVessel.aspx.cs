...
public partial class CrewOffshoreCompletedExamRequestVessel : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddImageButton("../CrewOffshore/CrewOffshoreCompletedExamRequestVessel.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void CrewQuery_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (dce.CommandName.ToUpper().Equals("PENDINGEXAM"))
        {
            Response.Redirect("../CrewOffshore/CrewOffshoreExamRequestVessel.aspx", true);
        }
    }
    ...
    protected void CrewQueryMenu_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("EXCEL"))
            {
                ...
                DataTable dt = PhoenixCrewOffshoreExamRequest.SearchCompletedExamRequestVessel(PhoenixSecurityContext.CurrentSecurityContext.InstallCode, null, null, null, null, null
                                                                                       , sortexpression, sortdirection
                                                                                       , 1, iRowCount
                                                                                       , ref iRowCount, ref iTotalPageCount
                                                                                       );
                General.ShowExcel("Completed Test Request", dt, alColumns, alCaptions, sortdirection, sortexpression);
            }
    ...
    public void BindData()
    {
        ...
        try
        {
            ...
            General.SetPrintOptions("gvExamRequest", "Completed Test Request", alCaptions, alColumns, ds);
            if (dt.Rows.Count > 0)
            {
    ...
    protected void gvExamRequest_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            ImageButton imgCertificate = (ImageButton)e.Row.FindControl("imgCertificate");
            if (cmdExamReq != null)
            {
            ...
            if (imgCertificate != null)
            {
                ...
                imgCertificate.Attributes.Add("onclick", "javascript:parent.Openpopup('chml','','../Reports/ReportsView.aspx?applicationcode=11&reportcode=TRAININGCOURSECERTIFICATE&examrequestid=" + drv["FLDEXAMREQUESTID"].ToString() + "&showmenu=0&showword=NO&showexcel=NO'); return true;");
            }
        }
    }
