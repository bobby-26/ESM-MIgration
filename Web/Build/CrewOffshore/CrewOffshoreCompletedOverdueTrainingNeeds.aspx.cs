...
public partial class CrewOffshore_CrewOffshoreCompletedOverdueTrainingNeeds : PhoenixBasePage
{
    ...
    protected void rbtoption_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            coursetype = PhoenixCommonRegisters.GetHardCode(1, 103, "7");
            Response.Redirect("../CrewOffshore/CrewOffshoreCompletedOverdueTrainingNeeds.aspx?employeeid=" + ViewState["employeeid"].ToString() + "&coursetype=" + coursetype, true);
        }
