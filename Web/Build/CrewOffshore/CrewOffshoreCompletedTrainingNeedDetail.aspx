<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreCompletedTrainingNeedDetail.aspx.cs" Inherits="CrewOffshoreCompletedTrainingNeedDetail" %>
    ...
    <form id="frmCrewRecommendedCourses" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <div class="navigation" id="Div1" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                ...
                <telerik:RadLabel ID="lbloverride" runat="server" Text="Completed Training Course"
                    Font-Bold="true">
                </telerik:RadLabel>
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvOffshoreTraining" runat="server" Height="" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                        ...
                        <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn UniqueName="TIC12" ColumnGroupName="office" HeaderText="Details of Training Imparted / Course Attended">
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                    <HeaderStyle Width="200px" />
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn UniqueName="NTI13" ColumnGroupName="office" HeaderText="Name of Trainer / Institute">
                                    <HeaderStyle Width="150px" />
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                ...
                                <telerik:GridTemplateColumn UniqueName="dc14" ColumnGroupName="office" HeaderText="Date Completed">
                                    <HeaderStyle Width="150px" />
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Test" ColumnGroupName="office" UniqueName="test15">
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                    <HeaderStyle Width="100px" />
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn ColumnGroupName="office" HeaderText="No. Of Attempts" UniqueName="attempt16">
                                ...
                                <telerik:GridTemplateColumn HeaderText="Score %" UniqueName="score17" ColumnGroupName="office">
                                    <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                    <HeaderStyle Width="50px" />
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Result" UniqueName="result18" ColumnGroupName="office">
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Date Attended" UniqueName="attended19" ColumnGroupName="office">
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                    <HeaderStyle Width="75px" />
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn UniqueName="action21" HeaderText="Action" ColumnGroupName="office">
