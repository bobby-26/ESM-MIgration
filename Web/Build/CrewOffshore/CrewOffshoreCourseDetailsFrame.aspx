<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreCourseDetailsFrame.aspx.cs" Inherits="CrewOffshore_CrewOffshoreCourseDetailsFrame" %>
    ...
    <div>
     <telerik:RadScriptManager ID="RadScriptManager1" runat="server"></telerik:RadScriptManager>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%" Font-Size="Smaller">
            ...
            <div>
                <telerik:RadGrid ID="gvCrewDocs" runat="server" AutoGenerateColumns="false"
                    ...
                    <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false" GroupsDefaultExpanded="true"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Document Name" HeaderStyle-Width="75px">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Certificate No" HeaderStyle-Width="75px">
                                <ItemTemplate>
