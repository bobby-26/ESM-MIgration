<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreDMRVoyageCompetedROB.aspx.cs" Inherits="CrewOffshore_CrewOffshoreDMRVoyageCompetedROB" %>
        ...
        <div>
            <table>
                ...
                <tr runat="server" visible="false">
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtLocation" runat="server" CssClass="input" Width="230px">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtDeckConditionRemarks" runat="server" TextMode="MultiLine" Width="230px" CssClass="input">
                        </telerik:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <div id="divGrid" style="position: relative; z-index: 0">
            <telerik:RadGrid ID="gvTradingArea" RenderMode="Lightweight" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn FooterText="">
                            ...
                            <ItemTemplate>
                                ...
                                &nbsp;&nbsp;
                                <telerik:RadTextBox ID="txtOthersOilType" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDOTHERSOILTYPE")%>' CssClass="input" Width="350px"></telerik:RadTextBox>
                                <telerik:RadLabel ID="lblOilTypeCode" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDOILTYPECODE")%>' Visible="false"></telerik:RadLabel>
                            </ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn FooterText="">
                            <ItemStyle Wrap="False" HorizontalAlign="Left" Width="30%"></ItemStyle>
                            <HeaderTemplate>
                                <telerik:RadLabel ID="lblTillDateHeader" Text="Amount ROB" runat="server">
                                </telerik:RadLabel>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <eluc:Number ID="ucROB" runat="server" Width="65px" CssClass="input" Enabled="true" IsInteger="true"
                                    Text='<%# DataBinder.Eval(Container, "DataItem.FLDROB")%>' MaskText="###########" />
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
