<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreDocumentCheckListMail.aspx.cs"
    Inherits="CrewOffshore_CrewOffshoreDocumentCheckListMail" %>
...
<head runat="server">
    <title>Document checklist Mail</title>
...
<body>
    <form id="faorm1" runat="server">
        <telerik:RadScriptManager ID="radscript1" runat="server"></telerik:RadScriptManager>
        <telerik:RadAjaxPanel ID="panel1" runat="server">



            <eluc:TabStrip ID="MenuMailRead" runat="server" Title="Message" OnTabStripCommand="MenuMailRead_TabStripCommand"></eluc:TabStrip>
            ...
            <table width="100%">
                <tr>
                    <td colspan="2" width="100%">
                        <telerik:RadEditor ID="edtBody" runat="server" Width="100%" Height="400px" CssClass="readonlytextbox">
                            <Modules>
