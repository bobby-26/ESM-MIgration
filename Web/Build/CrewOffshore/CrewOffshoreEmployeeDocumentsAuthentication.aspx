<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreEmployeeDocumentsAuthentication.aspx.cs"
    Inherits="CrewOffshore_CrewOffshoreEmployeeDocumentsAuthentication" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
            ...
            <eluc:TabStrip ID="AuthenticationMainMenu" runat="server" OnTabStripCommand="AuthenticationMainMenu_TabStripCommand"></eluc:TabStrip>
            ...
            <div id="dvTravel" runat="server" visible="false">
                <table width="100%" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblDocStatus" runat="server" Text="Doc Status"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:Date ID="ucAuthenticationDate" runat="server" CssClass="input" Width="150px" />
                        </td>
                    </tr>
                </table>
            </div>
            <div id="dvLicence" runat="server" visible="false">
                <table width="100%" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblLicenceType" runat="server" Text="Type"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:Date ID="ucLicenceAuthenticationDate" runat="server" CssClass="input" Width="150px" />
                        </td>
                    </tr>
                </table>
            </div>
            <div id="dvMedical" runat="server" visible="false">
                <table width="100%" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:Date ID="txtAuthenticatedDateM" runat="server" CssClass="input" Width="150px" />
                        </td>
                        <td>
                            <telerik:RadLabel ID="lblDoctorNameM" runat="server" Text="Doctor Name"></telerik:RadLabel>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlDoctorM" runat="server" CssClass="input" Width="150px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
            ...
            <div id="dvMedicalTest" runat="server" visible="false">
                <table width="100%" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlDoctor" runat="server" CssClass="input" Width="150px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <eluc:Date ID="ucTestAuthenticationDate" runat="server" CssClass="input" Width="150px" />
                        </td>
                    </tr>
                </table>
            </div>
            <div id="dvCourse" runat="server">
                <table width="100%" cellspacing="5" visible="false">
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:Date ID="ucCourseAuthenticationDate" runat="server" CssClass="input" Width="150px" />
                        </td>
                    </tr>
                </table>
            </div>
            <div id="dvOther" runat="server" visible="false">
                <table width="100%" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:Date ID="ucOtherDocAuthenticationDate" runat="server" CssClass="input" Width="150px" />
                        </td>
                    </tr>
                </table>
            </div>
