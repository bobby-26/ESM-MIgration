<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreEmployeeExperienceGanttChart.aspx.cs" Inherits="CrewOffshoreEmployeeExperienceGanttChart" %>
...
<head runat="server">
    <title>Crew Offshore Employee Experience Visual</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="80%">
            <telerik:RadGantt RenderMode="Lightweight" runat="server" ID="RadGantt1" Height="450px" ListWidth="250px" AllowColumnResize="true"
