<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreEmployeeProsperScore.aspx.cs" Inherits="CrewOffshoreEmployeeProsperScore" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="91%">
            <table cellpadding="1" cellspacing="1" width="99%">
                ...
                <tr>
                    ...
                    <td>                     
                        <telerik:RadComboBox ID="ddlcycle" runat="server" DataTextField="FLDCYCLEDATE" DataValueField="FLDCYCLEID"
                            CssClass="dropdown_mandatory" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlcycle_SelectedIndexChanged"
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvProsperemplist" runat="server" Height="45%" EnableViewState="false"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="DEF" UniqueName="PSCDEF" AllowSorting="false" ColumnGroupName="PSC" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblPSCDEF" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPSCDEF") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="DET" UniqueName="PSCDET" AllowSorting="false" ColumnGroupName="PSC" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblPSCDET" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPSCDET") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="DEF" UniqueName="VETTINGDEF" AllowSorting="false" ColumnGroupName="Vetting" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblVETTINGDEF" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDVETTINGDEF") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="REJ" UniqueName="VETTINGREJ" AllowSorting="false" ColumnGroupName="Vetting" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblREJ" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDVETTINGREJ") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="A" UniqueName="INCIDENTACATEGORY" ColumnGroupName="Incident" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="B" UniqueName="INCIDENTBCATEGORY" ColumnGroupName="Incident" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="C" UniqueName="INCIDENTCCATEGORY" ColumnGroupName="Incident" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="A" UniqueName="HNSACATEGORY" ColumnGroupName="Health & Safety" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="B" UniqueName="HNSBCATEGORY" ColumnGroupName="Health & Safety" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="C" UniqueName="HNSCCATEGORY" ColumnGroupName="Health & Safety" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="POS" UniqueName="FEEDBACKPOSITIVE" ColumnGroupName="Feedback" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="NEG" UniqueName="FEEDBACKNEGATIVE" ColumnGroupName="Feedback" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="WRN" UniqueName="FEEDBACKWARNING" ColumnGroupName="Feedback" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="DEF" UniqueName="TPIDEF" ColumnGroupName="Third Party" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblTPIDEF" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDTPIDEF") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="REJ" UniqueName="TPIDET" ColumnGroupName="Third Party" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblTPIDET" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDTPIDET") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="DEF" UniqueName="EXTDEF" ColumnGroupName="External Nav & Env" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblEXTDEF" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXTDEF") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="REJ" UniqueName="EXTDET" ColumnGroupName="External Nav & Env" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvEmployeeProsper" runat="server" Height="45%" EnableViewState="false"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Measure" AllowSorting="false" ShowSortIcon="true">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblMeasure" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMEASURENAME") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Count" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblCount" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOUNT") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Actual" UniqueName="ACTUAL" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblACTUAL" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDACTUAL") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Final Score" UniqueName="CALCULATED" AllowSorting="false" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <ItemTemplate>
