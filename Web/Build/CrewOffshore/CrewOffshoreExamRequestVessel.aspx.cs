...
public partial class CrewOffshoreExamRequestVessel : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddImageButton("../CrewOffshore/CrewOffshoreExamRequestVessel.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void CrewQuery_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../CrewOffshore/CrewOffshoreCompletedExamRequestVessel.aspx", true);
        }
    }
    ...
    protected void CrewQueryMenu_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("EXCEL"))
            {
                ...
                DataTable dt = PhoenixCrewOffshoreExamRequest.SearchExamRequestVessel(PhoenixSecurityContext.CurrentSecurityContext.InstallCode, null, null, null, null, null
