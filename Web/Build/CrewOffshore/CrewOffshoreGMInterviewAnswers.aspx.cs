...
public partial class CrewOffshore_CrewOffshoreGMInterviewAnswers : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../CrewOffshore/CrewOffshoreGMInterviewAnswers.aspx", "Show Excel","<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvOffshoreAnswers')", "Print the Grid","<i class=\"fas fa-print\"></i>", "PRINT");
    ...
    protected void ShowExcel()
    {
        ...
        DataTable dt = PhoenixCrewOffshoreGMInterviewAnswer.SearchInterviewAnswers(General.GetNullableInteger(ddlQuestion.SelectedValue), sortexpression, sortdirection,
    ...
    protected void ddlQuestion_SelectedValueChanged(object sender, EventArgs e)
    {
    ...
    {
        ddl.DataSource = PhoenixCrewOffshoreGMInterviewQuestions.ListInterviewQuestions(null);
    ...
    protected void gvOffshoreAnswers_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.ToUpper().Equals("ADD"))
            {
                ...
                PhoenixCrewOffshoreGMInterviewAnswer.InsertInterviewAnswer(int.Parse(((RadComboBox)e.Item.FindControl("ddlQuestionAdd")).SelectedValue),
                    ((RadTextBox)e.Item.FindControl("txtAnswerAdd")).Text,
            ...
            else if (e.CommandName.ToUpper().Equals("DELETE"))
            {
                ...
                int answerid = Int32.Parse(item.GetDataKeyValue("FLDANSWERID").ToString());
                PhoenixCrewOffshoreGMInterviewAnswer.DeleteInterviewAnswer(answerid);
                BindData();
                gvOffshoreAnswers.Rebind();
            }
            ...
            else if (e.CommandName.ToUpper().Equals("UPDATE"))
            {
                ...
                PhoenixCrewOffshoreGMInterviewAnswer.UpdateInterviewAnswer(answerid,
    ...
    protected void gvOffshoreAnswers_Sorting(object sender, GridSortCommandEventArgs a)
    {
        ViewState["SORTEXPRESSION"] = a.SortExpression;
