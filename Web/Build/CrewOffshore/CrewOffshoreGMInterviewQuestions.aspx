<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreGMInterviewQuestions.aspx.cs" Inherits="CrewOffshore_CrewOffshoreGMInterviewQuestions" %>
    ...
    <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <eluc:TabStrip ID="MenuOffshoreQuestions" runat="server" OnTabStripCommand="MenuOffshoreQuestions_TabStripCommand">
                 ...
                 <telerik:RadGrid ID="gvOffshoreQuestions" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                       ...
                       ShowHeader="true" EnableViewState="false" AllowSorting="true" AllowPaging="true" AllowCustomPaging="true" 
                        OnItemDataBound="gvOffshoreQuestions_ItemDataBound"  OnSorting="gvOffshoreQuestions_Sorting" 
                        OnNeedDataSource="gvOffshoreQuestions_NeedDataSource" RenderMode="Lightweight"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Rank"   >
                                ...
                                <ItemTemplate>
                                    ...
                                    <%--<asp:ImageButton ID="ImgRankList" runat="server" ImageUrl="<%$ PhoenixTheme:images/te_view.png%>">
                                    </asp:ImageButton>--%>
                                    
                                    <asp:LinkButton ID="ImgRankList" runat="server" CommandName="view"  >
                                 <span class="icon"><i class="fas fa-glasses"></i></span></asp:LinkButton>
                                   
                                    <eluc:Tooltip ID="ucRankList" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDRANKNAMELIST") %>' Width="350px"/>
                                </ItemTemplate>
<%-- <ItemTemplate>
     <asp:ImageButton ID="ImgRankList" runat="server" ImageUrl="<%$ PhoenixTheme:images/te_view.png%>"  CommandArgument='<%# Container.DataItemIndex %>'></asp:ImageButton>
--%>
