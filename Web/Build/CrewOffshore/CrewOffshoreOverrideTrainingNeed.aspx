<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreOverrideTrainingNeed.aspx.cs" Inherits="CrewOffshoreOverrideTrainingNeed" %>
...
<head id="Head1" runat="server">
    <title>Crew Recommended Courses</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                ...
                <div class="subHeader" style="position: relative">
                    <div class="subHeader" id="divHeading">
                        <span style="float: left">
                            <eluc:Title runat="server" ID="ucTitle" Text="Overridden Training Needs" ShowMenu="true" />
                        </span>
                    </div>
                </div>
                        ...
                        <Columns>
                             ...
                             <asp:TemplateField HeaderText="Name">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblExamID" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXAMID") %>'></asp:Label>  
                                    <asp:Label ID="lblCourseRequestId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOURSEREQUESTID") %>'></asp:Label>  
                                    <asp:Label ID="lblExamRequestId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXAMREQUESTID") %>'></asp:Label>                                                                    
                                    <asp:Label ID="lblTrainingNeedId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDTRAININGNEEDID") %>'></asp:Label>
                                    <asp:Label ID="lblIsRaisedFromCBT" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDISRAISEDFROMCBT") %>'></asp:Label>--%>
