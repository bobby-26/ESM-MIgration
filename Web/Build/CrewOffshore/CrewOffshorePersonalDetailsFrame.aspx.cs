...
public partial class CrewOffshore_CrewOffshorePersonalDetailsFrame : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                ucSex.Text = ((int)PhoenixHardTypeCode.SEX).ToString();
               ...
               // lnkResume.Visible = SessionUtil.CanAccess(this.ViewState, "RESUME");
                ...
                typeof(CrewOffshore_CrewOffshorePersonalDetailsFrame),
                "ScriptDoFocus",
    ...
    public void ListCrewInformation()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                ucSex.Text = dt.Rows[0]["FLDSEXNAME"].ToString();
                txtreligion.Text = dt.Rows[0]["FLDRELIGIONNAME"].ToString();  
                ...
                ucPool.Text = dt.Rows[0]["FLDPOOLNAME"].ToString();
                ...
                txtDateofBirth.Text = string.Format("{0:dd/MMM/yyyy}", dt.Rows[0]["FLDDATEOFBIRTH"]);
                txtPlaceofBirth.Text = dt.Rows[0]["FLDPLACEOFBIRTH"].ToString();
                ucMaritialStatus.Text = dt.Rows[0]["FLDMARITALSTATUSNAME"].ToString();
                ucNationality.Text = dt.Rows[0]["FLDNATIONALITYNAME"].ToString();
                //ucZone.SelectedZone = dt.Rows[0]["FLDZONE"].ToString();
                txtairport.Text= dt.Rows[0]["FLDNEAREDTPORT"].ToString();
                txtportofEngage.Text= dt.Rows[0]["FLDPORTOFENGAGEMENT"].ToString();
                txtlastupdatedby.Text = dt.Rows[0]["FLDLASTMODIFIED"].ToString();
                lblavailability.Text= string.Format("{0:dd/MMM/yyyy}", dt.Rows[0]["FLDDOA"]);
                ...
                ddlShoesSize.Text = dt.Rows[0]["FLDSHOESCMS"].ToString();
                ddlShirtSize.Text = dt.Rows[0]["FLDSHIRTSIZE"].ToString();
                txtdatesignon.Text = string.Format("{0:dd/MMM/yyyy}", dt.Rows[0]["FLDSIGNONDATE"]); 
                ucRank.Text = dt.Rows[0]["FLDRANKNAME"].ToString();
                txtAppliedOn.Text = dt.Rows[0]["FLDAPPLIEDON"].ToString();

                txtLastVessel.Text = dt.Rows[0]["FLDLASTVESSELNAME"].ToString();
                ddlRankPosted.Text = dt.Rows[0]["FLDRANKPOSTEDNAME"].ToString();
                txtDateofJoin.Text = string.Format("{0:dd/MMM/yyyy}", dt.Rows[0]["FLDDATEOFJOINING"]);
                ...
                ucZone.Text = dt.Rows[0]["FLDZONENAME"].ToString(); 
                ...
                ucBatch.Text = dt.Rows[0]["FLDBATCHNAME"].ToString();
