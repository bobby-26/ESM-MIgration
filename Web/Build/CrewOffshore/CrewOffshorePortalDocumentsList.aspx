<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshorePortalDocumentsList.aspx.cs" Inherits="CrewOffshore_CrewOffshorePortalDocumentsList" %>
    ...
    <form id="frmCrewOffShoreDocuments" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlDocument" Height="100%">
            ...
            <table width="100%" cellpadding="1" cellspacing="1">
                <tr>
                    <td style="text-emphasis-color: red">
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtPassportnumber" runat="server" CssClass="readonlytextbox" ReadOnly="true"></telerik:RadTextBox>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Date ID="ucDateOfIssue" runat="server" CssClass="readonlytextbox" ReadOnly="true" Enabled="false" />
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Date ID="ucDateOfExpiry" runat="server" CssClass="readonlytextbox" ReadOnly="true" Enabled="false"   />
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtPlaceOfIssue" runat="server" CssClass="readonlytextbox" ReadOnly="true" ></telerik:RadTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Hard ID="ucECNR" runat="server" AppendDataBoundItems="true" Enabled="false" ReadOnly="true" />
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Hard ID="ucBlankPages" runat="server" AppendDataBoundItems="true" Enabled="false"
                            ShortNameFilter="S,N" />
                    </td>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblDeclaration" runat="server" Text="Here i declare the details are correct"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadCheckBox ID="ChkPassport" runat="server"  AutoPostBack="true" ></telerik:RadCheckBox>
                    </td>
                    <td colspan="2"></td>
                </tr>
            </table>
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtSeamanBookNumber" runat="server" Enabled="false"></telerik:RadTextBox>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Flag ID="ucSeamanCountry" runat="server" AppendDataBoundItems="true" Enabled="false" />
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Date ID="ucSeamanDateOfIssue" runat="server" Enabled="false" />
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Date ID="ucSeamanDateOfExpiry" runat="server" Enabled="false" />
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtSeamanPlaceOfIssue" runat="server" Enabled="false"></telerik:RadTextBox>
                    </td>
                    <td>
                 ...
                 <tr>
                    <td>
                        <telerik:RadLabel ID="lblSeamanDeclaration" runat="server" Text="Here i declare the details are correct"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadCheckBox ID="ChkSeamandetails" runat="server"  AutoPostBack="true"></telerik:RadCheckBox>
                    </td>
                    <td colspan="2"></td>
                </tr>
            </table>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvTravelDocument" runat="server" AutoGenerateColumns="False" GroupingEnabled="false" EnableHeaderContextMenu="true" Font-Size="11px"
                ...
                OnUpdateCommand="gvTravelDocument_UpdateCommand" AllowPaging="true" AllowCustomPaging="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="130px" HeaderText="Document Name" UniqueName="DOCTYPE" SortExpression="FLDDOCUMENTNAME">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Declaration" HeaderStyle-Width="70px">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                
                            </ItemTemplate>
                            <FooterTemplate>
                                <telerik:RadCheckBox ID="chkTravelYN" runat="server" Width="100%" AutoPostBack="true" ToolTip="Here i declare the details are correct"></telerik:RadCheckBox>
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
            ...
            <%--   <telerik:RadGrid RenderMode="Lightweight" ID="gvCrewLicence" runat="server" AutoGenerateColumns="False" GroupingEnabled="false" 
                EnableHeaderContextMenu="true" Font-Size="11px"
                Width="100%" CellPadding="3" OnItemCommand="gvCrewLicence_ItemCommand" OnItemDataBound="gvCrewLicence_ItemDataBound"
                OnDeleteCommand="gvCrewLicence_DeleteCommand" OnNeedDataSource="gvCrewLicence_NeedDataSource" Height="300px"
                OnSelectedIndexChanging="gvCrewLicence_SelectedIndexChanging" AllowPaging="true" AllowCustomPaging="true"
                OnUpdateCommand="gvCrewLicence_RowUpdating" ShowFooter="true" ShowHeader="true" EnableViewState="false">
                <FooterStyle CssClass="datagrid_footerstyle"></FooterStyle>
                <HeaderStyle CssClass="DataGrid-HeaderStyle" />
                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrewLicence" runat="server" AutoGenerateColumns="False" GroupingEnabled="false" EnableHeaderContextMenu="true" Font-Size="11px"
               CellPadding="3" OnItemCommand="gvCrewLicence_ItemCommand" OnItemDataBound="gvCrewLicence_ItemDataBound"
                OnDeleteCommand="gvCrewLicence_DeleteCommand" OnNeedDataSource="gvCrewLicence_NeedDataSource"
                OnUpdateCommand="gvCrewLicence_RowUpdating" AllowPaging="true" AllowCustomPaging="true" 
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Licence Number" FooterText="Number" HeaderStyle-Width="70px">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lnkLicenceName" runat="server" CommandName="EDIT" CommandArgument="<%# Container.DataItem %>"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Declaration" HeaderStyle-Width="70px">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <FooterTemplate>
                                 <telerik:RadCheckBox ID="chkLicenceYN" runat="server" Width="100%" AutoPostBack="true" ToolTip="Here i declare the details are correct"></telerik:RadCheckBox>
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Seafarer" UniqueName="ISADDEDBYSEAFARER" HeaderStyle-Width="120px">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Medical" HeaderStyle-Width="70px">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lnkDoubleClick" runat="server" Visible="false" CommandName="Edit"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Medical Test" HeaderStyle-Width="150px">
                            ...
                            <EditItemTemplate>
                                <telerik:RadLabel ID="lnkDoubleClickEdit" runat="server" Visible="false" CommandName="Edit"
                                    CommandArgument='<%# Container.DataItem %>'>
                                </telerik:RadLabel>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Declaration" HeaderStyle-Width="70px">
                            ...
                            <FooterTemplate>
                                <telerik:RadCheckBox ID="chkMedicalTestYN" runat="server" Width="100%" AutoPostBack="true" ToolTip="Here i declare the details are correct"></telerik:RadCheckBox>
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-Width="200px">
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Course" HeaderStyle-Width="120px">
                            <ItemTemplate>
                                <asp:Label ID="lnkDoubleClick" runat="server" Visible="false" CommandName="Edit"
                                    CommandArgument='<%# Container.DataItem %>'></asp:Label>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Certificate Number" FooterText="Number" HeaderStyle-Width="85px">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lnkCourseNumber" runat="server" CommandName="EDIT" CommandArgument="<%# Container.DataItem %>"
                                    Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOURSENUMBER") %>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Declaration" HeaderStyle-Width="70px">
                            ...
                            <FooterTemplate>
                                <telerik:RadCheckBox ID="chkCourseYN" runat="server" Width="100%" AutoPostBack="true" ToolTip="Here i declare the details are correct"></telerik:RadCheckBox>
                            </FooterTemplate>
                            </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-Width="200px">
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Declaration" HeaderStyle-Width="70px">
                            ...
                            <FooterTemplate>
                                <telerik:RadCheckBox ID="chkOtherDocYN" runat="server" Width="100%" AutoPostBack="true" ToolTip="Here i declare the details are correct"></telerik:RadCheckBox>
                            </FooterTemplate>
                            </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-Width="200px">
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
