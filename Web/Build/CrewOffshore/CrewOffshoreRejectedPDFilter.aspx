<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreRejectedPDFilter.aspx.cs" Inherits="CrewOffshoreRejectedPDFilter" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <eluc:TabStrip ID="MenuPD" runat="server" Title="Rejected Proposal Filter" OnTabStripCommand="PD_TabStripCommand"></eluc:TabStrip>
            ...
            <div id="divFind">
                <table cellpadding="2" cellspacing="2">
                    <tr>
                        ...
                        <td>
                            <eluc:Rank ID="ddlRank" runat="server" AppendDataBoundItems="true" Width="150px" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:Vessel ID="ddlVessel" runat="server" AppendDataBoundItems="true" VesselsOnly="true" Width="150px"
                                 />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <eluc:User ID="ddlUser" runat="server" AppendDataBoundItems="true"  ActiveYN="172" Width="150px" />
                        </td>
                    </tr>
                </table>
            </div>
