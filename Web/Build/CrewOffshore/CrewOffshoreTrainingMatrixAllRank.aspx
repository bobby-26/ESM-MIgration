<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreTrainingMatrixAllRank.aspx.cs" Inherits="CrewOffshore_CrewOffshoreTrainingMatrixAllRank" %>
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Rank" HeaderStyle-Width="100px">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:Label ID="lblrankidedit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDRANKID") %>'></asp:Label>
