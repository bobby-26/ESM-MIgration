<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreTrainingNeedsCBTDetail.aspx.cs"
    Inherits="CrewOffshoreTrainingNeedsCBTDetail" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvTrainingbyreg" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowSorting="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Result" ColumnGroupName="To be Completed by Manning Office / Agent" HeaderStyle-Width="60px">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblResult" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXAMRESULT") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Date Attended" UniqueName="Attend17" ColumnGroupName="To be Completed by Manning Office / Agent" HeaderStyle-Width="105px">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn ColumnGroupName="To be Completed by Manning Office / Agent" UniqueName="Action20" HeaderText="Action" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px">
                            <ItemTemplate>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvOffshoreTraining" runat="server" AutoGenerateColumns="False" AllowPaging="true" AllowCustomPaging="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Date Completed" UniqueName="Date16" ColumnGroupName="header text" HeaderStyle-Width="120px">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblCompletionDate" runat="server" Text='<%# General.GetDateTimeToString(DataBinder.Eval(Container,"DataItem.FLDDATECOMPLETED")) %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Test" UniqueName="Exam17" ColumnGroupName="To be Completed by Manning Office / Agent" HeaderStyle-Width="140px">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblExam" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXAMNAME") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="No. of Attempts" UniqueName="Attempt18" ColumnGroupName="To be Completed by Manning Office / Agent" HeaderStyle-Width="90px">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Score" UniqueName="Score19" ColumnGroupName="To be Completed by Manning Office / Agent" HeaderStyle-Width="80px">
                            <HeaderTemplate>
                                <telerik:RadLabel ID="lblScoreHeader" runat="server" Text="Score %"></telerik:RadLabel>
                            </HeaderTemplate>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Result" UniqueName="Result20" ColumnGroupName="To be Completed by Manning Office / Agent" HeaderStyle-Width="60px">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblResult" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXAMRESULT") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Date Attended" UniqueName="Date21" ColumnGroupName="To be Completed by Manning Office / Agent" HeaderStyle-Width="100px">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblDateAttended" runat="server" Text='<%# General.GetDateTimeToString(DataBinder.Eval(Container,"DataItem.FLDDATEATTENDED")) %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn ColumnGroupName="To be Completed by Manning Office / Agent" UniqueName="Action24" HeaderStyle-Width="100px" HeaderText="Action" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
