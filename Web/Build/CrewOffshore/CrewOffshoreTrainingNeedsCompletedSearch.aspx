<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffshoreTrainingNeedsCompletedSearch.aspx.cs" Inherits="CrewOffshoreTrainingNeedsCompletedSearch" %>
        ...
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <eluc:Title runat="server" ID="Title1" Text="Completed Training Needs Search" ShowMenu="<%# Title1.ShowMenu %>">
                    </eluc:Title>
                </div>
