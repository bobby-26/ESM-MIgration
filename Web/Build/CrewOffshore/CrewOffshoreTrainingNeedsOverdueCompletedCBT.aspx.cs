...
public partial class CrewOffshore_CrewOffshoreTrainingNeedsOverdueCompletedCBT : PhoenixBasePage
{
    ...
    protected void rbtoption_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            coursetype = PhoenixCommonRegisters.GetHardCode(1, 103, "4");
            Response.Redirect("../CrewOffshore/CrewOffshoreTrainingNeedsOverdueCompletedCBT.aspx?employeeid=" + ViewState["employeeid"].ToString() + "&coursetype=" + coursetype, true);
        }
    }
