...
public partial class CrewOffshoreVesselEmployeeFamily : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                TextBox txtBankAddress1 = (TextBox)(ucBankAddress.FindControl("txtAddressLine1"));
                ...
                typeof(CrewOffshoreVesselEmployeeFamily),
                "ScriptDoFocus",
