<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewoffshoreTrainingNeedTaskOverride.aspx.cs" Inherits="CrewOffshore_CrewoffshoreTrainingNeedTaskOverride" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvTask.ClientID %>"));
                }, 200);
            }
        ...
        <div>
            ...
            <telerik:RadAjaxPanel runat="server" ID="pnlCrewRecommendedCourses">
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvTask" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowSorting="true"
                    ...
                    OnItemCommand="gvTask_ItemCommand"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Category" HeaderStyle-Width="200px">
                                <ItemTemplate>
                                    ...
                                    <telerik:RadLabel ID="lblTrainingNeedId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDTRAININGNEEDID") %>'></telerik:RadLabel>
