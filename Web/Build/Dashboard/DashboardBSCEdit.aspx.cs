...
public partial class Dashboard_DashboardBSCEdit : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbargrid.AddLinkButton("javascript:parent.openNewWindow('issue', 'Add Issue', 'Dashboard/DashboardBSCIssue.aspx?kpiid=" + ViewState["KPIID"].ToString() + "', 'false', '720px', '430px'); return false; ", "Add Issue", "Toggle2", ToolBarDirection.Left);
        toolbargrid.AddLinkButton("javascript:parent.openNewWindow('initiative', 'Add Initiative', 'Dashboard/DashboardBSCInitiative.aspx?kpiid=" + ViewState["KPIID"].ToString() + "&edit=no" + "', 'false', '720px', '330px'); return false; ", "Add Initiative", "Toggle3", ToolBarDirection.Left);
    ...
    protected void Tabkpi_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Guid? scorecardid = General.GetNullableGuid(ViewState["SCORECARDID"].ToString());
                int rowusercode = PhoenixSecurityContext.CurrentSecurityContext.UserCode;
                string team = string.Empty;
                team = General.GetNullableString(GetCheckedItemsvalues(radexecutioncb, team));
                PhoenixDashboardBSC.KPISCUpdate(rowusercode, scorecardid, team);
