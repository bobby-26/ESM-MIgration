<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardBSCLIAdd.aspx.cs" Inherits="Dashboard_DashboardBSCLIAdd" %>
...
<head runat="server">
    <title>Create Leading Indicator (LI)</title>
            ...
            <table style="margin-left: 20px">
                ...
                <tr>
                    ...
                    <telerik:RadComboBox runat="server" ID="radcbdept" CssClass="input_mandatory" Width="150px"
                         ...
                         <eluc:Hard ID="radcbrank" runat="server" AppendDataBoundItems="true" HardList='<%# PhoenixRegistersHard.ListHard(1, 51) %>' Width="150px"
                    ...
                    <td>
                        ...
                        <telerik:RadMultiColumnComboBox RenderMode="Lightweight" ID="Radcombodesignationlist" runat="server" Width="290px" Height="150px" NoWrap="true"
                            ...
                            Placeholder="Type to select to whom LI is to be Assigned" Filter="Contains" FilterFields="FLDDESIGNATIONNAME, FLDUSERNAME" CssClass="input_mandatory" >
                            <NoDataTemplate>
