<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardCommonOfficeVesselPosition.aspx.cs"
    Inherits="DashboardCommonOfficeVesselPosition" %>
        ...
        <div class="db_container">
            <div class="subHeader" style="position: relative">
                <div id="divHeading" style="vertical-align: top;">
                    <asp:Literal ID="lbltitle" runat="server" Text="Vessel Position"></asp:Literal>
                </div>
            </div>
                            ...
                            <td valign="top">
                                <div style="border-width: 1px; border-style: groove; border-color: Navy; width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RadioButtonList ID="rblNavication" runat="server" AppendDataBoundItems="false"
                                                    ...
                                                    <asp:ListItem Text="Map With Vessel List" Value="2" Selected="True"></asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <div id="divgrid" style="width: 100%; overflow-x: auto; overflow-y: auto;">
                                        <asp:GridView ID="gvVesselList" runat="server" AutoGenerateColumns="False" Font-Size="11px"
