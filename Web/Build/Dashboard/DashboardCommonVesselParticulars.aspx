<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardCommonVesselParticulars.aspx.cs"
    Inherits="DashboardCommonVesselParticulars" %>
...
<body>
    ...
    <asp:UpdatePanel runat="server" ID="pnlVesselParticulars">
        <ContentTemplate>
            <div class="db_container">
                <eluc:DashboardMenu runat="server" ID="ucDashboardMenu" SelectedOption="TECH-VOV" />
                <div class="db_results">
                    <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
                    <div class="navigation" id="navigation" style="margin-left: 0px; vertical-align: top; width: 99.9%;">
                        <table id="tblfind" width="100%" border="1" bordercolor="black">
                            <tr style="width: 25%">
                                <td style="width: 35%; background-color: Blue; color: White" colspan="1">
                                    <center>
                                        <asp:Label ID="lblVesselName" runat="server"></asp:Label></center>
                                </td>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblMaster" runat="server" Text="Master"></asp:Literal></b>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td rowspan="9">
                                    <a id="aVesselImg" runat="server">
                                        <asp:Image ID="imgPhoto" runat="server" Height="180px" Width="390px" /></a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblChiefEngineerHeader" runat="server" Text="Chief Engineer"></asp:Literal></b>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblLastExportSequenceHeader" runat="server" Text="Last Export Sequence"></asp:Literal></b>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblLastExportDateHeader" runat="server" Text="Last Export Date"></asp:Literal></b>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblLastImportSequenceHeader" runat="server" Text="Last Import Sequence"></asp:Literal></b>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblLastImportDateHeader" runat="server" Text="Last Import Date"></asp:Literal></b>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblLatitudeHeader" runat="server" Text="Latitude"></asp:Literal></b>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblLongitudeHeader" runat="server" Text="Longitude"></asp:Literal></b>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td style="width: 20%">
                                    <b>
                                        <asp:Literal ID="lblSpareLifeBoatCapacityHeader" runat="server" Text="Spare Life Boat Capacity"></asp:Literal></b>
                                </td>
                                <td>
                        ...
                        <table cellpadding="1" cellspacing="1" width="100%">
                            ...
                            <tr>
                                ...
                                <td style="width: 20%">
                                    <asp:TextBox runat="server" ID="txtVesselCode" CssClass="input" ReadOnly="true" Width="80%"></asp:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td style="width: 20%">
                                    <asp:TextBox ID="txtPortofRegistery" runat="server" CssClass="input" Width="80%"
                            ...
                            <tr>
                                ...
                                <td style="width: 20%">
                                    <asp:TextBox runat="server" ID="txtHullNo" MaxLength="20" ReadOnly="true" Width="80%"
                                        CssClass="input"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtFittedwithFramo" runat="server" CssClass="input" Width="80%"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtESMHandoverDate" runat="server" CssClass="input" Width="80%"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td>
                        ...
                        <table cellpadding="1" cellspacing="1" width="100%">
                            <tr>
                                <td colspan="2">
                                    <b>
                                        <asp:Literal ID="lblPrincipalDimensions" runat="server" Text="Principal Dimensions"></asp:Literal></b>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 10%">
                        ...
                        <table cellpadding="1" cellspacing="1" width="100%">
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblTonnage" runat="server" Text="Tonnage"></asp:Literal></b>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 10%">
                        ...
                        <table cellpadding="1" cellspacing="1" width="100%">
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblLoadLine" runat="server" Text="Load Line"></asp:Literal></b>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 10%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtFreeboardTropical" Width="70px" CssClass="input"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtFreeboardSummer" Width="70px" CssClass="input"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtFreeboardWinter" Width="70px" CssClass="input"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtFreeboardLightship" Width="70px" CssClass="input"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox runat="server" ID="txtDraftLightship" Width="70px" CssClass="input"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtFreeboardBallastCond" Width="70px" CssClass="input"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox runat="server" ID="txtDraftBallastCond" Width="70px" CssClass="input"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox runat="server" ID="txtDWTBallastCond" Width="70px" CssClass="input"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellpadding="1" cellspacing="1" width="100%">
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblMainMachinery" runat="server" Text="Main Machinery"></asp:Literal></b>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 10%">
                            ...
                            <tr>
                                ...
                                <td style="width: 20%">
                                    <asp:TextBox runat="server" ID="txtLifeBoatQuantity" CssClass="input" Width="50px"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 10%">
                                ...
                                <td style="width: 20%">
                                    <asp:TextBox runat="server" ID="txtLifeBoatCapacity" CssClass="input" Width="50px"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="25%">
                                    <asp:TextBox runat="server" ID="txtRemarks" CssClass="input" TextMode="MultiLine"
                                        ReadOnly="true" Height="70px" Width="80%"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <br />
                        ...
                        <table width="100%" id="tblCommunication">
                            <tr>
                                <td>
                                    <b>
                                        <asp:Literal ID="lblCommunication" runat="server" Text="Communication"></asp:Literal></b>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:Panel ID="pnlSatcom" runat="server" GroupingText="Satcom" Width="100%" Height="40%">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtBPhone" CssClass="input" MaxLength="50" Width="85%"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                                <td style="width: 10%">
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtBFax" CssClass="input" MaxLength="50" Width="85%"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtFPhone" CssClass="input" MaxLength="50" Width="85%"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                                <td style="width: 10%">
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtFFax" CssClass="input" MaxLength="50" Width="85%"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtAPhone" CssClass="input" MaxLength="50" Width="85%"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                                <td style="width: 10%">
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtAFax" CssClass="input" MaxLength="50" Width="85%"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtCTalex" CssClass="input" MaxLength="50" Width="85%"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <asp:Panel ID="pnlEmail" runat="server" GroupingText="E-mail" Width="100%" Height="40%">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtEmail" MaxLength="50" Width="85%" CssClass="input"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                                <td style="width: 10%">
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtNotificationEmail" CssClass="input" MaxLength="50"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" ID="txtAccInchargeEmail" CssClass="input" MaxLength="50"
                                                        ReadOnly="true" Width="85%"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <asp:Panel ID="pnlPhone" runat="server" GroupingText="Phone" Width="100%" Height="40%">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtPhone" CssClass="input" MaxLength="50" Width="85%"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                                <td style="width: 10%">
                                                ...
                                                <td style="width: 17%">
                                                    <asp:TextBox runat="server" ID="txtFax" CssClass="input" MaxLength="50" Width="85%"
                                                        ReadOnly="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
