...
public partial class DashboardCrewAccounts : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //    gvExport.Title = " [ " + nvc.Get("VesselName") != null ? nvc.Get("VesselName").ToString() : "" + " - " + nvc.Get("MeasureName") != null ? nvc.Get("MeasureName").ToString() : "" + " ] ";
            //}
        }
        BindToolbar();
        BindMenu();
    ...
    {     
        ...
        toolbargrid.AddFontAwesomeButton("../Dashboard/DashboardCrewAccounts.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void gvMeasureResult_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        DataSet ds = PhoenixDashboardTechnical.DashboardMeasureResult("CREWACCT"
    ...
    protected void gvMeasureResult_ItemCommand(object sender, GridCommandEventArgs e)
    {
        if (e.CommandName == "RowClick" && PhoenixSecurityContext.CurrentSecurityContext.InstallCode == 0)
        {
            ...
            nvc["SelectedModuleScreen"] = "../Accounts/AccountsInvoiceMaster.aspx";
            ...
            if (nvc != null)
            {
                ...
                string invoicenumber = item["Invoice_Number"].Text.ToString();

                criteria.Add("txtInvoiceNumberSearch", item["Invoice_Number"].Text.ToString());
                ...
                Filter.CurrentSelectedModule = "Accounts";
                Response.Redirect("../Accounts/AccountsInvoiceMaster.aspx");
    ...
    {
        DataSet ds = PhoenixDashboardOption.DashboardLastSelectedEdit("CREW", "CIN");
        ...
        {
            DataSet d = PhoenixDashboardTechnical.DashboardMeasure("CREWACCT", null);
            nvc.Add("APP", "CREW");
            nvc.Add("Option", "CIN");
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (ds.Tables[0].Rows[i]["FLDCOMMANDNAME"].ToString().ToUpper().Equals("INVOICE"))
                    {
	...
	private void ShowExcel()
	{
		...
		string[] ignoreColumns = { "FLDORDERID", "FLDVESSELID", "Column1" };
