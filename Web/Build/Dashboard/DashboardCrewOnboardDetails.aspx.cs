...
public partial class DashboardCrewOnboardDetails : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Dashboard/DashboardCrewOnboardDetails.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDEMPLOYEENAME", "FLDRANKNAME", "FLDPRESENTVESSEL", "FLDSIGNOFFOLDVESSEL", "FLDSIGNONDATE", "FLDRELIEFDUE" };
        string[] alCaptions = { "Name", "Rank", "Present Vessel", "Last Vessel", "Sign-on Date", "Relief Due Date" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewOnboardSearch(General.GetNullableString(ViewState["RANKID"].ToString())
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixDashboardOfficeV2Crew.DashboardCrewOnboardSearch(ViewState["RANKID"].ToString()
                    , sortexpression, sortdirection,
