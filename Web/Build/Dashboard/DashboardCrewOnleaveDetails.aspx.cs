...
public partial class DashboardCrewOnleaveDetails : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../DashBoard/DashboardCrewOnleaveDetails.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDEMPLOYEENAME", "FLDRANKNAME", "FLDSIGNOFFOLDVESSEL", "FLDSIGNOFFOLDVESSEL", "FLDDOA", "FLDPLANNEDVESSELNAMES" };
        string[] alCaptions = { "Name", "Rank", "Last Vessel", "Sign-Off Date", "D.O.A", "Planned Vessel" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewOnleaveSearch(General.GetNullableString(ViewState["RANKID"].ToString())
        ...
        if (ds.Tables.Count > 0)
            General.ShowExcel("Crew OnLeave", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixDashboardOfficeV2Crew.DashboardCrewOnleaveSearch(General.GetNullableString(ViewState["RANKID"].ToString())
                    , sortexpression, sortdirection,
        ...
        General.SetPrintOptions("gvcrew", "Crew OnLeave", alCaptions, alColumns, ds);
