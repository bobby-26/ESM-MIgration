...
public partial class DashboardCrewVesselPosition : PhoenixBasePage
{
    ...
    protected void BindToolbar()
    {
        ...
        toolbargrid.AddFontAwesomeButton("../Dashboard/DashboardCrewVesselPosition.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void GvCrew_NeedDataSource(object sender, Telerik.Web.UI.PivotGridNeedDataSourceEventArgs e)
    {
        ...
        NameValueCollection nvc = Filter.CurrentDashboardLastSelection;
        DataSet ds = PhoenixDashboardCrew.DashboardMeasure("VSLPOS", General.GetNullableString(nvc.Get("RankList")));
        if (ds.Tables.Count > 0)
        {
    ...
    protected void gvMeasureResult_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        DataSet ds = PhoenixDashboardCrew.DashboardMeasureResult("VSLPOS"
    ...
    {
        DataSet ds = PhoenixDashboardOption.DashboardLastSelectedEdit("CREW", "VPN");
        ...
        {
            DataSet d = PhoenixDashboardCrew.DashboardMeasure("VSLPOS", null);
            nvc.Add("APP", "CREW");
            nvc.Add("Option", "VPN");
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (ds.Tables[0].Rows[i]["FLDCOMMANDNAME"].ToString().ToUpper().Equals("ICEEXP"))
                    {
