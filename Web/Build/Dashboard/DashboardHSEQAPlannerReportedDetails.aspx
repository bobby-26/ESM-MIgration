<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardHSEQAPlannerReportedDetails.aspx.cs" Inherits="Dashboard_DashboardHSEQAPlannerReportedDetails" %>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Planned Date">
                         ...
                         <telerik:GridTemplateColumn HeaderText="Reason For No Attachments ">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="Radlblreason" runat="server" Text='<%#( DataBinder.Eval(Container, "DataItem.FLDREASON"))%>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
