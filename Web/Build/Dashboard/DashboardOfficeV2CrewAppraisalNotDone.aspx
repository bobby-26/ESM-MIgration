<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2CrewAppraisalNotDone.aspx.cs" Inherits="DashboardOfficeV2CrewAppraisalNotDone" %>
...
<head runat="server">
    <title>Appraisal Not Done</title>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" ShowFooter="false" EnableViewState="True" OnSortCommand="gvCrew_SortCommand"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Date Of Appraisal Done" AllowSorting="true">
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDAPPRAISALDONEDATE"])%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Next Vessel Planned" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDPLANNEDVESSELNAMES")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
