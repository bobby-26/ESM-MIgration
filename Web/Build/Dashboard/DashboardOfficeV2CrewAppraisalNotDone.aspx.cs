...
public partial class DashboardOfficeV2CrewAppraisalNotDone : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Dashboard/DashboardOfficeV2CrewAppraisalNotDone.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDEMPLOYEENAME", "FLDRANKNAME", "FLDLASTVESSELNAME", "FLDSIGNOFFDATE", "FLDAPPRAISALDONEDATE", "FLDPLANNEDVESSELNAMES" };
        string[] alCaptions = { "Name", "Rank", "Last Vessel Name", "Sign Off Date", "Date Of Appraisal Done", "Next Vessel Planned" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewAppraisalNotDone(General.GetNullableString(ViewState["RANKID"].ToString())
        ...
        if (ds.Tables.Count > 0)
            General.ShowExcel("Appraisal Not Done", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixDashboardOfficeV2Crew.DashboardCrewAppraisalNotDone(General.GetNullableString(ViewState["RANKID"].ToString())
                       , sortexpression, sortdirection,
        ...
        General.SetPrintOptions("gvCrew", "Appraisal Not Done", alCaptions, alColumns, ds);
