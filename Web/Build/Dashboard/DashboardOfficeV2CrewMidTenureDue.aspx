<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2CrewMidTenureDue.aspx.cs" Inherits="DashboardOfficeV2CrewMidTenureDue" %>
...
<head runat="server">
    <title>Mid Tenure Appraisal</title>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <NoRecordsTemplate>
                      ...
                      <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Due Date of Mid Tenure Appraisal (Contract Period / 2)" AllowSorting="true">
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDMIDTENUREDUE"])%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Sign On Date" AllowSorting="true">
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDSIGNONDATE"])%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Relief Due" AllowSorting="true">
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDRELEFDUEDATE"])%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
