...
public partial class DashboardOfficeV2CrewMidTenureDue : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Dashboard/DashboardOfficeV2CrewMidTenureDue.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDEMPLOYEENAME", "FLDRANKNAME", "FLDVESSELNAME", "FLDMIDTENUREDUE", "FLDSIGNONDATE", "FLDRELEFDUEDATE" };
        string[] alCaptions = { "Name", "Rank", "Vessel Name", "Due Date of Mid Tenure Appraisal (Contract Period / 2)", "Sign On Date", "Relief Due" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewMidTenureAppraisalDue(General.GetNullableString(ViewState["RANKID"].ToString())
        ...
        if (ds.Tables.Count > 0)
            General.ShowExcel("Mid Tenure Due", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixDashboardOfficeV2Crew.DashboardCrewMidTenureAppraisalDue(General.GetNullableString(ViewState["RANKID"].ToString())
                        , sortexpression, sortdirection,
        ...
        General.SetPrintOptions("gvCrew", "Mid Tenure Due", alCaptions, alColumns, ds);
