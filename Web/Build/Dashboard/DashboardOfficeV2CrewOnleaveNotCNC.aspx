<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2CrewOnleaveNotCNC.aspx.cs" Inherits="DashboardOfficeV2CrewOnleaveNotCNC" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvonleave.ClientID %>"));
                }, 200);
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <eluc:TabStrip ID="gvonleaveTab" runat="server" OnTabStripCommand="gvonleaveTab_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvonleave" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" ShowFooter="false" EnableViewState="True" OnSortCommand="gvonleave_SortCommand"
                OnNeedDataSource="gvonleave_NeedDataSource" OnItemCommand="gvonleave_ItemCommand" OnItemDataBound="gvonleave_ItemDataBound">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Batch" AllowSorting="true">
                            <ItemTemplate>
