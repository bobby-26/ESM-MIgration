<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2CrewOntimeRelief.aspx.cs" Inherits="DashboardOfficeV2CrewOntimeRelief" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" ShowFooter="false" EnableViewState="True" OnSortCommand="gvCrew_SortCommand"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Sign Off No. of Days - Contract" AllowSorting="true">
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDSSIGNOFDATEDIFF"])%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Sign Off Date" AllowSorting="true">
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDSIGNOFFDATE"])%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>                       
                        <telerik:GridTemplateColumn HeaderText="Reason" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDSIGNOFFREASON")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="DOA" AllowSorting="true">
                            <ItemTemplate>                              
                                 <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDDOA"])%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
