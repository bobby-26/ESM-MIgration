<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2CrewSummary.aspx.cs" Inherits="DashboardOfficeV2CrewSummary" %>
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="gvCrewSummary">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gvCrewSummary" UpdatePanelHeight="99%"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
        </telerik:RadAjaxManager>
        <telerik:RadPivotGrid ID="gvCrewSummary" runat="server" TotalsSettings-ColumnGrandTotalsPosition="None" OnNeedDataSource="gvCrewSummary_NeedDataSource"
