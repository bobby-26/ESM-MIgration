...
public partial class DashboardOfficeV2CrewTraineeJoiner : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Dashboard/DashboardOfficeV2CrewTraineeJoiner.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDEMPLOYEENAME", "FLDRANKNAME", "FLDBATCHNO", "FLDPRESENTVESSELNAME", "FLDLASTVESSELNAME", "FLDSIGNOFFDATE" };
        string[] alCaptions = { "Name", "Rank", "Batch", "Vessel Name", "Last Vessel", "Sign Off Date" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewTraineeJoinerSearch(General.GetNullableString(ViewState["RANKID"].ToString())
        ...
        if (ds.Tables.Count > 0)
            General.ShowExcel("Trainee Joined", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixDashboardOfficeV2Crew.DashboardCrewTraineeJoinerSearch(General.GetNullableString(ViewState["RANKID"].ToString())
                  , sortexpression, sortdirection,
        ...
        General.SetPrintOptions("gvCrew", "Trainee Joined", alCaptions, alColumns, ds);
