...
public partial class DashboardOfficeV2CrewVslAppraisalDue : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Dashboard/DashboardOfficeV2CrewVslAppraisalDue.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDEMPLOYEENAME", "FLDRANKNAME", "FLDVESSELNAME", "FLDRELIEFDUEDATE", "FLDFLEETDESCRIPTION", "FLDLASTAPPRAISALDONEDATE" };
        string[] alCaptions = { "Name", "Vessel Name", "Contract Expiry Date", "Relief Due Date", "Reliever Planned", "Last Appraisal Done Date" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewVslAppraisalDueSearch(General.GetNullableInteger(ViewState["VESSELID"].ToString())
        ...
        if (ds.Tables.Count > 0)
            General.ShowExcel("Appraisal Due", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        ...
        General.SetPrintOptions("gvCrew", "Appraisal Due", alCaptions, alColumns, ds);
