...
public partial class DashboardOfficeV2CrewVslCertExpiredin30Days : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Dashboard/DashboardOfficeV2CrewVslCertExpiredin30Days.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDNAME", "FLDRANKNAME", "FLDVESSELNAME", "FLDDOCUMENTNAME", "FLDEXPIRYDATE", "FLDRELIEFDUEDATE" };
        string[] alCaptions = { "Name", "Rank", "Vessel Name", "Certificate Document Name With Issuing Authority", "Certificate/Document Expiry Date", "Relief Due Date" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewVslCertExpired(General.GetNullableInteger(ViewState["VESSELID"].ToString())
                   , 30
        ...
        if (ds.Tables.Count > 0)
            General.ShowExcel("Certificate Expired in 30 Days", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixDashboardOfficeV2Crew.DashboardCrewVslCertExpired(General.GetNullableInteger(ViewState["VESSELID"].ToString())
                , 30
                , sortexpression, sortdirection,
        ...
        General.SetPrintOptions("gvCrew", "Certificate Expired in 30 Days", alCaptions, alColumns, ds);
