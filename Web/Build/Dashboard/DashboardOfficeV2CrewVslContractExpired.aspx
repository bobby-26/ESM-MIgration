<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2CrewVslContractExpired.aspx.cs" Inherits="DashboardOfficeV2CrewVslContractExpired" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" ShowFooter="false" EnableViewState="True" OnSortCommand="gvCrew_SortCommand"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Contract Expiry Date" AllowSorting="true">
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDCONTRACTEXPIRY"])%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Extension Of Contract" AllowSorting="true">
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDCONTRACTEXTENSION"])%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
