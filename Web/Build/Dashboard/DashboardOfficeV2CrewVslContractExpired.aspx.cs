...
public partial class DashboardOfficeV2CrewVslContractExpired : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Dashboard/DashboardOfficeV2CrewVslContractExpired.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDEMPLOYEENAME", "FLDVESSELNAME", "FLDCONTRACTEXPIRY", "FLDRELIEFDUEDATE", "FLDRELIEVER", "FLDCONTRACTEXTENSION" };
        string[] alCaptions = { "Name", "Vessel Name", "Contract Expiry Date", "Relief Due Date", "Reliever Planned", "Extension Of Contract" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewContractExpired(General.GetNullableInteger(ViewState["VESSELID"].ToString())
        ...
        if (ds.Tables.Count > 0)
            General.ShowExcel("Contract Expired", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixDashboardOfficeV2Crew.DashboardCrewContractExpired(General.GetNullableInteger(ViewState["VESSELID"].ToString())
                      , sortexpression, sortdirection,
        ...
        General.SetPrintOptions("gvCrew", "Contract Expired", alCaptions, alColumns, ds);
