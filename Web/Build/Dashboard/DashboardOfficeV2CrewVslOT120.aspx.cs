...
public partial class DashboardOfficeV2CrewVslOT120 : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Dashboard/DashboardOfficeV2CrewVslOT120.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDEMPLOYEENAME", "FLDVESSELNAME", "FLDRANKNAME", "FLDOTHRS" };
        string[] alCaptions = { "Name", "Vessel Name", "Rank", "OT > 120 Hours" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewVslOT120hrs(General.GetNullableInteger(ViewState["VESSELID"].ToString())                 
        ...
        if (ds.Tables.Count > 0)
            General.ShowExcel("Crew OT Details", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixDashboardOfficeV2Crew.DashboardCrewVslOT120hrs(General.GetNullableInteger(ViewState["VESSELID"].ToString())                
                  , sortexpression, sortdirection,
        ...
        General.SetPrintOptions("gvCrew", "Crew OT Details", alCaptions, alColumns, ds);
