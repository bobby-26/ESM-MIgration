<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2CrewVslOT140.aspx.cs" Inherits="DashboardOfficeV2CrewVslOT140" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" ShowFooter="false" EnableViewState="True" OnSortCommand="gvCrew_SortCommand"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                   ...
                   <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="OT > 140 Hours" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDOTHRS")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                         <%-- <telerik:GridTemplateColumn HeaderText="OT < 120 Hours" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDOTLESSERHRS")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>--%>
                     <%--   <telerik:GridTemplateColumn HeaderText="Amount Paid" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDAMOUNTPAID")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>--%>
                    </Columns>
