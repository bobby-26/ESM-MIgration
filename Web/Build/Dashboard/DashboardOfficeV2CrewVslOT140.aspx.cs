...
public partial class DashboardOfficeV2CrewVslOT140 : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Dashboard/DashboardOfficeV2CrewVslOT140.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alCaptions = { "Name", "Vessel Name", "Rank", "OT > 140 Hours" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewVslOT140hrs(General.GetNullableInteger(ViewState["VESSELID"].ToString())
        ...
        if (ds.Tables.Count > 0)
            General.ShowExcel("OT Details", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixDashboardOfficeV2Crew.DashboardCrewVslOT140hrs(General.GetNullableInteger(ViewState["VESSELID"].ToString())
                , sortexpression, sortdirection,
        ...
        General.SetPrintOptions("gvCrew", "OT Details", alCaptions, alColumns, ds);
