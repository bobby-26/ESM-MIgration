<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2CrewVslOcimf.aspx.cs" Inherits="DashboardOfficeV2CrewVslOcimf" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" ShowFooter="false" EnableViewState="True" OnSortCommand="gvCrew_SortCommand"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>                  
                        ...
                        <telerik:GridTemplateColumn HeaderText="Years in Rank(Combined) 36 Months For Senior Officers , 12 Months For Junior Officers" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDYEARSINRANK")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Years With Operator(Senior 24 Months, Junior 12 Months)" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDYEARSWITHOPERATOR")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Years On Tankers(SR 72 Months, JR 12 Months)" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDYEARSONTANKERS")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>                      
                    </Columns>
