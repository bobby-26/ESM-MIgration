<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2CrewVslSummary.aspx.cs" Inherits="DashboardOfficeV2CrewVslSummary" %>
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="GvCrewVslSummary">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="GvCrewVslSummary" UpdatePanelHeight="99%"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
