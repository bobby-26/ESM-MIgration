...
public partial class DashboardOfficeV2CrewVslSupnmy : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Dashboard/DashboardOfficeV2CrewVslSupnmy.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDEMPLOYEENAME", "FLDRANKNAME", "FLDVESSELNAME", "FLDSUPYNAME", "FLDJOININGDATE", "FLDRELIEFDUEDATE" };
        string[] alCaptions = { "Name", "Rank of Officer", "Vessel Name", "Supernumerary Name", "Joining Date", "Relief Date Of Officer" };
        ...
        ds = PhoenixDashboardOfficeV2Crew.DashboardCrewSupyOnboardSearch(General.GetNullableInteger(ViewState["VESSELID"].ToString())
        ...
        if (ds.Tables.Count > 0)
            General.ShowExcel("Supernumerary Onboard", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixDashboardOfficeV2Crew.DashboardCrewSupyOnboardSearch(General.GetNullableInteger(ViewState["VESSELID"].ToString())
                     , sortexpression, sortdirection,
        ...
        General.SetPrintOptions("gvCrew", "Supernumerary Onboard", alCaptions, alColumns, ds);
