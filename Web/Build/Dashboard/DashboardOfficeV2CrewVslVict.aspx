<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2CrewVslVict.aspx.cs" Inherits="DashboardOfficeV2CrewVslVict" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" ShowFooter="false" EnableViewState="True" OnSortCommand="gvCrew_SortCommand"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Victualling Budget Monthly" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDMONTHLYBUGETEDVICTUALLING")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Victualling Expenses Monthly" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDMONTHLYVICTUALLING")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    <%--    <telerik:GridTemplateColumn HeaderText="Victualling Budget YTD" AllowSorting="true">
                            <ItemTemplate>
                                <%#DataBinder.Eval(Container, "DataItem.FLDMONTHLYBUGETEDVICTUALLING")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Victualling Expenses YTD" AllowSorting="true">
                            <ItemTemplate>
                                 <%#DataBinder.Eval(Container, "DataItem.FLDMONTHLYBUGETEDVICTUALLING")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Variance(Month and YTD)" AllowSorting="true">
                            <ItemTemplate>
                                  <%#DataBinder.Eval(Container, "DataItem.FLDMONTHLYBUGETEDVICTUALLING")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>--%>
