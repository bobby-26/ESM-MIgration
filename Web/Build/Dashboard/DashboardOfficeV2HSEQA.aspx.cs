...
public partial class DashboardOfficeV2HSEQA : PhoenixBasePage
{
    ...
    protected void GvPMS_NeedDataSource(object sender, Telerik.Web.UI.PivotGridNeedDataSourceEventArgs e)
    {
        ...
        //unused.CellStyle=
        DataTable dt = PhoenixDashboardTechnical.DashboardOfficeHSEQAByVessel(ViewState["MOD"].ToString(),PhoenixSecurityContext.CurrentSecurityContext.CompanyID);
        GvPMS.DataSource = dt;
    }
