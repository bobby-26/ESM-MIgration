...
public partial class DashboardOfficeV2TechnicalAuditInspection : PhoenixBasePage
{
    ...
    private void BindData()
    {
        ...
        //unused.CellStyle=
        DataTable dt = PhoenixDashboardTechnical.DashboardOfficeInspectionByVessel(ViewState["MOD"].ToString(), General.GetNullableInteger(ViewState["Due"].ToString()),PhoenixSecurityContext.CurrentSecurityContext.CompanyID);
        GvPMS.DataSource = dt;
    }
}