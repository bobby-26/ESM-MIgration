<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2TechnicalCertificate.aspx.cs" Inherits="DashboardOfficeV2TechnicalCertificate" %>
    ...
    <form id="form1" runat="server">
       <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        Due: <telerik:RadDropDownList ID="lstDue" runat="server" OnSelectedIndexChanged="lstDue_SelectedIndexChanged" AutoPostBack="true">
            <Items>
                <telerik:DropDownListItem Text="Overdue" Value="0" />
