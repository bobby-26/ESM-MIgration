...
public partial class DashboardOfficeV2TechnicalCertificate : PhoenixBasePage
{
    ...
    private void BindData()
    {
        ...
        //unused.CellStyle=
        DataTable dt = PhoenixDashboardTechnical.DashboardOfficeCertificateByVessel(ViewState["MOD"].ToString(), General.GetNullableInteger(ViewState["Due"].ToString()));
        GvPMS.DataSource = dt;
    }
}