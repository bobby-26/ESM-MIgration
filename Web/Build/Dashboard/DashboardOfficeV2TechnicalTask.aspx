<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOfficeV2TechnicalTask.aspx.cs" Inherits="DashboardOfficeV2TechnicalTask" %>
    ...
    <form id="form1" runat="server">
       <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        Due: <telerik:RadDropDownList ID="lstDue" runat="server" OnSelectedIndexChanged="lstDue_SelectedIndexChanged" AutoPostBack="true">
            <Items>
                <telerik:DropDownListItem Text="Overdue" Value="1" />
                <telerik:DropDownListItem Text="15 Days" Value="2" />
                <telerik:DropDownListItem Text="Pndg Closure" Value="3" />
                <telerik:DropDownListItem Text="Extn. Req." Value="4" />
                <telerik:DropDownListItem Text="2ry Pndg Approval" Value="5" />
            </Items>
