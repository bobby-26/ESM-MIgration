<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardOffshoreVesselDetails.aspx.cs" Inherits="Dashboard_DashboardOffshoreVesselDetails" %>
                                            ...
                                            <div class="panel-body" style="height: 700px;">
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="gradeX">
                                                            <td style="background-color: aliceblue">Location</td>
                                                            <td>
                                                                <telerik:RadLabel ID="lblLastPort" runat="server" Text=""></telerik:RadLabel>
                                                            </td>
                                                        </tr>
                                                         <tr class="gradeX">
                                                            <td style="background-color: aliceblue">Vessel Status</td>
                                                            <td>
                                                                <telerik:RadLabel ID="lblvesselstatus" runat="server" Text=""></telerik:RadLabel>
                                                            </td>
                                                        </tr>
                                                        <tr class="gradeX">
                                                            <td style="background-color: aliceblue">Port</td>
                                                            <td>
                                                                <telerik:RadLabel ID="lblNextPort" runat="server" Text=""></telerik:RadLabel>
                                                            </td>
                                                        </tr>
                                                        <tr class="gradeX">
                                                            <td style="background-color: aliceblue">ETA / ETD</td>
                                                            <td>
                                                     ...
                                                     <%--   <tr class="gradeX">
                                                        ...
                                                        <tr class="gradeX">
                                                            <td style="background-color: aliceblue">Last OVID Inspection</td>
                                                            <td>
                                                        ...
                                                        <tr class="gradeX">
                                                            <td style="background-color: aliceblue">POB </td>
                                                            <td>
                                                    ...
                                                    <tbody>
                                                     ...
                                                     <%--   <tr class="gradeX">
                                                       ...
                                                       <%-- <tr class="gradeX">
                                                        ...
                                                        <tr class="gradeX">
                                                            <td><a id="btnMidnightreport" runat="server">Midnight report</a>  </td>
                                                ...
                                                <div class="panel-body" style="height: 800px;">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">AIS </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Autopilot </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">BNWAS </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Course Recorder </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">ECDIS 1 </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">ECDIS 2 </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Echo Sounder </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">GPS / DGPS </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Gyro </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">MF/HF </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Radar/ Arpa - S </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Radar/ Arpa - X </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Sat C </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">SSAS </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">VDR </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">VHF </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="gradeX">
                                                                ...
                                                                <td>-</td>
                                                                <td style="background-color: aliceblue">BCR KW</td>
                                                                <td>-</td>
                                                            </tr>
                                                            <tr class="gradeX">
                                                ...
                                                <div class="panel-body" style="height: 450px;">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                          ...
                                                          <%--  <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Aux Boilers </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>--%>
                                                           <%-- <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Cargo Crane </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>--%>
                                                           <%-- <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Cargo Pumps </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>--%>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Fast Rescue Boat </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                         <%--   <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Hose Handling Crane </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>--%>
                                                         <%--   <tr class="gradeX">
                                                                <td style="background-color: aliceblue">IG Generator </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>--%>
                                                           <%-- <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Life Boats </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>--%>
                                                            <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Provision Crane </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>
                                                           <%-- <tr class="gradeX">
                                                                <td style="background-color: aliceblue">Rescue Boat </td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                                <td>-</td>
                                                            </tr>--%>
