<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardSKKPITargetEdit.aspx.cs" Inherits="Dashboard_DashboardSKKPITargetEdit" %>
...
<head runat="server">
       <title>Edit Key Performance Indicators (KPI) Target </title>
           ...
           <br />
            <table style="margin-left: 20px">
                <tr>
                    ...
                    <td colspan="5">
                        <eluc:Year ID="radcbyear" runat= "server" AutoPostBack="True" YearStartFrom="2018"  NoofYearFromCurrent="0" OrderByAsc="True"   Enabled="false"/>
                    </td>
                ...
                <tr>
                   ...
                   <th>: &nbsp &nbsp &nbsp
                    ...
                    <td colspan="5">
                        <telerik:RadMultiColumnComboBox RenderMode="Lightweight" ID="radcobkpi" runat="server" Width="290px" Height="150px" NoWrap="true" Enable="false"
                ...
                <tr>
                    ...
                    <td >
                        <eluc:Decimal ID="radtbkpiminimumentry" runat="server" Width="150px" CssClass="input_mandatory"  MinValue="0" MaxValue="100" DecimalDigits="2">
                        </eluc:Decimal>
                    </td>
                    <td>
                        &nbsp &nbsp &nbsp
                    ...
                    <td  colspan="5">
                        <eluc:Decimal ID="radtbkpitargetvalueentry" runat="server" Width="150px" CssClass="input_mandatory"  MinValue="0" DecimalDigits="2" MaxValue="100">
                        </eluc:Decimal>
                    </td>
