<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardSKPIScope.aspx.cs" Inherits="Inspection_InspectionPIScope" %>
...
<head runat="server">
    <title>Performance Indicator (PI) Scope</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server"
            DecorationZoneID="gvPIScope" DecoratedControls="All" EnableRoundedCorners="true" />
...
<%--            <eluc:TabStrip ID="Tabkpi" runat="server" OnTabStripCommand="KPI_TabStripMenuCommand" TabStrip="true"></eluc:TabStrip>--%>
            ...
            <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvPIScope" AutoGenerateColumns="false"
                AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvPIScope_NeedDataSource" Height="88.5%"
                OnItemDataBound="gvPIScope_ItemDataBound" OnItemCommand="gvPIScope_ItemCommand" ShowFooter="true">
                <MasterTableView EditMode="InPlace" DataKeyNames="FLDSCOPEID" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Scope Code">
                           ...
                           <EditItemTemplate>
                                <telerik:RadTextBox ID="Radpiscopecodeedit" runat="server" CssClass="input_mandatory" width="150px" Text='<%# DataBinder.Eval(Container, "DataItem.FLDSCOPECODE")%>'>
                                </telerik:RadTextBox>
                           </EditItemTemplate>
                            <FooterTemplate>
                                 <telerik:RadTextBox ID="Radpiscopecodeentry" runat="server" CssClass="input_mandatory" width="150px">
                                </telerik:RadTextBox>
                            </FooterTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Scope">
                          ...
                          <EditItemTemplate>
                               <telerik:RadTextBox ID="Radpiscopenameedit" runat="server" CssClass="input_mandatory" width="150px" Text='<%# DataBinder.Eval(Container, "DataItem.FLDSCOPE")%>'>
                                </telerik:RadTextBox>
                          </EditItemTemplate>
                            <FooterTemplate>
                                 <telerik:RadTextBox ID="Radpiscopenameentry" runat="server" CssClass="input_mandatory" width="150px">
                                </telerik:RadTextBox>
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
