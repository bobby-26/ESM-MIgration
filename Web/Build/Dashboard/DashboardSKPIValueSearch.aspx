<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardSKPIValueSearch.aspx.cs" Inherits="Dashboard_DashboardSKPIValueSearch" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvPIlist" AutoGenerateColumns="false" Height="100%"
                AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvPIlist_NeedDataSource" 
                OnItemDataBound="gvPIlist_ItemDataBound" OnItemCommand="gvPIlist_ItemCommand" ShowFooter="false">
