<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardSKSPIColourConfig.aspx.cs" Inherits="Dashboard_DashboardSKSPIColourConfig" %>
...
<head runat="server">
    <title>SPI Colour Configuration</title>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <table>
                <tr>
                    ...
                    <th>
                        <telerik:RadLabel ID="Radlblspicodetitle" runat="server" Text="Code " />
                    </th>
                    <th>&nbsp
                    </th>
                    <td>
                        <telerik:RadLabel ID="Radlblspicode" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>&nbsp &nbsp 
                    ...
                    <th>
                        <telerik:RadLabel ID="Radlblspinametitle" runat="server" Text="Name " />
                    </th>
                    <th>&nbsp
                    </th>
                    <td>
                        <telerik:RadLabel ID="Radlblspiname" runat="server" />
                    </td>
                </tr>
            </table>
            ...
            OnItemDataBound="gvSPIlist_ItemDataBound" OnItemCommand="gvSPIlist_ItemCommand" ShowFooter="true">
            <MasterTableView EditMode="InPlace" DataKeyNames="FLDSPICOLOURID" AutoGenerateColumns="false"
                ...
                <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Colour">
                            ...
                            <FooterTemplate >
                                ...
                                <telerik:RadColorPicker ID="radspicolourpicker" runat="server" ShowIcon="true"  PaletteModes="WebPalette" />
                            </FooterTemplate>
                            <EditItemTemplate>
                                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                <telerik:RadColorPicker ID="radspicolourpickeredit" runat="server" ShowIcon="true"  PaletteModes="WebPalette" SelectedColor='<%# System.Drawing.ColorTranslator.FromHtml (DataBinder.Eval(Container, "DataItem.FLDCOLOUR").ToString())%>'/>
                            </EditItemTemplate>
                        </telerik:GridTemplateColumn>
