<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardSKSPIValueSearch.aspx.cs" Inherits="Dashboard_DashboardSKSPIValueSearch" %>
...
<body>
    ...
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvSPIlist" AutoGenerateColumns="false" Height="100%"
