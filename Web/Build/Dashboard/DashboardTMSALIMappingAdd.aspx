<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardTMSALIMappingAdd.aspx.cs" Inherits="Dashboard_DashboardTMSALIMappingAdd" %>
                  ...
                  <tr>
                    ...
                    <td colspan="5">
                       <telerik:RadMultiColumnComboBox RenderMode="Lightweight" ID="RadCombotmsalist" runat="server" Width="290px" Height="150px" NoWrap="true"
                            ...
                            Placeholder="Type to Select the TMSA Element" Filter="Contains" FilterFields="FLDTMSACODE, FLDTMSADESCRIPTION" CssClass="input_mandatory"
                            >
                            <NoDataTemplate>
