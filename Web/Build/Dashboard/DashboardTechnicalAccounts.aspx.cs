...
public partial class DashboardTechnicalAccounts : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            cmdChart.Attributes.Add("onclick", "javascript:parent.Openpopup('codehelp1','','../Dashboard/DashboardChart.aspx?measure=ACCOUNT&type=1'); return false;");
    ...
    {
        DataSet ds = PhoenixDashboardOption.DashboardLastSelectedEdit("TECH", "INV");
        ...
        {
            DataSet d = PhoenixDashboardTechnical.DashboardMeasure("ACCOUNT", null);
            nvc.Add("APP", "TECH");
            nvc.Add("Option", "INV");
    ...
    private void BindMeasure()
    {
        ...
        DataSet ds = PhoenixDashboardTechnical.DashboardMeasure("ACCOUNT", General.GetNullableString(nvc.Get("VesselList")));
    ...
    {
        NameValueCollection nvc = Filter.CurrentDashboardLastSelection;        
        DataSet ds = PhoenixDashboardTechnical.DashboardMeasureResult("ACCOUNT"
        ...
        try
        {
            ...
            if (e.CommandName.ToUpper().Equals("SELECT"))
            {
                ...
                if (nvc != null)
                {
                    ...
                    criteria.Clear();
                    criteria.Add("txtInvoiceNumberSearch", _gridView.Rows[nCurrentRow].Cells[1].Text);
    ...
    {
        NameValueCollection nvc = Filter.CurrentDashboardLastSelection;        
        DataSet ds = PhoenixDashboardTechnical.DashboardMeasureChart("ACCOUNT"
