<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardTechnicalCertificatesandSurveys.aspx.cs" Inherits="DashboardTechnicalCertificatesandSurveys" %>
            ...
            <div id="dashWrap">
                ...
                <asp:UpdatePanel runat="server" ID="Updp1">
                    <ContentTemplate>
                        ...
                        <div id="dataVizWrap" style="overflow-x: auto; overflow-y: auto">
                            <div id="ucmenu">
                                <eluc:DashboardMenu runat="server" ID="DashboardMenu1" ShowMenu="false" ShowFilter="1" />
                                <div id="dataMenu">
                                    <asp:GridView ID="gvMeasure" runat="server" AutoGenerateColumns="false"
