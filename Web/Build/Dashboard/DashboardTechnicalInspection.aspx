<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardTechnicalInspection.aspx.cs"
    Inherits="DashboardTechnicalInspection" %>
            ...
            <div id="dashWrap">
                ...
                <div id="dataVizWrap">
                    <div id="ucmenu" runat="server">
                        <div id="dataMenu">
                            <telerik:RadPivotGrid ID="GvInspection" runat="server" TotalsSettings-ColumnGrandTotalsPosition="None" OnNeedDataSource="GvInspection_NeedDataSource"
                                AllowPaging="false" AllowFiltering="true" ShowFilterHeaderZone="false" TotalsSettings-RowGrandTotalsPosition="None" OnCellDataBound="GvInspection_CellDataBound"
                                ...
                                <Fields>
                                    ...
                                    <telerik:PivotGridAggregateField DataField="Count" Caption="Count" Aggregate="Sum" IgnoreNullValues="true" CellStyle-Width="70px"></telerik:PivotGridAggregateField>
                                </Fields>
            ...
            <div id="pnl">
                <div id="otisTitleBar" class='otisTitleBar' onclick='toggle();setSize();' runat="server">
                 ...
                 <telerik:RadGrid ID="gvMeasureResult" runat="server" RenderMode="Lightweight" OnNeedDataSource="gvMeasureResult_NeedDataSource" OnItemDataBound="gvMeasureResult_ItemDataBound"
                     ...
                     <MasterTableView TableLayout="Fixed" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true">
                         <Columns>
                         </Columns>
                         <NoRecordsTemplate>
