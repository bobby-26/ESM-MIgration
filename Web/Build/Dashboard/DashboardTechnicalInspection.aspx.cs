...
public partial class DashboardTechnicalInspection : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbargrid.AddImageButton("../Dashboard/DashboardTechnicalInspection.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
    ...
    protected void GvInspection_NeedDataSource(object sender, Telerik.Web.UI.PivotGridNeedDataSourceEventArgs e)
    {
        RadPivotGrid grid = (RadPivotGrid)sender;
        //var unused = grid.Fields["Code"] as PivotGridRowField;
        //unused.IsHidden = true;
        //unused.CellStyle=
        DataTable dt = PhoenixDashboardTechnical.DashboardOfficeTechnicalByVessel("INSPECTION");
    ...
    protected void GvInspection_CellDataBound(object sender, Telerik.Web.UI.PivotGridCellDataBoundEventArgs e)
    {
    ...
    protected void gvMeasureResult_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        DataSet ds = PhoenixDashboardTechnical.DashboardMeasureResult("INSPECTION"
        ...
        if (ds.Tables.Count > 0)
        {
            foreach (DataColumn c in ds.Tables[0].Columns)
            {
                ...
                T.HeaderStyle.Width = Unit.Parse("5%");
                T.ItemStyle.Width = Unit.Parse("5%");
                T.HeaderStyle.Wrap = true;
    ...
    {
        DataSet ds = PhoenixDashboardOption.DashboardLastSelectedEdit("TECH", "INP");
        ...
        {
            DataSet d = PhoenixDashboardTechnical.DashboardMeasure("INSPECTION", null);
            nvc.Add("APP", "TECH");
            nvc.Add("Option", "INP");
        ...
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    if (ds.Tables[0].Rows[i]["FLDCOMMANDNAME"].ToString().ToUpper().Equals("INSPECTION"))
                    {
