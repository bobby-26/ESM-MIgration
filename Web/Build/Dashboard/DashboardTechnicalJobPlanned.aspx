<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardTechnicalJobPlanned.aspx.cs"
    Inherits="Dashboard_DashboardTechnicalJobPlanned" %>
...
<body>
    <form id="frmWorkOrder" runat="server" autocomplete="off">
        ...
        <telerik:RadGrid ID="gvWorkOrder" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                OnItemCommand="gvWorkOrder_ItemCommand" OnItemDataBound="gvWorkOrder_ItemDataBound" EnableViewState="true" OnSortCommand="gvWorkOrder_SortCommand"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderStyle-Width="80px" UniqueName="FLDVESSELNAME" HeaderText="Vessel" AllowSorting="false"
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="80px" HeaderText="Work Order No." AllowSorting="false"
                            ShowSortIcon="true" SortExpression="FLDWORKORDERNUMBER" AllowFiltering="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>                                
                                <asp:LinkButton ID="lnkGroupNo" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDWORKORDERNUMBER") %>'></asp:LinkButton>                                
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Title" AllowFiltering="false">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Category" FilterDelay="2000" UniqueName="FLDJOBCATEGORYID" DataField="FLDJOBCATEGORYID"
                            AllowSorting="true" ShowFilterIcon="false" SortExpression="FLDJOBCATEGORY">                            
                            <FilterTemplate>
                                <telerik:RadComboBox ID="cblJobCategory" OnDataBinding="cblJobCategory_DataBinding" AppendDataBoundItems="true" 
                                    SelectedValue='<%# ViewState["filterJobCategory"].ToString() %>' OnClientSelectedIndexChanged="JobCategoryIndexChanged"
                                    runat="server">                                                                    
                                </telerik:RadComboBox>    
