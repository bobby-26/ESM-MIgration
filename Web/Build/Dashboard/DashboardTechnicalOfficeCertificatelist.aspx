<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardTechnicalOfficeCertificatelist.aspx.cs"
    Inherits="DashboardTechnicalOfficeCertificatelist" %>
...
<body onload="setSize();" onresize="setSize();">
    <form id="frmWorkOrder" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="ajxPanel" runat="server">
            <eluc:TabStrip ID="MenuCertificate" runat="server" OnTabStripCommand="MenuCertificate_TabStripCommand"></eluc:TabStrip>
            ...
            <telerik:RadGrid ID="gvCertificate" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Vessel" DataField="FLDVESSELNAME" HeaderStyle-Width="250px"></telerik:GridBoundColumn>
