<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardTechnicalPms.aspx.cs"
    Inherits="DashboardTechnicalPms" %>
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function FireCommand(command, args) {
                var masterTable = $find("<%= gvWorkOrder.ClientID %>").get_masterTableView();
                masterTable.fireCommand(command, args);
            }
            function pageLoad() {
                ...
                pivotresize();
                var pivot = $find("<%= GvMeasure.ClientID %>");
                var ht = pivot._verticalScrollDiv.style.height;
                //pivot._verticalScrollDiv.style.height = (Number(ht.replace("px","")) - 20) + "px";
            }
            ...
            function setSize() {
                ...
                var sender = $find("<%= gvWorkOrder.ClientID %>");             
       ...
       <%-- <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="gvWorkOrder">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gvWorkOrder" UpdatePanelHeight="50%"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="ucError"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
                <telerik:AjaxSetting AjaxControlID="GvMeasure">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="GvMeasure" UpdatePanelHeight="50%"></telerik:AjaxUpdatedControl>
                        <telerik:AjaxUpdatedControl ControlID="gvWorkOrder" UpdatePanelHeight="50%"></telerik:AjaxUpdatedControl>
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
        ...
        <div class="db_container">
            <div id="dashWrap">
                ...
                <div id="dataVizWrap">
                    <div id="ucmenu" runat="server">
                        ...
                        <div id="dataMenu">
                            <telerik:RadPivotGrid ID="GvMeasure" runat="server" TotalsSettings-ColumnGrandTotalsPosition="None" OnNeedDataSource="GvMeasure_NeedDataSource"
                                AllowPaging="false" AllowFiltering="true" ShowFilterHeaderZone="false" TotalsSettings-RowGrandTotalsPosition="None" OnCellDataBound="GvMeasure_CellDataBound"
            ...
            <div class="navSelect" style="position: relative; width: 15px">
                <eluc:TabStrip ID="DashboardExport" runat="server" OnTabStripCommand="DashboardExport_TabStripCommand"></eluc:TabStrip>
            </div>
            <div id="lwr3rDiv" runat="server">
                <div id="DataDiv" style="width: 100%">

                    <telerik:RadGrid ID="gvWorkOrder" runat="server" AllowCustomPaging="true" AllowSorting="false" AllowPaging="true" OnItemDataBound="gvWorkOrder_ItemDataBound"
                        CellSpacing="0" GridLines="None" OnNeedDataSource="gvWorkOrder_NeedDataSource" AutoGenerateColumns="true" OnPreRender="gvWorkOrder_PreRender"
                        OnItemCommand="gvWorkOrder_ItemCommand" Height="100%">
