<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardTechnicalPurchase.aspx.cs" Inherits="DashboardTechnicalPurchase" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="db_container">
            ...
            <telerik:RadGrid ID="gvMeasureResult" runat="server" RenderMode="Lightweight" OnNeedDataSource="gvMeasureResult_NeedDataSource" OnItemDataBound="gvMeasureResult_ItemDataBound"
                OnItemCommand="gvMeasureResult_ItemCommand" AutoGenerateColumns="false" AllowPaging="true" AllowCustomPaging="true" OnPreRender="gvMeasureResult_PreRender" Height="100%">
