...
public partial class DashboardTechnicalWorkRestHours : PhoenixBasePage
{
    string vessellist = "";
    string valuelist = "";
    string colorlist = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
           // cmdChart.Attributes.Add("onclick", "javascript:parent.Openpopup('codehelp1','','../Dashboard/DashboardChart.aspx?measure=CREWLEGAL&type=1'); return false;");
    ...
    {
        DataSet ds = PhoenixDashboardOption.DashboardLastSelectedEdit("TECH", "WRH");
        ...
        {
            DataSet d = PhoenixDashboardTechnical.DashboardMeasure("TECHWRH", null);
            nvc.Add("APP", "TECH");
            nvc.Add("Option", "WRH");
    ...
    private void BindMeasure()
    {
        ...
        DataSet ds = PhoenixDashboardTechnical.DashboardMeasure("TECHWRH", General.GetNullableString(nvc.Get("VesselList")));
    ...
    protected void gvMeasure_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            for (int i = 0; i < header.Rows.Count; i++)
            {
                ...
                if (dr.Length > 0)
                {
                    string args = e.Row.RowIndex.ToString() + "~" + (i + 3) + "~" + dr[0]["FLDVESSELID"].ToString() + "~" + dr[0]["FLDVESSELNAME"].ToString() + "~" + measureid + "~" + measurename;
    ...
    protected void gvMeasure_OnRowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName.ToUpper().Equals("GRAPH"))
            {
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), "chart popup", "var dataSName = [" + vessellist + "]; var dataValues= [" + valuelist + "]; var colourList = [" + colorlist + "]; callDia('" + measurename.ToString() + "', '', 'WRH',dataSName,dataValues,colourList);", true);
            }
    ...
    private void BindMeasureResult()
    {
		...
		DataSet ds = PhoenixDashboardTechnical.DashboardMeasureResult("TECHWRH"
    ...
    protected void gvMeasureResult_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            lnklLink.Text = e.Row.Cells[2].Text;
            ...
            {
                e.Row.Cells[2].Controls.Add(lnklLink);
    ...
    protected void gvMeasureResult_OnRowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            //        Filter.CurrentSelectedModule = "DocumentManagement";
    ...
    {
        NameValueCollection nvc = Filter.CurrentDashboardLastSelection;
        DataSet ds = PhoenixDashboardTechnical.DashboardMeasureChart("TECHWRH"
		...
		try
		{
			...
			if (ds.Tables[0].Rows.Count > 0)
			{
				...
				for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
				{
					...
					if (ds.Tables[0].Rows[i]["FLDCOMMANDNAME"].ToString().ToUpper().Equals("WRH"))
					{
