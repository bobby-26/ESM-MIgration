...
public partial class Dashboard_DashboardVesselCertificates : PhoenixBasePage
{

    protected override void Render(HtmlTextWriter writer)
    {
        Table gridTable = (Table)gvVesselCertificates.Controls[0];
        ViewState["Category"] = "";
        foreach (GridViewRow gv in gvVesselCertificates.Rows)
        {
            Label lblCategory = (Label)gv.FindControl("lblCategory");
            ...
            if (lblCategory != null)
            {
                if (ViewState["Category"].ToString() != strCategory)
                {
                    ...
                    headerCell.ColumnSpan = gvVesselCertificates.Columns.Count;
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixCommonDashboard.DashboardVesselCertificatesSearch(vesselid, sortexpression, sortdirection,
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixCommonDashboard.DashboardVesselCertificatesSearch(vesselid, sortexpression, sortdirection,
            Int32.Parse(ViewState["PAGENUMBER"].ToString()),
    ...
    protected void gvVesselCertificates_RowDataBound(object sender, GridViewRowEventArgs e)
    {
