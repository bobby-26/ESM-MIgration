...
public partial class Dashboard_DashboardVesselParticulars : PhoenixBasePage
{
    ...
    protected void BindToolBar()
    {
        ...
        //    }
        //    //if (Filter.DashboardvesseloverviewselectedTab != null)
        //    //{
        //    //     drindex = ds.Tables[0].Select("FLDCOMMAND='"+ Filter.DashboardvesseloverviewselectedTab.ToString()+"'");
        //    //}
        //    //else
        //    //{
        //        drindex = ds.Tables[0].Select("FLDCOMMAND='PARTICULARS'");
        //    //}
        //    if (drindex != null)
        //    {
        ...
        //    //if (ViewState["Lastselecttab"] != null)
        //    //    MenuDdashboradVesselParticulrs.SelectedMenuIndex = int.Parse(ViewState["Lastselecttab"].ToString());
        //    //else
        //        MenuDdashboradVesselParticulrs.SelectedMenuIndex = index;
        //    //ViewState["Lastselecttab"] = MenuDdashboradVesselParticulrs.
        //}
    }
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixCommonDashboard.DashboardVesselParticularsEdit(vesselid);
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                lnkMasterName.Attributes.Add("onclick", "parent.openNewWindow('BioData','','Reports/ReportsViewWithSubReport.aspx?applicationcode=4&reportcode=BIODATA&empid="
            ...
            {
                lnkChiefEnginner.Attributes.Add("onclick", "parent.openNewWindow('BioData','','Reports/ReportsViewWithSubReport.aspx?applicationcode=4&reportcode=BIODATA&empid="
            ...
            //txtKeelLaid.Text = dr["FLDDATEENTERED"].ToString();
    ...
    //    //Filter.DashboardvesseloverviewselectedTab = dce.CommandName.ToString();
