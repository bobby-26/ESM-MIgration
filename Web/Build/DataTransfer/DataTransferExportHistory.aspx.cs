...
public partial class Registers_DataTransferExportHistory : PhoenixBasePage
{
    ...
    protected void ExportVesselList_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../DataTransfer/DataTransferImportHistory.aspx?vesselid=" + Request.QueryString["vesselid"].ToString());
            }
    ...
    protected void gvVesselExportList_RowCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName.ToUpper().Equals("EXPORT"))
            {
                ...
                PhoenixDataTransferExport.DataExportJob(short.Parse(Request.QueryString["vesselid"].ToString()), General.GetNullableGuid(lblTransferCode.Text));
                ucStatus.Text = "Re-Export Initiated.";
            }
    ...
    protected void BindData()
    {
        try
        {
            ViewState["PAGENUMBER"] = ViewState["PAGENUMBER"] != null ? ViewState["PAGENUMBER"] : gvVesselExportList.CurrentPageIndex + 1;
            ...
            ds = PhoenixDataTransferExport.DataTransferExportHistory(Convert.ToInt16(Request.QueryString["vesselid"].ToString()), sortexpression, sortdirection, gvVesselExportList.CurrentPageIndex + 1,
