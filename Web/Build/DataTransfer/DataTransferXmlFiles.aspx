<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataTransferXmlFiles.aspx.cs" Inherits="DataTransferXmlFiles" %>
            ...
            <ContentTemplate>
             ...
             <div id="navigation" style="top: 0px; margin-left: 0px; vertical-align:top; width:100%; position:absolute; z-index:+1">
                ...
                <div class="subHeader" style="position: relative">                    
                    <div id="divHeading">
                    <eluc:Title runat="server" ID="ucTitle" Text="Data Synchronizer - Files" ShowMenu="false" />                                 
                    </div>
                </div> 
