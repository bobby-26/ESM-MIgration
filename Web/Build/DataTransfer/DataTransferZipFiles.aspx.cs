...
public partial class DataTransferZipFiles : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            ds = PhoenixDataTransferImport.DataTransferPendingImport(
                short.Parse(Request.QueryString["vesselid"].ToString()));
        }
        else
        {
            ds = PhoenixDataTransferImport.AttachmentTransferPendingImport(
                short.Parse(Request.QueryString["vesselid"].ToString()));
        }
