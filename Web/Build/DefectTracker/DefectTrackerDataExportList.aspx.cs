...
public partial class DefectTrackerDataExportList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        MenuEDMSExport.SelectedMenuIndex = 0;
    ...
    {
        string xml = "function=GetDataExportList";
    ...
    protected void MenuEDMSExport_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (dce.CommandName == "ATTACHMENT")
        {
            Response.Redirect("../DefectTracker/DefectTrackerAttachmentExportList.aspx");
        }
    }
