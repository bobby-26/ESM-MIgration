<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DefectTrackerMailInbox.aspx.cs"
    Inherits="DefectTrackerMailInbox" %>
...
<body>
    ...
    <div class="subHeader">
        <div id="div1" style="vertical-align: top">
            <eluc:Title runat="server" ID="Title1" Text="Manage Mails"></eluc:Title>
        </div>
        <div style="position: absolute; top: 0px; right: 0px">
            <eluc:TabStrip ID="MenuMailInbox" runat="server" OnTabStripCommand="MenuMailInbox_TabStripCommand"
                    ...
                    <tr>
                        ...
                        <td width="30%">
                            <table>
                                <tr>
                                    <td>
                                        <asp:CheckBox runat="server" ID="chkResponse" Text="No Response" AutoPostBack="true"
                                            OnCheckedChanged="Module_Changed" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="chkphoenixit" runat="server" Text="Phoenix IT Support" AutoPostBack="true" OnCheckedChanged="Module_Changed" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <asp:GridView ID="MailManager" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="From">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="CallStatus" runat="server" AlternateText="Call Status" CommandName="ATTACHMENT"
                                    CommandArgument='<%# Container.DataItemIndex %>' ToolTip="Call Status"></asp:ImageButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="From">
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                ...
                                <img id="Img3" alt="" runat="server" src="<%$ PhoenixTheme:images/spacer.png %>"
                                    width="3" />
                                <asp:ImageButton runat="server" AlternateText="Log" ImageUrl="<%$ PhoenixTheme:images/61.png %>"
                                    CommandName="LOG" CommandArgument='<%# Container.DataItemIndex %>' ID="cmdLog"
                                    ToolTip="Log"></asp:ImageButton>
                                <img id="Img1" alt="" runat="server" src="<%$ PhoenixTheme:images/spacer.png %>"
                                    width="3" />
                                <asp:ImageButton runat="server" AlternateText="Archive" ImageUrl="<%$ PhoenixTheme:images/deplan.png %>"
