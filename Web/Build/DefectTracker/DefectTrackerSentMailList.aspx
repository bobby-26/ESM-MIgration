<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DefectTrackerSentMailList.aspx.cs"
    EnableEventValidation="false" Inherits="DefectTrackerSentMailList" %>
...
<body>
    ...
    <div class="subHeader">
        <div id="divHeading" style="vertical-align: top">
            <eluc:Title runat="server" ShowMenu="false" ID="ucSentMails"></eluc:Title>
        </div>
        <div style="position: absolute; top: 0px; right: 0px">
            <eluc:TabStrip ID="MenuMailSent" runat="server" TabStrip="true" OnTabStripCommand="MenuMailSent_TabStripCommand">
            </eluc:TabStrip>
        </div>
    </div>
                        ...
                        <asp:TemplateField HeaderText="Type">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkSubject" runat="server" CommandName="EDIT" CommandArgument='<%# Container.DataItemIndex %>'
                                    Text='<%# DataBinder.Eval(Container, "DataItem.FLDSUBJECT").ToString().Length > 30 ? DataBinder.Eval(Container, "DataItem.FLDSUBJECT").ToString().Substring(0, 30) + "..." : DataBinder.Eval(Container, "DataItem.FLDSUBJECT").ToString()%>'>
                                </asp:LinkButton>
