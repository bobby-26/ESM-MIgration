<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentFeatureListView.aspx.cs" Inherits="DocumentFeatureListView" %>
    ...
    <asp:UpdatePanel runat="server" ID="pnlInvoice">
        <ContentTemplate>
            <div class="navigation" id="Div2" style="top: 0px; margin-left: 0px; vertical-align: text-top;
                ...
                <table align ="center" title ="Phoenix Features" visible ="true"><tr><td><font face="BernhardMod BT" size ="5">Phoenix Features</font></td></tr></table>               
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
    </form>
