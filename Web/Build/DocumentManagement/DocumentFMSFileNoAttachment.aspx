<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentFMSFileNoAttachment.aspx.cs"
    Inherits="DocumentManagement_DocumentFMSFileNoAttachment" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1"
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvFMSFileNoattachment" Height="100%" runat="server"
                ...
                <MasterTableView HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDFILENO">
