...
public partial class DocumentManagement_DocumentFMSFileNoAttachment : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddLinkButton("javascript:openNewWindow('codehelp1','','DocumentManagement/DocumentManagementFMSFileNoAttachmentUpload.aspx?VESSELID="+ ViewState["VESSELID"].ToString() + "&FileNoID=" + Request.QueryString["filenoid"].ToString() + "')", "Upload File", "UPLOAD", ToolBarDirection.Right);
    ...
    private void BindData()
    {
        try
        {
            ...
            DataSet ds = PhoenixRegisterFMSMail.FMSFileNoUploadList(
                                                        ViewState["FILENOID"].ToString(),
