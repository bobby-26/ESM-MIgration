<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentFMSFileNoEForms.aspx.cs"
    Inherits="DocumentFMSFileNoEForms" %>
                ...
                <MasterTableView HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" ColumnGroupName="Action" AllowSorting="true"
                            ...
                            <ItemTemplate>
                                <asp:HyperLink ID="lnkfilename" Target="_blank" runat="server" ToolTip="Download File"
