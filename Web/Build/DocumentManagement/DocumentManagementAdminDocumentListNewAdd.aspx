<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementAdminDocumentListNewAdd.aspx.cs" Inherits="DocumentManagement_DocumentManagementAdminDocumentListNewAdd" %>
    ...
    <form id="frmDirectorComment" runat="server">
        ...
        <table width="100%">
            <tr>
                <td width="10%">S.No</td>
                <td width="40%">
                    <%--<teRadTelerik:xtBox ID="txtFormNo" runat="server" CssClass="input_mandatory" TextMode="SingleLine" Width="150px"></teRadTelerik:xtBox>--%>
                ...
                <td width="10%">Name</td>
                <td width="40%">
                    <telerik:RadTextBox ID="txtDocumentNameAdd" runat="server" CssClass="input_mandatory"
            ...
            <tr>
                ...
                <td>Company</td>
                <td>
                    <eluc:Company ID="ucCompany" runat="server" AppendDataBoundItems="true" CssClass="input_mandatory" Width="198px" />
                </td>
            </tr>
            <tr>
                <td>Active (Y/N)
                ...
                <td>
                    <telerik:RadCheckBox ID="cbWholeManualRead" runat="server" ></telerik:RadCheckBox>
