...
public partial class DocumentManagementAdminDocumentSectionRevisionListNew : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../DocumentManagement/DocumentManagementAdminDocumentSectionRevisionListNew.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            {
                toolbar.AddFontAwesomeButton("javascript:openNewWindow('Filter','','DocumentManagement/DocumentManagementDocumentnNewSectionRevisionEdit.aspx?documentid=" + Request.QueryString["DOCUMENTID"].ToString() + "&sectionid=" + Request.QueryString["SECTIONID"].ToString() + "'); return false;", "Modify", "<i class=\"fas fa-receipt\"></i>", "MODIFY");
            }
            else
            {
                toolbar.AddFontAwesomeButton("../DocumentManagement/DocumentManagementDocumentnNewSectionRevisionEdit.aspx", "Modify", "<i class=\"fas fa-receipt\"></i>", "MODIFY");
            }
    ...
    protected void MenuDocument_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../DocumentManagement/DocumentManagementAdminDocumentSectionListNew.aspx?DOCUMENTID=" + ViewState["DOCUMENTID"] + "&SECTIONID=" + ViewState["SECTIONID"].ToString());
            }
            else if (CommandName.ToUpper().Equals("DOCUMENT"))
            {
                Response.Redirect("../DocumentManagement/DocumentManagementAdminDocumentListNew.aspx?DOCUMENTID=" + ViewState["DOCUMENTID"] + "&SECTIONID=" + ViewState["SECTIONID"].ToString());
            }
        }
        catch (Exception ex)
        {
    ...
    protected void gvDocumentSectionRevison_ItemDataBound(Object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        if (e.Item is GridEditableItem)
        {
            ...
            if (cmgEditContent != null && lblSectionId != null && lblRevisionStatus.Text != "3")
                cmgEditContent.Attributes.Add("onclick", "javascript:parent.openNewWindow('Filter','','DocumentManagement/DocumentManagementDocumentSectionContentGeneralnNew.aspx?DOCUMENTID=" + lblDocumentId.Text + "&SECTIONID=" + lblSectionId.Text + "&REVISONID=" + lblRevisonId.Text + "'); return false;");
