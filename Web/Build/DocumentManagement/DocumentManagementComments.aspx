<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementComments.aspx.cs" Inherits="DocumentManagementComments" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellpadding="1" cellspacing="0" style="padding: 1px; margin: 1px; border-style: solid; border-width: 1px;"
            ...
            <tr>
                <td align="left" colspan="2">
                    <font color="blue" size="0"><b>Post your comments here.</b></font>
                </td>
                <td align="right" colspan="2">
                    <telerik:RadCheckBox ID="chkReviewedYN" Text="This Section has been reviewed and no changes required" runat="server" AutoPostBack="true" />
                </td>
            </tr>
            <tr>
                <td width="10%">Comment
        ...
        <%--        <div>
            <br />
            <asp:CheckBox ID="chkReviewedYN" Text="This Section has been reviewed and no changes required" runat="server" AutoPostBack="true" />
        </div>   --%>
    </form>
</body>
</html>
