<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementDashBoardUserUnread.aspx.cs" Inherits="DocumentManagementDashBoardUserUnread" %>
            ...
            <telerik:RadGrid ID="gvUsers" runat="server" RenderMode="Lightweight" AllowPaging="true" AllowCustomPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-Width="30%">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Grouprank / Designation" HeaderStyle-Width="20%">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblGroupRank" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDGROUPRANK") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Unread Section Count" HeaderStyle-Width="15%">
