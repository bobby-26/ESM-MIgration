...
public partial class DocumentManagementDashBoardUserUnreadDocumentSectionList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../DocumentManagement/DocumentManagementDashBoardUserUnreadDocumentSectionList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "EXCEL");
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["EMPLOYEECODE"] != null && Request.QueryString["EMPLOYEECODE"].ToString() != string.Empty)
                    ViewState["EMPLOYEECODE"] = Request.QueryString["EMPLOYEECODE"].ToString();
                else
                    ViewState["EMPLOYEECODE"] = "E20500";
    ...
    private void BindData()
    {
        try
        {
            ...
            ds = PhoenixDocumentManagementDashBoard.DocumentSectionUnreadSearch(General.GetNullableInteger(ViewState["VESSELID"].ToString())
                  , General.GetNullableString(ViewState["EMPLOYEECODE"].ToString())
                  , gvDocumentSection.CurrentPageIndex+1
