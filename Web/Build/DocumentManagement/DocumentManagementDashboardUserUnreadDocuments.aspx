<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementDashboardUserUnreadDocuments.aspx.cs" Inherits="DocumentManagementDashboardUserUnreadDocuments" %>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Document Section Name" HeaderStyle-Width="50%">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="lnkSectionName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSECTIONNAME") %>' CommandName="DOCUMENT" ></asp:LinkButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
