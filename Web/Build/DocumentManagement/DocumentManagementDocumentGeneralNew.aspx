<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementDocumentGeneralNew.aspx.cs" Inherits="DocumentManagement_DocumentManagementDocumentGeneralNew" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadEditor ID="ucEditor" RenderMode="Lightweight" runat="server" EnableTrackChanges="true" Width="100%" Height="93%" EmptyMessage="" ToolsFile="~/Content/DMS-Editor-Preview.xml"
            OnClientLoad="TelerikDemo.toggleTrackChanges" EnableComments="true" ContentFilters="DefaultFilters, PdfExportFilter, ConvertInlineStylesToAttributes"  OnExportContent="ucEditor_ExportContent"
