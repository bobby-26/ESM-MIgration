<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementDocumentSectionRevisionDetailsOfChange.aspx.cs" Inherits="DocumentManagement_DocumentManagementDocumentSectionRevisionDetailsOfChange" %>
        ...
        <ItemTemplate>
            <tr>
                <td width="15%" id="tdDocumentRevision" runat="server" valign="top">
                    <b>
                        <%#DataBinder.Eval(Container, "DataItem.FLDREVISIONDETAILS")%>
                    </b>
                </td>
                <td width="15%">
                    <%#DataBinder.Eval(Container, "DataItem.FLDOFFICEREMARKS")%>
                </td>
            </tr>
        </ItemTemplate>
        <FooterTemplate>
