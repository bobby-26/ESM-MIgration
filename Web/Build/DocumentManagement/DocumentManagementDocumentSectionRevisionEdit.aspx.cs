...
public partial class DocumentManagementDocumentSectionRevisionEdit : PhoenixBasePage
{
    ...
    protected void MenuSave_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                PhoenixDocumentManagementDocumentSection.DocumentSectionContentUpdate(
