<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementEditor.aspx.cs" Inherits="DocumentManagement_DocumentManagementEditor" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <%--<telerik:RadEditor ID="ucEditor" RenderMode="Lightweight" runat="server" EnableTrackChanges="true" Width="100%" Height="93%" EmptyMessage="" ToolsFile="~/Content/DMS-Editor.xml"
            OnClientLoad="TelerikDemo.toggleTrackChanges" EnableComments="true" ContentFilters="DefaultFilters, PdfExportFilter" 
            SkinID="WordLikeExperience" ToolbarMode="RibbonBar" EditModes="Design, Preview" ImageManager-RenderMode="Lightweight" ImportSettings-Docx-ImagesMode="External">
            <ExportSettings OpenInNewWindow="true" ></ExportSettings>
            <TrackChangesSettings CanAcceptTrackChanges="true" Author="John Smith" UserCssId="reU0" />
     ...
     <telerik:RadEditor ID="ucEditor" RenderMode="Lightweight" runat="server" EnableTrackChanges="true" Width="100%" Height="93%" EmptyMessage="" ToolsFile="~/Content/DMS-Editor.xml"
            ...
            <TrackChangesSettings CanAcceptTrackChanges="true" Author="John Smith" UserCssId="reU0" />
             <%--<Content>
                 <img alt="" src="https://images.pexels.com/photos/1820567/pexels-photo-1820567.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500" />
             </Content>--%>
        </telerik:RadEditor>      
