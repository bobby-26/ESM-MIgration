...
public partial class DocumentManagement_DocumentManagementEditor : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //ucEditor.ContentFilters = Telerik.Web.UI.EditorFilters.MakeUrlsAbsolute;
    ...
    private void GetDocumentName()
    {
        if (ViewState["DOCUMENTID"] != null && ViewState["DOCUMENTID"].ToString() != "")
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                //ucEditor.ImageManager.ViewPaths = new string[0];
                //ucEditor.ImageManager.ViewPaths[0] = dr["FLDATTACHMENTPATH"].ToString() + "\\DOCUMENTMANAGEMENT";
            }
        }
    }
    ...
    protected void btnInsertPic_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dr.Length > 0)
            {
                ...
                ucEditor.Content = ucEditor.Content + "<img src=\"" + "../Common/Download.aspx?dtkey=" + dr[0]["FLDDTKEY"].ToString() + "\" ></img>";
