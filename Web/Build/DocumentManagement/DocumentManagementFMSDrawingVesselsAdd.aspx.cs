...
public partial class DocumentManagementFMSDrawingVesselsAdd : PhoenixBasePage
{
        ...
        if (CommandName.ToUpper().Equals("SAVE"))
        {
            try
            {
                if (ViewState["DRAWINGID"] != null)
                {
                    ...
                    DataSet ds = PhoenixDocumentManagementFMSDrawings.FMSVesselMap(new Guid(ViewState["DRAWINGID"].ToString()), vessellist);
    ...
    private void BindVesselTypes()
    {
        ...
        DataSet ds = PhoenixDocumentManagementFMSDrawings.FMSVesselTypeMapVesselList(new Guid(ViewState["DRAWINGID"].ToString()));
