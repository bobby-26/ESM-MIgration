<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementFMSFileNoUpload.aspx.cs"
    Inherits="DocumentManagementFMSFileNoUpload" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table cellpadding="1" cellspacing="1" width="100%">
            ...
            <tr>
                <td>
                    <telerik:RadLabel ID="lblFileDescription" runat="server" Text="Description" Visible="false">
                    </telerik:RadLabel>
                </td>
                <td>
                    <telerik:RadTextBox runat="server" ID="txtDescription" Rows="2" TextMode="MultiLine" Visible="false"
                        MaxLength="300" Width="270px" CssClass="input_mandatory">
                    </telerik:RadTextBox>
                </td>
            </tr>
            <tr>
