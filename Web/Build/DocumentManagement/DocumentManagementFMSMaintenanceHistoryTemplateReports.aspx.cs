...
public partial class DocumentManagement_DocumentManagementFMSMaintenanceHistoryTemplateReports : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {      
            ...
            MenuHistoryTemplateReports.Title = Request.QueryString["FORMNAME"].ToString();                     
            MenuHistoryTemplateReports.AccessRights = this.ViewState;
            MenuHistoryTemplateReports.MenuList = toolbar.Show();

            PhoenixToolbar toolbar1 = new PhoenixToolbar();
            toolbar1.AddFontAwesomeButton("../DocumentManagement/DocumentManagementFMSMaintenanceHistoryTemplateReports.aspx", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
            toolbar1.AddFontAwesomeButton("../DocumentManagement/DocumentManagementFMSMaintenanceHistoryTemplateReports.aspx", "Clear Filter", " <i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName != "RebindGrid")
            {
                ...
                {
                    Response.Redirect("../DocumentManagement/DocumentManagementFMSWorkOrderMappingList.aspx?from=FMS&REPORTID=" + Reportid + "&FORMID=" + formid, true);
                }
