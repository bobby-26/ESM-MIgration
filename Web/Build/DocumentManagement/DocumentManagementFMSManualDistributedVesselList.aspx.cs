...
public partial class DocumentManagement_DocumentManagementFMSManualDistributedVesselList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../DocumentManagement/DocumentManagementFMSManualDistributedVesselList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            if (!IsPostBack)
            {
                ...
                {
                    ViewState["MANUALID"] = Request.QueryString["FileNoID"].ToString();
                }
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixDocumentManagementFMSManual.FMSManualDistributedVesselList(General.GetNullableGuid(ViewState["MANUALID"].ToString())
