<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementFMSShipboardFormList.aspx.cs"
    Inherits="DocumentManagementFMSShipboardFormList" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Vessel ID="ddlvessel" runat="server" CssClass="input" AppendDataBoundItems="true"
                             SyncActiveVesselsOnly="true" AutoPostBack="true" Width="240px" />
                    </td>
                </tr>
            </table>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvForm" runat="server" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                    ...
                    EnableHeaderContextMenu="true" CommandItemDisplay="none" GroupHeaderItemStyle-Font-Bold="true"
                ...
                <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="true" ReorderColumnsOnClient="true"
                    ...
                    <Scrolling AllowScroll="true" UseStaticHeaders="true" SaveScrollPosition="true"
                        FrozenColumnsCount="7" EnableNextPrevFrozenColumns="true" />
