<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementFMSVesselSurveyScheduleList.aspx.cs"
    Inherits="DocumentManagementFMSVesselSurveyScheduleList" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Vessel ID="ddlVessel" runat="server" AutoPostBack="true" Module="CERTIFICATESANDSURVEYS"
                             SyncActiveVesselsOnly="true" OnTextChangedEvent="ddlCategory_TextChanged" Width="200px" />
                    </td>
                    <td>
                    ...
                    <td>
                        <telerik:RadCheckBox ID="chkShowAll" runat="server" Text="Show All" Visible="false"></telerik:RadCheckBox>
                    </td>
                    <td>
                        <telerik:RadCheckBox ID="chkShowNotVerified" runat="server" Text="Show Not Verified" Visible="false"></telerik:RadCheckBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="8"></td>
            ...
            <telerik:RadGrid ID="gvSurvey" runat="server" AutoGenerateColumns="False" AllowPaging="true" EnableHeaderContextMenu="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false" GroupsDefaultExpanded="true"
                    ...
                    <Columns>
                        <telerik:GridClientSelectColumn UniqueName="ClientSelectColumn" HeaderStyle-Width="40px" HeaderStyle-HorizontalAlign="Center" Visible="false">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Issued" Visible="false">
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(DataBinder.Eval(Container, "DataItem.FLDDATEOFISSUE")) %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Expiry" UniqueName="ExpiryDate" AllowSorting="true" SortExpression="FLDDATEOFEXPIRY">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Issued By">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container,"DataItem.FLDISSUINGAUTHORITYNAME") %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Type" ColumnGroupName="LastSurvey">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Date" ColumnGroupName="LastSurvey">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Type" ColumnGroupName="NextSurvey">
                        ...
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Due" ColumnGroupName="NextSurvey" UniqueName="NextDue"
                        ...
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Window(Range)" ColumnGroupName="NextSurvey">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Date" ColumnGroupName="Planned" AllowSorting="true" SortExpression="FLDPLANDATE">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(DataBinder.Eval(Container, "DataItem.FLDPLANDATE")) %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Port" ColumnGroupName="Planned">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container,"DataItem.FLDSEAPORTNAME") %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Verified?">
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container, "DataItem.FLDVERIFIEDYN")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Action" UniqueName="Action" HeaderStyle-Width="20%">
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
                            <ItemStyle Wrap="False" HorizontalAlign="Justify"></ItemStyle>
                            <ItemTemplate>
                                <eluc:CommonToolTip runat="server" ID="ucCommonToolTip" Visible="false"
                                ...
                                <asp:LinkButton runat="server" CommandName="EDIT" ID="cmdEdit" Visible="false"
                                    ToolTip="Edit"><span class="icon"><i class="fas fa-edit"></i></span></asp:LinkButton>
                                <asp:LinkButton runat="server" CommandName="CHANGESURVEY/AUDIT" ID="cmdChangeSurvey" ToolTip="Change Survey/Audit" Visible="false"
                                    Style="display: none"><span class="icon"><i class="fas fa-exchange-alt"></i></span></asp:LinkButton>
                                <asp:LinkButton runat="server" ID="cmdCancelSurveyChange" ToolTip="Cancel Survey/Audit Change" Visible="false"
                                    CommandName="CANCELSURVEY/AUDIT" Style="display: none">
                                     <span class="icon"><i class="fas fa-window-close"></i></span></asp:LinkButton>
                                <asp:LinkButton runat="server" CommandName="DEPLAN" ID="cmdDePlan" Visible="false"
                                ...
                                <asp:LinkButton runat="server" CommandName="RESTART" ID="cmdRestart" Visible="false"
                                    ToolTip="Restart"><span class="icon"><i class="fas fa-sync-alt"></i></span></asp:LinkButton>
                                <asp:LinkButton runat="server" CommandName="CERTIFICATECOC" ID="cmdCOC" Visible="false"
                                    ToolTip="Log Survey Completion"><span class="icon"><i class="fas fa-tasks"></i></span></asp:LinkButton>
                                <asp:LinkButton runat="server" CommandName="VERIFY" ID="cmdVerify" Visible="false"
                                    ToolTip="Verify"><span class="icon"><i class="fas fa-check-circle"></i></span></asp:LinkButton>
                                <asp:LinkButton runat="server" CommandName="EXTNUPDATE" ID="lnkExtension" Visible="false"
