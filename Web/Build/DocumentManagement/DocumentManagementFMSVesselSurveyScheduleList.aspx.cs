...
public partial class DocumentManagementFMSVesselSurveyScheduleList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../DocumentManagement/DocumentManagementFMSVesselSurveyScheduleList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "EXCEL");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvSurvey')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("../DocumentManagement/DocumentManagementFMSVesselSurveyScheduleList.aspx", "Filter", "<i class=\"fas fa-search\"></i>", "FIND");
    ...
    {
        ddlCategory.DataSource = PhoenixRegistersVesselSurvey.FMSCertificateCategoryList();
    ...
    protected void gvSurvey_ItemDataBound(object sender, GridItemEventArgs e)
    {
        try
        {
            ...
            if (e.Item is GridDataItem)
            {
                ...
                if (lnk != null)
                {
                    lnk.Attributes.Add("onclick", "javascript:openNewWindow('codehelp1','','" + Session["sitepath"] + "/DocumentManagement/DocumentManagementFMSVesselWiseSurveyCertificateDetails.aspx?CertificateId=" + drv["FLDCERTIFICATEID"].ToString() + "&category=" + drv["FLDCATEGORYCODE"] + "');return false;");
                }
    ...
    protected void gvSurvey_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            {
                string sScript = "javascript:parent.Openpopup('codehelp1','','DocumentManagementFMSVesselWiseSurveyCertificateDetails.aspx?CertificateId=" + lblCertificateId.Text.Trim() + "');";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "", sScript, true);
            }
