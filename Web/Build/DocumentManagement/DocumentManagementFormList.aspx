<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementFormList.aspx.cs"
    Inherits="DocumentManagementFormList" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <telerik:RadGrid ID="gvForm" runat="server" AllowPaging="true" AllowCustomPaging="true" AllowSorting="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true"
                    AllowNaturalSort="false" GroupsDefaultExpanded="true" AutoGenerateColumns="false" TableLayout="Fixed" EnableHeaderContextMenu="true" GroupHeaderItemStyle-Font-Bold="true"
                    ...
                    <Columns>
                       ...
                       <%-- <telerik:GridTemplateColumn HeaderText="Published">
                        ...
                        <telerik:GridTemplateColumn>
                            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="170px"></HeaderStyle>
                            <HeaderTemplate>
                    ...
                    <NestedViewTemplate>
                        <table style="width: 1000px;" align="left">
                            ...
                            <tr valign="top">
                                ...
                                <td class="lblheader">
                                <telerik:RadLabel ID="lblFunction" runat="server" Text="Team Composition :"></telerik:RadLabel>
                                </td>
                                <td>
                                <telerik:RadLabel ID="lbltFunction" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDFUNCTION") %>'></telerik:RadLabel>
                                 </td>
                            </tr>
                        </table>
                    </NestedViewTemplate>
