<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementFormListAdd.aspx.cs" Inherits="DocumentManagement_DocumentManagementFormListAdd" %>
...
<body>
        ...
        <table width="80%">
          ...
          <%--  <tr>--%>
            ...
            <tr>--%>
                ...
                <td>
                    <eluc:Equipmentmake ID="ucEquipment" runat="server" CssClass="gridipput" Width="250px" /></td>
   ...
   <td>Activity/Operation</td>
                <td>
                <telerik:RadComboBox ID="ddlCategory" runat="server"  Width="200px" AppendDataBoundItems="true"
                                 DataTextField="FLDNAME" DataValueField="FLDACTIVITYID"  EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true" CheckBoxes="true" EnableCheckAllItemsCheckBox="true">
                                <%--<Items>
