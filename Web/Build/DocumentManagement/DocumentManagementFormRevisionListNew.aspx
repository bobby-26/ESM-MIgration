<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementFormRevisionListNew.aspx.cs" Inherits="DocumentManagementFormRevisionListNew" %>
    ...
    <form id="frmRegistersCountry" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvFormRevision" runat="server" Font-Size="11px"
                Width="100%" Height="88%" CellPadding="3" GridLines="None" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            ...
            <eluc:TabStrip ID="MenuField" runat="server" Visible="false" OnTabStripCommand="MenuField_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvFormField" Visible="false" runat="server" AutoGenerateColumns="False" Font-Size="11px"
