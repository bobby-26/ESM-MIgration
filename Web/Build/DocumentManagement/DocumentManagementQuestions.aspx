<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementQuestions.aspx.cs" Inherits="DocumentManagementQuestions" %>
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="Radcodeblock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvDMSQuestion.ClientID %>"));
               }, 200);
           }
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <eluc:TabStrip ID="MenuDMSQuestions" runat="server" OnTabStripCommand="MenuDMSQuestions_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvDMSQuestion" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" OnItemCommand="gvDMSQuestion_ItemCommand" OnNeedDataSource="gvDMSQuestion_NeedDataSource" ShowHeader="true"
                OnItemDataBound="gvDMSQuestion_ItemDataBound" EnableViewState="false" GroupingEnabled="false" EnableHeaderContextMenu="true" ShowFooter="false"
                OnSortCommand="gvDMSQuestion_SortCommand">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:LinkButton runat="server" AlternateText="Answer List" CommandName="ANSWER" ID="cmdAnswer" ToolTip="Options">
                                    <span class="icon"><i class="fas fa-Options" ></i></span>
                                </asp:LinkButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
