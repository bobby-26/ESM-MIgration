<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentManagementVesselListByDocument.aspx.cs"
    Inherits="DocumentManagementVesselListByDocument" %>
...
<body>
    <form id="frmDocument" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvVesselListByDocument" runat="server"
                AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" Height="94%"
                CellSpacing="0" CellPadding="3" GridLines="None" OnNeedDataSource="gvVesselListByDocument_NeedDataSource" ShowFooter="true" ShowHeader="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" 
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Vessel">
                            ...
                            <HeaderTemplate>
                                <telerik:RadLabel ID="lblVesselNameHeader" runat="server" Text="Vessel [ID]"></telerik:RadLabel>
                            </HeaderTemplate>
                            <ItemTemplate>
