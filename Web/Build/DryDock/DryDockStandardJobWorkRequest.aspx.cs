...
public partial class DryDockStandardJobWorkRequest : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Request.QueryString["STANDARDJOBID"] != null)
                toolbargrid.AddFontAwesomeButton("../DryDock/DryDockStandardJobWorkRequest.aspx?STANDARDJOBID=" + Request.QueryString["STANDARDJOBID"].ToString() + "&pno=" + Request.QueryString["pno"], "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            else if (Request.QueryString["REPAIRJOBID"] != null)
                toolbargrid.AddFontAwesomeButton("../DryDock/DryDockStandardJobWorkRequest.aspx?REPAIRJOBID=" + Request.QueryString["REPAIRJOBID"].ToString() + "&pno=" + Request.QueryString["pno"], "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            if (!IsPostBack)
            {
                ViewState["JOBID"] = (Request.QueryString["STANDARDJOBID"] != null ? Request.QueryString["STANDARDJOBID"] : Request.QueryString["REPAIRJOBID"]);
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            General.ShowExcel("Work Requests", dt, alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        try
        {
            ...
            General.SetPrintOptions("gvWorkOrder", "Work Requests", alCaptions, alColumns, ds);
    ...
    protected void gvWorkOrder_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            string status = ((RadDropDownList)_gridView.Rows[nCurrentRow].FindControl("ddlStatus")).SelectedValue;
            ...
            string completedsatisfactorily = ((RadDropDownList)_gridView.Rows[nCurrentRow].FindControl("ddlCompletedStatisfactorilyYN")).SelectedValue;
    ...
    protected void ddlStatus_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        GridDataItem gvrow = (GridDataItem)ddl.Parent.Parent;
    ...
    protected void gvWorkOrder_ItemDataBound1(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (ddl != null) ddl.SelectedValue = DataBinder.Eval(e.Item.DataItem, "FLDSTATUS").ToString();// drv["FLDSTATUS"].ToString();

            ddl = (RadDropDownList)e.Item.FindControl("ddlCompletedStatisfactorilyYN");
            if (ddl != null) ddl.SelectedValue = DataBinder.Eval(e.Item.DataItem, "FLDCOMPSATISFACTORILYYN").ToString();// drv["FLDCOMPSATISFACTORILYYN"].ToString();
        }
    ...
    protected void gvWorkOrder_UpdateCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            //string workorderid = eeditedItem.OwnerTableView.DataKeyValues[eeditedItem.ItemIndex]["FLDWORKORDERID"].ToString();
