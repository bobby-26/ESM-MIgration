<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DrydockCostIncurredDetails.aspx.cs" Inherits="DryDock_DrydockCostIncurredDetails" %>
...
<head runat="server">
    <title>Dry Dock Cost Inccured Details</title>
    ...
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <table>
         ...
         <telerik:RadGrid RenderMode="Lightweight" ID="gvprogress"  runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            ...
            OnNeedDataSource="gvprogress_NeedDataSource"  
            ...
            <MasterTableView EditMode="Batch" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                AutoGenerateColumns="false" DataKeyNames="FLDORDERLINEID" CommandItemDisplay="None" CommandItemSettings-ShowAddNewRecordButton="false" >
