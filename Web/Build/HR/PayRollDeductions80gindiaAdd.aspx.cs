...
public partial class PayRoll_PayRollDeductions80gindia : PhoenixBasePage
{
    int usercode = 0;
    int vesselId = 0;
    Guid Id = Guid.Empty;
    ...
    private void GetEditData()
    {
        if (Id != Guid.Empty)
        {
            DataSet ds = PhoenixPayRollIndia.Deductions80gindiaDetail(usercode, Id);
    ...
    protected void gvTabStrip_TabStripCommand(object sender, EventArgs e)
    {
    	try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                PhoenixPayRollIndia.Deductions80gindiaInsert(usercode, payRollId, employerId, employeeId, txtnameofdone.Text,
            ...
            {
                PhoenixPayRollIndia.Deductions80gindiaUpdate(usercode, Id, payRollId, employerId, employeeId, txtnameofdone.Text,
                    txtaddress.Text, txtcity.Text, int.Parse(ddlcountry.SelectedCountry), int.Parse(ucState.SelectedState),txtpincode.Text, txtpannumber.Text, decimal.Parse(txteliamt.Text), decimal.Parse(txtamount.Text), decimal.Parse(txtpercentage.Text));
            }
