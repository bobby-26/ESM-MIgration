<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayRollEmployeePersonalSingapore.aspx.cs" Inherits="PayRoll_PayRollEmployeePersonalSingapore" %>
...
<head runat="server">
    <title>Employee Personal Singapore</title>
...
<body onload="resize();" onresize="resize();">
    <form id="form1" runat="server">
        ...
        <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
            ...
            <eluc:TabStrip ID="EmployeeMenu" runat="server" OnTabStripCommand="EmployeeMenu_TabStripCommand"
