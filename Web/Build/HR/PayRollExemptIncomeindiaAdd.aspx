<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayRollExemptIncomeindiaAdd.aspx.cs" Inherits="PayRoll_PayRollExemptIncomeindiaAdd" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td>Amount</td>
                <td>
                    <eluc:Decimal ID="txtamt" runat="server" Width="180px"></eluc:Decimal></td>
            </tr>
