<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayRollExemptionSection10Add.aspx.cs" Inherits="PayRoll_PayRollExemptionSection10" %>
...
<head runat="server">
    <title>Exemption Section 10</title>
    ...
    <form id="form1" runat="server">
        ...
        <table>
           <tr>
            ...
            <tr>
                <td>Nature of Allowance</td>
                <td><telerik:RadTextBox ID="txtNatureOfAllowance" runat="server" Width="180px"></telerik:RadTextBox></td>   
            </tr>
            <tr> 
                <td>Description</td>
