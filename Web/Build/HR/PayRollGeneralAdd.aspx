<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayRollGeneralAdd.aspx.cs" Inherits="PayRoll_PayRollGeneral" %>
    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
              ...
              <tr>
                <td>Country</td>
                <%--<td><telerik:RadTextBox ID="txtCountry" runat="server" Width="100px"></telerik:RadTextBox></td>  --%>
            ...
            <tr> 
                <td>State</td>
                <%--<td><telerik:RadTextBox ID="txtState" runat="server" Width="100px"></telerik:RadTextBox></td>   --%>
