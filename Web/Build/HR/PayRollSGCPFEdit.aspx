<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayRollSGCPFEdit.aspx.cs" Inherits="HR_PayRollSGCPFEdit" %>
...
<head runat="server">
   <title>Central Provident Fund rate edit</title>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td>
                        <eluc:Decimal runat="server" ID="radtbminimumage" MaxValue="100" MinValue="0"  />
                    </td>
                    <td>
                        &nbsp
                    </td>
                    ...
                    <td>
                        <eluc:Decimal runat="server" ID="radtblmaximumage" MaxValue="100" MinValue="0" />
                    </td>
                </tr>
                <tr>
                    <td colspan="7">
                 ...
                 <tr>
                    ...
                    <td>
                        <eluc:Decimal runat="server" ID="radminimumtw"  MinValue="0" />
                    </td>
                    <td>
                        &nbsp
                    </td>
