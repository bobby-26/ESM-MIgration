<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayRollSGSDLEdit.aspx.cs" Inherits="HR_PayRollSGSDLEdit" %>
...
<head runat="server">
    <title>Skills Development Levy  edit</title>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td >
                        <eluc:Decimal runat="server" ID="rademployercontribution" MaxValue="1" MinValue="0"  CssClass="input_mandatory" DecimalDigits="4"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
