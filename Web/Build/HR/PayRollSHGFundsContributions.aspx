<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayRollSHGFundsContributions.aspx.cs" Inherits="HR_PayRollSHGFundsContributions" %>
...
<head runat="server">
     <title>SHG Fund Employee Contributions</title>
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvetf.ClientID %>"));
                }, 200);
            }
...
<body>
   ...
   <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <telerik:RadAjaxPanel ID="radajaxpanel1" runat="server">
            ...
            <table width="100%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadComboBox ID="ddlfund" runat="server" AllowCustomText="true" EmptyMessage="Type to select fund" />
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvetf" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" ShowFooter="false" Style="margin-bottom: 0px" EnableViewState="true" EnableHeaderContextMenu="true"
                OnNeedDataSource="gvetf_NeedDataSource"
                OnItemDataBound="gvetf_ItemDataBound"
                OnItemCommand="gvetf_ItemCommand">

                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDSGPRETHNICFUNDCONTRIBUTIONID" TableLayout="Fixed">
                    ...
                    <Columns>
                      ...
                      <telerik:GridTemplateColumn HeaderText='Fund' AllowSorting='true'>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblfund" runat="server" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDETHNICFUNDNAME") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText='SGH Fund Contribution ' AllowSorting='true'  ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblemployeecpf" runat="server" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDEMPLOYEEETHFUNDCONTRIBUTION") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
