<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayRollTaxSingaporeEdit.aspx.cs" Inherits="HR_PayRollTaxSingaporeEdit" %>
...
<head runat="server">
    <title>Tax Singapore Edit</title>
     ...
     <form id="form1" runat="server">
        ...
        <table>
            ...
            <td>
                ...
                <td>
                    <telerik:RadComboBox runat="server" ID="radstatus" >
                        <Items>
