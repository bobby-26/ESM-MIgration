<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PayrollSGCPFContribution.aspx.cs" Inherits="HR_PayrollSGCPFContribution" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvcpf.ClientID %>"));
                }, 200);
            }
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="radajaxpanel1" runat="server">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                         ...
                         <td>&nbsp</td>
                        <td> <telerik:RadLabel ID="RadLabel3" runat="server" Text="Employee " /></td>

                        <td>&nbsp</td>
                        <td> 
                            <telerik:RadComboBox ID="ddlemployee" runat="server" AllowCustomText="true" EmptyMessage="Type to select employee" />
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvcpf" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" ShowFooter="false" Style="margin-bottom: 0px" EnableViewState="true" EnableHeaderContextMenu="true"
                OnNeedDataSource="gvcpf_NeedDataSource"
                OnItemDataBound="gvcpf_ItemDataBound"
                OnItemCommand="gvcpf_ItemCommand">

                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDSGPRCPFCONTRIBUTIONID" TableLayout="Fixed">
                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    <ColumnGroups>


                        <telerik:GridColumnGroup Name="CPF" HeaderText="CPF Contribution" />
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText='Employee ' AllowSorting='true' ColumnGroupName="CPF" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblemployeecpf" runat="server" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDEMPLOYEECPFCONTRIBUTION") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText='Employer ' AllowSorting='true' ColumnGroupName="CPF" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblemployercpf" runat="server" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDEMPLOYERCPFCONTRIBUTION") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText='Net ' AllowSorting='true' ColumnGroupName="CPF" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblnetcpf" runat="server" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDNETCPFCONTRIBUTION") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
