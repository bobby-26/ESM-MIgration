<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="InspectionAuditInterface.aspx.cs"
    Inherits="InspectionAuditInterface" %>
...
<head id="Head1" runat="server">
    <title>Audit / Inspection Log</title>
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvAuditInterfaceList.ClientID %>"));
                }, 200);
            }
...
<body>
    <form id="frmInspectionScheduleSearch" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" EnableAJAX="false">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvAuditInterfaceList" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" AutoGenerateColumns="False" Font-Size="11px"
                CellSpacing="0" GridLines="None" Width="100%" OnItemCommand="gvAuditInterfaceList_ItemCommand" OnNeedDataSource="gvAuditInterfaceList_NeedDataSource"
                OnItemDataBound="gvAuditInterfaceList_ItemDataBound" OnSortCommand="gvAuditInterfaceList_SortCommand" OnEditCommand="gvAuditInterfaceList_EditCommand"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Vessel" HeaderStyle-Width="85px">
                            <ItemStyle Wrap="true" HorizontalAlign="Left" Width="100px"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblInspectionType" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDINSPECTIONTYPE") %>'></telerik:RadLabel>
                        ...
                        <telerik:GridTemplateColumn HeaderText="M/C" Visible="false" HeaderStyle-Width="40px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Ref. No" Visible="false" HeaderStyle-Width="106px">
                            <ItemStyle Wrap="true" HorizontalAlign="Left" Width="80px"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblInspectionRefNo" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREFERENCENUMBER").ToString() %>'></telerik:RadLabel>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="95px" HeaderText="Audit / Inspection">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lblReviewName" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREVIEWNAME") %>'></telerik:RadLabel>
                                ...
                                <asp:LinkButton ID="lnkInspection" runat="server" CommandName="INSPECT" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSHORTCODE").ToString().Length>35 ? DataBinder.Eval(Container, "DataItem.FLDSHORTCODE").ToString().Substring(0, 35)+ "..." : DataBinder.Eval(Container, "DataItem.FLDSHORTCODE").ToString() %>'></asp:LinkButton>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Credit" HeaderStyle-Width="52px">
                            <ItemStyle Wrap="False" HorizontalAlign="Left" Width="70px"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="OBS" HeaderStyle-Width="40px" ColumnGroupName="DeficiencyCount">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lblQuestionType" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDQUESTIONTYPE") %>'></telerik:RadLabel>
                                <telerik:RadLabel ID="lblLockyn" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDLOCKYN") %>'></telerik:RadLabel>

                            </ItemTemplate>
                        </telerik:GridTemplateColumn>

                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-Width="60px" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle Wrap="False" HorizontalAlign="Center" Width="50px"></ItemStyle>
                            <ItemTemplate>

                                <%--  <asp:LinkButton runat="server" AlternateText="Report" CommandName="SUMMARY"
                                    ID="cmdSummary" ToolTip="Summary">
                                ...
                                <asp:LinkButton runat="server" AlternateText="Note" CommandName="NOTE" ID="cmdNote" ToolTip="Note">
                                    <span class="icon"><i class="fas fa-clipboard"></i></span>
                                </asp:LinkButton>


                                <asp:LinkButton runat="server" AlternateText="lock" CommandName="LOCK"
                                    ID="cmdLock" ToolTip="lock">
                                    <span class="icon"><i class="fas fa-lock"></i></span>
                                </asp:LinkButton>

                                <asp:LinkButton runat="server" AlternateText="Unlock" CommandName="UNLOCK"
                                    ID="cmdUnlock" ToolTip="Unlock">
