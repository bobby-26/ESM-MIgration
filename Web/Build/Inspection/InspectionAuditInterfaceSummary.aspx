<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionAuditInterfaceSummary.aspx.cs" Inherits="InspectionAuditInterfaceSummary" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="Radcodeblock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvSummary.ClientID %>"));
                }, 200);
            }
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <table id="tblSearch" width="100%">
                <tr>
                    <td>
                        <telerik:RadLabel ID="RadLabel2" runat="server" Font-Bold="true" Text="MV/MT:" Width="50px"></telerik:RadLabel>

                    </td>
                    <td>
                        <telerik:RadLabel ID="txtMvMt" runat="server" Text="" Width="100px"></telerik:RadLabel>
                    </td>
                    <td>
                    ...
                    <td>
                        <telerik:RadLabel ID="txtmadeby" runat="server" Width="140px"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadLabel ID="RadLabel1" runat="server" Font-Bold="true" Text="From/To:" Width="50px"></telerik:RadLabel>
                        &nbsp;&nbsp;
                    </td>
                    <td>
                    ...
                    <td>
                        <telerik:RadLabel ID="RadLabel3" runat="server" Font-Bold="true" Text="From:" Width="30px"></telerik:RadLabel>
                        &nbsp;&nbsp;
                    </td>
                    <td>
                        <telerik:RadLabel ID="txtFrom" runat="server" Width="50px"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadLabel ID="RadLabel5" runat="server" Font-Bold="true" Text="To:" Width="20px"></telerik:RadLabel>
                        &nbsp;&nbsp;
                    </td>
                    <td>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvSummary" runat="server" CellSpacing="0" GridLines="None" width="100%"
                AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" EnableHeaderContextMenu="true" EnableViewState="true"
                GroupingEnabled="false" OnNeedDataSource="gvSummary_NeedDataSource" OnItemDataBound="gvSummary_ItemDataBound" OnItemCommand="gvSummary_ItemCommand">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Def Ref No" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="10%">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Compiles" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="3%">
                            <ItemStyle Wrap="False" HorizontalAlign="Left" Width="3%"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblCompiles" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDQUICKNAME") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>

                        <telerik:GridTemplateColumn HeaderText="Deficiency/Observation" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="13%">
                            <ItemStyle Wrap="True" HorizontalAlign="Left" Width="13%"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblObservation" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDESCRIPTION") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>

                        <telerik:GridTemplateColumn HeaderText="Action Required" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="12%">
                            ...
                            <EditItemTemplate>
                                <telerik:RadTextBox ID="txtActionRequired" runat="server" Width="98%" Resize="Both" TextMode="MultiLine" Text='<%# DataBinder.Eval(Container,"DataItem.FLDACTIONREQUIRED") %>'></telerik:RadTextBox>
                            </EditItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Assigned To" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="8%">
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="ddlAssignedTo" runat="server" Width="98%" DropDownHeight="50px" Filter="Contains"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Due Date" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="7%">
                            ...
                            <EditItemTemplate>
                                <eluc:UserControlDate ID="ucDueDate" runat="server" Width="98%" />
                            </EditItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Verification Level" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="7%">
                            ...
                            <EditItemTemplate>
                                <telerik:RadComboBox ID="cmdVerificationlevel" runat="server" Width="98%" DropDownHeight="50px" Filter="Contains"
                                    EnableDirectionDetection="true">
                                </telerik:RadComboBox>
                            </EditItemTemplate>
                        </telerik:GridTemplateColumn>
