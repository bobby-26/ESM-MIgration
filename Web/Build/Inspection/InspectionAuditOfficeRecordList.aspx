<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionAuditOfficeRecordList.aspx.cs"
    Inherits="InspectionAuditOfficeRecordList" %>
...
<head id="Head1" runat="server">
    <title>Inspection Schedule Search</title>
...
<body>
    <form id="frmInspectionScheduleSearch" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvAuditRecordList" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowPaging="true" AllowCustomPaging="true"
            Width="100%" CellPadding="3" OnItemCommand="gvAuditRecordList_ItemCommand" OnItemDataBound="gvAuditRecordList_ItemDataBound"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Reference Number" HeaderStyle-Width="250px">
        ...
        <table cellpadding="1" cellspacing="1">
            <tr>
                <td>
                    <b><telerik:RadLabel ID="lblManual" runat="server" Text="* M - Manual "></telerik:RadLabel>
                </td>
                <td>
                    <b><telerik:RadLabel ID="lblConfiguration" runat="server" Text="* C - Configuration"></telerik:RadLabel>
                </td>
                <td>
                     <table>
