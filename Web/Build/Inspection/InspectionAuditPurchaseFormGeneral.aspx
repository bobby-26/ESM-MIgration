<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionAuditPurchaseFormGeneral.aspx.cs"
    Inherits="InspectionAuditPurchaseFormGeneral" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadLabel ID="lblFormType1" runat="server" Text="Form Type"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadTextBox ID="txtType" runat="server" Text=" " Width="134px"
                            Enabled="False"></telerik:RadTextBox>
                    </td>
                    <td>
                    ...
                    <td>
                        <telerik:RadComboBox runat="server" ID="ddlStockType" Width="135px" Filter="Contains">
                            <Items>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Date ID="txtCreatedDate" runat="server" Enabled="false" />
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblOrdered" runat="server" Text="Ordered"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Date ID="txtOrderDate" runat="server" Enabled="false" ReadOnly="true" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <span id="spnPickListMaker">
                            <telerik:RadTextBox ID="txtVendorNumber" runat="server" Width="84px" Enabled="False"></telerik:RadTextBox>
                            <telerik:RadTextBox ID="txtVenderName" runat="server" Width="180px" Enabled="False"></telerik:RadTextBox>
                            <asp:LinkButton runat="server" ID="cmdShowMaker" OnClientClick="return showPickList('spnPickListMaker', 'codehelp1', '', '../Common/CommonPickListAddress.aspx?addresstype=130,131,132&framename=ifMoreInfo', true);">
                                <span class="icon"><i class="fas fas fa-tasks"></i></span>
                            </asp:LinkButton>
                            <telerik:RadTextBox ID="txtVendor" runat="server" Width="1px"></telerik:RadTextBox>
                        </span>
                        &nbsp;
                    ...
                    <td>
                        <eluc:Date ID="txtRecivedDate" runat="server" Enabled="false" ReadOnly="true" />
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblConfirmed" runat="server" Text="Confirmed"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Date ID="txtConfirmDate" runat="server" ReadOnly="true" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <span id="spnDLocation">
                            <telerik:RadTextBox ID="txtDeliveryLocationCode" runat="server" Width="84px"
                                Enabled="False"></telerik:RadTextBox>
                            <telerik:RadTextBox ID="txtDeliveryLocationName" runat="server" Width="180px"
                                Enabled="False"></telerik:RadTextBox>
                            ...
                            <telerik:RadTextBox ID="txtDeliveryLocationId" runat="server" Width="0px"></telerik:RadTextBox>
                        </span>
                    </td>
                    <td>
                    ...
                    <td>
                        <eluc:Date ID="txtBugetDate" runat="server" />
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblDelivered" runat="server" Text="Delivered"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Date ID="txtlLastDeliveryDate" runat="server" ReadOnly="false" />
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnDAddress">
                            <telerik:RadTextBox ID="txtDeliveryAddressCode" runat="server" Width="84px" 
                                Enabled="False"></telerik:RadTextBox>
                            <telerik:RadTextBox ID="txtDeliveryAddressName" runat="server" Width="180px"
                                Enabled="False"></telerik:RadTextBox>
                            ...
                            <telerik:RadTextBox ID="txtDeliveryAddressId" runat="server" Width="1px"></telerik:RadTextBox>
                        </span>
                        &nbsp;
                    ...
                    <td>
                        <eluc:Date ID="txtApproveDate" runat="server" Enabled="false" />
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblReceived" runat="server" Text=" Received"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Date ID="txtVenderDelveryDate" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <span id="spnPickListMainBudget">
                            <telerik:RadTextBox ID="txtBudgetCode" runat="server" Width="84px" Enabled="False"></telerik:RadTextBox>
                    ...
                    <td>
                        <eluc:Quick ID="ddlComponentClass" runat="server" AppendDataBoundItems="true" Width="180px" />
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtStatus" runat="server" Text="" Width="135px"
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnPickListForwarder">
                            <telerik:RadTextBox ID="txtForwarderCode" runat="server" Width="84px" Enabled="False"></telerik:RadTextBox>
                            <telerik:RadTextBox ID="txtForwarderName" runat="server" BorderWidth="1px" Width="180px" Enabled="False"></telerik:RadTextBox>
                            ...
                            <telerik:RadTextBox ID="txtForwarderId" runat="server" Width="1"></telerik:RadTextBox>
                        </span>
                        &nbsp;
                    ...
                    <td>
                        <eluc:Quick ID="UCPaymentTerms" AppendDataBoundItems="true" Enabled="false"
                    ...
                    <td>
                        <eluc:Quick ID="UCPeority" AppendDataBoundItems="true" runat="server" Width="135px" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <span id="spnPickListOwnerBudget">
                            <telerik:RadTextBox ID="txtOwnerBudgetCode" runat="server" Text="" Enabled="false" MaxLength="20" Width="265px"></telerik:RadTextBox>
                    ...
                    <td>
                        <eluc:Quick ID="UCDeliveryTerms" AppendDataBoundItems="true" Enabled="false" runat="server" Width="180px" />
                    </td>
                </tr>
                <tr>
                    <td colspan="6">
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Currency ID="ucCurrency" AppendDataBoundItems="true" Enabled="False"
                    ...
                    <td>
                        <eluc:Company ID="ucPayCompany" AppendDataBoundItems="true" runat="server" Width="120px" />
                    </td>
                    <td>
                ...
                <tr id="trPay" runat="server">
                    ...
                    <td>
                        <span id="spnPicPartPaid">
                            <eluc:Decimal ID="txtPartPaid" runat="server" Width="120px" ReadOnly="true" />
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtFormCreatedBy" runat="server" Width="180px"
                            Enabled="False"></telerik:RadTextBox>
                    </td>
                    <td>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtPOorderedBy" runat="server" Width="180px" Enabled="False"></telerik:RadTextBox>
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblPurchaseApprovedBy" runat="server" Text="Purchase Approved By"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadTextBox ID="txtPurchaseAppovedBy" runat="server" Width="180px"
                            Enabled="False"></telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtReqApprovedBy" runat="server" Visible="false" Width="120px" 
                            Enabled="False"></telerik:RadTextBox>
                    </td>
                    <td>
                        <%-- Accumulated Budget--%>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtAccumulatedBudget" Visible="false" runat="server" Width="90px"
                            Style="text-align: right" Enabled="False"></telerik:RadTextBox>
                    </td>
                    <td>
                        <%--Accumulated Total--%>
                    </td>
                    <td>
                        <eluc:Date ID="txtAccumulatedTotal" runat="server"  Visible="false" Enabled="False" />
                    </td>
                </tr>
            </table>
