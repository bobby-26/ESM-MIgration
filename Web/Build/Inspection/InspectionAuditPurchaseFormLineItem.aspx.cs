...
public partial class InspectionAuditPurchaseFormLineItem : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbargrid.AddFontAwesomeButton("../Inspection/InspectionAuditPurchaseFormLineItem.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            {
                if (Filter.CurrentAuditMenu == null)
                ...
                else if (Filter.CurrentAuditMenu == "directnc")
                {
                ...
                else if (Filter.CurrentAuditMenu == "directobs")
                {
                    if (ViewState["REVIEWDNC"] != null && ViewState["REVIEWDNC"].ToString() != string.Empty)
                    {
                        DataSet ds = PhoenixInspectionAuditDirectNonConformity.EditDirectObservation(new Guid(ViewState["REVIEWDNC"].ToString()));
            ...
            if (Filter.CurrentAuditMenu == null)
                toolbargrid.AddFontAwesomeButton("../Inspection/InspectionAuditPurchaseFormLineItem.aspx", "Delete", "<i class=\"fas fa-trash\"></i>", "BulkDelete");
            else if (Filter.CurrentAuditMenu == "directnc")
            {
                if (ViewState["REVIEWDNC"] != null && ViewState["REVIEWDNC"].ToString() != string.Empty)
                {
    ...
    protected void gvLineItem_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            LinkButton img = (LinkButton)e.Item.FindControl("imgComponentDetails");
            if (img != null) img.Attributes.Add("onclick", "javascript:return openNewWindow('Component', '', 'PurchaseFormItemComponentDetails.aspx?COMPONENTID=" + lblcomponentid.Text + "&VESSELID=" + lblvesselid.Text + "'); return false;");
            ...
            {
                if (Filter.CurrentInspectionPurchaseStockType.ToUpper().Equals("SERVICE"))
                    img1.Attributes.Add("onclick", "javascript:return openNewWindow('Component', '', 'PurchaseServiceDetail.aspx?WORKORDERID=" + lblcomponentid.Text + "&VESSELID=" + lblvesselid.Text + "&STOCKTYPE=" + Filter.CurrentInspectionPurchaseStockType.ToString() + "'); return false;");
                else
                    img1.Attributes.Add("onclick", "javascript:return openNewWindow('Component', '', 'PurchaseSpareItemDetail.aspx?SPAREITEMID=" + lblcomponentid.Text + "&VESSELID=" + lblvesselid.Text + "&STOCKTYPE=" + Filter.CurrentInspectionPurchaseStockType.ToString() + "'); return false;");
        ...
        {
            if (Filter.CurrentInspectionPurchaseStockType.ToUpper().Equals("SPARE"))
                ib2.Attributes.Add("onclick", "return showPickList('spnPickListOwnerBudgetEdit', 'codehelp1', '', '../Common/CommonPickListOwnerBudget.aspx?iframignore=true&vesselid=" + Filter.CurrentInspectionPurchaseVesselSelection + "&budgetdate=" + DateTime.Now.ToString() + "&budgetid=" + tb1.Text + "&framename=ifMoreInfo', true); ");
            else
                ib2.Attributes.Add("onclick", "return showPickList('spnPickListOwnerBudgetEdit', 'codehelp1', '', '../Common/CommonPickListOwnerBudget.aspx?iframignore=true&vesselid=" + Filter.CurrentInspectionPurchaseVesselSelection + "&budgetdate=" + DateTime.Now.ToString() + "&budgetid=" + tb1.Text + "&framename=ifMoreInfo', true); ");
        }
    }
