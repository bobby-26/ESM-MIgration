<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionAuditPurchaseFormType.aspx.cs"
    Inherits="InspectionAuditPurchaseFormType" %>
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                ...
                <tr>
                    <td>
                        ...
                        Component Class</telerik:RadLabel>
                    </td>
                    <td>
                        <span id="spnPickListClass">
                            ...
                            <%--<asp:ImageButton runat="server" ID="btnStockClassPickList" OnClientClick="return showPickList('spnPickListClass', 'codehelp1', '', '../Common/CommonPickListComponentClass.aspx', true);"
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnPickStock">
                            ...
                            <%--<asp:ImageButton runat="server" ID="btnPicstockItem" OnClientClick="return showPickList('spnPickStock', 'codehelp1', '', '../Common/CommonPickListStockItem.aspx', true);"
                                Text=".." ImageUrl="<%$ PhoenixTheme:images/picklist.png %>" ImageAlign="AbsMiddle" />--%>
                            ...
                            <%--<asp:ImageButton runat="server" ID="btnStocitemTo" OnClientClick="return showPickList('spnPickStockTo', 'codehelp1', '', '../Common/CommonPickListStockItem.aspx', true);"
                                Text=".." ImageUrl="<%$ PhoenixTheme:images/picklist.png %>" ImageAlign="AbsMiddle" />--%>
                            <asp:LinkButton runat="server" ID="btnStocitemTo" OnClientClick="return showPickList('spnPickStockTo', 'codehelp1', '', '../Common/CommonPickListStockItem.aspx', true);">
                                <span class="icon"><i class="fas fas fa-tasks"></i></span>
                            </asp:LinkButton>
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnPickListContract">
                            ...
                            <%--<asp:ImageButton runat="server" ID="btnContractPickList" OnClientClick="return showPickList('spnPickListContract', 'codehelp1', '', '../Common/CommonPickListAddress.aspx?addresstype=130,131&framename=ifMoreInfo', true);"
                                Text=".." ImageUrl="<%$ PhoenixTheme:images/picklist.png %>" ImageAlign="AbsMiddle" />--%>
