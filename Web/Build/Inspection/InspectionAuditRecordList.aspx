<%@ Page Language="C#" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="InspectionAuditRecordList.aspx.cs"
    Inherits="InspectionAuditRecordList" %>
...
<body>
    <form id="frmInspectionScheduleSearch" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvAuditRecordList" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" AutoGenerateColumns="False" Font-Size="11px"
            ...
            OnItemDataBound="gvAuditRecordList_ItemDataBound" OnSortCommand="gvAuditRecordList_SortCommand"
        ...
        <table cellpadding="1" cellspacing="1">
            <tr>
                <td>
                    <b><telerik:RadLabel ID="lblManual" runat="server" Text="* M - Manual "></telerik:RadLabel></b>
                </td>
                <td>
                    <b><telerik:RadLabel ID="lblConfiguration" runat="server" Text="* C - Configuration"></telerik:RadLabel></b>
                </td>
                 <td>
                     <table>
