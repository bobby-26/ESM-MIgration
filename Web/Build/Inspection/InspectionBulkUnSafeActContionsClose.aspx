<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionBulkUnSafeActContionsClose.aspx.cs" Inherits="InspectionBulkUnSafeActContionsClose" %>
...
<head id="Head1" runat="server">
    <title>Bulk Unsafe Acts / Conditions Closure</title>
    ...
    <form id="frmDirectorComment" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <table cellpadding="1" cellspacing="1" width="60%">
                <tr>
                    <td width="35%">
                        <telerik:RadLabel ID="lblOfficeRemarks" runat="server" Text="Closed Out Remarks"></telerik:RadLabel>
                    </td>
                    <td colspan="3">
