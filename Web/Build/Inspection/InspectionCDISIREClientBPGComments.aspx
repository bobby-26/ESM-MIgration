<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionCDISIREClientBPGComments.aspx.cs" Inherits="Inspection_InspectionCDISIREClientBPGComments" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvClientComments" Height="88%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDCDISIREBPGCOMMENTSID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Best Practice Guidance" >
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblcomments" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCDISIREBPGCOMMENTSID") %>'></telerik:RadLabel>
                                <telerik:RadLabel ID="lnkDepartmentName" runat="server"
                                    Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOMMENTS") %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <telerik:RadLabel ID="lblcommentsEdit" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCDISIREBPGCOMMENTSID") %>'></telerik:RadLabel>
