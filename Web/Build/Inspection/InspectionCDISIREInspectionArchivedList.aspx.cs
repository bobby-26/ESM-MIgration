...
public partial class Inspection_InspectionCDISIREInspectionArchivedList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            MenuCommentsEdit.Visible = false; 
    ...
    protected void MenuCommentsEdit_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["INSPECTIONID"] != null)
            {
                ...
                {
                    PhoenixInspectionCDISIREMatrix.OnboardVerificationComplete(new Guid(ViewState["INSPECTIONID"].ToString())
    ...
    protected void BindCompany()
    {
        ...
        DataTable dt = PhoenixInspectionCDISIREMatrix.CDISIREMatrixArchivedEdit(new Guid(ViewState["INSPECTIONID"].ToString()), new Guid(ViewState["CONTENTID"].ToString()), PhoenixSecurityContext.CurrentSecurityContext.VesselID);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixInspectionCDISIREMatrix.ListCDISIREInspectionArchiveList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixInspectionCDISIREMatrix.ListCDISIREInspectionArchiveList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            new Guid(ViewState["INSPECTIONID"].ToString()),
            new Guid(ViewState["CONTENTID"].ToString()),
            PhoenixSecurityContext.CurrentSecurityContext.VesselID,
            sortexpression,
        ...
        General.SetPrintOptions("gvVerificationSummary", "Archived List", alCaptions, alColumns, ds);
    ...
    protected void gvVerificationSummary_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        if (e.Item is GridEditableItem)
        {
            ...
            LinkButton lnkna = (LinkButton)e.Item.FindControl("lnkna");
            LinkButton lnkofficeverification = (LinkButton)e.Item.FindControl("lnkofficeverification");

            if (lnkno != null)
            {
                lnkno.Attributes.Add("onclick", "openNewWindow('source','', '" + Session["sitepath"] + "/Inspection/InspectionCDISIREVerificationSummaryView.aspx?categoryid=" + lblcategory.Text + "&inspectionid=" + lblinspectionid.Text + "&counttype=0' ); return true;");
            }

            if (lnkyes != null)
            {
                lnkyes.Attributes.Add("onclick", "openNewWindow('source','', '" + Session["sitepath"] + "/Inspection/InspectionCDISIREVerificationSummaryView.aspx?categoryid=" + lblcategory.Text + "&inspectionid=" + lblinspectionid.Text + "&counttype=1' ); return true;");
            }

            if (lnkna != null)
            {
                lnkna.Attributes.Add("onclick", "openNewWindow('source','', '" + Session["sitepath"] + "/Inspection/InspectionCDISIREVerificationSummaryView.aspx?categoryid=" + lblcategory.Text + "&inspectionid=" + lblinspectionid.Text + "&counttype=2' ); return true;");
            }

            if (lnkofficeverification != null)
            {
                lnkofficeverification.Attributes.Add("onclick", "openNewWindow('source','', '" + Session["sitepath"] + "/Inspection/InspectionCDISIREVerificationSummaryView.aspx?categoryid=" + lblcategory.Text + "&inspectionid=" + lblinspectionid.Text + "&counttype=3' ); return true;");
            }
