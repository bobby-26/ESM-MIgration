<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionCDISIREMatrixCategory.aspx.cs" Inherits="Inspection_InspectionCDISIREMatrixCategory" %>
...
<body>
    <form id="frmDocumentCategory" runat="server">
        ...
        <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" SplitBarsSize="10" Height="100%" Width="100%">
            ...
            <telerik:RadPane ID="contentPane" runat="server" Width="70%" Height="100%">
                <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" Height="94%">
                    ...
                    <table width="100%" cellpadding="5">
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblVetting" runat="server" Text="Inspection"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadComboBox ID="ucVetting" runat="server" Width="200px"
                        ...
                        <tr>
                            <td>
                                    <telerik:RadLabel ID="RadLabel1" runat="server" Text="Category Name"></telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="RadLabel2" runat="server" Text="Category Number"></telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="RadLabel3" runat="server" Text="Company"></telerik:RadLabel>
                                </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="RadLabel4" runat="server" Text="Active"></telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr runat="server" id="tblnoofcolumns">
                            <td>
                                <telerik:RadLabel ID="RadLabel5" runat="server" Text="No of Columns"></telerik:RadLabel>
                            </td>
                            <td>
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvCDISIREMatrix" runat="server" AutoGenerateColumns="false" Font-Size="11px" GridLines="None"
                        Width="100%" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellPadding="3" OnNeedDataSource="gvCDISIREMatrix_NeedDataSource"
...
<%--                            <GroupByExpressions>
                        ...
                        <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="true" ReorderColumnsOnClient="true" AllowColumnHide="true" ColumnsReorderMethod="Reorder" AllowDragToGroup="false">
                            ...
                            <Resizing EnableRealTimeResize="true" AllowResizeToFit="true" AllowColumnResize="true" />
                                ...
                                <asp:Button ID="confirm" runat="server" Text="confirm" PostBackUrl="../Inspection/InspectionCDISIREMatrixCategory.aspx" OnClick="confirm_Click" />
