<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionCDISIREMatrixCategoryContentArchivedList.aspx.cs" Inherits="Inspection_InspectionCDISIREMatrixCategoryContentArchivedList" %>
...
<body>
    <form id="frmDocumentCategory" runat="server">
        ...
        <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Height="90%" Width="100%">
            <telerik:RadPane ID="navigationPane" runat="server" Width="30%" Height="90%" Visible="false">
                <eluc:TreeView runat="server" ID="tvwDocumentCategory" RootText="ROOT" OnNodeClickEvent="ucTree_SelectNodeEvent"></eluc:TreeView>
            </telerik:RadPane>
            <telerik:RadSplitBar ID="RadSplitbar1" runat="server" CollapseMode="Forward" Height="100%" Visible="false">
            </telerik:RadSplitBar>
            <telerik:RadPane ID="contentPane" runat="server" Width="70%" Height="90%">
                <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" Height="80%">
                    ...
                    <table width="50%">
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="ddlRefNo" runat="server" OnSelectedIndexChanged="ddlRefNo_SelectedIndexChanged" AutoPostBack="true"
                                    DataTextField="FLDREFERENCENUMBER" DataValueField="FLDINSPECTIONSCHEDULEID" Width="200px" EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true">
                                </telerik:RadComboBox>
                            </td>
                            <td runat="server" visible="false">Client</td>
...
<%--                                    <FooterTemplate>
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn HeaderText="Evidence Required">
                                    ...
                                    <ItemTemplate>
                                        <telerik:RadCheckBox ID="chkSelect" runat="server" Enabled="false" OnClick="EvidenceRequired" Checked='<%# DataBinder.Eval(Container,"DataItem.FLDEVIDENCEREQD").ToString().Equals("1")?true:false %>'  />
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn HeaderText="Action">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton runat="server" ID="Edit" Visible="false" CommandArgument="<%# Container.DataItem %>"
                                        ...
                                        <asp:LinkButton runat="server" AlternateText="Comments" Visible="false" CommandName="COMMENTS" ID="cmdComments"
                                            ToolTip="Comments"><span class="icon"><i class="fas fa-comments"></i></span></asp:LinkButton>
                                        <asp:ImageButton runat="server" AlternateText="ClientComments" Visible="false" ImageUrl="<%$ PhoenixTheme:images/vendor-detail.png %>" CommandName="CLIENTCOMMENTS" ID="cmdClientComments"
                                        ...
                                        <asp:LinkButton runat="server" AlternateText="Archive" CommandName="ARCHIVE" Visible="false" ID="cmdarchive"
