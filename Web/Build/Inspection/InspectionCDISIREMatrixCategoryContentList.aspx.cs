...
public partial class Inspection_InspectionCDISIREMatrixCategoryContentList : PhoenixBasePage
{
    ...
    private void setMenu()
    {
        ...
        if (PhoenixSecurityContext.CurrentSecurityContext.VesselID != 0)
        {
            ...
            toolbar.AddImageLink("javascript:parent.openNewWindow('Filter','','Inspection/InspectionCDISIREMatrixCategoryContentArchivedList.aspx?categoryid=" + General.GetNullableGuid(ViewState["CATEGORYID"].ToString()) + "&inspectionid=" + General.GetNullableGuid(ViewState["INSPECTIONID"].ToString()) + "'); return false;", "Archived List", "Archive.png", "ARCHIVE");
       }
       ...
       if (PhoenixSecurityContext.CurrentSecurityContext.VesselID == 0)
       {
        ...
        toolbar.AddImageButton("../Inspection/InspectionCDISIREMatrixCategoryContentList.aspx", "Refresh", "refresh.png", "REFRESH", ToolBarDirection.Right);
