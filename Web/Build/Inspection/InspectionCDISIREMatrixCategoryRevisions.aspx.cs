...
public partial class Inspection_InspectionCDISIREMatrixCategoryRevisions : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionCDISIREMatrixCategoryRevisions.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    private void GetFormDetails()
    {
        ...
        {
            DataSet ds = PhoenixInspectionCDISIREMatrix.CDISIREMatrixCategoryEdit(
                                                            new Guid(ViewState["CATEGORYID"].ToString()),PhoenixSecurityContext.CurrentSecurityContext.VesselID);
    ...
    protected void MenuDocument_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../Inspection/InspectionCDISIREMatrixCategoryContentList.aspx?CATEGORYID=" + ViewState["CATEGORYID"].ToString());
            }
        }
        catch (Exception ex)
        {
    ...
    private void BindData()
    {
        ...
        ds = PhoenixInspectionCDISIREMatrix.CDISIRECategoryRevisionSearch(
                                                                ...
                                                                , ref iRowCount
                                                                , ref iTotalPageCount, PhoenixSecurityContext.CurrentSecurityContext.VesselID);
    ...
    protected void gvFormRevision_ItemDataBound(Object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        if (e.Item is GridEditableItem)
        {
            ...
            {
                hlnkAddedDate.Attributes.Add("onclick", "javascript:parent.openNewWindow('codehelp','','" + Session["sitepath"] + "/Inspection/InspectionCDISIREMatrixCategoryRevisionContentList.aspx?categoryid=" + ViewState["CATEGORYID"].ToString() + "&revisionid=" + dr["FLDREVISIONID"].ToString() + "'); return false;");
            }
            ...
            if (cmdMoreInfo != null)
            {
                cmdMoreInfo.Attributes.Add("onclick", "parent.openNewWindow('codeHelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionCDISIREMatrixCommentsRevisionView.aspx?categoryid=" + ViewState["CATEGORYID"].ToString() + "&revisionid=" + dr["FLDREVISIONID"].ToString() + "');return false;");
            }
