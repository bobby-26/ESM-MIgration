...
public partial class Inspection_InspectionCDISIREVerificationSummary : PhoenixBasePage
{
    ...
    protected void BindCompany()
    {
        ...
        DataTable dt = PhoenixInspectionCDISIREMatrix.CDISIREMatrixClientAuditEdit(General.GetNullableGuid(ViewState["INSPECTIONID"].ToString()), PhoenixSecurityContext.CurrentSecurityContext.VesselID);
        if(dt.Rows.Count > 0)
        {
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixInspectionCDISIREMatrix.ListCDISIREVerificationSummary(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixInspectionCDISIREMatrix.ListCDISIREVerificationSummary(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            General.GetNullableGuid(ViewState["INSPECTIONID"].ToString()),
            PhoenixSecurityContext.CurrentSecurityContext.CompanyID,
            PhoenixSecurityContext.CurrentSecurityContext.VesselID,
            sortexpression,
