<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionContactTypeExtn.aspx.cs" Inherits="InspectionContactTypeExtn" %>
...
<body>
    <form id="frmContactType" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
            ...
            <table id="tblCauseSearch" width="70%" runat="server" visible="false">
                <tr>
                    <td width="20%">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="10%">
                            <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                            <ItemTemplate>
                                <asp:LinkButton runat="server" AlternateText="Undesirable Event / Worst case" CommandName="WSMAPPING" ID="cmdMap" ToolTip="Undesirable Event / Worst Case">
