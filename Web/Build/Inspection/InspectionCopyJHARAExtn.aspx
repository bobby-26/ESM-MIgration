<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionCopyJHARAExtn.aspx.cs" Inherits="InspectionCopyJHARA" %>
    ...
    <form id="frmOfficeCopySelectCompany" runat="server">
        ...
        <table cellpadding="1" cellspacing="1" width="100%">
            <tr>
                <td width="15%">
                    <b>
                        <telerik:RadLabel ID="lblSelectCompany" runat="server" Text="Target Company"></telerik:RadLabel>
                    </b>
                </td>
                <td width="60%">
