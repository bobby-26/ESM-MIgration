...
public partial class InspectionCorrespondenceEmail : PhoenixBasePage
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		try
		{
            ...
            lnkAttachment.OnClientClick = "javascript:parent.openNewWindow('MailAttachment', '', '" + Session["sitepath"] + "/Options/OptionsAttachment.aspx?mailsessionid=" + ViewState["mailsessionid"] + "', 'xdata');";
    ...
    private void EditCorrespondenceEmail(string Correspondenceid, string employeeid)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                {
                    filepath = PhoenixGeneralSettings.CurrentGeneralSetting.AttachmentPath + "/EmailAttachments/" + dt1.Rows[i]["FLDFILEPATH"].ToString();
