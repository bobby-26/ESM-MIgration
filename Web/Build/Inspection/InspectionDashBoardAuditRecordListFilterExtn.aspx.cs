...
public partial class InspectionDashBoardAuditRecordListFilterExtn : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ViewState["type"] = PhoenixCommonRegisters.GetHardCode(1, 144, Request.QueryString["Type"].ToString());
            BindVesselFleetList();
            BindVesselList();
    ...
    protected void MenuScheduleFilter_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("GO"))
        {
            ...
            criteria.Add("ucAuditCategory", ViewState["type"].ToString());
