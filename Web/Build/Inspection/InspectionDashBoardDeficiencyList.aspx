<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDashBoardDeficiencyList.aspx.cs" Inherits="InspectionDashBoardDeficiencyList" %>
    ...
    <form id="frmDeficiency" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid ID="gvDeficiency" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                CellPadding="3" OnItemDataBound="gvDeficiency_ItemDataBound"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Req" ColumnGroupName="RCA">
                            <HeaderStyle Width="5%" HorizontalAlign="Center" VerticalAlign="Middle" Wrap="true" />
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:LinkButton runat="server"  AlternateText="Corrective Actions" CommandName="CORRECTIVEACTIONS" ID="cmdCorrectiveActions" ToolTip="View Corrective and Preventive Actions" Visible="false">
