...
public partial class InspectionDashBoardExternalFSIAuditRecord : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashBoardExternalFSIAuditRecord.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashBoardExternalFSIAuditRecord.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=FSI_Log.xls");
    ...
    private void BindData()
    {
        ...
        General.SetPrintOptions("gvAuditRecordList", "FSI Log", alCaptions, alColumns, ds);
