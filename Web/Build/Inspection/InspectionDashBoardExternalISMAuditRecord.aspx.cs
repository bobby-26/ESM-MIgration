...
public partial class InspectionDashBoardExternalISMAuditRecord : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashBoardExternalISMAuditRecord.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashBoardExternalISMAuditRecord.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=ISM_Log.xls");
    ...
    private void BindData()
    {
        ...
        General.SetPrintOptions("gvAuditRecordList", "ISM Log", alCaptions, alColumns, ds);
