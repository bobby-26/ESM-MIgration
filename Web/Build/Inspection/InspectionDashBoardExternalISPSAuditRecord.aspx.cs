...
public partial class InspectionDashBoardExternalISPSAuditRecord : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashBoardExternalISPSAuditRecord.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashBoardExternalISPSAuditRecord.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void MenuARSubTab_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("MLC"))
        {
            Response.Redirect("../Inspection/InspectionDashBoardExternalMLCAuditRecord.aspx");
        }
    }
    ...
    protected void ShowExcel()
    {
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=ISPS_Log.xls");
    ...
    private void BindData()
    {
        ...
        General.SetPrintOptions("gvAuditRecordList", "ISPS Log", alCaptions, alColumns, ds);
