<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDashBoardExternalInternalAuditRecordList.aspx.cs" Inherits="InspectionDashBoardExternalInternalAuditRecordList" %>
...
<%--        <eluc:TabStrip ID="MenuGeneral" runat="server" TabStrip="true" OnTabStripCommand="MenuGeneral_TabStripCommand"></eluc:TabStrip>--%>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvAuditRecordList" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" AutoGenerateColumns="False" Font-Size="11px"
            CellSpacing="0" GridLines="None" Width="100%" Height="90%" OnItemCommand="gvAuditRecordList_ItemCommand" OnNeedDataSource="gvAuditRecordList_NeedDataSource"
