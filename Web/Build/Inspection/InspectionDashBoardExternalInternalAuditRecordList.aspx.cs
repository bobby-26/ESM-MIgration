...
public partial class InspectionDashBoardExternalInternalAuditRecordList : PhoenixBasePage
{
    ...
    protected void ShowExcel()
    {
        ...
        DataSet ds = PhoenixInspectionOfficeDashboard.DashBoardExternalInternalAuditInspectionShipSearch(General.GetNullableString(nvc != null ? nvc["VesselList"] : null)
                                                                                            , General.GetNullableString(nvc != null ? nvc["VesselTypeList"] : null)
                                                                                            , General.GetNullableString(nvc != null ? nvc["FleetList"] : null)
                                                                                            , General.GetNullableInteger(nvc != null ? nvc["Owner"] : null)
