...
public partial class InspectionDashBoardInternalAICL1AuditRecord : PhoenixBasePage
{
    ...
    protected void MenuARSubTab_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("AICL8"))
        {
            Response.Redirect("../Inspection/InspectionDashBoardInternalAICL8AuditRecord.aspx");
        }
    }
