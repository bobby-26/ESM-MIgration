...
public partial class InspectionDashBoardInternalAICL8AuditRecord : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashBoardInternalAICL1AuditRecord.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvAuditRecordList')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelp1','', '" + Session["sitepath"] + "/Inspection/InspectionDashBoardAuditRecordListFilterExtn.aspx?type=INT')", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashBoardInternalAICL1AuditRecord.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
            MenuInspectionScheduleSearch.AccessRights = this.ViewState;
            MenuInspectionScheduleSearch.MenuList = toolbar.Show();

            PhoenixToolbar toolbarmain = new PhoenixToolbar();
            toolbarmain.AddButton("AICL1", "AICL1");
            toolbarmain.AddButton("AICL4", "AICL4");
            toolbarmain.AddButton("AICL8", "AICL8");
    ...
    protected void MenuARSubTab_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("AICL1"))
        {
            Response.Redirect("../Inspection/InspectionDashBoardInternalAICL1AuditRecord.aspx");
        }
        if (CommandName.ToUpper().Equals("AICL4"))
        {
            Response.Redirect("../Inspection/InspectionDashBoardInternalAICL4AuditRecord.aspx");
        }
    }
    ...
    protected void ddlAudit_DataBinding(object sender, EventArgs e)
    {
        ...
        string inter = PhoenixCommonRegisters.GetHardCode(1, 144, "INT");
