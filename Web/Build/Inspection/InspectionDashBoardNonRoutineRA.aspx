<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDashBoardNonRoutineRA.aspx.cs" Inherits="Inspection_InspectionDashBoardNonRoutineRA" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessment" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" AllowMultiRowSelection="true" AllowFilteringByColumn="true" FilterType="CheckList"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDRISKASSESSMENTID" AllowFilteringByColumn="false">
                    <NoRecordsTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-Width="20%" AllowFiltering="false">
