...
public partial class InspectionDashboardIncidentNearMissList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashboardIncidentNearMissList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alCaptions = { "Ref. No", "Type", "Category", "Subcategory", "Consequence Category", "Title", "Reported", "Incident", "Status" };
        ...
        ds = PhoenixInspectionIncident.InspectionDashboardIncidentSearch(General.GetNullableString(ViewState["CODE"].ToString())
        ...
        try
        {
            if (e.Item is GridEditableItem)
            {
                ...
                if (lnkRefno != null)
                {
                    ...
                    lnkRefno.Attributes.Add("onclick", "javascript:openNewWindow('Incident/NearMiss', '', '" + Session["sitepath"] + "/Inspection/InspectionIncidentList.aspx?DashboardYN=1');");
                }
            }
        }
        catch (Exception ex)
