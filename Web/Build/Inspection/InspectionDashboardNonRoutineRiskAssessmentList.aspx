<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDashboardNonRoutineRiskAssessmentList.aspx.cs" Inherits="InspectionDashboardNonRoutineRiskAssessmentList" %>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Status" HeaderStyle-Width="14%" ShowFilterIcon="false" UniqueName="FLDSTATUSID">
                            <FilterTemplate>
                                <telerik:RadComboBox ID="ddlStatus" runat="server" Visible="false" AutoPostBack="true" AppendDataBoundItems="true" OnDataBinding="ddlStatus_DataBinding"
