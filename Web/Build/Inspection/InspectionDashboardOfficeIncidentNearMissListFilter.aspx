<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDashboardOfficeIncidentNearMissListFilter.aspx.cs" Inherits="InspectionDashboardOfficeIncidentNearMissListFilter" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="80%">
            ...
            <table cellpadding="2" cellspacing="2" width="100%">   
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="ddlIncidentNearmiss" runat="server" Width="270px" AutoPostBack="true"
