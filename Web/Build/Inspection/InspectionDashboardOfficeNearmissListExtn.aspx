<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDashboardOfficeNearmissListExtn.aspx.cs"
    Inherits="InspectionDashboardOfficeNearmissListExtn" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvInspectionIncidentSearch" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Type" AllowFiltering="false" ShowFilterIcon="false" UniqueName="FLDISINCIDENTORNEARMISS" DataField="FLDISINCIDENTORNEARMISS" AutoPostBackOnFilter="true">
                            <%--<FilterTemplate>
