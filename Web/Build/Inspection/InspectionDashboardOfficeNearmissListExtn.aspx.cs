...
public partial class InspectionDashboardOfficeNearmissListExtn : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashboardOfficeNearmissListExtn.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashboardOfficeNearmissListExtn.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixInspectionOfficeDashboard.InspectionOfficeDashboardIncidentnearmissSearch(
            ...
            ref iRowCount,
            ref iTotalPageCount
            , 2//General.GetNullableInteger(Dashboardnvc != null ? Dashboardnvc["ddlIncidentNearmiss"] : "1")
    ...
    private void BindData()
    {
        try
        {
            ...
            string SS = Dashboardnvc != null ? General.GetNullableString(Dashboardnvc.Get("ucStatus")) : General.GetNullableString(ViewState["Status"].ToString());
    ...
    {
        DataSet dt = new DataSet();
        dt = PhoenixInspectionIncidentNearMissCategory.ListIncidentNearMissCategory(2);
