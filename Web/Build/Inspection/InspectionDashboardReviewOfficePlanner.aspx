<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDashboardReviewOfficePlanner.aspx.cs" Inherits="InspectionDashboardReviewOfficePlanner" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("#gvPlanner").height(browserHeight - 100);
            });
        </script>
...
<%--        <eluc:TabStrip ID="MenuGeneral" runat="server" TabStrip="true" OnTabStripCommand="MenuGeneral_TabStripCommand"></eluc:TabStrip>--%>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvPlanner" runat="server" AutoGenerateColumns="False" Height="89%" Font-Size="11px" AllowPaging="true" AllowCustomPaging="true"
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="65px" HeaderText="Category" Visible="false">
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Last Done" HeaderStyle-Width="150px">
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="150px" HeaderText="Due">
                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="80px"></ItemStyle>
                        <HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Planned" HeaderStyle-Width="80px">
                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="80px"></ItemStyle>
                        <HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Attending Supt" HeaderStyle-Width="120px">
                    ...
                    <telerik:GridTemplateColumn HeaderText="External Auditor" HeaderStyle-Width="110px">
                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="80px"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Organization" HeaderStyle-Width="83px" Visible="false">
