...
public partial class InspectionDashboardReviewOfficePlanner : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashboardReviewOfficePlanner.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvPlanner')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('Filter','', '" + Session["sitepath"] + "/Inspection/InspectionDashboardReviewOfficePlannerFilter.aspx')", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashboardReviewOfficePlanner.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
            MenuScheduleGroup.AccessRights = this.ViewState;
            MenuScheduleGroup.MenuList = toolbar.Show();

            if (!IsPostBack)
            {
                InspectionFilter.CurrentAuditInspectionSchedulrOfficeDashboardFilter = null;
    ...
    protected void ShowExcel()
    {
        ...
        NameValueCollection Dashboardnvc = InspectionFilter.CurrentAuditInspectionSchedulrOfficeDashboardFilter;

        ds = PhoenixInspectionOfficeDashboard.DashboardOfficeAuditPlannerSearch(General.GetNullableString(ViewState["STATUS"].ToString())
