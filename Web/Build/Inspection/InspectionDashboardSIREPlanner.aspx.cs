...
public partial class InspectionDashboardSIREPlanner : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashboardSIREPlanner.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvScheduleForCompany')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('Filter','', '" + Session["sitepath"] + "/Inspection/InspectionDashboardSIREPlannerFilter.aspx')", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
            toolbar.AddFontAwesomeButton("../Inspection/InspectionDashboardSIREPlanner.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
            ...
            if (!IsPostBack)
            {
                InspectionFilter.CurrentVettingSIREDashboardFilter = null;
    ...
    {
        gvScheduleForCompany.SelectedIndexes.Clear();
        gvScheduleForCompany.EditIndexes.Clear();
        gvScheduleForCompany.DataSource = null;
    ...
    protected void ShowExcel()
    {
        ...
        NameValueCollection Dashboardnvc = InspectionFilter.CurrentVettingSIREDashboardFilter;

        ds = PhoenixInspectionOfficeDashboard.DashboardVettingSearch(General.GetNullableString(ViewState["VESSELID"].ToString() != string.Empty ? ViewState["VESSELID"].ToString() : (Dashboardnvc != null ? Dashboardnvc["VesselList"] : null))
                      ...
                      , ref iRowCount
                      , ref iTotalPageCount
                      , General.GetNullableGuid(Dashboardnvc != null ? Dashboardnvc["ucVetting"] : null)
                      , General.GetNullableInteger(Dashboardnvc != null ? Dashboardnvc["ucPort"] : null)
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixInspectionOfficeDashboard.DashboardVettingSearch(General.GetNullableString(ViewState["VESSELID"].ToString() != string.Empty ? ViewState["VESSELID"].ToString() : (Dashboardnvc != null ? Dashboardnvc["VesselList"] : null))
                      , General.GetNullableString(ViewState["VESSELID"].ToString() != string.Empty ? null : (Dashboardnvc != null ? Dashboardnvc["VesselTypeList"] : null))
                      , General.GetNullableString(ViewState["VESSELID"].ToString() != string.Empty ? null : (Dashboardnvc != null ? Dashboardnvc["FleetList"] : null))
                      , General.GetNullableInteger(ViewState["VESSELID"].ToString() != string.Empty ? null : (Dashboardnvc != null ? Dashboardnvc["Owner"] : null))
                      , General.GetNullableString(ViewState["STATUS"].ToString())
            ...
            if (e.Item is GridDataItem)
            {
                ...
                if (lblDueDate != null)
                {
                    if (imgFlag != null && dv["FLDSIREDUE"].ToString().Equals("1"))
                    {
                        ...
                        //e.Item.Cells[9].Attributes.Add("style", "background-color:#00FF00;font-weight:bold;");
                    }
                    else if (imgFlag != null && dv["FLDSIREDUE"].ToString().Equals("2"))
                    {
                        lblDueDate.Attributes["style"] = "color:darkorange !important";
                        lblDueDate.Font.Bold = true;
                        //e.Item.Cells[9].Attributes.Add("style", "background-color:#FFFF00;font-weight:bold;");
                    }
                    else if (imgFlag != null && dv["FLDSIREDUE"].ToString().Equals("3"))
                    {
                        lblDueDate.Attributes["style"] = "color:Red !important";
                        lblDueDate.Font.Bold = true;
                        //e.Item.Cells[9].Attributes.Add("style", "background-color:#FF0000;font-weight:bold;");
                    }
                    else
                    {
