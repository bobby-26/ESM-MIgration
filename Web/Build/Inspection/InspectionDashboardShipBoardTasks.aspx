<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDashboardShipBoardTasks.aspx.cs" Inherits="InspectionDashboardShipBoardTasks" %>
...
<body>
    <form id="frmRegistersBudgetBillingList" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvShipBoardTasks" Height="94%" runat="server" AllowMultiRowSelection="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Source Ref.No" HeaderStyle-Width="98px" AllowSorting="true" SortExpression="FLDTASKID" ShowSortIcon="true">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Type" HeaderStyle-Width="52px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Department" HeaderStyle-Width="105px">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Item" HeaderStyle-Width="106px">
                            <ItemStyle Wrap="true" HorizontalAlign="Left" Width="10%"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Details" HeaderStyle-Width="106px">
                            <ItemStyle Wrap="true" HorizontalAlign="Left" Width="10%"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Task" HeaderStyle-Width="118px">
                            <ItemStyle Wrap="true" HorizontalAlign="Left" Width="10%"></ItemStyle>
                            <ItemTemplate>
