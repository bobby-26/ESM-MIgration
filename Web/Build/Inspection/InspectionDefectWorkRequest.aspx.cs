...
public partial class Inspection_InspectionDefectWorkRequest : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        SessionUtil.PageAccessRights(this.ViewState);
        PhoenixToolbar toolbar = new PhoenixToolbar();
        toolbar.AddFontAwesomeButton("../Inspection/InspectionDefectWorkRequest.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
        ...
        if (!IsPostBack)
        {
            ...
            {
                ViewState["REVIEWDNC"] = Request.QueryString["OBSID"].ToString();
            }
