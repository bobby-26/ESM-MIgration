<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDeficiencyCARList.aspx.cs" Inherits="InspectionDeficiencyCARList" %>
...
<body>
    <form id="frmInspectionIncidentCriticalFactor" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <br />
            <telerik:RadLabel ID="lblCorrectiveAction" runat="server" Text="Corrective Action" Font-Bold="true" Font-Underline="true" ></telerik:RadLabel>
            <telerik:RadGrid ID="gvCorrectiveAction" runat="server" Height="35%" AutoGenerateColumns="False" AllowCustomPaging="false" AllowSorting="true" AllowPaging="false"
                ...
                CellSpacing="0" GridLines="None" EnableHeaderContextMenu="true" GroupingEnabled="false" Width="100%">
            ...
            <br />
            <telerik:RadLabel ID="lblPreventiveAction" runat="server" Text="Preventive Action" Font-Bold="true" Font-Underline="true"></telerik:RadLabel>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                            <ItemTemplate>
                                <asp:LinkButton AlternateText="Edit" ID="cmdParEdit"
                                    runat="server" CommandName="PAREDIT" ToolTip="Task">
                                    <span class="icon"><i class="fas fa-book"></i></span>
                                </asp:LinkButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
