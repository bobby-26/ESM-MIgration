...
public partial class InspectionDeficiencyList : PhoenixBasePage
{
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            {
                ds = PhoenixInspectionDeficiency.DeficiencySearch
                     (General.GetNullableInteger(nvc != null ? (nvc["ucDefeciencyType"] == "0" ? null : nvc["ucDefeciencyType"].ToString()) : null),
                      ...
                      ref iRowCount,
                      ref iTotalPageCount,
                      General.GetNullableInteger(nvc != null ? nvc["ucVessel"] : null),
                     ...
                     General.GetNullableInteger(nvc != null ? nvc["chkOfficeAuditDeficiencies"] : null),
            ...
            {
                ds = PhoenixInspectionDeficiency.ShipboardDeficiencySearch
                     (General.GetNullableInteger(nvc != null ? (nvc["ucDefeciencyType"] == "0" ? null : nvc["ucDefeciencyType"].ToString()) : null),
                      sortexpression,
                      sortdirection,
                      1,
    ...
    protected void ExportDeficiency()
    {
        try
        {
            ...
            ds = PhoenixInspectionDeficiency.DeficiencyDetailSearch
                 (General.GetNullableInteger(nvc != null ? (nvc["ucDefeciencyType"] == "0" ? null : nvc["ucDefeciencyType"].ToString()) : null),
                  sortexpression,
                  sortdirection,
            ...
            General.ShowExcel("Deficiency Details", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
        }
        catch (Exception ex)
        {
            ucError.ErrorMessage = ex.Message;
        ...
        try
        {
            if (e.Item is GridDataItem)
            {
                ...
                if (drv["FLDOVERDUEYN"].ToString().Equals("1"))
                {
                    ...
                    IssuedDate.Attributes["style"] = "color:Red !important";
                    IssuedDate.Font.Bold = true;
                }
                else if (drv["FLDOVERDUEYN"].ToString().Equals("2"))
                {
                    //IssuedDate.BackColor = System.Drawing.Color.darkorange;
                    //IssuedDate.Attributes.Add("style", "font-weight:bold;");
                    IssuedDate.ToolTip = "Overdue for Closure";
                    IssuedDate.Attributes["style"] = "color:darkorange !important";
                    IssuedDate.Font.Bold = true;
                }
                else if (drv["FLDOVERDUEYN"].ToString().Equals("3"))
                {
                    //IssuedDate.BackColor = System.Drawing.Color.mediumpurple;
                    //IssuedDate.Attributes.Add("style", "font-weight:bold;");
                    IssuedDate.ToolTip = "Postponed";
                    IssuedDate.Attributes["style"] = "color:darkviolet !important";
                    IssuedDate.Font.Bold = true;
                }
