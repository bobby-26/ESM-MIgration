<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDirectIncidentList.aspx.cs" MaintainScrollPositionOnPostback="true"
    Inherits="InspectionDirectIncidentList" %>
...
<body>
    <form id="frmRegistersInspection" runat="server" submitdisabledcontrols="true">
        ...
        <%--  <asp:GridView ID="gvDirectIncident" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                    Width="100%" CellPadding="3" OnRowCommand="gvDirectIncident_RowCommand" OnRowDataBound="gvDirectIncident_ItemDataBound"
                    OnRowCreated="gvDirectIncident_RowCreated" ShowFooter="false" ShowHeader="true"
                    OnRowEditing="gvDirectIncident_RowEditing" EnableViewState="false" AllowSorting="true"
                    OnSelectedIndexChanging="gvDirectIncident_SelectedIndexChanging" OnSorting="gvDirectIncident_Sorting"
                    DataKeyNames="FLDDIRECTINCIDENTID" GridLines="None">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvDirectIncident" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            CellSpacing="0" GridLines="None" OnNeedDataSource="gvDirectIncident_NeedDataSource" Width="100%"
            OnSortCommand="gvDirectIncident_SortCommand"
            OnItemCommand="gvDirectIncident_ItemCommand"
            OnItemDataBound="gvDirectIncident_ItemDataBound"
