<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDirectNCWorkRequest.aspx.cs"
    Inherits="InspectionDirectNCWorkRequest" %>
    ...
    <form id="frmWorkOrderRequisition" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                <tr>
                    ...
                    <td>
                        ...
                        <telerik:RadTextBox ID="txtWorkOrderNumber" runat="server" Enabled="false" Width="120px"></telerik:RadTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadLabel ID="lblMaintenanceType" runat="server">Maintenance Type</telerik:RadLabel>
                    </td>
                    <td>
            ...
            <telerik:RadGrid ID="gvWorkOrder" runat="server" AutoGenerateColumns="False" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" Width="100%" Height="42%" CellPadding="3" ShowHeader="true" EnableViewState="false" EnableHeaderContextMenu="true" GroupingEnabled="false" 
                OnNeedDataSource="gvWorkOrder_NeedDataSource" OnSortCommand="gvWorkOrder_SortCommand" OnItemCommand="gvWorkOrder_ItemCommand">
