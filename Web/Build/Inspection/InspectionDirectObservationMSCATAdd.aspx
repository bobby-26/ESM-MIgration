<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDirectObservationMSCATAdd.aspx.cs" Inherits="InspectionDirectObservationMSCATAdd" %>
...
<body>
    <form id="frmMSCATAdd" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            <eluc:TabStrip ID="MenuMSCAT" runat="server" OnTabStripCommand="MenuMSCAT_TabStripCommand" Title="Add" />
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
            <table id="tblCauseSearch" width="99.6%">
                <tr>
                    <td></td>
                    <td>
            ...
            <table id="tblCauseList" width="99.6%" cellpadding="0" cellspacing="0" border="1">
                ...
                <tr>
                    <td width="35%" align="left">
                        ...
                        <br />
                        <asp:Literal ID="lblRemarks1" runat="server" Text="Remarks"></asp:Literal><br />
