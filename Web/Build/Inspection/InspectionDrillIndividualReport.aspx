<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDrillIndividualReport.aspx.cs" Inherits="Registers_Individualdrillreport" %>
...
<head runat="server">
    <title>Individual Drill Log</title>
        ...
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvindvdrillreport.ClientID %>"));
                }, 200);
           }
...
<body>
    ...
    <telerik:RadAjaxLoadingPanel runat="server" ID="RadAjaxLoadingPanel1" />
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
          <eluc:TabStrip ID="Tabstripdrillreportmenu" runat="server" OnTabStripCommand="drillreport_TabStripCommand"
        TabStrip="true"></eluc:TabStrip>
<telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvindvdrillreport" 
            AutoGenerateColumns="false" AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvindvdrillreport_NeedDataSource"
    OnItemDataBound="gvindvdrillreport_ItemDataBound"
           >
            <MasterTableView EditMode="InPlace"  AutoGenerateColumns="false" DataKeyNames="FLDDRILLSCHEDULEID" 
