<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDrillSchedule.aspx.cs" Inherits="Registers_DrillSchedule" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <%--<script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvDrillSchedulelist.ClientID %>"));
               }, 200);
           }
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server"
            DecorationZoneID="gvDrillSchedulelist,table1" DecoratedControls="All" EnableRoundedCorners="true" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="90%">
            <eluc:TabStrip ID="Tabstripdrillschedule" runat="server" OnTabStripCommand="drillschedule_TabStripCommand" TabStrip="true"></eluc:TabStrip>
            ...
            <eluc:TabStrip ID="TabstripMenu" runat="server" OnTabStripCommand="drillschedule_TabStripMenuCommand"></eluc:TabStrip>
            <asp:Button ID="cmdHiddenSubmit" runat="server" Text="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" CssClass="hidden" />
            <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvDrillSchedulelist" EnableLinqExpressions="false" EnableViewState="true" AllowFilteringByColumn="true"
                AutoGenerateColumns="false" AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvDrillSchedulelist_NeedDataSource" GroupingEnabled="false" EnableHeaderContextMenu="true" OnSortCommand="gvDrillSchedulelist_Sort"
                OnItemDataBound="gvDrillSchedulelist_ItemDataBound" AllowSorting="true" Height="88%">
                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                <MasterTableView EditMode="InPlace" DataKeyNames="FLDDRILLSCHEDULEID" AutoGenerateColumns="false" EnableColumnsViewState="false" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Title" DataField="FLDDRILLNAME" UniqueName="FLDDRILLNAME" FilterControlWidth="120px" FilterDelay="2000"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Due" AllowFiltering="false" AllowSorting="true" ShowSortIcon="true" SortExpression="FLDDRILLDUEDATE">
                            <HeaderStyle HorizontalAlign="Center" Width="78px" Font-Bold="true" />
                        ...
                        <telerik:GridTemplateColumn HeaderText="Last Done" AllowFiltering="false" AllowSorting="true" ShowSortIcon="true" SortExpression="FLDDRILLLASTDONEDATE">
                            <HeaderStyle HorizontalAlign="Center" Width="158px" Font-Bold="true" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="RadlblLastdonedate" runat="server" Text='<%#  General.GetDateTimeToString((DataBinder.Eval(Container, "DataItem.FLDDRILLLASTDONEDATE")).ToString())%>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
            ...
            <table cellpadding="1" cellspacing="1">
                <tr>
                    ...
                    <td>
                        <telerik:RadLabel ID="lbldrillyettosubmit" runat="server" Text="* Drill Yet to Confirmed"></telerik:RadLabel>
                    </td>
                    <td>
                        <span class="icon"><i class="fas fa-star-red"></i></span>
                    </td>
                    <td>
                        <telerik:RadLabel ID="lbldrilloverdue" runat="server" Text="* Drill Over Due"></telerik:RadLabel>
                    </td>
                </tr>
            </table>
