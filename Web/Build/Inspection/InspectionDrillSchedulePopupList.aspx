<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDrillSchedulePopupList.aspx.cs" Inherits="Inspection_InspectionDrillSchedulePopupList" %>
...
<head runat="server">
    <title> Drill Due across Vessels</title>
...
<body>
    ...
    <telerik:RadAjaxLoadingPanel runat="server" ID="RadAjaxLoadingPanel1" />
         ...
         <eluc:TabStrip ID="TabstripMenu" runat="server" OnTabStripCommand="drillschedule_TabStripMenuCommand" TabStrip="true">
            </eluc:TabStrip>
        <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
   <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvDrillSchedulelist" Height="93%"
            AutoGenerateColumns="false" AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvDrillSchedulelist_NeedDataSource"
            OnItemDataBound="gvDrillSchedulelist_ItemDataBound">
