<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDrillScheduleReport.aspx.cs" Inherits="Inspection_InspectionDrillScheduleReport" %>
        ...
        <div style="margin-left: 0px">
            ...
            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal" Height="600px">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadLabel ID="RadLabel2" runat="server" Text="On Save, next due date is not calculated and the Drill will be shown as overdue if due date is passed." ForeColor="Blue"></telerik:RadLabel>
                    ...
                    <td>
                        <telerik:RadLabel ID="RadLabel6" runat="server" Text="Click on Confirm to Submit the drill and generate the next due date." ForeColor="Blue"></telerik:RadLabel>
                        
                    </td>
                </tr>
            </table>
           
                    <eluc:TabStrip ID="Tabstripdrillschedulereportmenu" runat="server" OnTabStripCommand="drillschedulereportmenu_TabStripCommand"
                        TabStrip="true" />
                    <br />
                    <table style="margin-left: 20px; text-wrap: normal;" id="reportform">
                        <tr>
                            <td>
                                <telerik:RadLabel runat="server" Text="Drill" />

                            </td>
                            <th>&nbsp &nbsp &nbsp</th>
                            <td>
                                <telerik:RadLabel runat="server" ID="radlbldrilname" />
                            </td>
