<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionDrillVesseltypelist.aspx.cs" Inherits="Registers_vesseltypelist" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvvesseltypelist.ClientID %>"));
                }, 200);
           }
