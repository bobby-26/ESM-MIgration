<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionIncidentDamageList.aspx.cs" Inherits="InspectionIncidentDamageList" %>
        ...
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                ...
                <div id="divGrid" style="position: relative; z-index: 0; width: 100%;">
                    <asp:GridView ID="gvIncidentDamage" runat="server" AutoGenerateColumns="False"
                        ...
                        ShowFooter="false" ShowHeader="true" EnableViewState="false" DataKeyNames="FLDINSPECTIONINCIDENTDAMAGEID">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblTypeOfDamage" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDTYPEOFDAMAGENAME" ) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                   <asp:Label ID="lblEstimatedCostHeader" runat="server">Estimated Cost&nbsp;</asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
