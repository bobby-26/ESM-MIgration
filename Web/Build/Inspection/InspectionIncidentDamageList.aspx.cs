...
public partial class InspectionIncidentDamageList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {           
            if (!IsPostBack)
            {
                ...
                toolbar.AddImageButton("../Inspection/InspectionIncidentDamageList.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void IncidentGeneral_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Filter.CurrentIncidentTab = "CAUSE";
        ...
        {
            Filter.CurrentIncidentTab = "ACTION";
            Response.Redirect("../Inspection/InspectionIncidentList.aspx?selectTab=ACTION", true);
        }
    ...
    protected void IncidentReportGeneral_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (dce.CommandName.ToUpper().Equals("PROPERTYDAMAGE"))
        {
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDCOMPONENTNAME", "FLDTYPEOFDAMAGENAME", "FLDESTIMATEDCOST" };
        string[] alCaptions = { "Component Name", "Type of Damage", "Estimated Cost in USD" };
        ...
        DataSet ds = PhoenixInspectionIncidentDamage.IncidentDamageSearch(
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=IncidentDamageList.xls");
        Response.ContentType = "application/vnd.msexcel";
        Response.Write("<TABLE BORDER='0' CELLPADDING='2' CELLSPACING='0' width='100%'>");
        Response.Write("<tr>");
        Response.Write("<td><img src='http://" + Request.Url.Authority + Session["images"] + "/esmlogo4_small.png" + "' /></td>");
        Response.Write("<td><h3>Incident Damage List</h3></td>");
    ...
    private void BindData()
    {
        ...
        General.SetPrintOptions("gvIncidentDamage", "Incident Damage List", alCaptions, alColumns, ds);
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (ViewState["DAMAGEID"] == null)
            {
                ...
                ViewState["DAMAGEID"] = ((Label)gvIncidentDamage.Rows[0].FindControl("lblIncidentDamageId")).Text;
            }

            if (ViewState["PAGEURL"] == null)
            {
                ViewState["PAGEURL"] = "../Inspection/InspectionIncidentDamageGeneral.aspx";
                ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?damageid=" + ViewState["DAMAGEID"].ToString();
            }
            else
            {
                ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?damageid=" + ViewState["DAMAGEID"].ToString();
        ...
        else
        {
            ...
            ViewState["PAGEURL"] = "../Inspection/InspectionIncidentDamageGeneral.aspx";
            ifMoreInfo.Attributes["src"] = "../Inspection/InspectionIncidentDamageGeneral.aspx";
        }
    ...
    protected void gvIncidentDamage_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                ViewState["DAMAGEID"] = ((Label)_gridView.Rows[nCurrentRow].FindControl("lblIncidentDamageId")).Text;

                BindPageURL(nCurrentRow);
            }
            if (e.CommandName.ToUpper().Equals("DELETE"))
            {
                string inspectionincidentid = ((Label)_gridView.Rows[nCurrentRow].FindControl("lblIncidentDamageId")).Text;
                ViewState["DAMAGEID"] = null;
                DeleteIncidentDamage(inspectionincidentid);
            }
            else
            {
    ...
    private void SetRowSelection()
    {
        ...
        {
            if (gvIncidentDamage.DataKeys[i].Value.ToString().Equals(ViewState["DAMAGEID"].ToString()))
            {
                gvIncidentDamage.SelectedIndex = i;
                ViewState["DAMAGEID"] = ((Label)gvIncidentDamage.Rows[i].FindControl("lblIncidentDamageId")).Text;
                break;
            }
        }
    }
    ...
    private void BindPageURL(int rowindex)
    {
        try
        {
            ViewState["DAMAGEID"] = ((Label)gvIncidentDamage.Rows[rowindex].FindControl("lblIncidentDamageId")).Text;
    ...
    private void DeleteIncidentDamage(string incidentdamageid)
    {
        PhoenixInspectionIncidentDamage.DeleteIncidentDamage(
            PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            new Guid(incidentdamageid));
    }
