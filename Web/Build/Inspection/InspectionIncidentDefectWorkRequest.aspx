<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionIncidentDefectWorkRequest.aspx.cs" Inherits="Inspection_InspectionIncidentDefectWorkRequest" %>
                ...
                <table width="100%" runat="server" id="tbsec1">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:ImageButton ID="ImgLink" runat="server" ImageUrl="~/css/Theme1/images/add_task.png" OnClick="ImgLink_Click" />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <td valign="Left" width="20%">
                            <telerik:RadLabel runat="server" ID="RadLabel1" Text="Include"></telerik:RadLabel>
                        </td>
                        <td>
                            <div style="height: 100px; width: 85%; overflow: auto;" class="input">
