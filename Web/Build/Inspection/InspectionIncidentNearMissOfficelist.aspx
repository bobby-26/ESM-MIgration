<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionIncidentNearMissOfficelist.aspx.cs" Inherits="InspectionIncidentNearMissOfficelist" %>
...
<head id="Head1" runat="server">
    <title>Inspection Incident List</title>
...
<body>
    <form id="frmInspectionIncidentSearch" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid ID="gvInspectionIncidentSearch" Height="87%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                OnItemDataBound="gvInspectionIncidentSearch_ItemDataBound" ShowFooter="false" ShowHeader="true" EnableViewState="false" DataKeyNames="FLDINSPECTIONINCIDENTID"
                OnSortCommand="gvInspectionIncidentSearch_SortCommand" OnNeedDataSource="gvInspectionIncidentSearch_NeedDataSource" OnPreRender="gvInspectionIncidentSearch_PreRender">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Category" AllowSorting="true" SortExpression="FLDCATEGORYNAME">
                            <HeaderStyle Width="8%" HorizontalAlign="Left" />
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Title">
                            ...
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblTitle" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDINCIDENTTITLE") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
