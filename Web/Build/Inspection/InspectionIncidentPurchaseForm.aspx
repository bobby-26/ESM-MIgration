<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionIncidentPurchaseForm.aspx.cs" Inherits="InspectionIncidentPurchaseForm" %>
    ...
    <form id="frmPurchaseForm" runat="server" autocomplete="off">
        ...
        <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
            ...
            <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                <eluc:TabStrip ID="MenuOrderForm" runat="server" OnTabStripCommand="MenuOrderForm_TabStripCommand" Title=""></eluc:TabStrip>
                <telerik:RadGrid ID="gvFormDetails" runat="server" AutoGenerateColumns="False" Font-Size="11px" OnNeedDataSource="gvFormDetails_NeedDataSource"
                    Width="100%" Height="75%" CellPadding="3" AllowCustomPaging="true" AllowPaging="true" OnItemCommand="gvFormDetails_ItemCommand" OnItemDataBound="gvFormDetails_ItemDataBound"
                    AllowSorting="true" ShowHeader="true" EnableHeaderContextMenu="true" GroupingEnabled="false" EnableViewState="false" OnSortCommand="gvFormDetails_SortCommand">
