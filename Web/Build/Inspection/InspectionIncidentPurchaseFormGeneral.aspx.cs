...
public partial class InspectionIncidentPurchaseFormGeneral : PhoenixBasePage
{
    ...
    private void BindData(string orderid)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            string a = Filter.CurrentInspectionPurchaseStockType.ToString();
            ...
            cmdDeliveryAddress.Attributes.Add("onclick", "javascript:openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionPurchaseFormAddress.aspx?addresscode=" + txtDeliveryAddressId.Text + "');return false;");
            cmdForwarderAddress.Attributes.Add("onclick", "javascript:openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionPurchaseFormAddress.aspx?addresscode=" + txtForwarderId.Text + "');return false;");
        }
    }
    ...
    protected void MenuFormGeneral_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Inspection/InspectionIncidentPurchaseFormType.aspx?");
            }
