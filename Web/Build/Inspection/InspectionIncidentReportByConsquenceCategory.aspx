<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionIncidentReportByConsquenceCategory.aspx.cs"
    Inherits="InspectionIncidentReportByConsquenceCategory" %>
...
<head runat="server">
    <title>Consequence Category</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        ...
                        <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
                            <eluc:TabStrip ID="MenuConsequenceTypeGeneral" runat="server" OnTabStripCommand="MenuConsequenceTypeGeneral_TabStripCommand"
                ...
                <table id="tblNC" width="60%" runat="server">
                    ...
                    <tr>
                        <td>
                            <asp:Literal ID="lblConsequenceType" runat="server" Text="Consequence <br/> Category"></asp:Literal>
                        </td>
                        <td>
                            <div id="divConsequenceType" runat="server" class="input_mandatory" style="overflow: auto;
                                height: 100px; width:150px"> &nbsp;<asp:CheckBox ID="chkConsequenceTypeAll" runat="server" AutoPostBack="true" OnCheckedChanged="chkConsequenceTypeAll_Changed"
                                    Text="---SELECT ALL---" />
                                <asp:CheckBoxList ID="chkConsequenceType" runat="server" RepeatColumns="2">
                                </asp:CheckBoxList>
                            </div>
                        </td>
                        <td colspan="2">
                ...
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuConsequenceType" runat="server" OnTabStripCommand="MenuConsequenceType_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="divGrid" style="position: relative; z-index: 0">
                    <asp:GridView ID="gvCC" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowDataBound="gvCC_ItemDataBound" ShowHeader="true"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <HeaderTemplate>
                                    <asp:Label ID="lblConsequenceHeader" runat="server">Category Wise Incident Statistics</asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblConsequence" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCONSEQUENCETYPENAME") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
