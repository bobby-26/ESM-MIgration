<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionIncidentReportByPartOfBodyInjury.aspx.cs"
    Inherits="InspectionIncidentReportByPartOfBodyInjury" %>
...
<head runat="server">
    <title>Part of the Body Injured</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        ...
                        <div class="navSelect" style="top: 0px; right: 0px; position: absolute;">
                            <eluc:TabStrip ID="MenuPartOfBodyInjuryGeneral" TabStrip="true" runat="server" OnTabStripCommand="MenuPartOfBodyInjuryGeneral_TabStripCommand" />
                        </div>
                    </div>
                </div>
                <table id="tblWI" width="60%" runat="server">
                    ...
                    <tr>
                        <td>
                            <asp:Literal ID="lblPartOfBodyInjury" runat="server" Text="Part Of the Body Injured"></asp:Literal>
                        </td>
                        <td style="width: 200px" colspan="3">
                            <div id="divPartOfBodyInjury" runat="server" class="input" style="overflow: auto;
                                height: 100px; width: 250px;">&nbsp;<asp:CheckBox ID="chkPartOfBodyInjuryAll" runat="server" AutoPostBack="true" OnCheckedChanged="chkPartOfBodyInjuryAll_Changed"
                                    Text="---SELECT ALL---" />
                                <asp:CheckBoxList ID="chkPartOfBodyInjury" runat="server" RepeatColumns="2">
                                </asp:CheckBoxList>
                            </div>
                        </td>
                    </tr>
                ...
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuPartOfBodyInjury" runat="server" OnTabStripCommand="MenuPartOfBodyInjury_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="divGrid" style="position: relative; z-index: 0">
                    <asp:GridView ID="gvBI" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowDataBound="gvBI_ItemDataBound" ShowHeader="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Label ID="lblPartOfBodyInjuryHeader" runat="server"> Part Of Body Injured</asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblPartOfBodyInjury" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPARTOFBODYINJURYNAME") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
