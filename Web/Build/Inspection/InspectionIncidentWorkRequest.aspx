<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionIncidentWorkRequest.aspx.cs"
    Inherits="InspectionIncidentWorkRequest" %>
...
<body>
    <form id="frmWorkOrderRequisition" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWorkOrderRequestion" runat="server" OnTabStripCommand="MenuWorkOrderRequestion_TabStripCommand" Title="Work Request"></eluc:TabStrip>
            <table cellpadding="1" cellspacing="1" width="100%">
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblNo" runat="server" Text="Number"></telerik:RadLabel>
                    </td>
                    <td>
                        ...
                        <telerik:RadTextBox ID="txtWorkOrderNumber" runat="server" CssClass="input" Enabled="false"></telerik:RadTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnPickListComponent">
                            ...
                            <telerik:RadTextBox ID="txtComponentName" runat="server" CssClass="input_mandatory" MaxLength="20"
                                Enabled="false" Width="212px"></telerik:RadTextBox>
                            <asp:LinkButton id="imgComponent" runat="server" style="cursor: pointer; vertical-align: top">
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtCreatedDate" runat="server" CssClass="input" Width="90px" Enabled="false"></telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <span id="spnPickListJob">
                            ...
                            <telerik:RadTextBox ID="txtJobName" runat="server" CssClass="input readonlytextbox" MaxLength="20"
                                ReadOnly="false" Width="212px"></telerik:RadTextBox>
                            <asp:LinkButton id="imgJob" runat="server" style="cursor: pointer; vertical-align: top">
                                <span class="icon"><i class="fas fas fa-tasks"></i></span>
                            </asp:LinkButton>
                            <telerik:RadTextBox ID="txtJobId" runat="server" CssClass="input" Width="10px"></telerik:RadTextBox>
                        </span>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblEsitmatedDuration" runat="server" Text="Estimated Duration(Hrs)"></telerik:RadLabel>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Date ID="txtPlannedStartDate" runat="server" CssClass="input_mandatory" MaxLength="20" />
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Quick ID="ucMainType" runat="server" CssClass="input" AppendDataBoundItems="true" Width="180px" />
                    </td>
                </tr>
            </table>
            <hr />
            <telerik:RadGrid ID="gvWorkOrder" runat="server" AutoGenerateColumns="False" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" Width="100%" Height="255px" CellPadding="3" ShowHeader="true" EnableViewState="false" EnableHeaderContextMenu="true" GroupingEnabled="false"
                OnSortCommand="gvWorkOrder_SortCommand" OnNeedDataSource="gvWorkOrder_NeedDataSource" OnItemCommand="gvWorkOrder_ItemCommand" >
                        ...
                        <telerik:GridTemplateColumn HeaderText="Work Order Title" AllowSorting="true" SortExpression="FLDWORKORDERNAME">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="lnkWorkorderName" runat="server" CommandName="Select" 
                                    Text=' <%#((DataRowView)Container.DataItem)["FLDWORKORDERNAME"]%>'></asp:LinkButton> <%--CommandArgument='<%# ((DataRowView)Container.DataItem)["FLDWORKORDERID"]%>'--%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
