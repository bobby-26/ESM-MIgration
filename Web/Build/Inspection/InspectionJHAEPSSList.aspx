<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionJHAEPSSList.aspx.cs" Inherits="InspectionJHAEPSSList" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <eluc:Title runat="server" ID="ucTitle" Visible="false"></eluc:Title>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns> 
                        <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-Width="95%">
                            <ItemStyle Wrap="true" HorizontalAlign="Left" Width="95%"></ItemStyle>
                            <ItemTemplate>            
