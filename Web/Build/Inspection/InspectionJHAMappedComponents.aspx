<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionJHAMappedComponents.aspx.cs" Inherits="InspectionJHAMappedComponents" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <div id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%; position: absolute;">
                <table border="0" style="width: 100%">
                    <tr id="trDocuments">
                        <td>
                            <div id="divComponents" runat="server" style="height: auto; overflow-y: auto; overflow-x: auto; width: 100%;">
