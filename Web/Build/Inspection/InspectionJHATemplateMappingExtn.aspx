<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionJHATemplateMappingExtn.aspx.cs" Inherits="InspectionJHATemplateMappingExtn" %>
                    ...
                    <tr>
                        ...
                        <td width="90%">
                            <telerik:RadComboBox ID="ddlCategory" runat="server" CssClass="input" AppendDataBoundItems="true"
                                ...
                                DataValueField="FLDCATEGORYID" Width="270px" EmptyMessage="Type to select Activity" Filter="Contains" MarkFirstMatch="true">
                            </telerik:RadComboBox>
                        </td>
                    </tr>
                    <tr>
