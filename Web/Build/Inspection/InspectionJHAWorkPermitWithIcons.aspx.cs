...
public partial class InspectionJHAWorkPermitWithIcons : PhoenixBasePage
{
    ...
    private void BindData()
    {
        ...
        {
            DataTable DT = PhoenixInspectionRiskAssessmentHazardExtn.ListJHAWorkPermitWithIcons(new Guid(ViewState["JHAID"].ToString()));

            gvRAMiscellaneous.DataSource = DT;
        }
        else
        {
            DataTable DT = PhoenixInspectionRiskAssessmentHazardExtn.ListProcessRAWorkPermitWithIcons(new Guid(ViewState["JHAID"].ToString()));
