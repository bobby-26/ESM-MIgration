<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionLongTermActionAttachment.aspx.cs" Inherits="InspectionLongTermActionAttachment" %>
...
<head id="Head1" runat="server">
    <title>Inspection Attachment</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        ...
                        <eluc:Title runat="server" id="ucTitle" Text="Attachments" ShowMenu="true"></eluc:Title>
                    </div>
                </div>
