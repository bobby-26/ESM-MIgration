...
public partial class InspectionMOCActionPlanShipboardTaskList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddFontAwesomeButton("../Inspection/InspectionMOCActionPlanShipboardTaskList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
        ...
        toolbar.AddFontAwesomeButton("../Inspection/InspectionMOCActionPlanShipboardTaskList.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixInspectionMOCActionPlan.MOCShipboardTaskSearch(PhoenixSecurityContext.CurrentSecurityContext.UserCode
