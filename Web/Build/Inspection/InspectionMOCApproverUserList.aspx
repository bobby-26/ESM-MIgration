<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMOCApproverUserList.aspx.cs" Inherits="InspectionMOCApproverUserList" %>
...
<body>
  ...
  <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <eluc:TabStrip ID="MenuUser" runat="server" OnTabStripCommand="MenuUser_TabStripCommand" Title="User">
            </eluc:TabStrip>
            ...
            <telerik:RadGrid ID="gvUser" runat="server" AutoGenerateColumns="False" AllowCustomPaging="true" 
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Username"   SortExpression="FLDUSERNAME"    AllowSorting="true">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lblUserName" runat="server" CommandName="EDIT" Text='<%# DataBinder.Eval(Container,"DataItem.FLDUSERNAME") %>'></asp:LinkButton>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
