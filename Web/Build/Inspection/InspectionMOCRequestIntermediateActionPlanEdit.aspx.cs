...
public partial class InspectionMOCRequestIntermediateActionPlanEdit : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["MOCINTERMEDIATEID"] != null && Request.QueryString["MOCINTERMEDIATEID"].ToString() != string.Empty)
    ...
    {
        if (ViewState["ACTIONPLANID"] != null && ViewState["ACTIONPLANID"].ToString() != "")
        {
    ...
    protected void MenuCARGeneral_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Inspection/InspectionMOCIntermediateVerificationAdd.aspx?&VESSELID=" + ViewState["VESSELID"].ToString() + "&MOCID=" + ViewState["MOCID"].ToString() + "&MOCINTERMEDIATEID=" + ViewState["MOCINTERMEDIATEID"].ToString());
            }
