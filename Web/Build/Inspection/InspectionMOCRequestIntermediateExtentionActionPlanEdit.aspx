<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMOCRequestIntermediateExtentionActionPlanEdit.aspx.cs"
            ...
            <tr id="actionplancrewedit" runat="server">
                ...
                <td>
                    <span id="spnPersonInChargeactionplanEdit">
                        ...
                        <telerik:RadTextBox ID="txtCrewIdEdit" runat="server" CssClass="input" MaxLength="20"
                            Width="0px">
                        </telerik:RadTextBox>
                    </span>
                </td>
            ...
            <tr id="actionplanofficeedit" runat="server">
                ...
                <td>
                    <span id="spnActionPlanPersonOfficeEdit">
                        <telerik:RadTextBox ID="txtPersonNameEdit" runat="server" CssClass="input" Enabled="false"
                            MaxLength="50" Width="20%">
                        </telerik:RadTextBox>
                        <telerik:RadTextBox ID="txtPersonRankEdit" runat="server" CssClass="input" Enabled="false"
                            MaxLength="50" Width="20%">
                        </telerik:RadTextBox>
