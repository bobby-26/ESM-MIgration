...
public partial class InspectionMOCRequestActionPlanEdit : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["MOCREQUESTID"] != null && Request.QueryString["MOCREQUESTID"].ToString() != string.Empty)
    ...
    protected void MenuCARGeneral_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Inspection/InspectionMOCIntermediateVerificationAdd.aspx?&VESSELID=" + ViewState["VESSELID"].ToString() + "&MOCREQUESTID=" + ViewState["MOCREQUESTID"].ToString() + "&MOCID=" + ViewState["MOCID"].ToString());
            }
            ...
            {
                if ((ViewState["ACTIONPLANID"] == null) || (ViewState["ACTIONPLANID"] == null))
