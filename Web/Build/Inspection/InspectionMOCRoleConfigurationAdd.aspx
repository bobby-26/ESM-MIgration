<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMOCRoleConfigurationAdd.aspx.cs" Inherits="InspectionMOCRoleConfigurationAdd" %>
...
<body>
    <form id="frmRegistersCountryAdd" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server"    Height="100%">
            ...
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
                    ...
                    <eluc:TabStrip ID="MenuMOCRoleConfigurationAdd" runat="server" TabStrip="true"    OnTabStripCommand="MenuMOCRoleConfigurationAdd_TabStripCommand">
                    </eluc:TabStrip>
                <br />
            <table >
             <tr>
