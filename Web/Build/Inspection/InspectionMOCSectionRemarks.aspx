<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMOCSectionRemarks.aspx.cs"
    Inherits="InspectionMOCSectionRemarks" %>
...
<head runat="server">
    <title>MOC Section Remarks</title>
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1"
        ...
        <table id="tblGeneric" runat="server" cellpadding="1" cellspacing="1" width="75%">
            <tr>
                <td>
                    <b>
                        <telerik:RadLabel ID="lblsupport" runat="server" Text="">
                        </telerik:RadLabel>
                    </b>
                </td>
                <td>
                    <asp:TextBox ID="txtSectionName" runat="server" CssClass="input" ReadOnly="true" Enabled="false"
