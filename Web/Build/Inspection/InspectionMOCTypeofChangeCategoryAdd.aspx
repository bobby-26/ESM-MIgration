<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMOCTypeofChangeCategoryAdd.aspx.cs"
    Inherits="InspectionMOCTypeofChangeCategoryAdd" %>
...
<body>
    <form id="frmRegistersCountry" runat="server">
        ...
        <telerik:radajaxpanel id="RadAjaxPanel1" runat="server" loadingpanelid="RadAjaxLoadingPanel1" height="100%">
            ...
            <eluc:TabStrip ID="MenuRegistersTypeofChangeCategoryAdd" runat="server" OnTabStripCommand="MenuRegistersTypeofChangeCategoryAdd_TabStripCommand"   TabStrip="true" />
            <br />
        <table runat="server" >
            <tr>
