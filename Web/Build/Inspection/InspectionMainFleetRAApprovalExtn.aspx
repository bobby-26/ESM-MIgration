<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMainFleetRAApprovalExtn.aspx.cs" Inherits="InspectionMainFleetRAApprovalExtn" %>
...
<body>
    ...
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <tr>
            <td colspan="2">
                <b><telerik:RadLabel ID="lblNote" runat="server" Text="* Note: Once the RA is Approved/Rejected, it cannot be edited."></telerik:RadLabel></b>
            </td>
        </tr>
        <tr>
            <td width="10%">
                <b><telerik:RadLabel ID="lblOfficeRemarks" runat="server" Text="Office Remarks"></telerik:RadLabel></b>
            </td>
            <td>
                <asp:TextBox ID="txtApprovalRemarks" runat="server" CssClass="input_mandatory" Height="70px" Rows="5"
