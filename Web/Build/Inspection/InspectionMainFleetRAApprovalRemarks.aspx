<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMainFleetRAApprovalRemarks.aspx.cs" Inherits="InspectionMainFleetRAApprovalRemarks" %>
...
<body>
    ...
    <table cellpadding="1" cellspacing="1" width="30%">
        ...
        <tr>
            <td colspan="2">
                <b><asp:Literal ID="lblOverrideReason" runat="server" Text="Override Reason"></asp:Literal></b>
            </td>
        </tr>
        <tr>
            <td colspan="2">
