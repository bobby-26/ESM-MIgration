...
public partial class InspectionMainFleetRAApprovalRemarksExtn : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        SessionUtil.PageAccessRights(this.ViewState);
        PhoenixToolbar toolbarmain = new PhoenixToolbar();
        toolbarmain.AddButton("Approve", "SAVE", ToolBarDirection.Right);
    ...
    protected void MenuApprovalRemarks_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["RATEMPLATEID"] != null && ViewState["RATEMPLATEID"] != null)
            {
                ...
                {
                    PhoenixInspectionRiskAssessment.ApproveMainFleetRAWithRemarksExtn(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
