<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMainFleetRAGenericListExtn.aspx.cs" Inherits="InspectionMainFleetRAGenericListExtn" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server" DecorationZoneID="gvRiskAssessmentGeneric" DecoratedControls="All" EnableRoundedCorners="true" />
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentGeneric" Height="74%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" EnableHeaderContextMenu="true" GroupingEnabled="false" ShowHeader="true" EnableViewState="false"
                OnItemDataBound="gvRiskAssessmentGeneric_ItemDataBound" OnItemCommand="gvRiskAssessmentGeneric_ItemCommand" OnNeedDataSource="gvRiskAssessmentGeneric_NeedDataSource">
