<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMainFleetRAMachineryList.aspx.cs" Inherits="InspectionMainFleetRAMachineryList" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("#gvRiskAssessmentMachinery").height(browserHeight - 40);
            });
        </script>
...
<body>
    <form id="form1" runat="server">
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="ddlCategory" runat="server" AppendDataBoundItems="true"
                        EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true" AutoPostBack="True" DataTextField="FLDNAME" DataValueField="FLDACTIVITYID" Width="240px">
                        <Items>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentMachinery" runat="server" AutoGenerateColumns="False" AllowSorting="true" AllowPaging="true" AllowCustomPaging="true"
            CellPadding="3" Height="78%" ShowHeader="true" EnableViewState="true" GroupingEnabled="false" EnableHeaderContextMenu="true"
            OnItemDataBound="gvRiskAssessmentMachinery_ItemDataBound" DataKeyNames="FLDRISKASSESSMENTMACHINERYID" OnNeedDataSource="gvRiskAssessmentMachinery_NeedDataSource"
            OnItemCommand="gvRiskAssessmentMachinery_ItemCommand" OnSortCommand="gvRiskAssessmentMachinery_SortCommand" GridLines="None">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Activity" HeaderStyle-Width="210px">
                        ...
                        <ItemTemplate>
                            ...
                            <eluc:ToolTip ID="ucWorkActivity" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDACTIVITYCONDITIONS") %>' Visible="false" TargetControlId="lblWorkActivity" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Status" HeaderStyle-Width="140px">
                        <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn Visible="false">
                        ...
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblApprovedBy" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDAPPROVEDBY").ToString().Length > 20 ? DataBinder.Eval(Container, "DataItem.FLDAPPROVEDBY").ToString().Substring(0, 20) + "..." : DataBinder.Eval(Container, "DataItem.FLDAPPROVEDBY").ToString() %>'></telerik:RadLabel>
                            <eluc:ToolTip ID="ucApprovedBy" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDAPPROVEDBY") %>' Visible="false" TargetControlId="lblApprovedBy" />
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="230px" HeaderText="Action">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton runat="server" AlternateText="Machinery PDF" CommandName="RAMACHINERY"
                                ID="cmdRAMachinery" ToolTip="Show PDF">
