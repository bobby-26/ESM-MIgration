<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMainFleetRAMachineryListExtn.aspx.cs" Inherits="InspectionMainFleetRAMachineryListExtn" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="ddlRAType" runat="server" Width="270px" EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true">
                        </telerik:RadComboBox>
                    </td>
                    <td>
            ...
            <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server" DecorationZoneID="gvRiskAssessmentMachinery" DecoratedControls="All" EnableRoundedCorners="true" />
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentMachinery" Height="74%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" EnableHeaderContextMenu="true" GroupingEnabled="false" ShowHeader="true" EnableViewState="true"
                OnItemDataBound="gvRiskAssessmentMachinery_ItemDataBound" OnItemCommand="gvRiskAssessmentMachinery_ItemCommand" OnNeedDataSource="gvRiskAssessmentMachinery_NeedDataSource">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Intended <br>Work" HeaderStyle-Width="11%" AllowSorting="true" SortExpression="FLDINTENDEDWORKDATE" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-Width="11%">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:LinkButton runat="server" AlternateText="Report" CommandName="RAMACHINERY" ID="cmdRAMachinery" ToolTip="Show PDF">
