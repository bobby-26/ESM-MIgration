<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMainFleetRANavigationList.aspx.cs" Inherits="InspectionMainFleetRANavigationList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentNavigation" runat="server" AutoGenerateColumns="False" AllowPaging="true" AllowCustomPaging="true"
            Font-Size="11px" Width="100%" Height="78%" CellPadding="3" ShowHeader="true" EnableViewState="true" AllowSorting="true" GroupingEnabled="false" EnableHeaderContextMenu="true"
            ...
            OnItemCommand="gvRiskAssessmentNavigation_ItemCommand" OnSortCommand="gvRiskAssessmentNavigation_SortCommand" GridLines="None">
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    <telerik:GridTemplateColumn HeaderStyle-Width="34px">
                    ...
                    <telerik:GridTemplateColumn HeaderText="Activity" HeaderStyle-Width="280px">
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="220px" HeaderText="Action">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton runat="server" AlternateText="Machinery PDF" CommandName="RAMACHINERY"
                                ID="cmdRANavigation" ToolTip="Show PDF">
