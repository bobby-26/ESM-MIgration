<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMainFleetRANavigationListExtn.aspx.cs" Inherits="InspectionMainFleetRANavigationListExtn" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server" DecorationZoneID="gvRiskAssessmentNavigation" DecoratedControls="All" EnableRoundedCorners="true" />
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentNavigation" Height="74%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-Width="14%">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:LinkButton runat="server" AlternateText="Report" CommandName="RAMACHINERY" ID="cmdRANavigation" ToolTip="Show PDF">
