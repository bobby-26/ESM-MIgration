<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionMainFleetRAProcessListExtn.aspx.cs" Inherits="InspectionMainFleetRAProcessListExtn" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentProcess" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Prepared" HeaderStyle-Width="7%" AllowFiltering="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Left" Width="7%"></ItemStyle>
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDDATE"]) %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Process" HeaderStyle-Width="15%" ShowFilterIcon="false" UniqueName="FLDTYPE">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Status" HeaderStyle-Width="10%" ShowFilterIcon="false" UniqueName="FLDSTATUS" FilterControlWidth="99%">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Rev No" HeaderStyle-Width="3%" AllowFiltering="false">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Approved" HeaderStyle-Width="7%" AllowFiltering="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Left" Width="7%"></ItemStyle>
                            <ItemTemplate>
                                <%# General.GetDateTimeToString(((DataRowView)Container.DataItem)["FLDISSUEDDATE"])%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="H&S" HeaderStyle-Width="3%" ColumnGroupName="Level of Residual Risk" HeaderStyle-Font-Size="XX-Small" AllowFiltering="false">
                        ...
                        <telerik:GridTemplateColumn HeaderText="ENV" HeaderStyle-Width="3%" ColumnGroupName="Level of Residual Risk" HeaderStyle-Font-Size="XX-Small" AllowFiltering="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Center" Width="3%"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblEnvironmental" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDENVSCORE")  %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="ECO" HeaderStyle-Width="3%" ColumnGroupName="Level of Residual Risk" HeaderStyle-Font-Size="XX-Small" AllowFiltering="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Center" Width="3%"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblEcononmic" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDECOSCORE")  %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="WCS" HeaderStyle-Width="3%" ColumnGroupName="Level of Residual Risk" HeaderStyle-Font-Size="XX-Small" AllowFiltering="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Center" Width="3%"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                            <ItemTemplate>
                                <asp:LinkButton runat="server" AlternateText="Approve" CommandName="APPROVE" ID="imgApprove" ToolTip="Approve" Width="16px">
                                ...
                                <asp:LinkButton runat="server" AlternateText="Process PDF" CommandName="REPORT" ID="cmdRAProcess" ToolTip="Show PDF" Width="16px">
                                ...
                                <asp:LinkButton runat="server" AlternateText="Copy RA to Company" CommandName="OFFICECOPY" ID="imgOfficeCopy" ToolTip="Copy RA to Company" Width="16px">
