...
public partial class InspectionMainFleetRAProcessListExtn : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddFontAwesomeButton("../Inspection/InspectionMainFleetRAProcessListExtn.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
        ...
        toolbar.AddFontAwesomeButton("../Inspection/InspectionMainFleetRAProcessListExtn.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
        if (PhoenixSecurityContext.CurrentSecurityContext.InstallCode.Equals(0))
        {
            toolbar.AddFontAwesomeButton("../Inspection/InspectionMainFleetRAProcessListExtn.aspx", "New Template", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
        }
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixInspectionRiskAssessmentProcessExtn.InspectionRiskAssessmentMainFleetProcessSearch(
    ...
    protected void gvRiskAssessmentProcess_ItemCommand(object sender, GridCommandEventArgs gce)
    {
        try
        {
            if (gce.CommandName.ToUpper().Equals("EDITROW"))
            {
                ...
                SetRowSelection();
                Response.Redirect("../Inspection/InspectionRAProcessExtn.aspx?processid=" + lbl.Text + "&status=" + lblstatus.Text, false);
            }
