<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionNonConformityReportByCategoryWiseAudit.aspx.cs"
    Inherits="InspectionNonConformityReportByCategoryWiseAudit" %>
...
<head runat="server">
    <title>CategoryWise NC </title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    <form id="frmCategoryWiseNCTrend" runat="server">
    <ajaxToolkit:ToolkitScriptManager CombineScripts="false" ID="ToolScriptManager1"
        runat="server">
    </ajaxToolkit:ToolkitScriptManager>
    <asp:UpdatePanel ID="pnlCategoryNC" runat="server">
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        ...
                        <div class="navSelect" style="top: 0px; right: 0px; position: absolute;">
                            <eluc:TabStrip ID="MenuCategoryWiseNCGeneral" TabStrip="true" runat="server" OnTabStripCommand="MenuCategoryWiseNCGeneral_TabStripCommand" />
                        </div>
                    </div>
                </div>
                ...
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuCategoryWiseNC" runat="server" OnTabStripCommand="MenuCategoryWiseNC_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="divGrid" style="position: relative; z-index: 0">
                    <asp:GridView ID="gvCNC" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowDataBound="gvCNC_ItemDataBound" ShowHeader="true"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <HeaderTemplate>
                                    <asp:Literal ID="lblAuditType" runat="server" Text="Category Name"></asp:Literal>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblAuditType" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCATEGORYNAME") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Literal ID="lblShortCode" runat="server" Text="ShortCode"></asp:Literal>
                                </HeaderTemplate>
                                <ItemTemplate>
