<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionNonConformityReportByYearWiseAudit.aspx.cs"
    Inherits="InspectionNonConformityReportByYearWiseAudit" %>
...
<head runat="server">
    <title>Yearwise NC Trend</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    ...
    <asp:UpdatePanel ID="pnlYrNC" runat="server">
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        ...
                        <div class="navSelect" style="top: 0px; right: 0px; position: absolute;">
                            <eluc:TabStrip ID="MenuYearWiseNCGeneral" TabStrip="true" runat="server" OnTabStripCommand="MenuYearWiseNCGeneral_TabStripCommand" />
                        </div>
                    </div>
                </div>
                <table id="tblWI" width="60%" runat="server">
                    ...
                    <tr>
                        <td>
                            <asp:Literal ID="lblAuditCategory" runat="server" Text="Audit"></asp:Literal>
                        </td>
                        <td colspan="3">
                ...
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuYearWiseNC" runat="server" OnTabStripCommand="MenuYearWiseNC_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                    ...
                    <asp:GridView ID="gvNC" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Literal ID="lblAuditType" runat="server" Text="Type of Audit"></asp:Literal>
                                </HeaderTemplate>
                                <ItemTemplate>
