<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionNonRoutineRACargoTemplate.aspx.cs" Inherits="Inspection_InspectionNonRoutineRACargoTemplate" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("#gvRiskAssessmentCargo").height(browserHeight - 90);
            });
        </script>
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvRiskAssessmentCargo.ClientID %>"));
                }, 200);
           }
...
<body onclick="document.getElementById('divContextLinks').style.display='none';">
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentCargo" runat="server" AutoGenerateColumns="False" AllowPaging="true" AllowCustomPaging="true"
                ...
                OnItemDataBound="gvRiskAssessmentCargo_ItemDataBound" DataKeyNames="FLDRISKASSESSMENTCARGOID" OnNeedDataSource="gvRiskAssessmentCargo_NeedDataSource"
                OnItemCommand="gvRiskAssessmentCargo_ItemCommand" GridLines="None">
