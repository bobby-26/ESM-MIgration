<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionNonRoutineRAGenericTemplate.aspx.cs" Inherits="Inspection_InspectionNonRoutineRAGenericTemplate" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvRiskAssessmentGeneric.ClientID %>"));
                }, 200);
           }
...
<body onclick="document.getElementById('divContextLinks').style.display='none';">
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentGeneric" runat="server" AutoGenerateColumns="False" AllowPaging="true" AllowCustomPaging="true"
                ...
                OnItemDataBound="gvRiskAssessmentGeneric_ItemDataBound" DataKeyNames="FLDRISKASSESSMENTGENERICID" OnNeedDataSource="gvRiskAssessmentGeneric_NeedDataSource"
                OnItemCommand="gvRiskAssessmentGeneric_ItemCommand" GridLines="None">
