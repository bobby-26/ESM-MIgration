<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionNonRoutineRATask.aspx.cs" Inherits="InspectionNonRoutineRATask" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#gvShipboardRATask").height(browserHeight - 150);
            });
        ...
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvShipboardRATask.ClientID %>"));
                }, 200);
           }
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <eluc:TabStrip ID="MenuShipBoardRATasks" runat="server" OnTabStripCommand="MenuShipBoardRATasks_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvShipboardRATask" runat="server" AllowCustomPaging="true"
                Font-Size="11px" AllowPaging="true" AllowSorting="true" OnNeedDataSource="gvShipboardRATask_NeedDataSource"
                CellPadding="3" OnItemCommand="gvShipboardRATask_ItemCommand" OnItemDataBound="gvShipboardRATask_ItemDataBound"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Vessel" HeaderStyle-Width="15%" AllowSorting="true" SortExpression="FLDVESSELNAME" ShowSortIcon="true" Visible="false">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Task" HeaderStyle-Width="50%">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Target Date" HeaderStyle-Width="20%">
