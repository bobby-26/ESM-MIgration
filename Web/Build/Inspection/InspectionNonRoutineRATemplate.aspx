<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionNonRoutineRATemplate.aspx.cs" Inherits="Inspection_InspectionNonRoutineRATemplate" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("#gvRiskAssessmentMachinery").height(browserHeight - 90);
            });
        </script>
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvRiskAssessmentMachinery.ClientID %>"));
                }, 200);
           }
...
<body onclick="document.getElementById('divContextLinks').style.display='none';">
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentMachinery" runat="server" AutoGenerateColumns="False" AllowPaging="true" AllowCustomPaging="true"
                ...
                OnItemCommand="gvRiskAssessmentMachinery_ItemCommand" GridLines="None">
