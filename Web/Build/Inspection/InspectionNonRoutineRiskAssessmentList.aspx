<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionNonRoutineRiskAssessmentList.aspx.cs" Inherits="InspectionNonRoutineRiskAssessmentList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <eluc:Title runat="server" ID="ucTitle" Text="Non Routine RA" ShowMenu="true" Visible="false" />
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessment" runat="server" AutoGenerateColumns="False" AllowSorting="true" AllowPaging="true" AllowCustomPaging="true"
            ...
            OnItemDataBound="gvRiskAssessment_ItemDataBound" DataKeyNames="FLDRISKASSESSMENTID" OnNeedDataSource="gvRiskAssessment_NeedDataSource"
            OnItemCommand="gvRiskAssessment_ItemCommand" OnSortCommand="gvRiskAssessment_SortCommand" GridLines="None">
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Type" HeaderStyle-Width="110px">
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Activity" HeaderStyle-Width="220px">
                        <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
