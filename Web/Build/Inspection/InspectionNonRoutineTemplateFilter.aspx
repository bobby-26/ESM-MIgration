<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionNonRoutineTemplateFilter.aspx.cs" Inherits="Inspection_InspectionNonRoutineTemplateFilter" %>
    ...
    <div class="subHeader" style="position: relative">
        <div id="divHeading" style="vertical-align: top">
            <%--<asp:Label runat="server" ID="lblCaption" Font-Bold="true" Text="Non Routine RA Filter"></asp:Label>--%>
             <eluc:Title runat="server" ID="ucTitle" Text="Standard Template" ShowMenu="true" />
        </div>
    </div>
        ...
        <ContentTemplate>
            <table cellpadding="1" cellspacing="1" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Literal ID="lblApprovedDate" runat="server" Text="Approved for Use"></asp:Literal>
                    </td>
                    <td>
                        <eluc:Date ID="ucDateApprovedFrom" runat="server" CssClass="input" />
                        &nbsp;-&nbsp;
                        <eluc:Date ID="ucDateApprovedTo" runat="server" CssClass="input" />
                    </td>
                </tr>
            </table>
