<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionObservationCorrectiveAction.aspx.cs"
    Inherits="InspectionObservationCorrectiveAction" %>
...
<body>
    <form id="frmInspectionDirectNonConformityCauseAnalysis" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid ID="gvCorrectiveAction" Height="38%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            ...
            <telerik:RadGrid ID="gvPreventiveAction" Height="38%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Control Action">
                            <HeaderStyle Width="10%" HorizontalAlign="Left" />
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
