...
public partial class InspectionOfficeDashboardShipBoardTasksList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddFontAwesomeButton("../Inspection/InspectionOfficeDashboardShipBoardTasksList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
        ...
        toolbar.AddFontAwesomeButton("../Inspection/InspectionOfficeDashboardShipBoardTasksList.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void MenuARSubTab_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("OFFICE"))
        {
            Response.Redirect("../Inspection/InspectionOfficeDashboardOfficeTasksList.aspx?TASK=VIR&STATUS=");
        }
    }
    ...
    private void BindData()
    {
        ...
        {
            ds = ds = PhoenixInspectionOfficeDashboard.InspectionDashboardVIRTaskSearch(General.GetNullableString(ViewState["VESSELID"].ToString() == string.Empty ? (Dashboardnvc != null ? Dashboardnvc["VesselList"] : null) : ViewState["VESSELID"].ToString())
                                                                    , General.GetNullableString(ViewState["VESSELID"].ToString() == string.Empty ? (Dashboardnvc != null ? Dashboardnvc["VesselTypeList"] : null) : null)
                                                                    , General.GetNullableString(ViewState["VESSELID"].ToString() == string.Empty ? (Dashboardnvc != null ? Dashboardnvc["FleetList"] : null) : null)
                                                                    , General.GetNullableInteger(ViewState["VESSELID"].ToString() == string.Empty ? (Dashboardnvc != null ? Dashboardnvc["Owner"] : null) : null)
                                                                , General.GetNullableString(ViewState["Status"].ToString())
            ...
            General.SetPrintOptions("gvShipBoardTasks", "ShipBoard Tasks", alCaptions, alColumns, ds);
            gvShipBoardTasks.DataSource = ds;
            gvShipBoardTasks.VirtualItemCount = iRowCount;
            ViewState["ROWCOUNT"] = iRowCount;
            ViewState["TOTALPAGECOUNT"] = iTotalPageCount;
    ...
    protected void ShowExcel()
    {
        ...
        if(ViewState["TASK"].ToString().Equals("VIR"))
        {
            ds = PhoenixInspectionOfficeDashboard.InspectionDashboardVIRTaskSearch(General.GetNullableString(ViewState["VESSELID"].ToString() == string.Empty ? (Dashboardnvc != null ? Dashboardnvc["VesselList"] : null) : ViewState["VESSELID"].ToString())
                                                                    , General.GetNullableString(ViewState["VESSELID"].ToString() == string.Empty ? (Dashboardnvc != null ? Dashboardnvc["VesselTypeList"] : null) : null)
                                                                    , General.GetNullableString(ViewState["VESSELID"].ToString() == string.Empty ? (Dashboardnvc != null ? Dashboardnvc["FleetList"] : null) : null)
                                                                    , General.GetNullableInteger(ViewState["VESSELID"].ToString() == string.Empty ? (Dashboardnvc != null ? Dashboardnvc["Owner"] : null) : null)
                                                                , General.GetNullableString(ViewState["Status"].ToString())
            ...
            Response.AddHeader("Content-Disposition", "attachment; filename=ShipBoardTaskList.xls");
            Response.ContentType = "application/vnd.msexcel";
            Response.Write("<TABLE BORDER='0' CELLPADDING='2' CELLSPACING='0' width='100%'>");
            Response.Write("<tr>");
            Response.Write("<td><img src='http://" + Request.Url.Authority + Session["images"] + "/esmlogo4_small.png" + "' /></td>");
            Response.Write("<td><h3>ShipBoard Tasks</h3></td>");
            Response.Write("<td colspan='" + (alColumns.Length - 2).ToString() + "'>&nbsp;</td>");
            Response.Write("</tr>");
            Response.Write("</TABLE>");
            Response.Write("<br />");
