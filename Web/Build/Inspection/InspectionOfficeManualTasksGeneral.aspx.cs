...
public partial class InspectionOfficeManualTasksGeneral : PhoenixBasePage
{
    ...
    protected void EnableDisableControls()
    {
        if (General.GetNullableGuid(ViewState["PREVENTIVEACTIONID"].ToString()) == null)
        {
            ...
            chkVesselTypeAll.Enabled = false;
    ...
    private bool IsValidPreventiveAction()
    {
        ...
        if (string.IsNullOrEmpty(ucpaTargetDate.Text))
            ucError.ErrorMessage = "Target Date action is required.";
