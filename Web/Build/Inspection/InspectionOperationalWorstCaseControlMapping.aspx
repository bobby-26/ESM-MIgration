<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionOperationalWorstCaseControlMapping.aspx.cs" Inherits="InspectionOperationalWorstCaseControlMapping" %>
             ...
             <eluc:Status ID="ucStatus" runat="server"></eluc:Status>
                <div id="divFind">
                    <table width="100%" cellspacing="2">
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblAspects" runat="server" Font-Bold="true" Text="Aapect"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTextBox ID="txtAspect" runat="server" ReadOnly="true" Width="360px" TextMode="MultiLine" Resize="Both"
                                    CssClass="readonlytextbox" ></telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblevent" runat="server" Font-Bold="true" Text="Undesirable Event"></telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblhazard" runat="server" Font-Bold="true" Text="Worst Case"></telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblRiskofEscalation" runat="server" Font-Bold="true" Text="Risk"></telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblprocedure" runat="server" Font-Bold="true" Text="Procedures, Forms and Checklists"></telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                             ...
                             <td>
                                <telerik:RadCheckBoxList ID="cblRecomendedPPE" runat="server" Direction="Vertical" Columns="3" DataBindings-DataTextField="FLDNAME" DataBindings-DataValueField="FLDMISCELLANEOUSID" CssClass="input" BorderWidth="1px" Width="75%">
