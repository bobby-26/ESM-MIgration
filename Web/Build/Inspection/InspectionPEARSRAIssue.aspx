<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPEARSRAIssue.aspx.cs" Inherits="InspectionPEARSRAIssue" %>
...
<body>
    <form id="frmApprovalRemarks" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%" EnableAJAX="false">
            ...
            <eluc:TabStrip ID="MenuIssueRemarks" runat="server" OnTabStripCommand="MenuIssueRemarks_TabStripCommand"></eluc:TabStrip>
            <table id="tbl" runat="server" cellpadding="1" cellspacing="1" width="75%">                
                <tr>
                    <td width="15%">
                        <b>
                            <asp:Literal ID="lblRemarks" runat="server" Text="Complete Remarks"></asp:Literal></b>
                    </td>
                    <td>
                        <asp:TextBox ID="txtCompleteRemarks" runat="server" CssClass="input_mandatory" Height="70px" Rows="4"
