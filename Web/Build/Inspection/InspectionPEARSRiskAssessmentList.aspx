<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPEARSRiskAssessmentList.aspx.cs" Inherits="InspectionPEARSRiskAssessmentList" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvPEARSRA.ClientID %>"));
               }, 200);
           }
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvPEARSRA" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" AllowMultiRowSelection="true" 
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Ref. No" AllowFiltering="true" DataField="FLDREFERENCENUMBER" UniqueName="FLDREFERENCENUMBER"
                            FilterDelay="2000" AutoPostBackOnFilter="false" ShowFilterIcon="false" CurrentFilterFunction="Contains" HeaderStyle-Width="10%">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Vessel" HeaderStyle-Width="9%" AllowSorting="true" DataField="FLDVESSELID" UniqueName="FLDVESSELID" FilterDelay="2000" ShowFilterIcon="false">
                            <FilterTemplate>
                                <telerik:RadComboBox ID="ddlVessel" runat="server" OnDataBinding="ddlVessel_DataBinding" AppendDataBoundItems="true" AutoPostBack="true"
                                    Width="100%" OnSelectedIndexChanged="ddlVessel_SelectedIndexChanged" DataTextField="FLDVESSELNAME" DataValueField="FLDVESSELID" >
                                </telerik:RadComboBox>
                            </FilterTemplate>
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Prepared" AllowFiltering="false" HeaderStyle-Width="8%">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Intended <br> Work" HeaderStyle-Width="10%" FilterDelay="2000" AllowFiltering="true" DataField="FLDINTENDEDWORKDATE" UniqueName="FLDINTENDEDWORKDATE" ShowFilterIcon="false">
                            <FilterTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Type of Activity" AllowFiltering="false" HeaderStyle-Width="19%" >
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Activity Worksite" AllowFiltering="false" HeaderStyle-Width="19%" >
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Rev No" AllowFiltering="false" HeaderStyle-Width="5%">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Status" HeaderStyle-Width="8%" AllowFiltering="true" DataField="FLDSTATUSID" UniqueName="FLDSTATUSID" FilterDelay="2000" AutoPostBackOnFilter="true">
                            <FilterTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false" HeaderStyle-Width="12%">
            ...
            <asp:Button ID="btnnotused" runat="server" Text="confirmnotused" OnClick="btnnotused_Click" />
