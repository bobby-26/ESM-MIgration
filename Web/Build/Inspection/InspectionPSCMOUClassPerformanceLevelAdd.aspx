<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPSCMOUClassPerformanceLevelAdd.aspx.cs" Inherits="Inspection_InspectionPSCMOUClassPerformanceLevelAdd" %>
...
<head runat="server">
    <title>Class Performance Level</title>
    ...
    <form id="frmDocumentCategory" runat="server">
        ...
        <eluc:TabStrip ID="MenuDocumentCategoryMain" Title="" OnTabStripCommand="MenuDocumentCategoryMain_TabStripCommand" runat="server"></eluc:TabStrip>
                <table width="75%" id="tblcontent" cellpadding="5" runat="server">
                    <tr>
                    <td>
                        <asp:Label ID="lblClass" Width="200px"  runat="server" Text="Class Performance"></asp:Label>
                        <telerik:RadComboBox ID="ddlclassperf" runat="server" EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true" AutoPostBack="true"></telerik:RadComboBox>
                    </td>
                    </tr>
                    <tr>
                        <td>
