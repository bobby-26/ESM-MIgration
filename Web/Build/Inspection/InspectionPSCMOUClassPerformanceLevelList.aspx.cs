...
public partial class Inspection_InspectionPSCMOUClassPerformanceLevelList : PhoenixBasePage
{
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        gvVerificationSummaryDepartment.MasterTableView.GetColumn("FLDCLASSPERFORMANCELEVEL").Display = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionPSCMOUClassPerformanceLevelList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Class Performance','Inspection/InspectionPSCMOUClassPerformanceLevelAdd.aspx?action=add')", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADDADDRESS");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Class','Inspection/InspectionPSCCopyMOURegisterData.aspx?type=CLSSCORE')", "Copy", "<i class=\"fa fa-copy\"></i>", "COPY");
    ...
    private void BindFlagPerformance()
    {
        ...
        DataSet ds = PhoenixInspectionPSCMOUMatrix.PSCMOUShipClassPerformanceLevelList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            sortexpression,
            sortdirection,
    ...
    protected void gvVerificationSummaryDepartment_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            if (eb != null)
            {
                ...
                eb.Attributes.Add("onclick", "openNewWindow('codehelpactivity', 'Class', '" + Session["sitepath"] + "/Inspection/InspectionPSCMOUClassPerformanceLevelAdd.aspx?action=edit&classperformancelevel=" + drv["FLDCLASSPERFORMANCELEVEL"].ToString() + "');return false;");

            }

            if (drv["FLDCLASSPERFORMANCELEVEL"].ToString() == "")
            {
                eb.Visible = false;
            }
