<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPSCMOUClassRecognizedAdd.aspx.cs" Inherits="Inspection_InspectionPSCMOUClassRecognizedAdd" %>
...
<head runat="server">
    <title>Recognized Organisation YN</title>
    ...
    <form id="frmDocumentCategory" runat="server">
        ...
        <eluc:TabStrip ID="MenuDocumentCategoryMain" Title="" OnTabStripCommand="MenuDocumentCategoryMain_TabStripCommand" runat="server"></eluc:TabStrip>
                <table width="75%" id="tblcontent" cellpadding="5" runat="server">
                    <tr>
                    <td>
                        <asp:Label ID="lblFlag" Width="200px"  runat="server" Text="Class Society"></asp:Label>
