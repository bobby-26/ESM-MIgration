<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPSCMOUClassRecognizedList.aspx.cs" Inherits="Inspection_InspectionPSCMOUClassRecognizedList" %>
...
<body>
    <form id="frmRegistersDepartment" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Width="100%" Height="100%" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <eluc:TabStrip ID="MenuRegistersDepartment" runat="server"  OnTabStripCommand="MenuRegistersDepartment_TabStripCommand"></eluc:TabStrip>
