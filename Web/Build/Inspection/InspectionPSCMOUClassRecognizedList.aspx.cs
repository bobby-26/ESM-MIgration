...
public partial class Inspection_InspectionPSCMOUClassRecognizedList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionPSCMOUClassRecognizedList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "EXCEL");
            toolbar.AddFontAwesomeButton("../Inspection/InspectionPSCMOUClassRecognizedList.aspx", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADDCITY");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Class','Inspection/InspectionPSCCopyMOURegisterData.aspx?type=CLSRECG')", "Copy", "<i class=\"fa fa-copy\"></i>", "COPY");
            ...
            toolbarmain.AddButton("Recognized Organisation", "RECORG", ToolBarDirection.Right);
            toolbarmain.AddButton("Performance Level", "PERFLEVEL", ToolBarDirection.Right);
            toolbarmain.AddButton("Class Performance", "CLASSPERF", ToolBarDirection.Right);
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("CLASSPERF"))
        {
            Response.Redirect("../Inspection/InspectionPSCMOUClassPerformanceList.aspx", false);
        }
    ...
    protected void MenuRegistersDepartment_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            RadToolBarEventArgs dce = (RadToolBarEventArgs)e;
            ...
            {
                    String scriptpopup = String.Format("javascript:parent.openNewWindow('City','','" + Session["sitepath"] + "/Inspection/InspectionPSCMOUClassRecognizedAdd.aspx?action=add');");
    ...
    private void BindFlagPerformance()
    {
        ...
        DataSet ds = PhoenixInspectionPSCMOUMatrix.PSCMOUShipClassRecognizedList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            sortexpression,
            sortdirection,
    ...
    protected void gvVerificationSummaryDepartment_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            if (eb != null)
            {
                eb.Attributes.Add("onclick", "openNewWindow('codehelpactivity', 'Class', '" + Session["sitepath"] + "/Inspection/InspectionPSCMOUClassRecognizedAdd.aspx?action=edit&classid=" + drv["FLDCLASSID"].ToString() + "');return false;");
            }
