<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPSCMOUCompanyPerformanceLevelAdd.aspx.cs" Inherits="Inspection_InspectionPSCMOUCompanyPerformanceLevelAdd" %>
        ...
        <telerik:RadSplitter RenderMode="Lightweight" BorderColor="White" ID="RadSplitter1" runat="server" Height="100%" Width="100%">
            <telerik:RadPane ID="navigationPane" runat="server" Width="45%" Scrolling="None" Height="100%">
                <table width="75%" id="tblcontent" cellpadding="5" runat="server">
                    <tr>
                    <td>
                        <asp:Label ID="lblCompany" Width="200px"  runat="server" Text="Performance Level"></asp:Label>
                        <telerik:RadComboBox ID="ddlcompanyperf" runat="server" EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true" AutoPostBack="true"></telerik:RadComboBox>
                    </td>
                    </tr>
                    <tr>
                        <td>
