...
public partial class Inspection_InspectionPSCMOUCompanyPerformanceLevelList : PhoenixBasePage
{
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        gvVerificationSummaryDepartment.MasterTableView.GetColumn("FLDCOMPANYPERFORMANCELEVEL").Display = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionPSCMOUCompanyPerformanceLevelList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Company Performance','Inspection/InspectionPSCMOUCompanyPerformanceLevelAdd.aspx?action=add')", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADDADDRESS");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Class','Inspection/InspectionPSCCopyMOURegisterData.aspx?type=COMPERFMATRIXSCORE')", "Copy", "<i class=\"fa fa-copy\"></i>", "COPY");
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Inspection/InspectionPSCMOUCompanyPerformanceScore.aspx", false);
        }
    }
    ...
    private void BindFlagPerformance()
    {
        ...
        DataSet ds = PhoenixInspectionPSCMOUMatrix.PSCMOUShipCompanyPerformanceLevelList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            sortexpression,
            sortdirection,
    ...
    protected void gvVerificationSummaryDepartment_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            if (eb != null)
            {
                ...
                eb.Attributes.Add("onclick", "openNewWindow('codehelpactivity', 'Company', '" + Session["sitepath"] + "/Inspection/InspectionPSCMOUCompanyPerformanceLevelAdd.aspx?action=edit&companyperformancelevel=" + drv["FLDCOMPANYPERFORMANCELEVEL"].ToString() + "');return false;");

            }

            if (drv["FLDCOMPANYPERFORMANCELEVEL"].ToString() == "")
            {
                eb.Visible = false;
            }
