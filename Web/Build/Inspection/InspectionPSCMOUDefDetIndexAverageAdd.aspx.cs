...
public partial class Inspection_InspectionPSCMOUDefDetIndexAverageAdd : PhoenixBasePage
{
        ...
        if (ViewState["NOOFCOLUMNS"].ToString() != "")
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                if (ViewState["FLDINDEXTYPEID"] != null && ViewState["ACTION"].ToString() == "edit")
                {
                    ...
                    dt = PhoenixInspectionPSCMOUMatrix.PSCMOUDefDetAverageEdit(General.GetNullableInteger(ViewState["FLDINDEXTYPEID"].ToString()));
                    if (dt.Rows.Count > 0)
                    {
                        MyTextBox.Text = dt.Rows[i]["FLDMOUAVERAGE"].ToString();
                    ...
                    if (n > 0)
                    {
                        ...
                        for (int i = 0; i < n; i++)
                        {
                            ...
                            if (MyTextBox != null)
                            {
                                ...
                                if (MyTextBox != null)
                                {
                                    PhoenixInspectionPSCMOUMatrix.PSCMOUDefDetAverageInsert(
                                                                        PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                                                                         General.GetNullableInteger(ddlshipage.SelectedValue),
                                                                         General.GetNullableDecimal(ss),
                    ...
                    if (n > 0)
                    {
                        ...
                        for (int i = 0; i < n; i++)
                        {
                            ...
                            if (MyTextBox != null)
                            {
                                ...
                                if (MyTextBox != null)
                                {
                                    PhoenixInspectionPSCMOUMatrix.PSCMOUDefDetAverageUpdate(
                                                                        PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                                                                         General.GetNullableInteger(ddlshipage.SelectedValue),
                                                                         General.GetNullableDecimal(ss),
                                                                         General.GetNullableGuid(mou)
