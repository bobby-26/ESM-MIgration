...
public partial class Inspection_InspectionPSCMOUDefDetIndexRatioLimitList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Flag','Inspection/InspectionPSCMOUDefDetIndexRatioLimitAdd.aspx?action=add')", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADDADDRESS");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Class','Inspection/InspectionPSCCopyMOURegisterData.aspx?type=COMDEFDETLIMIT')", "Copy", "<i class=\"fa fa-copy\"></i>", "COPY");
           ...
           // toolbarmain.AddButton("IMO Audit", "IMOAUDIT", ToolBarDirection.Right);
            toolbarmain.AddButton("PSC MOU Average", "PSCAVG", ToolBarDirection.Right);
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("PSCAVG"))
        {
            Response.Redirect("../Inspection/InspectionPSCMOUDefDetIndexAverageList.aspx", false);
        }
    }
    ...
    private void BindFlagPerformance()
    {
        ...
        DataSet ds = PhoenixInspectionPSCMOUMatrix.PSCMOUDefDetLimitRatioList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            sortexpression,
            sortdirection,
    ...
    protected void gvVerificationSummaryDepartment_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            if (eb != null)
            {
                eb.Attributes.Add("onclick", "openNewWindow('codehelpactivity', 'Flag', '" + Session["sitepath"] + "/Inspection/InspectionPSCMOUDefDetIndexRatioLimitAdd.aspx?action=edit&indextype=" + drv["FLDINDEXTYPEID"].ToString() + "');return false;");
            }
