<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPSCMOUFlagIMOAuditAdd.aspx.cs" Inherits="Inspection_InspectionPSCMOUFlagIMOAuditAdd" %>
    ...
    <form id="frmDocumentCategory" runat="server">
        ...
        <eluc:TabStrip ID="MenuDocumentCategoryMain" Title="" OnTabStripCommand="MenuDocumentCategoryMain_TabStripCommand" runat="server"></eluc:TabStrip>
                <table width="75%" id="tblcontent" cellpadding="5" runat="server">
                    <tr>
                    <td>
                        <asp:Label ID="lblFlag" Width="200px"  runat="server" Text="Flag"></asp:Label>
                        <eluc:Flag ID="ucFlag" runat="server" Width="150px" AppendDataBoundItems="true" AutoPostBack="true" />
                    </td>
                    </tr>
                    <tr>
                        <td>
