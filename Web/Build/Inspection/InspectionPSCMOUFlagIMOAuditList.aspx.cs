...
public partial class Inspection_InspectionPSCMOUFlagIMOAuditList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionPSCMOUFlagIMOAuditList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Flag IMO Audit YN','Inspection/InspectionPSCMOUFlagIMOAuditAdd.aspx?action=add')", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADDADDRESS");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Flag','Inspection/InspectionPSCCopyMOURegisterData.aspx?type=FLIMO')", "Copy", "<i class=\"fa fa-copy\"></i>", "COPY");
    ...
    private void BindFlagPerformance()
    {
        ...
        DataSet ds = PhoenixInspectionPSCMOUMatrix.PSCMOUShipFlagIMOAuditList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            sortexpression,
            sortdirection,
    ...
    protected void gvVerificationSummaryDepartment_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (eb != null)
            {
                eb.Attributes.Add("onclick", "openNewWindow('codehelpactivity', 'Flag', '" + Session["sitepath"] + "/Inspection/InspectionPSCMOUFlagIMOAuditAdd.aspx?action=edit&flagid=" + drv["FLDFLAGID"].ToString() + "');return false;");
            }
