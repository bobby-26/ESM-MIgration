...
public partial class Inspection_InspectionPSCMOUFlagPerformanceColorList : PhoenixBasePage
{
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        gvVerificationSummaryDepartment.MasterTableView.GetColumn("FLDFLAGID").Display = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionPSCMOUFlagPerformanceColorList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Class Performance','Inspection/InspectionPSCMOUFlagPerformanceColorAdd.aspx?action=add')", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADDADDRESS");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Flag','Inspection/InspectionPSCCopyMOURegisterData.aspx?type=FLSCORE')", "Copy", "<i class=\"fa fa-copy\"></i>", "COPY");
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("COLOR"))
        {
            Response.Redirect("../Inspection/InspectionPSCMOUFlagPerformanceScoreList.aspx", false);
        }
    }
    ...
    private void BindFlagPerformance()
    {
        ...
        DataSet ds = PhoenixInspectionPSCMOUMatrix.PSCMOUShipFlagPerformanceColorList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            sortexpression,
            sortdirection,
    ...
    protected void gvVerificationSummaryDepartment_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (eb != null)
            {
                ...
                eb.Attributes.Add("onclick", "openNewWindow('codehelpactivity', 'Flag', '" + Session["sitepath"] + "/Inspection/InspectionPSCMOUFlagPerformanceColorAdd.aspx?action=edit&flagid=" + drv["FLDFLAGID"].ToString() + "');return false;");

            }
            if (drv["FLDFLAGID"].ToString() == "")
            {
                eb.Visible = false;
            }
