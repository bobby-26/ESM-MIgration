...
public partial class Inspection_InspectionPSCMOUFlagPerformanceScoreList : PhoenixBasePage
{
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        gvVerificationSummaryDepartment.MasterTableView.GetColumn("FLDPERFORMANCEID").Display = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionPSCMOUFlagPerformanceScoreList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Flag','Inspection/InspectionPSCCopyMOURegisterData.aspx?type=FLPERF')", "Copy", "<i class=\"fa fa-copy\"></i>", "COPY");
            ...
            toolbarmain.AddButton("IMO Audit", "IMOAUDIT", ToolBarDirection.Right);
            toolbarmain.AddButton("Color", "COLOR", ToolBarDirection.Right);
            toolbarmain.AddButton("Flag Performance", "FLAGPERF", ToolBarDirection.Right);
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("IMOAUDIT"))
        {
            Response.Redirect("../Inspection/InspectionPSCMOUFlagIMOAuditList.aspx", false);
        }
        if (CommandName.ToUpper().Equals("FLAGPERF"))
        {
            Response.Redirect("../Inspection/InspectionPSCMOUFlagPerformanceColorList.aspx", false);
        }
    }
    ...
    private void BindFlagPerformance()
    {
        ...
        DataSet ds = PhoenixInspectionPSCMOUMatrix.PSCMOUFlagColorScoreList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,            
            sortexpression,
            sortdirection,
    ...
    protected void gvVerificationSummaryDepartment_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (eb != null)
            {
                eb.Attributes.Add("onclick", "openNewWindow('codehelpactivity', 'Flag', '" + Session["sitepath"] + "/Inspection/InspectionPSCMOUFlagPerformanceScore.aspx?action=edit&flagperformance=" + drv["FLDPERFORMANCEID"].ToString() + "');return false;");
            }
            if (drv["FLDPERFORMANCEID"].ToString() == "")
            {
                eb.Visible = false;
            }
        }
