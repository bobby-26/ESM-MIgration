<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPSCMOUHistoricParameterLimitAdd.aspx.cs" Inherits="Inspection_InspectionPSCMOUHistoricParameterLimitAdd" %>
                ...
                <table width="75%" id="tblcontent" cellpadding="5" runat="server">
                    ...
                    <td>
                        ...
                        <Items>
                            ...
                            <telerik:RadComboBoxItem Text="Deficiency Limit" Value="1"></telerik:RadComboBoxItem>
                            <telerik:RadComboBoxItem Text="Detention Limit" Value="2"></telerik:RadComboBoxItem>
<%--                            <telerik:RadComboBoxItem Text=">Deficiency Limit" Value="3"></telerik:RadComboBoxItem>
                            <telerik:RadComboBoxItem Text="<=Detention Limit" Value="4"></telerik:RadComboBoxItem>--%>
                            <telerik:RadComboBoxItem Text="High Risk Limit" Value="5"></telerik:RadComboBoxItem>
                        </Items>    
                        </telerik:RadComboBox>
                    </td>
                    </tr>
