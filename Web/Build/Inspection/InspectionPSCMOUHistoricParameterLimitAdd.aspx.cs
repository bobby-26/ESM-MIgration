...
public partial class Inspection_InspectionPSCMOUHistoricParameterLimitAdd : PhoenixBasePage
{
        ...
        if (ViewState["NOOFCOLUMNS"].ToString() != "")
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                if (ViewState["FLDINDEXTYPEID"] != null && ViewState["ACTION"].ToString() == "edit")
                {
                    ...
                    dt = PhoenixInspectionPSCMOUMatrix.PSCMOUHistoricParameterLimitEdit(General.GetNullableInteger(ViewState["FLDINDEXTYPEID"].ToString()));
                    if (dt.Rows.Count > 0)
                    {
                        MyTextBox.Text = dt.Rows[i]["FLDMOULIMIT"].ToString();
                    ...
                    if (n > 0)
                    {
                        ...
                        for (int i = 0; i < n; i++)
                        {
                            ...
                            if (MyTextBox != null)
                            {
                                ...
                                if (MyTextBox != null)
                                {
                                    PhoenixInspectionPSCMOUMatrix.PSCMOUHistoricParameterLimitInsert(
                    ...
                    if (n > 0)
                    {
                        ...
                        for (int i = 0; i < n; i++)
                        {
                            ...
                            if (MyTextBox != null)
                            {
                                ...
                                if (MyTextBox != null)
                                {
                                    PhoenixInspectionPSCMOUMatrix.PSCMOUHistoricParameterLimitUpdate(
                                                                        PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                                                                         General.GetNullableInteger(ddlshipage.SelectedValue),
                                                                         General.GetNullableInteger(ss),
                                                                         General.GetNullableGuid(mou)
