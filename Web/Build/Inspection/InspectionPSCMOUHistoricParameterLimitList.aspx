<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPSCMOUHistoricParameterLimitList.aspx.cs" Inherits="Inspection_InspectionPSCMOUHistoricParameterLimitList" %>
...
<head id="Head1" runat="server">
    <title>Historic Parameters</title>
                ...
                <MasterTableView EditMode="InPlace" TableLayout="Fixed" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Action" UniqueName="ACTION">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton runat="server" AlternateText="Edit" CommandName="EDIT" ID="cmdEdit" ToolTip="Edit"> <span class="icon"><i class="fas fa-edit"></i></span></asp:LinkButton>
                            </ItemTemplate>
