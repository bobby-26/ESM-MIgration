...
public partial class Inspection_InspectionPSCMOUHistoricParameterLimitList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionPSCMOUDefDetIndexRatioLimitList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Parameters','Inspection/InspectionPSCMOUHistoricParameterLimitAdd.aspx?action=add')", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADDADDRESS");
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("PARSCORE"))
        {
            Response.Redirect("../Inspection/InspectionPSCMOUHistoricParameterScore.aspx", false);
        }
    }
    ...
    private void BindFlagPerformance()
    {
        ...
        DataSet ds = PhoenixInspectionPSCMOUMatrix.PSCMOUHistoricParameterLimitList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            sortexpression,
            sortdirection,
    ...
    protected void gvVerificationSummaryDepartment_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            if (eb != null)
            {
                eb.Attributes.Add("onclick", "openNewWindow('codehelpactivity', 'Flag', '" + Session["sitepath"] + "/Inspection/InspectionPSCMOUHistoricParameterLimitAdd.aspx?action=edit&indextype=" + drv["FLDINDEXTYPEID"].ToString() + "');return false;");
            }
