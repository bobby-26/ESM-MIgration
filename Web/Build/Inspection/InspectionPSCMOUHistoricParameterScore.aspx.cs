...
public partial class Inspection_InspectionPSCMOUHistoricParameterScore : PhoenixBasePage
{
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        gvVerificationSummaryDepartment.MasterTableView.GetColumn("FLDINDEXTYPEID").Display = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionPSCMOUHistoricParameterScore.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Parameters','Inspection/InspectionPSCMOUHistoricParameterScoreAdd.aspx?action=add')", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADDADDRESS");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Class','Inspection/InspectionPSCCopyMOURegisterData.aspx?type=PARMTSLIMIT')", "Copy", "<i class=\"fa fa-copy\"></i>", "COPY");
            ...
            toolbarmain.AddButton("Parameters Score", "PARSCORE", ToolBarDirection.Right);
            toolbarmain.AddButton("Parameters Limit", "PARLIMIT", ToolBarDirection.Right);
            //toolbarmain.AddButton("Df./Det. Limit", "DEFDET", ToolBarDirection.Right);
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("PARLIMIT"))
        {
            Response.Redirect("../Inspection/InspectionPSCMOUHistoricParameterLimitList.aspx", false);
        }
    }
    ...
    private void BindFlagPerformance()
    {
        ...
        DataSet ds = PhoenixInspectionPSCMOUMatrix.PSCMOUHistoricParameterLimitScoreList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            sortexpression,
            sortdirection,
    ...
    protected void gvVerificationSummaryDepartment_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            if (eb != null)
            {
                eb.Attributes.Add("onclick", "openNewWindow('codehelpactivity', 'Flag', '" + Session["sitepath"] + "/Inspection/InspectionPSCMOUHistoricParameterScoreAdd.aspx?action=edit&indextype=" + drv["FLDINDEXTYPEID"].ToString() + "');return false;");
            }

            if (drv["FLDINDEXTYPEID"].ToString() == "")
            {
                eb.Visible = false;
            }
