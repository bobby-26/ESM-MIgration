...
public partial class Inspection_InspectionPSCMOUHistoricParameterScoreAdd : PhoenixBasePage
{
        ...
        if (ViewState["NOOFCOLUMNS"].ToString() != "")
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                if (ViewState["FLDINDEXTYPEID"] != null && ViewState["ACTION"].ToString() == "edit")
                {
                    ...
                    dt = PhoenixInspectionPSCMOUMatrix.PSCMOUHistoricParameterLimitScoreEdit(General.GetNullableInteger(ViewState["FLDINDEXTYPEID"].ToString()));
                    if (dt.Rows.Count > 0)
                    {
                        MyTextBox.Text = dt.Rows[i]["FLDMOUWEIGHTAGE"].ToString();
                    ...
                    if (n > 0)
                    {
                        ...
                        for (int i = 0; i < n; i++)
                        {
                            ...
                            if (MyTextBox != null)
                            {
                                ...
                                if (MyTextBox != null)
                                {
                                    PhoenixInspectionPSCMOUMatrix.PSCMOUHistoricParameterLimitScoreInsert(
                    ...
                    if (n > 0)
                    {
                        ...
                        for (int i = 0; i < n; i++)
                        {
                            ...
                            if (MyTextBox != null)
                            {
                                ...
                                if (MyTextBox != null)
                                {
                                    PhoenixInspectionPSCMOUMatrix.PSCMOUHistoricParameterLimitScoreUpdate(
                                                                        PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                                                                         General.GetNullableInteger(ddlshipage.SelectedValue),
                                                                         General.GetNullableInteger(ss),
                                                                         General.GetNullableGuid(mou)
