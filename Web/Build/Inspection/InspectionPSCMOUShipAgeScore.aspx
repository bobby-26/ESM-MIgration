<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPSCMOUShipAgeScore.aspx.cs" Inherits="Inspection_InspectionPSCMOUShipAgeScore" %>
...
<body>
    <form id="frmRASeverity" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
            ...
            <eluc:Title runat="server" ID="ucTitle" Text="Ship Age Score" Visible="false"></eluc:Title>
            <br />
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvMenuPSCMOU" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowPaging="true" AllowCustomPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Ship Age">
                            <ItemStyle Wrap="False" HorizontalAlign="Left" Width="60%"></ItemStyle>
                            <HeaderTemplate>
                                <telerik:RadLabel ID="lblshipageHeader" runat="server" >Age of ship&nbsp;</telerik:RadLabel>                                
                            </HeaderTemplate>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblshipageId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDAGEOFSHIPSCOREID") %>'></telerik:RadLabel>
                                <telerik:RadLabel ID="lblshipage" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSHIPAGE") %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <telerik:RadLabel ID="lblshipageEdit" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDAGEOFSHIPSCOREID") %>'></telerik:RadLabel>
                                <telerik:RadTextBox ID="txtshipageEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSHIPAGE") %>'
                                    CssClass="gridinput_mandatory" MaxLength="200" Width="98%"></telerik:RadTextBox>
                            </EditItemTemplate>
                            <FooterTemplate>
                                <telerik:RadTextBox ID="txtshipageAdd" runat="server" CssClass="gridinput_mandatory" Width="98%" MaxLength="200"></telerik:RadTextBox>
                            </FooterTemplate>
                       ...
                       <telerik:GridTemplateColumn HeaderText="PSC MOU">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblpscmouId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDAGEOFSHIPSCOREID") %>'></telerik:RadLabel>
                                <telerik:RadLabel ID="lblpscmou" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPSCMOUREGION") %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <telerik:RadLabel ID="lblpscmouEdit" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDAGEOFSHIPSCOREID") %>'></telerik:RadLabel>
