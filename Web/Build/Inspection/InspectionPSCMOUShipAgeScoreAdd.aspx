<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPSCMOUShipAgeScoreAdd.aspx.cs" Inherits="Inspection_InspectionPSCMOUShipAgeScoreAdd" %>
...
<head runat="server">
    <title>Ship Age Weightage</title>
    ...
    <form id="frmDocumentCategory" runat="server">
        ...
        <eluc:TabStrip ID="MenuDocumentCategoryMain" Title="" OnTabStripCommand="MenuDocumentCategoryMain_TabStripCommand" runat="server"></eluc:TabStrip>
                <table width="75%" id="tblcontent" cellpadding="5" runat="server">
                    <tr>
                    <td>
                        <asp:Label ID="lblShipType" Width="200px" runat="server" Text="Ship Age"></asp:Label>
