<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPSCMOUShipTypeScoreAdd.aspx.cs" Inherits="Inspection_InspectionPSCMOUShipTypeScoreAdd" %>
...
<head runat="server">
    <title>Ship Type Weightage</title>
    ...
    <form id="frmDocumentCategory" runat="server">
        ...
        <eluc:TabStrip ID="MenuDocumentCategoryMain" Title="" OnTabStripCommand="MenuDocumentCategoryMain_TabStripCommand" runat="server"></eluc:TabStrip>
                <table width="75%" id="tblcontent" cellpadding="5" runat="server">
                    <tr>
                    <td>
                        <asp:Label ID="lblShipType" Width="200px" runat="server" Text="Ship Type"></asp:Label>
                        <eluc:Hard ID="ucVesselType" runat="server" AppendDataBoundItems="true" AutoPostBack="true" HardList='<%# PhoenixRegistersHard.ListHard(1, 81) %>'
                            HardTypeCode="81"/>                    
                    </td>
                    </tr>
                    <tr>
