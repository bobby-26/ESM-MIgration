...
public partial class Inspection_InspectionPSCMOUShipTypeScoreList : PhoenixBasePage
{
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        gvVerificationSummaryDepartment.MasterTableView.GetColumn("FLDSHIPTYPE").Display = false;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionPSCMOUShipTypeScoreList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','Flag','Inspection/InspectionPSCMOUShipTypeScoreAdd.aspx?action=add')", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADDADDRESS");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelpactivity','ShipType','Inspection/InspectionPSCCopyMOURegisterData.aspx?type=SHIPTYPE')", "Copy", "<i class=\"fa fa-copy\"></i>", "COPY");
    ...
    private void BindFlagPerformance()
    {
        ...
        DataSet ds = PhoenixInspectionPSCMOUMatrix.PSCMOUShipTypeScoresList(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            sortexpression,
            sortdirection,
    ...
    protected void gvVerificationSummaryDepartment_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (eb != null)
            {
                eb.Attributes.Add("onclick", "openNewWindow('codehelpactivity', 'Flag', '" + Session["sitepath"] + "/Inspection/InspectionPSCMOUShipTypeScoreAdd.aspx?action=edit&shiptype=" + drv["FLDSHIPTYPE"].ToString() + "');return false;");
            }

            if(drv["FLDSHIPTYPE"].ToString() == "")
            {
                eb.Visible = false;
            }
