<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPurchaseForm.aspx.cs" Inherits="InspectionPurchaseForm" %>
...
<body>
    <form id="frmPurchaseForm" runat="server" autocomplete="off">
        ...
        <asp:TextBox ID="lblorderId" runat="server" Visible="false"></asp:TextBox>
        ...
        <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
            ...
            <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                ...
                <telerik:RadGrid ID="gvFormDetails" runat="server" AutoGenerateColumns="False" Font-Size="11px" OnSortCommand="gvFormDetails_SortCommand"
                    ...
                    AllowSorting="true" ShowHeader="true" EnableHeaderContextMenu="true" GroupingEnabled="false" EnableViewState="false" OnNeedDataSource="gvFormDetails_NeedDataSource">
