<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPurchaseFormGeneral.aspx.cs" Inherits="InspectionPurchaseFormGeneral" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Date ID="txtRecivedDate" runat="server" ReadOnly="true" />
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnPickListOwnerBudget">
                            ...
                            <telerik:RadTextBox ID="txtOwnerBudgetName" runat="server" Width="0px" Enabled="False"></telerik:RadTextBox>
                ...
                <tr id="trPay" runat="server">
                    ...
                    <td>
                        <eluc:Decimal ID="txtVenderEsmeted" runat="server" Width="120px" Mask="99,999,999.99" ReadOnly="true" />
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Date ID="txtAccumulatedTotal" runat="server" Style="text-align: right" Visible="false" Enabled="False" />
                    </td>
                </tr>
            </table>
