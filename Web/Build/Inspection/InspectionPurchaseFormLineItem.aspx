<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionPurchaseFormLineItem.aspx.cs" Inherits="InspectionPurchaseFormLineItem" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtStatus" runat="server" Width="90px" ReadOnly="True"
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblPrice" runat="server"> </telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Currency ID="ucCurrency" AppendDataBoundItems="true" Width="90px" 
                    ...
                    <td>
                        <eluc:Decimal ID="txtOrderQty" runat="server" Width="90px" Mask="99999" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <eluc:Decimal ID="txtRecivedQty" runat="server" Width="90px" Mask="99,999"  />
                    </td>
                    <td>
                        <telerik:RadLabel ID="lblCancelledQty" runat="server" Text="Cancelled Qty"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Decimal ID="txtCanceledQty" runat="server" Width="90px" Mask="99,999" 
                            ReadOnly="true" />
                    </td>
                </tr>
                <tr>
            ...
            <telerik:RadGrid ID="gvLineItem" runat="server" AutoGenerateColumns="False" Font-Size="11px" EnableHeaderContextMenu="true" GroupingEnabled="false" OnNeedDataSource="gvLineItem_NeedDataSource"
                ...
                OnUpdateCommand="gvLineItem_UpdateCommand" AllowSorting="True" EnableViewState="false" OnSorting="gvLineItem_Sorting" DataKeyNames="FLDORDERLINEID" OnSortCommand="gvLineItem_SortCommand">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="ROB">
                            ...
                            <HeaderTemplate>
                                <telerik:RadLabel ID="lblROBQuantityHeader" runat="server">ROB</telerik:RadLabel>
                            </HeaderTemplate>
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                <span id="spnPickListOwnerBudgetEdit">
                                    ...
                                    <telerik:RadTextBox ID="txtOwnerBudgetIdEdit" runat="server" Width="0px" 
                                        Text='<%# DataBinder.Eval(Container,"DataItem.FLDOWNERBUDGETID") %>'></telerik:RadTextBox>
                ...
                <tr>
                    <td>
                        <asp:ImageButton ID="imgFlag" runat="server" Enabled="false" ImageUrl="<%$ PhoenixTheme:images/detail-flag.png %>" /><telerik:RadLabel
                            ID="lblMessage" runat="server" ForeColor="Red"> Line item Details. </telerik:RadLabel>
                    </td>
                </tr>
            </table>
