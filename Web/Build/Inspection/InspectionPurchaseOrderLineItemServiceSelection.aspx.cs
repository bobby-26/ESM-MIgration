...
public partial class InspectionPurchaseOrderLineItemServiceSelection : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbargrid.AddImageButton("../Inspection/InspectionPurchaseOrderLineItemServiceSelection.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('divGrid')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Inspection/InspectionPurchaseOrderLineItemServiceSelection.aspx", "<b>Find</b>", "search.png", "FIND");
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            DataSet ds = PhoenixInspectionAuditPurchaseForm.SearchServiceLineItems(General.GetNullableGuid(txtComponentID.Text), Filter.CurrentInspectionPurchaseVesselSelection, General.GetNullableGuid(ViewState["orderid"].ToString())
    ...
    private void BindData()
    {
        try
        {
            ...
            DataSet ds = PhoenixInspectionAuditPurchaseForm.SearchServiceLineItems(
    ...
    private void InsertOrderLineItem(string storeitemid, string orderlineid, string componentid, string quantity, string unit)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    PhoenixInspectionAuditPurchaseForm.InsertServiceOrderLine(PhoenixSecurityContext.CurrentSecurityContext.UserCode, new Guid(storeitemid), General.GetNullableGuid(componentid), new Guid(ViewState["orderid"].ToString())
                         , General.GetNullableDecimal(quantity), Filter.CurrentPurchaseStockType.ToString(), General.GetNullableInteger(unit.ToString()));
                }
                else
                {
                    PhoenixInspectionAuditPurchaseForm.UpdateOrderLine(PhoenixSecurityContext.CurrentSecurityContext.UserCode, General.GetNullableGuid(orderlineid)
