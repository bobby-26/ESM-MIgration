<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionQuestionOptions.aspx.cs" Inherits="InspectionQuestionOptions" %>
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="Radcodeblock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvQuestionOptions.ClientID %>"));
               }, 200);
           }
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <eluc:TabStrip ID="MenuQuestionOptions" runat="server" OnTabStripCommand="MenuQuestionOptions_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvQuestionOptions" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" OnItemCommand="gvQuestionOptions_ItemCommand" OnNeedDataSource="gvQuestionOptions_NeedDataSource" ShowHeader="true"
                OnItemDataBound="gvQuestionOptions_ItemDataBound" EnableViewState="false" GroupingEnabled="false" EnableHeaderContextMenu="true" ShowFooter="false"
                OnSortCommand="gvQuestionOptions_SortCommand">
