...
public partial class InspectionRAApprovalRemarks : PhoenixBasePage
{
    ...
    protected void MenuApprovalRemarks_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["RATEMPLATEID"] != null && ViewState["RATEMPLATEID"] != null)
            {
                ...
                {
                    PhoenixInspectionRiskAssessment.ApproveRAWithRemarks(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
