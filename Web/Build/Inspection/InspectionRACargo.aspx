<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRACargo.aspx.cs"
    Inherits="Inspection_InspectionRACargo" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmCargo" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="99.9%">
            ...
            <eluc:Title runat="server" ID="ucTitle" Text="Cargo" ShowMenu="false" Visible="false" />
            ...
            <div id="tblCargo">
                <table border="1" width="99.9%" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:Company ID="ucCompany" runat="server" CssClass="input_mandatory" Width="360px" AppendDataBoundItems="true" />
                        </td>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <span id="spnRAEdit">
                                    ...
                                    <asp:LinkButton ID="imgShowRAEdit" runat="server" Text="" ToolTip="">
                        ...
                        <tr valign="middle">
                            ...
                            <td colspan="3">
                                ...
                                <eluc:Hazard ID="ucHazardType" runat="server" Width="200px" AppendDataBoundItems="true" CssClass="dropdown_mandatory"
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" ID="gvHealthSafetyRisk" runat="server" AutoGenerateColumns="False"
                                    ...
                                    ShowHeader="true" ShowFooter="true" EnableViewState="false" OnItemDataBound="gvHealthSafetyRisk_ItemDataBound" GroupingEnabled="false" EnableHeaderContextMenu="true">
                        ...
                        <tr valign="middle">
                            ...
                            <td colspan="3">
                                ...
                                <telerik:RadGrid RenderMode="Lightweight" ID="gvEnvironmentalRisk" runat="server" AutoGenerateColumns="False" GroupingEnabled="false" EnableHeaderContextMenu="true"
                                    ...
                                    EnableViewState="false" OnItemDataBound="gvEnvironmentalRisk_ItemDataBound" OnNeedDataSource="gvEnvironmentalRisk_NeedDataSource">
                                    <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                                    <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                        AutoGenerateColumns="false">
                                        <ColumnGroups>
                        ...
                        <tr valign="middle">
                            ...
                            <td colspan="3">
                                <telerik:RadCheckBoxList ID="cblProposedControl" runat="server" Columns="2" Direction="Vertical"
                                    AutoPostBack="true" OnTextChanged="OtherDetailClick" />
                                <br />
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <telerik:RadGrid RenderMode="Lightweight" ID="gvCargoSafety" runat="server" AutoGenerateColumns="False" Font-Size="11px" GroupingEnabled="false" EnableHeaderContextMenu="true"
                                    Width="99.9%" ShowHeader="true" ShowFooter="true" EnableViewState="false" OnItemCommand="gvCargoSafety_ItemCommand"
                                    OnItemDataBound="gvCargoSafety_ItemDataBound" OnRowEditing="gvCargoSafety_RowEditing" OnNeedDataSource="gvCargoSafety_NeedDataSource"
                                    ...
                                    <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderStyle-Width="72px" HeaderText="Action">
                                ...
                                <%--  <telerik:RadTextBox ID="txtAdditionalSafetyProcedures" runat="server" CssClass="input" Width="360px" Resize="Both"
                                        Rows="4" TextMode="MultiLine"></telerik:RadTextBox>--%>
