...
public partial class InspectionRACargoAspectList : PhoenixBasePage
{
    ...
    protected void gvRAOperationalHazard_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        try
        {
            ...
            ds = PhoenixInspectionRiskAssessmentCargoExtn.ListOperationalHazard(General.GetNullableGuid(ViewState["RAID"].ToString()));
