...
public partial class InspectionRACargoComparison : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString["cargoid"] != null)
        {
            ViewState["RISKASSESSMENTCARGOID"] = Request.QueryString["cargoid"].ToString();
    ...
    {
        DataSet ds = PhoenixInspectionRiskAssessmentGeneric.InspectionRiskAssessmentCargoComparison(
