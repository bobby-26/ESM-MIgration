<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRACargoDetails.aspx.cs"
    Inherits="InspectionRACargoDetails" %>
...
<body>
    ...
    <asp:UpdatePanel runat="server" ID="pnlCargo">
        <ContentTemplate>
            ...
            <eluc:Confirm ID="ucConfirmProposeTemplate" runat="server" OnConfirmMesage="btnConfirmProposeTemplate_Click"
