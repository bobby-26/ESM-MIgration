...
public partial class InspectionRACargoDetails : PhoenixBasePage
{
    ...
    protected void BindScore()
    {
        ...
        DataSet ds = PhoenixInspectionRiskAssessmentCargo.CargoScores(General.GetNullableGuid(ViewState["RISKASSESSMENTGENERICID"].ToString()));
    ...
    private void BindGridHealthSafetyRisk()
    {
        ...
        DataSet ds = new DataSet();
        ds = PhoenixInspectionRiskAssessmentCargo.ListCargoCategory(1, General.GetNullableGuid(ViewState["RISKASSESSMENTGENERICID"].ToString()),
    ...
    {
        DataSet ds = new DataSet();
        ds = PhoenixInspectionRiskAssessmentCargo.ListCargoCategory(2, General.GetNullableGuid(ViewState["RISKASSESSMENTGENERICID"].ToString()),
            General.GetNullableInteger(ViewState["VESSELID"].ToString()));
        if (ds.Tables[0].Rows.Count > 0)
        {
    ...
    {
        DataSet ds = new DataSet();
        ds = PhoenixInspectionRiskAssessmentCargo.ListCargoCategory(4, General.GetNullableGuid(ViewState["RISKASSESSMENTGENERICID"].ToString()),
            General.GetNullableInteger(ViewState["VESSELID"].ToString()));
        if (ds.Tables[0].Rows.Count > 0)
        {
    ...
    protected void btnConfirmProposeTemplate_Click(object sender, EventArgs e)
    {
        try
        {
            UserControlConfirmMessage ucCM = (UserControlConfirmMessage)sender;
