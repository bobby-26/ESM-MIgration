...
public partial class InspectionRACargoExtn : PhoenixBasePage
{
    ...
    protected void CommentsLink()
    {
        ...
        lnkcomment.Attributes.Add("onclick", "javascript:parent.openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionRAComments.aspx?RATYPEID=6&SECTIONID=1&RAID=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "'); ");
        lnkaspectcomment.Attributes.Add("onclick", "javascript:parent.openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionRAComments.aspx?RATYPEID=6&SECTIONID=2&RAID=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "'); ");
        lnkhealthcomments.Attributes.Add("onclick", "javascript:parent.openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionRAComments.aspx?RATYPEID=65&SECTIONID=3&RAID=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "'); ");
        lnkEnvironmental.Attributes.Add("onclick", "javascript:parent.openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionRAComments.aspx?RATYPEID=6&SECTIONID=4&RAID=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "'); ");
        lnkEconomic.Attributes.Add("onclick", "javascript:parent.openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionRAComments.aspx?RATYPEID=6&SECTIONID=4&RAID=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "'); ");
        lnkUndesireable.Attributes.Add("onclick", "javascript:parent.openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionRAComments.aspx?RATYPEID=6&SECTIONID=6&RAID=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "'); ");
        lnkPersonal.Attributes.Add("onclick", "javascript:parent.openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionRAComments.aspx?RATYPEID=6&SECTIONID=9&RAID=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "'); ");
    }
    public void BindMenu()
    {
        ...
        else
        {
            if (Request.QueryString["RevYN"] != "1")
            {
                ...
                {
                    toolbar.AddLinkButton("javascript:openNewWindow('codehelp1','','Inspection/InspectionRiskAssessmentVerification.aspx?RATEMPLATEID=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "&TYPE=4" + "')", "Verify", "VERIFY", ToolBarDirection.Right);
                }
        ...
        toolbaroperational.AddFontAwesomeButton("javascript:parent.openNewWindow('codehelp1', '','" + Session["sitepath"] + "/Inspection/InspectionRACargoOperationalHazardPickList.aspx?RAId=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "')", "Map from Aspects Register", "<i class=\"fas fa-tasks\"></i>", "ADD");
        toolbaroperational.AddFontAwesomeButton("javascript:parent.openNewWindow('codehelp1', '','" + Session["sitepath"] + "/Inspection/InspectionGobalRAOperationalHazard.aspx?RATYPE=6&RAId=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "')", "Add New Aspect", "<i class=\"fa fa-plus-circle\"></i>", "MADD");
        ...
        toolbarMachinerySafetyAfter.AddFontAwesomeButton("../Inspection/InspectionRiskAssessmentTask.aspx?RATYPE=6&TaskMode=2&Status=" + ViewState["status"].ToString() + "&Vesselid=" + ViewState["VESSELID"].ToString() + "&RAId=" + ViewState["RISKASSESSMENTCARGOID"].ToString(), "New Task", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
        ...
        toolbarMachinerySafetyDuring.AddFontAwesomeButton("../Inspection/InspectionRiskAssessmentTask.aspx?RATYPE=6&TaskMode=2&Status=" + ViewState["status"].ToString() + "&Vesselid=" + ViewState["VESSELID"].ToString() + "&RAId=" + ViewState["RISKASSESSMENTCARGOID"].ToString(), "New Task", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
        ...
        toolbarMachinerySafety.AddFontAwesomeButton("../Inspection/InspectionRiskAssessmentTask.aspx?RATYPE=6&TaskMode=0&Status=" + ViewState["status"].ToString() + "&Vesselid=" + ViewState["VESSELID"].ToString() + "&RAId=" + ViewState["RISKASSESSMENTCARGOID"].ToString(), "New Task", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
    ...
    protected void gvevent_RowDataBound(object sender, GridViewRowEventArgs ge)
    {
        ...
        if (ge.Row.RowType == DataControlRowType.Footer)
        {
            ...
            DropDownList ddlWorstCase = (DropDownList)ge.Row.FindControl("ddlWorstCase");
            ddlWorstCase.DataTextField = "FLDNAME";
            ddlWorstCase.DataValueField = "FLDHAZARDID";
            ddlWorstCase.DataSource = PhoenixInspectionRiskAssessmentHazard.ListRiskAssessmentHazard(3, null);
            ddlWorstCase.DataBind();
        }
    }
    protected void gvevent_RowCommand(object sender, GridViewCommandEventArgs gce)
    {
        try
        {
            GridView _gridView = (GridView)sender;
            int nCurrentRow = Int32.Parse(gce.CommandArgument.ToString());
            if (gce.CommandName.ToUpper().Equals("UADD"))
            {

                if (!IsValidWorstCase(((DropDownList)_gridView.FooterRow.FindControl("ddlWorstCase")).SelectedValue.ToString()))
                {
                    ucError.Visible = true;
                    return;
                }

                PhoenixInspectionOperationalRiskControls.InsertRiskAssessmentWorstCase(int.Parse(((DropDownList)_gridView.FooterRow.FindControl("ddlWorstCase")).SelectedValue.ToString()), 6,
                        new Guid(ViewState["RISKASSESSMENTCARGOID"].ToString()));

                BindGrid();

            }
            else if (gce.CommandName.ToUpper().Equals("UDELETE"))
            {
                string categoryid = ((RadLabel)_gridView.Rows[nCurrentRow].FindControl("lblWorstCaseid")).Text;
                PhoenixInspectionOperationalRiskControls.DeleteRiskAssessmentWorstCase(new Guid(categoryid));
                BindGrid();
            }
        }
        catch (Exception ex)
    ...
    private void RiskAssessmentCargoEdit()
    {
        ...
        {
            DataTable dt = PhoenixInspectionRiskAssessmentCargoExtn.EditPhoenixInspectionRiskAssessmentCargo(
    ...
    private void BindData()
    {
        ...
        chkActivities.DataSource = PhoenixInspectionRiskAssessmentActivityExtn.ListNonRoutineRiskAssessmentActivity(4, null);
    ...
    protected void MenuCargo_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("REQUESTAPPROVAL"))
            {
                if (ViewState["RISKASSESSMENTCARGOID"] != null && ViewState["RISKASSESSMENTCARGOID"].ToString() != "")
                {
                    PhoenixInspectionRiskAssessmentCargoExtn.RequestApprovalCargo(new Guid(ViewState["RISKASSESSMENTCARGOID"].ToString()));
            ...
            if (CommandName.ToUpper().Equals("CONFIRM"))
            {
                if (ViewState["COPYTYPE"].ToString() == "1")
                {
                    if (ViewState["RISKASSESSMENTCARGOID"] != null && ViewState["RISKASSESSMENTCARGOID"].ToString() != "")
                    {
                        PhoenixInspectionRiskAssessmentCargoExtn.CopyCargo(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                ...
                if (ViewState["COPYTYPE"].ToString() == "2")
                {
                    if (ViewState["RISKASSESSMENTCARGOID"] != null && ViewState["RISKASSESSMENTCARGOID"].ToString() != "")
                    {
                        PhoenixInspectionRiskAssessmentCargoExtn.ProposeCargoTemplate(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                            new Guid(ViewState["RISKASSESSMENTCARGOID"].ToString()), PhoenixSecurityContext.CurrentSecurityContext.VesselID);
    ...
    private void SaveRiskAssessmentCargo()
    {
        try
        {
            ...
            PhoenixInspectionRiskAssessmentCargoExtn.InsertPhoenixInspectionRiskAssessmentCargo(
    ...
    public void rblOptions_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (lblId != null && lblId != "")
            {
                ...
                PhoenixInspectionRiskAssessmentCargoExtn.UpdateControl(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            ...
            else
            {
                ...
                PhoenixInspectionRiskAssessmentCargoExtn.InsertControl(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
    ...
    protected void gvHealthSafetyRisk_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        try
        {
            ...
            ds = PhoenixInspectionRiskAssessmentCargoExtn.ListCargoCategory(1, General.GetNullableGuid(ViewState["RISKASSESSMENTCARGOID"].ToString()),
    ...
    protected void gvEnvironmentalRisk_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            DataSet ds = new DataSet();
            ds = PhoenixInspectionRiskAssessmentCargoExtn.ListCargoCategory(2, General.GetNullableGuid(ViewState["RISKASSESSMENTCARGOID"].ToString()),
            General.GetNullableInteger(ViewState["VESSELID"].ToString()));
    ...
    protected void gvEconomicRisk_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            DataSet ds = new DataSet();
            ds = PhoenixInspectionRiskAssessmentCargoExtn.ListCargoCategory(4, General.GetNullableGuid(ViewState["RISKASSESSMENTCARGOID"].ToString()),
            General.GetNullableInteger(ViewState["VESSELID"].ToString()));
        ...
        try
        {
            if (e.Item is GridEditableItem)
            {
                ...
                if (e.CommandName.ToUpper().Equals("CDELETE"))
                {
                    ...
                    PhoenixInspectionRiskAssessmentCargoExtn.DeleteCargoCategory(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                        new Guid(Healthid));
    ...
    protected void gvPersonal_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            DataSet ds = new DataSet();
            ds = PhoenixInspectionRiskAssessmentCargoExtn.ListControl(General.GetNullableGuid(ViewState["RISKASSESSMENTCARGOID"].ToString()),
                General.GetNullableInteger(ViewState["VESSELID"].ToString()));
        ...
        try
        {
            if (e.Item is GridEditableItem)
            {
                ...
                if (e.CommandName.ToUpper().Equals("RDELETE"))
                {
                    ...
                    {
                        PhoenixInspectionRiskAssessmentCargoExtn.DeleteControl(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                       new Guid(controlid));
                        gvPersonal.Rebind();
                    }
                }
    ...
    protected void gvRAOperationalHazard_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            DataSet ds = new DataSet();
            ds = PhoenixInspectionRiskAssessmentCargoExtn.ListOperationalHazard(General.GetNullableGuid(ViewState["RISKASSESSMENTCARGOID"].ToString()));
        ...
        try
        {
            if (e.Item is GridEditableItem)
            {
                ...
                if (e.CommandName.ToUpper().Equals("ASPECTDELETE"))
                {
                    ...
                    PhoenixInspectionRiskAssessmentCargoExtn.DeleteOperationalHazard(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
    ...
    protected void gvRAOperationalHazard_ItemDataBound(object sender, GridItemEventArgs e)
    {
        try
        {
            if (e.Item is GridEditableItem)
            {
                ...
                if (cmdEdit != null)
                {
                    cmdEdit.Attributes.Add("onclick", "openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Inspection/InspectionOperationalRiskHazardMapping.aspx?ratypeid=6&Operationalhazardid=" + lblOperationalId.Text + "&RAID=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "'); return true;");
                }
                ...
                if (cmdAspectEdit != null)
                {
                    ...
                    cmdAspectEdit.Attributes.Add("onclick", "javascript:parent.openNewWindow('codehelp1','', '" + Session["sitepath"] + "/Inspection/InspectionRAOperationalAspectsEdit.aspx?RATYPE=6&Operationalhazardid=" + lblOperationalId.Text + "');return true;");
                }
    ...
    protected void gvevent_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        {
            DataSet ds = new DataSet();
            ds = PhoenixInspectionOperationalRiskControls.ListRiskAssessmentworstcase(General.GetNullableGuid(ViewState["RISKASSESSMENTCARGOID"].ToString()), 6);
    ...
    protected void gvevent_ItemDataBound(object sender, GridItemEventArgs e)
    {
        try
        {
            if (e.Item is GridEditableItem)
            {
                ...
                {
                    DataSet dss = PhoenixInspectionRiskAssessmentJobHazardExtn.UndesirableeventFormposterList(General.GetNullableGuid(lblWorstcaseid.Text), General.GetNullableGuid(ViewState["RISKASSESSMENTCARGOID"].ToString()));
                    int number = 1;
    ...
    protected void gvMachinerySafetyAfter_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            if (e.Item is GridEditableItem)
            {
                ...
                {
                    Response.Redirect("../Inspection/InspectionRiskAssessmentTask.aspx?RATYPE=6&TaskMode=1&Status=" + ViewState["status"].ToString() + "&Vesselid=" + ViewState["VESSELID"].ToString() + "&RAId=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "&Taskid=" + machinerysafteyid, false);
                }
            }
        }
        catch (Exception ex)
    ...
    protected void gvMachinerySafetyDuring_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            if (e.Item is GridEditableItem)
            {
                ...
                {
                    Response.Redirect("../Inspection/InspectionRiskAssessmentTask.aspx?RATYPE=6&TaskMode=2&Status=" + ViewState["status"].ToString() + "&Vesselid=" + ViewState["VESSELID"].ToString() + "&RAId=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "&Taskid=" + machinerysafteyid, false);
                }
            }
        }
        catch (Exception ex)
    ...
    protected void gvMachinerySafety_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            if (e.Item is GridEditableItem)
            {
                ...
                {
                    Response.Redirect("../Inspection/InspectionRiskAssessmentTask.aspx?RATYPE=6&TaskMode=0&Status=" + ViewState["status"].ToString() + "&Vesselid=" + ViewState["VESSELID"].ToString() + "&RAId=" + ViewState["RISKASSESSMENTCARGOID"].ToString() + "&Taskid=" + machinerysafteyid, false);
                }
            }
        }
        catch (Exception ex)
    ...
    protected void lnkComponentAdd_Click(object sender, EventArgs e)
    {
        ...
        {
            if (ViewState["RISKASSESSMENTCARGOID"].Equals(""))
            {
                ucError.ErrorMessage = "Add the Template first and then add Hazard.";
                return;
            }
            PhoenixInspectionRiskAssessmentJobHazardExtn.UpdateRAComponents(new Guid(ViewState["RISKASSESSMENTCARGOID"].ToString()), new Guid(txtComponentId.Text), 6);
    ...
    {
        DataSet ds = PhoenixInspectionRiskAssessmentJobHazardExtn.JHAImpactEquipmentList(General.GetNullableGuid(ViewState["IMPACTID"].ToString()), 6);
    ...
    {
        DataSet ds = PhoenixInspectionRiskAssessmentJobHazardExtn.JHAEventEquipmentList(General.GetNullableGuid(ViewState["EVENTID"].ToString()), 6);
        chkEquipment.DataSource = ds.Tables[0];
        chkEquipment.DataBind();
    ...
    {
        DataSet dss = PhoenixInspectionRiskAssessmentJobHazardExtn.RAComponentList(ViewState["RISKASSESSMENTCARGOID"].ToString() == "" ? null : General.GetNullableGuid(ViewState["RISKASSESSMENTCARGOID"].ToString()), 6);
        int number = 1;
        if (dss.Tables[0].Rows.Count > 0)
        {
    ...
    void com_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (c.Checked == false)
        {
            PhoenixInspectionRiskAssessmentJobHazardExtn.RAComponentDelete(new Guid(ViewState["RISKASSESSMENTCARGOID"].ToString()), new Guid(c.ID), 6);
    ...
    {
        DataSet dss = PhoenixInspectionRiskAssessmentJobHazardExtn.RAFormPosterCheckList(ViewState["RISKASSESSMENTCARGOID"] == null ? null : General.GetNullableGuid(ViewState["RISKASSESSMENTCARGOID"].ToString()), General.GetNullableInteger("0"), 6);
        int number = 1;
        if (dss.Tables[0].Rows.Count > 0)
        {
            tblForms.Rows.Clear();
    ...
    {
        DataSet dss = PhoenixInspectionRiskAssessmentJobHazardExtn.RAFormPosterCheckList(ViewState["RISKASSESSMENTCARGOID"] == null ? null : General.GetNullableGuid(ViewState["RISKASSESSMENTCARGOID"].ToString()), General.GetNullableInteger("1"),6);
        int number = 1;
        if (dss.Tables[0].Rows.Count > 0)
        {
    ...
    void cb_CheckedChanged(object sender, EventArgs e)
    {
        ...
        if (c.Checked == false)
        {
            PhoenixInspectionRiskAssessmentJobHazardExtn.RAFormPosterChecklistDelete(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                new Guid(ViewState["RISKASSESSMENTCARGOID"].ToString()), new Guid(c.ID), int.Parse("0"), 6);
    ...
    void doccb_CheckedChanged(object sender, EventArgs e)
    {
        ...
        {
            PhoenixInspectionRiskAssessmentJobHazardExtn.RAFormPosterChecklistDelete(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
               new Guid(ViewState["RISKASSESSMENTCARGOID"].ToString()), new Guid(c.ID), int.Parse("1"), 6);
    ...
    protected void lnkFormAdd_Click(object sender, EventArgs e)
    {
        try
        {
            if (ViewState["RISKASSESSMENTCARGOID"] == null || ViewState["RISKASSESSMENTCARGOID"].ToString() == string.Empty)
            {
            ...
            if (General.GetNullableGuid(txtDocumentId.Text) != null)
            {
                PhoenixInspectionRiskAssessmentJobHazardExtn.UpdateRAFormsandchecklist(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                        new Guid(ViewState["RISKASSESSMENTCARGOID"].ToString()), new Guid(txtDocumentId.Text), 6);
        ...
        try
        {
            ...
            if (General.GetNullableGuid(txtdocumentProcedureId.Text) != null)
            {
                PhoenixInspectionRiskAssessmentJobHazardExtn.UpdateRAEmergencyProcedures(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                    new Guid(ViewState["RISKASSESSMENTCARGOID"].ToString()), new Guid(txtdocumentProcedureId.Text), 6);
        ...
        if (Page.IsValid)
        {
            try
            {
                ...
                if (ViewState["RequestFrom"].ToString() == "EVENT")
                {
                    ...
                    , General.GetNullableInteger(ddlWorstCase.SelectedValue), 6);
                ...
                {
                    PhoenixInspectionRiskAssessmentJobHazardExtn.UpdateJHAImpactComponents(new Guid(ViewState["IMPACTID"].ToString()), General.RadCheckBoxList(chkEquipment), General.ReadCheckBoxList(cblRecomendedPPE), General.RadCheckBoxList(chkEvent), 6);
                    ucStatus.Text = "Equipment added.";
