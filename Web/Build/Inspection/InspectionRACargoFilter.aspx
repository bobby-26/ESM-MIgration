<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRACargoFilter.aspx.cs"
    Inherits="InspectionRACargoFilter" %>
...
<head runat="server">
    <title>Inspection RA Cargo Filter</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    ...
    <div class="subHeader" style="position: relative">
        <div id="divHeading" style="vertical-align: top">
            <asp:Label runat="server" ID="lblCaption" Font-Bold="true" Text="Cargo RA Filter"></asp:Label>
        </div>
    </div>
    <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
        <eluc:TabStrip ID="MenuRACargoFilter" runat="server" OnTabStripCommand="MenuRACargoFilter_TabStripCommand">
        </eluc:TabStrip>
    </div>    
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" CombineScripts="false">
    </ajaxToolkit:ToolkitScriptManager>
    <asp:UpdatePanel runat="server" ID="pnlRACargo">
        <ContentTemplate>
        <br />
