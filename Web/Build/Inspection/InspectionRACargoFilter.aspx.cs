...
public partial class InspectionRACargoFilter : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            MenuRACargoFilter.AccessRights = this.ViewState;
            MenuRACargoFilter.MenuList = toolbar.Show();
            txtRefNo.Focus();
            BindStatus();
    ...
    protected void MenuRACargoFilter_TabStripCommand(object sender, EventArgs e)
    {
