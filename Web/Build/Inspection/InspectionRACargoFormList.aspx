<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRACargoFormList.aspx.cs" Inherits="InspectionRACargoFormList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="gvRiskAssessmentCargo" runat="server" AutoGenerateColumns="False"
            Font-Size="11px" Width="100%" CellPadding="3" ShowHeader="true" EnableViewState="false"
            OnRowDataBound="gvRiskAssessmentCargo_RowDataBound"
            OnRowCommand="gvRiskAssessmentCargo_RowCommand">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Risks/Aspects">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="lblCargoFormid" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDRISKASSESSMENTGENERICFORMID")  %>' Visible="false"></asp:Label>
