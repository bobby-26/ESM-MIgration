<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRACargoList.aspx.cs"
    Inherits="InspectionRACargoList" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $("#gvRiskAssessmentCargo").height(browserHeight - 40);
            });
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentCargo" runat="server" AutoGenerateColumns="False" AllowSorting="true" AllowPaging="true" AllowCustomPaging="true"
                Font-Size="11px" Width="100%" Height="78%" CellPadding="3" ShowHeader="true" EnableViewState="true" GroupingEnabled="false" EnableHeaderContextMenu="true"
                OnItemDataBound="gvRiskAssessmentCargo_ItemDataBound" OnNeedDataSource="gvRiskAssessmentCargo_NeedDataSource" DataKeyNames="FLDRISKASSESSMENTCARGOID"
                OnItemCommand="gvRiskAssessmentCargo_ItemCommand" OnSortCommand="gvRiskAssessmentCargo_SortCommand" GridLines="None">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Intended Work" AllowSorting="true" SortExpression="FLDINTENDEDWORKDATE" ShowSortIcon="true">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <HeaderTemplate>
                                <asp:LinkButton ID="lnkintendedWorkDateHeader" runat="server" CommandName="Sort" CommandArgument="FLDINTENDEDWORKDATE"></asp:LinkButton>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Type" HeaderStyle-Width="110px" Visible="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn AllowSorting="true" SortExpression="FLDDATE" ShowSortIcon="true" HeaderText="Rev.No" HeaderStyle-Width="50px">
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="165px" HeaderText="Action">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:LinkButton runat="server" AlternateText="Cargo PDF" CommandName="RACARGO"
                                    ID="cmdRACargo" ToolTip="Show PDF">
