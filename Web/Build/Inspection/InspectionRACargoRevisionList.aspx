<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRACargoRevisionList.aspx.cs" Inherits="InspectionRACargoRevisionList" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#gvRiskAssessmentCargoRevision").height(browserHeight - 90);
            });
        </script>
...
<body>
    <form id="form1" runat="server">
        ...
        <eluc:Title runat="server" ID="ucTitle" Text="Cargo Revisions" ShowMenu="false" Visible="false" />
        <asp:Button ID="cmdHiddenSubmit" runat="server" Text="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" CssClass="hidden" />
        <eluc:TabStrip ID="MenuCargo" runat="server" OnTabStripCommand="MenuCargo_TabStripCommand"></eluc:TabStrip>
        <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentCargoRevision" runat="server" AutoGenerateColumns="False" AllowPaging="true" AllowCustomPaging="true"
            Font-Size="11px" Width="100%" Height="91.5%" CellPadding="3" ShowHeader="true" EnableViewState="false" OnNeedDataSource="gvRiskAssessmentCargoRevision_NeedDataSource"
            OnItemDataBound="gvRiskAssessmentCargoRevision_ItemDataBound" DataKeyNames="FLDRISKASSESSMENTCARGOID" GroupingEnabled="false" EnableHeaderContextMenu="true">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Activity / Conditions">
                        ...
                        <ItemTemplate>
                            ...
                            <telerik:RadLabel ID="lblWorkActivity" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDACTIVITYCONDITIONS").ToString().Length > 60 ? DataBinder.Eval(Container, "DataItem.FLDACTIVITYCONDITIONS").ToString().Substring(0, 60) + "..." : DataBinder.Eval(Container, "DataItem.FLDACTIVITYCONDITIONS").ToString() %>'></telerik:RadLabel>
