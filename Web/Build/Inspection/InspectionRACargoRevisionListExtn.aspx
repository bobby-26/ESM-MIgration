<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRACargoRevisionListExtn.aspx.cs" Inherits="InspectionRACargoRevisionListExtn" %>
...
<head runat="server">
    <title>Cargo Revision</title><telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
    ...
    <form id="form1" runat="server">
     <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentCargoRevision" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                OnItemDataBound="gvRiskAssessmentCargoRevision_ItemDataBound" OnNeedDataSource="gvRiskAssessmentCargoRevision_NeedDataSource">
