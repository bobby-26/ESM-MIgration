<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRACargoTemplateAdd.aspx.cs" Inherits="Inspection_InspectionRACargoTemplateAdd" MaintainScrollPositionOnPostback="true" %>
...
<head runat="server">
    <title>Risk Assessment Cargo</title>
...
<body>
    <form id="frmCargo" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <eluc:Title runat="server" ID="ucTitle" Text="Cargo" ShowMenu="true" Visible="false" />
            ...
            <table border="1" width="99.9%" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadComboBox ID="ddlCategory" runat="server" CssClass="dropdown_mandatory" AppendDataBoundItems="true" Width="270px"
                    ...
                    <tr valign="middle">
                        ...
                        <td colspan="3">
                            <telerik:RadTextBox ID="txtAternativeMethod" runat="server" CssClass="input" Width="700px"
                    ...
                    <tr valign="middle">
                        ...
                        <td colspan="3">
                            ...
                            <eluc:Hazard ID="ucHazardType" runat="server" AppendDataBoundItems="true" CssClass="dropdown_mandatory"
                                Type="1" AutoPostBack="true" OnTextChangedEvent="ucHazardType_TextChangedEvent" Width="200px" />
                            <br />
                            <br />
                            <telerik:RadGrid RenderMode="Lightweight" ID="gvHealthSafetyRisk" runat="server" AutoGenerateColumns="False"
                                OnItemCommand="gvHealthSafetyRisk_ItemCommand" Font-Size="11px" Width="99.9%" CellPadding="3" GroupingEnabled="false" EnableHeaderContextMenu="true"
                                ShowHeader="true" ShowFooter="true" EnableViewState="false" OnItemDataBound="gvHealthSafetyRisk_ItemDataBound" OnNeedDataSource="gvHealthSafetyRisk_NeedDataSource">
                    ...
                    <tr valign="middle">
                        ...
                        <td colspan="3">
                            ...
                            <br />
                            <br />
                            <telerik:RadGrid RenderMode="Lightweight" ID="gvEnvironmentalRisk" runat="server" AutoGenerateColumns="False"
                                Font-Size="11px" Width="99.9%" CellPadding="3" ShowHeader="true" ShowFooter="true" GroupingEnabled="false" EnableHeaderContextMenu="true"
                                EnableViewState="false" OnItemDataBound="gvEnvironmentalRisk_ItemDataBound" OnItemCommand="gvEnvironmentalRisk_ItemCommand" OnNeedDataSource="gvEnvironmentalRisk_NeedDataSource">
                                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                    AutoGenerateColumns="false">
                                    <ColumnGroups>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <eluc:Hazard ID="ucEconomicHazardType" runat="server" AppendDataBoundItems="true"
                                CssClass="dropdown_mandatory" Type="4" AutoPostBack="true" OnTextChangedEvent="ucEconomicHazardType_OnTextChangedEvent" Width="200px" />
                            <br />
                            <br />
                    ...
                    <tr valign="middle">
                        ...
                        <td colspan="3">
                            <telerik:RadCheckBoxList ID="cblProposedControl" runat="server" Direction="Vertical"
                                Columns="2" AutoPostBack="true" OnTextChanged="OtherDetailClick" />
                            <br />
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <telerik:RadGrid RenderMode="Lightweight" ID="gvCargoSafety" runat="server" AutoGenerateColumns="False" Font-Size="11px" GroupingEnabled="false" EnableHeaderContextMenu="true"
                                Width="99.9%" ShowHeader="true" ShowFooter="true" EnableViewState="false" OnNeedDataSource="gvCargoSafety_NeedDataSource"
                                OnItemDataBound="gvCargoSafety_ItemDataBound" OnItemCommand="gvCargoSafety_ItemCommand">
                                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                    AutoGenerateColumns="false">
                                    <ColumnGroups>
                                    ...
                                    <Columns>
                                        <telerik:GridTemplateColumn HeaderText="S.No" HeaderStyle-Width="7%">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <telerik:RadLabel ID="lblCargoSafetyId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCARGOSAFETYID") %>'
                                                    Visible="false">
                                                </telerik:RadLabel>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="ActualStart Date" HeaderStyle-Width="17%">
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadLabel ID="lblCargoSafetyIdEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCARGOSAFETYID") %>'
                                                    Visible="false">
                                                </telerik:RadLabel>
