<%@ Page Language="C#" AutoEventWireup="True" CodeFile="InspectionRACategory.aspx.cs" Inherits="InspectionRACategory"
...
<body>
    <form id="frmRACategory" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
            ...
            <eluc:Title runat="server" ID="ucTitle" Text="Type" Visible="false"></eluc:Title>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRACategory" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowPaging="true" AllowCustomPaging="true"
                ...
                OnNeedDataSource="gvRACategory_NeedDataSource" OnRowDeleting="gvRACategory_RowDeleting" AllowSorting="true"
                OnRowUpdating="gvRACategory_RowUpdating" ShowFooter="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Code" HeaderStyle-Width="10%" AllowSorting="true" ShowSortIcon="true" SortExpression="FLDCODE">
                            ...
                            <EditItemTemplate>
                                <telerik:RadTextBox ID="txtCodeEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCODE") %>'
                                    CssClass="gridinput" MaxLength="10" Width="98%">
                                </telerik:RadTextBox>
                            </EditItemTemplate>
                            <FooterTemplate>
                                <telerik:RadTextBox ID="txtCodeAdd" runat="server" CssClass="gridinput" MaxLength="10" Width="98%"></telerik:RadTextBox>
                            </FooterTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" AllowSorting="true" ShowSortIcon="true" SortExpression="FLDNAME">
                            ...
                            <FooterTemplate>
                                <telerik:RadTextBox ID="txtNameAdd" runat="server" CssClass="gridinput_mandatory" Width="98%" MaxLength="200"></telerik:RadTextBox>
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
