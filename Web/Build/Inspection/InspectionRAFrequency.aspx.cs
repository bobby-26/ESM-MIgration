...
public partial class InspectionRAFrequency : PhoenixBasePage
{
	protected void Page_Load(object sender, EventArgs e)
	{
		try
		{
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionRAFrequency.aspx?" + Request.QueryString["type"], "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "EXCEL");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvRAFrequency')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("../Inspection/InspectionRAFrequency.aspx?type=" + Request.QueryString["type"], "Find", "<i class=\"fas fa-search\"></i>", "FIND");
	...
	protected void ShowExcel()
	{
		...
		ds = PhoenixInspectionRiskAssessmentFrequency.RiskAssessmentFrequencySearch(General.GetNullableString(txtName.Text),
    ...
    private void InsertRAFrequency(string Frequency, string score, string type, int? byvessel, string shortcode)
	{
		...
		PhoenixInspectionRiskAssessmentFrequency.InsertRiskAssessmentFrequency(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
    ...
    private void UpdateRAFrequency(int Frequencyid, string Frequency, string score, string type, int? byvessel, string shortcode)
	{
		...
		PhoenixInspectionRiskAssessmentFrequency.UpdateRiskAssessmentFrequency(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
    ...
    private bool IsValidRAFrequency(string Frequency, string score, string shortcode)
    {
        ...
        if (ViewState["TYPE"].ToString() == "4" || ViewState["TYPE"].ToString() == "2")
        {
	...
	{
		PhoenixInspectionRiskAssessmentFrequency.DeleteRiskAssessmentFrequency(PhoenixSecurityContext.CurrentSecurityContext.UserCode, Frequencyid);
	}
