...
public partial class InspectionRAGenericAspectList : PhoenixBasePage
{
    ...
    protected void gvRAOperationalHazard_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        try
        {
            ...
            ds = PhoenixInspectionRiskAssessmentGenericExtn.ListOperationalHazard(General.GetNullableGuid(ViewState["RAID"].ToString()));
