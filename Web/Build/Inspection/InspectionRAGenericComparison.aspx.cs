...
public partial class InspectionRAGenericComparison : PhoenixBasePage
{
    ...
    {
        DataSet ds = PhoenixInspectionRiskAssessmentGeneric.InspectionRiskAssessmentGenericComparison(
