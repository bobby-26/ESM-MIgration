<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAGenericDetails.aspx.cs"
    Inherits="InspectionRAGenericDetails" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <table border="1" width="99.9%" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Company ID="ucCompany" runat="server" CssClass="input_mandatory" Width="330px" AppendDataBoundItems="true" />
                    </td>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadComboBox ID="ddlCategory" runat="server" CssClass="dropdown_mandatory" AppendDataBoundItems="true"
                                AutoPostBack="True" Filter="Contains" Width="330px">
                                <Items>
                    ...
                    <tr valign="top">
                        ...
                        <td colspan="3">
                            <telerik:RadCheckBoxList ID="cblReason" runat="server" Columns="3"
                                AutoPostBack="true" OnTextChanged="OtherDetailClick">
                            </telerik:RadCheckBoxList>
                            <br />
                            <telerik:RadTextBox ID="txtOtherReason" runat="server" CssClass="readonlytextbox" Width="700px"
                                Height="80px" TextMode="MultiLine" Resize="Both" ReadOnly="true" onKeyUp="TxtMaxLength(this,700)"
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <%--      <telerik:RadTextBox ID="txtWorkDetails" runat="server" CssClass="input_mandatory" Width="360px"
                                        Rows="4" TextMode="MultiLine" Resize="Both"></telerik:RadTextBox>--%>
                    ...
                    <tr valign="top">
                        ...
                        <td colspan="3">
                            ...
                            <br />
                            <br />
                            <telerik:RadGrid ID="gvEnvironmentalRisk" runat="server" CellSpacing="0" GridLines="None" AutoGenerateColumns="False"
                                ...
                                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Impact Type">
                                            ...
                                            <FooterTemplate>
                                                <eluc:Miscellaneous ID="ucImpactType" width="100%" AppendDataBoundItems="true" runat="server"
                    ...
                    <tr valign="top">
                        ...
                        <td colspan="3">
                            <telerik:RadCheckBoxList ID="cblOtherRisk" runat="server" Columns="4"
                                AutoPostBack="true" OnTextChanged="OtherDetailClick">
                            </telerik:RadCheckBoxList>
                            <%--<br />
                                Details
                    ...
                    <tr valign="top">
                        ...
                        <td colspan="3">
                            <telerik:RadCheckBoxList ID="cblProposedControl" runat="server"
                            ...
                            <telerik:RadTextBox ID="txtProposedControlDetails" runat="server" CssClass="readonlytextbox"
                                TextMode="MultiLine" Rows="3" Resize="Both" Width="700px" Height="80px" ReadOnly="true">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <telerik:RadGrid ID="gvGenericSafety" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                                Width="100%" ShowHeader="true" ShowFooter="true" EnableViewState="true" OnItemCommand="gvGenericSafety_ItemCommand"
                                OnItemDataBound="gvGenericSafety_ItemDataBound" EnableHeaderContextMenu="true" GroupingEnabled="false">
                                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                                <GroupingSettings ShowUnGroupButton="true"></GroupingSettings>
                                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                    AutoGenerateColumns="false" DataKeyNames="FLDGENERICSAFETYID">
                                    <NoRecordsTemplate>
                                        <table runat="server" width="100%" border="0">
                                            <tr>
                                                <td align="center">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="PIC">
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadLabel ID="lblGenericSafetyIdEdit" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDGENERICSAFETYID") %>'></telerik:RadLabel>
                                                <span id="spnPICEdit">
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Remarks">
                                            ...
                                            <EditItemTemplate>
                                                <telerik:RadTextBox ID="txtRemarksEdit" runat="server" TextMode="MultiLine" CssClass="input_mandatory" Resize="Both"
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <telerik:RadTextBox ID="txtRemarks" runat="server" CssClass="readonlytextbox" Width="360px"
                                TextMode="MultiLine" Rows="4" Resize="Both" ReadOnly="true">
                            </telerik:RadTextBox>
                        </td>
                        <td valign="top">
                        ...
                        <td>
                            <telerik:RadTextBox ID="txtMasterRemarks" runat="server" CssClass="readonlytextbox" TextMode="MultiLine"
                                Rows="4" ReadOnly="true" Resize="Both" Width="280px">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
            </table>
