<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAGenericExtn.aspx.cs" Inherits="InspectionRAGenericExtn" %>
...
<body>
    <form id="frmGeneric" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <table id="tblGeneric" width="100%" cellspacing="3">
                <tr>
                    <td width="10%">
