<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAGenericList.aspx.cs"
    Inherits="InspectionRAGenericList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <eluc:TabStrip ID="MenuGenericMain" runat="server" TabStrip="false" OnTabStripCommand="MenuGenericMain_TabStripCommand" Title="Generic"></eluc:TabStrip>
            <eluc:TabStrip ID="MenuGeneric" runat="server" OnTabStripCommand="MenuGeneric_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid ID="gvRiskAssessmentGeneric" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" Height="87%"
