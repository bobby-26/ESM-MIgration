<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAGenericRevisionListExtn.aspx.cs" Inherits="InspectionRAGenericRevisionListExtn" %>
...
<head runat="server">
    <title>Generic Revision</title><telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
    ...
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
                ...
                <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>                
                    ...
                    <eluc:TabStrip ID="MenuGeneric" runat="server" OnTabStripCommand="MenuGeneric_TabStripCommand">
                    </eluc:TabStrip>
               <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentGenericRevision" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                OnItemDataBound="gvRiskAssessmentGenericRevision_ItemDataBound" OnNeedDataSource="gvRiskAssessmentGenericRevision_NeedDataSource">
                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                <GroupingSettings ShowUnGroupButton="true"></GroupingSettings>
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDRISKASSESSMENTGENERICID">
                    <NoRecordsTemplate>
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Ref. No">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lnkRefNo" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDNUMBER")  %>'></telerik:RadLabel>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Activity / Conditions" HeaderStyle-Width="30%">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lblRevisionno" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREVISIONNO")  %>'
                                    Visible="false"></telerik:RadLabel>
                                <asp:LinkButton ID="lnkWorkActivity" runat="server" CommandName="NAVIGATE" 
                                    Text='<%# DataBinder.Eval(Container,"DataItem.FLDACTIVITYCONDITIONS")  %>'></asp:LinkButton>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>                        
                        <telerik:GridTemplateColumn HeaderText="Rev No" HeaderStyle-Width="7%">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblRevno" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREVISIONNO")  %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Status" HeaderStyle-Width="13%">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
