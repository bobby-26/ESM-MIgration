<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAGenericTemplateAdd.aspx.cs" Inherits="Inspection_InspectionRAGenericTemplateAdd" MaintainScrollPositionOnPostback="true" %>
            ...
            <table border="1" width="100%" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <telerik:RadRadioButtonList ID="rblPeopleInvolved" runat="server" Direction="Horizontal" Columns="4">
                    ...
                    <tr valign="middle">
                        ...
                        <td colspan="3">
                            ...
                            <telerik:RadGrid RenderMode="Lightweight" ID="gvHealthSafetyRisk" runat="server" AutoGenerateColumns="False"
                               OnItemCommand="gvHealthSafetyRisk_ItemCommand" Font-Size="11px" Width="100%" CellPadding="3" GroupingEnabled="false" EnableHeaderContextMenu="true"
                    ...
                    <tr valign="middle">
                        ...
                        <td colspan="3">
                            ...
                            <br />
                            <br />
                            <telerik:RadGrid ID="gvEnvironmentalRisk" runat="server" AutoGenerateColumns="False"
                                Font-Size="11px" Width="100%" CellPadding="3" ShowHeader="true" ShowFooter="true" GroupingEnabled="false" EnableHeaderContextMenu="true"
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <br />
                            <br />
                            <telerik:RadGrid ID="gvEconomicRisk" runat="server" AutoGenerateColumns="False" Font-Size="11px" GroupingEnabled="false" EnableHeaderContextMenu="true"
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <telerik:RadGrid ID="gvGenericSafety" runat="server" AutoGenerateColumns="False" Font-Size="11px" GroupingEnabled="false" EnableHeaderContextMenu="true"
                                Width="100%" ShowHeader="true" ShowFooter="true" EnableViewState="false" OnItemCommand="gvGenericSafety_ItemCommand"
                                OnItemDataBound="gvGenericSafety_ItemDataBound" OnRowEditing="gvGenericSafety_RowEditing" OnNeedDataSource="gvGenericSafety_NeedDataSource">
                                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                    AutoGenerateColumns="false">
                                    <ColumnGroups>
