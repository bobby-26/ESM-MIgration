<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAGenericTemplateDetails.aspx.cs" Inherits="Inspection_InspectionRAGenericTemplateDetails" %>
                    ...
                    <table border="1" width="100%" cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:GridView ID="gvGenericSafety" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                                        Width="100%" ShowHeader="true" ShowFooter="true" EnableViewState="false" OnRowCommand="gvGenericSafety_RowCommand"
                                        OnRowDataBound="gvGenericSafety_RowDataBound" OnRowEditing="gvGenericSafety_RowEditing"
                                        OnRowCancelingEdit="gvGenericSafety_RowCancelingEdit">
                                        <HeaderStyle CssClass="DataGrid-HeaderStyle" />
                                        <FooterStyle CssClass="datagrid_footerstyle"></FooterStyle>
                                        <AlternatingRowStyle CssClass="datagrid_alternatingstyle" />
                                        <SelectedRowStyle CssClass="datagrid_selectedstyle" />
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="S.No">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblGenericSafetyId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDGENERICSAFETYID") %>'
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <EditItemTemplate>
                                                    <asp:Label ID="lblGenericSafetyIdEdit" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDGENERICSAFETYID") %>'></asp:Label>
                                                    <span id="spnPICEdit">
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <EditItemTemplate>
                                                    <eluc:Date ID="ucActualFinishDateEdit" runat="server" CssClass="input_mandatory" Width="60px"
