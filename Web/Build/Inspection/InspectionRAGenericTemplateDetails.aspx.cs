...
using System.Web;
public partial class Inspection_InspectionRAGenericTemplateDetails : PhoenixBasePage
{
    ...
    private void BindGridGenericSafety()
    {
        ...
        else
        {
            ...
            DataTable dt = ds.Tables[0];
            ShowNoRecordsFound(dt, gvGenericSafety);
        }
    }
    ...
    protected void gvGenericSafety_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    protected void gvGenericSafety_RowCommand(object sender, GridViewCommandEventArgs gce)
    {
        try
        {
            GridView _gridView = (GridView)sender;
            ...
            {
                string genericsafteyid = ((Label)_gridView.Rows[nCurrentRow].FindControl("lblGenericSafetyId")).Text;
            ...
            else if (gce.CommandName.ToUpper().Equals("SUPDATE"))
            {
                ...
                string genericsafteyid = ((Label)_gridView.Rows[nCurrentRow].FindControl("lblGenericSafetyIdEdit")).Text;
