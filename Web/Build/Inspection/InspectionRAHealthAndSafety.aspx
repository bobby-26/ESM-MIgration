<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAHealthAndSafety.aspx.cs"
    Inherits="InspectionRAHealthAndSafety" %>
...
<body>
    <form id="frmRAHealthAndSafety" runat="server" autocomplete="off">
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    </ajaxToolkit:ToolkitScriptManager>
    <asp:UpdatePanel runat="server" ID="pnlRAHealthAndSafety">
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative;">
                    <span class="navSelect" style="margin-top: 0px; float: right; width: auto;">
                        <eluc:TabStrip ID="MenuHealthAndSafety" runat="server" OnTabStripCommand="HealthAndSafety_TabStripCommand">
                        </eluc:TabStrip>
                    </span>
                </div>
                <table width="100%" cellpadding="1" cellspacing="3">
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:HazardType ID="ucHazardType" runat="server" Type="1" CssClass="dropdown_mandatory"
                ...
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuGridHealthAndSafety" runat="server" OnTabStripCommand="GridHealthAndSafety_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="divGrid" style="position: relative; z-index: 0">
                    <asp:GridView ID="gvHealthAndSafety" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowCommand="gvHealthAndSafety_RowCommand" OnRowDataBound="gvHealthAndSafety_ItemDataBound"
                        OnRowDeleting="gvHealthAndSafety_RowDeleting"
                        AllowSorting="true" OnRowEditing="gvHealthAndSafety_RowEditing" OnSorting="gvHealthAndSafety_Sorting"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <HeaderTemplate>
                                    <asp:Label ID="lblHazardHeader" runat="server">Hazard</asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:label ID="lblProbabiliytofOccuranceHeader" runat="server">Probabilty of occurance</asp:label>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Label ID="lblLikelyhoodOfHarmHeader" runat="server">Likelyhood of Harm</asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
