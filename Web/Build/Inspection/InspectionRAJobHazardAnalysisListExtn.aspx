<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAJobHazardAnalysisListExtn.aspx.cs"
    Inherits="InspectionRAJobHazardAnalysisListExtn" %>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Hazard Number" DataField="FLDHAZARDNUMBER" UniqueName="FLDHAZARDNUMBER"
                            FilterDelay="2000" HeaderStyle-Width="7%" FilterControlWidth="99%"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Process" HeaderStyle-Width="11%" FilterDelay="200" ShowFilterIcon="false" UniqueName="FLDSUBCATEGORY">
                            <FilterTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Job" DataField="FLDJOB" UniqueName="FLDJOB"
                            HeaderStyle-Width="21%" FilterDelay="2000" FilterControlWidth="99%"
                            AutoPostBackOnFilter="false" ShowFilterIcon="false" CurrentFilterFunction="Contains">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Status" HeaderStyle-Width="9%" FilterDelay="200" ShowFilterIcon="false" UniqueName="FLDSTATUSID">
                            <FilterTemplate>
                                <telerik:RadComboBox ID="ddlStatus" runat="server" AutoPostBack="true" AppendDataBoundItems="true" OnDataBinding="ddlStatus_DataBinding" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" SelectedValue='<%# ViewState["ddlStatus"] %>' Width="100%">
                                </telerik:RadComboBox>
                            </FilterTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Rev No" HeaderStyle-Width="4%" AllowFiltering="false" HeaderStyle-HorizontalAlign="Center">
                        ...
                        <telerik:GridTemplateColumn HeaderText="H&S" HeaderStyle-Width="3%" ColumnGroupName="Level of Residual Risk" HeaderStyle-Font-Size="X-Small" AllowFiltering="false">
                            <ItemStyle Wrap="true" HorizontalAlign="Center" Width="3%" Font-Size="X-Small"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblHS" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDHSRR") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="ENV" HeaderStyle-Width="3%" ColumnGroupName="Level of Residual Risk" HeaderStyle-Font-Size="X-Small" AllowFiltering="false">
                            <ItemStyle Wrap="true" HorizontalAlign="Center" Width="3%" Font-Size="X-Small"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblENV" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDENVRR") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="ECO" HeaderStyle-Width="3%" ColumnGroupName="Level of Residual Risk" HeaderStyle-Font-Size="X-Small" AllowFiltering="false">
                            <ItemStyle Wrap="true" HorizontalAlign="Center" Width="3%" Font-Size="X-Small"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblECO" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDECORR") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="WCS" HeaderStyle-Width="3%" ColumnGroupName="Level of Residual Risk" HeaderStyle-Font-Size="X-Small" AllowFiltering="false">
                            <ItemStyle Wrap="true" HorizontalAlign="Center" Width="3%" Font-Size="X-Small"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" AllowFiltering="false" HeaderStyle-Width="14%">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                            <ItemTemplate>
                                <asp:LinkButton runat="server" AlternateText="Revision" CommandName="REVISION" ID="imgrevision" ToolTip="Create Revision" Width="16px">
                                    <span class="icon"><i class="fas fa-registered"></i></span>
                                </asp:LinkButton>
                                <asp:LinkButton runat="server" AlternateText="Job Hazard" CommandName="REPORT" ID="cmdJobHazard" ToolTip="Show PDF" Width="16px">
                                    <span class="icon"><i class="fas fa-file-pdf"></i></span>
                                </asp:LinkButton>
                                <asp:LinkButton runat="server" AlternateText="Revision" CommandName="VIEWREVISION" ID="cmdRevisions" ToolTip="View Revisions" Width="16px">
                                    <span class="icon"><i class="fas fa-eye"></i></span>
                                </asp:LinkButton>
                                <asp:LinkButton runat="server" AlternateText="Copy" CommandName="COPY" ID="imgCopy" ToolTip="Copy" Width="16px">
                                    <span class="icon"><i class="fas fa-copy"></i></span>
                                </asp:LinkButton>
                                <asp:LinkButton runat="server" AlternateText="Copy JHA to Company" CommandName="OFFICECOPY" ID="imgOfficeCopy" ToolTip="Copy JHA to Company" Width="16px">
                                    <span class="icon"><i class="fas fa-file-import"></i></span>
                                </asp:LinkButton>
                                <asp:LinkButton runat="server" AlternateText="Delete" CommandName="DELETE" ID="cmdDelete" ToolTip="Delete" Width="16px">
