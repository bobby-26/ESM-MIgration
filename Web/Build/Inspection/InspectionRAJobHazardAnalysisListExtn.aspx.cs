...
public partial class InspectionRAJobHazardAnalysisListExtn : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddFontAwesomeButton("../Inspection/InspectionRAJobHazardAnalysisListExtn.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
        ...
        toolbar.AddFontAwesomeButton("../Inspection/InspectionRAJobHazardAnalysisListExtn.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
        toolbar.AddFontAwesomeButton("../Inspection/InspectionRAJobHazardAnalysisListExtn.aspx", "New Template", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
        ...
        try
        {
            ...
            if (Request.QueryString["callfrom"] != null && Request.QueryString["callfrom"].ToString() != "")
            {
                ...
                toolbar.AddImageButton("../Inspection/InspectionRAJobHazardAnalysisListExtn.aspx", "Find", "search.png", "SEARCH");
                toolbar.AddImageButton("../Inspection/InspectionRAJobHazardAnalysisListExtn.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            }
            else
            {
                ViewState["callfrom"] = "";
    ...
    protected void gvRiskAssessmentJobHazardAnalysis_ItemCommand(object sender, GridCommandEventArgs gce)
    {
        try
     {
            if (gce.CommandName.ToUpper().Equals("EDITROW"))
            {
                ...
                Response.Redirect("../Inspection/InspectionRAJobHazardAnalysisExtn.aspx?jobhazardid=" + lbl.Text + "&status=" + lblstatus.Text, false);
                Rebind();
            }
