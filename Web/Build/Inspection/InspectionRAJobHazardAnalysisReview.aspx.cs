...
public partial class InspectionRAJobHazardAnalysisReview : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
		PhoenixToolbar toolbar = new PhoenixToolbar();

		toolbar.AddImageButton("../Inspection/InspectionRAJobHazardAnalysisReview.aspx?jobhazardid=" + Request.QueryString["jobhazardid"], "Export to Excel", "icon_xls.png", "Excel");
