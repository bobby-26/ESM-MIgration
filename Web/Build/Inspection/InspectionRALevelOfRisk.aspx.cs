...
public partial class InspectionRALevelOfRisk : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionRALevelOfRisk.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvRALevel')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("../Inspection/InspectionRALevelOfRisk.aspx", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixInspectionRiskAssessmentType.RiskAssessmentLevelOfRiskSearch(
        ...
        try
        {
            if (e.Item is GridFooterItem)
            {
                if (e.CommandName.ToUpper().Equals("ADD"))
                {
                    ...
                    PhoenixInspectionRiskAssessmentType.InsertRiskAssessmentLevelOfRisk(
            ...
            if (e.Item is GridEditableItem)
            {
                ...
                {
                    PhoenixInspectionRiskAssessmentType.DeleteRiskAssessmentLevelOfRisk(
                                                                PhoenixSecurityContext.CurrentSecurityContext.UserCode,
