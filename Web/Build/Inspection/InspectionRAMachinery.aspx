<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAMachinery.aspx.cs"
    Inherits="InspectionRAMachinery" MaintainScrollPositionOnPostback="true" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <table width="100%" border="1" cellpadding="1" cellspacing="1">
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" Width="270px" CssClass="readonlytextbox" ID="txtRefNo"
                            ReadOnly="true">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" Width="60px" CssClass="readonlytextbox" ID="txtRevNO"
                            ReadOnly="true">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" Width="270px" CssClass="readonlytextbox" ID="txtpreparedby"
                            ReadOnly="true">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" Width="270px" CssClass="readonlytextbox" ID="txtApprovedby"
                            ReadOnly="true">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" Width="270px" CssClass="readonlytextbox" ID="txtIssuedBy"
                            ReadOnly="true">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" Width="270px" CssClass="readonlytextbox" ID="txtrejectedby"
                            ReadOnly="true">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Company ID="ucCompany" runat="server" CssClass="input_mandatory" AppendDataBoundItems="true" Width="270px" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="ddlCategory" runat="server" CssClass="dropdown_mandatory" AppendDataBoundItems="true" EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true"
                            AutoPostBack="True" DataTextField="FLDNAME" DataValueField="FLDACTIVITYID" OnSelectedIndexChanged="ddlCategory_Changed" Width="270px">
                            <Items>
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnRAEdit">
                            ...
                            <%--    <asp:ImageButton ID="imgShowRAEdit" runat="server" ImageUrl="<%$ PhoenixTheme:images/picklist.png %>"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <telerik:RadTextBox ID="txtActivityCondition" runat="server" Width="270px" CssClass="input_mandatory"></telerik:RadTextBox>
                    </td>
                </tr>
                <tr valign="middle">
                    <td colspan="2">
                    ...
                    <td colspan="3">
                        ...
                        <br />
                        <telerik:RadTextBox ID="txtFunctionality" runat="server" CssClass="readonlytextbox" Width="270px" Resize="Both"
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        ...
                        <br />
                        <telerik:RadTextBox ID="txtOtherReason" runat="server" CssClass="readonlytextbox" TextMode="MultiLine" Resize="Both"
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <%-- <telerik:RadTextBox ID="txtWorkDetails" runat="server" CssClass="input_mandatory" Width="270px" Resize="Both"
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        ...
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvHealthSafetyRisk" runat="server" AutoGenerateColumns="False" GroupingEnabled="false" EnableHeaderContextMenu="true"
                            OnItemCommand="gvHealthSafetyRisk_ItemCommand" Font-Size="11px" Width="100%" CellPadding="3" OnNeedDataSource="gvHealthSafetyRisk_NeedDataSource"
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        <telerik:RadCheckBoxList ID="cblImpact" runat="server" Direction="Vertical" Visible="false">
                            <Items>
                        ...
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvEnvironmentalRisk" runat="server" AutoGenerateColumns="False" GroupingEnabled="false" EnableHeaderContextMenu="true"
                            Font-Size="11px" Width="100%" CellPadding="3" ShowHeader="true" ShowFooter="true" OnItemDataBound="gvEnvironmentalRisk_ItemDataBound"
                            EnableViewState="false" OnItemCommand="gvEnvironmentalRisk_ItemCommand" OnNeedDataSource="gvEnvironmentalRisk_NeedDataSource">
                            <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                AutoGenerateColumns="false">
                                <ColumnGroups>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvEconomicRisk" runat="server" AutoGenerateColumns="False" Font-Size="11px" GroupingEnabled="false" EnableHeaderContextMenu="true"
                            Width="100%" ShowHeader="true" ShowFooter="true" EnableViewState="false" OnItemCommand="gvEconomicRisk_ItemCommand"
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <%--<br />
                                Details
                                <br />--%>
                        <telerik:RadTextBox ID="txtOtherDetails" runat="server" CssClass="readonlytextbox" Width="270px"
                ...
                <%--<tr valign="middle">
                            ...
                            <td colspan="2">
                                <telerik:RadTextBox ID="txtOtherRisk" runat="server" CssClass="input" Width="270px" TextMode="MultiLine" Resize="Both"
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvPersonal" runat="server" AutoGenerateColumns="False" Font-Size="11px" GroupingEnabled="false" EnableHeaderContextMenu="true"
                            OnItemCommand="gvPersonal_ItemCommand" Width="100%" CellPadding="3" ShowHeader="true" OnNeedDataSource="gvPersonal_NeedDataSource"
                            EnableViewState="false" ShowFooter="false" OnItemDataBound="gvPersonal_ItemDataBound"
                            OnRowCancelingEdit="gvPersonal_RowCancelingEdit" OnRowDeleting="gvPersonal_RowDeleting"
                            OnRowEditing="gvPersonal_RowEditing" OnRowUpdating="gvPersonal_RowUpdating">
                            <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                AutoGenerateColumns="false">
                                <ColumnGroups>
                                ...
                                <HeaderStyle Width="102px" />
                                <Columns>
                                    <telerik:GridTemplateColumn HeaderText="Item" HeaderStyle-Width="50%">
                                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Option" HeaderStyle-Width="25%">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <telerik:RadRadioButtonList ID="rblOptionEdit" runat="server" Direction="Vertical" Columns="3"
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        <telerik:RadCheckBoxList ID="cblStandByUnit" runat="server" Direction="Vertical" Columns="3"
                            AutoPostBack="true" OnTextChanged="OtherDetailClick" />
                        <br />
                        ...
                        <telerik:RadTextBox ID="txtStandByUnitDetails" runat="server" CssClass="readonlytextbox" Resize="Both"
                            TextMode="MultiLine" Rows="3" Width="270px" ReadOnly="true">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <%--<tr>
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        <telerik:RadCheckBoxList ID="cblProposedControl" runat="server" RepeatDirection="Horizontal" Direction="Vertical" Columns="3"
                            AutoPostBack="true" OnTextChanged="OtherDetailClick" />
                        <br />
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <br />
                        <telerik:RadTextBox ID="txtCtDetail" runat="server" CssClass="readonlytextbox" Width="270px" Resize="Both"
                            TextMode="MultiLine" Rows="3" ReadOnly="true">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvMachinerySafety" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            Width="99.9%" ShowHeader="true" ShowFooter="true" EnableViewState="false" OnItemCommand="gvMachinerySafety_ItemCommand"
                            OnItemDataBound="gvMachinerySafety_ItemDataBound" GroupingEnabled="false" EnableHeaderContextMenu="true"
                            OnNeedDataSource="gvMachinerySafety_NeedDataSource">
                            <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="true"
                                AutoGenerateColumns="false">
                                <ColumnGroups>
                                    <telerik:GridColumnGroup Name="FromToPort" HeaderText="Port" HeaderStyle-HorizontalAlign="Center"></telerik:GridColumnGroup>
                                </ColumnGroups>
                                ...
                                <HeaderStyle Width="102px" />
                                <Columns>
                                    <telerik:GridTemplateColumn HeaderText="S.No" HeaderStyle-Width="7%">
                                        <ItemStyle Wrap="False" HorizontalAlign="Right" Width="98%"></ItemStyle>
                                        <FooterStyle Wrap="false" HorizontalAlign="Right" Width="98%" />
                                        <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                            <eluc:Number ID="ucSNoEdit" runat="server" CssClass="input" IsInteger="true" Width="100%"
                                                Text='<%# DataBinder.Eval(Container,"DataItem.FLDSERIALNUMBER") %>' />
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <eluc:Number ID="ucSNoAdd" runat="server" CssClass="input" Width="100%" IsInteger="true" />
                                        </FooterTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn HeaderText="Task" HeaderStyle-Width="25%">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="PIC" HeaderStyle-Width="9%">
                                        <ItemStyle Wrap="true" HorizontalAlign="Left" Width="17%"></ItemStyle>
                                        <FooterStyle Wrap="true" HorizontalAlign="Left" Width="17%" />
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Estimated Start Date" HeaderStyle-Width="17%">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <br />
                                            <telerik:RadTextBox ID="txtEstimatedStartTimeEdit" runat="server" CssClass="input" Width="45px" />
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <br />
                                            <telerik:RadTextBox ID="txtEstimatedStartTimeAdd" runat="server" CssClass="input" Width="45px" />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Estimated Finish Date" HeaderStyle-Width="17%">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <br />
                                            <telerik:RadTextBox ID="txtEstimatedFinishTimeEdit" runat="server" CssClass="input" Width="45px" />
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <br />
                                            <telerik:RadTextBox ID="txtEstimatedFinishTimeAdd" runat="server" CssClass="input" Width="45px" />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="ActualStart Date" HeaderStyle-Width="17%">
                                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="7%"></ItemStyle>
                                        <FooterStyle Wrap="False" HorizontalAlign="Left" Width="7%" />
                                        <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <eluc:Date ID="ucActualStartDateEdit" runat="server"
                                                Text='<%#  General.GetDateTimeToString(DataBinder.Eval(Container,"DataItem.FLDACTUALSTARTDATE")) %>' />
                                            <br />
                                            <telerik:RadTextBox ID="txtActualStartTimeEdit" runat="server" CssClass="input" Width="45px" />
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="ActualFinish Date" HeaderStyle-Width="17%">
                                        ...
                                        <EditItemTemplate>
                                            <eluc:Date ID="ucActualFinishDateEdit" runat="server"
                                                Text='<%#  General.GetDateTimeToString(DataBinder.Eval(Container,"DataItem.FLDACTUALFINISHDATE")) %>' />
                                            <br />
                                            <telerik:RadTextBox ID="txtActualFinishTimeEdit" runat="server" CssClass="input" Width="45px" />
                        ...
                        <%--  <telerik:RadTextBox ID="txtAdditionalSafetyProcedures" runat="server" CssClass="input" Width="270px" Resize="Both"
                ...
                <tr valign="middle" runat="server" visible="false">
                    <td colspan="2">
                        <telerik:RadLabel ID="lblApprovedForUse" runat="server" Text="Approved for Use"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadRadioButtonList ID="rblOtherRiskControl" runat="server" Direction="Vertical"
                            Visible="false">
                        </telerik:RadRadioButtonList>
                ...
                <tr valign="middle">
                    ...
                    <td colspan="4">
                        ...
                        <br />
                        <telerik:RadRadioButtonList ID="rblVerifcation" runat="server" RepeatDirection="Horizontal" Direction="Horizontal"
                        ...
                        <br />
                        <telerik:RadTextBox ID="txtVerificationRemarks" runat="server" CssClass="input" Width="270px" Resize="Both"
                            Height="80px" TextMode="MultiLine" onKeyUp="TxtMaxLength(this,1000)" onChange="TxtMaxLength(this,1000)">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr valign="middle" runat="server" visible="false">
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtRemarks" runat="server" CssClass="readonlytextbox" Width="270px" Resize="Both"
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtMasterRemarks" runat="server" CssClass="readonlytextbox" TextMode="MultiLine" Resize="Both"
                            Width="270px" Rows="4" ReadOnly="true">
                        </telerik:RadTextBox>
                    </td>
                </tr>
            </table>
