...
public partial class InspectionRAMachineryAspectList : PhoenixBasePage
{
    ...
    protected void gvRAOperationalHazard_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        try
        {
            ...
            ds = PhoenixInspectionRiskAssessmentMachineryExtn.ListOperationalHazard(General.GetNullableGuid(ViewState["RAID"].ToString()));
        ...
        try
        {
            if (e.Item is GridEditableItem)
            {
                ...
                if (e.CommandName.ToUpper().Equals("PICKLIST"))
                {
                    ...
                    {
                        ucError.ErrorMessage = "JHA is required";
                        ucError.Visible = true;
                        return;
                    }
