<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAMachineryExtn.aspx.cs" Inherits="InspectionRAMachineryExtn" MaintainScrollPositionOnPostback="true" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <table id="tblGeneric" runat="server" width="100%">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <div id="divFunctionality" runat="server" style="height: 100px; overflow-y: auto; overflow-x: auto; width: 420px; border-width: 1px; border-style: solid; border: 1px solid #c3cedd">
                        ...
                        <br />
                        <telerik:RadTextBox ID="txtFunctionality" runat="server" CssClass="readonlytextbox" Width="94%"
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnPickListComponent">
                            ...
                            <asp:LinkButton ID="cmdJobDetail" runat="server" ImageAlign="Middle" Style="vertical-align: middle;"
                                ToolTip="Job Detail">
                            ...
                            <telerik:RadDock Width="100%" RenderMode="Lightweight" ID="RadDock1" runat="server" EnableAnimation="true" EnableDrag="false"
                                ...
                                <ContentTemplate>
                                    ...
                                    <telerik:RadGrid RenderMode="Lightweight" ID="gvRAOperationalHazard" runat="server" AllowCustomPaging="false"
                                        Font-Size="11px" AllowPaging="false" AllowSorting="true" EnableViewState="false" OnNeedDataSource="gvRAOperationalHazard_NeedDataSource"
                                        ...
                                        <MasterTableView EditMode="InPlace" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                            AutoGenerateColumns="false" DataKeyNames="FLDRAMACHINERYOPERATIONID">
                                            <NoRecordsTemplate>
                                            ...
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Aspect" HeaderStyle-Width="13%">
                                                    <ItemStyle Wrap="true" HorizontalAlign="Left" Width="13%"></ItemStyle>
                                                    <ItemTemplate>
                                                        <telerik:RadLabel ID="lblOperationalId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDRAMACHINERYOPERATIONID") %>'></telerik:RadLabel>
                    ...
                    <td colspan="4">
                        <telerik:RadDockZone ID="RadDockZone7" runat="server" FitDocks="true" Orientation="Horizontal" Width="99%" BorderStyle="None">
                            <telerik:RadDock Width="100%" RenderMode="Lightweight" ID="RadDock7" runat="server" EnableAnimation="true" EnableDrag="false"
                                ...
                                <TitlebarTemplate>
                                    <telerik:RadLabel runat="server" ID="lblCommissioning" Text="Commissioning and Testing procedures" Font-Bold="true"></telerik:RadLabel>
                                    &nbsp;&nbsp;
                                            <asp:LinkButton ID="lnkCommissioning" runat="server" ToolTip="Comments" Visible="false">
                                                   <span class="icon"><i class="fa fa-comments"></i></span>
                                            </asp:LinkButton>
                                </TitlebarTemplate>
                                <ContentTemplate>
                                    ...
                                    <br />
                                    <telerik:RadTextBox ID="txtCtDetail" runat="server" CssClass="readonlytextbox" Width="360px"
                ...
                <tr>
                    <td colspan="4">
                        <telerik:RadDockZone ID="RadDockZone12" runat="server" FitDocks="true" Orientation="Horizontal" Width="99%" BorderStyle="None">
                            <telerik:RadDock Width="100%" RenderMode="Lightweight" ID="RadDock12" runat="server" EnableAnimation="true" EnableDrag="false"
                                EnableRoundedCorners="true" Resizable="true" CssClass="higherZIndex" Closed="false">
                                <Commands>
                                    <telerik:DockExpandCollapseCommand />
                                </Commands>
