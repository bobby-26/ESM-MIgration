...
public partial class InspectionRAMachineryFilter : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            MenuRAMachineryFilter.AccessRights = this.ViewState;
            MenuRAMachineryFilter.MenuList = toolbar.Show();
            txtRefNo.Focus();
            BindStatus();
    ...
    protected void MenuRAMachineryFilter_TabStripCommand(object sender, EventArgs e)
    {
