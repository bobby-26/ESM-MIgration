<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAMachineryList.aspx.cs"
    Inherits="InspectionRAMachineryList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <eluc:TabStrip ID="MenuMachineryMain" runat="server" TabStrip="false" OnTabStripCommand="MenuMachineryMain_TabStripCommand" Title="Machinery"></eluc:TabStrip>
            <eluc:TabStrip ID="MenuMachinery" runat="server" OnTabStripCommand="MenuMachinery_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid ID="gvRiskAssessmentMachinery" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" Height="87%"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:LinkButton runat="server" AlternateText="Machinery PDF" CommandName="RAMACHINERY" ID="cmdRAMachinery" ToolTip="Show PDF">
