...
public partial class InspectionRAMachineryOperationalHazardPickList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        SessionUtil.PageAccessRights(this.ViewState);
        PhoenixToolbar toolbar = new PhoenixToolbar();
        toolbar.AddFontAwesomeButton("../Inspection/InspectionRAMachineryOperationalHazardPickList.aspx?", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
        toolbar.AddFontAwesomeButton("../Inspection/InspectionRAMachineryOperationalHazardPickList.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
        toolbar.AddFontAwesomeButton("../Inspection/InspectionRAMachineryOperationalHazardPickList.aspx", "Bulk Upload", "<i class=\"fa-upload\"></i>", "BULKSELECT");
    ...
    protected void gvOperationalHazard_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        if (e.CommandName.ToUpper().Equals("ASPECT"))
        {
            ...
            PhoenixInspectionRiskAssessmentMachineryExtn.RAOperationalHazardMapping(General.GetNullableGuid((ViewState["RAID"]).ToString())
        ...
        if (e.CommandName.ToUpper().Equals("TEDIT"))
        {
            ...
            Response.Redirect("../Inspection/InspectionOperationalRiskControlMapping.aspx?callfrom=machinery&raid=" + ViewState["RAID"].ToString() + "&Operationalhazardid=" + lblOperationalId.Text, false);
        }
    ...
    private void BindGrid()
    {
        ...
        ds = PhoenixInspectionRiskAssessmentMachineryExtn.RAOperationalHazardPendingList(General.GetNullableInteger(ucElement.SelectedCategory), General.GetNullableGuid(ViewState["RAID"].ToString()),General.GetNullableString(txtOperationalHazard.Text.Trim()));
