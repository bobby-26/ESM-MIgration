<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAMachineryTemplateDetails.aspx.cs" Inherits="Inspection_InspectionRAMachineryTemplateDetails" %>
...
<head runat="server">
    <title>Risk Assessment Machinery</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    ...
    <asp:UpdatePanel runat="server" ID="pnlMachinery_">
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading" style="vertical-align: top">
                        <eluc:Title runat="server" ID="ucTitle" Text="Machinery" ShowMenu="true" />
                        <asp:Button ID="cmdHiddenSubmit" runat="server" Text="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" />
                    </div>
                </div>
                <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
                    <eluc:TabStrip ID="MenuMachinery" runat="server" OnTabStripCommand="MenuMachinery_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="tblGeneric">
                    <table width="100%" border="1" cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Label ID="lblCategoryShortCode" runat="server" Visible="false"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblEquipmentBeingAssessed" runat="server" Text="Equipment being assessed"></asp:Literal>
                            </td>
                            <td>
                                <span id="spnPickListComponent">
                                    ...
                                    <asp:ImageButton runat="server" ID="imgClearParentComponent" ToolTip="Clear Value"
                                        OnClick="ClearComponent" ImageUrl="<%$ PhoenixTheme:images/clear-filter.png %>" />
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="txtActivityCondition" runat="server" CssClass="readonlytextbox"
                                    Enabled="false" Width="360px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr valign="top">
                            <td colspan="2">
                                <asp:Literal ID="lblFunctionalityoftheEquipment" runat="server" Text="Functionality of the Equipment"></asp:Literal>
                            </td>
                            <td colspan="3">
                                <asp:CheckBoxList ID="cblFunctionality" runat="server" RepeatDirection="Horizontal"
                                ...
                                <br />
                                <asp:TextBox ID="txtFunctionality" runat="server" CssClass="readonlytextbox" Width="700px"
                        ...
                        <tr valign="top">
                            ...
                            <td colspan="3">
                                ...
                                <br />
                                <asp:TextBox ID="txtOtherReason" runat="server" CssClass="readonlytextbox" TextMode="MultiLine"
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblNoofPeopleInvolvedInActivity" runat="server" Text="No of people involved in activity"></asp:Literal>
                            </td>
                            <td colspan="3">
                        ...
                        <tr valign="top">
                            <td colspan="2">
                                <asp:Literal ID="lblPersonnalSparesandTools" runat="server" Text="Personnel, Spares and Tools"></asp:Literal>
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblAreAdequateStandByUnit" runat="server" Text="Are Adequate StandBy unit(s) Available ?"></asp:Literal>
                            </td>
                            <td colspan="3">
                        ...
                        <tr valign="top">
                            <td colspan="2">
                                <asp:Literal ID="lblDetailsofStandByUnitRedundancy" runat="server" Text="Details of StandBy Unit/Redundancy"></asp:Literal>
                            </td>
                            <td colspan="3">
                                <asp:CheckBoxList ID="cblStandByUnit" runat="server" RepeatDirection="Horizontal"
                                    RepeatColumns="3" AutoPostBack="true" OnTextChanged="OtherDetailClick" />
                                <br />
                        ...
                        <tr valign="top">
                            ...
                            <td colspan="3">
                                <asp:CheckBoxList ID="cblProposedControl" runat="server" RepeatDirection="Horizontal"
                                    RepeatColumns="3" AutoPostBack="true" OnTextChanged="OtherDetailClick" />
                                <br />
                                <asp:Literal ID="lblDetails2" runat="server" Text="Details"></asp:Literal>
                                <br />
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblCommissioningandTestingProcedures" runat="server" Text="Commissioning and Testing procedures"></asp:Literal>
                            </td>
                            <td colspan="3">
                                <asp:CheckBoxList ID="cblCommisionProcedure" runat="server" RepeatDirection="Horizontal"
                                    RepeatColumns="3" AutoPostBack="true" OnTextChanged="OtherDetailClick" />
                                <br />
                                <asp:Literal ID="lblDetails3" runat="server" Text="Details"></asp:Literal>
                                <br />
                                <asp:TextBox ID="txtCtDetail" runat="server" CssClass="readonlytextbox" Width="700px"
                                    Height="80px" onKeyUp="TxtMaxLength(this,700)" onChange="TxtMaxLengththis,700)"
                                    TextMode="MultiLine" Rows="3" ReadOnly="true"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:GridView ID="gvMachinerySafety" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                                    Width="100%" ShowHeader="true" ShowFooter="true" EnableViewState="false" OnRowCommand="gvMachinerySafety_RowCommand"
                                    OnRowDataBound="gvMachinerySafety_RowDataBound" OnRowEditing="gvMachinerySafety_RowEditing"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="S.No">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblMachinerySafetyId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMACHINERYSAFETYID") %>'
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <EditItemTemplate>
                                                <asp:Label ID="lblMachinerySafetyIdEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMACHINERYSAFETYID") %>'
                                                    Visible="false"></asp:Label>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <EditItemTemplate>
                                                <eluc:Date ID="ucActualFinishDateEdit" runat="server" CssClass="input_mandatory"
                                                    Width="60px" Text='<%#  General.GetDateTimeToString(DataBinder.Eval(Container,"DataItem.FLDACTUALFINISHDATE")) %>' />
                                                <br>
                                                </br>
