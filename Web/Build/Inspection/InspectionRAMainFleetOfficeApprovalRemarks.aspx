<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAMainFleetOfficeApprovalRemarks.aspx.cs" Inherits="InspectionRAMainFleetOfficeApprovalRemarks" %>
...
<body>
    ...
    <table cellpadding="1" cellspacing="1" width="60%">
        <tr>
            <td>
                <b><font color="blue"><asp:Literal ID="lblNote" runat="server" Text="* Note: Once the RA is approved, it cannot be edited."></asp:Literal></font></b>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <b><asp:Literal ID="lblOfficeRemarks" runat="server" Text="Office Remarks"></asp:Literal></b>
            </td>
        </tr>
        <tr>
            <td colspan="2">
