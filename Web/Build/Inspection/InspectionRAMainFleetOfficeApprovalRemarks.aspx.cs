...
public partial class InspectionRAMainFleetOfficeApprovalRemarks : PhoenixBasePage
{
    ...
    protected void MenuApprovalRemarks_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["RATEMPLATEID"] != null && ViewState["RATEMPLATEID"] != null)
            {
                ...
                {
                    PhoenixInspectionRiskAssessment.ApproveMainFleetRAWithOfficeRemarks(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
