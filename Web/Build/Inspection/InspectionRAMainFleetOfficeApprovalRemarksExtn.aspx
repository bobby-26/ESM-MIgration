<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAMainFleetOfficeApprovalRemarksExtn.aspx.cs" Inherits="InspectionRAMainFleetOfficeApprovalRemarksExtn" %>
...
<body>
    ...
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <tr>
            <td colspan="2">
                <b><asp:Literal ID="lblNote" runat="server" Text="* Note: Once the RA is approved, it cannot be edited."></asp:Literal></b>
            </td>
        </tr>
        <tr>
            <td width="15%">
