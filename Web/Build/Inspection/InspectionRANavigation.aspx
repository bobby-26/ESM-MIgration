<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRANavigation.aspx.cs"
    Inherits="InspectionRANavigation" MaintainScrollPositionOnPostback="true" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="99.9%">
            ...
            <table width="99.9%" border="1" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" Width="360px" CssClass="readonlytextbox" ID="txtrejectedby"
                            ReadOnly="true">
                        </telerik:RadTextBox>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <eluc:Date ID="txtDate" CssClass="readonlytextbox" Visible="false" ReadOnly="false" Width="360px"
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <%--<telerik:RadTextBox ID="txtWorkDetails" runat="server" CssClass="input_mandatory" Width="360px" Rows="4" TextMode="MultiLine"></telerik:RadTextBox>--%>
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        ...
                        <br />
                        <br />
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvEnvironmentalRisk" runat="server" AutoGenerateColumns="False" AllowCustomPaging="false" AllowPaging="false" AllowSorting="true"
                            Font-Size="11px" Width="99.9%" CellPadding="3" ShowHeader="true" ShowFooter="true" OnNeedDataSource="gvEnvironmentalRisk_NeedDataSource" EnableHeaderContextMenu="true"
                            EnableViewState="false" OnItemDataBound="gvEnvironmentalRisk_ItemDataBound" OnItemCommand="gvEnvironmentalRisk_ItemCommand" GroupingEnabled="false">
                            <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                AutoGenerateColumns="false">
                                <ColumnGroups>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvEconomicRisk" runat="server" AutoGenerateColumns="False" Font-Size="11px" GroupingEnabled="false" EnableHeaderContextMenu="true"
                            ...
                            OnItemCommand="gvEconomicRisk_ItemCommand" OnItemDataBound="gvEconomicRisk_ItemDataBound">
                            <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                AutoGenerateColumns="false">
                                <ColumnGroups>
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvPersonal" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowSorting="true"
                            OnItemDataBound="gvPersonal_ItemDataBound" OnItemCommand="gvPersonal_ItemCommand" Width="99.9%" CellPadding="3" ShowHeader="true" GroupingEnabled="false" EnableHeaderContextMenu="true"
                            EnableViewState="false" ShowFooter="false" OnNeedDataSource="gvPersonal_NeedDataSource">
                            <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                AutoGenerateColumns="false">
                                <ColumnGroups>
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        <telerik:RadCheckBoxList ID="cbllStandByUnitDetails" runat="server" Direction="Horizontal"
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        ...
                        <telerik:RadTextBox ID="txtProposedControlDetails" runat="server" CssClass="readonlytextbox" Resize="Both"
                            ReadOnly="true" Width="360px" TextMode="MultiLine" Rows="3">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                            ...
                            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="true"
                                ...
                                <Columns>
                                    <telerik:GridTemplateColumn HeaderText="S.No" HeaderStyle-Width="7%">
                                        ...
                                        <EditItemTemplate>
                                            <eluc:Number ID="ucSNoEdit" runat="server" IsInteger="true" Width="99.9%"
                                                Text='<%# DataBinder.Eval(Container,"DataItem.FLDSERIALNUMBER") %>' />
                                        </EditItemTemplate>
                                        <FooterTemplate>
                                            <eluc:Number ID="ucSNoAdd" runat="server" Width="99.9%" IsInteger="true" />
                                        </FooterTemplate>
                                    </telerik:GridTemplateColumn>
                                        ...
                                        <FooterTemplate>
                                            <span id="spnPICAdd">
                                                ...
                                                <%--       <asp:ImageButton runat="server" ID="btnPICAdd" ImageUrl="<%$ PhoenixTheme:images/picklist.png %>"
                                                    ImageAlign="Top" Text=".." CommandArgument="<%# Container.DataItem %>" />--%>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="EstimatedStart Date" HeaderStyle-Width="17%">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="EstimatedFinish Date" HeaderStyle-Width="17%">
                                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="7%"></ItemStyle>
                                        <FooterStyle Wrap="False" HorizontalAlign="Left" Width="7%" />
                                        <ItemTemplate>
                        ...
                        <%--   <telerik:RadTextBox ID="txtAdditionalSafetyProcedures" runat="server" CssClass="input" Resize="Both"
                                    Width="360px" Rows="4" TextMode="MultiLine"></telerik:RadTextBox>--%>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadRadioButtonList ID="rblOtherRiskControl" runat="server" RepeatDirection="Horizontal"
                            Visible="false">
                        </telerik:RadRadioButtonList>
