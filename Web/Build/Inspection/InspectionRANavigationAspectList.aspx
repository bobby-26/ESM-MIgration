<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRANavigationAspectList.aspx.cs" Inherits="InspectionRANavigationAspectList" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRAOperationalHazard" runat="server" AllowCustomPaging="false"
                Font-Size="11px" AllowPaging="true" AllowSorting="false" EnableViewState="true" OnNeedDataSource="gvRAOperationalHazard_NeedDataSource"
