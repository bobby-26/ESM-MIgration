<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRANavigationComparison.aspx.cs" Inherits="InspectionRANavigationComparison" %>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <%--<div class="subHeader" style="position: relative">
                    <div id="divHeading" style="vertical-align: top">
                        <eluc:Title runat="server" ID="ucTitle" Text="Navigation" ShowMenu="false" />
                    </div>
                </div>--%>
                <div id="tblGeneric">
