...
public partial class InspectionRANavigationComparison : PhoenixBasePage
{
    ...
    {
        DataSet ds = PhoenixInspectionRiskAssessmentGeneric.InspectionRiskAssessmentNavigationComparison(
