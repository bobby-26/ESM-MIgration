<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRANavigationExtn.aspx.cs" Inherits="InspectionRANavigationExtn" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmGeneric" runat="server">
        ...
        <telerik:RadFormDecorator ID="RadformDecortor" DecorationZoneID="tblnavigation" runat="server" DecoratedControls="All" EnableRoundedCorners="true" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <table id="tblnavigation" width="100%" cellspacing="3">
                <tr>
                    <td width="10%">
                                ...
                                <ContentTemplate>
                                    ...
                                    <telerik:RadGrid RenderMode="Lightweight" ID="gvRAOperationalHazard" runat="server" AllowCustomPaging="false"
                                        ...
                                        <MasterTableView EditMode="InPlace" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                            AutoGenerateColumns="false" DataKeyNames="FLDRANAVIGATIONOPERATIONID">
                                            <NoRecordsTemplate>
                                            ...
                                            <Columns>
                                                <telerik:GridTemplateColumn HeaderText="S.No." HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="4%">
                                                    <ItemStyle Wrap="true" HorizontalAlign="Center" Width="4%"></ItemStyle>
                                                    <ItemTemplate>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Aspect" HeaderStyle-Width="15%">
                                                    ...
                                                    <ItemTemplate>
                                                        <telerik:RadLabel ID="lblOperationalId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDRANAVIGATIONOPERATIONID") %>'></telerik:RadLabel>
                    ...
                    <td colspan="4">
                        <telerik:RadDockZone ID="RadDockZone5" runat="server" FitDocks="true" Orientation="Horizontal" Width="99%" BorderStyle="None">
                            <telerik:RadDock Width="100%" RenderMode="Lightweight" ID="RadDock5" runat="server" EnableAnimation="true" EnableDrag="false"
                                ...
                                <TitlebarTemplate>
                                    <telerik:RadLabel runat="server" ID="lblUndesirable" Text="Undesireable Event / Worst Case Scenario" Font-Bold="true"></telerik:RadLabel>
                                    &nbsp;&nbsp;
