<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRANavigationFilter.aspx.cs"
    Inherits="InspectionRANavigationFilter" %>
...
<head runat="server">
    <title>Inspection RA Navigation Filter</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    ...
    <div class="subHeader" style="position: relative">
        <div id="divHeading" style="vertical-align: top">
            <asp:Label runat="server" ID="lblCaption" Font-Bold="true" Text="Navigation RA Filter"></asp:Label>
        </div>
    </div>
    <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
        <eluc:TabStrip ID="MenuRANavigationFilter" runat="server" OnTabStripCommand="MenuRANavigationFilter_TabStripCommand">
        </eluc:TabStrip>
    </div>
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" CombineScripts="false">
    </ajaxToolkit:ToolkitScriptManager>
    <asp:UpdatePanel runat="server" ID="pnlRANavigation">
        <ContentTemplate>
            <br />
