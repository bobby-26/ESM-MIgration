...
public partial class InspectionRANavigationFilter : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            MenuRANavigationFilter.AccessRights = this.ViewState;
            MenuRANavigationFilter.MenuList = toolbar.Show();
            txtRefNo.Focus();
    ...
    protected void MenuRANavigationFilter_TabStripCommand(object sender, EventArgs e)
    {
