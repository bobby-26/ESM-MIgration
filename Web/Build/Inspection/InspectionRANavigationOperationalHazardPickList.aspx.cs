...
public partial class InspectionRANavigationOperationalHazardPickList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        SessionUtil.PageAccessRights(this.ViewState);
        PhoenixToolbar toolbar = new PhoenixToolbar();
        toolbar.AddFontAwesomeButton("../Inspection/InspectionRANavigationOperationalHazardPickList.aspx?", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
        toolbar.AddFontAwesomeButton("../Inspection/InspectionRANavigationOperationalHazardPickList.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
        toolbar.AddFontAwesomeButton("../Inspection/InspectionRANavigationOperationalHazardPickList.aspx", "Bulk Upload", "<i class=\"fa-upload\"></i>", "BULKSELECT");
    ...
    protected void gvOperationalHazard_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        if (e.CommandName.ToUpper().Equals("ASPECT"))
        {
            ...
            {
                ucError.ErrorMessage = "Please save template first.";
                ucError.Visible = true;
                return;
            }

            PhoenixInspectionRiskAssessmentNavigationExtn.RAOperationalHazardMapping(General.GetNullableGuid((ViewState["RAID"]).ToString())
        ...
        if (e.CommandName.ToUpper().Equals("TEDIT"))
        {
            ...
            Response.Redirect("../Inspection/InspectionOperationalRiskControlMapping.aspx?callfrom=navigation&raid=" + ViewState["RAID"].ToString() + "&Operationalhazardid=" + lblOperationalId.Text, false);
        }
    ...
    private void BindGrid()
    {
            ...
            ds = PhoenixInspectionRiskAssessmentNavigationExtn.RAOperationalHazardPendingList(General.GetNullableInteger(ucElement.SelectedCategory), General.GetNullableGuid(ViewState["RAID"].ToString()),General.GetNullableString(txtOperationalHazard.Text.Trim()));
