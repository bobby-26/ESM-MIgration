<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRANavigationRevisionListExtn.aspx.cs" Inherits="InspectionRANavigationRevisionListExtn" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessmentNavigationRevision" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                OnItemDataBound="gvRiskAssessmentNavigationRevision_ItemDataBound" OnNeedDataSource="gvRiskAssessmentNavigationRevision_NeedDataSource">
