<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRANavigationTemplate.aspx.cs" Inherits="Inspection_InspectionRANavigationTemplate" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmGeneric" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="99.9%">
            ...
            <eluc:TabStrip ID="MenuNavigation" runat="server" OnTabStripCommand="MenuNavigation_TabStripCommand" Title="Navigation"></eluc:TabStrip>
            <table width="99.9%" border="1" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <eluc:Date ID="txtDate" CssClass="readonlytextbox" Visible="false" ReadOnly="false" Width="270px"
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="ddlCategory" runat="server" CssClass="dropdown_mandatory" AppendDataBoundItems="true" Width="270px" EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true"
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        ...
                        <br />
                        <telerik:RadTextBox ID="txtOtherReason" runat="server" CssClass="readonlytextbox" ReadOnly="true" Resize="Both"
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <%--<telerik:RadTextBox ID="txtWorkDetails" runat="server" CssClass="input_mandatory" Width="270px" Rows="4" TextMode="MultiLine"></telerik:RadTextBox>--%>
                            ...
                            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <FooterStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" AlternateText="Delete" CommandName="EDELETE" ID="LinkButton3"
                                                ToolTip="Delete">
                                            <span class="icon"><i class="fas fa-trash"></i></span>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:LinkButton runat="server" AlternateText="Add" CommandName="EADD" ID="LinkButton4"
                                                ToolTip="Add">
                                               <span class="icon"><i class="fa fa-plus-circle"></i></span>
                                            </asp:LinkButton>
                                        </FooterTemplate>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvEconomicRisk" runat="server" AutoGenerateColumns="False" Font-Size="11px" GroupingEnabled="false" EnableHeaderContextMenu="true"
                            Width="99.9%" ShowHeader="true" ShowFooter="true" EnableViewState="false" OnItemCommand="gvEconomicRisk_ItemCommand" OnNeedDataSource="gvEconomicRisk_NeedDataSource"
                            ...
                            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <FooterStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" AlternateText="Delete" CommandName="CDELETE" ID="LinkButton1"
                                                ToolTip="Delete">
                                                <span class="icon"><i class="fas fa-trash"></i></span>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:LinkButton runat="server" AlternateText="Add" CommandName="CADD" ID="LinkButton2"
                                                ToolTip="Add">
                                            <span class="icon"><i class="fa fa-plus-circle"></i></span>
                                            </asp:LinkButton>
                                        </FooterTemplate>
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvPersonal" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            OnItemCommand="gvPersonal_ItemCommand" Width="99.9%" CellPadding="3" ShowHeader="true" GroupingEnabled="false" EnableHeaderContextMenu="true"
                            EnableViewState="false" ShowFooter="false" OnItemDataBound="gvPersonal_ItemDataBound" OnNeedDataSource="gvPersonal_NeedDataSource"
                ...
                <%--<tr align="center">
                            ...
                            <td colspan="2">
                                <telerik:RadTextBox ID="txtOtherRisk" runat="server" CssClass="input" Width="270px" TextMode="MultiLine"
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        <telerik:RadCheckBoxList ID="cbllStandByUnitDetails" runat="server" Direction="Vertical"
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3">
                        ...
                        <telerik:RadTextBox ID="txtProposedControlDetails" runat="server" CssClass="readonlytextbox" Resize="Both"
                            ReadOnly="true" Width="270px" TextMode="MultiLine" Rows="3">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvNavigationSafety" runat="server" AutoGenerateColumns="False" GroupingEnabled="false" EnableHeaderContextMenu="true"
                            Font-Size="11px" Width="99.9%" ShowHeader="true" ShowFooter="true" EnableViewState="false" OnNeedDataSource="gvNavigationSafety_NeedDataSource"
                            ...
                            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="EstimatedStart Date" HeaderStyle-Width="16%">
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="EstimatedFinish Date" HeaderStyle-Width="16%">
                                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="7%"></ItemStyle>
                                        <FooterStyle Wrap="False" HorizontalAlign="Left" Width="7%" />
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="ActualStart Date" HeaderStyle-Width="16%">
                                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="7%"></ItemStyle>
                                        <FooterStyle Wrap="False" HorizontalAlign="Left" Width="7%" />
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="ActualFinish Date" HeaderStyle-Width="16%">
                                        ...
                                        <EditItemTemplate>
                                            <eluc:Date ID="ucActualFinishDateEdit" runat="server" CssClass="inputs"
                        ...
                        <%--   <telerik:RadTextBox ID="txtAdditionalSafetyProcedures" runat="server" CssClass="input"
                                    Width="270px" Rows="4" TextMode="MultiLine"></telerik:RadTextBox>--%>
