<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRANavigationTemplateDetails.aspx.cs" Inherits="Inspection_InspectionRANavigationTemplateDetails" %>
...
<head runat="server">
    <title>Risk Assessment Navigation</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    ...
    <asp:UpdatePanel runat="server" ID="pnlNavigation">
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading" style="vertical-align: top">
                        <eluc:Title runat="server" ID="ucTitle" Text="Navigation" ShowMenu="true" />
                    </div>
                </div>
                <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
                    <eluc:TabStrip ID="MenuNavigation" runat="server" OnTabStripCommand="MenuNavigation_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="tblnavigation">
                    <table width="100%" border="1" cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblPreparedBy" runat="server">Prepared By</asp:Literal>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Literal ID="lblDate" runat="server">Date</asp:Literal>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblApprovedBy" runat="Server">Approved By</asp:Literal>
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:Literal ID="lblDate1" runat="server"> Date</asp:Literal>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblIssuedBy" runat="server"> Issued By</asp:Literal>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblAmendmentTo" runat="server">Amendment To</asp:Literal>
                            </td>
                            <td>
                        ...
                        <tr valign="top">
                            ...
                            <td colspan="3">
                                ...
                                <br />
                                <asp:TextBox ID="txtOtherReason" runat="server" CssClass="readonlytextbox" ReadOnly="true"
                                    TextMode="MultiLine" Width="700px" Height="80px" onKeyUp="TxtMaxLength(this,700)"
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblNoofPeopleInvolvedInActivityAffected" runat="server" Text="No of people involved in activity / Affected"></asp:Literal>
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblDurationofWorkActivity" runat="server">Duration of work activity</asp:Literal>
                            </td>
                            <td colspan="3">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <%--<asp:TextBox ID="txtWorkDetails" runat="server" CssClass="input_mandatory" Width="360px" Rows="4" TextMode="MultiLine"></asp:TextBox>--%>
                                ...
                                <asp:GridView ID="gvEconomicRisk" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField Visible="false">
                                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                                            <HeaderTemplate>
                                                <asp:Literal ID="lblProposedControlsToReduceRiskHeader" runat="server">Proposed Controls To reduce risk</asp:Literal>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblProposedControl" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPROPOSEDCONTROLS") %>'></asp:Label>
                                            </ItemTemplate>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblWorstCaseScenario" runat="server">Worst Case Scenario</asp:Literal>
                            </td>
                            <td colspan="3">
                        ...
                        <tr valign="top">
                            <td colspan="2">
                                <asp:Literal ID="lblPersonnelSparesTools" runat="server" Text="Personnel, Spares and Tools"></asp:Literal>
                            </td>
                            <td colspan="3">
                                <div id="divPersonal" style="position: relative; z-index: +1">
                                    <asp:GridView ID="gvPersonal" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                                        OnRowCommand="gvPersonal_RowCommand" Width="100%" CellPadding="3" ShowHeader="true"
                                        EnableViewState="false" ShowFooter="false" OnRowDataBound="gvPersonal_RowDataBound"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Name">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCONTROLID") %>'></asp:Label>
                                                    <asp:Label ID="lblItemid" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDITEMID") %>'></asp:Label>
                                                    <asp:Label ID="lblName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDITEM") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Left" Width="100px"></ItemStyle>
                                                <HeaderTemplate>
                                                    <asp:Label ID="lblOptionHeader" runat="server">Option</asp:Label>
                                                </HeaderTemplate>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblOption" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDOPTION") %>'></asp:Label>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblAreAdequateStandByUnits" runat="server" Text="Are Adequate StandBy unit(s) Available ?"></asp:Literal>
                            </td>
                            <td colspan="3">
                                <asp:RadioButtonList ID="rblStandByUnit" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="1" Text="Yes"></asp:ListItem>
                                    <asp:ListItem Value="0" Text="No"></asp:ListItem>
                                    <asp:ListItem Value="2" Text="N/A"></asp:ListItem>
                                </asp:RadioButtonList>
                        ...
                        <tr valign="top">
                            <td colspan="2">
                                <asp:Literal ID="lblDetailsOfStandByUnit" runat="server" Text="Details of StandBy Unit/Redundancy"></asp:Literal>
                            </td>
                            <td colspan="3">
                                <asp:CheckBoxList ID="cbllStandByUnitDetails" runat="server" RepeatDirection="Horizontal"
                                    RepeatColumns="3" AutoPostBack="true" OnTextChanged="OtherDetailClick" />
                                <br />
                                <asp:Literal ID="lblDetails" runat="server" Text="Details"></asp:Literal>
                                <br />
                                <asp:TextBox ID="txtStandByUnitDetails" runat="server" CssClass="readonlytextbox"
                        ...
                        <tr valign="top">
                            ...
                            <td colspan="3">
                                <asp:CheckBoxList ID="cblProposedControl" runat="server" RepeatDirection="Horizontal"
                                    RepeatColumns="3" AutoPostBack="true" OnTextChanged="OtherDetailClick" />
                                <br />
                                <asp:Literal ID="lblDetails1" runat="server" Text="Details"></asp:Literal>
                                <br />
                                <asp:TextBox ID="txtProposedControlDetails" runat="server" CssClass="readonlytextbox"
                                    ReadOnly="true" Width="700px" Height="80px" TextMode="MultiLine" Rows="3"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <asp:Literal ID="lblAdditionalSafetyProcedures" runat="server" Text="Additional Safety Procedures (Emergency)"></asp:Literal>
                            </td>
                            <td colspan="3">
                                <asp:GridView ID="gvNavigationSafety" runat="server" AutoGenerateColumns="False"
                                    Font-Size="11px" Width="100%" ShowHeader="true" ShowFooter="true" EnableViewState="false"
                                    OnRowCommand="gvNavigationSafety_RowCommand" OnRowDataBound="gvNavigationSafety_RowDataBound"
                                    OnRowEditing="gvNavigationSafety_RowEditing" OnRowCancelingEdit="gvNavigationSafety_RowCancelingEdit">
                                    <HeaderStyle CssClass="DataGrid-HeaderStyle" />
                                    <FooterStyle CssClass="datagrid_footerstyle"></FooterStyle>
                                    <AlternatingRowStyle CssClass="datagrid_alternatingstyle" />
                                    <SelectedRowStyle CssClass="datagrid_selectedstyle" />
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="S.No">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lblNavigationSafetyId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDNAVIGATIONSAFETYID") %>'
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <EditItemTemplate>
                                                <asp:Label ID="lblNavigationSafetyIdEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDNAVIGATIONSAFETYID") %>'
                                                    Visible="false"></asp:Label>
                                                <span id="spnPICEdit">
                                ...
                                <%--   <asp:TextBox ID="txtAdditionalSafetyProcedures" runat="server" CssClass="input"
                                    Width="360px" Rows="4" TextMode="MultiLine"></asp:TextBox>--%>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <asp:TextBox ID="txtMasterRemarks" runat="server" CssClass="readonlytextbox" TextMode="MultiLine"
                                    ReadOnly="true" Width="280px" Rows="4"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </div>
