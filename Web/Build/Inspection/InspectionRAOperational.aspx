<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAOperational.aspx.cs"
    Inherits="InspectionRAOperational" %>
...
<body>
    <form id="frmRAOperational" runat="server" autocomplete="off">
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    </ajaxToolkit:ToolkitScriptManager>
    <asp:UpdatePanel runat="server" ID="pnlRAOperational">
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative;">
                    <span class="navSelect" style="margin-top: 0px; float: right; width: auto;">
                        <eluc:TabStrip ID="MenuOperational" runat="server" OnTabStripCommand="Operational_TabStripCommand">
                        </eluc:TabStrip>
                    </span>
                </div>
                <table width="100%" cellpadding="1" cellspacing="3">
                    <tr>
                        <td>
                            <b><asp:Literal ID="lblOperational" runat="server" Text="Operational"></asp:Literal></b>
                        </td>
                    </tr>
                     <tr>
                         <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:HazardType ID="ucHazardType" runat="server" Type="3" CssClass="dropdown_mandatory"
                                AppendDataBoundItems="true" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                           <asp:Literal ID="lblNoofPeople" runat="server" Text="No of people"></asp:Literal>
                        </td>
                        <td>
                            <eluc:Frequency ID="ucFrequency" runat="server" Type="3" CssClass="dropdown_mandatory"
                                AppendDataBoundItems="true" />
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:literal ID="lblLikelyHoolofHarm" runat="server" Text="Likelyhood of harm"></asp:literal>
                        </td>
                        <td>
                ...
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuGridOperational" runat="server" OnTabStripCommand="GridOperational_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="divGrid" style="position: relative; z-index: 0">
                    <asp:GridView ID="gvOperational" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowCommand="gvOperational_RowCommand" OnRowDataBound="gvOperational_ItemDataBound"
                        OnRowDeleting="gvOperational_RowDeleting"
                        AllowSorting="true" OnRowEditing="gvOperational_RowEditing" OnSorting="gvOperational_Sorting"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <HeaderTemplate>
                                    <asp:label ID="lblHeazardHeader" runat="server" >Hazard</asp:label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblHazard" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDHAZARDNAME") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:label ID="lblProbabilityOfOccurance" runat="server" >Probabilty of occurance</asp:label>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:label ID="lblLikelyhoodofHarm" runat="server">LikelyHood of Harm</asp:label>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Label ID="lblLevelofControlHeader" runat="server">Level of Control</asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
