<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRAOtherRisk.aspx.cs" Inherits="InspectionRAOtherRisk" %>
...
<body>
    <form id="frmRAOtherRisk" runat="server" autocomplete="off">
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
    </ajaxToolkit:ToolkitScriptManager>
    <asp:UpdatePanel runat="server" ID="pnlRAOtherRisk">
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative;">
                    <span class="navSelect" style="margin-top: 0px; float: right; width: auto;">
                        <eluc:TabStrip ID="MenuOtherRisk" runat="server" OnTabStripCommand="OtherRisk_TabStripCommand">
                        </eluc:TabStrip>
                    </span>
                </div>
                <table width="100%" cellpadding="1" cellspacing="3">
                    <tr>
                        <td>
                            <b><asp:Literal ID="lblOtherRisk" runat="server" Text="Other Risk"></asp:Literal></b>
                        </td>
                    </tr>
                     <tr>
                         <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <eluc:HazardType ID="ucHazardType" runat="server" Type="4" CssClass="dropdown_mandatory"
                ...
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuGridOtherRisk" runat="server" OnTabStripCommand="GridOtherRisk_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="divGrid" style="position: relative; z-index: 0">
                    <asp:GridView ID="gvOtherRisk" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowCommand="gvOtherRisk_RowCommand" OnRowDataBound="gvOtherRisk_ItemDataBound"
                        OnRowDeleting="gvOtherRisk_RowDeleting"
                        AllowSorting="true" OnRowEditing="gvOtherRisk_RowEditing" OnSorting="gvOtherRisk_Sorting"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <HeaderTemplate>
                                    <asp:label ID="lblConsequencesHeader" runat="server">Consequences</asp:label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblConsequences" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDHAZARDNAME") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:label ID="lblProbabilityOfOccuranceHeader" runat="server">Probabilty of occurance</asp:label>
                                </HeaderTemplate>
                                <ItemTemplate>
