<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRARecommendedPPE.aspx.cs" Inherits="InspectionRARecommendedPPE" %>
    ...
    <form id="frmRAMiscellaneous" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <eluc:TabStrip ID="MenuRAMiscellaneous" runat="server" OnTabStripCommand="RAMiscellaneous_TabStripCommand"></eluc:TabStrip>
                     <telerik:RadGrid RenderMode="Lightweight" ID="gvRAMiscellaneous" runat="server" AutoGenerateColumns="False" AllowPaging="true" AllowCustomPaging="true"
                Font-Size="11px" Width="100%" CellPadding="3" EnableHeaderContextMenu="true" GroupingEnabled="false" OnNeedDataSource="gvRAMiscellaneous_NeedDataSource"
                OnItemCommand="gvRAMiscellaneous_ItemCommand" OnItemDataBound="gvRAMiscellaneous_ItemDataBound" AllowSorting="true" ShowFooter="true" ShowHeader="true" EnableViewState="false">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="EPSS" ColumnGroupName="Controls" HeaderStyle-Font-Size="X-Small" HeaderStyle-Width="40%">
                            <ItemStyle Wrap="true" HorizontalAlign="Left" Width="40%" Font-Size="X-Small" VerticalAlign="Top"></ItemStyle>
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" HeaderStyle-Width="10%">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton runat="server" AlternateText="Edit" CommandName="IMAGEMAPPING" ID="cmdEdit" ToolTip="Edit">
