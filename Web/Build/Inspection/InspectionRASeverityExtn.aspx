<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRASeverityExtn.aspx.cs" Inherits="InspectionRASeverityExtn" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRASeverity" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowPaging="true" AllowCustomPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Consequence">
                            ...
                            <EditItemTemplate>
                                <telerik:RadTextBox ID="txtconsequenceedit" runat="server" Width="90px" CssClass="gridinput_mandatory" MaxLength="1" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCONSCATEGORY") %>'>
                            </telerik:RadTextBox>
                            </EditItemTemplate>
                            <FooterTemplate>
                                <telerik:RadTextBox ID="txtconsequenceadd" runat="server" Width="90px" CssClass="gridinput_mandatory" MaxLength="1">
                            </telerik:RadTextBox>
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
