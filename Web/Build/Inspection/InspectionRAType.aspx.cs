...
public partial class InspectionRAType : PhoenixBasePage
{
    ...
    private void BindData()
    {
        ...
        ds = PhoenixInspectionRiskAssessmentType.RATypeSearch(General.GetNullableInteger(ucRAType.SelectedHard),
        ...
        try
        {
            if (e.Item is GridFooterItem)
            {
                if (e.CommandName.ToUpper().Equals("ADD"))
                {
                    ...
                    int i = PhoenixInspectionRiskAssessmentType.RATypeInsert(General.GetNullableInteger(ucRAType.SelectedHard),
                          ((RadTextBox)e.Item.FindControl("txtRAItemAdd")).Text,
            ...
            if (e.Item is GridEditableItem)
            {
                ...
                {
                    int i = PhoenixInspectionRiskAssessmentType.RATypeDelete(
                ...
                if (e.CommandName.ToUpper().Equals("UPDATE"))
                {
                    ...
                    int i = PhoenixInspectionRiskAssessmentType.RATypeUpdate(((RadLabel)e.Item.FindControl("lblRAIDEdit")).Text,
                        ((RadTextBox)e.Item.FindControl("txtRAItem")).Text,
