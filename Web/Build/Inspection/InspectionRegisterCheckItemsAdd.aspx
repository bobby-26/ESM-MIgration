<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRegisterCheckItemsAdd.aspx.cs" Inherits="InspectionRegisterCheckItemsAdd" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadFormDecorator ID="RadFormDecorator" DecorationZoneID="RadAjaxPanel1" runat="server" DecoratedControls="All" EnableRoundedCorners="true" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <table width="100%" valign="top" id="lblCheckitem" runat="server" cellspacing="3">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <telerik:RadTextBox ID="txtDescription" runat="server" Text="" TextMode="MultiLine" Resize="Both" Width="98%" Height="120px" CssClass="input_mandatory"></telerik:RadTextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <div id="divActivity" runat="server" style="height: 150px; overflow-y: auto; overflow-x: auto; width: 98%; border-width: 1px; border-style: solid; border: 1px solid #c3cedd">
                            <telerik:RadCheckBoxList runat="server" ID="ChkActivity" Columns="2" Layout="Flow" AutoPostBack="false"
