...
public partial class InspectionRegisterCheckItemsAdd : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
           ...
           // ScriptManager.GetCurrent(this).RegisterPostBackControl(MenuAddCheckItem);
            ...
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
                btnChaperAdd.Attributes.Add("onclick", "return showPickList('Add','codehelp1','','../Inspection/InspectionCheckItemChapterMappingAdd.aspx?CHECKITEMID=" + ViewState["CHECKITEMID"] + "');");
    ...
    private void BindChapters()
    {
        ...
        ddlVIQ.DataSource = PhoenixInspectionRegisterCheckItems.ListCheckItemChapter(PhoenixSecurityContext.CurrentSecurityContext.CompanyID, "VIQ");
        ddlVIQ.DataTextField = "FLDCHAPTERNAME";
        ddlVIQ.DataValueField = "FLDCHAPTERID";
        ddlVIQ.DataBind();

        ddlCDI.DataSource = PhoenixInspectionRegisterCheckItems.ListCheckItemChapter(PhoenixSecurityContext.CurrentSecurityContext.CompanyID, "CDI");
        ddlCDI.DataTextField = "FLDCHAPTERNAME";
        ddlCDI.DataValueField = "FLDCHAPTERID";
        ddlCDI.DataBind();
    ...
    protected void MenuAddCheckItem_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../Inspection/InspectionRegisterCheckItemsList.aspx");
            }
    ...
    private void UpdateCheckItem()
    {
        try
        {
            ...
            Guid NewCheckitemid = new Guid();
              ...
              PhoenixInspectionRegisterCheckItems.InsertCheckItem(General.GetNullableGuid(ViewState["CHECKITEMID"].ToString())
                      , txtItem.Text
                      , General.GetNullableGuid(ddlPSC.SelectedValue)
                      , txtPSC.Text
                      , General.GetNullableGuid(ddlVIQ.SelectedValue)
                      , txtVIQ.Text
                      , General.GetNullableGuid(ddlCDI.SelectedValue)
                      , txtCDI.Text
                      , txtDescription.Text
                      , txtGuidence.Text
              ...
              ViewState["CHECKITEMID"] = NewCheckitemid;
    ...
    private void BindCheckitem()
    {
        try
        {
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
            {
                ...
                ds = PhoenixInspectionRegisterCheckItems.EditCheckItem(new Guid(ViewState["CHECKITEMID"].ToString()));
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    ddlVIQ.SelectedValue = ds.Tables[0].Rows[0]["FLDVIQCHAPTERID"].ToString();
                    ddlCDI.SelectedValue = ds.Tables[0].Rows[0]["FLDCDICHAPTERID"].ToString();
                    ...
                    ViewState["CHECKITEMID"] = ds.Tables[0].Rows[0]["FLDINSPECTIONCHECKITEMID"].ToString();
    ...
    protected void lnkDocumentAdd_Click(object sender, EventArgs e)
    {
        try
        {
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
            {
                PhoenixInspectionRegisterCheckItems.AddProcedureFormschecklist(new Guid(ViewState["CHECKITEMID"].ToString()), new Guid(txtdocumentProcedureId.Text));
    ...
    protected void BindHSEQA()
    {
        try
        {
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
            {
                DataSet dss = PhoenixInspectionRegisterCheckItems.FormsList(new Guid(ViewState["CHECKITEMID"].ToString()));
                int number = 1;
    ...
    void doc_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (c.Checked == false)
            {
                PhoenixInspectionRegisterCheckItems.DeleteProcedureFormschecklist(new Guid(ViewState["CHECKITEMID"].ToString()), new Guid(c.ID));
    ...
    protected void BindFormReports()
    {
        try
        {
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
            {
                DataSet dss = PhoenixInspectionRegisterCheckItems.FilingSystemList(new Guid(ViewState["CHECKITEMID"].ToString()));
                int number = 1;
    ...
    void cbreport_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (c.Checked == false)
            {
                PhoenixInspectionRegisterCheckItems.DeleteFilingSystem(new Guid(ViewState["CHECKITEMID"].ToString()), new Guid(c.ID));
    ...
    protected void lnkReportAdd_Click(object sender, EventArgs e)
    {
        try
        {
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
            {
                PhoenixInspectionRegisterCheckItems.AddFilingSystem(new Guid(ViewState["CHECKITEMID"].ToString()), new Guid(txtReportId.Text));
    ...
    protected void lnkComponentAdd_Click(object sender, EventArgs e)
    {
        try
        {
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
            {
                PhoenixInspectionRegisterCheckItems.AddComponent(new Guid(ViewState["CHECKITEMID"].ToString()), new Guid(txtComponentId.Text));
    ...
    private void BindCheckItemChapter()
    {
        try
        {
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
            {
                DataSet dss = PhoenixInspectionRegisterCheckItems.ChapterMappingList(new Guid(ViewState["CHECKITEMID"].ToString()));
                int number = 1;
                if (dss.Tables[0].Rows.Count > 0 && dss.Tables[0].Columns.Count > 1)
                {
    ...
    private void BindComponent()
    {
        try
        {
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
            {
                DataSet dss = PhoenixInspectionRegisterCheckItems.ComponentsList(new Guid(ViewState["CHECKITEMID"].ToString()));
                int number = 1;
                if (dss.Tables[0].Rows.Count > 0 && dss.Tables[0].Columns.Count > 1)
                {
    ...
    void cbComponent_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (cc.Checked == false)
            {
                PhoenixInspectionRegisterCheckItems.DeleteComponent(new Guid(ViewState["CHECKITEMID"].ToString()), new Guid(cc.ID));
    ...
    private void BindJobs()
    {
        if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
        {
            cbJobs.DataSource = PhoenixInspectionRegisterCheckItems.JobList(new Guid(ViewState["CHECKITEMID"].ToString()));
    ...
    private bool IsValidCheckItem()
    {
        ...
        //  if (General.GetNullableGuid(ddlPSC.SelectedValue) == null && General.GetNullableGuid(ddlVIQ.SelectedValue) == null && General.GetNullableGuid(ddlCDI.SelectedValue) == null)
        //      ucError.ErrorMessage = "Chapter is required.";

        //  if (General.GetNullableString(txtPSC.Text) == null && General.GetNullableString(txtVIQ.Text) == null && General.GetNullableString(txtCDI.Text) == null)
        //      ucError.ErrorMessage = "Chapter code is required.";
    ...
    protected void lnkLocationAdd_Click(object sender, EventArgs e)
    {
        try
        {
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
            {
                PhoenixInspectionRegisterCheckItems.AddLocation(new Guid(ViewState["CHECKITEMID"].ToString()), new Guid(txtLocationId.Text));
    ...
    private void BindLocation()
    {
        try
        {
            if (ViewState["CHECKITEMID"] != null && ViewState["CHECKITEMID"].ToString() != string.Empty)
            {
                DataSet ds1 = PhoenixInspectionRegisterCheckItems.LocationList(new Guid(ViewState["CHECKITEMID"].ToString()));
                int number = 1;
    ...
    void cbLocation_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ch.Checked == false)
            {
                ...
                PhoenixInspectionRegisterCheckItems.DeleteLocation(new Guid(ViewState["CHECKITEMID"].ToString()), new Guid(chs));
