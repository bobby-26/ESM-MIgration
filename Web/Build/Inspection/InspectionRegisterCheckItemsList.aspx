<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRegisterCheckItemsList.aspx.cs" Inherits="InspectionRegisterCheckItemsList" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvInspectionCheckItems.ClientID %>"));
                }, 200);
            }
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="80%">
            ...
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="ddlParentitem" runat="server" AutoPostBack="true" Filter="Contains" Width="300px" 
                           AppendDataBoundItems="true" OnSelectedIndexChanged="ddlParentitem_SelectedIndexChanged" EmptyMessage="Type to select "></telerik:RadComboBox>
                    </td>
                </tr>
            </table>
            <div runat="server" style="width:200%;">
            <eluc:TabStrip ID="MenuCheckItem" runat="server" OnTabStripCommand="MenuCheckItem_TabStripCommand" />
                </div> 
            <telerik:RadGrid ID="gvInspectionCheckItems" runat="server" AllowPaging="true" AllowCustomPaging="true" AllowSorting="true"
                OnNeedDataSource="gvInspectionCheckItems_NeedDataSource" RenderMode="Lightweight" OnItemCommand="gvInspectionCheckItems_ItemCommand"
                OnItemDataBound="gvInspectionCheckItems_ItemDataBound" ShowHeader="true" ShowFooter="false" Width="200%">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Item" HeaderStyle-Width="13%">
                            <ItemStyle Wrap="true" HorizontalAlign="left" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblCheckitemid" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDINSPECTIONCHECKITEMID") %> ' Visible="false"></telerik:RadLabel>
                                <asp:LinkButton ID="lnkItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDITEM") %>' CommandName="EDIT"></asp:LinkButton>                                
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>

                         <telerik:GridTemplateColumn HeaderText="Audit / Inspection / Chapter Code" HeaderStyle-Width="10%">
                            <ItemStyle Wrap="true" HorizontalAlign="left" />
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Responsibility" HeaderStyle-Width="10%">
                         ...
                         <telerik:GridTemplateColumn HeaderText="Checklist Mapping" HeaderStyle-Width="17%">
                            <ItemStyle Wrap="true" HorizontalAlign="left" />
                            <ItemTemplate>
