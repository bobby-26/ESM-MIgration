<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRegulationNotCompleted.aspx.cs" Inherits="InspectionRegulationNotCompleted" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvRegulation" runat="server" Height="91%" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            CellSpacing="0" GridLines="None"
            OnNeedDataSource="gvRegulation_NeedDataSource"
            OnItemCommand="gvRegulation_ItemCommand" EnableHeaderContextMenu="true" GroupingEnabled="false">
