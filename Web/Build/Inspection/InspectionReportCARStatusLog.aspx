<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionReportCARStatusLog.aspx.cs" Inherits="InspectionReportCARStatusLog" %>
...
<head id="Head1" runat="server">
    <title>CAR Status Log Report</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body onload="resizeFrame()">
    <form id="frmReportCARStatusLog" runat="server">
    ...
    <eluc:Status ID="ucStatus" runat="server" />
     <div class="navigation" id="Div2" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader" style="position: relative">
            <eluc:Title runat="server" ID="CARStatusLog" Text="CAR Status Log" ShowMenu="true">
            </eluc:Title>
