...
public partial class InspectionReportsOfficeAuditList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionReportsOfficeAuditList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvSchedulePlan')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("../Inspection/InspectionReportsOfficeAuditList.aspx", "Filter", "<i class=\"fas fa-search\"></i>", "FIND");
            toolbar.AddFontAwesomeButton("../Inspection/InspectionReportsOfficeAuditList.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDCOMPANYNAME", "FLDREFERENCENO", "FLDINSPECTIONNAME", "FLDLASTDONEDATE", "FLDDUEDATE", "FLDRANGEFROMDATE", "FLDCOMPLETIONDATE", "FLDAUDITOR", "FLDATTENDINGSUPDT", "FLDDEFICIENCYCOUNT", "FLDMAJORNCCOUNT", "FLDNCCOUNT", "FLDOBSCOUNT", "FLDSTATUSNAME", };
        string[] alCaptions = { "Company", "Reference Number", "Audit/Inspection", "Last Done Date", "Due Date", "Planned Date", "Completed Date", "Auditor", "Attending Supdt.", "Deficiency Count", "Major NC Count", "NC Count", "Observations Count", "Status" };
        ...
        ds = PhoenixInspectionAuditScheduleReport.OfficeAuditScheduleSearchReport(
                                                                PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                , General.GetNullableInteger(ucAuditCategory.SelectedHard)
                                                                , General.GetNullableGuid(ddlAudit.SelectedValue)
                                                                , General.GetNullableInteger(ucCompanySelect.SelectedCompany)
        ...
        General.ShowExcel("Office Audit/Inspection", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    }
    ...
    protected void MenuSchedulePlan_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ucCompanySelect.SelectedCompany = "";
    ...
    private void BindData()
    {
        ...
        General.SetPrintOptions("gvSchedulePlan", "Office Audit/Inspection", alCaptions, alColumns, ds);
    ...
    protected void gvSchedulePlan_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (cmdDeficiencySummary != null && lblReviewScheduleId != null)
            {
                ...
                cmdDeficiencySummary.Attributes.Add("onclick", "javascript:openNewWindow('Summary','','" + Session["sitepath"] + "/Inspection/InspectionDeficiencySummary.aspx?SOURCEID=" + lblReviewScheduleId.Text + "&VESSELID=0'); return true;");
