<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionRiskAssessmentVerification.aspx.cs" Inherits="InspectionRiskAssessmentVerification" %>
...
<head runat="server">
    <title>RA Verification Remarks</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    ...
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <tr>
            <td width="25%">
                <b><asp:Literal ID="lblOfficeRemarks" runat="server" Text="Verification Remarks"></asp:Literal></b>
            </td>
            <td>
