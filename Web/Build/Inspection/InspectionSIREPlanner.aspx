<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionSIREPlanner.aspx.cs" Inherits="InspectionSIREPlanner" %>
...
<head id="Head1" runat="server">
    <title>Inspection Schedule By Company</title>
...
<body>
    <form id="frmInspectionScheduleByCompany" runat="server">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvScheduleForCompany" runat="server" AutoGenerateColumns="False" AllowPaging="true" AllowCustomPaging="true" EnableViewState="true"
            Font-Size="11px" Width="100%" Height="92%" CellPadding="3" OnItemCommand="gvScheduleForCompany_ItemCommand" OnNeedDataSource="gvScheduleForCompany_NeedDataSource"
