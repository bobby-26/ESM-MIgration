<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionScheduleExtensionReason.aspx.cs" Inherits="InspectionScheduleExtensionReason" %>
                    ...
                    <asp:GridView ID="gvExtensionReason" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Posted By">
                                <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                <HeaderTemplate>
                                    <asp:Label ID="lblChangedByHeader" runat="server">Changed By</asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="PurPayableAmount">
                                <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                <HeaderTemplate>
                                    <asp:label ID="lblChangedDateHeader" runat="server">Changed Date</asp:label>
                                </HeaderTemplate>
                                <ItemTemplate>
