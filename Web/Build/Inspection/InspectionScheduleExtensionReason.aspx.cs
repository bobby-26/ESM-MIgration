...
public partial class InspectionScheduleExtensionReason : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                ViewState["INSPECTIONSCHEDULEID"] = Request.QueryString["scheduleid"].ToString();
            }
            else
    ...
    protected void MenuNCRGeneral_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("../Inspection/InspectionSchedule.aspx?scheduleid=" + ViewState["INSPECTIONSCHEDULEID"], false);
        }
    }
    ...
    private void BindData()
    {
        ...
        ds = PhoenixInspectionSchedule.ReScheduleHistorySearch(
                                                                General.GetNullableGuid(ViewState["INSPECTIONSCHEDULEID"].ToString())
                                                                , sortexpression
                                                                , sortdirection
