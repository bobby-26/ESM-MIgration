...
public partial class InspectionScheduleMaster : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionScheduleMaster.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvInspectionSchedule')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelp1','', '" + Session["sitepath"] + "/Inspection/InspectionScheduleFilter.aspx')", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
            toolbar.AddFontAwesomeButton("../Inspection/InspectionScheduleMaster.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        NameValueCollection nvc = Filter.CurrentInspectionScheduleFilterCriteria;
        ...
        if (Filter.CurrentInspectionScheduleFilterCriteria == null)
        {
        ...
        DataSet ds = PhoenixInspectionSchedule.InspectionScheduleSearch(
            ...
            , nvc != null ? General.GetNullableString(nvc.Get("ucStatus")) : General.GetNullableString(ViewState["Status"].ToString())
    ...
    protected void gvInspectionSchedule_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            RadLabel lblCompletionDate = (RadLabel)e.Item.FindControl("lblLastDoneDate");
