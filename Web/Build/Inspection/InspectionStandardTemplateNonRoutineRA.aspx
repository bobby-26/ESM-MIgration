<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionStandardTemplateNonRoutineRA.aspx.cs" Inherits="InspectionStandardTemplateNonRoutineRA" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessment" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Rev No" HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign="Center" AllowFiltering="false">
