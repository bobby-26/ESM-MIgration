<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionSupdtEventFeedbackBannerEdit.aspx.cs" Inherits="Inspection_InspectionSupdtEventFeedbackBannerEdit" %>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn>
                            ...
                            <HeaderTemplate>
                                <asp:CheckBox ID="chkAllAssignedTo" runat="server" Text="Select All" AutoPostBack="true"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" AllowSorting="true" SortExpression="FLDNAME">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblSignonoffId" runat="server" Visible="false" Text='<%# ((DataRowView)Container.DataItem)["FLDEMPLOYEEID"]%>'></telerik:RadLabel>
