...
public partial class Inspection_InspectionTMSAClientBPGComments : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Inspection/InspectionTMSAClientBPGComments.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvClientComments')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            //toolbar.AddFontAwesomeButton("javascript:openNewWindow('codehelp1','','Inspection/InspectionTMSAClientBPGCommentsAdd.aspx?categoryid=" + General.GetNullableGuid(ViewState["CATEGORYID"].ToString()) + "&contentid=" + General.GetNullableGuid(ViewState["CONTENTID"].ToString()) + "'); return false;", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
            //toolbar.AddFontAwesomeButton("../Inspection/InspectionTMSAClientBPGCommentsAdd.aspx?categoryid=" , "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixInspectionTMSAMatrix.ListTMSABPGComments(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixInspectionTMSAMatrix.ListTMSABPGComments(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            new Guid(ViewState["CATEGORYID"].ToString()),
            new Guid(ViewState["CONTENTID"].ToString()),
            sortexpression,
            sortdirection,
    ...
    {
        PhoenixInspectionTMSAMatrix.InspectionTMSAClientBPGCommentInsert(PhoenixSecurityContext.CurrentSecurityContext.UserCode, 
                                    new Guid(ViewState["CATEGORYID"].ToString()),
                                    new Guid(ViewState["CONTENTID"].ToString()),
                                    new Guid(company), 
                                    comments);
    ...
    {
        PhoenixInspectionTMSAMatrix.InspectionTMSAClientBPGCommentUpdate(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                                new Guid(commentsid),
                                new Guid(company),
                                    comments);  
    ...
    {
        PhoenixInspectionTMSAMatrix.InspectionTMSAClientBPGCommentDelete(PhoenixSecurityContext.CurrentSecurityContext.UserCode, new Guid(commentsid));
    }
