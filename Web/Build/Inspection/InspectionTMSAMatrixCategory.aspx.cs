...
public partial class Inspection_InspectionTMSAMatrixCategory : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddFontAwesomeButton("../Inspection/InspectionTMSAMatrixCategory.aspx", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
    ...
    protected void Bind_UserControls(object sender, EventArgs e)
    {
        ...
        ddlAudit.DataSource = PhoenixInspection.ListInspectionByCompany(General.GetNullableInteger(type)
                                        , General.GetNullableInteger(category)
                                        , null
                                        , 0
        ...
        {
            RadComboBoxItem item = ddlAudit.FindItemByText("TMSA & MR");
            if (item != null)
            {
                item.Selected = true;
            }
        ...
        {
            RadComboBoxItem item = ddlAudit.FindItemByText("OVMSA");
            if (item != null)
            {
                item.Selected = true;
            }
    ...
    protected void MenuPhoenixQuery_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("ADD"))
        {
            ...
            //   "javascript:Openpopup('codehelp1', '', '../Inspection/InspectionTMSAMatrixContentAdd.aspx?categoryid=" + General.GetNullableGuid(lblSelectedNode.Text) + "&noofcolumns=" + txtnoofcolumns.Text + "');");
            ...
            if (!string.IsNullOrEmpty(lblSelectedNode.Text))
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (string.IsNullOrEmpty(ds.Tables[0].Rows[0]["FLDPARENTCATEGORYID"].ToString()))
                    {
                        ...
                        txtnoofstages.Enabled = true;
                    }
                    else
                    {
                        txtnoofcolumns.Enabled = false;
                        txtnoofstages.Enabled = false;
                    }
                }
            }
    ...
    private void ShowQuery(Guid? categoryid, DataTable dt, DataTable dtcolumn)
    {
        ...
        if (columncount > 0)
        {
            ...
            for (int i = noofcolumns + 3; i < gvTMSAMatrix.Columns.Count; i++)
            {
    ...
    private int AddTemplateColumn(Guid? queryid, DataTable dt, DataTable dtcolumn)
    {
        ...
        if (dtcolumn.Rows.Count > 0)
        {
            foreach (DataRow dr in dt.Rows)
            {
                ...
                //gvTMSAMatrix.Columns.Add(procname);
                ...
                //gvTMSAMatrix.Columns.Add(objevidence);
                ...
                //gvTMSAMatrix.Columns.Add(action);
            }
        }
        else
        {
        ...
        //var columntomove1 = gvTMSAMatrix.Columns[0];
        //gvTMSAMatrix.Columns.RemoveAt(0);
        //gvTMSAMatrix.Columns.Insert(noofcolumns + 2, columntomove1);

        //var columntomove = gvTMSAMatrix.Columns[0];
        //gvTMSAMatrix.Columns.RemoveAt(0);
        //gvTMSAMatrix.Columns.Insert(noofcolumns + 2, columntomove);

        //var columntomove2 = gvTMSAMatrix.Columns[0];
        //gvTMSAMatrix.Columns.RemoveAt(0);
        //gvTMSAMatrix.Columns.Insert(noofcolumns + 2, columntomove2);
    ...
    //protected void gvTMSAMatrix_RowCommand_RowCommand(object sender, GridViewCommandEventArgs gce)
    //{
        ...
        if (txtnoofcolumns.Text != "")
        {
            ...
            for (int i = 1; i <= n; i++)
            {
                ...
                if (lblSelectedNode.Text != "")
                {
                    ...
                    ds = PhoenixInspectionTMSAMatrix.EditTMSAMatrixColumnHeaders(General.GetNullableGuid(lblSelectedNode.Text), General.GetNullableGuid(ddlAudit.SelectedValue));
                    if (ds.Rows.Count > 0)
                    {
                    ...
                    if (i == 1)
                    {
                        MyTextBox.Text = "Stage";
                    }
                    DataSet ds1 = new DataSet();
                    ds1 = PhoenixInspectionTMSAMatrix.TMSAMatrixCategoryEdit(new Guid(lblSelectedNode.Text), new Guid(ddlAudit.SelectedValue));
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                if (lblCategoryId.Text == "")
                {
                    ...
                    PhoenixInspectionTMSAMatrix.InsertTMSAMatrixCategory(
                                                         ...
                                                         General.GetNullableInteger(txtnoofstages.Text),
                ...
                else
                {
                    ...
                    dt = PhoenixInspectionTMSAMatrix.TMSAMatrixCategoryEdit(new Guid(lblSelectedNode.Text), new Guid(ddlAudit.SelectedValue));
    ...
    protected void DocumentCategoryEdit()
    {
        if (!string.IsNullOrEmpty(lblSelectedNode.Text) && lblSelectedNode.Text.ToString().ToUpper() != "ROOT")
        {
            ...
            DataSet ds = PhoenixInspectionTMSAMatrix.TMSAMatrixCategoryEdit(new Guid(lblSelectedNode.Text), new Guid(ddlAudit.SelectedValue));
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                txtnoofstages.Text = ds.Tables[0].Rows[0]["FLDNOOFSTAGES"].ToString();
                ...
                ddlAudit.SelectedValue = ds.Tables[0].Rows[0]["FLDINSPECTIONID"].ToString();
            }
    ...
    private void Reset()
    {
        ...
        if (!string.IsNullOrEmpty(lblSelectedNode.Text))
        {
            ds = PhoenixInspectionTMSAMatrix.TMSAMatrixCategoryEdit(new Guid(lblSelectedNode.Text), new Guid(ddlAudit.SelectedValue));
            if (ds.Tables[0].Rows.Count > 0)
            {
                if (string.IsNullOrEmpty(ds.Tables[0].Rows[0]["FLDPARENTCATEGORYID"].ToString()))
                {
                    tblnoofcolumns.Visible = false;
                    tblnoofstages.Visible = false;
                }
                else
                {
                    tblnoofcolumns.Visible = true;
