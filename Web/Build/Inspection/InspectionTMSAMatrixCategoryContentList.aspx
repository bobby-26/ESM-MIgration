<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionTMSAMatrixCategoryContentList.aspx.cs" Inherits="Inspection_InspectionTMSAMatrixCategoryContentList" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock runat="server" ID="DivHeader">
        ...
        <script type="text/javascript">
            function confirmTMSAReview(args) {
                if (args) {
                    __doPostBack("<%=confirmTMSAReview.UniqueID %>", "");
                }
            }
        </script>
        <script type="text/javascript">
            function confirmTMSAUnlock(args) {
                if (args) {
                    __doPostBack("<%=confirmTMSAUnlock.UniqueID %>", "");
                }
            }
        </script>
...
<body>
    <form id="frmDocumentCategory" runat="server">
        ...
        <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Height="93%" SplitBarsSize="10" Width="100%">
            ...
            <telerik:RadSplitBar ID="RadSplitbar1" runat="server" CollapseMode="Forward"  Width="100%" Height="100%">
            </telerik:RadSplitBar>
            <telerik:RadPane ID="contentPane" Scrolling ="Both" runat="server" Width="70%" Height="93%">
                <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" Height="80%">
                    ...
                    <table width="75%">
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="ddldeptlist" runat="server" OnSelectedIndexChanged="ddldeptlist_SelectedIndexChanged" AutoPostBack="true"
                                    DataTextField="FLDDEPARTMENTNAME" DataValueField="FLDDEPARTMENTID" Width="200px" EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true">
                                </telerik:RadComboBox>
                            </td>
                        </tr>
                    </table>
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvTMSAMatrix" runat="server" AutoGenerateColumns="false" Font-Size="11px" GridLines="None"
                        ...
                        OnItemCommand="gvTMSAMatrix_RowCommand" OnItemDataBound="gvTMSAMatrix_ItemDataBound" ShowFooter="false">
                        <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true"
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn HeaderText="Comply" >
                                    ...
                                    <ItemTemplate>
                                        <telerik:RadCheckBox ID="chkSelect" runat="server" EnableViewState="false" OnClick="chkSelect_Click" Checked='<%# DataBinder.Eval(Container,"DataItem.FLDCOMPLIANCE").ToString().Equals("1")?true:false %>'  />
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                            </Columns>
                            <Columns>
...
<%--                                    <FooterTemplate>
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn HeaderText="Action">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:ImageButton runat="server" AlternateText="Comments" ImageUrl="<%$ PhoenixTheme:images/vendor-detail.png %>" CommandName="CLIENTCOMMENTS" ID="cmdClientComments"
                                            ToolTip="Client BPG"></asp:ImageButton>
                                        <asp:LinkButton runat="server" AlternateText="OfficeChecks" CommandArgument='<%# Container.DataSetIndex %>' CommandName="OFFICECHECKS" ID="cmdOfficeChecks"
                                            ToolTip="Office Checks"><span class="icon"><i class="fas fa-check-square-ec"></i></span></asp:LinkButton>
                    ...
                    <asp:Button ID="confirmTMSAReview" runat="server" Text="confirm" OnClick="confirmTMSAReview_Click" />
                    <asp:Button ID="confirmTMSAUnlock" runat="server" Text="confirmUnlock" OnClick="confirmTMSAUnlock_Click" />
