<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionTMSAMatrixCategoryRevisionContentList.aspx.cs" Inherits="Inspection_InspectionTMSAMatrixCategoryRevisionContentList" %>
            ...
            <telerik:RadPane ID="contentPane" runat="server" Width="70%" Height="100%">
                <telerik:RadAjaxPanel ID="RadAjaxPanel2" runat="server" Height="80%">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvTMSAMatrix" runat="server" AutoGenerateColumns="false" Font-Size="11px" GridLines="None"
                        Width="100%" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" Height="100%" CellPadding="3" OnNeedDataSource="gvTMSAMatrix_NeedDataSource"
...
<%--                                    <FooterTemplate>
                           ...
                           <Columns>
                                <telerik:GridTemplateColumn HeaderText="Comply" >
                                    ...
                                    <ItemTemplate>
                                        <telerik:RadCheckBox ID="chkSelect" runat="server" EnableViewState="false" Enabled="false" Checked='<%# DataBinder.Eval(Container,"DataItem.FLDCOMPLIANCE").ToString().Equals("1")?true:false %>'  />
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                            </Columns>
                            <Columns>
