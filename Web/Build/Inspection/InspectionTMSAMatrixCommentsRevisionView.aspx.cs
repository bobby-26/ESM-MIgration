...
public partial class Inspection_InspectionTMSAMatrixCommentsRevisionView : PhoenixBasePage
{
    ...
    private void BindData()
    {
        ...
        {
            dt = PhoenixInspectionTMSAMatrix.ListTMSARevisionComments(new Guid(ViewState["CATEGORYID"].ToString()), new Guid(ViewState["REVISIONID"].ToString()));
