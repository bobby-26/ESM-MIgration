<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionTMSAMatrixContentAdd.aspx.cs" Inherits="Inspection_InspectionTMSAMatrixContentAdd" %>
...
<body>
    <form id="frmDocumentCategory" runat="server">
        ...
        <eluc:TabStrip ID="MenuDocumentCategoryMain" Title="TMSA/ISM/ISO Matrix Content" runat="server" OnTabStripCommand="MenuDocumentCategoryMain_TabStripCommand"></eluc:TabStrip>
            ...
            <tr>
                ...
                <td>
                    <div id="dvClass" runat="server" class="input" style="overflow: auto; width: 200px;
                        height: 95px">
                        <asp:CheckBoxList ID="chkDeptList" runat="server" CssClass="input" DataTextField="FLDDEPARTMENTNAME"
                            DataValueField="FLDDEPARTMENTID" Height="100%" RepeatDirection="Vertical" Width="100%">
                        </asp:CheckBoxList>
                    </div>
                </td>
            </tr>                
