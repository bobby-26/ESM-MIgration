<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionTMSAVerificationSummaryView.aspx.cs" Inherits="Inspection_InspectionTMSAVerificationSummaryView" %>
    ...
    <form id="frmDocumentCategory" runat="server">
        ...
        <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true">
                    ...
                    <telerik:RadGrid RenderMode="Lightweight" ID="gvCDISIREMatrix" runat="server" AutoGenerateColumns="false" Font-Size="11px" GridLines="None"
                        Width="100%" AllowSorting="true" AllowPaging="false" Height="90%" CellPadding="3" OnNeedDataSource="gvCDISIREMatrix_NeedDataSource"
...
<%--                                    <FooterTemplate>
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn HeaderText="Comply">
                                    ...
                                    <ItemTemplate>
                                        <telerik:RadCheckBox ID="chkSelect" runat="server" EnableViewState="true" Checked='<%# DataBinder.Eval(Container,"DataItem.FLDCOMPLIANCE").ToString().Equals("1")?true:false %>'  />
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                            </Columns>
                            <Columns>
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn HeaderText="Remarks">
                                    ...
                                    <ItemTemplate>
                                        <telerik:RadLabel ID="lblremarks" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDOFFICEREMARKS" ) %>'></telerik:RadLabel>                                        
                                    </ItemTemplate>
                                    <%--                                    <FooterTemplate>
                                            <telerik:RadTextBox ID="txtObj" runat="server" CssClass="input" Rows="2" TextMode="MultiLine"
                                                ></telerik:RadTextBox>
