...
public partial class Inspection_InspectionTMSAVerificationSummaryView : PhoenixBasePage
{
    ...
    private void setMenu()
    {
        ...
        toolbar.AddFontAwesomeButton("../Inspection/InspectionTMSAVerificationSummaryView.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "EXCEL");
        //toolbar.AddFontAwesomeButton("../Inspection/InspectionTMSAMatrixCategoryContentList.aspx", "Publish", "<i class=\"fa fa-check-square\"></i>", "PUBLISH");
        //toolbar.AddFontAwesomeButton("../Inspection/InspectionTMSAMatrixCategoryContentList.aspx", "Revisions", "<i class=\"fas fa-receipt\"></i>", "REVISIONS");
    ...
    protected void ShowExcel()
    {
        ...
        dt = PhoenixInspectionTMSAMatrix.EditTMSAMatrixColumnHeaders(General.GetNullableGuid(ViewState["CATEGORYID"].ToString()), General.GetNullableGuid(ViewState["INSPECTIONID"].ToString()));
        ...
        columns = columns + ",FLDPROCEDURES,FLDOBJECTIVEEVIDENCE,FLDDEPARTMENTNAMELIST,FLDISCOMPLIANCE,FLDISOFFICEACCEPTED,FLDOFFICEREMARKS";
        captions = captions + ",Procedures, Objective Evidence,Responsibility, Comply, Accepted, Remarks";
        ...
        dtcolumn = PhoenixInspectionTMSAMatrix.TMSAMatrixSummaryVerificationView(General.GetNullableGuid(ViewState["CATEGORYID"].ToString()), null, General.GetNullableInteger(ViewState["COUNTTYPE"].ToString()));
    ...
    private void BindData()
    {
        try
        {
            ...
            dtcolumn = PhoenixInspectionTMSAMatrix.TMSAMatrixSummaryVerificationView(General.GetNullableGuid(ViewState["CATEGORYID"].ToString()), General.GetNullableGuid(null), General.GetNullableInteger(ViewState["COUNTTYPE"].ToString()));
        ...
        if (e.Item is GridDataItem)
        {
            ...
            if (BPGAtt != null)
            {
                ...
                BPGAtt.Attributes.Add("onclick", "javascript:openNewWindow('att','','" + Session["sitepath"] + "/Common/CommonFileAttachment.aspx?dtkey=" + drv["FLDDTKEY"].ToString() + "&mod="
                    + PhoenixModule.QUALITY + "&type=BPGEXAMPLE&cmdname=SHIPBOARDEVIDENCEUPLOAD" + "'); return true;");
            }
