<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionTrainingHistory.aspx.cs" Inherits="Inspection_InspectionTrainingHistory" %>
    ...
    <title>Training History</title>
     <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvTrainingHistorylist.ClientID %>"));
                }, 200);
           }
...
<body>
    ...
    <eluc:TabStrip ID="TabstripTraininghistoy" runat="server" OnTabStripCommand="Traininghistory_TabStripCommand"
    ...
    <table id="table1">
        <tbody>
            ...
            <telerik:RadComboBox ID="radcomboTraining" runat="server"  CssClass="input"  EmptyMessage="Type to select Training"  AllowCustomText="true"  width="160px" />
    ...
    <eluc:TabStrip ID="TabstripTraininghistorymenu" runat="server" OnTabStripCommand="Traininghistorymenu_TabStripCommand"
        TabStrip="true"></eluc:TabStrip>
              <asp:Button ID="cmdHiddenSubmit" runat="server" Text="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" CssClass="hidden" />
    <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvTrainingHistorylist" 
        AutoGenerateColumns="false" AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvTrainingHistorylist_NeedDataSource"
        OnItemDataBound="gvTrainingHistorylist_ItemDataBound">
            ...
            <Columns>
               <telerik:GridTemplateColumn HeaderText="Vessel" UniqueName="vesselcolumn" >
                ...
                <telerik:GridTemplateColumn HeaderText=" Last Done">
                    ...
                    <ItemTemplate>
                        <telerik:RadLabel ID="Radlbldonedate" runat="server" Text='<%# General.GetDateTimeToString(( DataBinder.Eval(Container, "DataItem.FLDTRAININGONBOARDLASTDONEDATE")).ToString())%>'>
                        </telerik:RadLabel>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
