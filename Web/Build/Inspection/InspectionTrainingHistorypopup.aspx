<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionTrainingHistorypopup.aspx.cs" Inherits="Inspection_InspectionTrainingHistorypopup" %>
...
<head runat="server">
    <title>Training History Across all Vessels</title>
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvTrainingHistorypopuplist.ClientID %>"));
                }, 200);
           }
...
<body>
    ...
    <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server"
        DecorationZoneID="gvTrainingHistorylist" DecoratedControls="All" EnableRoundedCorners="true" />
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
     <eluc:TabStrip ID="TabstripTraininghistoy" runat="server" OnTabStripCommand="Traininghistory_TabStripCommand"
        ...
        EnableShadow="true"/>
         <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvTrainingHistorypopuplist" 
        AutoGenerateColumns="false" AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvTrainingHistorypopuplist_NeedDataSource"
        OnItemDataBound="gvTrainingHistorypopuplist_ItemDataBound" >
        <MasterTableView  DataKeyNames="FLDTRAININGONBOARDSCHEDULEID" AutoGenerateColumns="false" EnableColumnsViewState ="false"
