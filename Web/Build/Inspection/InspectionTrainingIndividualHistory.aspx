<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionTrainingIndividualHistory.aspx.cs" Inherits="Inspection_InspectionTrainingIndividualHistory" %>
...
<head runat="server">
   <title>Individual Training History</title>
    ...
    <eluc:TabStrip ID="Tabstriptraininghistorymenu" runat="server" OnTabStripCommand="traininghistorymenu_TabStripCommand"
        ...
        <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvTrainingHistorylist" 
           ...
           OnItemDataBound="gvTrainingHistorylist_ItemDataBound">
            <MasterTableView  DataKeyNames="FLDTRAININGONBOARDSCHEDULEID" AutoGenerateColumns="false"
