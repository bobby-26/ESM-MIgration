<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionTrainingReport.aspx.cs" Inherits="Inspection_InspectionTrainingReport" %>
...
<head runat="server">
   ...
   <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvMandatoryTrainingReport.ClientID %>"));
               }, 200);
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvCompanySpecifiedTrainingReport.ClientID %>"));
                }, 200);
           }
...
<body>
    ...
    <eluc:TabStrip ID="TabstripTrainingreport" runat="server" OnTabStripCommand="Trainingreport_TabStripCommand"
    ...
    <eluc:TabStrip ID="TabstripTrainingreportmenu" runat="server" OnTabStripCommand="Trainingreportmenu_TabStripCommand"
        TabStrip="true"></eluc:TabStrip>
    <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvMandatoryTrainingReport"
        AutoGenerateColumns="false" OnNeedDataSource="gvMandatoryTrainingReport_NeedDataSource" OnItemDataBound="gvMandatoryTrainingReport_ItemDataBound">
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed" CommandItemDisplay="None"
            ...
            <Columns>
                <telerik:GridTemplateColumn HeaderText="Mandatory Trainings/ Exercise">
                    ...
                    <ItemTemplate>
                        <telerik:RadLabel ID="RadlblTrainingName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDTRAININGNAME")%>'>
                         ...
                         <telerik:RadLabel ID="Radlbltrainingid" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container, "DataItem.FLDTRAININGID")%>'>
                        </telerik:RadLabel>
                    </ItemTemplate>
    ...
    <div>
     <eluc:TabStrip ID="TabstripTrainingreportmenu_1" runat="server" OnTabStripCommand="Trainingreportmenu1_TabStripCommand"
        TabStrip="true"></eluc:TabStrip>
    <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvCompanySpecifiedTrainingReport"
        AutoGenerateColumns="false" OnNeedDataSource="gvCompanySpecifiedTrainingReport_NeedDataSource" OnItemDataBound="gvCompanySpecifiedTrainingReport_ItemDataBound" >
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed" CommandItemDisplay="None"
            ShowHeadersWhenNoRecords="true" EnableColumnsViewState="false" >
            <NoRecordsTemplate>
                        <table width="100%" border="0">
            ...
            <Columns>
                <telerik:GridTemplateColumn HeaderText="Company Specified Trainings/Exercise">
                    <HeaderStyle HorizontalAlign="Left" Width="150px" Font-Bold="true"/>
                    <ItemStyle HorizontalAlign="Left" />
                    <ItemTemplate>
                        <telerik:RadLabel ID="RadlblTrainingName1" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDTRAININGNAME")%>'>
                        </telerik:RadLabel>
                        <telerik:RadLabel ID="Radlbltrainingid1" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container, "DataItem.FLDTRAININGID")%>'>
                        </telerik:RadLabel>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                <telerik:GridTemplateColumn HeaderText="Scenario">
