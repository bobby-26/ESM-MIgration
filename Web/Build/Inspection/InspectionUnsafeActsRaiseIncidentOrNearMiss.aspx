<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionUnsafeActsRaiseIncidentOrNearMiss.aspx.cs"
    Inherits="InspectionUnsafeActsRaiseIncidentOrNearMiss" %>
    ...
    <form id="form1" runat="server">
        ...
        <table id="tblFiles" width="100%">
            ...
            <tr>
                <td colspan="2">
                    <br />
                    <asp:Label ID="lblMessage" Width="85%" runat="server" ForeColor="Red" Font-Bold="true"
                        Font-Size="Small" Style="word-wrap: break-word;"></asp:Label>
                </td>
            </tr>
        </table>
    </form>
