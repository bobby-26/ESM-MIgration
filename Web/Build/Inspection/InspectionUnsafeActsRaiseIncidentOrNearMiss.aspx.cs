...
public partial class InspectionUnsafeActsRaiseIncidentOrNearMiss : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ucCategory.TypeId = ViewState["INCIDENTORNEARMISS"].ToString() == "1" ? "1" : "2";
    ...
    protected void MenuLocation_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            if (CommandName.ToUpper().Equals("RAISE"))
            {
                ...
                PhoenixInspectionUnsafeActsConditions.UnsafeActsRaiseIncidentOrNearMiss(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                    , General.GetNullableGuid(ViewState["DIRECTINCIDENTID"].ToString())
