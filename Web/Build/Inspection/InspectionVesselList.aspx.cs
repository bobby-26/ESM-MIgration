...
public partial class InspectionVesselList : PhoenixBasePage
{    
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            toolbar.AddImageButton("../Inspection/InspectionVesselList.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("javascript:CallPrint('gvVesselList')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageButton("../Inspection/InspectionVesselList.aspx", "Find", "search.png", "FIND");
    ...
    protected void gvVesselList_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
    {
    ...
    protected void gvVesselList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                Filter.CurrentInspectionVesselID = ((Label)_gridView.Rows[nCurrentRow].FindControl("lblVesselId")).Text;
                string vesselname = ((LinkButton)_gridView.Rows[nCurrentRow].FindControl("lnkVesselName")).Text;
                Response.Redirect("InspectionScheduleSearch.aspx?vesselname=" + vesselname, false);
            }
        }
        catch (Exception ex)
        {
    ...
    protected void gvVesselList_RowDeleting(object sender, GridViewDeleteEventArgs de)
    {
        BindData();
        SetPageNavigator();
    }
    ...
    {
        PhoenixRegistersVessel.DeleteVessel(PhoenixSecurityContext.CurrentSecurityContext.UserCode, vesselid);
    }
