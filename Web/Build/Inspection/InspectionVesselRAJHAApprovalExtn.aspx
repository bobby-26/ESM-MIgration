<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionVesselRAJHAApprovalExtn.aspx.cs" Inherits="InspectionVesselRAJHAApprovalExtn" %>
...
<body>
    ...
    <div>
        <b><font color="blue">
            <asp:Literal ID="lblNote" runat="server" Text="* Note: Once the JHA is approved, It cannot be edited."></asp:Literal></font></b>
    </div>
