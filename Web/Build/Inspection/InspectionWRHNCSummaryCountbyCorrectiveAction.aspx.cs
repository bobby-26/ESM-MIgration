...
public partial class Inspection_InspectionWRHNCSummaryCountbyCorrectiveAction : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCSummaryCountbyCorrectiveAction.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCSummaryCountbyCorrectiveAction.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDCORRECTIVEACTION", "FLDPERIOD", "FLDNCCOUNT" };
        string[] alCaptions = { "Corrective Action", "Month", "Total No. of NC`s" };
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyCorrectiveAction.NcSummaryCountbyCorrectiveAction((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
    ...
    private void ShowReport()
    {
        ...
        General.SetPrintOptions("gvCrew", "WRH NC Summary Count by CorrectiveAction", alCaptions, alColumns, ds);
