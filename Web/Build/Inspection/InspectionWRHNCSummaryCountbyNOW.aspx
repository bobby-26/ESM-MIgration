<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCSummaryCountbyNOW.aspx.cs" Inherits="Inspection_InspectionWRHNCSummaryCountbyNOW" %>
...
<head runat="server">
    <title>NC Summary Count by Nature Of Work</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC Summary Count by Nature Of Work"></eluc:Title>
                        </div>
                    </div>
