...
public partial class Inspection_InspectionWRHNCSummaryCountbyNOW : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCSummaryCountbyNOW.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCSummaryCountbyNOW.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDNATUREOFWORK", "FLDPERIOD", "FLDNCCOUNT" };
        string[] alCaptions = { "Nature Of Work", "Month", "Total No. of NC`s" };
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyNOW.NcSummaryCountbyNatureOfWork((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
    ...
    private void ShowReport()
    {
        ...
        General.SetPrintOptions("gvCrew", "WRH NC Summary Count by Nature Of Work", alCaptions, alColumns, ds);
