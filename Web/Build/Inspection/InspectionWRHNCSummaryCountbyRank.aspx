<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCSummaryCountbyRank.aspx.cs" Inherits="Inspection_InspectionWRHNCSummaryCountbyRank" %>
...
<head runat="server">
    <title>NC Summary Count by Rank</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC Summary Count by Rank"></eluc:Title>
                        </div>
                    </div>
