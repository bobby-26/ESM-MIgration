...
public partial class Inspection_InspectionWRHNCSummaryCountbyRank : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCSummaryCountbyRank.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCSummaryCountbyRank.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDRANKNAME", "FLDPERIOD", "FLDNCCOUNT" };
        string[] alCaptions = { "Rank", "Month", "Total No. of NC`s" };
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyRank.NcSummaryCountbyRank((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
