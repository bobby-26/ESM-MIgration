...
public partial class Inspection_InspectionWRHNCSummaryCountbyVessel : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCSummaryCountbyVessel.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCSummaryCountbyVessel.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDVESSEL", "FLDPERIOD", "FLDNCOUNT" };
        string[] alCaptions = { "Vessel", "Month", "Total No. of NC`s" };
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyVessel.NcSummaryCountbyVessel((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
