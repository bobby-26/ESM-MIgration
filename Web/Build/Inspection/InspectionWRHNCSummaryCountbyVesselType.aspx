<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCSummaryCountbyVesselType.aspx.cs" Inherits="Inspection_InspectionWRHNCSummaryCountbyVesselType" %>
...
<head runat="server">
    <title>NC Summary Count by VesselType</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC Summary Count by VesselType"></eluc:Title>
                        </div>
                    </div>
                        ...
                        <asp:GridView ID="gvCrew" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDVESSELTYPE") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
