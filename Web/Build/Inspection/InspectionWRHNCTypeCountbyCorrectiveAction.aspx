<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyCorrectiveAction.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyCorrectiveAction" %>
...
<head runat="server">
    <title>NC Type Count by Corrective Action</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC Type Count by Corrective Action"></eluc:Title>
                        </div>
                    </div>
                    ...
                    <table cellpadding="2" cellspacing="2">
                        <tr align="top">
                            ...
                            <td>
                             ...
                             <td>
                                <asp:Literal ID="litCorrectiveAction" runat="server" Text="Corrective Action"></asp:Literal>
                                <div runat="server" id="divReason" class="input" style="overflow-y: auto; overflow-x: hidden; height: 80px" onscroll="javascript:setGroupScroll();">
                                    <asp:CheckBoxList ID="chkboxlstCorAction" runat="server" DataTextField="FLDQUICKNAME" AutoPostBack="false" Width="390px"
                                        DataValueField="FLDQUICKCODE" RepeatDirection="Vertical" RepeatColumns="1" OnDataBound="OnDataBound">
                                    </asp:CheckBoxList>
                                </div>
                            </td>
                        </tr>
                    ...
                    <div id="divGrid" style="position: relative; overflow: auto; z-index: 0; width: 99%">
                        <asp:GridView ID="gvCrew" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblcorrectiveaction" runat="server">Corrective Action</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDCORRECTIVEACTION") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblFormNo" runat="server">S1 (<10 H)</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDS1COUNT") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblVessel" runat="server">S2 (Split <2)</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDS2COUNT") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblVessel" runat="server">S3 (<6 H)</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDS3COUNT") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblRefSentOn" runat="server">S4 (Gap >14 H)</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDS4COUNT") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblRefRespondOn" runat="server">S5 (<77 H)</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDS5COUNT") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblRefRespondOn" runat="server">O1 (OPA 15 H)</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDO1COUNT") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblDeliveredOn" runat="server">O2 (OPA 36 H)</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDO2COUNT") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
