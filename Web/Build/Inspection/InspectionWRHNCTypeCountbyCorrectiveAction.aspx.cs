...
public partial class Inspection_InspectionWRHNCTypeCountbyCorrectiveAction : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyCorrectiveAction.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyCorrectiveAction.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void CrewShowExcel_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("CLEAR"))
            {
                ...
                foreach (ListItem item in chkboxlstCorAction.Items)
                {
                    item.Selected = false;
                ...
                InspectionFilter.CurrentWRHNcTypeCountbyCorrectiveActionFilter = null;
                ShowReport();
                SetPageNavigator();
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                sessionFilterValues();
                Response.Redirect("../Inspection/InspectionWRHNCTypeCountbyCorrectiveActionVisual.aspx");
            }
    ...
    public NameValueCollection sessionFilterValues()
    {
        ...
        if (IsPostBack)
        {
            ...
            nvc.Add("chkboxlstCorrectiveAction", selectedAction());

            InspectionFilter.CurrentWRHNcTypeCountbyCorrectiveActionFilter = nvc;
        }
    ...
    protected void BindFilterCriteria()
    {
        ...
        NameValueCollection nvc = InspectionFilter.CurrentWRHNcTypeCountbyCorrectiveActionFilter;
        if (nvc == null)
        {
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyCorrectiveAction.NcCountbyCorrectiveAction((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
    ...
    private void ShowReport()
    {
        ...
        General.SetPrintOptions("gvCrew", "WRH NC Type Count by CorrectiveAction", alCaptions, alColumns, ds);
    ...
    public void bindCorrectiveActionList()
    {
        chkboxlstCorAction.DataSource = PhoenixInspectionWRHNCTypeCountbyReason.getReasonList(82);
        chkboxlstCorAction.DataBind();
    }
    protected void OnDataBound(object sender, EventArgs e)
    {
        ListItem li = new ListItem("--Check All--", "0");
        li.Attributes.Add("onclick", "checkUnchekAll(this);");
        chkboxlstCorAction.Items.Insert(0, li);
    }
