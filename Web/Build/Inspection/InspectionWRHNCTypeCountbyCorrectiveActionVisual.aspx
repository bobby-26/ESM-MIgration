<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyCorrectiveActionVisual.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyCorrectiveActionVisual" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <div id="nctypecountactionbyyear-1"></div>
        <div id="nctypecountactionbyquarter-2"></div>
        <div id="nctypecountactionbymonth-3"></div>
        <div id="nctypecountactionbyfleet-4"></div>
        <div id="nctypecountactionbyvessel-5"></div>
        <div id="nctypecountbyaction-6"></div>
