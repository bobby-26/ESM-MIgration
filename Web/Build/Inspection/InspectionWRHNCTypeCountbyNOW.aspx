<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyNOW.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyNOW" %>
...
<head runat="server">
    <title>NC Type Count by Nature Of Work</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                    ...
                    <table cellpadding="2" cellspacing="2">
                        <tr align="top">
                            ...
                            <td>
                             ...
                             <td>
                                <asp:Literal ID="litNOW" runat="server" Text="Nature Of Work"></asp:Literal>
                                <div runat="server" id="divNOW" class="input" style="overflow-y: auto; overflow-x: hidden; height: 80px" onscroll="javascript:setGroupScroll();">
                                    <asp:CheckBoxList ID="chkboxlstNOW" runat="server" DataTextField="FLDQUICKNAME" AutoPostBack="false" Width="390px"
                    ...
                    <div id="divGrid" style="position: relative; overflow: auto; z-index: 0; width: 99%">
                        <asp:GridView ID="gvCrew" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblcorrectiveaction" runat="server">Nature Of Work</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDNATUREOFWORK") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
