...
public partial class Inspection_InspectionWRHNCTypeCountbyNOW : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyNOW.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyNOW.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void CrewShowExcel_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("CLEAR"))
            {
                ...
                foreach (ListItem item in chkboxlstNOW.Items)
                {
                    item.Selected = false;
                ...
                InspectionFilter.CurrentWRHNcTypeCountbyNOWFilter = null;
                ShowReport();
                SetPageNavigator();
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                sessionFilterValues();
                Response.Redirect("../Inspection/InspectionWRHNCTypeCountbyNOWVisual.aspx");
            }
    ...
    public NameValueCollection sessionFilterValues()
    {
        ...
        if (IsPostBack)
        {
            ...
            nvc.Add("chkboxlstNOW", selectedNOW());

            InspectionFilter.CurrentWRHNcTypeCountbyNOWFilter = nvc;
        }
    ...
    protected void BindFilterCriteria()
    {
        ...
        NameValueCollection nvc = InspectionFilter.CurrentWRHNcTypeCountbyNOWFilter;
        if (nvc == null)
        {
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDNATUREOFWORK", "FLDPERIOD", "FLDS1COUNT", "FLDS2COUNT", "FLDS3COUNT", "FLDS4COUNT", "FLDS5COUNT", "FLDO1COUNT", "FLDO2COUNT", "FLDTOTAL" };
        string[] alCaptions = { "Nature Of Work", "Month", "S1 (<10 H)", "S2 (Split <2)", "S3 (<6 H)", "S4 (Gap >14 H)", "S5 (<77 H)", "O1 (OPA 15 H)", "O2 (OPA 36 H)", "Total No. of NC`s" };
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyNOW.NcCountbyNatureOfWork((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
    ...
    private void ShowReport()
    {
        ...
        General.SetPrintOptions("gvCrew", "WRH NC Type Count by Nature Of Work", alCaptions, alColumns, ds);
    ...
    public void bindNatureOfWorkList()
    {
        chkboxlstNOW.DataSource = PhoenixInspectionWRHNCTypeCountbyReason.getReasonList(84);
        chkboxlstNOW.DataBind();
    }
    protected void OnDataBound(object sender, EventArgs e)
    {
        ListItem li = new ListItem("--Check All--", "0");
        li.Attributes.Add("onclick", "checkUnchekAll(this);");
        chkboxlstNOW.Items.Insert(0, li);
    }
