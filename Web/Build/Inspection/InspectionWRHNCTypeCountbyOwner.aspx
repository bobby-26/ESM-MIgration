<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyOwner.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyOwner" %>
...
<head runat="server">
    <title>NC Type Count by Owner</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC Type Count by Owner"></eluc:Title>
                        </div>
                    </div>
                        ...
                        <tr align="top">
                            ...
                            <td>
                             ...
                             <td>
                                ...
                                <eluc:Address ID="ucPrincipal" AddressType="128" runat="server" AppendDataBoundItems="true" CssClass="input" />
                            </td>
                    ...
                    <div id="divGrid" style="position: relative; overflow: auto; z-index: 0; width: 99%">
                        <asp:GridView ID="gvCrew" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblVendorName" runat="server">Owner</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDOWNER") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
