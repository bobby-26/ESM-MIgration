...
public partial class Inspection_InspectionWRHNCTypeCountbyOwner : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyOwner.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyOwner.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void CrewShowExcel_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("CLEAR"))
            {
                ...
                InspectionFilter.CurrentWRHNcTypeCountbyOwnerFilter = null;
                ShowReport();
                SetPageNavigator();
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                sessionFilterValues();
                Response.Redirect("../Inspection/InspectionWRHNCTypeCountbyOwnerVisual.aspx");
            }
    ...
    public NameValueCollection sessionFilterValues()
    {
        ...
        if (IsPostBack)
        {
            ...
            InspectionFilter.CurrentWRHNcTypeCountbyOwnerFilter = nvc;
        }

        return InspectionFilter.CurrentWRHNcTypeCountbyOwnerFilter;
    }
    protected void BindFilterCriteria()
    {

        NameValueCollection nvc = InspectionFilter.CurrentWRHNcTypeCountbyOwnerFilter;
        if (nvc == null)
        {
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDOWNER", "FLDPERIOD", "FLDS1COUNT", "FLDS2COUNT", "FLDS3COUNT", "FLDS4COUNT", "FLDS5COUNT", "FLDO1COUNT", "FLDO2COUNT", "FLDTOTAL" };
        string[] alCaptions = { "Owner", "Month", "S1 (<10 H)", "S2 (Split <2)", "S3 (<6 H)", "S4 (Gap >14 H)", "S5 (<77 H)", "O1 (OPA 15 H)", "O2 (OPA 36 H)", "Total No. of NC`s" };
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyOwner.NcCountbyOwner((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
