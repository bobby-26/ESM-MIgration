<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyOwnerVisual.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyOwnerVisual" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <div id="nctypecountownerbyyear-1"></div>
        <div id="nctypecountownerbyquarter-2"></div>
        <div id="nctypecountownerbymonth-3"></div>
        <div id="nctypecountownerbyfleet-4"></div>
        <div id="nctypecountownerbyvessel-5"></div>
        <div id="nctypecountbyowner-6"></div>
    </form>
