...
public partial class Inspection_InspectionWRHNCTypeCountbyRank : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyRank.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyRank.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            //if (dce.CommandName.ToUpper().Equals("SHOWNCREPORT"))
            //{
            ...
            {
                sessionFilterValues();
                Response.Redirect("../Inspection/InspectionWRHNCTypeCountbyRankVisual.aspx");
            }
    ...
    public NameValueCollection sessionFilterValues()
    {
        ...
        if (IsPostBack)
        {
            ...
            InspectionFilter.CurrentWRHNcTypeCountbyRankFilter = nvc;
        }
    ...
    protected void BindFilterCriteria()
    {
        ...
        NameValueCollection nvc = InspectionFilter.CurrentWRHNcTypeCountbyRankFilter;
        if (nvc == null)
        {
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyRank.NcCountbyRank((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
