<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyRankVisual.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyRankVisual" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <div id="nctypecountrankbyyear-1"></div>
        <div id="nctypecountrankbyquarter-2"></div>
        <div id="nctypecountrankbymonth-3"></div>
        <div id="nctypecountrankbyfleet-4"></div>
        <div id="nctypecountrankbyvessel-5"></div>
        <div id="nctypecountbyrank-6"></div>
    </form>
