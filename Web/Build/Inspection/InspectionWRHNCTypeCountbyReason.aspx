<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyReason.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyReason" %>
...
<head runat="server">
    <title>NC Type Count by Reason</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC Type Count by Reason"></eluc:Title>
                        </div>
                    </div>
                        ...
                        <tr align="top">
                            ...
                            <td>
                                ...
                                <div runat="server" id="divReason" class="input" style="overflow-y: auto; overflow-x: hidden; height: 80px" onscroll="javascript:setGroupScroll();">
                                    <asp:CheckBoxList ID="chkboxlstReason" runat="server" DataTextField="FLDQUICKNAME" AutoPostBack="false" Width="390px"
                    ...
                    <div id="divGrid" style="position: relative; overflow: auto; z-index: 0; width: 99%">
                        <asp:GridView ID="gvCrew" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblVendorName" runat="server">Reason</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
