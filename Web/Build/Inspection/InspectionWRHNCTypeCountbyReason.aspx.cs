...
using System.Web;
public partial class Inspection_InspectionWRHNCTypeCountbyReason : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyReason.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyReason.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void CrewShowExcel_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("CLEAR"))
            {
                ...
                foreach (ListItem item in chkboxlstReason.Items)
                {
                    item.Selected = false;
                ...
                InspectionFilter.CurrentWRHNcTypeCountbyReasonFilter = null;
                ShowReport();
                SetPageNavigator();
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                InspectionFilter.CurrentWRHNcTypeCountbyRankFilter = null;
                sessionFilterValues();
            }
            if (dce.CommandName.ToUpper().Equals("SHOWVISUAL"))
            {
                sessionFilterValues();
                Response.Redirect("../Inspection/InspectionWRHNCTypeCountbyReasonVisual.aspx");
            }
    ...
    public NameValueCollection sessionFilterValues()
    {
        ...
        if (IsPostBack)
        {
            ...
            nvc.Add("chkboxlistReason", selectedReason());

            InspectionFilter.CurrentWRHNcTypeCountbyReasonFilter = nvc;
        }

        return InspectionFilter.CurrentWRHNcTypeCountbyRankFilter;
    }
    protected void BindFilterCriteria()
    {

        NameValueCollection nvc = InspectionFilter.CurrentWRHNcTypeCountbyReasonFilter;
        if (nvc == null)
        {
        ...
        //chkboxlstReason.SelectedValue = CheckIsNull(nvc.Get("chkboxlistReason"));
        //string Reason = CheckIsNull(nvc.Get("chkboxlistReason"));
        //CheckUncheck(Reason, "Reason");
    ...
    protected void CheckUncheck(string Values, string ID)
    {
        if (Values != "" && Values != null)
        {
            ...
            for (int i = 0; i < values.Length; i++)
            {
                ...
                //if (ID == "Reason")
                //    chkboxlstReason.Items.FindByValue(values[i]).Selected = true;
                //else if (ID == "Fleet")
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDREASON", "FLDPERIOD", "FLDS1COUNT", "FLDS2COUNT", "FLDS3COUNT", "FLDS4COUNT", "FLDS5COUNT", "FLDO1COUNT", "FLDO2COUNT", "FLDTOTAL" };
        string[] alCaptions = { "Reason", "Month", "S1 (<10 H)", "S2 (Split <2)", "S3 (<6 H)", "S4 (Gap >14 H)", "S5 (<77 H)", "O1 (OPA 15 H)", "O2 (OPA 36 H)", "Total No. of NC`s" };
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyReason.NcCountbyReason((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
                                                                       , selectedReason()
    ...
    private void ShowReport()
    {
        ...
        string[] alColumns = { "FLDRANKNAME", "FLDPERIOD", "FLDS1COUNT", "FLDS2COUNT", "FLDS3COUNT", "FLDS4COUNT", "FLDS5COUNT", "FLDO1COUNT", "FLDO2COUNT", "FLDTOTAL" };
        string[] alCaptions = { "Rank", "Month", "S1 (<10 H)", "S2 (Split <2)", "S3 (<6 H)", "S4 (Gap >14 H)", "S5 (<77 H)", "O1 (OPA 15 H)", "O2 (OPA 36 H)", "Total No. of NC`s" };
        ...
        General.SetPrintOptions("gvCrew", "WRH NC Type Count by Reason", alCaptions, alColumns, ds);
    ...
    {
        chkboxlstReason.DataSource = PhoenixInspectionWRHNCTypeCountbyReason.getReasonList(83);
        chkboxlstReason.DataBind();
    }
    protected void OnDataBound(object sender, EventArgs e)
    {
        ListItem li = new ListItem("--Check All--", "0");
        li.Attributes.Add("onclick", "checkUnchekAll(this);");
        chkboxlstReason.Items.Insert(0, li);
    }
