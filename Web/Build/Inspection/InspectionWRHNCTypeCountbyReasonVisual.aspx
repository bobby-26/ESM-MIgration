<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyReasonVisual.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyReasonVisual" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <div id="nctypecountreasonbyyear-1"></div>
        <div id="nctypecountreasonbyquarter-2"></div>
        <div id="nctypecountreasonbymonth-3"></div>
        <div id="nctypecountreasonbyfleet-4"></div>
        <div id="nctypecountreasonbyvessel-5"></div>
        <div id="nctypecountbyreason-6"></div>
