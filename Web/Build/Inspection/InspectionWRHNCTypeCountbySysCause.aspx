<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbySysCause.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbySysCause" %>
...
<head runat="server">
    <title>NC Type Count by System Cause</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC Type Count by System Cause"></eluc:Title>
                        </div>
                    </div>
                    ...
                    <table cellpadding="2" cellspacing="2">
                        <tr align="top">
                            ...
                            <td>
                             ...
                             <td>
                                <asp:Literal ID="litSysCause" runat="server" Text="System Cause"></asp:Literal>
                                <div runat="server" id="divSysCause" class="input" style="overflow-y: auto; overflow-x: hidden; height: 80px" onscroll="javascript:setGroupScroll();">
                                    <asp:CheckBoxList ID="chkboxlstSysCause" runat="server" DataTextField="FLDQUICKNAME" AutoPostBack="false" Width="390px"
                    ...
                    <div id="divGrid" style="position: relative; overflow: auto; z-index: 0; width: 99%">
                        <asp:GridView ID="gvCrew" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblcorrectiveaction" runat="server">System Cause</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDSYSTEMCAUSE") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
