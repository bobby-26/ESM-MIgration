<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbySysCauseVisual.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbySysCauseVisual" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <div id="nctypecountsyscausebyyear-1"></div>
        <div id="nctypecountsyscausebyquarter-2"></div>
        <div id="nctypecountsyscausebymonth-3"></div>
        <div id="nctypecountsyscausebyfleet-4"></div>
        <div id="nctypecountsyscausebyvessel-5"></div>
        <div id="nctypecountbysyscause-6"></div>
