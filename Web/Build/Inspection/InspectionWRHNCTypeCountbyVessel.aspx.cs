...
public partial class Inspection_InspectionWRHNCTypeCountbyVessel : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyVessel.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyVessel.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void CrewShowExcel_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("CLEAR"))
            {
                ...
                InspectionFilter.CurrentWRHNcTypeCountbyVesselFilter = null;
                ShowReport();
                SetPageNavigator();
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                sessionFilterValues();
                Response.Redirect("../Inspection/InspectionWRHNCTypeCountbyVesselVisual.aspx");
            }
    ...
    public NameValueCollection sessionFilterValues()
    {
        ...
        if (IsPostBack)
        {
            ...
            InspectionFilter.CurrentWRHNcTypeCountbyVesselFilter = nvc;
        }

        return InspectionFilter.CurrentWRHNcTypeCountbyVesselFilter;
    }
    protected void BindFilterCriteria()
    {

        NameValueCollection nvc = InspectionFilter.CurrentWRHNcTypeCountbyVesselFilter;
        if (nvc == null)
        {
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDVESSEL", "FLDPERIOD", "FLDS1COUNT", "FLDS2COUNT", "FLDS3COUNT", "FLDS4COUNT", "FLDS5COUNT", "FLDO1COUNT", "FLDO2COUNT", "FLDTOTAL" };
        string[] alCaptions = { "Vessel", "Month", "S1 (<10 H)", "S2 (Split <2)", "S3 (<6 H)", "S4 (Gap >14 H)", "S5 (<77 H)", "O1 (OPA 15 H)", "O2 (OPA 36 H)", "Total No. of NC`s" };
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyVessel.NcCountbyVessel((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
    ...
    private void ShowReport()
    {
        ...
        string Fleet = ucFleet.SelectedList.ToString();
        string Vessel = ucVessel.SelectedVessel.ToString();
        string Fromdate = General.GetNullableDateTime(ucFromDate.Text).ToString();
        string Todate = General.GetNullableDateTime(ucToDate.Text).ToString();
        ...
        General.SetPrintOptions("gvCrew", "WRH NC Type Count by Vessel", alCaptions, alColumns, ds);
