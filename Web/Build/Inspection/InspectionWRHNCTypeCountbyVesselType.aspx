<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyVesselType.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyVesselType" %>
...
<head runat="server">
    <title>NC Type Count by VesselType</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC Type Count by VesselType"></eluc:Title>
                        </div>
                    </div>
                    ...
                    <div id="divGrid" style="position: relative; overflow: auto; z-index: 0; width: 99%">
                        <asp:GridView ID="gvCrew" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblVendorName" runat="server">Vessel Type</asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDVESSELTYPECATEGORY") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
