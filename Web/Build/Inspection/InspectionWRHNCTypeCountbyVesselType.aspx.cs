...
public partial class Inspection_InspectionWRHNCTypeCountbyVesselType : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyVesselType.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCTypeCountbyVesselType.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void CrewShowExcel_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("CLEAR"))
            {
                ...
                InspectionFilter.CurrentWRHNcTypeCountbyVesselTypeFilter = null;
                ShowReport();
                SetPageNavigator();
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                sessionFilterValues();
                Response.Redirect("../Inspection/InspectionWRHNCTypeCountbyVesselTypeVisual.aspx");
            }
    ...
    public NameValueCollection sessionFilterValues()
    {
        ...
        if (IsPostBack)
        {
            ...
            nvc.Add("ucVesselType", ucVesselType.SelectedHard.ToString());

            InspectionFilter.CurrentWRHNcTypeCountbyVesselTypeFilter = nvc;
        }
    ...
    protected void BindFilterCriteria()
    {
        ...
        NameValueCollection nvc = InspectionFilter.CurrentWRHNcTypeCountbyVesselTypeFilter;
        if (nvc == null)
        {
        ...
        ucVesselType.SelectedHard = CheckIsNull(nvc.Get("ucRank"));
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDVESSELTYPECATEGORY", "FLDPERIOD", "FLDS1COUNT", "FLDS2COUNT", "FLDS3COUNT", "FLDS4COUNT", "FLDS5COUNT", "FLDO1COUNT", "FLDO2COUNT", "FLDTOTAL" };
        string[] alCaptions = { "Vessel Type", "Month", "S1 (<10 H)", "S2 (Split <2)", "S3 (<6 H)", "S4 (Gap >14 H)", "S5 (<77 H)", "O1 (OPA 15 H)", "O2 (OPA 36 H)", "Total No. of NC`s" };
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyVesselType.NcCountbyVesselTypeCategory((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
                                                                                   , (ucVessel.SelectedVessel.ToString()) == "," ? null : General.GetNullableString(ucVessel.SelectedVessel.ToString())
                                                                                   , (ucVesselType.SelectedHard.ToString()) == "," ? null : General.GetNullableString(ucVesselType.SelectedHard.ToString())
    ...
    private void ShowReport()
    {
        ...
        General.SetPrintOptions("gvCrew", "WRH NC Type Count by Rank", alCaptions, alColumns, ds);
