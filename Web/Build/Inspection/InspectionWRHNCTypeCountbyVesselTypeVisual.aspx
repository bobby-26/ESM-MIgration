<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyVesselTypeVisual.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyVesselTypeVisual" %>
...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%; height: 0;">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC Type Count by Vessel Type"></eluc:Title>
                        </div>
                    </div>
        ...
        <br />
        <br />
        <div id="nctypecountvesseltypebyyear-1"></div>
        <div id="nctypecountvesseltypebyquarter-2"></div>
        <div id="nctypecountvesseltypebymonth-3"></div>
        <div id="nctypecountvesseltypebyfleet-4"></div>
        <div id="nctypecountbyvesseltype-5"></div>
        <div id="nctypecountvesseltypebyvessel-6"></div>
