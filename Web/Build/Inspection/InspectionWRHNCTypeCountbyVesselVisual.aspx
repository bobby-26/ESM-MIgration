<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWRHNCTypeCountbyVesselVisual.aspx.cs" Inherits="Inspection_InspectionWRHNCTypeCountbyVesselVisual" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <div id="nctypecountvesselbyyear-1"></div>
        <div id="nctypecountvesselbyquarter-2"></div>
        <div id="nctypecountvesselbymonth-3"></div>
        <div id="nctypecountvesselbyfleet-4"></div>
        <div id="nctypecountbyvessel-5"></div>
