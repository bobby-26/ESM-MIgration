...
public partial class Inspection_InspectionWRHNcSummaryCountbyOwner : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCSummaryCountbyOwner.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbar1.AddImageButton("../Inspection/InspectionWRHNCSummaryCountbyOwner.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDOWNER", "FLDPERIOD", "FLDNCCOUNT" };
        string[] alCaptions = { "Owner", "Month", "Total No. of NC`s" };
        ...
        ds = PhoenixInspectionWRHNCTypeCountbyOwner.NcSummaryCountbyOwner((ucFleet.SelectedList.ToString()) == "," ? null : General.GetNullableString(ucFleet.SelectedList.ToString())
    ...
    private void ShowReport()
    {
        ...
        General.SetPrintOptions("gvCrew", "WRH NC Summary Count by Rank", alCaptions, alColumns, ds);
