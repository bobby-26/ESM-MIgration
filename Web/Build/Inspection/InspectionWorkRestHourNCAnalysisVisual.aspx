<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InspectionWorkRestHourNCAnalysisVisual.aspx.cs" Inherits="Inspection_InspectionWorkRestHourNCAnalysisVisual" %>
...
<body>
    ...
    <form id="form1" runat="server">
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%; height: 0;">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="WRH NC Analysis"></eluc:Title>
                        </div>
                    </div>
        ...
        <br />
    <div>
        <div id="wrhncanalysis-1"></div>
        <div id="wrhncanalysis-2"></div>
        <div id="wrhncanalysis-3"></div>
        <div id="wrhncanalysis-4"></div>
        <div id="wrhncanalysis-5"></div>
        <div id="wrhncanalysis-6"></div>
        <div id="wrhncanalysis-7"></div>
        <div id="wrhncanalysis-8"></div>
        <div id="wrhncanalysis-9"></div>
    </div>
    </form>
</body>
</html>
