<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InventoryComponentChangeRequest.aspx.cs"
    Inherits="InventoryComponentChangeRequest" %>
...
<body>
    <form id="frmPlannedMaintenanceComponent" runat="server" autocomplete="off">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvComponent" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" Width="100%"
            Height="89%" CellSpacing="0" GridLines="None" OnNeedDataSource="gvComponent_NeedDataSource" DataKeyNames="FLDCOMPONENTID" OnItemCommand="gvComponent_ItemCommand"
