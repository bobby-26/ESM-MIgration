<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InventoryComponentChangeRequestGeneral.aspx.cs"
    Inherits="InventoryComponentChangeRequestGeneral" %>
        ...
        <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
            ...
            <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Height="200px" Width="100%">
                ...
                <telerik:RadPane ID="navigationPane" runat="server" Width="200">
                    <eluc:ComponentTypeTreeView ID="tvwComponent" runat="server" OnNodeClickEvent="tvwComponent_NodeClickEvent" />
                    ...
                    <div id="Details" runat="server">
                        ...
                        <table width="100%" cellpadding="1" cellspacing="1">
                            ...
                            <tr>
                                ...
                                <asp:ImageButton ID="cmdMakerChangeClear" runat="server" ImageUrl="<%$ PhoenixTheme:images/clear.png %>"
                                    ImageAlign="AbsMiddle" Text=".." OnClick="cmdMakerChangeClear_Click" />
                                </td>
                                <td>
                                ...
                                <asp:ImageButton ID="cmdVendorChangeClear" runat="server" ImageUrl="<%$ PhoenixTheme:images/clear.png %>"
                            ...
                            <tr>
                                ...
                                <asp:ImageButton ID="cmdParentChangeClear" runat="server" ImageUrl="<%$ PhoenixTheme:images/clear.png %>"
                            ...
                            <tr>
                                ...
                                <td>
                                    <eluc:UserControlHard runat="server" ID="ucComponentStatusChange" CssClass="dropdown_mandatory" HardTypeCode="13" AppendDataBoundItems="true" />
                                </td>
                            </tr>
                        </table>
                        <br clear="all" />
