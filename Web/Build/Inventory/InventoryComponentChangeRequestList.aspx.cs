...
public partial class Inventory_InventoryComponentChangeRequestList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddFontAwesomeButton("../Inventory/InventoryComponentChangeRequestList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbargrid.AddFontAwesomeButton("javascript:CallPrint('gvComponent')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbargrid.AddFontAwesomeButton("../Inventory/InventoryComponentChangeRequestListFilter.aspx?go=ChangeRequest", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
            toolbargrid.AddFontAwesomeButton("../Inventory/InventoryComponentChangeRequestList.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
            toolbargrid.AddFontAwesomeButton("../Inventory/InventoryComponentChangeRequestAdd.aspx?Type=New&Mode=New&tv=1", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
    ...
    protected void gvComponent_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName.ToUpper() == "SELECT")
            {
                ...
                if (reqtype == "0")
                    Response.Redirect("../Inventory/InventoryComponentChangeRequestAdd.aspx?tv=1&Type=New&Mode=Edit&parent=" + parentid + "&COMPONENTID=" + compid, false);
                else
                    Response.Redirect("../Inventory/InventoryComponentChangeRequestAdd.aspx?tv=1&Type=Edit&Mode=Edit&COMPONENTID=" + compid, false);
            }
    ...
    protected void TabMenus_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            Filter.CurrentComponentFilterCriteria = null;
            string url = "InventoryComponentChangeRequest.aspx";
