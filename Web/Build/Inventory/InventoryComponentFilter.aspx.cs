...
public partial class InventoryComponentFilter : PhoenixBasePage
{
    ...
    protected void MenuComponentFilter_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string url =Request.QueryString["go"] == null ? "InventoryComponent.aspx" : "InventoryComponentChangeRequest.aspx";
