...
public partial class Inventory_InventoryComponentTree : PhoenixBasePage
{
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["COMPONENTID"] != null && Request.QueryString["COMPONENTID"] != "")
                {
                    ...
                    ifMoreInfo.Attributes["src"] = "../Inventory/InventoryComponentGeneral.aspx?COMPONENTID=" + Request.QueryString["COMPONENTID"].ToString();
                }
    ...
    protected void BindTreeData()
    {
        try
        {
            ...
            if (ViewState["COMPONENTID"] == null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                ifMoreInfo.Attributes["src"] = "../Inventory/InventoryComponentGeneral.aspx?COMPONENTID=" + ViewState["COMPONENTID"].ToString();
            }
