<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InventorySpareItemDetail.aspx.cs"
    Inherits="InventorySpareItemDetail" %>
    ...
    <form id="form1" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" UpdateInitiatorPanelsOnly="true">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="MenuFormDetail">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="MenuStockItemDetails" />
        ...
        <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
            ...
            <div style="font-weight: 600; font-size: 12px;" runat="server">
                <eluc:TabStrip ID="MenuStockItemDetails" runat="server" OnTabStripCommand="MenuStockItemDetails_TabStripCommand"></eluc:TabStrip>
            </div>
