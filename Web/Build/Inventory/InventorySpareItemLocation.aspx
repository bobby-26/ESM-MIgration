<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InventorySpareItemLocation.aspx.cs"
    Inherits="InventorySpareItemLocation" MaintainScrollPositionOnPostback="true" %>
...
<head id="Head1" runat="server">
    <title>Spare Item Location</title>
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript" lang="javascript" src="<%=Session["sitepath"]%>/js/phoenixGridResize.js"></script>
                    ...
                    <td>
                        <table id="tblmain" cellpadding="0" cellspacing="0">
                                ...
                                <td style="width: 990px">
                                    ...
                                    <telerik:RadGrid RenderMode="Lightweight" ID="gvLocation" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None"
                                        ...
                                        <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                                            AutoGenerateColumns="false" DataKeyNames="FLDSPAREITEMLOCATIONID" ShowFooter="true">
                                            ...
                                            <Columns>
                                                <telerik:GridTemplateColumn HeaderText="Location" HeaderStyle-Width="115px" Visible="false" AllowSorting="true" SortExpression="FLDUNITNAME">
                                                    <ItemTemplate>
                                                        <telerik:RadLabel ID="lblStockItemLocationId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSPAREITEMLOCATIONID") %>'></telerik:RadLabel>
                                                        <telerik:RadLabel ID="lblLocationId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDLOCATIONID") %>'></telerik:RadLabel>
                                                        <telerik:RadLabel ID="lblStockItemId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSPAREITEMID") %>'></telerik:RadLabel>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <telerik:RadLabel ID="lblStockItemLocationIdEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSPAREITEMLOCATIONID") %>'></telerik:RadLabel>
                                                ...
                                                <telerik:GridTemplateColumn ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" HeaderText="Current Stock" HeaderStyle-Width="70px" AllowSorting="true">
                                                    ...
                                                    <FooterTemplate>
                                                        ...
                                                        <%--<eluc:Number ID="txtItemQuantityAdd" Width="100px" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDQUANTITY","{0:n0}") %>' MaxLength="9" />--%>
                            ...
                            <tr>
                                <td align="center">
                                    <b><i>
                                        <asp:Literal ID="lblTotalstockCaption" runat="server" Text="Total stock"></asp:Literal>
                                    </i></b>:<telerik:RadLabel ID="lblTotalStock" runat="server"></telerik:RadLabel>
                                </td>
                            </tr>
                        </table>
                    </td>
