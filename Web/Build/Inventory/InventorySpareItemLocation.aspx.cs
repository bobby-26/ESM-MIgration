...
public partial class InventorySpareItemLocation : PhoenixBasePage
{
    ...
    private void BindData()
    {
        try
        {
            ...
            DataSet ds = PhoenixInventorySpareItemLocation.SpareItemLocationSearch(spareitemid, PhoenixSecurityContext.CurrentSecurityContext.VesselID,
                null, null,
    ...
    private void InsertStockItemLocation(string locationid, string quantity)
    {
        try
        {
            ...
            PhoenixInventorySpareItemLocation.InsertSpareItemLocation(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                 Convert.ToInt32(locationid), new Guid(Request.QueryString["SPAREITEMID"]), 
    ...
    private void DefaultStockItemLocation(string stockitemlocationid)
    {
        try
        {
            PhoenixInventorySpareItemLocation.DefaultSpareItemLocation(PhoenixSecurityContext.CurrentSecurityContext.UserCode, 
                new Guid(stockitemlocationid), new Guid(Request.QueryString["SPAREITEMID"]),PhoenixSecurityContext.CurrentSecurityContext.VesselID);
        }
        catch (Exception ex)
        {
            ucError.ErrorMessage = ex.Message;
    ...
    //            return;
    //        }
    //        PhoenixInventorySpareItemLocation.UpdateSpareItemLocationQuantity(PhoenixSecurityContext.CurrentSecurityContext.UserCode, new Guid(stockitemlocationid), Convert.ToDecimal(quantity));
    //    }
    //    catch (Exception ex)
    //    {
    //        ucError.ErrorMessage = ex.Message;
    ...
    //    try
    //    {
    //        PhoenixInventorySpareItemLocation.DeleteSpareItemLocation(PhoenixSecurityContext.CurrentSecurityContext.UserCode, new Guid(stockitemlocationid));
    //    }
    //    catch (Exception ex)
    //    {
    //        ucError.ErrorMessage = ex.Message;
    ...
    protected void gvLocation_UpdateCommand(object sender, GridCommandEventArgs e)
    {
        ...
        //                    ((UserControlNumber)eeditedItem.FindControl("txtItemQuantityEdit")).Text
        //                    );
    ...
    protected void ddlLocationAdd_SelectedIndexChanged(object sender, DropDownListEventArgs e)
    {
        try
        {
