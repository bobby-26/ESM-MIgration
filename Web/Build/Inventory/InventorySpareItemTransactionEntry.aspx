<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InventorySpareItemTransactionEntry.aspx.cs"
    Inherits="InventorySpareItemTransactionEntry" %>
...
<body>
    ...
    <asp:UpdatePanel runat="server" ID="pnlSpareItemTransactionEntry">
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
                <div class="subHeader" style="position: relative">
                    <div id="div2" style="vertical-align: top">
                        <eluc:Title runat="server" ID="Title1" Text="Spare Transaction" ShowMenu="false"></eluc:Title>
                    </div>
                    <div>
                ...
                <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
                    <eluc:TabStrip ID="MenuSpareItemTransactionEntry" runat="server" OnTabStripCommand="MenuSpareItemTransactionEntry_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuGridSpareItemTransactionEntry" runat="server" OnTabStripCommand="SpareItemTransactionEntry_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="divGrid" style="position: relative;">
                    <asp:GridView ID="gvSpareTransactionEntry" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowCommand="gvSpareTransactionEntry_RowCommand" OnRowDataBound="gvSpareTransactionEntry_ItemDataBound"
                        OnRowCancelingEdit="gvSpareTransactionEntry_RowCancelingEdit" OnRowDeleting="gvSpareTransactionEntry_RowDeleting"
                        OnRowEditing="gvSpareTransactionEntry_RowEditing"   Style="margin-bottom: 0px">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblSpareItemDispositionHeaderId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSPAREITEMDISPOSITIONHEADERID") %>'></asp:Label>
                                    <asp:Label ID="lblSpareItemDispositionId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSPAREITEMDISPOSITIONID") %>'></asp:Label>
                                    <asp:Label ID="lblSpareItemId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSPAREITEMID") %>'></asp:Label>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="gvSpareTransactionEntry" />
        </Triggers>
    </asp:UpdatePanel>
