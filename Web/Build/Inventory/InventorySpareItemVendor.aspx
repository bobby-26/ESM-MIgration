<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InventorySpareItemVendor.aspx.cs"
    Inherits="InventorySpareItemVendor" EnableEventValidation="false" %>
...
<head runat="server">
    <title>Spare Item Vendors</title>
...
<body onresize="PaneResized()" onload="PaneResized()">
    <form id="form1" runat="server" autocomplete="off">
        ...
        <eluc:TabStrip ID="MenuGridSpareItemVendor" runat="server" OnTabStripCommand="SpareItemVendor_TabStripCommand"></eluc:TabStrip>
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            <telerik:RadGrid RenderMode="Lightweight" ID="gvVendor" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                OnSortCommand="gvVendor_SortCommand" CellSpacing="0" GridLines="None" OnDeleteCommand="gvVendor_DeleteCommand"
                OnNeedDataSource="gvVendor_NeedDataSource" AutoGenerateColumns="false" Width="100%" GroupingEnabled="false" EnableHeaderContextMenu="true">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Vendor Code" HeaderStyle-Width="80px" AllowSorting="true" SortExpression="FLDVENDORID">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblStockItemVendorId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSPAREITEMVENDORID") %>'></telerik:RadLabel>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" AllowSorting="true" ShowSortIcon="true" SortExpression="FLDNAME">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblVendorName" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDNAME") %>'></telerik:RadLabel>
                                <telerik:RadLabel ID="lnkVendorName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDNAME") %>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Last Purchased Price" ItemStyle-HorizontalAlign="Right">
                            <HeaderStyle Width="80px" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="lnkStockItemPrice" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSPAREITEMPRICE","{0:n2}") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
