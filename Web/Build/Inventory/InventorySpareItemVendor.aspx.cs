...
public partial class InventorySpareItemVendor : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddFontAwesomeButton("../Inventory/InventorySpareItemVendor.aspx?SPAREITEMID=" + Request.QueryString["SPAREITEMID"] + "", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            MenuGridSpareItemVendor.AccessRights = this.ViewState;   
            MenuGridSpareItemVendor.MenuList = toolbargrid.Show();
    ...
    protected void SpareItemVendor_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
    ...
    protected void gvVendor_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        try
        {
            ...
            string[] alColumns = { "FLDVENDORCODE", "FLDNAME", "FLDQAGRADING", "FLDSPAREITEMPRICE", "FLDFORMNO", "FLDORDERED", "FLDORDEREDDATE", "FLDRECEIVEDDATE" };
            ...
            string strHeader = "Inventory Spare Item Vendor";
            ...
            DataSet ds = PhonixInventorySpareItemVendor.SpareItemVendorSearch(null, Request.QueryString["SPAREITEMID"].ToString(),
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            DataSet ds = PhonixInventorySpareItemVendor.SpareItemVendorSearch(null, Request.QueryString["SPAREITEMID"].ToString(),
                ...
                null, null, null, null, General.GetNullableDateTime(""), sortexpression, sortdirection, (int)ViewState["PAGENUMBER"],
                General.ShowRecords(null),
                ref iRowCount,
                ref iTotalPageCount);

            Response.AddHeader("Content-Disposition", "attachment; filename=SpareItemVendor.xls");
            Response.ContentType = "application/vnd.msexcel";
            Response.Write("<TABLE BORDER='0' CELLPADDING='2' CELLSPACING='0' width='100%'>");
            Response.Write("<tr>");
            Response.Write("<td><img src='http://" + Request.Url.Authority + Session["images"] + "/esmlogo4_small.png" + "' /></td>");
            Response.Write("<td><h3>Inventory Spare Item Vendor</h3></td>");
    ...
    private void DeleteStockItemVendor(string stockitemvendorid)
    {
        try
        {
            ...
            PhonixInventorySpareItemVendor.DeleteSpareItemVendor(PhoenixSecurityContext.CurrentSecurityContext.UserCode, new Guid(stockitemvendorid));
        }
        catch (Exception ex)
        {
            ucError.ErrorMessage = ex.Message;
    ...
    protected void cmdHiddenSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                PhonixInventorySpareItemVendor.InsertSpareItemVendor
                (
                    PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                    Convert.ToInt32(vendorid), new Guid(Request.QueryString["SPAREITEMID"]), PhoenixSecurityContext.CurrentSecurityContext.VesselID
                );
            }
