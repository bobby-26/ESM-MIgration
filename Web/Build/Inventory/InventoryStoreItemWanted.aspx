<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InventoryStoreItemWanted.aspx.cs"
    Inherits="InventoryStoreItemWanted" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function PaneResized(sender, args) {
            ...
            var grid = $find("gvStoreItemWanted");
...
<body onresize="PaneResized()" onload="PaneResized()">
    <form id="form1" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" UpdateInitiatorPanelsOnly="true">
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="gvStoreItemWanted">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="gvStoreItemWanted" LoadingPanelID="RadAjaxLoadingPanel1" />
        ...
        <telerik:RadSplitter RenderMode="Lightweight" ID="RadSplitter1" runat="server" Width="100%" Orientation="Horizontal">
            ...
            <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                <eluc:TabStrip ID="MenuStoreItemWanted" runat="server" OnTabStripCommand="StoreItemWanted_TabStripCommand"></eluc:TabStrip>
                <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server" DecorationZoneID="gvStoreItemWanted" DecoratedControls="All" EnableRoundedCorners="true" />
                <telerik:RadGrid RenderMode="Lightweight" ID="gvStoreItemWanted" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                    CellSpacing="0" GridLines="None" OnNeedDataSource="gvStoreItemWanted_NeedDataSource" OnUpdateCommand="gvStoreItemWanted_UpdateCommand"
                    OnItemDataBound="gvStoreItemWanted_ItemDataBound" OnItemCommand="gvStoreItemWanted_ItemCommand" OnSortCommand="gvStoreItemWanted_SortCommand"
                    ...
                    <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-Width="25%" AllowSorting="true" SortExpression="FLDNAME">
                                ...
                                <ItemTemplate>
                                    ...
                                    <telerik:RadLabel ID="lnkStockItemName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDNAME") %>'></telerik:RadLabel>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Maker" HeaderStyle-Width="25%" AllowSorting="true" SortExpression="MAKER">
                                <ItemStyle Wrap="false" />
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Wanted" HeaderStyle-Width="10%" AllowSorting="true" ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Unit" AllowSorting="true" HeaderStyle-Width="10%" SortExpression="FLDUNITNAME">
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblUnit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDUNITNAME") %>'></telerik:RadLabel>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Stock Class" AllowSorting="true" HeaderStyle-Width="15%" SortExpression="STOCKCLASSNAME">
                                <ItemTemplate>
