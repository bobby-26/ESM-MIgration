<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogAutomaticTransferBilge.aspx.cs" Inherits="Log_ElectricLogAutomaticTransferBilge" %>
...
<head id="Head1" runat="server">
    <title>Automatic Transfer of bilge water from engine-room bilge wells</title>
        ...
        <telerik:RadAjaxPanel runat="server">
            ...
            <div style="width: 100%; overflow: auto;">
                <div style="float: initial; margin: 0 50px">
                    ...
                    <h3>Automatic Transfer of bilge water from engine-room bilge wells to a tank listed under item 3.3 in the
                    Supplement to the IOPPC</h3>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblPumpStartTime" runat="server" Text="Pump Start Time"></telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblPumpStopTime" runat="server" Text="Pump Stop Time"></telerik:RadLabel>
                            </td>
                            <td>
