<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogBilgeWell.aspx.cs" Inherits="Log_ElectricLogBilgeWell" %>
                ...
                <div style="float: initial; margin: 0 50px">
                    <table>
                        <tr>
                            ...
                            <td>
                                <telerik:RadTimePicker ID="txtStartTime" AutoPostBack="true" runat="server" CssClass="input_mandatory" OnSelectedDateChanged="txtOperationDate_SelectedDateChanged">
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblFrom" runat="server" Text="Bilge Well Transfer"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadComboBox ID="ddlTransferFrom" dropdownposition="Static" CssClass="input_mandatory" AutoPostBack="true" runat="server" DataTextField="FLDNAME" OnSelectedIndexChanged="ddlTransferFrom_SelectedIndexChanged" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True"
                            ...
                            <td>
                                <telerik:RadTimePicker ID="txtStopTime" runat="server" AutoPostBack="true" CssClass="input_mandatory" OnSelectedDateChanged="txtOperationDate_SelectedDateChanged">
                                    <TimeView Interval="00:30:00"></TimeView>
                                </telerik:RadTimePicker>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtBfrTrnsROBFrom" CssClass="input_mandatory" AutoPostBack="true" MinValue="0" MaxValue="99999999" OnTextChanged="txtBfrTrnsROBFrom_TextChanged" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtAftrTrnsROBFrom" AutoPostBack="true" OnTextChanged="txtBfrTrnsROBFrom_TextChanged" MinValue="0" MaxValue="99999999" RenderMode="Lightweight" CssClass="input_mandatory" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                                    <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
