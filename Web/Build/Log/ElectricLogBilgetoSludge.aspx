<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogBilgetoSludge.aspx.cs" Inherits="Log_ElectricLogBilgetoSludge" %>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <telerik:RadLabel ID="lblTranscationDetailId" runat="server" Visible="false"></telerik:RadLabel>

                            </td>
                        </tr>
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblFrom" runat="server" Text="Bilge Water Transferred FROM"></telerik:RadLabel>
                            </td>
                            <td>
                            ...
                            <td>
                                <telerik:RadLabel ID="lblTo" runat="server" Text="Transferred TO Sludge Tank"></telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtBfrTrnsROBFrom" CssClass="input_mandatory" OnTextChanged="from_SelectedIndexChanged" MinValue="0" MaxValue="99999999" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                            ...
                            <td>
                                <telerik:RadLabel ID="lblAftrTrnsROBFrom" runat="server" Text="Before Transfer ROB"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtBfrTrnsROBTo" CssClass="input_mandatory" AutoPostBack="true" MinValue="0" MaxValue="99999999" OnTextChanged="txtAftrTrnsROBFrom_TextChanged" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                                    <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtAftrTrnsROBFrom" CssClass="input_mandatory" AutoPostBack="true" MinValue="0" MaxValue="99999999" OnTextChanged="txtAftrTrnsROBFrom_TextChanged" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                                    <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtAfrTrnsROBTo" CssClass="input_mandatory" Visible="true" MinValue="0" MaxValue="99999999" AutoPostBack="true" OnTextChanged="txtAftrTrnsROBFrom_TextChanged" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                                    <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadTimePicker ID="txtStartTime" runat="server" CssClass="input_mandatory" AutoPostBack="true" OnSelectedDateChanged="txtStopTime_SelectedDateChanged">
