<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogBilgewaterERToDeck.aspx.cs" Inherits="Log_ElectricLogBilgewaterERToDeck" %>
...
<head runat="server">
    <title>Bilge Water from ER to Deck/cargo Slop Tank</title>
                ...
                <div style="float: initial; margin: 0 50px">
                    <table>
                        <tr>
                            ...
                            <td>
                                  <telerik:RadDatePicker RenderMode="Lightweight" runat="server" AutoPostBack="true" CssClass="input_mandatory" ID="txtOperationDate" MaxLength="12"  OnSelectedDateChanged="txtOperationDate_SelectedDateChanged"  >
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtBfrTrnsROBFrom" AutoPostBack="true" MinValue="0" MaxValue="99999999" OnTextChanged="txtBfrTrnsROBFrom_TextChanged" CssClass="input_mandatory" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtAftrTrnsROBFrom" CssClass="input_mandatory" AutoPostBack="true" MinValue="0" MaxValue="99999999" OnTextChanged="txtBfrTrnsROBFrom_TextChanged" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                                    <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
