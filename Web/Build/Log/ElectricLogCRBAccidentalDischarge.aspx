<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogCRBAccidentalDischarge.aspx.cs" Inherits="Log_ElectricLogCRBAccidentalDischarge" %>
...
<head runat="server">
    <title>Accidental or Other Exceptional Discharge</title>
        ...
        <telerik:RadAjaxPanel runat="server" ID="radAjaxPanel">
            ...
            <div style="width: 100%; overflow: auto;">
                <div style="float: initial; margin: 0 50px">
                 <h3>Accidental or Other Exceptional Discharge</h3>
                    <table>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox DropDownPosition="Static" CssClass="input_mandatory"  ID="ddlTransferFrom" runat="server" DataTextField="FLDNAME" AutoPostBack="true" OnSelectedIndexChanged="ddlTransferFrom_SelectedDateChanged" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True"
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblquantitydischarge" runat="server" Text="Approx Quantity of Exceptional Discharge"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtquantitydischarge" RenderMode="Lightweight" CssClass="input_mandatory" MinValue="0" MaxValue="9999999" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number"  AutoPostBack="true" OnTextChanged="Refresh_TextChangedEvent">
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
                                <telerik:RadLabel ID="RadLabel3" runat="server" Text="MT"></telerik:RadLabel>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblProductName" runat="server" Visible="true" Text="Name of the Product Discharged"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTextBox ID="txtProductName" RenderMode="Lightweight" CssClass="input_mandatory" runat="server" Width="120px" AutoPostBack="true" OnTextChanged="Refresh_TextChangedEvent">                                    
                                </telerik:RadTextBox>                                
                            </td>
                            <td>
                                <telerik:RadLabel ID="lblProductCategory" runat="server" Visible="true" Text="Category of the Product Discharged"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTextBox ID="txtProductCategory" RenderMode="Lightweight" CssClass="input_mandatory" runat="server" Width="120px" AutoPostBack="true" OnTextChanged="Refresh_TextChangedEvent">                                    
                                </telerik:RadTextBox>                                
                            </td>
                        </tr>
                        <tr>
                             <td>
                                <telerik:RadLabel ID="lblaccidentreason" runat="server" Visible="true" Text="Reason for Accident or Discharge"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTextBox ID="txtaccidentreason" RenderMode="Lightweight" CssClass="input_mandatory" runat="server" Width="120px" AutoPostBack="true" OnTextChanged="Refresh_TextChangedEvent">                                    
                                </telerik:RadTextBox>                                
                            </td>
                        </tr>
                    </table>
