<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogCRBBallastingCargoTanks.aspx.cs" Inherits="Log_ElectricLogCRBBallastingCargoTanks" %>
                 ...
                 <h3>Ballasting of Cargo Tanks</h3>
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox DropDownPosition="Static" CssClass="input_mandatory"  ID="ddlTransferFrom" runat="server" DataTextField="FLDNAME" AutoPostBack="true" OnSelectedIndexChanged="txtOperationDate_SelectedDateChanged" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True"
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblStartTime" runat="server" Text="Start Time of Ballasting"></telerik:RadLabel>
                            </td>
                            <td>
