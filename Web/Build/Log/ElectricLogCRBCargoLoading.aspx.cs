...
public partial class Log_ElectricLogCRBCargoLoading : PhoenixBasePage
{
    string ReportCode;
    int usercode = 0;
    int vesselId = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        logId = PhoenixMarpolLogCRB.GetCRBLogId(usercode, "LoadingCargo");
    ...
    private void SetDefaultData()
    {
        ...
        lblrecord1.Text = string.Format("<span class='left'><b>{0}</b></span>", ViewState["TankName"].ToString().TrimEnd(','));
    }
    ...
    public bool isValidInput()
    {
        ...
        {
            ucError.ErrorMessage = "Load Terminal is Required Before Save";
        }
