<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogCRBDischargeOfWater.aspx.cs" Inherits="Log_ElectricLogCRBDischargeOfWater" %>
...
<head runat="server">
    <title>Discharge into the Sea of Tanks Washings</title>
        ...
        <telerik:RadAjaxPanel runat="server" ID="radAjaxPanel">
            ...
            <div style="width: 100%; overflow: auto;">
                <div style="float: initial; margin: 0 50px">
                    <h3>Discharge into the Sea of Tanks Washings</h3>
                    <table>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblTankDischarged" runat="server" Text="Identity of Tanks, Discharged"></telerik:RadLabel>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblCleaningTanks" runat="server" Visible="true" Text="Were tank washings discharged during cleaning of tank(s)? If so, at what rate?" Width="200px"></telerik:RadLabel>
                            </td>
                            <td>

                                <telerik:RadRadioButtonList runat="server" ID="ddlCleaningTanks"  AutoPostBack="true" Direction="Horizontal" OnSelectedIndexChanged="ddlCleaningTank_SelectedIndexChanged">
                                    <Items>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblCollectingTanks" runat="server" Text="Were tank washing(s) discharged from a slops collecting tank? If so, state quantity and rate of discharge" Width="200px"></telerik:RadLabel>
                            </td>
                            <td>

                                <telerik:RadRadioButtonList runat="server" ID="ddlCollectingTanks"  AutoPostBack="true" Direction="Horizontal" OnSelectedIndexChanged="ddlCleaningTank_SelectedIndexChanged" >
                                    <Items>
                                        <telerik:ButtonListItem Value="No" Text="No" ToolTip="No"  Selected="true" />
                                        <telerik:ButtonListItem Value="Yes" Text="Yes" ToolTip="Yes"/>
                                    </Items>
                            ...
                            <td>
                                <telerik:RadLabel ID="lblQtydischarge" runat="server" Visible="true" Text="Quantity Discharged"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtQtydischarge" RenderMode="Lightweight" MinValue="0" MaxValue="99999999" CssClass="input_mandatory" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number" AutoPostBack="true" OnTextChanged="Refresh_TextChangedEvent">
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lbldisrate" runat="server" Visible="true" Text="Rate of Discharge"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtdisrate" RenderMode="Lightweight" MinValue="0" MaxValue="99999999" CssClass="input_mandatory" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number" AutoPostBack="true" OnTextChanged="Refresh_TextChangedEvent">
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
                                <telerik:RadLabel ID="RadLabel6" runat="server" Visible="true" Text="m3/hr"></telerik:RadLabel>
                            </td>
                        </tr>
                        <tr>
                            <td>
