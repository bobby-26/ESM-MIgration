...
public partial class Log_ElectricLogCRBMasterSignature : PhoenixBasePage
{
    string txids;
    ...
    protected void gvTabStrip_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                PhoenixMarpolLogCRB.MasterSignatureCRB(int.Parse(ViewState["UserCode"].ToString()), txids, lblMasterFirstName.Text + " " + lblMasterLastName.Text, DateTime.Now);
