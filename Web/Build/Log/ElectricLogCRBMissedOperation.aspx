<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogCRBMissedOperation.aspx.cs" Inherits="Log_ElectricLogCRBMissedOperation" %>
...
<head runat="server">
    ...
    <script>
        ...
        function hiddenClickOnIframe() {
            //document.getElementById('iframe').contentDocument.getElementById('cmdHiddenSubmit');
            alert();
        }
</script>
</head>
