<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogCRBOperationList.aspx.cs" Inherits="Log_ElectricLogCRBOperationList" %>
...
<head id="Head1" runat="server">
    <title>Entries in Cargo Record Book </title>
    <%--<title></title>--%>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvElogTransaction" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" EnableViewState="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Status" HeaderStyle-Width="80px" UniqueName="status">
                            <ItemStyle Wrap="False" VerticalAlign="Top" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <table>
                                    <tr>
