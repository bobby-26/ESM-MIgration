...
public partial class Log_ElectricLogCRBRevisionView : PhoenixBasePage
{
    int usercode = 0;
    int vesselId = 0;
    ...
    {
        DataSet ds = PhoenixMarpolLogCRB.LogCRBLocationGetAttachmentFromRevision(usercode, vesselId, revisionNo);
    ...
    protected void gvRevision_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        gvRevision.DataSource = PhoenixMarpolLogCRB.PhoenixLogCRBLocationByRevisionNumber(usercode, vesselId, revisionNo, revisionDate);
