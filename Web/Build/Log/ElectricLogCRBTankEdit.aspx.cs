...
public partial class Log_ElectricLogCRBTankEdit : PhoenixBasePage
{
    Guid LocationId;
    int usercode;
    int vesselid;
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                if (IsValidReport())
                {
                    ...
                    PhoenixMarpolLogCRB.EditCRBLocation(usercode, LocationId, ioppname, capacity, vesselid, tankType, txtFrameFrom.Text, txtLateralPosition.Text);
    ...
    private void GetLocationDetails()
    {
        ...
        DataSet ds = PhoenixMarpolLogCRB.LocationCRBSelect(usercode, LocationId);
