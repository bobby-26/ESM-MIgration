<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogCargoBilgeHoldingTank.aspx.cs" Inherits="Log_ElectricLogCargoBilgeHoldingTank" %>
...
<head runat="server">
    <title>Cargo Holding Bilge Tank to ER Bilge</title>
                ...
                <div style="float: initial; margin: 0 50px">
                    <table>
                        <tr>
                            ...
                            <td>
                                <telerik:RadDatePicker ID="txtOperationDate" RenderMode="Lightweight" AutoPostBack="true" runat="server" CssClass="input_mandatory" MaxLength="12" OnSelectedDateChanged="txtOperationDate_SelectedDateChanged" >
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="ddlTransferFrom" DropDownPosition="Static" Style="width: 100%"  runat="server" AutoPostBack="true" DataTextField="FLDNAME" OnSelectedIndexChanged="ddlTransferFrom_SelectedIndexChanged" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True"
                                    EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true" CssClass="input_mandatory">
                                </telerik:RadComboBox>
                            </td>
                            <td>
                                <telerik:RadLabel ID="lblTo" runat="server" Visible="true" Text="Bilge Transferred TO"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadComboBox ID="ddlTransferTo" DropDownPosition="Static" Style="width: 100%" AutoPostBack="true" OnSelectedIndexChanged="ddlTransferTo_SelectedIndexChanged" Visible="true"  runat="server" DataTextField="FLDNAME" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True" CssClass="input_mandatory"
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblBfrTrnsROBFrom" runat="server" Text="Quantity Transfer"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtTransferQuantity" CssClass="input_mandatory" AutoPostBack="true" MinValue="0" MaxValue="99999999" OnTextChanged="txtTransferQuantity_TextChanged" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtBfrTrnsROBTo" RenderMode="Lightweight" AutoPostBack="true" CssClass="input_mandatory" MinValue="0" MaxValue="99999999" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number"  OnTextChanged="txtTransferQuantity_TextChanged">
                                    <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <telerik:RadLabel ID="RadLabel2" runat="server" Visible="true" Text="After Transfer ROB"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtAftrTrnsROBTo" RenderMode="Lightweight" CssClass="input_mandatory" Visible="true" MinValue="0" MaxValue="99999999" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number" AutoPostBack="true"  OnTextChanged="txtTransferQuantity_TextChanged">                                    
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
