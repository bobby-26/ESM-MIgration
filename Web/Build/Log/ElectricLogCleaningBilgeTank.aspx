<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogCleaningBilgeTank.aspx.cs" Inherits="Log_ElectricLogCleaningBilgeTank" %>
...
<head runat="server">
    <title>Cleaning Bilge Tank</title>
            ...
            <asp:Button ID="cmdHiddenSubmit" runat="server" OnClick="cmdHiddenSubmit_Click" Style="display: none;" />
                ...
                <div style="float: initial; margin: 0 50px">
                    <table>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblEndTime" runat="server" Visible="true" Text="Finished Time"></telerik:RadLabel>
                            </td>
                            <td>
