<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogELCheifEngineerSignature.aspx.cs" Inherits="Log_ElectricLogELCheifEngineerSignature" %>
...
<head runat="server">
    <title>Chief Engineer Sign & Remarks</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                <td colspan="2" style="width:200px;text-align:center;"><telerik:RadLabel runat="server" Text="All input will no longer be editable"></telerik:RadLabel></td>
            </tr>
            <tr>
