<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogEngineAttributes.aspx.cs" Inherits="ElectricLogEngineAttributes" %>
...
<body>
    <form id="frmMOC" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            <eluc:TabStrip ID="MenuOperational" runat="server" OnTabStripCommand="Operational_TabStripCommand" Title="Configuration"></eluc:TabStrip>
            ...
            <table id="tblConfigure" width="100%">
                <tr>
                    ...
                    <td width="30%">
                        <telerik:RadComboBox ID="ddlType" runat="server" Width="270px"
                            AutoPostBack="True" DataTextField="FLDNAME" DataValueField="FLDTYPEID" Enabled="false" OnTextChanged="ddlType_TextChanged" Filter="Contains" MarkFirstMatch="true">
                            <Items>
