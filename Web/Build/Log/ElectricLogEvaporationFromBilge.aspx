<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogEvaporationFromBilge.aspx.cs" Inherits="Log_ElectricLogEvaporationFromBilge" %>
...
<head runat="server">
    <title>Evaporation From Bilge Tank</title>
            ...
            <div style="width: 100%; overflow: auto;">
                <div style="float: initial; margin: 0 50px">
                    <table>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblFrom" runat="server" Text="Water Evaporation From Bilge Tank"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadComboBox DropDownPosition="Static" AutoPostBack="true" CssClass="input_mandatory"  ID="ddlTransferFrom" runat="server" DataTextField="FLDNAME" OnSelectedIndexChanged="ddlTransferFrom_SelectedIndexChanged" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True"
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtBfrTrnsROBFrom" AutoPostBack="true" RenderMode="Lightweight" MinValue="0" MaxValue="99999999" CssClass="input_mandatory" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number"  OnTextChanged="txtAfrTrnsROBFrom_TextChangedEvent">
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblBfrTrnsROBTo" runat="server" Visible="true" Text="After Evaporation ROB"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtAftrTrnsROBTo" RenderMode="Lightweight" CssClass="input_mandatory" MinValue="0" MaxValue="99999999" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number"  OnTextChanged="txtAfrTrnsROBFrom_TextChangedEvent" AutoPostBack="true">
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
