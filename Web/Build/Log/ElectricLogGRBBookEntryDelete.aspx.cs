...
public partial class Log_ElectricLogGRBBookEntryDelete : PhoenixBasePage
{
    Guid LogBookId;
    int usercode = 0;
    int vesselID = 0;
    ...
    protected void gvTabStrip_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                PhoenixMarpolLogGRB.DeletEBookEntryGRBRecord(Convert.ToInt32(txtUserCode.Text), LogBookId, rankId, lblRank.Text, lblName.Text);
