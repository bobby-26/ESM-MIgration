...
public partial class Log_ElectricLogGRBExceptionalDischarge : PhoenixBasePage
{
    int usercode = 0;
    int vesselId = 0;
    int logId = 0;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        logId = PhoenixMarpolLogGRB.GetGRBLogId(usercode, "ExcepDischarge");
    ...
    private void logBookEntryUpdate()
    {
        ...
        PhoenixMarpolLogGRB.LogGRBBookEntryStatusUpdate(usercode, logId, logBookId, Convert.ToInt32(lblinchId.Text), lblinchName.Text, lblincRank.Text, Convert.ToDateTime(lblincSignDate.Text), null, null, null, null);
    }
    ...
    private void logBookEntryInsert()
    {
        ...
        //// status insert
        PhoenixMarpolLogGRB.LogGRBBookEntryStatusInsert(usercode, logId, logBookTransferId, Convert.ToInt32(lblinchId.Text), lblinchName.Text, lblincRank.Text, Convert.ToDateTime(lblincSignDate.Text), null, null, null, null);
    }
