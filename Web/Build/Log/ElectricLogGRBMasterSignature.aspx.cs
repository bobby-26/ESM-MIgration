...
public partial class Log_ElectricLogGRBMasterSignature : PhoenixBasePage
{
    string txids;
    ...
    protected void gvTabStrip_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                PhoenixMarpolLogGRB.MasterSignatureGRB(int.Parse(ViewState["UserCode"].ToString()), txids, lblMasterFirstName.Text + " " + lblMasterLastName.Text, DateTime.Now);
