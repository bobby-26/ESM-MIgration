<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogGRBOperationList.aspx.cs" Inherits="Log_ElectricLogGRBOperationList" %>
...
<head id="Head1" runat="server">
    <title>Entries in Garbage Record Book Part 1 </title>
    ...
    <form id="frmgvCounterUpdate" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="95%" ClientEvents-OnRequestStart="pageOnUnload" ClientEvents-OnResponseEnd="pageOnLoad">
            ...
            <table width="100%">
                <tr>
                    <td>
                        <b>Garbage Categories:</b> A - Plastics; B - Food Waste; C - Domestic Waste; D - Cooking Oil; E - Incineration Ashes; F - Operational Waste; 
                        G - Animal Carcasses; H - Fishing Gear; I - E-Waste.
                    </td>
                </tr>
            </table>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvElogTransaction" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" EnableViewState="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="(m3)" HeaderStyle-Width="50px" AllowSorting="true" ColumnGroupName="Incinerated" ShowSortIcon="true" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Bottom" SortExpression="FLDINCINERATED" UniqueName="incineration">
                            <ItemStyle Wrap="true" HorizontalAlign="Center" VerticalAlign="Top"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblincineration" runat="server" Visible="True"></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
