...
public partial class Log_ElectricLogGRBTranscationHistory : PhoenixBasePage
{
    int usercode = 0;
    int vesselId = 0;
    ...
    private DataSet GetHistoryData(ref int iRowCount)
    {
        ...
        return PhoenixMarpolLogGRB.LogBookGRBHistorySearch(usercode, vesselId, gvTranscationHistory.CurrentPageIndex + 1, gvTranscationHistory.PageSize, ref iRowCount, ref iTotalPageCount, logBookId, fromDate, toDate);
    ...
    {
        string[] columns = new string[] { "FLDDISPLAYID", "FLDDATE", "FLDTYPE", "FLDEMPLOYEECODE", "FLDRANKSHORTCODE", "FLDMETHOD", "FLDCATEGORY", "FLDQUANTITY", "FLDPORTPOSITION", "FLDSTATUS", "FLDVERIFIED", "FLDREVERIFIED", "FLDMODIFYING" };
        return columns;
    }

    private string[] alCaptions()
    {
        string[] columns = new string[] { "Entry", "Datetime", "Type", "User Id", "Rank", "Method", "Category", "Quantity", "Facility / Vessel", "Receipt Ref", "Status", "Verified", "Re-Verified","Modifying" };
        return columns;
    }
}