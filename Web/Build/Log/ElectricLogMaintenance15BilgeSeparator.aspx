<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogMaintenance15BilgeSeparator.aspx.cs" Inherits="Log_ElectricLogMaintenance15BilgeSeparator" %>
...
<head runat="server">
    <title>Maintenance of 15ppm bilge separators</title>
            ...
            <div style="width: 100%; overflow: auto;">
                <div style="float: initial; margin: 0 50px">
                    <table>
                        ...
                        <tr>
                            <td><b>Oily Water Separator Maintenance</b></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <telerik:RadTextBox runat="server" ID="txtMaintenance" AutoPostBack="true" OnTextChanged="txt_selectedchange" CssClass="input_mandatory" TextMode="MultiLine" Columns="10" Width="150px"></telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                        ...
                        <td>
                            <telerik:RadTimePicker ID="txtStopTime" runat="server" CssClass="input_mandatory"  OnSelectedDateChanged="txtStopTime_SelectedDateChanged" AutoPostBack="true">
                                <TimeView Interval="00:30:00"></TimeView>
                            </telerik:RadTimePicker>
