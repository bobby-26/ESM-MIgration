...
public partial class Log_ElectricLogMasterSignature : PhoenixBasePage
{
    string txids;    
    ...
    protected void gvTabStrip_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                PhoenixElog.MasterSignature(int.Parse(ViewState["UserCode"].ToString()), txids, lblMasterFirstName.Text + " " + lblMasterLastName.Text, DateTime.Now);
