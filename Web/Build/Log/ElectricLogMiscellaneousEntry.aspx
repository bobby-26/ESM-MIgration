<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogMiscellaneousEntry.aspx.cs" Inherits="Log_ElectricLogMiscellaneousEntry" %>
            ...
            <div style="width: 100%; overflow: auto;">
                <div style="float: initial; margin: 0 50px">
                    <table>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblRemarks" runat="server" Visible="True" Text="Remarks"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTextBox runat="server" ID="txtRemarks" CssClass="input_mandatory" TextMode="MultiLine" Width="150px" Rows="5" Columns="10" AutoPostBack="true" OnTextChanged="txtOperationDate_TextChangedEvent"></telerik:RadTextBox>
                            </td>
                        </tr>
                    </table>
