<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogMissedOperationalEntry.aspx.cs" Inherits="Log_ElectricLogMissedOperationalEntry" %>
        ...
        <telerik:RadAjaxPanel runat="server">
            ...
            <div style="width: 100%; overflow: auto;">
                ...
                <%--    <table cellpadding="5px" cellspacing="5px" class="style_one" style="font-size: small; padding: 0 50px; width: 100%">
                        ...
                        <tr class="style_one">
                            <td class="style_one">
                                <telerik:RadLabel ID="txtDate" runat="server" Width="75px"></telerik:RadLabel>
                            </td>
                ...
                <div style="width: 100%; overflow: auto;">
                    <div style="float: initial; margin: 0 50px">
                        ...
                        <tr class="style_one">
                            ...
                            <%--<tr>
                                <td class="style_one" style="width: 80px">
                                    <telerik:RadLabel runat="server" ID="txtMisseOperdDate"></telerik:RadLabel>
                                </td>
                                <td class="style_one" style="text-align: center; width: 50px">
                                    <telerik:RadLabel ID="txtMissedOperCode" runat="server"></telerik:RadLabel>
                                </td>
                                <td class="style_one" style="text-align: center">
                                    <telerik:RadLabel ID="txtMissedOperItemNo" runat="server"></telerik:RadLabel>
                                </td>
                                <td>
                                    <telerik:RadLabel ID="txtMissedOperRecord" runat="server"></telerik:RadLabel>
                                </td>
                            </tr>--%>
                            <tr class="style_one" runat="server" id="temprecord0" visible="false">
                                <td class="style_one">
            ...
            <br />
            <div style="float: initial; margin: 0 50px">
                <iframe runat="server" id="iframe" class="iframe-style" visible="false" width="100%" height="100%" onload="iframe_OnLoad"></iframe>
            </div>
