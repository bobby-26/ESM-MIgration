...
public partial class Log_ElectricLogNOXBookEntryDelete : PhoenixBasePage
{
    Guid txid;
    int usercode = 0;
    int vesselID = 0;
    ...
    protected void gvTabStrip_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                PhoenixMarpolLogNOX.DeletEBookEntryNOXRecord(Convert.ToInt32(txtUserCode.Text), txid, rankId, lblRank.Text, lblName.Text);
