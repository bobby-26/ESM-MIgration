<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogORB2AdditionalProcedure.aspx.cs" Inherits="Log_ElectricLogORB2AdditionalProcedure" %>
...
<head id="Head1" runat="server">
    <title>Additional Operational Procedures and General</title>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <div style="width: 100%; overflow: auto;">
                <div style="float: initial; margin: 0 50px">
                    ...
                    <h3>Additional Operational Procedures and General</h3>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <telerik:RadDatePicker RenderMode="Lightweight" runat="server" CssClass="input_mandatory" AutoPostBack="true" ID="txtOperationDate" MaxLength="12" >
                        ...
                        <tr>
                         <td>
                                <telerik:RadLabel ID="RadLabel2" runat="server" Text="Operation or Additional Remark" style="vertical-align:text-bottom"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTextBox ID="txtremark" runat="server" TextMode="MultiLine" CssClass="input_mandatory"  RenderMode="Lightweight" AutoPostBack="true" OnTextChanged="txtFailureReason_TextChanged">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
