<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogORB2AfterRepairOilDischarge.aspx.cs" Inherits="Log_ElectricLogORB2AfterRepairOilDischarge" %>
                ...
                <div style="float: initial; margin: 0 50px">
                    ...
                    <table>
                        ...
                        <tr>
                         ...
                         <tr>
                            <td>
                                <telerik:RadLabel ID="RadLabel2" Text="Repair Time" runat="server"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTimePicker ID="txtrepairtime" runat="server" CssClass="input_mandatory" AutoPostBack="true" OnSelectedDateChanged="txtFailureTime_SelectedDateChanged">
                                    <TimeView ID="TimeView3" Interval="00:30:00" runat="server"></TimeView>
                                </telerik:RadTimePicker>
                                <telerik:RadLabel ID="Radlabel3" runat="server" Text="HH:MM"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadLabel ID="RadLabel7" Text="UTC" runat="server"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTimePicker ID="txtutc2" runat="server" CssClass="input_mandatory" AutoPostBack="true" OnSelectedDateChanged="txtFailureTime_SelectedDateChanged">
                                    <TimeView ID="TimeView4" Interval="00:30:00" runat="server"></TimeView>
                                </telerik:RadTimePicker>
                          ...
                          <tr runat="server" visible="false"> 
                            ...
                            <td>
                                <telerik:RadTextBox ID="txtFailureReason" RenderMode="Lightweight" TextMode="MultiLine" Text="-" AutoPostBack="true" CssClass="input_mandatory" runat="server"  OnTextChanged="txtFailureReason_TextChanged">
                                </telerik:RadTextBox>
                            </td>
                            <td></td>
                        </tr>
