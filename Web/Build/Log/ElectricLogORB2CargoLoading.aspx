<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogORB2CargoLoading.aspx.cs" Inherits="Log_ElectricLogORB2CargoLoading" %>
...
<head runat="server">
    <title>Loading of Oil Cargo</title>
                ...
                <div style="float: initial; margin: 0 50px">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadTextBox ID="txtLoadTerminal" runat="server" CssClass="input_mandatory" RenderMode="Lightweight" AutoPostBack="true" OnTextChanged="txtLoadTerminal_TextChanged">
                                </telerik:RadTextBox>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblTotalQuantity" runat="server" Text="Total Quantity Loaded"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtTotalQuantityLoaded" RenderMode="Lightweight" MinValue="0" MaxValue="99999999" CssClass="input_mandatory" runat="server" MaxLength="22" Width="132px" Style="text-align: right;" Type="Number" AutoPostBack="true" OnTextChanged="txtAfrTrnsROBFrom_TextChangedEvent">
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblGradeCargo" runat="server" Visible="true" Text="Grade of Cargo"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTextBox ID="txtGradeofCargo" runat="server" CssClass="input_mandatory" RenderMode="Lightweight" AutoPostBack="true" OnTextChanged="txtAfrTrnsROBFrom_TextChangedEvent">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                    </table>
