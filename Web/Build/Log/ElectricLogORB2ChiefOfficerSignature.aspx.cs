...
public partial class Log_ElectricLogORB2ChiefOfficerSignature : PhoenixBasePage
{
    int usercode = 0;
    int vesselId = 0;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                bool isChiefOfficer = PhoenixElog.validChiefOfficer(rank);               
                ...
                if (isChiefOfficer)
                {
                    ...
                    nvc.Add("isChiefOfficer", isChiefOfficer.ToString());
                ...
                {
                    throw new ArgumentException("Only valid Chief Officer can able to sign");
                }
            }
        }
        catch (Exception ex)
