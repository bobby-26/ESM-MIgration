...
public partial class Log_ElectricLogORB2MasterSignature : PhoenixBasePage
{
    string txids;
    ...
    protected void gvTabStrip_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                PhoenixMarbolLogORB2.MasterSignatureORB2(int.Parse(ViewState["UserCode"].ToString()), txids, lblMasterFirstName.Text + " " + lblMasterLastName.Text, DateTime.Now);
