<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogORB2ReallocationBallastWater.aspx.cs" Inherits="Log_ElectricLogORB2ReallocationBallastWater" %>
...
<head runat="server">
    <title>Re-allocation of Ballast Water Within the Ship</title>
        ...
        <telerik:RadAjaxPanel runat="server" ID="radAjaxPanel">
            ...
            <asp:Button ID="cmdHiddenSubmit" runat="server" OnClick="cmdHiddenSubmit_Click" Style="display: none;" />
                ...
                <div style="float: initial; margin: 0 50px">
                    ...
                    <h3>Re-allocation of Ballast Water Within the Ship</h3>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblReallocation" runat="server" Text="Reasons for Re-allocation"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTextBox ID="txtReasons" runat="server" CssClass="input_mandatory" RenderMode="Lightweight" AutoPostBack="true" TextMode="MultiLine" Rows="5" OnTextChanged="Refresh_TextChanged" Width="350px">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                    </table>
