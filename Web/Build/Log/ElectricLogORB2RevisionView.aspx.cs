...
public partial class Log_ElectricLogORB2RevisionView : PhoenixBasePage
{
    int usercode = 0;
    int vesselId = 0;
    ...
    {
        DataSet ds = PhoenixMarbolLogORB2.LogORB2LocationGetAttachmentFromRevision(usercode, vesselId, revisionNo);
    ...
    protected void gvRevision_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        gvRevision.DataSource = PhoenixMarbolLogORB2.PhoenixLogORB2LocationByRevisionNumber(usercode, vesselId, revisionNo, revisionDate);
