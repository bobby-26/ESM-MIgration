...
public partial class Log_ElectricLogORB2TankAdd : PhoenixBasePage
{
    int usercode;
    int vesselid;
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                if (IsValidReport())
                {
                    ...
                    PhoenixMarbolLogORB2.InsertORB2Location(usercode, code, txtTankName.Text, vesselid, txtIoppName.Text, tankType, capacity, txtFrameFrom.Text, txtLateralPosition.Text);
