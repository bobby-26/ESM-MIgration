<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogORB2TranscationHistory.aspx.cs" Inherits="Log_ElectricLogORB2TranscationHistory" %>
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText='Line 1' AllowSorting='true'>
                            <ItemStyle Width="50px" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblRecord" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDLINE1") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText='Line 6' AllowSorting='true'>
                            <ItemStyle Width="50px" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblRecord5" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDLINE6") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>

                        <telerik:GridTemplateColumn HeaderText='Line 7' AllowSorting='true'>
                            <ItemStyle Width="50px" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblRecord6" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDLINE7") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>

                        <telerik:GridTemplateColumn HeaderText='Line 8' AllowSorting='true'>
                            <ItemStyle Width="50px" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblRecord7" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDLINE8") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
