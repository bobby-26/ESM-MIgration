...
public partial class Log_ElectricLogORB2TranscationHistory : PhoenixBasePage
{
    int usercode = 0;
    int vesselId = 0;
    ...
    private DataSet GetHistoryData(ref int rowCount)
    {
        int iRowCount = 0;
        ...
        return PhoenixMarbolLogORB2.LogBookORB2HistorySearch(usercode, vesselId, 1, gvTranscationHistory.PageSize, ref iRowCount, ref iTotalPageCount, txid, fromDate, toDate);
