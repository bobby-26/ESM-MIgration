<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogOWSOperation.aspx.cs" Inherits="Log_ElectricLogOWSOperation" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server">
            ...
            <div style="margin: 0 50px">
                <table style="padding-left: 50px;">
                    <tr>
                        ...
                        <td>
                            ...
                            <telerik:RadLabel runat="server" ID="lblBilgeTranscationId" Visible="false"></telerik:RadLabel>
                    ...
                    <tr>
                        <td>
                            <telerik:RadLabel ID="lblFrom" runat="server" Text="Oily Water Separator Operation"></telerik:RadLabel>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadNumericTextBox ID="txtBfrTrnsROBFrom" CssClass="input_mandatory" AutoPostBack="true" MinValue="0" MaxValue="99999999" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number" OnTextChanged="txt_SelectedDateChanged">
                    ...
                    <tr>
                        <td>
                            <telerik:RadLabel ID="lblOperationTest" runat="server" Text="Operational Test"></telerik:RadLabel>
                        </td>
                        <td>
                            <telerik:RadTimePicker ID="txtOperationalTime" runat="server" CssClass="input_mandatory" AutoPostBack="true" OnSelectedDateChanged="txt_SelectedDateChanged">
                    ...
                    <tr>
                        <td>
                            <telerik:RadLabel ID="lblOperatingTime" runat="server" Text="Opearting Time"></telerik:RadLabel>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadNumericTextBox ID="txtOWSCapacityRunTime" CssClass="input_mandatory" MinValue="0" MaxValue="99999999" AutoPostBack="true" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" OnTextChanged="txt_SelectedDateChanged" Style="text-align: right;" Type="Number">
                                <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                            </telerik:RadNumericTextBox>
                ...
                <br />
                <table style="padding-left: 50px;" cellpadding="5px" cellspacing="5px" class="style_one operation-table">
                    <tr>
                        <td style="width: 50px">
                            <b>
                    ...
                    <tr class="style_one">
                        ...
                        <td class="style_one" style="text-align: center">
                            <telerik:RadLabel runat="server" ID="txtCode"></telerik:RadLabel>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style_one">
                            <telerik:RadLabel ID="lblEquipment" runat="server"></telerik:RadLabel>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        <td class="style_one"></td>
                        <td>
                            <telerik:RadLabel ID="lblStartPos" runat="server"></telerik:RadLabel>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        <td class="style_one" style="text-align: center"></td>
                        <td class="style_one">
                            <telerik:RadLabel ID="lblStopPos" runat="server"></telerik:RadLabel>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
