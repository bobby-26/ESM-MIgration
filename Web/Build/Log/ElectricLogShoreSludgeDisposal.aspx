<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogShoreSludgeDisposal.aspx.cs" Inherits="Log_ElectricLogShoreSludgeDisposal" %>
...
<head runat="server">
    <title>Shore Sludge Disposal</title>
                ...
                <div style="float: initial; margin: 0 50px">
                    <table>
                        <tr>
                            ...
                            <td>
                                <telerik:RadDatePicker ID="txtOperationDate" RenderMode="Lightweight" runat="server" CssClass="input_mandatory" MaxLength="12" AutoPostBack="true" OnSelectedDateChanged="txtOperationDate_TextChangedEvent" >
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblFrom" runat="server" Text="Discharge from tank"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadComboBox dropdownposition="Static" CssClass="input_mandatory"  ID="ddlTransferFrom" runat="server" DataTextField="FLDNAME" OnSelectedIndexChanged="ddlTransferFrom_SelectedIndexChanged" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True" AutoPostBack="true"
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblBfrTrnsROBFrom" runat="server" Text="Before Discharge ROB"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtBfrTrnsROBFrom" CssClass="input_mandatory" MinValue="0" MaxValue="99999999" AutoPostBack="true" OnTextChanged="bfr_onselctedindexchanged" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                            ...
                            <td>
                                <telerik:RadLabel ID="lblShoreFacility" runat="server" Text="Name of Barage/Truck Number/Shore Facility"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadTextBox ID="txtShoreFacility" CssClass="input_mandatory" AutoPostBack="true"  OnTextChanged="txtAftrTrnsROBFrom_TextChanged" runat="server">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblBfrTrnsROBTo" runat="server" Text="After Discharge ROB"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtAftrTrnsROBFrom" CssClass="input_mandatory" MinValue="0" MaxValue="99999999" AutoPostBack="true" RenderMode="Lightweight" OnTextChanged="txtAftrTrnsROBFrom_TextChanged"  runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
                            ...
                            <td>
                                <telerik:RadTextBox ID="txtPortName" CssClass="input_mandatory" runat="server"  OnTextChanged="txtAftrTrnsROBFrom_TextChanged" AutoPostBack="true">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                    </table>
