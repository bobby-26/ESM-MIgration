<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogSludgeFromERToDeck.aspx.cs" Inherits="Log_ElectricLogSludgeFromERToDeck" %>
...
<head runat="server">
    <title>Sludge from ER to Deck</title>
                ...
                <div style="float: initial; margin: 0 50px">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="ddlTransferFrom" dropdownposition="Static" CssClass="input_mandatory"  runat="server" DataTextField="FLDNAME" OnSelectedIndexChanged="ddlTransferFrom_SelectedIndexChanged" AutoPostBack="true" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True"
                                    EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true">
                                </telerik:RadComboBox>
                            </td>
                            <td>
                                <telerik:RadLabel ID="lblTo" runat="server" Text="Transferred to deck/cargo slop tank"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadComboBox ID="ddlTransferTo" dropdownposition="Static" CssClass="input_mandatory"  runat="server" DataTextField="FLDNAME" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True" AutoPostBack="true"
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtBfrTrnsROBFrom" CssClass="input_mandatory" Disable="true" MinValue="0" MaxValue="99999999" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number" AutoPostBack="true" OnTextChanged="txtBfrTrnsROBFrom_TextChanged">
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtAftrTrnsROBFrom"  RenderMode="Lightweight" MinValue="0" MaxValue="99999999" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number" CssClass="input_mandatory" OnTextChanged="txtAftrTrnsROBFrom_TextChanged" AutoPostBack="true">
                                    <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
