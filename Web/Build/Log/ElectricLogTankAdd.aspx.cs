...
public partial class Log_ElectricLogTankAdd : PhoenixBasePage
{
    int usercode;
    int vesselid;
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                if (IsValidReport())
                {
                    ...
                    PhoenixElog.InsertLocation(usercode, variant, code, txtTankName.Text, true, vesselid, txtIoppName.Text, tankType, capacity, txtFrameFrom.Text, txtLateralPosition.Text);
