...
public partial class Log_ElectricLogTankEdit : PhoenixBasePage
{
    Guid LocationId;
    int usercode;
    int vesselid;
    ...
    {
        ddlTankType.DataSource = PhoenixElog.GetTankType("ORB1");
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                if (IsValidReport())
                {
                    ...
                    PhoenixElog.EditLocation(usercode, LocationId, ioppname, capacity, vesselid, tankType, txtFrameFrom.Text, txtLateralPosition.Text);
    ...
    {
        DataSet ds = PhoenixElog.LocationSelect(usercode, LocationId);
