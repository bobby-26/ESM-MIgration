<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogTankList.aspx.cs" Inherits="Log_ElectricLogTankList" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="95%">
            ...
            <div class="new-grid">
                <telerik:RadGrid RenderMode="Lightweight" ID="gvTankList" runat="server" AllowCustomPaging="false" AllowSorting="true" AllowPaging="false"
                    ...
                    OnItemCommand="gvTankList_ItemCommand" OnGridExporting="gvTankList_GridExporting"
                    ...
                    <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false" GroupsDefaultExpanded="true"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Lateral Position" ColumnGroupName="tanklocation">
                                <HeaderStyle Width="150px" HorizontalAlign="Center" />
                                <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Action">
                                ...
                                <ItemTemplate>
                                    ...
                                    <%--<asp:LinkButton runat="server" AlternateText="Revision"
                                    CommandName="REVISION" ID="cmdRevision"
                                    ToolTip="Revision" Width="20PX" Height="20PX">
                                        <span class="icon"><i class="fas fa-copy-requisition"></i></span>
                                </asp:LinkButton>
                                <asp:LinkButton runat="server" AlternateText="Attachment"
                                    CommandName="EDIT" ID="cmdAttachment"
                                    ToolTip="Attachment" Width="20PX" Height="20PX">
                                        <span class="icon"><i runat="server" id="lblAttachmentIcon" class="fas fa-paperclip-na"></i></span>
                                </asp:LinkButton>--%>
