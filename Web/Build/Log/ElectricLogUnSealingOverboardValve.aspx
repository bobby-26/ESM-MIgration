<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogUnSealingOverboardValve.aspx.cs" Inherits="Log_ElectricLogUnSealingOverboardValve" %>
...
<head runat="server">
    <title>UnSealing of Overboard Valve</title>
                ...
                <div style="float: initial; margin: 0 50px">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadTextBox ID="txtSealingOverBoard" runat="server" CssClass="input_mandatory"  AutoPostBack="true" OnTextChanged="txt_TextChanged">
                                </telerik:RadTextBox>
                                <%-- <telerik:RadNumericTextBox ID="txtSealingOverBoard" RenderMode="Lightweight" CssClass="input_mandatory" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number"  OnTextChanged="txt_TextChanged">
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadTextBox ID="txtSealNo" runat="server" CssClass="input_mandatory" AutoPostBack="true"  OnTextChanged="txt_TextChanged">
                                </telerik:RadTextBox>
                             <%--   <telerik:RadNumericTextBox ID="txtSealNo" RenderMode="Lightweight" CssClass="input_mandatory" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number"  OnTextChanged="txt_TextChanged">
                                </telerik:RadNumericTextBox>--%>
                            </td>
                            <td></td>
                            <td></td>
