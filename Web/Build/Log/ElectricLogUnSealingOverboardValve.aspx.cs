...
public partial class Log_ElectricLogUnSealingOverboardValve : PhoenixBasePage
{
    string ReportCode = "I";
    string ItemNo = null;
    ...
    public void BindData()
    {
        try
        {
            ...
            ds = PhoenixElog.SealingUnsealingSearch(usercode, vesselId, txid, true);
    ...
    private void MissedOperationUpdate(string logName, Guid? TranscationId, Guid logId)
    {
        ...
        nvc.Add("Record3", lblrecord1.Text);
    ...
    private void SetDefaultData()
    {
        ...
        lblRecord.Text = string.Format("Overboard value no <b>{0}</b> from 15 ppm bilge water seperator unit unsealed", txtSealingOverBoard.Text);
        lbltorecord.Text = string.Format("for normal operation of 15ppm unit");
        lblrecord1.Text = string.Format("Seal No:  <b>{0}</b>", txtSealNo.Text);
    }
