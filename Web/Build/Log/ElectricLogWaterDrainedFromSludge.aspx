<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricLogWaterDrainedFromSludge.aspx.cs" Inherits="Log_ElectricLogWaterDrainedFromSludge" %>
...
<head runat="server">
    <title>Water Drained from Sludge Tank</title>
            ...
            <div style="width: 100%; overflow: auto;">
                <div style="float: initial; margin: 0 50px">
                    <table>
                        ...
                        <tr>
                            <td>
                                <telerik:RadLabel ID="lblFrom" runat="server" Text="Water Drained from"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadComboBox ID="ddlTransferFrom" dropdownposition="Static" CssClass="input_mandatory"  runat="server" DataTextField="FLDNAME" AutoPostBack="true" OnSelectedIndexChanged="ddlTransferFrom_SelectedIndexChanged" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True"
                                    EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true">
                                </telerik:RadComboBox>
                            </td>
                            <td>
                                <telerik:RadLabel ID="lblTo" runat="server" Text="Drained water transferred to"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadComboBox ID="ddlTransferTo" dropdownposition="Static" CssClass="input_mandatory"  runat="server" DataTextField="FLDNAME" DataValueField="FLDLOCATIONID" EnableLoadOnDemand="True"
                                    EmptyMessage="Type to select" Filter="Contains" MarkFirstMatch="true" AutoPostBack="true" OnSelectedIndexChanged="ddlTransferTo_SelectedIndexChanged">
                                </telerik:RadComboBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <telerik:RadNumericTextBox ID="txtBfrTrnsROBFrom" CssClass="input_mandatory" MinValue="0" MaxValue="99999999" RenderMode="Lightweight" AutoPostBack="true" OnTextChanged="from_selectedindexchanged" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                            ...
                            <td>
                                <telerik:RadLabel ID="lblBfrTrnsROBTo" runat="server" Text="Before Transfer ROB"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtBfrTrnsROBTo" CssClass="input_mandatory" AutoPostBack="true" MinValue="0" MaxValue="99999999" OnTextChanged="To_selectedindexchanged"  RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                                    <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadLabel ID="lblAftrTrnsROBFrom" runat="server" Text="After Transfer ROB"></telerik:RadLabel>
                            </td>
                            <td>
                                <%--<telerik:RadNumericTextBox ID="RadNumericTextBox1"  CssClass="input_mandatory" OnTextChanged="txtAftrTrnsROBFrom_TextChanged" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">--%>
                                <telerik:RadNumericTextBox ID="txtAftrTrnsROBFrom"  CssClass="input_mandatory" MinValue="0" MaxValue="99999999" RenderMode="Lightweight" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number">
                                    <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
                            ...
                            <td>
                                <telerik:RadLabel ID="lblAftrTrnsROBTo" runat="server" Text="After Transfer ROB"></telerik:RadLabel>
                            </td>
                            <td>
                                <telerik:RadNumericTextBox ID="txtAftrTrnsROBTo" CssClass="input_mandatory" RenderMode="Lightweight" MinValue="0" MaxValue="99999999" runat="server" MaxLength="22" Width="120px" Style="text-align: right;" Type="Number" OnTextChanged="txtAftrTrnsROBFrom_TextChanged" AutoPostBack="true">
                                    <NumberFormat DecimalSeparator="." DecimalDigits="2" />
                                    <ClientEvents OnKeyPress="NumberFieldKeyPress" />
                                </telerik:RadNumericTextBox>
