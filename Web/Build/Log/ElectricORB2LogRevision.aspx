<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectricORB2LogRevision.aspx.cs" Inherits="Log_ElectricORB2LogRevision" %>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvRevision" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <%--    <telerik:GridTemplateColumn HeaderText='' AllowSorting='true'>
                    ...
                    <%--<telerik:GridTemplateColumn HeaderText='Date' AllowSorting='true'>
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblREVISIONDATE" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREVISIONDATE") %>'></telerik:RadLabel>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>--%>


                    <%--<telerik:GridTemplateColumn HeaderText='I' AllowSorting='true'>
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblISACTIVEREVISION" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDISACTIVEREVISION") %>'></telerik:RadLabel>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>--%>
