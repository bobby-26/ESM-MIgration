...
public partial class Log_ElectricORB2LogRevision : PhoenixBasePage
{
    int usercode = 0;
    int vesselId = 0;
    ...
    protected void gvRevision_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        gvRevision.DataSource = PhoenixMarbolLogORB2.PhoenixLogORB2RevisionSearch(usercode, vesselId, 1, 100, ref iRowCount, ref iTotalPageCount);
    ...
    protected void gvRevision_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        if (e.Item is GridEditableItem)
        {
            ...
            {
                string script = string.Format("javascript:openNewWindow('MoreInfo', '', '{0}/Log/ElectricLogORB2RevisionView.aspx?date={1}&revisionNo={2}', 'true'); return false", Session["sitepath"], drv["FLDREVISIONDATE"].ToString(), drv["FLDREVISIONNO"].ToString());
