<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectronicLogAnnexVIEngineParametersRecordHistory.aspx.cs" Inherits="Log_ElectronicLogAnnexVIEngineParametersRecordHistory" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvODS" AutoGenerateColumns="false"
                ...
                <MasterTableView EditMode="InPlace" DataKeyNames="FLDHISTORYID" AutoGenerateColumns="false" HeaderStyle-Font-Bold="true"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Adjustment Made">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle HorizontalAlign="Left" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="radadjustment" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDADJUSTMENT")%>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
