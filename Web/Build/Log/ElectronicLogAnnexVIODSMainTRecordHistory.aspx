<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ElectronicLogAnnexVIODSMainTRecordHistory.aspx.cs" Inherits="Log_ElectronicLogAnnexVIODSMainTRecordHistory" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvODS" AutoGenerateColumns="false"
                ...
                <MasterTableView EditMode="InPlace" DataKeyNames="FLDHISTORYID" AutoGenerateColumns="false" HeaderStyle-Font-Bold="true"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name of Gas">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="radmaker" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDGASNAME")%>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Qty used/ Eqpt">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="radmodel" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDQOREUSED")%>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Reason - Charging">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="rasdlocation" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDCHARGINGREASON")%>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Maint done">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="radodsname" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FLDMAINTDONE")%>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
