...
public partial class Log_ElectronicLogAnnexVIODSMainTRecordHistory : PhoenixBasePage
{
    ...
    protected void gvODS_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        try
        {
            ...
            DataTable dt = PhoenixMarpolLogODS.ODSMaintRecordHistorySearch(From, To, Status, gvODS.CurrentPageIndex + 1, gvODS.PageSize, ref iRowCount, ref iTotalPageCount);
