...
public partial class Log_ElectronicLogAnnexVIODSSDRecordHistory : PhoenixBasePage
{
    ...
    protected void gvODS_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        try
        {
            ...
            DataTable dt = PhoenixMarpolLogODS.ODSSDRecordHistorySearch(From, To, Status, gvODS.CurrentPageIndex + 1, gvODS.PageSize, ref iRowCount, ref iTotalPageCount);
