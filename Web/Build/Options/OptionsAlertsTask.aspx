<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OptionsAlertsTask.aspx.cs"
    Inherits="OptionsAlertsTask" EnableEventValidation="false" %>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="gvAlertsTask" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                                Width="100%" CellPadding="3" OnRowCommand="gvAlertsTask_RowCommand" OnRowDataBound="gvAlertsTask_RowDataBound">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="AlertName">
                                        ...
                                        <HeaderTemplate>
                                            <asp:Label ID="lblAlert" runat="server">Alert&nbsp;
                                            </asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="lblDescription" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDESCRIPTION") %>' CommandArgument="<%# Container.DataItemIndex %>"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
