...
public partial class OptionsCrewLFTDueAlert : PhoenixBasePage
{
    ...
    private void GetAlertItems(string tasktype)
    {
        ...
        if (tasktype.Equals("22"))
        {
            gvAlertsTask.DataSource = PhoenixCrewMedical.AlertCrewLFTdue(
