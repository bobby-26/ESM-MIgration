<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OptionsCrewTraineeAppraisalAlert.aspx.cs" Inherits="OptionsCrewTraineeAppraisalAlert" %>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblDescriptionDate" runat="server" 
                                                Text='<%# DataBinder.Eval(Container,"DataItem.FLDRELIEFDUEDATE") %>' ></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
