<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OptionsCriticalSpareItemBelowMinLevel.aspx.cs"
    Inherits="OptionsCriticalSpareItemBelowMinLevel" %>
        ...
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="navSelect" style="position: relative; width: 15px">
                 ...
                 <asp:GridView ID="gvStockItem" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowDataBound="gvStockItem_ItemDataBound"                        
                        ShowHeader="true" EnableViewState="false" AllowSorting="true"
                        OnSorting="gvStockItem_Sorting" DataKeyNames="FLDSPAREITEMID" >
                        ...
                        <Columns>       
                            <asp:TemplateField HeaderText="Number">
                                ...
                                <HeaderTemplate>
                                   <asp:Label ID="lblVesselNameHeader" runat="server">Vessel Name
                                    </asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Maker's Reference">
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Label ID="lblMakerReferenceHeader" runat="server">Maker's Reference&nbsp;
                                    </asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                   <asp:Label ID="lblMakerReference" runat ="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMAKERREFERENCE") %>'></asp:label> 
                                   <asp:Label ID="lblMarkerReferencFullDetails" Visible="false" runat ="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMAKERREFERENCEFULLDETAILS") %>'></asp:label> 
                               <%--   <asp:LinkButton ID="lnkMakerReference" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMAKERREFERENCE") %>'></asp:LinkButton>--%>
                            ...
                            <asp:TemplateField>
                                ...
                                <HeaderTemplate>
                                    <asp:Label ID="lblSpareMinimumHeader" runat="server">Spare Minimum
                                    </asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container,"DataItem.FLDSPAREMINIMUM") %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="ROB">
                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Label ID="lblROBHeader" runat="server">Total Quantity</asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblROB" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDROB","{0:n0}") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>                           
                        </Columns>
                    </asp:GridView>
