<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OptionsDmsUserIdentity.aspx.cs" Inherits="OptionsDmsUserIdentity" %>
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvUseridentity.ClientID %>"));
                }, 200);
            }
