<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OptionsEmailDraft.aspx.cs"
    Inherits="OptionsEmailDraft" %>
...
<head runat="server">
    <title>Draft</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    <form id="frmOptionEmailDraft" runat="server">
    ...
    <div id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%;
        ...
        <div class="subHeader" style="position: relative">
            <eluc:Title runat="server" ID="Title1" Text="Draft" ShowMenu="false"></eluc:Title>
        </div>
        <asp:GridView Width="100%" Font-Size="11px" ID="gvDraft" runat="server" CellPadding="3"
            AutoGenerateColumns="False" HeaderStyle-HorizontalAlign="Left" ShowFooter="false" ShowHeader="true" EnableViewState="false"
            OnRowDataBound="gvDraft_RowDataBound" OnRowDeleting="gvDraft_RowDeleting" >
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="To" SortExpression="FLDTO">
                    <ItemTemplate>
                        <a href="OptionsEmail.aspx?mailId=<%# Eval("FLDEMAILID") %>&sessionId=<%# Eval("FLDSESSIONID") %>&mailFolderId=1">
                            <%# Eval("FLDTO") %></a>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                         <a href="OptionsEmail.aspx?mailId=<%# Eval("FLDEMAILID") %>&sessionId=<%# Eval("FLDSESSIONID") %>&mailFolderId=1">
                            <img src="<%$ PhoenixTheme:images/te_edit.png %>" runat="server" alt="Edit" title="Edit" /></a>
