...
public partial class OptionsEmailReceived : PhoenixBasePage
{
    ...
    private void BindGridView()
    {
        ...
        DataSet ds = PhoenixMail.MailSearch(General.GetNullableInteger(Filter.CurrentCrewSelection).Value, PhoenixMail.Folder.Inbox
