<%@ Page Language="C#" AutoEventWireup="True" CodeFile="OptionsHardExtn.aspx.cs"
    Inherits="OptionsHardExtn" MaintainScrollPositionOnPostback="true" %>
...
<body>
   ...
   <form id="frmRegistersHard" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="94%">
            ...
            <eluc:Title runat="server" ID="ucTitle" Text="System Parameters Extension" Visible="false">
            </eluc:Title>
            <eluc:TabStrip ID="MenuHardExtn" runat="server" OnTabStripCommand="MenuHardExtn_TabStripCommand"
                ...
                <table id="tblConfigureHard" width="100%">
                    <tr>
                        ...
                        <td>
                            <Telerik:RadDropDownList ID="ddlHardType" runat="server" DataTextField="FLDHARDTYPENAME"
                                DataValueField="FLDHARDTYPECODE" CssClass="input">
                            </Telerik:RadDropDownList>
                            <%-- <eluc:HardType ID="ddlHardType" OnTextChangedEvent="ddlHardType_TextChanged" runat="server"
                                    CssClass="input"OnTextChanged="ddlHardType_TextChanged" />--%>
                        </td>
                    </tr>
                </table>
             <eluc:TabStrip ID="MenuPhoenixHard" runat="server" OnTabStripCommand="PhoenixHard_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvHard" Height="88%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"  OnSorting="gvHard_Sorting"
                CellSpacing="0" GridLines="None" OnItemCommand="gvHard_ItemCommand" OnItemDataBound="gvHard_ItemDataBound" OnNeedDataSource="gvHard_NeedDataSource"
