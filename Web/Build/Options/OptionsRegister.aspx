<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OptionsRegister.aspx.cs" Inherits="OptionsRegister" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmRegisters" autocomplete="off" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRegister" Height="88%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDREGISTERID">
                    <NoRecordsTemplate>
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Code" AllowSorting="true" SortExpression="FLDSHORTCODE">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lblRegisterId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREGISTERID") %>'></telerik:RadLabel>

                            </ItemTemplate>
                            <EditItemTemplate>
                                <telerik:RadLabel ID="lblRegisterIdEdit" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREGISTERID") %>'></telerik:RadLabel>
                                <telerik:RadTextBox ID="lblShortCodeEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSHORTCODE") %>'
                            ...
                            <FooterTemplate>
                                <telerik:RadTextBox ID="txtShortCodeAdd" runat="server" CssClass="gridinput_mandatory"
                                    MaxLength="5" ToolTip="Enter Short Code" Width="100%"></telerik:RadTextBox>
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Name" AllowSorting="true" SortExpression="FLDREGISTERNAME">
                            <HeaderStyle Width="45%" />
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblRegisterName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREGISTERNAME") %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <telerik:RadTextBox ID="txtRegisterNameEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREGISTERNAME") %>'
                                    CssClass="gridinput_mandatory" MaxLength="200" Width="100%"></telerik:RadTextBox>
                            </EditItemTemplate>
                            <FooterTemplate>
