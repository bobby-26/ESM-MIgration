<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OptionsVesselDMSImportList.aspx.cs" Inherits="OptionsVesselDMSImportList" %>
...
<head id="Head1" runat="server">
    <title>Vessel DMS Import List</title>
...
<body>
    <form id="frmDataTransferVesselDMSList" runat="server">
                        ...
                        <telerik:GridTemplateColumn HeaderText=" Last DT Import Sequence">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblVesselImportSequence" runat="server"
                                    Text='<%# DataBinder.Eval(Container,"DataItem.FLDDTENTITYSERIAL") %>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Last AT Import Sequence">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblVesselImportDate" runat="server"
                                    Text='<%# DataBinder.Eval(Container,"DataItem.FLDATENTITYSERIAL") %>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
