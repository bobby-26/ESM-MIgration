...
public partial class OptionsWorkOrderDue : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {                  
            ...
            toolbar1.AddImageButton("../Options/OptionsWorkOrderDue.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            General.ShowExcel("Major Overhaul Job Due", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        try
        {
            ...
            General.SetPrintOptions("gvWorkOrder", "Major Overhaul Job Due", alCaptions, alColumns, ds);
