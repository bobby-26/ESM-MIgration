...
public partial class OptionsWorkOrderDue2Months : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {                   
            ...
            toolbar1.AddImageButton("../Options/OptionsWorkOrderDue2Months.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            General.ShowExcel("Major Overhaul Job Due in 2 Months", ds.Tables[0], alColumns, alCaptions, sortdirection, sortexpression);
    ...
    private void BindData()
    {
        try
        {
            ...
            General.SetPrintOptions("gvWorkOrder", "Major Overhaul Job Due in 2 Months", alCaptions, alColumns, ds);
