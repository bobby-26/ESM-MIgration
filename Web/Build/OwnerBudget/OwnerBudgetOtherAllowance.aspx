<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnerBudgetOtherAllowance.aspx.cs" Inherits="OwnerBudgetOtherAllowance" %>
    ...
    <form id="frmContactType" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlContactType">
                ...
                <tr>
                    ...
                    <td>
                        <eluc:AddressType runat="server" ID="ucUnion" CssClass="input" AppendDataBoundItems="false" Width="30%"
                            AddressType="134" OnTextChangedEvent="ucUnion_TextChangedEvent" AutoPostBack="true" />
                    </td>
                </tr>
            </table>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvContactType" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                ...
                ShowHeader="true" EnableViewState="true" OnSortCommand="gvContactType_SortCommand"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Seq" HeaderStyle-Width="290px">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <HeaderTemplate>
                                <telerik:RadLabel ID="lblAllowance" runat="server" Text="Allowance"></telerik:RadLabel>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblAllownace" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDALLOWANCE") %>'></telerik:RadLabel>
                                <telerik:RadLabel ID="lblAllowanceId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDOTHERALLOWANCEID") %>'></telerik:RadLabel>
                                <telerik:RadLabel ID="lblAllowanceName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDALLOWANCENAME") %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <FooterTemplate>
                                <eluc:Quick ID="ucAllowance" runat="server" CssClass="gridinput_mandatory" AppendDataBoundItems="true"
                                    QuickTypeCode="111" Width="200px" />
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderStyle-Width="290px" HeaderStyle-HorizontalAlign="Right">
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="290px">
