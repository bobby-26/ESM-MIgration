...
public partial class OwnerBudgetOtherExpenses : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../OwnerBudget/OwnerBudgetOtherExpenses.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "OTHEREXPENSE", "FLDAMOUNT", "FREQUENCY" };
        string[] alCaptions = { "Expense", "Amount","Frequency" };
        ...
        ds = PhoenixOwnerBudgetRegisters.OtherExpensesSearch(General.GetNullableInteger(ddlManagementType.SelectedValue)
                       , 1
                       , iRowCount
                       , ref iRowCount
                       , ref iTotalPageCount);
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=OtherExpenses.xls");
        Response.ContentType = "application/vnd.msexcel";
        Response.Write("<TABLE BORDER='0' CELLPADDING='2' CELLSPACING='0' width='100%'>");
        Response.Write("<tr>");
        Response.Write("<td><img src='http://" + Request.Url.Authority + Session["images"] + "/esmlogo4_small.png" + "' /></td>");
        Response.Write("<td><h3>Other Expenses</h3></td>");
    ...
    private void BindData()
    {
        ...
        General.SetPrintOptions("gvContactType", "Other Expenses", alCaptions, alColumns, ds);
    ...
    protected void gvContactType_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            {
                if (!IsValidContactType(ddlManagementType.SelectedValue
                                    , ((UserControlQuick)e.Item.FindControl("ucOtherExpense")).SelectedQuick
                ...
                PhoenixOwnerBudgetRegisters.OtherExpensesInsert(int.Parse(ddlManagementType.SelectedValue)
                                                , int.Parse(((UserControlQuick)e.Item.FindControl("ucOtherExpense")).SelectedQuick)
            ...
            {
                if (!IsValidContactType(ddlManagementType.SelectedValue
                                    , ((RadLabel)e.Item.FindControl("lblOtherExpense")).Text
                ...
                PhoenixOwnerBudgetRegisters.OtherExpensesUpdate(new Guid(((RadLabel)e.Item.FindControl("lblOtherExpensesId")).Text.ToString())
            ...
            {
                PhoenixOwnerBudgetRegisters.PortOfRotationDelete(new Guid(((RadLabel)e.Item.FindControl("lblOtherExpensesId")).Text.ToString()));
            }
            BindData();
    ...
    protected void gvContactType_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridFooterItem)
        {
            ...
            UserControlQuick ucOtherExpense = (UserControlQuick)e.Item.FindControl("ucOtherExpense");
            if (ucOtherExpense != null)
            {
                ucOtherExpense.QuickTypeCode = "116";
                ucOtherExpense.bind();
            }
        }
    ...
    private bool IsValidContactType(string managementtype, string expense, string amount, string frequency)
    {
        ucError.HeaderMessage = "Please provide the following required information";

        if (General.GetNullableInteger(managementtype) == null)
