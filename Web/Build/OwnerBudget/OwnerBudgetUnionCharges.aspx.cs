...
public partial class OwnerBudgetUnionCharges : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../OwnerBudget/OwnerBudgetUnionCharges.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDUNIONCHARGESNAME", "FLDAMOUNT", "FREQUENCY" };
        ...
        ds = PhoenixOwnerBudgetRegisters.UnionChargesSearch(General.GetNullableInteger(ucUnion.SelectedAddress)
                       , null
                       , 1
                       , iRowCount
                       , ref iRowCount
        ...
        Response.Write("<td><h3>Union</h3></td>");
    ...
    private void BindData()
    {
        ...
        General.SetPrintOptions("gvContactType", "Union", alCaptions, alColumns, ds);
    ...
    protected void gvContactType_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName.ToUpper().Equals("ADD"))
            {
                ...
                PhoenixOwnerBudgetRegisters.UnionChargesInsert(int.Parse(ucUnion.SelectedAddress)
            ...
            else if (e.CommandName.ToUpper().Equals("UPDATE"))
            {
                ...
                PhoenixOwnerBudgetRegisters.UnionChargesUpdate(new Guid(((RadLabel)e.Item.FindControl("lblAllowanceId")).Text.ToString())
            ...
            {
                PhoenixOwnerBudgetRegisters.unionChargesDelete(new Guid(((RadLabel)e.Item.FindControl("lblAllowanceId")).Text.ToString()));
            }
            BindData();
