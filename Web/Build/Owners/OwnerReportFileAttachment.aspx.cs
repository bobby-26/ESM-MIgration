...
public partial class OwnerReportFileAttachment : PhoenixBasePage
{
        ...
        if (CommandName.ToString().ToUpper() == cmdname)
        {
            ...
            if (!string.IsNullOrEmpty(attachmentcode))
            {
                ...
                try
                {
                    ...
                    if (Request.QueryString["mod"].ToString() == "OFFSHORE" && (type.ToUpper() == "CONTRACT"))
                    {
    ...
    private void BindEditData()
    {
        ...
        {
            string src = "../common/download.aspx?dtkey=" + ds.Tables[0].Rows[0]["FLDDTKEY"].ToString();
    ...
    private void BindData()
    {
        ...
        {
            gvAttachment.Columns[6].Visible = false;
        }
