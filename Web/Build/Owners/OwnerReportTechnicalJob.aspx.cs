...
public partial class OwnerReportTechnicalJob : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbarmain.AddFontAwesomeButton("../Owners/OwnerReportTechnicalJob.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
            ...
            {
                MenuWorkOrder.Visible = false;
                menuWorkorderCreate.Visible = false;
            }
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            DataTable dt = PhoenixOwnerReportPMS.PMSJobSearch(ViewState["CODE"].ToString()
    ...
    protected void gvWorkOrder_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        try
        {
            ...
            if (General.GetNullableString(Filter.SelectedOwnersReportLockedYN.ToString()).Equals("1"))
            {
                gvWorkOrder.Columns[11].Visible = false;
            }
