<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnerReportUserGroupMeasureRights.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="OwnerReportUserGroupMeasureRights" %>
            ...
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
              <table width="80%">
                <tr>
                    ...
                    <td>
                        <telerik:RadLabel ID="lblModule" runat="server" Text="Panel"></telerik:RadLabel>
                    </td>
                    <td>
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Measure Name">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lblMeasureCode" ToolTip="measurecode" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMEASUREID") %>'></telerik:RadLabel>                                                            
                            </ItemTemplate>
