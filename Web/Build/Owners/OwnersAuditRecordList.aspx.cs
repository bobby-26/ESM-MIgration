...
public partial class OwnersAuditRecordList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Owners/OwnersAuditRecordList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        DataSet ds = PhoenixOwnerReportQuality.AuditInspectionShipSearch((General.GetNullableInteger(Filter.SelectedOwnersReportVessel))
    ...
    private void BindData()
    {
        ...
        {
            gvAuditRecordList.Columns[16].Visible = false;
        }
    }
