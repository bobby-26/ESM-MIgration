...
public partial class OwnersInspectionDeficiencyList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddFontAwesomeButton("../Owners/OwnersInspectionDeficiencyList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            ds = PhoenixOwnerReportQuality.DeficiencyShipSearch
    ...
    private void BindData()
    {
        try
        {
            ...
            {
                gvDeficiency.Columns[13].Visible = false;
            }
