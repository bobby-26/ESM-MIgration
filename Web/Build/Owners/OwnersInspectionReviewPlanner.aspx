<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersInspectionReviewPlanner.aspx.cs" Inherits="OwnersInspectionReviewPlanner" %>
    ...
    <form id="frmReviewPlanner" runat="server">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvPlanner" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowPaging="true" AllowCustomPaging="true" 
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Vessel" HeaderStyle-HorizontalAlign="Left" Visible="false" >
                    ...
                    <telerik:GridTemplateColumn HeaderText="M/C" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="35px" >
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left"  HeaderText="Audit/Inspection">
                        <ItemStyle Wrap="false" HorizontalAlign="Left"></ItemStyle>
                        <HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left"  HeaderText="Category" Visible="false">
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left"  HeaderText="Last Done">
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left"  HeaderText="Due">
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left"  HeaderText="Planned">
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <HeaderTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left"  HeaderText="From" ColumnGroupName="FromToPort">
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left"  HeaderText="To" ColumnGroupName="FromToPort">
                        <ItemStyle Wrap="False" HorizontalAlign="Left" ></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left" HeaderText="Attending Supt">
                        <ItemStyle Wrap="False" HorizontalAlign="Left" ></ItemStyle>
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblInspector" runat="server"  Text='<%# DataBinder.Eval(Container,"DataItem.FLDATTENDINGSUPT").ToString() %>'></telerik:RadLabel>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left"  HeaderText="External Auditor">
                        <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="97px" Visible="false" HeaderText="Organization">
                        <ItemStyle Wrap="true" HorizontalAlign="Left" ></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-HorizontalAlign="Left"  HeaderText="Status">
                        <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
        ...
        <table cellpadding="1" cellspacing="1">
            <tr>
                ...
                <tr>--%>
                <td>
                    <telerik:RadLabel ID="lblManualConfiguration" runat="server" Text=" * M - Manual * C - Configuration"></telerik:RadLabel>
                </td>
            </tr>
        </table>
