...
public partial class OwnersInspectionReviewPlanner : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Owners/OwnersInspectionReviewPlanner.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixOwnerReportQuality.ShipAuditPlannerSearch(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)                     
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixOwnerReportQuality.ShipAuditPlannerSearch(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)                       
                      , General.GetNullableString(ViewState["STATUS"].ToString())
                      , sortexpression
                      , sortdirection
        ...
        {
            gvPlanner.Columns[14].Visible = false;
        }
    }
