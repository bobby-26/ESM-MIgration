...
public partial class OwnersInspectionSIREPlanner : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Owners/OwnersInspectionSIREPlanner.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixOwnerReportQuality.VettingSearch(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixOwnerReportQuality.VettingSearch(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)
                      , General.GetNullableString(ViewState["STATUS"].ToString())
                      , sortexpression
                      , sortdirection
        ...
        {
            gvScheduleForCompany.Columns[15].Visible = false;
        }
    }
    ...
    protected void gvScheduleForCompany_ItemDataBound(object sender, GridItemEventArgs e)
    {
        try
        {
            ...
            if (e.Item is GridDataItem)
            {
                ...
                {
                    lblDueDate.Attributes["style"] = "color:#00FF00 !important";
                ...
                {
                    lblDueDate.Attributes["style"] = "color:#FFFF00 !important";
                    lblDueDate.Font.Bold = true;
                ...
                {
                    lblDueDate.Attributes["style"] = "color:#FF0000 !important";
                    lblDueDate.Font.Bold = true;
