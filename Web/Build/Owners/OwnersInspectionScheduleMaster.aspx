<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersInspectionScheduleMaster.aspx.cs" Inherits="OwnersInspectionScheduleMaster" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("gvInspectionSchedule").height(browserHeight - 90);
            });
...
<body>
    <form id="frmInspectionScheduleMaster" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvInspectionSchedule" runat="server" AutoGenerateColumns="False" AllowPaging="true" AllowCustomPaging="true"
            Font-Size="11px" Width="100%" Height="90%" CellPadding="3" OnItemCommand="gvInspectionSchedule_ItemCommand" OnItemDataBound="gvInspectionSchedule_ItemDataBound"
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    <telerik:GridTemplateColumn HeaderText="Vessel" Visible="false" HeaderStyle-Width="96px" AllowSorting="true" SortExpression="FLDVESSELNAME" ShowSortIcon="true">
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="70px" HeaderText="Total" ColumnGroupName="DeficiencyCount" HeaderStyle-HorizontalAlign="Center">
                        <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderStyle-Width="40px" HeaderText="HR OBS" ColumnGroupName="DeficiencyCount" HeaderStyle-HorizontalAlign="Center">
                        <ItemStyle Wrap="False" HorizontalAlign="Center" Width="60px"></ItemStyle>
                        <ItemTemplate>
