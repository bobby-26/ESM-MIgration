...
public partial class OwnersInspectionScheduleMaster : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Owners/OwnersInspectionScheduleMaster.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        DataSet ds = PhoenixOwnerReportQuality.ScheduleSearch(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)
    ...
    private void BindData()
    {
        ...
        {
            gvInspectionSchedule.Columns[15].Visible = false;
        }
    }
