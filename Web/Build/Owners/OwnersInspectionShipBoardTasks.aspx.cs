...
public partial class OwnersInspectionShipBoardTasks : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddFontAwesomeButton("../Owners/OwnersInspectionShipBoardTasks.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    private void BindData()
    {
        ...
        {
            ds = ds = PhoenixOwnerReportQuality.CorrectiveTaskList(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)
        ...
        {
            ds = ds = PhoenixOwnerReportQuality.PreventiveTaskList(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)
                                                                , General.GetNullableString(ViewState["STATUS"].ToString())
                                                                           , Int32.Parse(ViewState["PAGENUMBER"].ToString())
                                                                           , gvShipBoardTasks.PageSize
                                                                           , ref iRowCount
        ...
        {
            ds = ds = PhoenixOwnerReportQuality.VIRTaskList(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)
                                                                , General.GetNullableString(ViewState["STATUS"].ToString())
                                                                , Int32.Parse(ViewState["PAGENUMBER"].ToString())
                                                                , gvShipBoardTasks.PageSize
                                                                , ref iRowCount
    ...
    protected void ShowExcel()
    {
        ...
        if (ViewState["TASK"].ToString().Equals("CAR"))
        {
            ds = PhoenixOwnerReportQuality.CorrectiveTaskList(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)
                                                                , General.GetNullableString(ViewState["STATUS"].ToString())
                                                                 , Int32.Parse(ViewState["PAGENUMBER"].ToString())
                                                                 , gvShipBoardTasks.PageSize
                                                                 , ref iRowCount
        ...
        if (ViewState["TASK"].ToString().Equals("PAR"))
        {
            ds = PhoenixOwnerReportQuality.PreventiveTaskList(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)
                                                                , General.GetNullableString(ViewState["STATUS"].ToString())
                                                                               , Int32.Parse(ViewState["PAGENUMBER"].ToString())
                                                                               , gvShipBoardTasks.PageSize
                                                                               , ref iRowCount
        ...
        if (ViewState["TASK"].ToString().Equals("VIR"))
        {
            ds = PhoenixOwnerReportQuality.VIRTaskList(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)
                                                                , General.GetNullableString(ViewState["STATUS"].ToString())
                                                                , Int32.Parse(ViewState["PAGENUMBER"].ToString())
                                                                , gvShipBoardTasks.PageSize
                                                                , ref iRowCount
