...
public partial class Owners_OwnersMonthlyReportAuditList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../Owners/OwnersMonthlyReportAuditList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            // toolbar.AddFontAwesomeButton("../Owners/OwnersReportAuditInspection.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        ...
        {
            alColumns = new string[]{  "FLDREFERENCENUMBER",  "FLDSHORTCODE", "FLDCOMPLETIONDATE",
            ...
            alCaptions = new string[]{  "Reference Number", "Audit / Inspection", "Last Done",
        ...
        if (PhoenixSecurityContext.CurrentSecurityContext.DatabaseCode.ToUpper().Equals("OFFSHORE"))
        {
            gvAuditRecordList.Columns[4].Visible = false;
            gvAuditRecordList.Columns[9].Visible = false;
        }
        ...
        DataTable dt = PhoenixOwnerReportQuality.OwnersReportAuditSummary(PhoenixSecurityContext.CurrentSecurityContext.VesselID, General.GetNullableDateTime(Filter.SelectedOwnersReportDate));
    ...
    private void BindData()
    {
        ...
        General.SetPrintOptions("gvAuditRecordList", "Audit / Inspection", alCaptions, alColumns, ds);
    }
