<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersMonthlyReportNRRAView.aspx.cs" Inherits="OwnersMonthlyReportNRRAView" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvRiskAssessment" runat="server" AllowCustomPaging="false" AllowSorting="true" AllowPaging="false" AllowMultiRowSelection="true" AllowFilteringByColumn="true" FilterType="CheckList"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Vessel" HeaderStyle-Width="12%" ShowFilterIcon="false" UniqueName="FLDVESSELID" DataField="FLDVESSELID" Visible="false">
                            <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                            <FilterTemplate>
