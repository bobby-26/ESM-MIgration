<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersMonthlyReportPMSMaintananceDoneView.aspx.cs" Inherits="OwnersMonthlyReportPMSMaintananceDoneView" %>
...
<body onresize="Resize()" onload="Resize()">
    <form id="frmWorkOrderReportList" runat="server" autocomplete="off">
        ...
        <telerik:RadGrid  ID="RadGrid1" runat="server" AllowCustomPaging="false" AllowSorting="false" AllowPaging="false" Width="100%"
            ...
            OnItemCommand="RadGrid1_ItemCommand" OnItemDataBound="RadGrid1_ItemDataBound" AllowFilteringByColumn="true" EnableLinqExpressions="false">
