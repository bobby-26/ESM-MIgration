<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersMonthlyReportPMSPostponedJobView.aspx.cs" Inherits="OwnersMonthlyReportPMSPostponedJobView" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="radCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvPostponementJob.ClientID %>"));
                }, 200);
           }
        </script> 
                ...
                <tr>
                    <td style="width: 100%;">
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvPostponementJob" runat="server" GridLines="None" OnNeedDataSource="gvPostponementJob_NeedDataSource"
                           AutoGenerateColumns="false" OnItemDataBound="gvPostponementJob_ItemDataBound"
