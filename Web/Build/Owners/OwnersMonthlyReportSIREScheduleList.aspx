<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersMonthlyReportSIREScheduleList.aspx.cs" Inherits="OwnersMonthlyReportSIREScheduleList" %>
...
<head id="Head1" runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvScheduleForCompany.ClientID %>"));
                }, 200);
            }
...
<body>
    <form id="frmInspectionScheduleByCompany" runat="server">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvScheduleForCompany" runat="server" AutoGenerateColumns="False" EnableViewState="true"
            Font-Size="11px" Width="100%" CellPadding="3" OnItemCommand="gvScheduleForCompany_ItemCommand" OnNeedDataSource="gvScheduleForCompany_NeedDataSource"
            OnItemDataBound="gvScheduleForCompany_ItemDataBound" ShowFooter="false" ShowHeader="true"
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Type" HeaderStyle-Width="8%">
                    ...
                    <telerik:GridTemplateColumn HeaderText="Due" HeaderStyle-Width="8%">
                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="8%"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Planned" HeaderStyle-Width="8%">
                        <ItemStyle Wrap="False" HorizontalAlign="Left" Width="8%"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Active" HeaderStyle-Width="5%">
