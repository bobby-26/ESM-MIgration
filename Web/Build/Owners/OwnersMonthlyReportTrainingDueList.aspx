<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersMonthlyReportTrainingDueList.aspx.cs" Inherits="Owners_OwnersMonthlyReportTrainingDueList" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvTrainingDue.ClientID %>"));
               }, 200);
           }
