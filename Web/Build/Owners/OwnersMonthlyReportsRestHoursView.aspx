<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersMonthlyReportsRestHoursView.aspx.cs" Inherits="Owners_OwnersMonthlyReportsRestHoursView" %>
    ...
    <form id="frmNonComplianceSummary" runat="server">
        ...
        <telerik:RadGrid ID="gvNC" runat="server" AutoGenerateColumns="False" Font-Size="11px" GridLines="None" Width="100%"
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    <telerik:GridTemplateColumn HeaderText="No" HeaderStyle-CssClass="white">
