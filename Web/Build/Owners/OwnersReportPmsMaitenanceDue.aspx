<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersReportPmsMaitenanceDue.aspx.cs" Inherits="OwnersReportPmsMaitenanceDue" %>
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="" AllowSorting="false" UniqueName="FLDISCRITICAL"
                        ShowSortIcon="false" FilterControlWidth="50px" AutoPostBackOnFilter="false" ShowFilterIcon="false" >
                        ...
                        <FilterTemplate>
                            ...
                            <br />
                            <telerik:RadLabel ID="lblFIsCritial" runat="server" Text="Is Critical" ToolTip="Is Critical" AssociatedControlID="chkIsCritical"></telerik:RadLabel>                            
                        </FilterTemplate>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Due On" UniqueName="FLDDUEDATE" SortExpression="FLDDUEDATE"
                        AllowSorting="true" FilterDelay="2000" AutoPostBackOnFilter="false" CurrentFilterFunction="Between">
                        <FilterTemplate>
                            <telerik:RadComboBox ID="ddlDueDays" runat="server" Width="80px" SelectedValue='<%# GetFilter("DUE") %>'
                    ...
                    <telerik:GridTemplateColumn HeaderText="Status" UniqueName="FLDWORKORDERSTATUS" AllowSorting="false" 
                     ...
                     <telerik:GridTemplateColumn HeaderText="" UniqueName="FLDDEFECT" SortExpression="FLDDEFECT"
                        AllowSorting="true" FilterDelay="2000" AutoPostBackOnFilter="false" CurrentFilterFunction="EqualTo">
                        <FilterTemplate>
                            <telerik:RadComboBox ID="ddlDefect" runat="server" Width="60px" SelectedValue='<%# GetFilter("chkDefect") %>'
                    ...
                    <telerik:GridTemplateColumn HeaderText="Work Order No." UniqueName="FLDISJOBPLANNED" AllowSorting="false" AllowFiltering="true" ShowFilterIcon="false">
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <FilterTemplate>
