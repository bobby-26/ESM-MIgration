...
public partial class OwnersReportWorkOrderReportList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddFontAwesomeButton("../Owners/OwnersReportWorkOrderReportList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            toolbargrid.AddFontAwesomeButton("../Owners/OwnersReportWorkOrderReportList.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            DataSet ds = PhoenixOwnerReportPMS.OwnersWorkOrderReportLogSearch(General.GetNullableInteger(Filter.SelectedOwnersReportVessel)
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (RA != null)
            {
                RA.Attributes.Add("onclick", "javascript:openNewWindow('Risk Assessment','" + name + "','" + Session["sitepath"] + "/PlannedMaintenance/PlannedMaintenanceWorkOrderRAList.aspx?&WORKORDERID=" + drv["FLDWORKORDERID"] + "&vesselid=" + Filter.SelectedOwnersReportVessel + "',500,600); return false;");
            ...
            {
                cmdReschedule.Attributes.Add("onclick", "javascript:openNewWindow('Postpone','" + name + "','" + Session["sitepath"] + "/PlannedMaintenance/PlannedMaintenanceWorkOrderRescheduleDetail.aspx?LOG=Y&WORKORDERID=" + drv["FLDWORKORDERID"] + "&vesselid=" + Filter.SelectedOwnersReportVessel + "',500,600); return false;");
            ...
            {
                cmdRTemplates.Attributes.Add("onclick", "javascript:openNewWindow('Reporting Templates','" + name + "','" + Session["sitepath"] + "/PlannedMaintenance/PlannedMaintenanceWorkOrderReportLogHistoryTemplate.aspx?&WORKORDERID=" + drv["FLDWORKORDERID"] + "&vesselid=" + Filter.SelectedOwnersReportVessel + "',500,600); return false;");

            }
            LinkButton cmdParts = (LinkButton)e.Item.FindControl("cmdParts");
            if (cmdParts != null)
            {
                cmdParts.Attributes.Add("onclick", "javascript:openNewWindow('Parts','" + name + "','" + Session["sitepath"] + "/PlannedMaintenance/PlannedMaintenanceWorkOrderReportLogUsesParts.aspx?&WORKORDERID=" + drv["FLDWORKORDERID"] + "&vesselid=" + Filter.SelectedOwnersReportVessel + "',500,600); return false;");
            ...
            if (waive != null)
            {
                if (drv["FLDISWAIVED"].ToString() == "1")
                    waive.Attributes.Add("onclick", "javascript:openNewWindow('WAIVE','" + name + "','" + Session["sitepath"] + "/PlannedMaintenance/PlannedMaintenanceWorkOrderLogWaiver.aspx?WORKORDERID=" + drv["FLDWORKORDERID"].ToString() + "&vesselid=" + Filter.SelectedOwnersReportVessel + "','','1200','600');return false");
                else
                    waive.Visible = false;
            }
        }
