...
public partial class OwnersSOAWithSupportingsVoucher : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (SessionUtil.CanAccess(this.ViewState, "Excel"))
                toolbargrid.AddFontAwesomeButton("../Owners/OwnersSOAWithSupportingsVoucher.aspx", "Export to Excel", "<i class=\"fa fa-file-excel\"></i>", "Excel");
    ...
    private void BindData()
    {
        ...
        ds = PhoenixOwnersStatementOfAccounts.StatementOfAccountVoucherListOwnerBudget(ViewState["debitnotereference"].ToString(),
            int.Parse(ViewState["Ownerid"].ToString()), General.GetNullableGuid(ViewState["ownerbudgetid"].ToString()),
