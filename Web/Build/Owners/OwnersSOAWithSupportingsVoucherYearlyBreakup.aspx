<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersSOAWithSupportingsVoucherYearlyBreakup.aspx.cs" Inherits="OwnersSOAWithSupportingsVoucherYearlyBreakup" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="94%">
            ...
            <div style="width: 50%; height: 100%; float: left;">
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvOwnersAccount" Height="85%" runat="server" AllowCustomPaging="false" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" OnItemCommand="gvOwnersAccount_ItemCommand" OnItemDataBound="gvOwnersAccount_ItemDataBound" EnableViewState="false"
                    ShowFooter="false" ShowHeader="true" OnNeedDataSource="gvOwnersAccount_NeedDataSource" OnItemCreated="gvOwnersAccount_ItemCreated"
                     OnColumnCreated="gvOwnersAccount_ColumnCreated">
                    <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                    <MasterTableView EditMode="InPlace" ShowGroupFooter="true" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        AutoGenerateColumns="false">
                        <HeaderStyle Width="102px" />
                        <GroupByExpressions>
                            <telerik:GridGroupByExpression>
                                    <SelectFields>
                                    <telerik:GridGroupByField FieldName="FLDESMBUDGETCODE"  HeaderText="Budget Code" SortOrder="Ascending" />
                                </SelectFields>
                                <GroupByFields>
                                    <telerik:GridGroupByField FieldName="FLDESMBUDGETCODE" SortOrder="Ascending" />
                                </GroupByFields>
                            </telerik:GridGroupByExpression>
                        </GroupByExpressions>
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Budget Code" Visible="false">
                                ...
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblBudgetCode" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDESMBUDGETCODE") %>'></telerik:RadLabel>
                                </ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Amount(USD)" Aggregate="Sum" DataField="FLDAMOUNT" FooterText=" ">
            ...
            <div style="width: 50%; height: 100%; float: left;">
                <table>
                    ...
                    <tr>
                        <td>
                            <b>
                                <telerik:RadLabel ID="lblBudgetCodeTotal" runat="server" Text="Budget Group Total"></telerik:RadLabel>
                            </b>
                        </td>
                        <td>
                            <b>
