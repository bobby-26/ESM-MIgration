<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OwnersWorkOrderReportList.aspx.cs" Inherits="OwnersWorkOrderReportList" %>
...
<body onresize="Resize()" onload="Resize()">
    <form id="frmWorkOrderReportList" runat="server" submitdisabledcontrols="true" autocomplete="off">
        ...
        <telerik:RadGrid  ID="RadGrid1" runat="server" AllowCustomPaging="true" AllowSorting="false" AllowPaging="false" Width="100%"
