...
public partial class PlannedMaintenanceCompJobMainSummaryAdminList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddFontAwesomeButton("../PlannedMaintenance/PlannedMaintenanceCompJobMainSummaryAdminList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    protected void gvWorkOrder_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (pub != null)
            {
                pub.Attributes.Add("onclick", "javascript: openNewWindow('codehelp1', '', 'PlannedMaintenance/PlannedMaintenanceCompJobMainSummaryPublish.aspx?JOBSUMMARYID=" + drv["FLDCOMPJOBSUMMARYID"].ToString() + "',false,500,300);");
