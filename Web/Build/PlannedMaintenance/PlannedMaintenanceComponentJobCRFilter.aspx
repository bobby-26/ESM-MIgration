<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceComponentJobCRFilter.aspx.cs"
    Inherits="PlannedMaintenanceComponentJobCRFilter" %>
    ...
    <form id="frmComponentJobFilter" runat="server" autocomplete="off">
        ...
        <table cellpadding="1" cellspacing="1" width="100%">
            <tr>
                ...
                <td>
                    <telerik:RadTextBox ID="txtCompNumber" runat="server" CssClass="input" Width="180px"></telerik:RadTextBox>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadTextBox ID="txtJobcode" runat="server" CssClass="input" Width="180px"></telerik:RadTextBox>
                </td>
            </tr>
            <tr>
                <td>
