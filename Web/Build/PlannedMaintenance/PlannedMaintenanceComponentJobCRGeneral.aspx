<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceComponentJobCRGeneral.aspx.cs"
    ...
    <form id="frmPMSComponentJob" runat="server" autocomplete="off">
        ...
        <table width="100%" cellpadding="1" cellspacing="1">
                ...
                <td colspan="3">
                    <span id="spnPickCompJob">
                        <telerik:RadTextBox ID="txtCompJobCode" runat="server" CssClass="input_mandatory"
                            MaxLength="20" ReadOnly="false" Width="60px">
                        </telerik:RadTextBox>
                        <telerik:RadTextBox ID="txtCompJobName" runat="server" CssClass="input_mandatory"
                            MaxLength="200" ReadOnly="false" Width="210px">
                        </telerik:RadTextBox>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="ddlChangeReqType" CssClass="input_mandatory" runat="server">
                        <Items>
                            <telerik:RadComboBoxItem Text="--Select--" Value=""></telerik:RadComboBoxItem>
                            <telerik:RadComboBoxItem Text="Update" Value="1"></telerik:RadComboBoxItem>
                            <telerik:RadComboBoxItem Text="Delete" Value="2"></telerik:RadComboBoxItem>
                        </Items>
                    </telerik:RadComboBox>
                </td>
                <td>
