<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceComponentJobGeneralOffice.aspx.cs"
    Inherits="PlannedMaintenanceComponentJobGeneralOffice" %>
            ...
            <table width="100%" cellpadding="1" cellspacing="1">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:ImageButton ID="cmdClear" runat="server" ImageUrl="<%$ PhoenixTheme:images/clear.png %>"
                            ImageAlign="AbsMiddle" Text=".." ToolTip="Clear" OnClick="cmdClear_Click" />
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtFrequency" MaxLength="3" IsInteger="true" InputType="Number"
                            Width="70px" OnTextChanged="LastDoneDateCalculation" AutoPostBack="true">
                        </telerik:RadTextBox>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <%--<eluc:Date runat="server" ID="txtlastDoneDate" CssClass="input" OnTextChanged="LastDoneDateCalculation" AutoPostBack="True" />--%>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <telerik:RadTextBox runat="server" ID="ucCounterFrequency" CssClass="input" MaxLength="6"
                            IsInteger="true" Width="60px" AutoPostBack="true" OnTextChanged="ucCounterFrequency_TextChanged">
                        </telerik:RadTextBox>
