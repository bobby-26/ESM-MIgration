<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceComponentJobParameter.aspx.cs" Inherits="PlannedMaintenance_PlannedMaintenanceComponentJobParameter" %>
            ...
            <telerik:RadGrid ID="gvJobParameter" runat="server" Height="90%" OnItemDataBound="gvJobParameter_ItemDataBound"
                ...
                <MasterTableView EditMode="InPlace" AutoGenerateColumns="false" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" DataKeyNames="FLDMAPPINGID">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Min" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <%# ((DataRowView)Container.DataItem)["FLDMINVALUE"] %>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Max" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate>
