<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceComponentTypeJob.aspx.cs"
    Inherits="PlannedMaintenanceComponentTypeJob" %>
...
<head id="Head1" runat="server">
    <title>ComponentType</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <div style="top: 100px; margin-left: auto; margin-right: auto; width: 100%;">
                <div style="top: 100px; margin-left: auto; margin-right: auto; vertical-align: middle;">
                    ...
                    <div class="subHeader" style="position: relative; right: 0px">
                        <eluc:Title runat="server" ID="Title1" Text="Jobs" ShowMenu="<%# Title1.ShowMenu %>">
                        </eluc:Title>
                        <asp:Button ID="cmdHiddenSubmit" runat="server" Text="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" />
                    </div>
                    <div class="navSelect" style="width: auto; float: right; margin-top: -26px">
                        <eluc:TabStrip ID="MenuComponentTypeJob" runat="server" OnTabStripCommand="MenuComponentTypeJob_TabStripCommand"
                    ...
                    <asp:GridView ID="gvComponentTypeJob" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <HeaderTemplate>
                                    <asp:LinkButton ID="lblFunctionNumberHeader" runat="server" CommandName="Sort" CommandArgument="FLDJOBCODE"
                                        ForeColor="White">Job Code</asp:LinkButton>
                                    <img id="FLDJOBCODE" runat="server" visible="false" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblFunctionNumber" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDJOBCODE") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField >
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
