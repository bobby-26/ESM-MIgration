<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceCounterLogFilter.aspx.cs"
    Inherits="PlannedMaintenanceCounterLogFilter" %>
...
<body>
    ...
    <div class="subHeader" style="position: relative">
        <div id="divHeading" style="vertical-align: top">
            <asp:Label runat="server" ID="lblCaption" Font-Bold="true" Text="Counter Log Filter"></asp:Label>
        </div>
    </div>
