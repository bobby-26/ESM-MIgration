...
public partial class PlannedMaintenanceDefectLinkJobs : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbarmain.AddFontAwesomeButton("../PlannedMaintenance/PlannedMaintenanceDefectLinkJobs.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
