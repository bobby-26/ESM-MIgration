<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceDefectListRegister.aspx.cs"
    Inherits="PlannedMaintenanceDefectListRegister" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <telerik:RadGrid ID="gvDefectList" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Defect No">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lblStatusCode" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSTATUSCODE")%>'></telerik:RadLabel>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Completion Date">
                            ...
                            <HeaderStyle HorizontalAlign="Left" Width="70px" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblCompletionDate" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDONEDATE","{0:dd/MM/yyyy}") %>' ></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="VIQ Code">
                            <ItemStyle HorizontalAlign="Left" Width="70px" />
                            <HeaderStyle HorizontalAlign="Left" Width="70px" />
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblVIQCode" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDVIQCODE") %>' ></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn UniqueName="Action" HeaderText="Action" AllowFiltering="false">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:ImageButton runat="server" AlternateText="Delete" ImageUrl="<%$ PhoenixTheme:images/te_del.png %>"
                                    CommandName="DELETE" ID="cmdDelete" ToolTip="Delete" Visible="false"></asp:ImageButton>
                ...
                <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="true" ReorderColumnsOnClient="true" AllowColumnHide="true"
                    EnablePostBackOnRowClick="false" ColumnsReorderMethod="Reorder">
