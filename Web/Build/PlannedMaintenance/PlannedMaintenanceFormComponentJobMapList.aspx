<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceFormComponentJobMapList.aspx.cs"
    Inherits="PlannedMaintenance_PlannedMaintenanceFormComponentJobMapList" %>
    ...
    <form id="frmComponentJob" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel1">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="RadGrid1" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" OnNeedDataSource="RadGrid1_NeedDataSource" OnPreRender="RadGrid1_PreRender" EnableHeaderContextMenu="true" GroupingEnabled="false"
