<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceGlobalRoutineWorkorderEdit.aspx.cs" Inherits="PlannedMaintenanceGlobalRoutineWorkorderEdit" %>
...
<head runat="server">
   <title>Global Routine Workorder Edit</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWorkOrderEdit" runat="server" OnTabStripCommand="MenuWorkOrderEdit_TabStripCommand" TabStrip="true"></eluc:TabStrip>
