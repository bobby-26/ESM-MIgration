<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceHistoryTemplateListAdd.aspx.cs" Inherits="PlannedMaintenanceHistoryTemplateListAdd" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvHistoryTemplateList" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" Width="100%"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                      ...
                      <%--  <telerik:GridTemplateColumn HeaderText="Include Yes/NO">
                            ...
                            <ItemTemplate>
                                <center>
                                    <telerik:RadCheckBox ID="chkVerified" runat="server" Checked='<%# DataBinder.Eval(Container, "DataItem.FLDVERIFIEDYN").ToString() == "1" ? true:false%>'
                                        Enabled="false"></telerik:RadCheckBox>
                                </center>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <center>
                    ...
                    <telerik:GridTemplateColumn>
                            ...
                            <HeaderTemplate>
                                <telerik:RadCheckBox ID="chkAllForm" runat="server" Text="" AutoPostBack="false"  />
                            </HeaderTemplate>
                            <ItemTemplate>
                             <telerik:RadCheckBox ID="chkSelect" runat="server" Checked='<%# DataBinder.Eval(Container, "DataItem.FLDVERIFIEDYN").ToString() == "1" ? true:false%>'
                                        Enabled="true" AutoPostBack="false"></telerik:RadCheckBox>
                                        </ItemTemplate>
                            <%--<ItemTemplate>
                                <telerik:RadCheckBox ID="chkSelect" runat="server" EnableViewState="true" />
                            </ItemTemplate>--%>
                        </telerik:GridTemplateColumn>
