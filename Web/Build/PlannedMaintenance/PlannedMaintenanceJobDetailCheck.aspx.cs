...
public partial class PlannedMaintenanceJobDetailCheck : PhoenixBasePage
{
        ...
        try
        {
            ...
            if ((Request.QueryString["JOBID"] != null) && (Request.QueryString["JOBID"] != ""))
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    txtJobDetail.Content = dr["FLDJOBDETAILCHECK"].ToString();
    ...
    protected void MenuJobDetail_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                if ((Request.QueryString["JOBID"] != null) && (Request.QueryString["JOBID"] != ""))
                {
                    PhoenixPlannedMaintenanceJob.UpdateJobDetailCheck
                    (
                    ...
                    ucStatus.Text = "Detail of checks Saved.";
