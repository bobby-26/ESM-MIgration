<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceOverDueJobMonthWiseChart.aspx.cs"
    Inherits="PlannedMaintenanceOverDueJobMonthWiseChart" %>
        ...
        <div style="width: 100%; border: 1px; background-color: #1c84c6;">
            <table style="width: 50%; color: #ffffff; font: 11px Helvetica, Arial, sans-serif; font-size: 11px; font-weight: bold">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlVessel" runat="server" DataTextField="FLDVESSELNAME" DataValueField="FLDVESSELID"
                            AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    <td>
                    ...
                    <td>
                        <asp:TextBox size="10" ID="txtFromDate" runat="server" AutoPostBack="true" Visible="true" Style="width: 110px;"></asp:TextBox>
                    ...
                    <td>
                        <asp:TextBox size="10" ID="txtToDate" runat="server" AutoPostBack="true" Visible="true" Style="width: 110px;"></asp:TextBox>
