<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceRescheduleFilter.aspx.cs"
    Inherits="PlannedMaintenanceRescheduleFilter" %>
...
<body>
    <form id="frmMaintenanceRescheduleFilter" runat="server" autocomplete="off">
    ...
    <div class="subHeader" style="position: relative">
        <div id="div2" style="vertical-align: top">
            <eluc:Title runat="server" ID="Title1" Text="Reschedule Filter" ShowMenu="True">
            </eluc:Title>
        </div>
    </div>
    <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
        <eluc:TabStrip ID="MenuMaintenanceRescheduleFilter" runat="server" 
 OnTabStripCommand="MenuMaintenanceRescheduleFilter_TabStripCommand">
        </eluc:TabStrip>
    </div>  
            ...
            <table cellpadding="1" cellspacing="1" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Literal ID="lblUnplannedWork" runat="server" Text="Maintenance Cause"></asp:Literal>
                    </td>
                    <td>
