<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceStockItemWithLocation.aspx.cs" Inherits="PlannedMaintenanceStockItemWithLocation" %>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvStockItem" runat="server" Height="80%" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Stock Item Name" AllowSorting="true" SortExpression="FLDNAME">
                            <HeaderStyle Width="22%" />
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Loctaion" AllowSorting="true" SortExpression="FLDLOCATIONNAME">
                            <HeaderStyle Width="10%" />
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Maker's Reference" AllowSorting="true" SortExpression="FLDMAKERREFERENCE">
                            <HeaderStyle Width="22%" />
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Drawing No." AllowSorting="true" SortExpression="FLDDRAWINGNUMBER">
                            <HeaderStyle Width="22%" />
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="ROB" AllowSorting="true" SortExpression="FLDQUANTITY">
                            <HeaderStyle Width="22%" />
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <ItemTemplate>
