<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceVesselWiseSurveyCertificateDetails.aspx.cs"
    Inherits="PlannedMaintenance_PlannedMaintenanceVesselWiseSurveyCertificateDetails" %>
    ...
    <form id="frmRegistersSurvey" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
            ...
            <telerik:RadGrid ID="gvSurvey" runat="server" AutoGenerateColumns="False" OnItemDataBound="gvSurvey_ItemDataBound"
                Width="100%"  ShowHeader="true" OnNeedDataSource="gvSurvey_NeedDataSource" AllowCustomPaging="true"
