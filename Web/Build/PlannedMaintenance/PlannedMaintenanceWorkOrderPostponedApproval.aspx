<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceWorkOrderPostponedApproval.aspx.cs" Inherits="PlannedMaintenanceWorkOrderPostponedApproval" %>
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Component">
                        ...
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblComponentNumber" runat="server" Text='<%#((DataRowView)Container.DataItem)["FLDCOMPONENTNUMBER"] + " " + ((DataRowView)Container.DataItem)["FLDCOMPONENTNAME"]%>'
                                ToolTip='<%#((DataRowView)Container.DataItem)["FLDCOMPONENTNUMBER"] + " " + ((DataRowView)Container.DataItem)["FLDCOMPONENTNAME"]%>'></telerik:RadLabel>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>                   
