...
public partial class PlannedMaintenanceWorkOrderReport : PhoenixBasePage
{
    ...
    protected void MenuWorkOrder_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../PlannedMaintenance/PlannedMaintenanceWorkOrder.aspx?WORKORDERID=" + ViewState["WORKORDERID"], false);
            }
