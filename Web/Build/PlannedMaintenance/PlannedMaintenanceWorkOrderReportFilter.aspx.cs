...
public partial class PlannedMaintenanceWorkOrderReportFilter : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            MenuWorkOrderReportFilter.MenuList = toolbarmain.Show();
            if (!IsPostBack)
            {
    ...
    protected void MenuWorkOrderReportFilter_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("GO"))
            {
                ...
                criteria.Add("ucRank", ucDiscipline.SelectedDiscipline);
                ...
                Response.Redirect("../PlannedMaintenance/PlannedMaintenanceWorkOrderReport.aspx",false );
            }
