<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceWorkOrderReportList.aspx.cs" Inherits="PlannedMaintenanceWorkOrderReportList" %>
        ...
        <telerik:RadGrid  ID="RadGrid1" runat="server" AllowCustomPaging="true" AllowSorting="false" AllowPaging="true" Width="100%"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Job Type" UniqueName="FLDJOBDONESTATUS">                       
                        <HeaderStyle Width="70px" />
                        <FilterTemplate>
                            <telerik:RadComboBox ID="ddlJobType" runat="server" Width="100%" SelectedValue='<%# GetFilter("ddlJobType") %>'
                            ...
                            <telerik:RadScriptBlock runat="server">
                                <script type="text/javascript">
                                    function DefectIndexChanged(sender, args) {
                                        var tableView = $find("<%# ((GridItem)Container).OwnerTableView.ClientID %>");
                                        tableView.filter("FLDJOBDONESTATUS", args.get_item().get_value(), "EqualTo");
                                    }
                                </script>
                            </telerik:RadScriptBlock>
                        </FilterTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Done Date" UniqueName="FLDWORKDONEDATE" DataField="FLDWORKDONEDATE">
                       ...
                       <FilterTemplate>                                      
                            From<telerik:RadDatePicker ID="FromOrderDatePicker" runat="server" Width="100px" ClientEvents-OnDateSelected="FromDateSelected"
                                    DbSelectedDate='<%# GetFilter("txtDateFrom") %>' />
                    ...
                    <telerik:GridTemplateColumn HeaderText="Done By" UniqueName="FLDREPORTBY">
                        <HeaderStyle Width="180px" />
                        <ItemStyle Width="180px" />
                        <FilterTemplate>
                             To&nbsp&nbsp&nbsp&nbsp<telerik:RadDatePicker ID="ToOrderDatePicker" runat="server" Width="100px" ClientEvents-OnDateSelected="ToDateSelected"
                                    DbSelectedDate='<%# GetFilter("txtDateTo") %>' />
                        </FilterTemplate>
                        <ItemStyle HorizontalAlign="Center" /><ItemTemplate>
