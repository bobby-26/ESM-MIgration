<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PlannedMaintenanceWorkOrderReportPartsUsed.aspx.cs"
    Inherits="PlannedMaintenanceWorkOrderReportPartsUsed" %>
...
<body>
    <form id="frmgvUsesParts" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="gvUsesParts" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            CellSpacing="0" GridLines="None" OnItemCommand="gvUsesParts_ItemCommand" OnPreRender="gvUsesParts_PreRender" Width="100%" 
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Location">
                        ...
                        <EditItemTemplate>
                            <telerik:RadDropDownList ID="ddlLocation" runat="server" CssClass="input_mandatory" DataTextField="FLDLOCATIONNAME" DataValueField="FLDLOCATIONID" AppendDataBoundItems="true">
