...
public partial class PlannedMaintenaneManualsExplorer : PhoenixBasePage
{ 
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {            
            FileExplorer1.Configuration.ViewPaths = new string[] { PhoenixGeneralSettings.CurrentGeneralSetting.PMSManualsPath };
...
public class CustomFileSystemProvider : FileBrowserContentProvider
{
  ...
  <Mappings>
    <Mapping>
      ...
      <VirtualPath><![CDATA[PMSManuals/]]></VirtualPath>
    </Mapping>    
  </Mappings>
</CustomFileBrowserProvider>".Replace("@physicalpath@", PhoenixGeneralSettings.CurrentGeneralSetting.PMSManualsPath);
