<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PortalDocuments.aspx.cs"
    Inherits="PortalDocuments" %>
        ...
        <tr>
            <td align="left" valign="top">
                &nbsp;&nbsp;<img id="Img1" runat="server" style="vertical-align: top" src="<%$ PhoenixTheme:images/esmlogo4_small.png %>"
                    alt="Phoenix" onclick="showDatabaseChooser();" />&nbsp; &nbsp;&nbsp;<font class="application_title"><asp:Literal
        ...
        <tr>
            <td valign="top" width="50%">
                <asp:Login ID="phoenixLogin" runat="server" CssClass="Loginbox_background" InstructionText="Please enter your User Name and Password to login."
                    ...
                    Width="325px" OnAuthenticate="phoenixLogin_Authenticate" UserNameLabelText="User Name"
                    PasswordLabelText="Password" DisplayRememberMe="false">
