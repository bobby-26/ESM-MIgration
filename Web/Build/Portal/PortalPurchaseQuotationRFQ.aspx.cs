...
public partial class PortalPurchaseQuotationRFQ : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbargrid.AddFontAwesomeButton("../Portal/PortalPurchaseQuotationRFQ.aspx?SESSIONID=" + Request.QueryString["SESSIONID"], "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            ...
            if (arcyn == "1")
            {
                toolbargrid.AddImageButton("../Portal/PortalPurchaseQuotationRFQ.aspx?SESSIONID=" + Request.QueryString["SESSIONID"], "Import Items from XL", "icon_xls.png", "EXPORT2XL");
            }
            ...
            toolbargrid.AddFontAwesomeButton("javascript:openNewWindow('codehelp1','','" + Session["sitepath"] + "/Reports/ReportsViewWithSubReport.aspx?applicationcode=3&reportcode=PURCHASEORDERFORMVENDOR&quotationid=" + ViewState["quotationid"].ToString() + "&orderid=" + ViewState["ORDERID"] + "'); return false;", "RFQ", "<i class=\"fas fa-file-alt\"></i>", "ORDER");
            if ((Request.QueryString["VIEWONLY"] == null) && (ViewState["WEBSESSIONSTATUS"].ToString() == "Y"))
            {
                toolbargrid.AddFontAwesomeButton("javascript:openNewWindow('codehelp1','','" + Session["sitepath"] + "/Purchase/PurchaseQuotationVendorBulkSave.aspx?quotationid="
            ...
            if ((Request.QueryString["VIEWONLY"] == null) && (ViewState["WEBSESSIONSTATUS"].ToString() == "Y"))
            {
                ...
                toolbarmain.AddButton("Confirm Quote", "CONFIRM", ToolBarDirection.Right);
    ...
    protected void MenuMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Portal/PortalPurchaseVendorQuotationList.aspx");
    ...
    protected void MenuQuotationLineItem_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("ATTACHMENT"))
            {
                ...
                Script += " setTimeout(function(){ openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Common/CommonFileAttachment.aspx?DTKEY=" + ViewState["DTKEY"] + "&MOD=" + PhoenixModule.PURCHASE + "&VESSELID=" + ViewState["VESSELID"].ToString() + "');},500)";
                Script += "</script>" + "\n";
            ...
            if (CommandName.ToUpper().Equals("REMARKS"))
            {
                string Script = "";
                Script += "<script language='javaScript' id='BookMarkScript'>" + "\n";
                Script += " setTimeout(function(){ openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Purchase/PurchaseVendorDetail.aspx?QUOTATIONID=" + ViewState["quotationid"].ToString() +
            ...
            if (CommandName.ToUpper().Equals("COMMENTS"))
            {
                string Script = "";
                Script += "<script language='javaScript' id='BookMarkScript'>" + "\n";
                Script += " setTimeout(function(){ openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Purchase/PurchaseQuotationComments.aspx?QUOTATIONID=" + ViewState["quotationid"].ToString() +
            ...
            if (CommandName.ToUpper().Equals("DELIVERYINSTRUCTION"))
            {
                string Script = "";
                Script += "<script language='javaScript' id='BookMarkScript'>" + "\n";
                Script += " setTimeout(function(){ openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Purchase/PurchaseQuotationDeliveryInstruction.aspx?QUOTATIONID=" + ViewState["quotationid"].ToString() +
                    "&VESSELID=" + ViewState["VESSELID"].ToString() + "&STOCKTYPE=" + Filter.CurrentPurchaseStockType.ToString() +
            ...
            if (CommandName.ToUpper().Equals("DECLINEQUOTE"))
            {
                string Script = "";
                Script += "<script language='javaScript' id='BookMarkScript'>" + "\n";
                Script += " setTimeout(function(){ openNewWindow('codehelp1', '', '" + Session["sitepath"] + "/Purchase/PurchaseQuotationDeclineQuote.aspx?QUOTATIONID=" + ViewState["quotationid"].ToString() +
                    "&VESSELID=" + ViewState["VESSELID"].ToString() + "&STOCKTYPE=" + Filter.CurrentPurchaseStockType.ToString() +
                    "&editable=true&launchedfrom=VENDOR');},500)";
                Script += "</script>" + "\n";
                RadScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "script", Script, false);
            ...
            if (CommandName.ToUpper().Equals("DETAILS"))
            {
                string Script = "";
                Script += "<script language='javaScript' id='BookMarkScript'>" + "\n";
                Script += " setTimeout(function(){ openNewWindow('codehelp1', '', '"+ Session["sitepath"] + "/Purchase/PurchaseFormDetail.aspx?orderid=" + ViewState["ORDERID"].ToString() +
    ...
    protected void gvVendorItem_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            if (Request.QueryString["VIEWONLY"] == "Y")
                img.Attributes.Add("onclick", "javascript:openNewWindow('ev','', '" + Session["sitepath"] + "/Purchase/PurchaseFormItemMoreInfo.aspx?quotationlineid=" + item.GetDataKeyValue("FLDQUOTATIONLINEID").ToString() + "&viewsession=N'); return false;");
            else
                img.Attributes.Add("onclick", "javascript:openNewWindow('ev','', '" + Session["sitepath"] + "/Purchase/PurchaseFormItemMoreInfo.aspx?quotationlineid=" + item.GetDataKeyValue("FLDQUOTATIONLINEID").ToString() + "&viewsession=" + ViewState["WEBSESSIONSTATUS"].ToString() + "'); return false;");



            LinkButton imgAttach = (LinkButton)item.FindControl("cmdViewAttachment");
            if (imgAttach != null) imgAttach.Attributes.Add("onclick", "openNewWindow('AddAddress', '', '" + Session["sitepath"] + "/Common/CommonFileAttachment.aspx?DTKEY=" + item.GetDataKeyValue("FLDDTKEY").ToString() + "&MOD=" + PhoenixModule.PURCHASE + "&U=N'); return false;");


            LinkButton imgDetails = (LinkButton)item.FindControl("cmdDetails");
            if (imgDetails != null) imgDetails.Attributes.Add("onclick", "openNewWindow('AddAddress', '', '" + Session["sitepath"] + "/Purchase/PurchaseFormItemComment.aspx?orderlineid=" + item.GetDataKeyValue("FLDORDERLINEID").ToString() + "&viewonly=Y'); return false;");
            ...
            if (imgComponentDetails != null) imgComponentDetails.Attributes.Add("onclick", "javascript:openNewWindow('Component', '', '" + Session["sitepath"] + "/Purchase/PurchaseFormItemComponentDetails.aspx?COMPONENTID=" + item.GetDataKeyValue("FLDCOMPONENTID").ToString() + "&VESSELID=" + item.GetDataKeyValue("FLDVESSELID").ToString() + "'); return false;");
            ...
            {
                if (Filter.CurrentPurchaseStockType.ToUpper().Equals("SERVICE"))
                    img.Attributes.Add("onclick", "javascript:return openNewWindow('Component', '', '" + Session["sitepath"] + "/Purchase/PurchaseServiceDetail.aspx?WORKORDERID=" + item.GetDataKeyValue("FLDPARTID").ToString() + "&VESSELID=" + item.GetDataKeyValue("FLDVESSELID").ToString() + "&STOCKTYPE=" + Filter.CurrentPurchaseStockType.ToString() + "'); return false;");
                else
                    img.Attributes.Add("onclick", "openNewWindow('Component', '', '" + Session["sitepath"] + "/Purchase/PurchaseSpareItemDetail.aspx?SPAREITEMID=" + item.GetDataKeyValue("FLDPARTID").ToString() + "&VESSELID=" + item.GetDataKeyValue("FLDVESSELID").ToString() + "&STOCKTYPE=" + Filter.CurrentPurchaseStockType.ToString() + "'); return false;");
            }
