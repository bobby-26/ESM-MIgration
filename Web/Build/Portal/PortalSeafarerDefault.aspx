<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PortalSeafarerDefault.aspx.cs" Inherits="PortalSeafarerDefault" %>
    ...
    <div class="middle-box text-center loginscreen  animated fadeInDown">
        <div>
            ...
            <form class="m-t" role="form" action="#" runat="server" autocomplete="off">
                ...
                <a href="../Options/OptionsForgotPassword.aspx?loginfrom=SEAFARER" class="text-white"><small>Forgot password?</small></a>
            </form>
        </div>
    </div>
