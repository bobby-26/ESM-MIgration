<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PortalSeafarerOTPVerify.aspx.cs" Inherits="Portal_PortalSeafarerOTPVerify" %>
        ...
        <div>
            ...
            <form class="m-t" role="form" action="#" runat="server" autocomplete="off">
                <div class="form-group">
                    <input id="txtUserName" type="text" class="form-control" placeholder="Enter OTP" required=""
                        runat="server">
                </div>
