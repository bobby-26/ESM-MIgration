...
public partial class Portal_PortalSeafarerTrainingCompleted : PhoenixBasePage
{
    ...
    protected void TrainingNeed_TabStripCommand(object sender, EventArgs e)
    {
        ...
        {
            coursetype = PhoenixCommonRegisters.GetHardCode(1, 103, "4");
            Response.Redirect("../Portal/PortalSeafarerTraining.aspx?empid=" + ViewState["employeeid"].ToString() + "&coursetype=" + coursetype, true);
        }
