<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PortalSeafarerTrainingOverdueCBT.aspx.cs" Inherits="Portal_PortalSeafarerTrainingOverdueCBT" %>
    ...
    <form id="form1" runat="server">
       <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlCrewRecommendedCourses" Height="100%">
            ...
            <br />
            <telerik:RadLabel ID="lblcompheading" runat="server" Text="CBT training is done later than prescribed date"
                Font-Bold="true">
            </telerik:RadLabel>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Course/CBT" UniqueName="Course10" HeaderStyle-Width="140px" ColumnGroupName="header text">
                            <ItemTemplate>
                              ...
                              <telerik:GridTemplateColumn HeaderText="Sign-on Date" UniqueName="SignDate14" HeaderStyle-Width="80px" ColumnGroupName="header text">
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                <eluc:Date ID="ucSignonDate" runat="server" CssClass="input" Text='<%# General.GetDateTimeToString(DataBinder.Eval(Container,"DataItem.FLDSIGNONDATE")) %>' />
                                <telerik:RadLabel ID="lblSignonDateedit" runat="server" Text='<%# General.GetDateTimeToString(DataBinder.Eval(Container,"DataItem.FLDSIGNONDATE")) %>' Visible="false"></telerik:RadLabel>
                            </EditItemTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderText="No. Of Attempts" UniqueName="Attempt16" HeaderStyle-Width="75px" ColumnGroupName="To be Completed by Manning Office / Agent" Visible="false">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Score" UniqueName="Score17" HeaderStyle-Width="80px" ColumnGroupName="To be Completed by Manning Office / Agent" Visible="false">
                            <HeaderTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Result" UniqueName="Result18" HeaderStyle-Width="70px" ColumnGroupName="To be Completed by Manning Office / Agent" Visible="false">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblResult" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXAMRESULT") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Date Attended" UniqueName="Attend19" HeaderStyle-Width="80px" ColumnGroupName="To be Completed by Manning Office / Agent" Visible="false">
                            <ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" UniqueName="Action21" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="75px" ColumnGroupName="To be Completed by Manning Office / Agent" Visible="false">
                            <ItemTemplate>
