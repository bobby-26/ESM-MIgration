...
public partial class PreSeaAdministrationHandOverList : PhoenixBasePage
{
	protected void Page_Load(object sender, EventArgs e)
	{
		try
		{
			...
			if (!IsPostBack)
			{
				...
				toolbarsub.AddImageButton("../PreSea/PreSeaAdministrationHandOverList.aspx", "Export to Excel", "icon_xls.png", "Excel");
	...
	protected void gvAdminHandOver_RowDataBound(Object sender, GridViewRowEventArgs e)
	{
		...
		if (e.Row.RowType == DataControlRowType.DataRow)
		{
			...
			if (imgHandover != null)
			{
				imgHandover.Attributes.Add("onclick", "Openpopup('codehelp1', '', 'PreSeaAdministrationHandOver.aspx?traineeid=" + lbltraineeid.Text
