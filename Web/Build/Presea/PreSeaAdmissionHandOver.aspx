<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaAdmissionHandOver.aspx.cs"
    Inherits="PreSeaAdmissionHandOver" %>
...
<body>
    <form id="frmPreSeaAdmissionHandOver" runat="server" autocomplete="off">
    ...
    <asp:UpdatePanel runat="server" ID="pnlAdmissionHandOverEntry">
        <ContentTemplate>
                ...
                <div id="divFind" style="position: relative; z-index: 2">
                    <table id="tblConfigureBatch" width="100%">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTrainee" runat="server" ReadOnly="true" CssClass="readonlytextbox"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </div>
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuPreSeaAdmissionHandOver" runat="server" OnTabStripCommand="PreSeaAdmissionHandOver_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="divGrid" style="position: relative; z-index: 0">
                    <asp:GridView ID="gvAdmissionHandOver" runat="server" AutoGenerateColumns="False"
                        Font-Size="11px" Width="100%" CellPadding="3" OnRowDataBound="gvAdmissionHandOver_RowDataBound"
                        OnRowUpdating="gvAdmissionHandOver_RowUpdating" EnableViewState="false" OnRowCancelingEdit="gvAdmissionHandOver_RowCancelingEdit"
                        OnRowDeleting="gvAdmissionHandOver_RowDeleting" OnRowEditing="gvAdmissionHandOver_RowEditing"
                        OnRowCommand="gvAdmissionHandOver_RowCommand" ShowHeader="true" ShowFooter="false">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <EditItemTemplate>
                                    <asp:CheckBox ID="chkAdmissionEdit" runat="server" Checked='<%# (DataBinder.Eval(Container,"DataItem.FLDADMISSION").ToString().Equals("1"))?true:false %>'>
                                    </asp:CheckBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtAdmissionRemarksEdit" runat="server" CssClass="gridinput_mandatory"
                                        MaxLength="200" Text='<%# DataBinder.Eval(Container, "DataItem.FLDADMISSIONREMARK")%>'></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <HeaderTemplate>
