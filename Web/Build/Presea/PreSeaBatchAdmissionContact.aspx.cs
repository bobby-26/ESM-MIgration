...
public partial class PreSeaBatchAdmissionContact : PhoenixBasePage
{
    ...
    public void BindData()
    {
        ...
        try
        {
            ...
            DataSet ds = PhoenixPreSeaBatchAdmissionContact.ListPreSeaBatchAdmissionContact(Convert.ToInt32(Filter.CurrentPreSeaCourseMasterBatchSelection));
            ...
            DataSet ds1 = PhoenixPreSeaBatchAdmissionContact.ListPreSeaBatchAdmissionUser(ddlDepartment.SelectedValue);
    ...
    protected void gvCourseContact_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName.ToUpper().Equals("ADD"))
            {
               ...
               PhoenixPreSeaBatchAdmissionContact.InsertPreSeaBatchAdmissionContact(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                    Convert.ToInt32(((DropDownList)_gridView.FooterRow.FindControl("ddlCourseContactAdd")).SelectedValue),
                    null, null,
                    Convert.ToInt32(Filter.CurrentPreSeaCourseMasterSelection),Convert.ToInt32(Filter.CurrentPreSeaCourseMasterBatchSelection));
            ...
            {
               PhoenixPreSeaBatchAdmissionContact.DeletePreSeaBatchAdmissionContact(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
    ...
    protected void gvCourseContact_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
           ...
           PhoenixPreSeaBatchAdmissionContact.UpdatePreSeaBatchAdmissionContact(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
