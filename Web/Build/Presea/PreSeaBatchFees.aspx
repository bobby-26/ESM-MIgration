<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaBatchFees.aspx.cs" Inherits="PreSeaBatchFees" %>
                    ...
                    <asp:GridView ID="gvPreSeaFees" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Fees Name">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="LblBatchFeesId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDBATCHFEEID") %>'></asp:Label>
                                    <asp:Label ID="LblBatchId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPRESEABATCHID") %>'></asp:Label>
                                ...
                                <EditItemTemplate>
                                    <asp:Label ID="LblBatchFeesIdEdit" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDBATCHFEEID") %>'></asp:Label>
