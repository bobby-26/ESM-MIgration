...
public partial class PreSeaBatchInternalExamResults : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            MenuBatchPlanner.SelectedMenuIndex = 5;

            PhoenixToolbar toolbargrid = new PhoenixToolbar();
            toolbargrid.AddImageButton("../PreSea/PreSeaBatchInternalExamResults.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageButton("../PreSea/PreSeaBatchInternalExamResults.aspx", "Find", "search.png", "FIND");
            toolbargrid.AddImageButton("../PreSea/PreSeaBatchInternalExamResults.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void BindExamSchedule()
    {
        DataTable dt = PhoenixPreSeaBatchExamSchedule.ListPreSeaBatchExamSchedule(General.GetNullableInteger(Filter.CurrentPreSeaBatchManagerSelection)
                ...
                , null);//General.GetNullableGuid(ViewState["EXAMSCHEDULEID"].ToString())
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            string[] alCaptions = { "Batch Roll No", "Name","Subject", "Marks", "Pass/Fail" };
            ...
            ds = PhoenixPreSeaBatchExamResults.SearchPreSeaInternalExamTrainee(PhoenixSecurityContext.CurrentSecurityContext.UserCode
            ...
            Response.Write("<td><h3>Exam Results</h3></td>");
            Response.Write("<td colspan='" + (alColumns.Length - 2).ToString() + "'>&nbsp;</td>");
            Response.Write("</tr>");
            Response.Write("<tr>");
            Response.Write("<td> <b> Course </b> </td> <td>" + ddlCourse.SelectedName + "</td>");
            Response.Write("<td></td><td> <b> Batch </b></td><td>" + ucBatch.SelectedName + "</td>");
            Response.Write("<td></td><td> <b> Exam Type </b></td><td>" + ucExam.SelectedName + "</td></tr>");            
            Response.Write("<tr><td> <b> Semester </b></td><td>" + ddlSemester.SelectedSemester + "</td>");
            Response.Write("<td></td><td> <b> Section </b> </td> <td>" + ddlSection.SelectedValue + "</td>");
            Response.Write("<td></td><td> <b> Exam </b></td><td>" + ucBatchExam.SelectedName + "</td></tr>");
                                        ...
                                        , ((UserControlNumber)_gridView.Rows[nCurrentRow].FindControl("txtMarkEdit")).Text))
                {
                    ...
                    if (TraineeExamid != null && TraineeExamid != "")
                    {
                        PhoenixPreSeaBatchExamResults.UpdatePreSeaSemesterExamTrainee(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                 ...
                                                                 , General.GetNullableInteger(((Label)_gridView.Rows[nCurrentRow].FindControl("lblBatchExamIdEdit")).Text)
                    ...
                    {
                        PhoenixPreSeaBatchExamResults.InsertPreSeaInternalExamTrainee(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                , General.GetNullableInteger(Session["BATCHMANAGECOURSE"].ToString())
                                                                , General.GetNullableInteger(Filter.CurrentPreSeaBatchManagerSelection)
                                                                , null
                                                                , null
    ...
    private bool IsValidResult(string courseid, string batchid, string subjectid, string marks)
    {
        ...
        if (General.GetNullableGuid(ucBatchExam.SelectedBatchExam) == null)
            ucError.ErrorMessage = "Batch Exam is Required.";
