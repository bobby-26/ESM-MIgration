<%@ Page Language="C#" AutoEventWireup="True" CodeFile="PreSeaBatchManager.aspx.cs"
    Inherits="PreSeaBatchManager" MaintainScrollPositionOnPostback="true" %>
        ...
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <eluc:Title runat="server" ID="ucTitle" Text="Plan" />
                    </div>
                </div>
