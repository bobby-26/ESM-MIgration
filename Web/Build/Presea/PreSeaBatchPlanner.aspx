<%@ Page Language="C#" AutoEventWireup="True" CodeFile="PreSeaBatchPlanner.aspx.cs"
    Inherits="PreSeaBatchPlanner" MaintainScrollPositionOnPostback="true" %>
        ...
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <eluc:Title runat="server" ID="ucTitle" Text="Admission Planner" />
                    </div>
                </div>
                    ...
                    <asp:GridView ID="gvBatch" runat="server" AutoGenerateColumns="False" Font-Size="11px" DataKeyNames="FLDBATCHID" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" AlternateText="Plan Batch" ImageUrl="<%$ PhoenixTheme:images/plan.png %>"
                                        CommandName="SELECT" CommandArgument="<%# Container.DataItemIndex %>" ID="cmdPlan"
                                        ToolTip="PlanDetails"></asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
