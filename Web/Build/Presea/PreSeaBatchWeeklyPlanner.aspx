<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaBatchWeeklyPlanner.aspx.cs"
    Inherits="PreSeaBatchWeeklyPlanner" EnableEventValidation="false" %>
            ...
            <ContentTemplate>
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    ...
                    <div class="subHeader" style="position: relative">
                        <eluc:Title runat="server" ID="WeeklyPlannerTitle" Text="Weekly Planner" ShowMenu="true"></eluc:Title>
                    ...
                    <table cellpadding="2" cellspacing="2" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <eluc:Semester ID="ddlSemester" runat="server" Width="120px" CssClass="input_mandatory" AppendDataBoundItems="true"
                                    AutoPostBack="true" OnTextChangedEvent="ddlSemester_Changed" />
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="ddlSection" AppendDataBoundItems="true" CssClass="input_mandatory"
                                    Width="120px">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:ImageButton runat="server" ID="imgCopy" ImageUrl='<%$ PhoenixTheme:images/copy.png %>'
                                    ToolTip="Copy previous day plan" OnClick="imgCopy_Click" />
                            </td>
                            <td>
                                <asp:Literal ID="lblTimeSlot" runat="server" Text="Time slot"></asp:Literal>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlTimeSlot" runat="server" AppendDataBoundItems="true" CssClass="input"
                                    AutoPostBack="true" OnTextChanged="ddlTimeSlot_Changed">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>
                    ...
                    <div id="divGrid" style="position: relative; z-index: 0; width: 100%;">
                        <asp:GridView ID="gvPreSea" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            OnSelectedIndexChanging="gvPreSea_SelectedIndexChanging" ShowFooter="true" EnableViewState="false">
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblIsCompletedYN" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOMPLETED") %>'></asp:Label>
                                        ...
                                        <asp:Label ID="lblStaffId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSTAFFID") %>'></asp:Label>
                                        <asp:Label ID="lblDate" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDATE") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                    ...
                                    <FooterTemplate>
                                        <asp:Label ID="lblIsCompletedYNAdd" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOMPLETED") %>'></asp:Label>
                                        <%--<eluc:MCSubject ID="ucSubjectAdd" runat="server" CssClass="input" Width="50" />--%>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <span id="spnFacultyEdit">
                                            <asp:TextBox ID="txtFacultyEdit" runat="server" CssClass="input" Enabled="false"
                                                MaxLength="50" Width="120px" Text='<%# ((DataRowView)Container.DataItem)["FLDSTAFFNAME"]%>'></asp:TextBox>
                                            <asp:ImageButton runat="server" ID="imgFacultyEdit" Style="cursor: pointer; vertical-align: top"
                                                ImageUrl="<%$ PhoenixTheme:images/picklist.png %>" CommandArgument="<%# Container.DataItemIndex %>" />
                                            <asp:TextBox ID="txtFacultyDesignationEdit" runat="server" CssClass="input" Width="0px"
                                                Enabled="false" MaxLength="50"></asp:TextBox>
                                            <asp:TextBox runat="server" ID="txtFacultyIdEdit" CssClass="input" Width="0px" MaxLength="20"
                                                Text='<%# DataBinder.Eval(Container,"DataItem.FLDSTAFFID") %>'></asp:TextBox>
                                            <asp:TextBox runat="server" ID="txtFacultyEmailEdit" CssClass="input" Width="0px"
                                                MaxLength="20"></asp:TextBox>
                                        </span>
                                    </EditItemTemplate>
                                    <FooterTemplate>
                                        <%--  <asp:DropDownList ID="ddlFacultyAdd" runat="server"  AppendDataBoundItems="true" CssClass="input_mandatory">
                                    </asp:DropDownList>--%>
                                        <span id="spnFacultyAdd">
                                            <asp:TextBox ID="txtFacultyAdd" runat="server" CssClass="input" Enabled="false" MaxLength="50"
                                                Width="120px"></asp:TextBox>
                                            <asp:ImageButton runat="server" ID="imgFacultyAdd" Style="cursor: pointer; vertical-align: top"
                                                ImageUrl="<%$ PhoenixTheme:images/picklist.png %>" CommandArgument="<%# Container.DataItemIndex %>" />
                                            <asp:TextBox ID="txtFacultyAddDesignation" runat="server" CssClass="input" Width="0px"
                                                Enabled="false" MaxLength="50"></asp:TextBox>
                                            <asp:TextBox runat="server" ID="txtFacultyAddId" CssClass="input" Width="0px" MaxLength="20"></asp:TextBox>
                                            <asp:TextBox runat="server" ID="txtFacultyAddEmail" CssClass="input" Width="0px"
                                                MaxLength="20"></asp:TextBox>
                                        </span>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <asp:DropDownList ID="ddlClassRoomEdit" runat="server" CssClass="input" DataValueField="FLDROOMID"
                                ...
                                <asp:TemplateField>
                                    ...
                                    <EditItemTemplate>
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlPracticalEdit" AppendDataBoundItems="true"
                                    ...
                                    <FooterTemplate>
                                        <asp:DropDownList runat="server" ID="ddlPracticalAdd" AppendDataBoundItems="true"
                                            CssClass="input" Width="120px">
                                            <asp:ListItem Text="--Select--" Value="">--Select--</asp:ListItem>
                                            <asp:ListItem Text="A" Value="1">A</asp:ListItem>
                                            <asp:ListItem Text="B" Value="2">B</asp:ListItem>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:ImageButton runat="server" AlternateText="Details" ImageUrl="<%$ PhoenixTheme:images/annexure.png %>"
                                            CommandName="PLAN" CommandArgument='<%# Container.DataItemIndex %>' ID="cmdPlan"
                                            ToolTip="Individual Plan"></asp:ImageButton>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                    ...
                                    <FooterTemplate>
                                        <asp:ImageButton runat="server" AlternateText="Save" ImageUrl="<%$ PhoenixTheme:images/te_check.png %>"
                                            CommandName="PLANADD" CommandArgument='<%# Container.DataItemIndex %>' ID="cmdAdd"
                    ...
                    <br />
                    <div class="navSelect" style="position: relative; clear: both; width: 15px">
                        <eluc:TabStrip ID="MenuPreSeaWeekPlanner" runat="server" OnTabStripCommand="MenuPreSeaWeekPlanner_TabStripCommand"></eluc:TabStrip>
                    </div>
