<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaCandidateBioData.aspx.cs" Inherits="Presea_PreSeaCandidateBioData" %>
...
<body>
    ...
    <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div style="position: relative">
            <iframe runat="server" id="ifMoreInfo" frameborder="0" style="width: 100%; min-height:500px;">
            </iframe>
        </div>
    </div>
    </form>
