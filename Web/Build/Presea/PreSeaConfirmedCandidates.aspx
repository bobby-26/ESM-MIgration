<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaConfirmedCandidates.aspx.cs" Inherits="Presea_PreSeaConfirmedCandidates" %>
        ...
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <eluc:Title runat="server" ID="Title1" Text="Send Letter to Confirmed Candidates" ShowMenu="<%# Title1.ShowMenu %>">
                    </eluc:Title>
                </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlLetterType" runat="server" CssClass="input_mandatory">
                                <asp:ListItem Value="0">Offer Letter</asp:ListItem>
