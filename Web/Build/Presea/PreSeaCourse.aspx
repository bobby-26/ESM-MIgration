<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaCourse.aspx.cs" Inherits="PreSeaCourse" %>
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="lnkCourseName" runat="server" CommandName="EDIT" CommandArgument='<%# ((DataRowView)Container.DataItem)["FLDPRESEACOURSEID"] %>'><%# ((DataRowView)Container.DataItem)["FLDPRESEACOURSENAME"]%></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
