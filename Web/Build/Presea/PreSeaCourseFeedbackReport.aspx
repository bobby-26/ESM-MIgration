<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaCourseFeedbackReport.aspx.cs" Inherits="Presea_PreSeaCourseFeedbackReport" %>
            ...
            <div style="top: 100px; margin-left: auto; margin-right: auto; width: 100%;">
                <div style="top: 100px; margin-left: auto; margin-right: auto; vertical-align: middle;">
                    ...
                    <div class="subHeader" style="position: relative; right: 0px">
                        <eluc:Title runat="server" ID="Title1" Text="Course Feedback" ShowMenu="true" />
                    </div>
                </div>
