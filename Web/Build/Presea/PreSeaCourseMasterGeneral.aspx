<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaCourseMasterGeneral.aspx.cs" Inherits="PreSeaCourseMasterGeneral" %>
...
<head runat="server">
    <title>PreSea - Course Master General</title>
    ...
    <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader">
            <div class="divFloatLeft">
                <eluc:Title runat="server" ID="Title1" Text="PreSea - Course Master" ShowMenu="<%# Title1.ShowMenu %>">
                </eluc:Title>
            </div>
            <div class="divFloat">
        ...
        <div class="divFloat" style="clear:right">
            <eluc:TabStrip ID="PreSeaCourseGeneral" runat="server" OnTabStripCommand="PreSeaCourseGeneral_TabStripCommand" TabStrip="true" >
            </eluc:TabStrip>
        </div>
