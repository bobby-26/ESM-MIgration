<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaEntranceScoreCardSummary.aspx.cs"
    Inherits="PreSeaEntranceScoreCardSummary" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    <title>Presea entrance scorecard template</title>
                ...
                <asp:GridView ID="gvPreSea" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            ...
                            <HeaderTemplate>
                                <asp:CheckBox ID="chkAll" runat="server" onclick="CheckAll(this)" Text="S.No" />
                            </HeaderTemplate>
                            <ItemTemplate>
