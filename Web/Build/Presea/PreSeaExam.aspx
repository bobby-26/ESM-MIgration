<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaExam.aspx.cs" Inherits="PreSea_PreSeaExam" %>
        ...
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <eluc:Title runat="server" ID="ucTitle" Text="Exam" ShowMenu="true"></eluc:Title>
                    </div>
                </div>
                <div id="divSearch">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Exam Name">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtExamNameEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXAMNAME") %>'
                                        CssClass="gridinput_mandatory" MaxLength="200" />
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtExamNameAdd" runat="server" CssClass="gridinput_mandatory" MaxLength="200" />
                                </FooterTemplate>
                            </asp:TemplateField>                         
                            <asp:TemplateField>
