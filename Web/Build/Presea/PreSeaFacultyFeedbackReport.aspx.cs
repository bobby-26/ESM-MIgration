...
public partial class Presea_PreSeaFacultyFeedbackReport : PhoenixBasePage
{
    ...
    protected void MenuPreSea_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("SHOWREPORT"))
            {
                ...
                ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=10&reportcode=FEEDBACKREPORT&batchid=" + ucBatch.SelectedBatch + "&showmenu=0";
            }
