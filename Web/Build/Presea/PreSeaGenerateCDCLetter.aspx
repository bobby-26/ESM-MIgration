<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaGenerateCDCLetter.aspx.cs" Inherits="Presea_PreSeaGenerateCDCLetter" %>
...
<head runat="server">
    <title>PreSea Confirmed Candidates</title>
        ...
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <eluc:Title runat="server" ID="Title1" Text="Generate CDC/IMU Forms" ShowMenu="<%# Title1.ShowMenu %>">
                    </eluc:Title>
                </div>
                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlLetterType" runat="server" CssClass="input_mandatory">
                                <asp:ListItem Value="0">CDC Form1</asp:ListItem>
                                <asp:ListItem Value="1">CDC Form2</asp:ListItem>
                                <asp:ListItem Value="2">IMU Registration Form</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
