...
public partial class PreSeaInterviewScoreCardDNSBTECH : PhoenixBasePage
{
    ...
    protected override void Render(HtmlTextWriter writer)
    {
        ...
        foreach (GridViewRow r in gvAcademicSection.Rows)
        {
            ...
            if (r.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblFieldDesc!=null && (lblFieldDesc.Text.ToUpper() == "HSC PHYSICS" ||
                ...
                if (lblFieldDesc != null &&(lblFieldDesc.Text.ToUpper() == "HSC PCM"))
                {
                    ...
                    //    ucMax.Text = pcmMax.ToString();
                    //if (ucAllot != null)
                    //    ucAllot.Text = pcmAllot.ToString();
                    //if (lblPercentage != null)
                    //    lblPercentage.Text = string.Format("{0:0.00}", (pcmAllot / pcmMax) * 100).ToString();
                    //}

                    //Label lblFieldDesc = (Label)e.Row.FindControl("lblFieldDesc");
    ...
    private void SetOverallTotal()
    {
        ...
        //lblAvg.Text = Math.Round(((academic + written + general) / 3)*100,3).ToString();
    ...
    protected void gvScore_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (edit != null)
            {
                ...
                {
                    //ucConfirm.Text = "Finalize record can not be deleted.";
                    //ucConfirm.Visible = true;
                    //edit.Enabled = false;
                    //edit.Attributes.Add("onclick", "return fnConfirmDelete(event,'Are you sure you want to delete this course?')")
                    //edit.OnClientClick()
                }
            }
    ...
    protected void gvScore_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            ...
            if (!String.IsNullOrEmpty(ViewState["INTERVIEWID"].ToString()))
            {
                ...
                //UserControlMaskNumber ucScredPercent = (UserControlMaskNumber)_gridView.Rows[nCurrentRow].FindControl("ucScredPercent");
    ...
    protected void InterviewScoreCard_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                RadWindowManager1.RadConfirm("You will not be able to make any changes. Are you sure you want to finalize the scorecard?", "confirm", 320, 150, null, "Confirm");
    ...
    protected void ucMax_TextChangedEvent(object o, EventArgs e)
    {
        ...
        if (txtMaxMark!=null && txtAllotMark!=null &&  !string.IsNullOrEmpty(txtMaxMark.Text) && !string.IsNullOrEmpty(txtAllotMark.Text) && General.GetNullableDecimal(txtMaxMark.Text.Trim())> 0)
