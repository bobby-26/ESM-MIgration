...
public partial class PreSeaInterviewScoreCardGME : PhoenixBasePage
{
    ...
    protected override void Render(HtmlTextWriter writer)
    {
        ...
        foreach (GridViewRow r in gvAcademicSection.Rows)
        {
            ...
            if (r.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblFieldDesc != null && (lblFieldDesc.Text.ToUpper() == "HSC PCM"))//((Label)gvAcademicSection.Rows[rowIndex].FindControl("lblFieldDesc")).Text.ToUpper() == "HSC PCM")
                {
