<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaMoreInfo.aspx.cs" Inherits="PreSeaMoreInfo" %>
...
<body>
    ...
    <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <eluc:Editor ID="txtComment" runat="server" Width="100%" Height="100%" DesgMode="true" />
    </div>
    </form>
</body>
</html>
