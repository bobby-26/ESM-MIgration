<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaMoreInfoExamInvigilator.aspx.cs" Inherits="PreSeaMoreInfoExamInvigilator" %>
            ...
            <asp:GridView ID="gvInvigilator" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                ...
                <Columns>
                    <asp:TemplateField>
                        ...
                        <HeaderTemplate>
                            <asp:Label ID="lblInvigilatorHeader" runat="server">Invigilator Name&nbsp;
                            </asp:Label>
                        </HeaderTemplate>
                        <ItemTemplate>
