<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaNewApplicantAcademicQualification.aspx.cs"
    Inherits="PreSeaNewApplicantAcademicQualification" %>
...
<body>
    ...
    <asp:UpdatePanel runat="server" ID="pnlPreSeaNewApplicantAcademicEntry">
        <ContentTemplate>
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
            <div class="navigation" id="Div1" style="top: 0px; margin-left: 0px; vertical-align: top;
                width: 100%">
                <div class="subHeader">
                    <eluc:Title runat="server" ID="Academic" Text="Applicant Academic Qualification"
