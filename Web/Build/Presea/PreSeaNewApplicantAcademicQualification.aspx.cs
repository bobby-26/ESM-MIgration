...
public partial class PreSeaNewApplicantAcademicQualification : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../PreSea/PreSeaNewApplicantAcademicQualification.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('gvPreSeaAcademics')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageLink("javascript:parent.Openpopup('codehelp1','','PreSeaNewApplicantAcademic.aspx?empid=" + Filter.CurrentPreSeaNewApplicantSelection + "')", "Add", "add.png", "ADDPRESEAACADEMIC");
            MenuPreSeaAcademic.AccessRights = this.ViewState;
            MenuPreSeaAcademic.MenuList = toolbargrid.Show();
            MenuPreSeaAcademic.SetTrigger(pnlPreSeaNewApplicantAcademicEntry);

            toolbargrid = new PhoenixToolbar();
            toolbargrid.AddImageButton("../PreSea/PreSeaNewApplicantAcademicQualification.aspx", "Export to Excel", "icon_xls.png", "Excel");
            //PreSeaCourse.AccessRights = this.ViewState;
           // PreSeaCourse.MenuList = toolbargrid.Show();
    ...
    protected void PreSeaAcademicMenu_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("EXCEL"))
            {
                ...
                DataTable dt = PhoenixPreSeaNewApplicantAcademicQualification.ListPreSeaNewApplicantAcademic(Convert.ToInt32(Filter.CurrentPreSeaNewApplicantSelection), null);
    ...
    protected void gvPreSeaAcademics_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            if (!e.Row.RowState.Equals(DataControlRowState.Alternate | DataControlRowState.Edit) && !e.Row.RowState.Equals(DataControlRowState.Edit))
            {
                ...
                lb.Attributes.Add("onclick", "parent.Openpopup('codehelp1', '', 'PreSeaNewApplicantAcademicDetail.aspx?empid=" + Filter.CurrentPreSeaNewApplicantSelection + "&ACADEMICID=" + l.Text + "&ACADEMICTYPE=" + lblAcademictype.Text + "');return false;");

                ImageButton db1 = (ImageButton)e.Row.FindControl("cmdEdit");
                db1.Attributes.Add("onclick", "parent.Openpopup('codehelp1', '','PreSeaNewApplicantAcademicDetail.aspx?empid=" + Filter.CurrentPreSeaNewApplicantSelection + "&ACADEMICID=" + l.Text + "&ACADEMICTYPE=" + lblAcademictype.Text + "');return false;");
