...
public partial class PreSeaNewApplicantFamilyNok : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                SetPreSeaNewApplicantFamilyDetails();
                SetPreSeaNewApplicantSiblings();
                ...
                typeof(PreSeaNewApplicantFamilyNok),
                "ScriptDoFocus",
    ...
    protected void PreSeaFamily_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                if (ViewState["EMPLOYEEFAMILYID"] == null)
                {
                    SavePreSeaNewApplicantFamilyDetails();

                }
                else
                {
                    UpdateNewApplicantFamilyDetails();
                }
            }
            ...
            {
                PhoenixPreSeaNewApplicantFamilyNok.DeletePreSeaNewApplicantFamily(General.GetNullableInteger(ViewState["EMPLOYEEFAMILYID"].ToString()).Value);               
                ViewState["EMPLOYEEFAMILYID"] = null;
                ResetFormControlValues(this);
                SetPreSeaNewApplicantPrimaryDetails();
                SetPreSeaNewApplicantFamilyDetails();
    ...
    public void SetPreSeaNewApplicantPrimaryDetails()
    {
        try
        {
            ...
            dt = PhoenixPreSeaNewApplicantFamilyNok.ListPreSeaNewApplicantFamily(Convert.ToInt32(Filter.CurrentPreSeaNewApplicantSelection), null);
    ...
    private void SavePreSeaNewApplicantFamilyDetails()
    {
        try
        {

            DataTable family = PhoenixPreSeaNewApplicantFamilyNok.InsertPreSeaNewApplicantFamily(PhoenixSecurityContext.CurrentSecurityContext.UserCode
            ...
            DataTable dt = PhoenixPreSeaNewApplicantFamilyNok.ListPreSeaNewApplicantFamily(Convert.ToInt32(Filter.CurrentPreSeaNewApplicantSelection)
    ...
    private void SetPreSeaNewApplicantFamilyDetails()
    {
        try
        {
            ...
            DataTable dt = PhoenixPreSeaNewApplicantFamilyNok.ListPreSeaNewApplicantFamily(Convert.ToInt32(Filter.CurrentPreSeaNewApplicantSelection), General.GetNullableInteger(familyid));
    ...
    private void UpdateNewApplicantFamilyDetails()
    {
        try
        {
            if (txtFileUpload.HasFile)
            ...
            PhoenixPreSeaNewApplicantFamilyNok.UpdatePreSeaNewApplicantFamily(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                    , Convert.ToInt32(Filter.CurrentPreSeaNewApplicantSelection)
    ...
    public void SetPreSeaNewApplicantSiblings()
    {
        DataTable dt = PhoenixPreSeaNewApplicantPersonal.PreSeaNewApplicantSiblingsList(General.GetNullableInteger(Filter.CurrentPreSeaNewApplicantSelection));
        if (dt.Rows.Count > 0)
        {
