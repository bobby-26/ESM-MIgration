<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaNewApplicantGraduation.aspx.cs"
    Inherits="PreSeaNewApplicantGraduation" MaintainScrollPositionOnPostback ="true" %>
                ...
                <div>
                    <table cellpadding="1" cellspacing="1" width="100%">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtUniversity" runat="server" CssClass="input_mandatory" MaxLength="200"
                        ...
                        <tr>
                            <td valign="top" colspan="4" style="width: 100%;">
                                <asp:GridView ID="gvMarks" runat="server" AutoGenerateColumns="false" Font-Size="11px"
                                    OnRowDataBound="gvMarks_RowDataBound" Width="95%" CellPadding="3" EnableViewState="false">
                                        ...
                                        <asp:TemplateField HeaderText="Marks obtained">
                                            ...
                                            <ItemTemplate>
                                                <eluc:Number ID="txtMarksEdit" CssClass="input_mandatory" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMARKS") %>'
                                                    Width="100px" MaxLength="6" DecimalPlace="2" Mask="999.99" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                        ...
                        <tr>
                            <td colspan="4" align="right">
                                <asp:Button ID="btnBasicSave" runat="server" CommandName="Graduation" Text="Save"
