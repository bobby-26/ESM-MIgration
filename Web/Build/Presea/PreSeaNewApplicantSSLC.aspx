<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaNewApplicantSSLC.aspx.cs"
    Inherits="PreSeaNewApplicantSSLC" %>
    ...
    <div class="navigation" id="Div1" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div>
            <table cellpadding="2" cellspacing="1" width="100%">
                <tr>
                    ...
                    <td>
                        <eluc:Quick ID="ucAcademicBoard" runat="server" CssClass="dropdown_mandatory" QuickTypeCode="101"
                            Width="300" AppendDataBoundItems="true" />
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtInstituteName" runat="server" CssClass="input_mandatory" Width="150px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td colspan="4">
                        <asp:CheckBox ID="chkResultYN" runat="server" Visible="false" />
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                ...
                <tr>
                    <td valign="top" colspan="4" style="width: 80%;">
                        <asp:GridView ID="gvMarks" runat="server" AutoGenerateColumns="false" Font-Size="11px"
                            OnRowDataBound="gvMarks_RowDataBound" Width="95%" CellPadding="3" EnableViewState="true">
                                ...
                                <asp:TemplateField HeaderText="Marks obtained">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <eluc:Number ID="txtMarksEdit" CssClass="input_mandatory" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMARKS") %>'
                                            Width="100px" MaxLength="3" IsInteger="true" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Grade Point">
                                    ...
                                    <ItemTemplate>
                                        <eluc:Number ID="txtGradePointEdit" CssClass="readonlytextbox" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDGRADEPOINT") %>'
                                            Width="100px" MaxLength="2" Enabled="false" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                ...
                <tr>
                    <td colspan="4" align="right">
                        <asp:Button ID="btnBasicSave" runat="server" CommandName="SSLC" Text="Save" CssClass="DataGrid-HeaderStyle"
