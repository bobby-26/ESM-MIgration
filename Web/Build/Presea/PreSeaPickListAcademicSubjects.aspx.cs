...
public partial class PreSeaPickListAcademicSubjects : PhoenixBasePage
{
    ...
    private void BindData()
    {
        try
        {
            ...
            ds = PhoenixPreSeaCommon.SearchPreSeaCourseSubject(null
                , txtSubject.Text.Trim(), null, General.GetNullableInteger(ddlCertificate.SelectedQualification)
    ...
    protected void gvPreseaPicklist_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            ...
            if (Request.QueryString["mode"] == "custom")
            {
                ...
                Label lblCode = (Label)_gridView.Rows[nCurrentRow].FindControl("lblQualify");
                nvc.Add(lblCode.ID, lblCode.Text);
                LinkButton lb = (LinkButton)_gridView.Rows[nCurrentRow].FindControl("lnkSubjectName");
                nvc.Add(lb.ID, lb.Text.ToString());
                Label lbl = (Label)_gridView.Rows[nCurrentRow].FindControl("lblSubjectId");
