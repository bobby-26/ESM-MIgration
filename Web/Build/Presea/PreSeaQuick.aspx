<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaQuick.aspx.cs" Inherits="PreSeaQuick" %>
        ...
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <eluc:Title runat="server" ID="ucTitle" Text="Other Registers"></eluc:Title>
                    </div>
                </div>
                    ...
                    <asp:GridView ID="gvQuick" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField FooterText="New Short">
                                ...
                                <HeaderTemplate>
                                    <asp:Label ID="lblQuickCodeHeader" Visible="true" runat="server">
                                    ...
                                    <asp:LinkButton ID="lnkQuickCodeHeader" runat="server" CommandName="Sort" CommandArgument="FLDSHORTNAME"
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtShortNameEdit" runat="server" CssClass="gridinput_mandatory" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSHORTNAME") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                            ...
                            <asp:TemplateField FooterText="New Quick">
                                ...
                                <FooterTemplate>
                                    <asp:TextBox ID="txtQuickNameAdd" runat="server" CssClass="gridinput_mandatory" MaxLength="200"
                                        ToolTip="Enter Quick Name"></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
