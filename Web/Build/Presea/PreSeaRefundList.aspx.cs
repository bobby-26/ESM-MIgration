...
public partial class Presea_PreSeaRefundList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbarsub.AddImageButton("../PreSea/PreSeaRefundList.aspx", "Export to Excel", "icon_xls.png", "EXCEL");
            toolbarsub.AddImageButton("../PreSea/PreSeaRefundList.aspx", "Filter", "search.png", "FIND");
            toolbarsub.AddImageButton("../PreSea/PreSeaRefundList.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void PreSeaQuery_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("SHOWREPORT"))
            {
                ...
                {
                    string script = "parent.Openpopup('Bank','','../Reports/ReportsView.aspx?applicationcode=10&reportcode=REFUNDLETTER&showword=no&showexcel=no&candidateslist=" + candidates + "&batch=" + ucBatch.SelectedBatch + "');";
    ...
    public void BindData()
    {
        ...
        try
        {
            ...
            DataSet ds = PhoenixPreSeaCandidateConfirmation.PreSeaRefundCandidates(General.GetNullableInteger(ucBatch.SelectedBatch)
