<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaSemester.aspx.cs" Inherits="PreSea_PreSeaSemester"
                ...
                <div id="divSearch">
                    <table id="tblSearch" width="100%">
                        <tr>
                            ...
                            <td>
                                <%--<asp:TextBox ID="txtSemestername" runat="server" CssClass="input"></asp:TextBox>--%>
                            </td>
                        </tr>
                    </table>
                </div>
