...
public partial class PreSea_PreSeaSemester : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                toolbar.AddImageButton("../PreSea/PreSeaSemester.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixPreSeaSemester.PreSeaSemesterSearch(null
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixPreSeaSemester.PreSeaSemesterSearch(null
          , General.GetNullableInteger(Filter.CurrentPreSeaCourseMasterSelection)
          , sortexpression
          , sortdirection
          , (int)ViewState["PAGENUMBER"]
    ...
    private void InsertPreSeaSemester(int courseid, string semestername, string semestercode, string noofweeks, string ordersequence)
    {
        PhoenixPreSeaSemester.InsertPreSeaSemester(PhoenixSecurityContext.CurrentSecurityContext.UserCode, courseid,
            semestername, semestercode, Convert.ToInt16(noofweeks), General.GetNullableInteger(ordersequence));
    }

    private void UpdatePreSeaSemester(int courseid, int semesterid, string semestername, string semestercode, string noofweeks, string ordersequence)
    {
        PhoenixPreSeaSemester.UpdatePreSeaSemester(PhoenixSecurityContext.CurrentSecurityContext.UserCode, courseid,
    ...
    {
        PhoenixPreSeaSemester.DeletePreSeaSemester(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
            semesterid);
    }

    private bool IsValidPreSeaSemester(string courseid, string semestername, string semestercode, string noofweeks)
    {
    ...
    protected void gvPreSeaSemester_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            //UserControlPreSeaCourse ucCourse = (UserControlPreSeaCourse)e.Row.FindControl("ddlCourseAdd");
            //if (ucCourse != null)
            //{
            //    ucCourse.SelectedCourse = PhoenixPreSeaCourse.ListPreSeaCourse();
            //    ucCourse.DataBind();
            //}
        }
    }
