...
public partial class PreSeaSemesterExamInvigilator : PhoenixBasePage
{
    ...
    {             
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["semesterplanid"] != null)
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixPreSeaBatchExamInvigilator.SemesterExamInvigilatorSearch(PhoenixSecurityContext.CurrentSecurityContext.UserCode
            ,int.Parse(ViewState["SEMESTERPLANID"].ToString())
            ,sortexpression
            ,sortdirection
    ...
    protected void CheckBoxClicked(object sender, EventArgs e)
    {
        ...
        PhoenixPreSeaBatchExamInvigilator.UpdateSemesterExamInvigilator(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                , int.Parse(ViewState["SEMESTERPLANID"].ToString())
                , int.Parse(usercode));
