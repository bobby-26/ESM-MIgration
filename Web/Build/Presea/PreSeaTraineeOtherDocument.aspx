<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaTraineeOtherDocument.aspx.cs" Inherits="PreSeaTraineeOtherDocument" %>
...
<body>
    <form id="frmDocumentOther" runat="server" autocomplete="off">
        <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" CombineScripts="false">
        </ajaxToolkit:ToolkitScriptManager>
        <asp:UpdatePanel runat="server" ID="pnlDocumentOther">
            <ContentTemplate>
                <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
                <asp:Button runat="server" ID="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" />
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader">
                        <eluc:Title runat="server" ID="TravelDocument" Text="Trainee Other Document" ShowMenu="false"></eluc:Title>
                    </div>
                    ...
                    <div class="navSelect" style="position: relative; width: 15px">
                        <eluc:TabStrip ID="MenuPreSeaDocumentOther" runat="server" OnTabStripCommand="PreSeaDocumentOtherMenu_TabStripCommand"></eluc:TabStrip>
                    </div>
                    <asp:GridView ID="gvOtherDocument" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        OnRowUpdating="gvOtherDocument_RowUpdating" OnRowEditing="gvOtherDocument_RowEditing" OnSelectedIndexChanging="gvOtherDocument_SelectedIndexChanging"
                        ShowFooter="True" EnableViewState="false" AllowSorting="true" OnSorting="gvOtherDocument_Sorting">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <EditItemTemplate>
                                    ...
                                    <eluc:DocumentType ID="ucDocumentTypeEdit" runat="server" DocumentTypeList='<%#PhoenixRegistersDocumentOther.ListDocumentOther(((int)PhoenixDocumentType.OTHER_DOC_NONE).ToString())%>'
                                        ...
                                        CssClass="dropdown_mandatory" OnTextChangedEvent="ddlDocumentType_TextChanged" AutoPostBack="true" />
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <eluc:DocumentType ID="ucDocumentTypeAdd" runat="server" DocumentType='<%# ((int)PhoenixDocumentType.OTHER_DOC_NONE).ToString()%>' DocumentTypeList='<%#PhoenixRegistersDocumentOther.ListDocumentOther(((int)PhoenixDocumentType.OTHER_DOC_NONE).ToString())%>'
                            ...
                            <asp:TemplateField HeaderText="Remarks">
                                <ItemStyle Wrap="false" HorizontalAlign="Left"></ItemStyle>
                                <ItemTemplate>
                                    <asp:Label ID="lblRemarks" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDREMARKS") %>' Visible="false"></asp:Label>
