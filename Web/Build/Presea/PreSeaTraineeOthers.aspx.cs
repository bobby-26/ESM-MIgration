...
public partial class PreSeaTraineeOthers : PhoenixBasePage
{
	...
	{
		DataTable dt = PhoenixPreSeaTraineeOthers.PreSeaTraineeOtherDetailsList(Convert.ToInt32(Filter.CurrentPreSeaTraineeSelection));
		if (dt.Rows.Count > 0)
		{
	...
	protected void PreSeaOthersMain_TabStripCommand(object sender, EventArgs e)
	{
		try
		{
			...
			if (dce.CommandName.ToUpper().Equals("SAVE"))
			{
				...
				{
					PhoenixPreSeaTraineeOthers.UpdatePreSeaTraineeOtherDetails(PhoenixSecurityContext.CurrentSecurityContext.UserCode
				...
				{
					PhoenixPreSeaTraineeOthers.InertPreSeaTraineeOtherDetails(PhoenixSecurityContext.CurrentSecurityContext.UserCode
															 , General.GetNullableInteger(ucNewspaperMagazine.SelectedQuick)
															 , General.GetNullableInteger(ucSchoolCollage.SelectedQuick)
															 , General.GetNullableInteger(ucState.SelectedState)
															 , General.GetNullableInteger(ddlPlace.SelectedCity)
