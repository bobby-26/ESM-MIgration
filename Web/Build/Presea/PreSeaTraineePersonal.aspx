...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaTraineePersonal.aspx.cs"
    Inherits="PreSeaTraineePersonal" %>
...
<body>
    ...
    <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader">
            <eluc:Title runat="server" ID="ttlPreSeaMainPersonel" Text="Trainee Personal Details"
                ShowMenu="false"></eluc:Title>
        </div>
        <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
            <eluc:TabStrip ID="PreSeaMainPersonal" runat="server" OnTabStripCommand="PreSeaMainPersonal_TabStripCommand">
            </eluc:TabStrip>
        </div>
        <table cellpadding="2" cellspacing="4" width="100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtFileNo" runat="server" CssClass="readonlytextbox" MaxLength="200" Width="75px"></asp:TextBox>
                </td>
                <td>
                    Batch Roll No
                </td>
            ...
            <tr>
                ...
                <td>
                    Major illness/operations Description
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtBloodGroup" CssClass ="input" runat="server" ></asp:TextBox>
                </td>
                <td>
                    Family Relation to Company
                </td>
                <td>
                ...
                <td>
                    Family Relation to Company Description
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <eluc:Quick ID="ucCategory" runat="server" AppendDataBoundItems="true" CssClass="input" QuickTypeCode="105" />
                </td>
            </tr>
            <tr>
               <td>
