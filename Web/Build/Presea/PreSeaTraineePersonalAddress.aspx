<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaTraineePersonalAddress.aspx.cs"
    Inherits="PreSeaTraineePersonalAddress" %>
...
<head id="Head" runat="server">
    <title>PreSea Trainee Personal Address</title>
...
<body>
    ...
    <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader">
            <eluc:Title runat="server" ID="ttlAddress" Text="Trainee Address" ShowMenu="false">
            </eluc:Title>
        </div>
        ...
        <table cellpadding="1" cellspacing="1" width="100%">
            ...
            <tr>
                ...
                <td>
                    <eluc:MobileNumber ID="txtMobileNumber"  runat="server" CssClass="input" />
                </td>
                <td>
                    Mobile Number
                </td>
                <td>
                    <eluc:MobileNumber ID="txtMobileNumber2"  runat="server" CssClass="input" />
                </td>
                <td>
                    Mobile Number
                </td>
                <td>
                    <eluc:MobileNumber ID="txtPostalMobileNumber"  runat="server"
                        CssClass="input" />
                </td>
                <td>
                    Mobile Number
                ...
                <td>
                    <eluc:MobileNumber ID="txtPostalMobileNumber2"  runat="server"
                        CssClass="input" />
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    <table cellpadding="1" cellspacing="1">
                        <tr>
                            <td>
                                <eluc:MobileNumber ID="txtMobileNumber3"  runat="server" CssClass="input" />
                            </td>
                            <td>
                                Relation
            ...
            <tr>
                ...
                <td colspan="3">
                    <table cellpadding="1" cellspacing="1">
                        <tr>
                            <td>
                                <eluc:Date ID="txtValidUntilPostal" runat="server" CssClass="input_mandatory" />
                            </td>
                        </tr>
                    </table>
                </td>
                <td>
                    Address Valid Untill
                </td>
                <td colspan="3">
                    <table cellpadding="1" cellspacing="1">
                        <tr>
                            <td>
                                <eluc:Date ID="txtValidUntillPermanent" runat="server" CssClass="input_mandatory" />
                            </td>
                        </tr>
                    </table>
                </td>
