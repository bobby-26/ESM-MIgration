...
public partial class PreSeaTraineePersonalAddress : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                SetPreSeaTraineeAddress();
                ddlCountry_TextChanged(null, null);

                Page.ClientScript.RegisterStartupScript(
                typeof(PreSeaTraineePersonalAddress),
                "ScriptDoFocus",
    ...
    protected void PreSeaPersonalAddressMain_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                {
                    SavePreSeaTraineeAddress();
                }
                else
                {
                    UpdatePreSeaTraineeAddress();
                }
    ...
    public void SavePreSeaTraineeAddress()
    {
        try
        {
            ...
            int localaddressid = PhoenixPreSeaTraineePersonal.InsertPreSeaTraineeAddress(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                                                      ...
                                                                                                      , General.GetNullableDateTime(txtValidUntilPostal.Text)
                                                                                                      );

            int Permanentaddressid = PhoenixPreSeaTraineePersonal.InsertPreSeaTraineeAddress(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                                                        , Convert.ToInt32(Filter.CurrentPreSeaTraineeSelection)
                                                                                                        ...
                                                                                                        , General.GetNullableDateTime(txtValidUntillPermanent.Text)
                                                                                                        );
    ...
    public void SetPreSeaTraineeAddress()
    {
        try
        {
            DataTable dt = PhoenixPreSeaTraineePersonal.ListPreSeaTraineeAddress(Convert.ToInt32(Filter.CurrentPreSeaTraineeSelection));
            if (dt.Rows.Count > 0)
            {
                ...
                txtValidUntilPostal.Text = dt.Rows[0]["FLDVALIDUNTIL"].ToString();
                txtValidUntilPostal.Text = dt.Rows[1]["FLDVALIDUNTIL"].ToString();
            }
        }
        catch (Exception ex)
        {
    ...
    public void UpdatePreSeaTraineeAddress()
    {
        try
        {
            if (!IsValidate(PermanentAddress.Address1, PermanentAddress.City, PermanentAddress.State, PermanentAddress.Country,
            ...
            int localaddressid = PhoenixPreSeaTraineePersonal.UpdatePreSeaTraineeAddress(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                                            , Convert.ToInt32(Filter.CurrentPreSeaTraineeSelection)
            ...
            int Permanentaddressid = PhoenixPreSeaTraineePersonal.UpdatePreSeaTraineeAddress(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                                                                            , Convert.ToInt32(Filter.CurrentPreSeaTraineeSelection)
    ...
    private bool IsValidate(string address1, string city, string state, string county
                           , string email, string mobilenumber, string prefix, string validdate)
    {
        int employeecountry;
        ...
        {
            ucError.ErrorMessage = prefix + " Address valid date reruired";
        }        
