<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaTraineeQueryActivityFilter.aspx.cs"
    Inherits="PreSeaTraineeQueryActivityFilter" %>
            ...
            <div id="divFind">
                <table cellpadding="2" cellspacing="2" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBoxList ID="cblStaus" runat="server" RepeatDirection="Vertical" DataTextField="FLDHARDNAME"
                                DataValueField="FLDHARDCODE" RepeatColumns="1" class="input" Style="width: 155px;">
                            </asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <asp:Panel ID="pnlRecordedBy" runat="server" GroupingText="Recorded By" Width="250%">
