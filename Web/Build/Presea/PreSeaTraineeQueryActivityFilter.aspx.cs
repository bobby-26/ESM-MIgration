...
public partial class PreSeaTraineeQueryActivityFilter : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            cblStaus.DataSource = PhoenixPreSeaNewApplicantManagement.ListPreSeaApplicantStatus(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                       , "CON,TRA");
            cblStaus.DataBind();
            txtName.Focus();
        }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        foreach (ListItem item in cblStaus.Items)
        {
        ...
        criteria.Add("cblStatus", strApplicantStatus);               
