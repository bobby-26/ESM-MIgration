<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreSeaTraineeSection.aspx.cs"
    Inherits="PreSeaTraineeSection" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmPreSeaSection" runat="server" autocomplete="off">
    ...
    <asp:UpdatePanel runat="server" ID="pnlSectionEntry">
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div id="divFind" style="position: relative; z-index: 2">
                    <table id="tblConfigureSection" width="100%">
                        <tr>
                            <td>
                                Batch
                            </td>
                ...
                <div class="navSelect" style="position: relative; width: 15px">
                    <eluc:TabStrip ID="MenuPreSeaSection" runat="server" OnTabStripCommand="PreSeaSection_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                <div id="divGrid" style="position: relative; z-index: 0">
                    <asp:GridView ID="gvSection" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowDataBound="gvSection_RowDataBound" EnableViewState="false"
                        OnRowDeleting="gvSection_RowDeleting" OnRowCommand="gvSection_RowCommand" ShowHeader="true"
                        ShowFooter="false">
