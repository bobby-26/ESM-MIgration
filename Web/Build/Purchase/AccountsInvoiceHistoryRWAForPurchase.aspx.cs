...
public partial class AccountsInvoiceHistoryRWAForPurchase : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Purchase/AccountsInvoiceHistoryRWAForPurchase.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void MenuOrderFormMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Purchase/AccountsInvoiceLineItemDetailsRWAForPurchase.aspx?qinvoicecode=" + ViewState["invoicecode"] + "&qcallfrom=" + ViewState["qfrom"].ToString());
            }
            ...
            {
                Response.Redirect("../Purchase/AccountsInvoiceAttachmentsRWAForPurchase.aspx?qinvoicecode=" + ViewState["invoicecode"].ToString() + "&qfrom=" + ViewState["qfrom"].ToString());
            }
            else
                MenuOrderFormMain.SelectedMenuIndex = 4;
        }
    ...
    private void SetRedirectURL()
    {
        if (ViewState["qfrom"] != null)
        {
            ...
            {
                ViewState["URL"] = "../Purchase/AccountsInvoiceMasterRWAForPurchase.aspx?qinvoicecode=";
            }
