...
public partial class PurchaseAnalysisReport : PhoenixBasePage
{
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("SHOWREPORT"))
            {
                ...
                {
                    ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=3&reportcode=ANALYSISREPORT&fromdate=" + ucFromDate.Text + "&todate=" + ucToDate.Text + "&vesselid=" + ViewState["SelectedVesselList"].ToString() + "&showmenu=0";
                }
            }
        }
        catch (Exception ex)
