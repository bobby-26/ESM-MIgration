<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseAwaitingPOApproval.aspx.cs" Inherits="PurchaseAwaitingPOApproval" %>
...
<head runat="server">
    <title>Awaiting PO Approval</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body onresize="PaneResized()" onload="PaneResized()">
    <form id="form1" runat="server">
        ...
        <table width="100%" border="0" cellpadding="10">
            ...
            <tr>
                <td>
                    <telerik:RadLabel RenderMode="Lightweight" runat="server" ID="RadLabel1" Text="Vendor"></telerik:RadLabel>
                </td>
                 <td colspan="11">
                    <telerik:RadTextBox RenderMode="Lightweight" ID="txtvendorname" runat="server" MaxLength="400"></telerik:RadTextBox>
                </td>
            </tr>
        </table>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="rgvForm" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Vendor" UniqueName="VENDOR" AllowSorting="true" SortExpression="FLDVENDORNAME">
                        <ItemStyle HorizontalAlign="Left"></ItemStyle>
                        <ItemTemplate>
