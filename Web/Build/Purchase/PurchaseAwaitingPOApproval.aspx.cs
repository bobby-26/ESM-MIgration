...
public partial class PurchaseAwaitingPOApproval : PhoenixBasePage
{
    string vesselname;
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Purchase/PurchaseAwaitingPOApproval.aspx", "Find", "search.png", "FIND");
            toolbar.AddImageButton("../Purchase/PurchaseAwaitingPOApproval.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            toolbar.AddImageButton("../Purchase/PurchaseAwaitingPOApproval.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixPurchaseSearch.AwaitingPOApprovalSearch(vesselname, txtFormNo.Text.Trim(),
              txtTitle.Text.Trim(), General.GetNullableDateTime(txtFromDate.Text)
                                                                , General.GetNullableDateTime(txtToDate.Text)
                                                                , ddlStockType.SelectedValue, txtvendorname.Text,
              sortexpression, sortdirection, 1, rgvForm.VirtualItemCount > 0 ? rgvForm.VirtualItemCount : 10,
                  ref iRowCount, ref iTotalPageCount);

        Response.AddHeader("Content-Disposition", "attachment; filename=AwaitingPOApproval.xls");
        ...
        Response.Write("<h3><center>Awaiting PO Approval</center></h3></td>");
        Response.Write("</tr>");
    ...
    protected void rgvForm_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = PhoenixPurchaseSearch.AwaitingPOApprovalSearch(General.GetNullableString(vesselname), txtFormNo.Text.Trim(), txtTitle.Text.Trim()
