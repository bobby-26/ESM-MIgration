<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseAwaitingQuotes.aspx.cs" Inherits="PurchaseAwaitingQuotes" %>
...
<head runat="server">
    <title>Awaiting Quotes</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
