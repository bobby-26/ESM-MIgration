...
public partial class PurchaseAwaitingQuotes : PhoenixBasePage
{
    string vesselname;
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Purchase/PurchaseAwaitingQuotes.aspx", "Find", "search.png", "FIND");
            toolbar.AddImageButton("../Purchase/PurchaseAwaitingQuotes.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            toolbar.AddImageButton("../Purchase/PurchaseAwaitingQuotes.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixPurchaseSearch.AwaitingQuoteSearch(vesselname, txtFormNo.Text.Trim(),
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=AwaitingQuotes.xls");
    ...
    protected void rgvForm_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = PhoenixPurchaseSearch.AwaitingQuoteSearch(General.GetNullableString(vesselname), txtFormNo.Text.Trim(), txtTitle.Text.Trim()
