...
public partial class PurchaseBulkDirectPOList : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            toolbar.AddFontAwesomeButton("../Purchase/PurchaseBulkDirectPOList.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvBulkPO')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("../Purchase/PurchaseBulkPOFilter.aspx?callfrom=directpo", "Find", "<i class=\"fas fa-search\"></i>", "FIND");
            ...
            Filter.CurrentSelectedBulkPOType = "2";
        }
    }
    ...
    private void BindData()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            ifMoreInfo.Attributes["src"] = "../Purchase/PurchaseBulkPOGeneral.aspx?ORDERID=" + ViewState["ORDERID"]+"&POTYPE=2";
        }
        else
        {
            ifMoreInfo.Attributes["src"] = "../Purchase/PurchaseBulkPOGeneral.aspx?ORDERID=&POTYPE=2";
        }
    ...
    protected void gvBulkPO_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            {
                PhoenixPurchaseBulkPurchase.BulkPOCancel(new Guid(((Label)e.Item.FindControl("lblOrderId")).Text));
                gvBulkPO.Rebind();
            }
        }
        catch (Exception ex)
    ...
    private void BindPageURL(int rowindex)
    {
        try
        {
            ...
            ifMoreInfo.Attributes["src"] = "../Purchase/PurchaseBulkPOGeneral.aspx?ORDERID=" + ViewState["ORDERID"].ToString()+"&POTYPE=2";
        }
        catch (Exception ex)
        {
            ucError.ErrorMessage = ex.Message;
