<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseBulkPOLineItemAdditionalSealNumber.aspx.cs" Inherits="PurchaseBulkPOLineItemAdditionalSealNumber" %>
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            <telerik:RadWindowManager RenderMode="Lightweight" ID="RadWindowManager1" runat="server" EnableShadow="true">
                ...
                <table width="100%" cellpadding="1" cellspacing="1">
                    <tr>
                        <td>
                            <asp:Literal ID="lblFromSerialNumber" runat="server" Text="From Serial Number"></asp:Literal>
                        </td>
                        <td>
                            <eluc:Number ID="txtFromSerialNo" runat="server" CssClass="input_mandatory" IsInteger="true" IsPositive="true" />
                            <telerik:RadTextBox ID="txtPrefix" Visible="false" runat="server" CssClass="input"></telerik:RadTextBox>
                            <eluc:Number ID="txtNoofdigits" runat="server" Visible="false" CssClass="input" IsInteger="true" IsPositive="true" />
                        </td>
                        <td>
