<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseBulkPOList.aspx.cs" Inherits="PurchaseBulkPOList" %>
            ...
            <telerik:RadPane ID="contentPane" runat="server" Scrolling="None" OnClientResized="PaneResized">
                ...
                <telerik:RadGrid RenderMode="Lightweight" ID="gvBulkPO" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                    ...
                    <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Bulk Purchase Reference Number" HeaderStyle-Width="70px" ItemStyle-Width="70px" AllowSorting="true" SortExpression="FLDFORMNUMBER">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Form Title" HeaderStyle-Width="115px" ItemStyle-Width="115px" AllowSorting="true" SortExpression="FLDFORMTITLE">
                                <ItemTemplate>
                                    <asp:Label ID="lblFormTitle" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDFORMTITLE") %>'></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Currency" HeaderStyle-Width="70px" ItemStyle-Width="70px" AllowSorting="true" SortExpression="FLDCURRENCYCODE">
                                <ItemTemplate>
                                    <asp:Label ID="lblCurrency" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCURRENCYCODE") %>'></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Vendor" HeaderStyle-Width="70px" ItemStyle-Width="70px" AllowSorting="true">
                                <ItemTemplate>
                                    <asp:Label ID="lblVendor" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDVENDORCODE") %>'></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Invoice Reference Number" HeaderStyle-Width="70px" ItemStyle-Width="70px" AllowSorting="true" SortExpression="FLDINVOICEREFERENCENUMBER">
                                <ItemTemplate>
                                    <asp:Label ID="lblInvoiceRefNo" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDINVOICEREFERENCENUMBER") %>'></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Invoice Number" AllowSorting="true" HeaderStyle-Width="30px" ItemStyle-Width="30px" SortExpression="FLDINVOICENUMBER" ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
                                    <asp:Label ID="lblInvoiceNumber" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDINVOICENUMBER") %>'></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Status" AllowSorting="true" HeaderStyle-Width="30px" ItemStyle-Width="30px" SortExpression="FLDAPPROVALSTATUS" ItemStyle-HorizontalAlign="Right">
                                <ItemTemplate>
