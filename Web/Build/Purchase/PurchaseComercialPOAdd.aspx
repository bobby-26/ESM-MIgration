<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseComercialPOAdd.aspx.cs" Inherits="PurchaseComercialPOAdd" %>
...
<body onresize="PaneResized()" onload="PaneResized()">
    <form id="form1" runat="server">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td>
                    <telerik:RadLabel RenderMode="Lightweight" runat="server" ID="lblVendor" Text="Vendor"></telerik:RadLabel>
                </td>
                <td >
                    <eluc:MultiAddress runat="server" ID="ucAddrAgent" AddressType="131" Width="98%" />
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="rgvForm" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Quoted Price" UniqueName="PRICE">
                    ...
                    <telerik:GridTemplateColumn UniqueName="ACTION" HeaderText="Action">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton runat="server" AlternateText="Add" CommandName="ADD" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.FLDORDERID") %>' ImageUrl="<%$ PhoenixTheme:images/Add.png %>"
