<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseCommittedCostBreakUp.aspx.cs" Inherits="PurchaseCommittedCostBreakUp" %>
        ...
        <ContentTemplate>                
            ...
            <div id="navigation" style="top: 0px; margin-left: 0px; vertical-align:top; width:100%; position:absolute; z-index:+1">
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <asp:Literal ID="lblCostBreakup" runat="server" Text="Committed"></asp:Literal>&nbsp;&nbsp;&nbsp;
