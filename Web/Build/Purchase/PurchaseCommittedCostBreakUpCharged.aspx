<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseCommittedCostBreakUpCharged.aspx.cs" Inherits="PurchaseCommittedCostBreakUpCharged" %>
        ...
        <ContentTemplate>                
            ...
            <div id="navigation" style="top: 0px; margin-left: 0px; vertical-align:top; width:100%; position:absolute; z-index:+1">
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <asp:Literal ID="lblCostBreakup" runat="server" Text="Charged"></asp:Literal>&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:GridView ID="gvCostBreakup" runat="server" AutoGenerateColumns="False" Font-Size="11px" 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Label ID="lblApprovalDateHeader" runat="server">Invoice Posted Date&nbsp;
                                    </asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblApprovalDate" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDATEOFPOSTING", "{0:dd/MMM/yyyy}") %>'></asp:Label>
                                </ItemTemplate>                                
                            </asp:TemplateField>
