<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseFalApproveEdit.aspx.cs" Inherits="PurchaseFalApproveEdit" %>
...
<head runat="server">
    <title>Purchase Fal Approve Edit</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">         
            ...
            <eluc:TabStrip ID="MenuPurchaseFalApproveEdit" runat="server" OnTabStripCommand="MenuPurchaseFalApproveEdit_TabStripCommand" TabStrip="true"></eluc:TabStrip>
            <table style="margin-left: 20px">
                <tr>
                    <td>
                        <telerik:RadLabel ID="RadLabel3" runat="server" Text="Level"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadLabel ID="lbllevel" runat="server"></telerik:RadLabel>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="RadLabel4" runat="server" Text="Level Name"></telerik:RadLabel>
                    </td>
                    <td>                      
                        <telerik:RadTextBox ID="lblname" runat="server"></telerik:RadTextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Number ID="lblMaximum" runat="server" Text="" DecimalPlace="2" IsInteger="true" MaxLength="10" Width="100px" CssClass="input_mandatory" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Group ID="UcGroup" runat="server" AutoPostBack="true" CssClass="input_mandatory" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Target ID="UcTarget" runat="server" AutoPostBack="true" CssClass="input_mandatory" />
                    </td>
                </tr>
