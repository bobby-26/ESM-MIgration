<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseFalLevelEdit.aspx.cs" Inherits="PurchaseFalLevelEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuFalLevelEdit" runat="server" OnTabStripCommand="MenuFalLevelEdit_TabStripCommand" TabStrip="true"></eluc:TabStrip>
            <table style="margin-left: 20px">
                <tr>
                    ...
                    <td>                                          
                         <eluc:Number ID="txtLevel" runat="server" Text="" IsInteger="true" IsPositive="true" MaxLength="3" CssClass="input_mandatory" />
                    </td>
                </tr>
