<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseFalLevelMappingAdd.aspx.cs" Inherits="PurchaseFalLevelMappingAdd" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuFalLevelMappingAdd" runat="server" OnTabStripCommand="MenuFalLevelMappingAdd_TabStripCommand" TabStrip="true"></eluc:TabStrip>
