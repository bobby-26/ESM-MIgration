<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseFalRules.aspx.cs" Inherits="PurchaseFalRules" %>
    ...
    <form id="form1" runat="server">
       ...
       <asp:Button ID="cmdHiddenSubmit" runat="server" Text="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" CssClass="hidden" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuPurchaseFalRules" runat="server" OnTabStripCommand="MenuPurchaseFalRules_TabStripCommand" />


               <telerik:RadGrid RenderMode="Lightweight" ID="gvPurchaseFalRule" runat="server" CellSpacing="0" GridLines="None" Height="88%"
                AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" EnableHeaderContextMenu="true" EnableViewState="false"
                GroupingEnabled="false" OnNeedDataSource="gvPurchaseFalRule_NeedDataSource"  OnItemDataBound="gvPurchaseFalRule_ItemDataBound"
                   OnItemCommand="gvPurchaseFalRule_ItemCommand"
                >
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel runat="server" ID="lblId" Visible="false" Text='<%#DataBinder.Eval(Container,"DataItem.FLDAPPROVALRULEID") %>'></telerik:RadLabel>
                          ...
                          <telerik:GridTemplateColumn HeaderText="Active" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lblActive" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDISACTIVE") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
