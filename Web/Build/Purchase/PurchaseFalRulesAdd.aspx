<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseFalRulesAdd.aspx.cs" Inherits="PurchaseFalRulesAdd" %>
...
<head runat="server">
    <title>Purchase Fal Rules Add</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuFalRuleAdd" runat="server" OnTabStripCommand="MenuFalRuleAdd_TabStripCommand" TabStrip="true"></eluc:TabStrip>
