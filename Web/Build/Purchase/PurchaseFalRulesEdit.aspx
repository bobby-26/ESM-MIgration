<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseFalRulesEdit.aspx.cs" Inherits="PurchaseFalRulesEdit" %>
...
<head runat="server">
    <title>Purchase Fal Rules Edit</title>
...
<body>
    ...
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuFalRuleEdit" runat="server" OnTabStripCommand="MenuFalRuleEdit_TabStripCommand" TabStrip="true"></eluc:TabStrip>
