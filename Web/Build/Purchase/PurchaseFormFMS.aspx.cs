...
public partial class PurchaseFormFMS : PhoenixBasePage
{
    string vesselname;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["FMS"] != null)
                {
                    NameValueCollection criteria = new NameValueCollection();
                    criteria.Clear();
                    criteria.Add("ucVessel", ViewState["vslid"].ToString());
                    criteria.Add("ddlStockType", null);
                    if (Request.QueryString["FILTER"] == "5")
                        criteria.Add("txtNumber", "%-9%");
                    else
                        criteria.Add("txtNumber", "%-0%");
                    criteria.Add("txtTitle", null);
                    criteria.Add("txtVendorid", null);
                    criteria.Add("txtDeliveryLocationId", null);
                    criteria.Add("txtBudgetId", null);
                    criteria.Add("txtBudgetgroupId", null);
                    criteria.Add("ucFinacialYear", null);
                    criteria.Add("ucFormState", null);
                    criteria.Add("ucApproval", null);
                    criteria.Add("UCrecieptCondition", null);
                    criteria.Add("UCPeority", null);
                    criteria.Add("ucFormStatus", Request.QueryString["STATUS"].ToString());
                    criteria.Add("ucFormType", null);
                    criteria.Add("ucComponentclass", null);
                    criteria.Add("txtMakerReference", null);
                    criteria.Add("txtOrderedDate", null);
                    criteria.Add("txtOrderedToDate", null);
                    criteria.Add("txtCreatedDate", null);
                    criteria.Add("txtCreatedToDate", null);
                    criteria.Add("txtApprovedDate", null);
                    criteria.Add("txtApprovedToDate", null);
                    criteria.Add("ddlDepartment", null);
                    criteria.Add("ddlReqStatus", null);
                    criteria.Add("ucReason4Requisition", null);
            ...
            toolbarmain.AddButton("Form", "FORM", ToolBarDirection.Left);
            ...
            if (Filter.CurrentVesselConfiguration == null || Filter.CurrentVesselConfiguration.ToString().Equals("0"))
                toolbarmain.AddButton("Quotations", "QUOTATIONS", ToolBarDirection.Left);
    ...
    protected void ShowExcel()
    {
        ...
        DataSet ds = new DataSet();
        string[] alColumns = { "FLDFORMNO", "FLDTITLE", "FLDVENDORNAME", "FLDFORMTYPENAME", "FLDFORMSTATUSNAME", "FLDSUBACCOUNT", "FLDVENDORDELIVERYDATE", "FLDSTOCKTYPE", "FLDSTOCKCLASS", "FLDSTATUS", "FLDPOSTATUS", "FLDVESSELCODE", "FLDCURRENCY", "FLDBUDGETNAME", "FLDREASONFORREQUISITIONNAME", "FLDCREATEDDATE", "FLDPURCHASEAPPROVEDATE", "FLDORDEREDDATE" };
        string[] alCaptions = { "Number", "Form Title", "Vendor", "Form Type", "Form Status", "Budget Code", "Received date", "Type", "Component Class</br>/Store Type", "Requisition Status", "PO Status", "Vessel", "Currency", "Budget", "Reason for Requisition", "Created Date", "Approved Date", "Ordered Date" };
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=OrderForm - " + vesselname + ".xls");
