...
public partial class PurchaseFormSplit : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            MenuStockItemGeneral.Title = "Split ( "+Filter.CurrentPurchaseFormNumberSelection + " )";
            ...
            if (!IsPostBack)
            {
                ...
                {
                    imgOrder.Attributes.Add("onclick", "return showPickList('spnPickListOrder', 'codehelp1', '', 'Common/CommonPickListOrder.aspx?VESSELID=" + Filter.CurrentPurchaseVesselSelection + "&STOCKTYPE=SERVICE', false);");
                }
                else
                {
    ...
    protected void InventoryStockItemGeneral_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("../Purchase/PurchaseQuotationVendorItems.aspx?quotationid=" + ViewState["quotationid"].ToString() + "&orderid=" + ViewState["orderid"].ToString()+"&pageno=1");
            }
