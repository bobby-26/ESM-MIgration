<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseMultipleVendorSelection.aspx.cs" Inherits="PurchaseMultipleVendorSelection" %>
        ...
        <ContentTemplate>
            ...
            <div id="divGrid" style="position: relative;">
                <asp:GridView ID="gvAddress" runat="server" AutoGenerateColumns="False" CellPadding="3"
                    ...
                    ShowHeader="true" Width="100%" EnableViewState="false" DataKeyNames="FLDADDRESSCODE">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:CheckBox ID="chkVendorSelect" runat="server" EnableViewState="true" OnCheckedChanged="SaveCheckedAddressValues"/>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                        ...
                        <asp:TemplateField FooterStyle-HorizontalAlign="Center">
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" AlternateText="Relation" ImageUrl="<%$ PhoenixTheme:images/annexure.png %>"
                                        CommandName="RELATION" CommandArgument="<%# Container.DataItemIndex %>" ID="cmdRelation"
