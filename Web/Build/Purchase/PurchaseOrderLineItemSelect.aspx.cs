...
public partial class Purchase_PurchaseOrderLineItemSelect : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbargrid.AddImageButton("../Purchase/PurchaseOrderLineItemSelect.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('divGrid')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Purchase/PurchaseOrderLineItemSelect.aspx", "<b>Find</b>", "search.png", "FIND");
            ...
            if (!IsPostBack)
            {
                ...
                {
                    ddlComponentClass.DataSource = PhoenixPurchaseOrderLine.GetComponentHeads(Filter.CurrentPurchaseVesselSelection);
    ...
    protected void StoreItemInOutTransaction_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../Purchase/PurchaseLineItem.aspx?orderid=" + ViewState["orderid"]+ "&VesselId=" + Filter.CurrentPurchaseVesselSelection + "&StockType=" + Filter.CurrentPurchaseStockType + "&StockClass=" + Filter.CurrentPurchaseStockClass );
            }
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            DataSet ds = PhoenixPurchaseOrderLine.SearchWantedLineItems(General.GetNullableGuid(ddlComponentClass.SelectedValue.ToString()), Filter.CurrentPurchaseVesselSelection, General.GetNullableGuid(ViewState["orderid"].ToString())
    ...
    protected void gvItemList_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            InsertOrderLineItem(
                   ((Label)_gridView.Rows[nCurrentRow].FindControl("lblStoreItemId")).Text,
    ...
    protected void gvItemList_ItemDataBound(Object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                TextBox tb = (TextBox)e.Row.FindControl("txtQuantityEdit");
                if (tb != null) tb.Focus();
            }
