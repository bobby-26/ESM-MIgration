...
public partial class PurchaseOrderLineItemSelection : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbargrid.AddImageButton("../Purchase/PurchaseOrderLineItemSelection.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('divGrid')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Purchase/PurchaseOrderLineItemSelection.aspx", "<b>Find</b>", "search.png", "FIND");   
    ...
    protected void StockItemNameClick(object sender, CommandEventArgs e)
    {
        ...
        //    BindFooterItemDetails(e.CommandArgument.ToString());
        //    ViewState["FIRSTINITIALIZED"] = false;  
        //}
        //catch (Exception ex)
        //{
        //    ucError.ErrorMessage = ex.Message;
