...
public partial class PurchaseOrderLineItemServiceSelection : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            toolbargrid.AddImageButton("../Purchase/PurchaseOrderLineItemServiceSelection.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbargrid.AddImageLink("javascript:CallPrint('divGrid')", "Print Grid", "icon_print.png", "PRINT");
            toolbargrid.AddImageButton("../Purchase/PurchaseOrderLineItemServiceSelection.aspx", "<b>Find</b>", "search.png", "FIND");   
