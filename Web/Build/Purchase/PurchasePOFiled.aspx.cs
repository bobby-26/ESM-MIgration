...
public partial class PurchasePOFiled : PhoenixBasePage
{
    string vesselname;
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixPurchaseSearch.POFiledSearch(vesselname, txtFormNo.Text.Trim(),
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=POFiled.xls");
        ...
        Response.Write("<h3><center>Filed POs</center></h3></td>");
        Response.Write("</tr>");
    ...
    protected void rgvForm_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = PhoenixPurchaseSearch.POFiledSearch(General.GetNullableString(vesselname), txtFormNo.Text.Trim(), txtTitle.Text.Trim()
        ...
        General.SetPrintOptions("rgvForm", "Filed POs", alCaptions, alColumns, ds);
    }
