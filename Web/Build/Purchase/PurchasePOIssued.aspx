<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchasePOIssued.aspx.cs" Inherits="PurchasePOIssued" %>
...
<head runat="server">
    <title>PO Issued</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
                ...
                <Columns>
                    <telerik:GridTemplateColumn HeaderText="Type" UniqueName="TYPE">
                        ...
                        <ItemTemplate>
                            ...
                            <telerik:RadLabel RenderMode="Lightweight" ID="lblInvoice" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDINVOICECODE") %>'></telerik:RadLabel>
                            <telerik:RadLabel RenderMode="Lightweight" ID="lblInvoiceNumber" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDINVOICENUMBER") %>'></telerik:RadLabel>
                        </ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Quoted Price" UniqueName="PRICE" HeaderStyle-HorizontalAlign="Right">
                        <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                        <ItemTemplate>
                            <telerik:RadLabel RenderMode="Lightweight" ID="lblQuotedPrice" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDACTUALTOTAL","{0:###,###,###,##0.00}") %>'></telerik:RadLabel>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>

                    <telerik:GridTemplateColumn HeaderText="Committed (USD)" UniqueName="COMMITTED" HeaderStyle-HorizontalAlign="Right">
                        <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn UniqueName="ACTION" HeaderText="Action">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ImageUrl="<%$ PhoenixTheme:images/document_view.png %>" ID="imgInvoice" runat="server" AlternateText="Invoice" ToolTip="Invoice" 
                                            CommandArgument='<%# DataBinder.Eval(Container,"DataItem.FLDORDERID") %>' Visible="false" CommandName="INVOICE"/>
                        <asp:ImageButton runat="server" AlternateText="Shipped" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.FLDORDERID") %>' ImageUrl="<%$ PhoenixTheme:images/annexure.png %>"
                                ID="cmdshippedquantity" ToolTip="Shipped Quantity"></asp:ImageButton>
