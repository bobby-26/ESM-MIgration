...
public partial class PurchasePOToBeIssued : PhoenixBasePage
{
    string vesselname;
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Purchase/PurchasePOToBeIssued.aspx", "Find", "search.png", "FIND");
            toolbar.AddImageButton("../Purchase/PurchasePOToBeIssued.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            toolbar.AddImageButton("../Purchase/PurchasePOToBeIssued.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixPurchaseSearch.POToBeIssuedSearch(vesselname, txtFormNo.Text.Trim(),
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=POToBeIssued.xls");
        ...
        Response.Write("<h3><center>PO To Be Issued</center></h3></td>");
        Response.Write("</tr>");
    ...
    protected void rgvForm_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = PhoenixPurchaseSearch.POToBeIssuedSearch(General.GetNullableString(vesselname), txtFormNo.Text.Trim(), txtTitle.Text.Trim()
