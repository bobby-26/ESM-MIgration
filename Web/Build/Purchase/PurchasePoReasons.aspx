<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchasePoReasons.aspx.cs" Inherits="PurchasePoReasons" %>
        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="rgvForm" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Committed (USD)" UniqueName="COMMITTED" Visible="false">
                    ...
                    <telerik:GridTemplateColumn UniqueName="ACTION" HeaderText="Action" HeaderStyle-Width="10%">
                        <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                            <asp:ImageButton runat="server" AlternateText="Port List" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.FLDORDERID") %>' ImageUrl="<%$ PhoenixTheme:images/showlist.png %>"
                                ID="cmdPortlist" ToolTip="Port List"></asp:ImageButton>
