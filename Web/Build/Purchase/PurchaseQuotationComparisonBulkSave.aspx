<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseQuotationComparisonBulkSave.aspx.cs" Inherits="Purchase_PurchaseQuotationComparisonBulkSave" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">  
        ...
        {
            UpperBound = parseInt('<%= this.gvVendor.Rows.Count %>') - 1;
            LowerBound = 0;
            SelectedRowIndex = -1;        
        }
...
<body>
    ...
    <asp:UpdatePanel runat="server" ID="pnlLineItemEntry">
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div id="divGrid" style="position: relative; z-index: 0; width: 100%;">
                    <asp:GridView ID="gvVendor" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        Width="100%" CellPadding="3" OnRowCommand="gvVendor_RowCommand" OnRowDataBound="gvVendor_ItemDataBound"
                        OnRowEditing="gvVendor_RowEditing" OnRowCancelingEdit="gvVendor_RowCancelingEdit" ShowHeader="true" EnableViewState="false"
                        ShowFooter="true">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Component">
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Label ID="lblComponentHeader" runat="server">Component</asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblComponentNo" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOMPONENT") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="gvVendor" />
        </Triggers>
    </asp:UpdatePanel>
    </form>
</body>
