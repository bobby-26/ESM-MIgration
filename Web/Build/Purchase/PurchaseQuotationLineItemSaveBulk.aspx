<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseQuotationLineItemSaveBulk.aspx.cs" Inherits="Purchase_PurchaseQuotationLineItemSaveBulk" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">  
        ...
        {
    	    var args = "function=BulkSaveQuotationLine";
    ...
    <asp:UpdatePanel runat="server" ID="pnlLineItemEntry">
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                ...
                <font color="red">
                <asp:Literal ID="lblred" runat="server" Text="red"></asp:Literal>
                                 </font>
                <asp:Literal ID="lblcolouandthenlickSaveLineitemswhicharepartiallyfilledupwillnotbeupdated" runat="server" Text="colour and then click 'Save'. Line items which are partially filled up will not be updated."></asp:Literal>
                                  </font>                
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Quoted Qty">
                                ...
                                <ItemTemplate>
                                    ...
                                    <eluc:Numeber ID="txtQuantityEdit" runat="server" Width="90px" IsPositive="true" CssClass="gridinput_mandatory"
                            ...
                            <asp:TemplateField HeaderText="Price">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="lblQuotedPrice" runat="server" Visible="false" Width="90px" Text='<%# DataBinder.Eval(Container,"DataItem.FLDQUOTEDPRICE","{0:n2}") %>'></asp:Label>
                                    <eluc:Numeber ID="txtQuotedPriceEdit" runat="server" Width="90px" CssClass="gridinput_mandatory" IsPositive="true"
                                        Text='<%# DataBinder.Eval(Container,"DataItem.FLDQUOTEDPRICE","{0:n3}") %>' DecimalPlace="3" MaxLength="16" />
                                         <%--<asp:TextBox ID="txtQuotedPriceEdit" runat="server" CssClass="txtNumber gridinput_mandatory" Width="90px"
                             ...
                             <asp:TemplateField HeaderText="Discount">
                                ...
                                <ItemTemplate>
                                    ...
                                    <eluc:Numeber ID="txtDiscountEdit" runat="server" Width="90px" CssClass="gridinput" IsPositive="true"
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <eluc:Numeber ID="txtDeliveryEdit" runat="server" Width="50px" CssClass="input" IsPositive="true"
