...
public partial class PurchaseQuotationQuoted : PhoenixBasePage
{
    string vesselname;
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Purchase/PurchaseQuotationQuoted.aspx", "Find", "search.png", "FIND");
            toolbar.AddImageButton("../Purchase/PurchaseQuotationQuoted.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            toolbar.AddImageButton("../Purchase/PurchaseQuotationQuoted.aspx", "Export to Excel", "icon_xls.png", "Excel");
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixPurchaseSearch.QuotationQuotedSearch(vesselname, txtFormNo.Text.Trim(),
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=QuotationQuoted.xls");
        ...
        Response.Write("<h3><center>Quotation Quoted</center></h3></td>");
        Response.Write("</tr>");
    ...
    protected void rgvForm_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
    {
        ...
        DataSet ds = new DataSet();
        ds = PhoenixPurchaseSearch.QuotationQuotedSearch(General.GetNullableString(vesselname), txtFormNo.Text.Trim(), txtTitle.Text.Trim()
