...
public partial class PurchaseReportDepartmentStrategy : PhoenixBasePage
{
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("SHOWREPORT"))
            {
                ...
                {
                    ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=3&reportcode=DEPTSTRATEGY&fromdate=" + ucFromDate.Text + "&todate=" + ucToDate.Text + "&showmenu=0";
                }
            }
        }
        catch (Exception ex)
