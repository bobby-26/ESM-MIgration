<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseReportPriceAnalysis.aspx.cs" Inherits="PurchaseReportPriceAnalysis" %>
...
<body>
    ...
    <div class="navigation" id="Div2" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader" style="position: relative">
            <eluc:Title runat="server" ID="Title3" Text="Price Analysis Report" ShowMenu="true">
            </eluc:Title>
