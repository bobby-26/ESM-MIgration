...
public partial class PurchaseReportPriceAnalysis : PhoenixBasePage
{
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("SHOWREPORT"))
            {
                ...
                {
                    ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=3&reportcode=PURCHASEPRICE&fromdate=" + ucFromDate.Text + "&todate=" + ucToDate.Text + "&vesselid=" + ucVessel.SelectedVessel + "&showmenu=0";
                }
            }
        }
        catch (Exception ex)
