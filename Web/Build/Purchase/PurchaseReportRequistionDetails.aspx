<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseReportRequistionDetails.aspx.cs" Inherits="Purchase_PurchaseReportRequistionDetails" %>
...
<head runat="server">
     <title>Requistion Details</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body onload="resizeFrame()">
    ...
    <div class="navigation" id="Div2" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader" style="position: relative">
            <eluc:Title runat="server" ID="Title3" Text="Requistion Details" ShowMenu="true">
            </eluc:Title>
