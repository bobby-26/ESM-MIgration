<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseReportSupplierBusiness.aspx.cs" Inherits="PurchaseReportSupplierBusiness" %>
...
<head id="Head1" runat="server">
    <title>Supplier Business Report</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
 ...
 <body onload="resizeFrame()">
        <form id="frmReportSupplierBusiness" runat="server">
        ...
        <div class="navigation" id="Div2" style="top: 0px; margin-left: 0px; vertical-align: top;
            ...
            <div class="subHeader" style="position: relative">
                <eluc:Title runat="server" ID="Title3" Text="Supplier Business Report" ShowMenu="true">
                </eluc:Title>
