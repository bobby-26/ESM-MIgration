<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseRulesAdd.aspx.cs" Inherits="PurchaseRulesAdd" %>
...
<head runat="server">
   <title>Purchase Rules Add</title>
...
<body>
    ...
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuPurchaseRuleAdd" runat="server" OnTabStripCommand="MenuPurchaseRuleAdd_TabStripCommand" TabStrip="true"></eluc:TabStrip>
            <table style="margin-left: 20px">
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="RadLabel1" runat="server" Text="Rule Name" ></telerik:RadLabel>
                        &nbsp;&nbsp;
                    </td>
                    <td>
