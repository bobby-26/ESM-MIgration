<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseSpareItemDeliveryAnalysis.aspx.cs" Inherits="Purchase_PurchaseSpareItemDeliveryAnalysis" %>
...
<%--                        <eluc:Title runat="server" ID="pageTitle" Text=""></eluc:Title>--%>
                    ...
                    <table id="tblSpare" width="100%">
                        ...
                        <td>
                            ...
                            <span id="spnPickComponent">
                                ...
                                <asp:ImageButton runat="server" ID="cmdShowComponent" ImageUrl="<%$ PhoenixTheme:images/picklist.png %>"
                                    ...
                                    Text=".." />
                                <asp:TextBox ID="txtComponentID" runat="server" Width="0px" />
                            </span>
                        </td>
                        </tr>
                    </table>
                        ...
                        <telerik:RadGrid RenderMode="Lightweight" ID="gvSpare" runat="server" AutoGenerateColumns="False" Font-Size="11px" Height="78%" EnableHeaderContextMenu="true"
                            OnItemDataBound="gvSpare_RowDataBound" OnItemCommand="gvSpare_RowCommand" Width="100%" AllowPaging="true" AllowCustomPaging="true" GroupingEnabled="false"
                            CellPadding="3" ShowHeader="true" EnableViewState="false" AllowSorting="true" OnNeedDataSource="gvSpare_NeedDataSource"
                    ...
                    AutoGenerateColumns="false" >
                        ...
                        <table runat="server" width="100%" border="0">
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn HeaderText="Price(USD" AllowSorting="true" SortExpression="FLDPRICE">
                                    <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDPRICE", "{0:n}") %>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn HeaderText="Total Price(USD)" AllowSorting="true" SortExpression="FLDTOTALPRICE">
                                     <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDTOTALPRICE","{0:n}") %>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                                  <telerik:GridTemplateColumn HeaderText="Purchased" AllowSorting="true" SortExpression="FLDORDERDDATE">
                                  <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDORDERDDATE" , "{0:dd-MM-yyyy}") %>
                                    </ItemTemplate>
                                   </telerik:GridTemplateColumn>
                                
                                <telerik:GridTemplateColumn HeaderText="Received" AllowSorting="true" SortExpression="FLDDELIVERYDATE">
                                   <ItemTemplate>
                                        <%# DataBinder.Eval(Container,"DataItem.FLDDELIVERYDATE" , "{0:dd-MM-yyyy}") %>
                                    </ItemTemplate>
                                   </telerik:GridTemplateColumn>
                                 <telerik:GridTemplateColumn HeaderText="Delivered" AllowSorting="true" SortExpression="FLDDURATION">
                                     <ItemTemplate>
