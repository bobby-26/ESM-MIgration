<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseSpareItemDeliveryAnalysisVisual.aspx.cs" Inherits="Purchase_PurchaseSpareItemDeliveryAnalysisVisual" %>
...
<head runat="server">
    ...
    <script src="../js/sn-visual/sn-visual-pie-beta-v2.js"></script>
</head>
<body>
     <script>
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <div id="delivery-1"></div>
        <div id="delivery-2"></div>
        <div id="delivery-3"></div>
    </form>
</body>
</html>
