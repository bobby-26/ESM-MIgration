<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseStasticsReport.aspx.cs" Inherits="PurchaseStasticsReport" %>
...
<head runat="server">
    <title>Purchase Stastics Report</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body onload="resizeFrame()">
    ...
    <div class="navigation" id="Div2" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader" style="position: relative">
            <eluc:Title runat="server" ID="Title3" Text="Purchase Statistics" ShowMenu="true">
            </eluc:Title>
