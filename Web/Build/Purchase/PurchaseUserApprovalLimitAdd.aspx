<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseUserApprovalLimitAdd.aspx.cs" Inherits="PurchaseUserApprovalLimitAdd" %>
...
<head runat="server">
    <title>User Approval Limit Add</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuUserApprovalAdd" runat="server" OnTabStripCommand="MenuUserApprovalAdd_TabStripCommand" TabStrip="true"></eluc:TabStrip>
