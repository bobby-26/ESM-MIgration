<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseVendorPerformancePOAmountVisual.aspx.cs" Inherits="Purchase_PurchaseVendorPerformancePOAmountVisual" %>
...
<%--                            <eluc:Title runat="server" ID="ucTitle" Text=""></eluc:Title>--%>
       ...
       <div id ="purchaseservicepoamountyearchart-1"></div>
        <div id="purchaseservicepoamountmonthchart-2"></div>
        <div id="purchaseservicepoamountvendorchart-3"></div>
        <div id="purchaseservicepoamountfleetchart-4"></div>
        <div id="purchaseservicepoamountvesselchart-5"></div>
        <div id="purchaseservicepoamountvendorlist-6"></div>
