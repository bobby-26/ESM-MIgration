<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchaseVendorperformanceDataVisual.aspx.cs" Inherits="PurchaseVendorperformanceDataVisual" %>
...
<%--                            <eluc:Title runat="server" ID="ucTitle" Text=""></eluc:Title>--%>
        ...
        <br />
        <br />
        <div id="purchaseyearchart-1"></div>
        <div id="purchasequarterchart-2"></div>
        <div id="purchasemonthchart-3"></div>
        <div id="purchasevedorservicechart-3"></div>
        <div id="purchasevedorservicechart-4"></div>
        <div id="purchasevedorservicechart-5"></div>
        <div id="purchasevedorservicechart-6"></div>
        <div id="purchasevedorservicechart-7"></div>
        <div id="purchasevedorservicechart-8"></div>
        <div id="purchasevedorservicechart-9"></div>
    </form>
