<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowActionEdit.aspx.cs" Inherits="WorkflowActionEdit" %>
...
<head runat="server">
    <title>Workflow - Action Edit</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWorkflowActionEdit" runat="server" OnTabStripCommand="MenuWorkflowActionEdit_TabStripCommand" TabStrip="true"></eluc:TabStrip>
            <table style="margin-left: 20px">
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblActionType" runat="server" Text="Action Type"></telerik:RadLabel>
                        &nbsp;&nbsp;
                    </td>
                    <td>
                        <telerik:RadLabel runat="server" ID="txtActiontype" Text="" Width="120px" ></telerik:RadLabel>
