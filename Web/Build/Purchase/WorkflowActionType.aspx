<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowActionType.aspx.cs" Inherits="WorkflowActionType" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            <eluc:TabStrip ID="MenuWFActionType" runat="server" OnTabStripCommand="MenuWFActionType_TabStripCommand" TabStrip="true" />
            ...
            <eluc:TabStrip ID="MenuWorkflowActionType" runat="server" OnTabStripCommand="MenuWorkflowActionType_TabStripCommand"></eluc:TabStrip>

            <telerik:RadGrid RenderMode="Lightweight" ID="gvWorkflowActionType" runat="server" CellSpacing="0" GridLines="None" Height="88%"
                AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" EnableHeaderContextMenu="true" EnableViewState="false"
                GroupingEnabled="false" OnNeedDataSource="gvWorkflowActionType_NeedDataSource" OnItemDataBound="gvWorkflowActionType_ItemDataBound"
                OnItemCommand="gvWorkflowActionType_ItemCommand">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="FLDACTIONTYPEID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-HorizontalAlign="Center">
                              <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel runat="server" ID="lblId" Visible="false" Text='<%#DataBinder.Eval(Container,"DataItem.FLDACTIONTYPEID") %>'></telerik:RadLabel>
