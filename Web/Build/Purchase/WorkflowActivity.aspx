<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowActivity.aspx.cs" Inherits="WorkflowActivity" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            <eluc:TabStrip ID="MenuWFActivity" runat="server" OnTabStripCommand="MenuWFActivity_TabStripCommand" TabStrip="true" />
            ...
            <table id="tblSearch">
                <tr>
                    ...
                    <td>
                        <eluc:ActivityType ID="UcActivityType" runat="server" AutoPostBack="true" AppendDataBoundItems="true" />
                    </td>
                    <td>
            ...
            <eluc:TabStrip ID="MenuWorkflowActivity" runat="server" OnTabStripCommand="MenuWorkflowActivity_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvWorkflowActivity" runat="server" CellSpacing="0" GridLines="None" Height="88%"
                AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" EnableHeaderContextMenu="true" EnableViewState="false"
                GroupingEnabled="false" OnNeedDataSource="gvWorkflowActivity_NeedDataSource" OnItemDataBound="gvWorkflowActivity_ItemDataBound"
                OnItemCommand="gvWorkflowActivity_ItemCommand">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="FLDACTIVITYID">
                    <NoRecordsTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel runat="server" ID="lblId" Visible="false" Text='<%#DataBinder.Eval(Container,"DataItem.FLDACTIVITYID") %>'></telerik:RadLabel>
