<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowActivityType.aspx.cs" Inherits="WorkflowActivityType" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            <eluc:TabStrip ID="MenuWFActivityType" runat="server" OnTabStripCommand="MenuWFActivityType_TabStripCommand" TabStrip="true" />
            ...
            <eluc:TabStrip ID="MenuWorkflowActivityType" runat="server" OnTabStripCommand="MenuWorkflowActivityType_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvWorkflowActivityType" runat="server" CellSpacing="0" GridLines="None" Height="88%"
                AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" EnableHeaderContextMenu="true" EnableViewState="false"
                GroupingEnabled="false" OnNeedDataSource="gvWorkflowActivityType_NeedDataSource" OnItemDataBound="gvWorkflowActivityType_ItemDataBound"
                OnItemCommand="gvWorkflowActivityType_ItemCommand">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="FLDACTIVITYTYPEID">
                    <NoRecordsTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle Wrap="false" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <telerik:RadLabel runat="server" ID="lblId" Visible="false" Text='<%#DataBinder.Eval(Container,"DataItem.FLDACTIVITYTYPEID") %>'></telerik:RadLabel>
