<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowActivityTypeAdd.aspx.cs" Inherits="WorkflowActivityTypeAdd" %>
...
<head runat="server">
    <title>Workflow - Activity Type Add</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWorkflowActivityTypeAdd" runat="server" OnTabStripCommand="MenuWorkflowActivityTypeAdd_TabStripCommand" TabStrip="true"></eluc:TabStrip>
            <table style="margin-left: 20px">
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txtDescription" runat="server" Text="" TextMode="MultiLine" Rows="6" Width="240px" CssClass="input_mandatory"></telerik:RadTextBox>&nbsp;&nbsp;
                    </td>
                </tr>
            </table>
