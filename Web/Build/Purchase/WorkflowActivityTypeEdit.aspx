<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowActivityTypeEdit.aspx.cs" Inherits="WorkflowActivityTypeEdit" %>
...
<head runat="server">
    <title>Workflow - Activity Type Edit</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWorkFlowActivityTypeEdit" runat="server" OnTabStripCommand="MenuWorkFlowActivityTypeEdit_TabStripCommand" TabStrip="true"></eluc:TabStrip>
