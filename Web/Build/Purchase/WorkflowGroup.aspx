<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowGroup.aspx.cs" Inherits="WorkflowGroup" %>
    ...
    <telerik:RadCodeBlock ID="Radcodeblock1" runat="server">
        ...
        <%: Styles.Render("~/bundles/css") %>
         ...
         <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvWorkflowGroup.ClientID %>"));
                }, 200);
           }
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" >
            ...
            <eluc:TabStrip ID="MenuWorkflowGroup" runat="server" OnTabStripCommand="MenuWorkflowGroup_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvWorkflowGroup" runat="server" CellSpacing="0" GridLines="None" 
                AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" EnableHeaderContextMenu="true" EnableViewState="false"
                GroupingEnabled="false" OnNeedDataSource="gvWorkflowGroup_NeedDataSource" OnItemCommand="gvWorkflowGroup_ItemCommand"
                 OnItemDataBound="gvWorkflowGroup_ItemDataBound">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle Wrap="false" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <telerik:RadLabel runat="server" ID="lblId" Visible="false" Text='<%#DataBinder.Eval(Container,"DataItem.FLDGROUPID") %>'></telerik:RadLabel>
