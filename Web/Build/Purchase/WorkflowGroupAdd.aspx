<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowGroupAdd.aspx.cs" Inherits="WorkflowGroupAdd" %>
...
<head runat="server">
     <title>Workflow - Group Add</title>
...
<body>
    ...
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWFGroupAdd" runat="server" OnTabStripCommand="MenuWFGroupAdd_TabStripCommand"  TabStrip="true"></eluc:TabStrip>
