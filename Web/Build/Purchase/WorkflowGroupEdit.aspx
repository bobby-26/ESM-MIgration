<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowGroupEdit.aspx.cs" Inherits="WorkflowGroupEdit" %>
...
<head runat="server">
    <title>Workflow - Group Edit</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWorkFlowGroupEdit" runat="server" OnTabStripCommand="MenuWorkFlowGroupEdit_TabStripCommand" TabStrip="true"></eluc:TabStrip>
