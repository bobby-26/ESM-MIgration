<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowGroupMemberAdd.aspx.cs" Inherits="WorkflowGroupMemberAdd" %>
...
<head runat="server">
    <title>Workflow - Group Member Add</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuGroupMemberAdd" runat="server" OnTabStripCommand="MenuGroupMemberAdd_TabStripCommand" TabStrip="true"></eluc:TabStrip>
            <table style="margin-left: 20px">
                <tr>
                    ...
                    <td>
                        <eluc:Group ID="UcGroup" runat="server" CssClass="input_mandatory" Width="280px" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <eluc:Target ID="UcTarget" runat="server" CssClass="input_mandatory" Width="280px" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <span id="spnPickListFleetManager">
                            <telerik:RadTextBox ID="txtMentorName" runat="server" CssClass="input_mandatory" MaxLength="160" AutoPostBack="true"
                                Width="280px">
                            </telerik:RadTextBox>
