<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowProcessGroupAdd.aspx.cs" Inherits="WorkflowProcessGroupAdd" %>
...
<head runat="server">
    <title>Workflow - Process Group Add</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWorkflowProcessGroupAdd" runat="server" OnTabStripCommand="MenuWorkflowProcessGroupAdd_TabStripCommand" TabStrip="true"></eluc:TabStrip>
         
             <telerik:RadGrid RenderMode="Lightweight" ID="gvProcessGroupAdd" runat="server" CellSpacing="0" GridLines="None"
                EnableHeaderContextMenu="true" EnableViewState="false" GroupingEnabled="false" OnNeedDataSource="gvProcessGroupAdd_NeedDataSource">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Select" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                <telerik:RadCheckBox ID="ChkGroup" runat="server"></telerik:RadCheckBox>
                            </ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Target" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle Wrap="false" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <telerik:RadLabel runat="server" ID="lblGroupId" Visible="false" Text='<%#DataBinder.Eval(Container,"DataItem.FLDGROUPID") %>'></telerik:RadLabel>
