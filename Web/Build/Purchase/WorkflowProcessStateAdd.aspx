<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowProcessStateAdd.aspx.cs" Inherits="WorkflowProcessStateAdd" %>
...
<head runat="server">
    <title>Workflow - Proces State Add</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWorkflowProcessStateAdd" runat="server" OnTabStripCommand="MenuWorkflowProcessStateAdd_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvProcessStateAdd" runat="server" CellSpacing="0" GridLines="None"
                EnableHeaderContextMenu="true" EnableViewState="false" GroupingEnabled="false" OnNeedDataSource="gvProcessStateAdd_NeedDataSource">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Select" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                <telerik:RadCheckBox ID="ChkState" runat="server"></telerik:RadCheckBox>
                            </ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="State Type" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblStateTypeId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSTATETYPEID") %>'></telerik:RadLabel>
