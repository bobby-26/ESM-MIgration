<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowStateType.aspx.cs" Inherits="WorkflowStateType" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
              <eluc:TabStrip ID="MenuWFStateType" runat="server" OnTabStripCommand="MenuWFStateType_TabStripCommand" TabStrip="true"  ></eluc:TabStrip>
            ...
            <eluc:TabStrip ID="MenuWorkformStateType" runat="server" OnTabStripCommand="MenuWorkformStateType_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvWorkflowStateType" runat="server" CellSpacing="0" GridLines="None" Height="88%"
                AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" EnableHeaderContextMenu="true" EnableViewState="false"
                GroupingEnabled="false" OnNeedDataSource="gvWorkflowStateType_NeedDataSource" OnItemDataBound="gvWorkflowStateType_ItemDataBound" OnItemCommand="gvWorkflowStateType_ItemCommand">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDSTATETYPEID" TableLayout="Fixed">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-HorizontalAlign="Center">
                            <ItemStyle Wrap="false" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <telerik:RadLabel runat="server" ID="lblId" Visible="false" Text='<%#DataBinder.Eval(Container,"DataItem.FLDSTATETYPEID") %>'></telerik:RadLabel>
