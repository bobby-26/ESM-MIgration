<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowTarget.aspx.cs" Inherits="WorkflowTarget" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="Radcodeblock1" runat="server">
        ...
        <script type="text/javascript">
           function Resize() {
               setTimeout(function () {
                   TelerikGridResize($find("<%= gvWorkflowTarget.ClientID %>"));
                }, 200);
           }
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" >
            ...
            <eluc:TabStrip ID="MenuWorkflowTarget" runat="server" OnTabStripCommand="MenuWorkflowTarget_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvWorkflowTarget" runat="server" CellSpacing="0" GridLines="None"
                AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" EnableHeaderContextMenu="true" EnableViewState="false"
                GroupingEnabled="false" OnNeedDataSource="gvWorkflowTarget_NeedDataSource" OnItemDataBound="gvWorkflowTarget_ItemDataBound" OnItemCommand="gvWorkflowTarget_ItemCommand">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="FLDTARGETID">
                    <NoRecordsTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Name" HeaderStyle-HorizontalAlign="Center">
                              <ItemStyle Wrap="false" HorizontalAlign="Left" />
                            <ItemTemplate>
                                <telerik:RadLabel runat="server" ID="lblId" Visible="false" Text='<%#DataBinder.Eval(Container,"DataItem.FLDTARGETID") %>'></telerik:RadLabel>
