<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowTargetAdd.aspx.cs" Inherits="WorkflowTargetAdd" %>
...
<head runat="server">
    <title>Workflow - Target Add</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWorkflowTargetAdd" runat="server" OnTabStripCommand="MenuWorkflowTargetAdd_TabStripCommand" TabStrip="true"></eluc:TabStrip>
