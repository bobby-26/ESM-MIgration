...
public partial class WorkflowTargetAdd : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        PhoenixToolbar toolbarmain = new PhoenixToolbar();
        toolbarmain.AddButton("Save", "SAVE", ToolBarDirection.Right);
        MenuWorkflowTargetAdd.MenuList = toolbarmain.Show();
    }


    protected void MenuWorkflowTargetAdd_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                PhoenixWorkForm.TargetInsert(PhoenixSecurityContext.CurrentSecurityContext.UserCode, Name, Shortcode, Description);
