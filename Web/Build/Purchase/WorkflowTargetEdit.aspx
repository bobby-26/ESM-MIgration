<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkflowTargetEdit.aspx.cs" Inherits="WorkflowTargetEdit" %>
...
<head runat="server">
    <title>Workflow - Target Edit</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%">
            ...
            <eluc:TabStrip ID="MenuWorkFlowTargetEdit" runat="server" OnTabStripCommand="MenuWorkFlowTargetEdit_TabStripCommand" TabStrip="true"></eluc:TabStrip>
