<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterAdminAssetType.aspx.cs" Inherits="RegisterAdminAssetType"
        ...
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <eluc:Title runat="server" ID="ucTitle" Text="Asset Category" />
                    </div>
                </div>
                <div id="divFind" style="position: relative; z-index: 2">
                    <table id="tblConfigureAdminAssetType" width="50%">
                        <tr>
                            <td>
                                Category
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlCategory" runat="server" Width="120px" CssClass="input_mandatory" AutoPostBack="true"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtSearch" runat="server" MaxLength="100" Width="120px" CssClass="input"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </div>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField FooterText="New Team Member">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:TextBox ID="txtAssetTypeNameEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDNAME") %>'
                                        CssClass="gridinput_mandatory" MaxLength="200"></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtAssetTypeNameAdd" runat="server" CssClass="gridinput_mandatory"
                            ...
                            <asp:TemplateField FooterText="Asset Type Description">
                                ...
                                <EditItemTemplate>
                                   <asp:TextBox ID="txtAssetTypeDesEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDESCRIPTION") %>'
                                        CssClass="gridinput_mandatory" MaxLength="200"></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:TextBox ID="txtAssetTypeDesAdd" runat="server" CssClass="gridinput_mandatory"
                            ...
                            <asp:TemplateField>
                                ...
                                <EditItemTemplate>                                      
                                    <asp:DropDownList ID="ddlItemTypeEdit" runat="server" CssClass="input_mandatory" Width="120px" AutoPostBack="true" DataTextField="FLDNAME" DataValueField="FLDADMITEMTYPEID">
                                    </asp:DropDownList>
                                    <asp:Label ID="lblItemTypeEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDITEMTYPE") %>' Visible="false"></asp:Label>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:DropDownList ID="ddlItemTypeAdd" runat="server" CssClass="input_mandatory" Width="120px" AutoPostBack="true" DataTextField="FLDNAME" DataValueField="FLDADMITEMTYPEID">
                                    </asp:DropDownList>
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                ...
                                <EditItemTemplate>                                      
                                    <asp:DropDownList ID="ddlAssetAssemblyEdit" runat="server" CssClass="input_mandatory" Width="120px" AutoPostBack="true" DataTextField="FLDNAME" DataValueField="FLDPARENTID">
                                    </asp:DropDownList>
                                    <asp:Label ID="lblParentId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPARENTID") %>' Visible="false"></asp:Label>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <asp:DropDownList ID="ddlAssetAssemblyAdd" runat="server" CssClass="input" Width="120px" AutoPostBack="true" DataTextField="FLDNAME" DataValueField="FLDPARENTID">
                                    </asp:DropDownList>
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
