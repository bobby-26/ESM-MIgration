...
public partial class RegisterAdminAssetType : PhoenixBasePage
{
    ...
    protected void ShowExcel()
    {
        ...
        ds = PhoenixRegistersAssetType.SearchAssetType(txtSearch.Text, General.GetNullableInteger(ddlCategory.SelectedValue), sortexpression, sortdirection,
    ...
    private void BindData()
    {
        ...
        ds = PhoenixRegistersAssetType.SearchAssetType(txtSearch.Text, General.GetNullableInteger(ddlCategory.SelectedValue), sortexpression, sortdirection, Int32.Parse(ViewState["PAGENUMBER"].ToString()), General.ShowRecords(null), ref iRowCount, ref iTotalPageCount);
    ...
    protected void gvAssetType_RowEditing(object sender, GridViewEditEventArgs de)
    {
        try
        {
            ...
            BindData();
            ((TextBox)_gridview.Rows[de.NewEditIndex].FindControl("txtAssetTypeNameEdit")).Focus();
            SetPageNavigator();
        }
        catch (Exception ex)
        {
    ...
    protected void gvAssetType_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                if (!IsValidTeamName(((TextBox)_gridView.FooterRow.FindControl("txtAssetTypeNameAdd")).Text
                    , ((TextBox)_gridView.FooterRow.FindControl("txtAssetTypeDesAdd")).Text
                    , ((DropDownList)_gridView.FooterRow.FindControl("ddlItemTypeAdd")).SelectedValue
                    , ((DropDownList)_gridView.FooterRow.FindControl("ddlAssetAssemblyAdd")).SelectedValue
                    )
                   )
                {
                    ucError.Visible = true;
                ...
                InsertAssetType(
                    ((TextBox)_gridView.FooterRow.FindControl("txtAssetTypeNameAdd")).Text
                    , ((TextBox)_gridView.FooterRow.FindControl("txtAssetTypeDesAdd")).Text
                    , General.GetNullableInteger(ddlCategory.SelectedValue)
                    , General.GetNullableInteger(((DropDownList)_gridView.FooterRow.FindControl("ddlItemTypeAdd")).SelectedValue)
                    , General.GetNullableInteger(((DropDownList)_gridView.FooterRow.FindControl("ddlAssetAssemblyAdd")).SelectedValue)
                    );
                BindData();
            }
            if (e.CommandName.ToUpper().Equals("SAVE"))
            {
                if (!IsValidTeamName(((TextBox)_gridView.Rows[nCurrentRow].FindControl("txtAssetTypeNameEdit")).Text
                    , ((TextBox)_gridView.Rows[nCurrentRow].FindControl("txtAssetTypeDesEdit")).Text
                    , ((DropDownList)_gridView.Rows[nCurrentRow].FindControl("ddlItemTypeEdit")).SelectedValue
                    , ((DropDownList)_gridView.Rows[nCurrentRow].FindControl("ddlAssetAssemblyEdit")).SelectedValue
                    )
                )
                {
                    ucError.Visible = true;
                ...
                UpdateAssetType(
                    ...
                    , ((TextBox)_gridView.Rows[nCurrentRow].FindControl("txtAssetTypeNameEdit")).Text
                    , ((TextBox)_gridView.Rows[nCurrentRow].FindControl("txtAssetTypeDesEdit")).Text
                    , General.GetNullableInteger(ddlCategory.SelectedValue)
                    , General.GetNullableInteger(((DropDownList)_gridView.Rows[nCurrentRow].FindControl("ddlItemTypeEdit")).SelectedValue)
                    , General.GetNullableInteger(((DropDownList)_gridView.Rows[nCurrentRow].FindControl("ddlAssetAssemblyEdit")).SelectedValue)
                    );
                _gridView.EditIndex = -1;
                BindData();
            }
    ...
    protected void gvAssetType_RowDataBound(Object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                DropDownList ddlItemTypeEdit = (DropDownList)e.Row.FindControl("ddlItemTypeEdit");
                ...
                DropDownList ddlAssetAssemblyEdit = (DropDownList)e.Row.FindControl("ddlAssetAssemblyEdit");
            ...
            {
                DropDownList ddlItemTypeAdd = (DropDownList)e.Row.FindControl("ddlItemTypeAdd");
                ...
                DropDownList ddlAssetAssemblyAdd = (DropDownList)e.Row.FindControl("ddlAssetAssemblyAdd");
