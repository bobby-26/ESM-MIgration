<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterChartererList.aspx.cs" Inherits="RegisterChartererList" %>
                        ...
                        <tr>
                            <td colspan="2">
                                <div id="dvRanklist" runat="server" class="input" style="overflow: auto; width: 99%;
                                    ...
                                    <telerik:RadCheckBoxList ID="chkChartererList" runat="server"  Columns="2">
