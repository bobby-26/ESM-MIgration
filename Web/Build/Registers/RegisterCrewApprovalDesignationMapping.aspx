<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterCrewApprovalDesignationMapping.aspx.cs" Inherits="Registers_RegisterCrewApprovalDesignationMapping" %>
...
<body>
    ...
    <telerik:RadAjaxPanel ID="panel1" runat="server" Height="100%">
        ...
        <table id="tblConfiguremoccategory">
            <tr>
                <td style="padding-right: 20px">
                    <telerik:RadLabel ID="lblApproverRole" runat="server" Text="Approver Role">
                    </telerik:RadLabel>
                </td>
                <td>
        ...
        <eluc:TabStrip ID="MenuRegistersDesignation" runat="server" OnTabStripCommand="MenuRegistersDesignation_TabStripCommand">
        </eluc:TabStrip>
        <telerik:RadGrid ID="gvCrewDesignation" runat="server" AutoGenerateColumns="False"
            Font-Size="11px" Width="100%" CellPadding="3" OnItemCommand="gvCrewDesignation_ItemCommand"
            OnItemDataBound="gvCrewDesignation_ItemDataBound"
            OnNeedDataSource="gvCrewDesignation_NeedDataSource" AllowSorting="true"
            ShowFooter="false" Height="30%" ShowHeader="true" EnableViewState="false" 
