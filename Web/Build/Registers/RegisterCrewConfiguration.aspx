<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterCrewConfiguration.aspx.cs" Inherits="RegisterCrewConfiguration" %>
...
<body>
    <form id="frmRegistersCrew" runat="server" submitdisabledcontrols="true">
        <telerik:RadScriptManager runat="server" ID="RadScriptManager2" />
        <telerik:RadSkinManager runat="server" ID="RadSkinManager1" />
        <telerik:RadWindowManager runat="server" ID="RadWidowManager1"></telerik:RadWindowManager>
        <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server" DecoratedControls="All" EnableRoundedCorners="true" />
        <telerik:RadAjaxPanel ID="RadAjaxPanel" runat="server" Height="80%">
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
            <eluc:Status runat="server" ID="ucStatus" />
            <asp:Button runat="server" ID="cmdHiddenSubmit" OnClick="cmdHiddenSubmit_Click" />
            <eluc:TabStrip ID="MenuRegistersCrew" runat="server" OnTabStripCommand="MenuRegistersCrew_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrew" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" OnItemCommand="gvCrew_ItemCommand" OnNeedDataSource="gvCrew_NeedDataSource" Height="99%"
                OnItemDataBound="gvCrew_ItemDataBound" EnableViewState="true" GroupingEnabled="false" EnableHeaderContextMenu="true" ShowFooter="false"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Code" HeaderStyle-Width="20%">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Description" HeaderStyle-Width="40%">
                            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle"></HeaderStyle>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Active" HeaderStyle-Width="20%">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblisactive" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDACTIVEYESNO") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
