<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterDocumentAcceptInstituteList.aspx.cs" Inherits="Registers_RegisterDocumentAcceptInstituteList" %>
        ...
        <telerik:RadAjaxPanel ID="radajaxpanel1" runat="server" Height="80%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvOwner" runat="server" Height="" AllowCustomPaging="true" AllowSorting="true" AllowPaging="false"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="FLDADDRESSCODE">
                    <NoRecordsTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Institute Name" HeaderStyle-Width="75px" AllowFiltering="true" UniqueName="FLDNAME" 
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblgroupid" Visible="false" runat="server" Text='<%# (DataBinder.Eval(Container,"DataItem.FLDADDRESSCODE").ToString()) %>'></telerik:RadLabel>

                                <telerik:RadLabel ID="lblExpiry" runat="server" Text='<%# (DataBinder.Eval(Container,"DataItem.FLDNAME").ToString()) %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
