<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterDocumentUserWaiverList.aspx.cs" Inherits="Registers_RegisterDocumentUserWaiverList" %>
        ...
        <telerik:RadAjaxPanel ID="radajaxpanel1" runat="server" Height="80%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvOwner" runat="server" Height="" AllowCustomPaging="true" AllowSorting="true" AllowPaging="false"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="FLDGROUPCODE">
                    <NoRecordsTemplate>
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="User Group" HeaderStyle-Width="75px" AllowFiltering="true" UniqueName="FLDNAME" 
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblgroupid" Visible="false" runat="server" Text='<%# (DataBinder.Eval(Container,"DataItem.FLDGROUPCODE").ToString()) %>'></telerik:RadLabel>

                                <telerik:RadLabel ID="lblExpiry" runat="server" Text='<%# (DataBinder.Eval(Container,"DataItem.FLDGROUPNAME ").ToString()) %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
