...
public partial class Registers_RegisterDocumentUserWaiverList : PhoenixBasePage
{
    ...
    {
        DataTable dt = PhoenixRegisterDocumentRankGroup.DocumentUserWaiverList(General.GetNullableInteger(ViewState["DOCUMENTCOURSEID"].ToString()), ViewState["TYPE"].ToString());
    ...
    protected void MenuRankList_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("SAVE"))
        {
            ...
            {
                bool result = false;
                index = int.Parse(gvrow.GetDataKeyValue("FLDGROUPCODE").ToString());
            ...
            if (ViewState["TYPE"].ToString().ToUpper().Equals("COURSE"))
            {
                PhoenixRegisterCrewList.UpdateDocumentCourseList(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                          , Int16.Parse(ViewState["DOCUMENTCOURSEID"].ToString()), null, selecteduser);
            }
            if (ViewState["TYPE"].ToString().ToUpper().Equals("LICENSE"))
            {
                PhoenixRegisterCrewList.UpdateDocumentLicenseList(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                                , Int16.Parse(ViewState["DOCUMENTCOURSEID"].ToString()), null, null, null, null, null, null, null, null, null, null, null, selecteduser);
            }
            ...
            if (ViewState["TYPE"].ToString().ToUpper().Equals("MEDICAL"))
            {
                PhoenixRegisterCrewList.UpdateDocumentMedicalList(PhoenixSecurityContext.CurrentSecurityContext.UserCode
                   , Int16.Parse(ViewState["DOCUMENTCOURSEID"].ToString()), null, null, null, null, null, null, null, null, null, null,  selecteduser);
            }
