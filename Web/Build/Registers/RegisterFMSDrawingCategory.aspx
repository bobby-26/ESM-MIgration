<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterFMSDrawingCategory.aspx.cs"
    Inherits="RegisterFMSDrawingCategory" %>
...
<body>
    ...
    <telerik:RadAjaxPanel ID="panel1" runat="server" Height="100%">
        ...
        <telerik:RadGrid ID="gvFMSCategory" runat="server" AutoGenerateColumns="False" Font-Size="11px"
            ...
            ShowHeader="true" EnableViewState="false" AllowSorting="true" OnSorting="gvFMSCategory_Sorting"
            ...
            <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage"
                ...
                <Columns>
                    <telerik:GridTemplateColumn HeaderText="Code">
                        ...
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblShortCode" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDRAWINGCODE") %>'
                                Width="50px">
                            </telerik:RadLabel>
                        </ItemTemplate>                       
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="Drawing Category" AllowSorting="true" SortExpression="FLDDRAWINGCATEGORY">
                        <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                        <HeaderStyle Width="75%" HorizontalAlign="Left" VerticalAlign="Middle"></HeaderStyle>
                        <ItemTemplate>
                            <telerik:RadLabel ID="lblCategory" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDRAWINGCATEGORY") %>'>
                            </telerik:RadLabel>
                            <telerik:RadLabel ID="lblCategoryId" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDFMSDRAWINGCATEGORY") %>'
                                Visible="false">
                            </telerik:RadLabel>
                        </ItemTemplate>                       
                    </telerik:GridTemplateColumn>
