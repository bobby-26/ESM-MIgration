<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterFlagList.aspx.cs" Inherits="RegisterFlagList" %>
                        ...
                        <tr>
                            <td colspan="2">
                                <div id="dvRanklist" runat="server" class="input" style="overflow: auto; width: 99%;
                                    ...
                                    <telerik:RadCheckBoxList ID="ddlflag" runat="server"  Columns="3">
