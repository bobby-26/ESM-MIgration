...
public partial class Registers_RegisterPOSHProjectLineItemPurchaseOrderAdd : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddImageButton("../Registers/RegisterPOSHProjectLineItemPurchaseOrderAdd.aspx", "Filter", "search.png", "FIND");
            toolbargrid.AddImageButton("../Registers/RegisterPOSHProjectLineItemPurchaseOrderAdd.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void gvGrid_ItemCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            if (e.CommandName.ToUpper() == "ADD")
            {
                ...
                {
                    PhoenixRegisterPOSHProjectCode.InsertPurchaseLineItem(new Guid(lblCommittedcostbreakupid), General.GetNullableInteger(ViewState["PROJECTID"].ToString()));
    ...
    protected void BindData()
    {
        ...
        dt = PhoenixRegisterPOSHProjectCode.PurchaseLineItemAddSearch(General.GetNullableInteger(ViewState["PROJECTID"].ToString())
