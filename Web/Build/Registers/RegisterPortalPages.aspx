<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterPortalPages.aspx.cs" Inherits="Registers_RegisterPortalPages" %>
            ...
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
                    ...
                    <table id="tblConfigureQuick" >
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="cmbpages" runat="server" AutoPostBack="true" OnSelectedIndexChanged="cmdSearch_Click"
                                DataSource='<%# PhoenixRegistersQuick.ListQuick(1,197) %>'
                    ...
                    <HeaderStyle Width="102px" />
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn FooterText="New Short"  HeaderText="Code"   AllowSorting="true" SortExpression="FLDSHORTNAME">
                                ...
                                <HeaderTemplate>
                                    <telerik:RadLabel ID="lblQuickCodeHeader" Visible="true" runat="server">
                                        <asp:ImageButton runat="server" ID="cmdAbbreviation" OnClick="cmdSearch_Click" CommandName="FLDPAGESHORTCODE"
                                            ImageUrl="<%$ PhoenixTheme:images/spacer.png %>" />
                                    </telerik:RadLabel>
                                   
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkShortName" runat="server" CommandName="EDIT" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPAGESHORTCODE") %>'></asp:LinkButton>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <telerik:RadTextBox ID="txtShortNameEdit" runat="server" Width="100%" CssClass="gridinput_mandatory" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPAGESHORTCODE") %>'></telerik:RadTextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                            ...
                            <telerik:GridTemplateColumn FooterText="New Quick"  HeaderText="Name"   AllowSorting="true" SortExpression="FLDPAGENAME"   >
                                <ItemStyle Wrap="False" HorizontalAlign="Left" ></ItemStyle>
                                <HeaderStyle Wrap="true" HorizontalAlign="Left" Width="55%"/>
                                <FooterStyle Wrap="true" HorizontalAlign="Left" />
                                
                                <ItemTemplate>
                                    <telerik:RadLabel ID="lblQuickTypeCode" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPORTALPAGES") %>'></telerik:RadLabel>
                                    ...
                                    <telerik:RadLabel ID="lblQuickName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPAGENAME") %>'></telerik:RadLabel>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <telerik:RadLabel ID="lblQuickTypeCodeEdit" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPORTALPAGES") %>'></telerik:RadLabel>
                                    ...
                                    <telerik:RadTextBox ID="txtQuickNameEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPAGENAME") %>' Width="100%"
                             ...
                             <telerik:GridTemplateColumn FooterText="Sort order"  HeaderText="Sort Order"   AllowSorting="true" SortExpression="FLDSORTORDER"   >
                                <ItemStyle Wrap="False" HorizontalAlign="Left" ></ItemStyle>
                                <HeaderStyle Wrap="true" HorizontalAlign="Left" Width="55%"/>
                                <FooterStyle Wrap="true" HorizontalAlign="Left" />
                                ...
                                <ItemTemplate>
                                    ...
                                    <telerik:RadLabel ID="lblsortnum" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSORTORDER") %>'></telerik:RadLabel>
                                </ItemTemplate>
                                <EditItemTemplate>
                                   
                                    <telerik:RadTextBox ID="txtsortorderEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSORTORDER") %>' Width="100%"
                                        CssClass="gridinput_mandatory" MaxLength="200"></telerik:RadTextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                                    <telerik:RadTextBox ID="txtsortorderAdd" runat="server" CssClass="gridinput_mandatory" MaxLength="200" Width="100%"
                                        ToolTip="Enter Quick Name"></telerik:RadTextBox>
                                </FooterTemplate>
                            </telerik:GridTemplateColumn>
