<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterProsperCardstatusAdd.aspx.cs" Inherits="RegisterProsperCardstatusAdd" MaintainScrollPositionOnPostback="true" %>
    ...
    <telerik:RadScriptManager runat="server" ID="RadScriptManager1" />
        ...
        <table cellpadding="3" cellspacing="3">
            <tr>
                ...
                <td>
                    <telerik:RadTextBox ID="txtCode" runat="server" Enabled="true" CssClass="input_mandatory" Width="110%"></telerik:RadTextBox>
                </td>
            </tr>
            <tr>
                <td>
