<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterProsperCardstatusMappingEdit.aspx.cs" Inherits="RegisterProsperCardstatusMappingEdit" %>
    ...
    <form id="frmcardstatus" runat="server">
        ...
        <table cellpadding="3" cellspacing="3">
            ...
            <tr>
                ...
                <td>
                    <eluc:Rank ID="ucRank" runat="server" AppendDataBoundItems="false" Visible="false" AutoPostBack="false"
                            CssClass="dropdown_readonly" Width="110%" />
                    <telerik:RadTextBox ID="txtrank" runat="server" Enabled="false" ReadOnly="true" CssClass="readonlytextbox" Width="110%"></telerik:RadTextBox>
                </td>
            </tr>
            <tr>
                <td>
