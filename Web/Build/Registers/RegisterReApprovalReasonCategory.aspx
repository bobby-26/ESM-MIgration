<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterReApprovalReasonCategory.aspx.cs"
    Inherits="Registers_RegisterReApprovalReasonCategory" %>
...
<head runat="server">
    <title>ReEmployment Category</title>
...
<body>
    <form id="frmRegistersCategory" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel" runat="server" Height="93%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCategory" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" OnItemCommand="gvCategory_ItemCommand" OnNeedDataSource="gvCategory_NeedDataSource" Height="88%"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Category Name" HeaderStyle-Width="300px">
                            ...
                            <HeaderTemplate>
                                <asp:LinkButton ID="lblHeader" runat="server" CommandName="Sort" CommandArgument="FLDCATEGORYNAME">Name&nbsp;</asp:LinkButton>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="lnkFlagName" runat="server" CommandName="EDIT" 
                            ...
                            <EditItemTemplate>
                                ...
                                <telerik:RadTextBox ID="txtCategory" runat="server" CssClass="input_mandatory" Width="50%" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCATEGORYNAME") %>'></telerik:RadTextBox>
                            </EditItemTemplate>
                            <FooterTemplate>
                                <telerik:RadTextBox ID="txtCategoryFooter" runat="server" CssClass="input_mandatory" Width="50%"></telerik:RadTextBox>
                            </FooterTemplate>
