<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterTrainingAdd.aspx.cs" Inherits="Registers_RegisterTrainingAdd" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="margin-left: 0px">
            ...
            <eluc:TabStrip ID="TabstripTrainingaddmenu" runat="server" OnTabStripCommand="Trainingaddmenu_TabStripCommand"
                TabStrip="true" />
            <br />
            <table style="margin-left: 20px">
                <tr>
                    ...
                    <td colspan="5">
                        <telerik:RadTextBox ID="RadTrainingnameentry" runat="server" Width="240px" CssClass="input_mandatory">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
