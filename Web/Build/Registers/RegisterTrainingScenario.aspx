<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegisterTrainingScenario.aspx.cs" Inherits="Registers_RegisterTrainingScenario" %>
    ...
    <form id="form1" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" >
            ...
            <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="gvScenariolist" AutoGenerateColumns="false"
                AllowPaging="true" AllowCustomPaging="true" OnNeedDataSource="gvScenariolist_NeedDataSource" 
                ...
                <MasterTableView EditMode="InPlace" DataKeyNames="FLDSCENARIOID" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Training" DataField="FLDTRAININGNAME" UniqueName="FLDTRAININGNAME" FilterControlWidth="100px" FilterDelay="2000"
