<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersAddressAssessmentQuestionAdd.aspx.cs" Inherits="Registers_RegistersAddressAssessmentQuestionAdd" %>
...
<head runat="server">
    <title>Institute Assessment Question</title>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblremark" Text="Remarks required" runat="server"></telerik:RadLabel>
                    </td>
                    <td>
                        <asp:CheckBox ID="chkremark" runat="server" /></td>
                </tr>
                <tr>
                    <td>
