...
public partial class Registers_RegistersAdminAmcHistory : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddImageButton("../Registers/RegistersAdminAmcHistory.aspx", "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("javascript:CallPrint('gvAdminAMC')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageButton("../Registers/RegistersAdminAmcHistory.aspx", "Find", "search.png", "FIND");
            toolbar.AddImageButton("../Registers/RegistersAdminAmcHistory.aspx", "Clear Filter", "clear-filter.png", "RESET");
    ...
    protected void Asset_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Response.Redirect("../Registers/RegistersAdminAmc.aspx?ZONEID=" + ViewState["ZONEID"].ToString(), false);
            }
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDNAME", "FLDADDRESSNAME", "FLDPOREFERENCE", "FLDDURATION", "FLDNEXTDUE", "FLDLASTDONE", "FLDSTATUSNAME" };
        string[] alCaptions = { "Asset", "Address", "Po Reference", "Duration", "Next due", "Last done", "Active" };
        ...
        ds = PhoenixAdministrationAssetAMC.SearchAssetAMCHistory(txtAssetName.Text, new Guid(ViewState["ASSETID"].ToString()), General.GetNullableInteger(ViewState["ZONEID"].ToString()), sortdirection, sortexpression, Int32.Parse(ViewState["PAGENUMBER"].ToString()), General.ShowRecords(null),
    ...
    protected void gvAdminAMC_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                Guid? AssetAMCID = General.GetNullableGuid(((Label)_gridView.Rows[nCurrentRow].FindControl("lblAssetAMCID")).Text);
                PhoenixAdministrationAssetAMC.DeleteAssetAMC(AssetAMCID);
                BindData();
                SetPageNavigator();
            }
        }
    ...
    private bool IsValidAMC(string AssetId, string AddressCode)
    {
    ...
    protected void gvAdminAMC_ItemDataBound(Object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            {
                imgAssetNameEdit.Attributes.Add("onclick", "return showPickList('spnAssetNameEdit', 'codehelp1', '', '../Common/CommonPickListAdminAssetName.aspx?CategoryType=" + 1 + "', true);");
            }
        }
        if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            {
                imgAssetNameAdd.Attributes.Add("onclick", "return showPickList('spnAssetNameAdd', 'codehelp1', '', '../Common/CommonPickListAdminAssetName.aspx?CategoryType=" + 1 + "', true);");
            }
        }
    }
