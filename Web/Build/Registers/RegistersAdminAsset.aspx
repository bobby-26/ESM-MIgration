<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersAdminAsset.aspx.cs" 
    Inherits="RegisterAdminAsset" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <asp:GridView ID="gvAdminAsset" runat="server" AutoGenerateColumns="false" Font-Size="11px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" AlternateText="User" ImageUrl="<%$ PhoenixTheme:images/vendor.png %>"
                                        CommandName="User" CommandArgument='<%# Container.DataItemIndex %>' ID="cmdUser"
                                        ToolTip="User"></asp:ImageButton>
