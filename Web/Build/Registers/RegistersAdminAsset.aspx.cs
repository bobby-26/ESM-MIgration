...
public partial class RegisterAdminAsset : PhoenixBasePage
{
    ...
    protected void gvAdminAsset_RowDataBound(Object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            //ImageButton cmdUser = (ImageButton)e.Row.FindControl("cmdUser");
            //if (cmdUser != null)
            //{
            //    if (drv["FLDITEMTYPE"].ToString() == "1")
            //    {
            //        cmdUser.Visible = SessionUtil.CanAccess(this.ViewState, cmdUser.CommandName);
            //        cmdUser.Attributes.Add("onclick", "Openpopup('codehelp1', '', '../Registers/RegistersAdminAssetUserMapping.aspx?ASSETID=" + drv["FLDASSETID"].ToString() + "&ASSETNAME=" + drv["FLDNAME"] + "');return false;");
            //        cmdUser.Visible = true;
            //    }
            //    else
            //    {
            //        cmdUser.Visible = SessionUtil.CanAccess(this.ViewState, cmdUser.CommandName);
            //        cmdUser.Visible = false;
            //    }
            //}
        }
    }
