<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersAdminAssetHardwareItem.aspx.cs" Inherits="Registers_RegistersAdminAssetHardwareItem" %>
                    ...
                    <asp:GridView ID="gvAdminAssetItems" runat="server" AutoGenerateColumns="false" Font-Size="11px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    <asp:ImageButton runat="server" AlternateText="Scrap" ImageUrl="<%$ PhoenixTheme:images/move-confirm.png %>"
                                                CommandName="SCRAPITEM" CommandArgument='<%# Container.DataItemIndex %>' ID="cmdScrapItem"
                                                ToolTip="Scrap"></asp:ImageButton>
                                    <img id="Img2" runat="server" alt="" src="<%$ PhoenixTheme:images/spacer.png %>"
                                        width="3" />
                                    <asp:ImageButton runat="server" AlternateText="Add Item" ImageUrl="<%$ PhoenixTheme:images/move_items.png %>"
                                                CommandName="ADDITEM" CommandArgument='<%# Container.DataItemIndex %>' ID="cmdAddItems"
