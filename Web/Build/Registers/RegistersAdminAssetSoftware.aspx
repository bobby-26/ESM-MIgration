<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersAdminAssetSoftware.aspx.cs" Inherits="RegistersAdminAssetSoftware" %>
...
<head runat="server">
 <title>Asset Software</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div>
                    ...
                    <tr>
                        ...
                        <td width="25.4%">
                            <eluc:Number ID="ucLicense" runat="server" CssClass="input" MaxLength="3" Width="35px" />
                        </td>
                        <td width="8%">
