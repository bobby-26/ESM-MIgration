<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersAdminAssetSoftwareAdd.aspx.cs" Inherits="RegistersAdminAssetSoftwareAdd" %>
...
<head runat="server">
     <title>Software</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <ContentTemplate>
            <div style="z-index: 1;">
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <eluc:Title runat="server" ID="ucTitle" Text="Software" ShowMenu="false" />
                    </div>
                </div>
                <div class="Header">
                ...
                <table cellpadding="1" cellspacing="1" width="100%">
                  <tr>
                    ...
                    <tr>
                        <td width="20%">
                            <asp:Literal ID="lblIdentificationNumber" runat="server" Text="Identification Number"></asp:Literal> 
                        </td>
                        <td width="30%">
