<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersBudgetOwnerCodeReport.aspx.cs" Inherits="Registers_RegistersBudgetOwnerCodeReport" %>
        ...
        <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
            ...
            <div>
                <table width="50%">
                    <tr>
                        <td>
                            <telerik:RadLabel ID="lblAddress" runat="server" Text="Owner" ></telerik:RadLabel>
                        </td>
                        <td>
