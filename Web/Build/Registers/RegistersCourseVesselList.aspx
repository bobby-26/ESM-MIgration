<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersCourseVesselList.aspx.cs" Inherits="Registers_RegistersCourseVesselList" %>
...
<head runat="server">
    ...
    <telerik:RadCodeBlock ID="Radcodeblock2" runat="server">
        ...
        <script type="text/javascript">
            function Resize() {
                setTimeout(function () {
                    TelerikGridResize($find("<%= gvVessel.ClientID %>"));
                }, 200);
            }
...
<body>
    ...
    <form id="frmRanklist" runat="server">
        ...
        <eluc:TabStrip ID="MenuRankList" runat="server" OnTabStripCommand="MenuRankList_TabStripCommand" TabStrip="true"></eluc:TabStrip>

        <telerik:RadAjaxPanel ID="radajaxpanel1" runat="server">
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
            <eluc:Status ID="ucStatus" runat="server"></eluc:Status>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvVessel" runat="server" Height="" AllowCustomPaging="true" AllowSorting="true" AllowPaging="false"
                CellSpacing="0" GridLines="None" EnableViewState="false" OnNeedDataSource="gvVessel_NeedDataSource"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Vessel Name" HeaderStyle-Width="75px">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblgroupid" Visible="false" runat="server" Text='<%# (DataBinder.Eval(Container,"DataItem.FLDVESSELID").ToString()) %>'></telerik:RadLabel>

                                <telerik:RadLabel ID="lblExpiry" runat="server" Text='<%# (DataBinder.Eval(Container,"DataItem.FLDVESSELNAME").ToString()) %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
