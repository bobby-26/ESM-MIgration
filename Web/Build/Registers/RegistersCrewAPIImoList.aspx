<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersCrewAPIImoList.aspx.cs" Inherits="RegistersCrewAPIImoList" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="95%">
            ...
            <table width="100%" cellpadding="2" cellspacing="2">
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblImono" runat="server" Text="IMO Number"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadTextBox ID="txtIMONumber" runat="server"></telerik:RadTextBox>
                    </td>
                </tr>
            </table>
            <eluc:TabStrip ID="gvValidIMOTab" runat="server" OnTabStripCommand="gvValidIMOTab_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvValidIMO" Height="82%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" ShowFooter="True" EnableViewState="false" OnSortCommand="gvValidIMO_SortCommand"
                OnNeedDataSource="gvValidIMO_NeedDataSource" OnItemCommand="gvValidIMO_ItemCommand" OnItemDataBound="gvValidIMO_ItemDataBound"
                OnUpdateCommand="gvValidIMO_UpdateCommand" OnDeleteCommand="gvValidIMO_DeleteCommand">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Vessel" HeaderStyle-Width="200px" AllowSorting="false">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblVessel" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDVESSELNAME") %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <FooterTemplate>
                                <eluc:Vessel ID="ucVessel" runat="server" Width="264" Entitytype="VSL"   VesselList="<%#PhoenixRegistersVessel.ListVessel() %>" VesselsOnly="true" ActiveVesselsOnly="true" AppendDataBoundItems="true" AssignedVessels="true" />                                 
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="IMO Number" HeaderStyle-Width="200px" AllowSorting="false">
                            <ItemTemplate>
                            ...
                            <EditItemTemplate>
                                <telerik:RadTextBox ID="lblIMONumberEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDIMONUMBER") %>'></telerik:RadTextBox>
                                <telerik:RadLabel ID="lblIDEdit" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDID") %>'></telerik:RadLabel>
                            </EditItemTemplate>
                            <%--<FooterTemplate>
                                <telerik:RadTextBox ID="lblIMONumberEdit" runat="server" CssClass="input_Mandatory" Text='<%# DataBinder.Eval(Container,"DataItem.FLDIMONUMBER") %>'></telerik:RadTextBox>
                            </FooterTemplate>--%>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Principal" HeaderStyle-Width="200px" AllowSorting="false">
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblPrincipal" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPRINCIPAL") %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <%-- <EditItemTemplate>
                                <eluc:MultiAddress runat="server" ID="ucPrincipalEdit" AddressType='<%# ((int)PhoenixAddressType.PRINCIPAL).ToString()%>'
