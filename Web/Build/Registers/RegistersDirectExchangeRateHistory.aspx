<%@ Page Language="C#" AutoEventWireup="True" CodeFile="RegistersDirectExchangeRateHistory.aspx.cs"
    Inherits="RegistersDirectExchangeRateHistory" MaintainScrollPositionOnPostback="true" %>
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="USD to Currency" AllowSorting="true" SortExpression="FLDEXCHANGERATE">
                            ...
                            <ItemTemplate>
                                <asp:Label ID="lnkexchangerate" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXCHANGERATE" ,"{0:f17}") %>'></asp:Label>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Currency to USD" AllowSorting="true" SortExpression="FLDEXCHANGERATEUSD">
                            ...
                            <ItemStyle HorizontalAlign="Right" />
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkexchangerateuSD" runat="server" CommandName="EDIT" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXCHANGERATEUSD" ,"{0:f17}") %>'></asp:LinkButton>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <%-- <span id="spnInDirectExchangeEdit">
                                    <eluc:Decimal ID="txtExchangerateEditUSD" runat="server" CssClass="input_mandatory" DecimalDigits="15"
                                        Width="100%" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXCHANGERATEUSD") %>' />
                                </span> --%> 
                                <telerik:RadTextBox ID="txtExchangerateEditUSD" RenderMode="Lightweight" runat="server" CssClass="input_mandatory" Text='<%# DataBinder.Eval(Container,"DataItem.FLDEXCHANGERATEUSD") %>'></telerik:RadTextBox>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Action" AllowSorting="true" SortExpression="">
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="cmdEdit" runat="server" AlternateText="Edit" CommandName="EDIT" ToolTip="Edit" Width="20px" Height="20px">
                                ...
                                <asp:LinkButton ID="cmdHistory" runat="server" AlternateText="History" CommandArgument='<%# DataBinder.Eval(Container,"DataItem.FLDCURRENCYID")  %>'
                                    CommandName="History" ToolTip="History" Width="20px" Height="20px">
                                    <span class="icon"><i class="fas fa-history"></i></span>
                                </asp:LinkButton>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:LinkButton ID="cmdSave" runat="server" AlternateText="Save" CommandName="Save" ToolTip="Save" Width="20px" Height="20px">
                                    <span class="icon"><i class="fas fa-save"></i></span>
                                </asp:LinkButton>
                                <asp:LinkButton ID="cmdCancel" runat="server" AlternateText="Cancel" CommandName="Cancel" ToolTip="Cancel" Width="20px" Height="20px">
