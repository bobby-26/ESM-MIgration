<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersDocumentOtherAdd.aspx.cs" Inherits="Registers_RegistersDocumentOtherAdd" %>
...
<body>
    <form id="frmDocumentLicenceList" runat="server">
        ...
        <table style="width: 100%;">
            <tr>
                <td>
                    <telerik:RadLabel ID="lblLicence" runat="server" Text="Document Name"></telerik:RadLabel>
                </td>
                <td>
                    <telerik:RadTextBox runat="server" ID="txtdocname" MaxLength="50" Width="260px" CssClass="input_mandatory"></telerik:RadTextBox>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadLabel ID="RadLabel7" runat="server" Text="Short Expiry Y/N"></telerik:RadLabel>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <telerik:RadLabel ID="lblcode" runat="server" Text="Document Code"></telerik:RadLabel>
                </td>
                <td>
                    <telerik:RadTextBox runat="server" ID="txtcode" MaxLength="50" Width="134px" CssClass="input_mandatory"></telerik:RadTextBox>
                </td>

                <td>
                    <telerik:RadLabel ID="RadLabel8" runat="server" Text="NOK Y/N"></telerik:RadLabel>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <telerik:RadLabel ID="lblexpiry" runat="server" Text="Group"></telerik:RadLabel>
                </td>
                <td>
                    <eluc:Hard runat="server" ID="ucGroupAdd" CssClass="input_mandatory" ShortNameFilter="CDC,VSA,NON,WPT" HardTypeCode='<%# ((int)PhoenixHardTypeCode.CREWDOCUMENTTYPE).ToString() %>' />

                </td>
                <td>
                    <telerik:RadLabel ID="RadLabel9" runat="server" Text="Expiry Y/N"></telerik:RadLabel>
                </td>
                <td>
                    <telerik:RadCheckBox ID="chkhavingexpyn" runat="server" AutoPostBack="true" OnCheckedChanged="chkhavingexpyn_CheckedChanged"/>
            ...
            <tr>
                <td>
                    <telerik:RadLabel ID="RadLabel3" runat="server" Text="CBA Other Document Y/N"></telerik:RadLabel>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadLabel ID="lblown" runat="server" Text="Owner"></telerik:RadLabel>
