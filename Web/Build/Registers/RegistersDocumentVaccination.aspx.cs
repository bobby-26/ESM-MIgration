...
public partial class RegistersDocumentVaccination : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddFontAwesomeButton("../Registers/RegistersDocumentVaccination.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
        toolbar.AddFontAwesomeButton("javascript:CallPrint('gvDocumentMedical')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
        toolbar.AddFontAwesomeButton("../Registers/RegistersDocumentVaccination.aspx", "Find", "<i class=\"fas fa-search\"></i>", "FIND");        
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = { "FLDNAMEOFMEDICAL", "FLDEXPIRYYN" };
        string[] alCaptions = { "Vaccination Name","Having Expiry" };
        ...
        ds = PhoenixRegistersDocumentMedical.DocumentVaccinationSearch(MedicalSearch, sortexpression, sortdirection,
            (int)ViewState["PAGENUMBER"],
            gvDocumentMedical.PageSize,
            ref iRowCount,
            ref iTotalPageCount);

        Response.AddHeader("Content-Disposition", "attachment; filename=Vaccination.xls");
        Response.ContentType = "application/vnd.msexcel";
        Response.Write("<TABLE BORDER='0' CELLPADDING='2' CELLSPACING='0' width='100%'>");
        Response.Write("<tr>");
        Response.Write("<td><img src='http://" + Request.Url.Authority + Session["images"] + "/esmlogo4_small.png" + "' /></td>");
        Response.Write("<td><h3>Vaccination</h3></td>");
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixRegistersDocumentMedical.DocumentVaccinationSearch(MedicalSearch, sortexpression, sortdirection,
            (int)ViewState["PAGENUMBER"],
            gvDocumentMedical.PageSize,
            ref iRowCount,
            ref iTotalPageCount);

        General.SetPrintOptions("gvDocumentMedical", "Vaccination", alCaptions, alColumns, ds);
    ...
    private void InsertDocumentMedical(string nameofmedical,int expiryyn)
    {
        ...
        PhoenixRegistersDocumentMedical.InsertDocumentVaccination(
            PhoenixSecurityContext.CurrentSecurityContext.UserCode
            , nameofmedical
            , expiryyn);
    }

    private void UpdateDocumentMedical(int documentmedicalid, string nameofmedical,int expiryyn)
    {
        if (!IsValidDocumentMedical(nameofmedical))
        {
            ucError.Visible = true;
        ...
        PhoenixRegistersDocumentMedical.UpdateDocumentVaccination(
            PhoenixSecurityContext.CurrentSecurityContext.UserCode
            , documentmedicalid
            , nameofmedical
            , expiryyn);
    ...
    private bool IsValidDocumentMedical(string nameofmedical)
    {
        ...
        if (nameofmedical.Trim().Equals(""))
            ucError.ErrorMessage = "Vaccination Name is required.";
    ...
    {
        PhoenixRegistersDocumentMedical.DeleteDocumentVaccination(
            PhoenixSecurityContext.CurrentSecurityContext.UserCode
            , documentmedicalid);
    }
