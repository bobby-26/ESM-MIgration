...
public partial class RegistersExchangeRateHistory : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbar.AddFontAwesomeButton("../Registers/RegistersExchangeRateHistory.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
        toolbar.AddFontAwesomeButton("javascript:CallPrint('dgExchangerate')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
        toolbar.AddFontAwesomeButton("../Registers/RegistersExchangeRateHistory.aspx", "<b>Find</b>", "<i class=\"fas fa-search\"></i>", "FIND");
        toolbar.AddFontAwesomeButton("../Registers/RegistersExchangeRateHistory.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    protected void dgExchangerate_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        if (e.CommandName.ToUpper().Equals("SAVE"))
        {
            ...
            if (ExchangeRateId == "")
            {
                ...
                string exchangerate = ((RadTextBox)e.Item.FindControl("txtExchangerateEdit")).Text;
                string exchangerateusd = null;
                int active = 1;
            ...
            if (ExchangeRateId != "")
            {
                ...
                string strExchangeRate = ((RadTextBox)e.Item.FindControl("txtExchangerateEdit")).Text;
                string exchangerateusd = null;
                int isactive = 1;
    ...
    protected void dgExchangerate_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridEditableItem && e.Item.IsInEditMode)
        {
            ...
            UserControlCurrency ddlCurrency = (UserControlCurrency)item.FindControl("ddlCurrencyCode");
    ...
    private bool IsValidExchangeRate(string strCurrencycode, string strExchangeRate, string dirExchangerate)
    {
        ...
        else if (General.GetNullableDecimal(strExchangeRate) == null)
        {
            ucError.ErrorMessage = "Invalid Exchange Rate.";
        }
        else if ((Convert.ToDecimal(strExchangeRate)) <= 0 || (Convert.ToDecimal(strExchangeRate)) >= 99999)
        {
