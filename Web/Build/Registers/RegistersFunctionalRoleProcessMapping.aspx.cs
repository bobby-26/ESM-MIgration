...
public partial class RegistersFunctionalRoleProcessMapping : PhoenixBasePage
{
    ...
    protected void MenuMapping_TabStripCommand(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                ...
                {
                    string source = General.RadCheckBoxList(cblProcess);

                    PhoenixRegistersRole.UpdateFunctionalRoleProcess(General.GetNullableInteger(ViewState["ROLEID"].ToString())
    ...
    {
        //cblProcess.Items.Clear();
        cblProcess.DataSource = PhoenixRegistersHardExtn.ListHardExtn(PhoenixSecurityContext.CurrentSecurityContext.UserCode,277);
        cblProcess.DataBindings.DataTextField = "FLDHARDNAME";
        cblProcess.DataBindings.DataValueField = "FLDHARDCODE";
        cblProcess.DataBind();
    }
    private void BindData()
    {
        ...
        else
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                General.RadBindCheckBoxList(cblProcess, dr["FLDPROCESS"].ToString());
            }            
        }
    }    
}