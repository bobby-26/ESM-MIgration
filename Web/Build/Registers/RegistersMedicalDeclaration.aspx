<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersMedicalDeclaration.aspx.cs" Inherits="RegistersMedicalDeclaration" %>
...
<body>
    <form id="frmRegistersDocumentMedical" runat="server" submitdisabledcontrols="true">
        ...
        <%--<eluc:TabStrip ID="MenuTitle" runat="server" Title="Medical Declaration"></eluc:TabStrip>--%>
        <telerik:RadAjaxPanel ID="RadAjaxPanel" runat="server" Height="80%">
            ...
            <table id="tblConfigureDocumentMedical" width="100%">
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblVaccinationName" runat="server" Text="Declaration"></telerik:RadLabel>
                    </td>
                    <td>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvDocumentMedical" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Declaration" HeaderStyle-Width="600px">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <HeaderTemplate>                             
                                <asp:LinkButton ID="lblNameOfMedicalHeader" runat="server" CommandName="Sort" CommandArgument="FLDNAMEOFDECLARATION">Declaration&nbsp;</asp:LinkButton>                                
                            </HeaderTemplate>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblDocumentMedicalId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMEDICALDECLARATIONID") %>'></telerik:RadLabel>
                                <asp:LinkButton ID="lnkNameOfMedical" runat="server" CommandName="EDIT"
                                    Text='<%# DataBinder.Eval(Container,"DataItem.FLDNAMEOFDECLARATION") %>'></asp:LinkButton>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <telerik:RadLabel ID="lblDocumentMedicalIdEdit" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDMEDICALDECLARATIONID") %>'></telerik:RadLabel>
                                <telerik:RadTextBox ID="txtNameOfMedicalEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDNAMEOFDECLARATION") %>'
