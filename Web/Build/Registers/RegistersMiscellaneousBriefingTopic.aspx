<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersMiscellaneousBriefingTopic.aspx.cs"
    Inherits="RegistersMiscellaneousBriefingTopic" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmRegistersBriefingTopics" autocomplete="off" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel" runat="server" Height="88%">
            ...
            <eluc:TabStrip ID="MenuRegistersBriefingTopics" runat="server" OnTabStripCommand="RegistersBriefingTopics_TabStripCommand"></eluc:TabStrip>

            <telerik:RadGrid RenderMode="Lightweight" ID="gvBriefingTopics" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" OnItemCommand="gvBriefingTopics_ItemCommand" OnNeedDataSource="gvBriefingTopics_NeedDataSource" Height="85%"
                OnItemDataBound="gvBriefingTopics_ItemDataBound" EnableViewState="false" GroupingEnabled="false" EnableHeaderContextMenu="true" ShowFooter="true"
                OnSortCommand="gvBriefingTopics_SortCommand">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Subject" HeaderStyle-Width="300px">
                            ...
                            <HeaderTemplate>
                                <telerik:RadLabel ID="lblSubjectHeader" Visible="true" runat="server">
                                </telerik:RadLabel>
                            ...
                            <FooterTemplate>
                                <telerik:RadTextBox ID="txtSubjectAdd" runat="server" CssClass="gridinput_mandatory" MaxLength="200" Width="98%"
                                    ToolTip="Enter Briefing Subject">
                                </telerik:RadTextBox>
                            </FooterTemplate>
