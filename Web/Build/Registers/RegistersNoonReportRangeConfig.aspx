<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersNoonReportRangeConfig.aspx.cs"
    Inherits="RegistersNoonReportRangeConfig" %>
...
<body>
    <form id="frmNoonReportRangeConfig" runat="server" submitdisabledcontrols="true">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1" Height="100%">
                ...
                <tr>
                    ...
                    <asp:Panel ID="pnlCopy" runat="server" GroupingText="Copy">
                                <table width="100%">
                                    <tr>
                                        <td>
                                            <telerik:RadLabel ID="lblCopyTo" runat="server" Text="Copy From"></telerik:RadLabel>
                                        </td>
                                        <td>
                                            <eluc:Vessel ID="ucFromVessel" runat="server" CssClass="input_mandatory" Width="180px" VesselsOnly="true" AppendDataBoundItems="true" />
                                        </td>
                                        <td>
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvNRConfig" Height="78%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Req. in LOG">
                            ...
                            <ItemStyle Wrap="false" HorizontalAlign="center"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadCheckBox ID="reqinlog" runat="server" Enabled="false" Checked='<%# DataBinder.Eval(Container, "DataItem.FLDREQUIREDINLOG").ToString() == "1" ? true : false %>'></telerik:RadCheckBox>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
