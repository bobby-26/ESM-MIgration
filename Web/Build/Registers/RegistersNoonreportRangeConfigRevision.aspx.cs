...
public partial class RegistersNoonreportRangeConfigRevision : PhoenixBasePage
{
    ...
    private void BindData()
    {
        ...
        ds = PhoenixRegistersNoonReportRangeConfig.RangeConfigRevisionList(General.GetNullableInteger(ViewState["VesselId"].ToString()));
    ...
    protected void gvExtensionReason_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (lnkOldRevNo != null)
            {
                lnkOldRevNo.Attributes.Add("onclick", "javascript:openNewWindow('Report','','" + Session["sitepath"] + "/Registers/RegistersNoonReportRangeConfigRevisionHistory.aspx?revisionid=" + lblRevisionId.Text + "&vesselid="+Request.QueryString["VesselId"] +"'); return false;");
            }
        }
    }
}
