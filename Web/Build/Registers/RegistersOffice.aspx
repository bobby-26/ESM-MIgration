<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersOffice.aspx.cs"
    Inherits="RegistersOffice" %>
...
<body>
    <form id="form1" runat="server" autocomplete="off">
        ...
        <telerik:RadFormDecorator ID="RadFormDecorator1" runat="server" DecoratedControls="All" DecorationZoneID="RadAjaxPanel1" />
                    ...
                    <telerik:RadPanelItem Text="Configuration" Width="100%">
                        ...
                        <ContentTemplate>
                            <table width="100%" cellpadding="1" cellspacing="1">
                                ...
                                <tr>
                                    <td>
                                        <telerik:RadLabel ID="lblsendrfq" runat="server" Visible="false" Text="Send RFQ"></telerik:RadLabel>
                                    </td>
                                    <td>
                                        <asp:CheckBox ID="ChksendRFQ" Visible="false" runat="server" CssClass="input"></asp:CheckBox>

                                    </td>
                                    <td>
                                        <telerik:RadLabel ID="lblsendpo" runat="server" Visible="false" Text="Send PO"></telerik:RadLabel>
                                    </td>
                                    <td>
                                        <asp:CheckBox ID="ChksendPO" Visible="false" runat="server" CssClass="input"></asp:CheckBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadLabel ID="RadLabel5" runat="server" Text="Invoice by Shipped Qty Allowed"></telerik:RadLabel>
                                    </td>
                                    <td>
            ...
            <telerik:RadPanelBar RenderMode="Lightweight" ID="AccordionPane2" runat="server" Width="100%">
                <Items>
                    <telerik:RadPanelItem Text="Product/Services" Width="100%">
                        ...
                        <ContentTemplate>
                            <telerik:RadCheckBoxList RenderMode="Lightweight" runat="server" ID="cblProduct" Height="90%" Columns="5"
                                Direction="Vertical" Layout="Flow" AutoPostBack="false">
                            </telerik:RadCheckBoxList>
                        </ContentTemplate>
                    </telerik:RadPanelItem>
