<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersPoolOtherDocMapping.aspx.cs"
    Inherits="RegistersPoolOtherDocMapping" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmRegistersPoolMaster" runat="server">
        ...
        <eluc:TabStrip ID="MenuNav" runat="server" OnTabStripCommand="MenuNav_TabStripCommand"
            Title="Other Document Mapping" TabStrip="true"></eluc:TabStrip>
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn>
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <HeaderTemplate>
                                <telerik:RadLabel ID="lblHeaderDocument" runat="server">
                                    Document
                                </telerik:RadLabel>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container,"DataItem.FLDDOCUMENTNAME") %>
                            ...
                            <EditItemTemplate>
                                ...
                                <eluc:DocumentType ID="ucDocumentTypeEdit" runat="server" AppendDataBoundItems="true" DocumentTypeList='<%#PhoenixRegistersDocumentOther.ListDocumentOther(((int)PhoenixDocumentType.OTHER_DOC_NONE).ToString())%>'
                                    SelectedDocumentType='<%# DataBinder.Eval(Container,"DataItem.FLDDOCUMENTID") %>' Width="200px"
                            ...
                            <FooterTemplate>
                                <eluc:DocumentType ID="ucDocumentTypeAdd" runat="server" DocumentType='<%# ((int)PhoenixDocumentType.OTHER_DOC_NONE).ToString()%>'
                                    ...
                                    AppendDataBoundItems="true" CssClass="dropdown_mandatory" Width="200px" />
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn>
