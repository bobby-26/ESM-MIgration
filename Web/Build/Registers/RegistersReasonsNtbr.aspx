<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersReasonsNtbr.aspx.cs"
    Inherits="Registers_RegistersReasonsNtbr" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmRegistersReasonsNTBR" autocomplete="off" runat="server">
        <telerik:RadScriptManager runat="server" ID="RadScriptManager2" />
        <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server" DecoratedControls="All" EnableRoundedCorners="true" />
        <eluc:TabStrip ID="MenuTitle" runat="server" Title="NTBR"></eluc:TabStrip>
        <telerik:RadAjaxPanel ID="RadAjaxPanel" runat="server" Height="95%">
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
            <eluc:Status runat="server" ID="ucStatus" />
            <eluc:TabStrip ID="MenuRegistersReasonsNTBR" runat="server" OnTabStripCommand="RegistersReasonNTBR_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvReasonNTBR" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" OnItemCommand="gvReasonNTBR_ItemCommand" OnNeedDataSource="gvReasonNTBR_NeedDataSource" Height="85%"
                OnItemDataBound="gvReasonNTBR_ItemDataBound" EnableViewState="false" GroupingEnabled="false" EnableHeaderContextMenu="true" ShowFooter="true">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Code" HeaderStyle-Width="180px">
                            ...
                            <EditItemTemplate>
                                ...
                                <telerik:RadTextBox ID="txtAbbreviationEdit" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDABBREVIATION") %>' Width="98%"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Reason" HeaderStyle-Width="330px">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <HeaderTemplate>
                                <asp:LinkButton ID="lblReasonHeader" runat="server" CommandName="Sort" CommandArgument="FLDREASON">
                                            Reason&nbsp;</asp:LinkButton>
