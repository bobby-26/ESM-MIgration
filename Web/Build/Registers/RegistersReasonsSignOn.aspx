<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersReasonsSignOn.aspx.cs"
    Inherits="Registers_RegistersReasonsSignOn" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmRegistersReasonsSignOn" autocomplete="off" runat="server">
        <telerik:RadScriptManager runat="server" ID="RadScriptManager2" />
        <telerik:RadFormDecorator RenderMode="Lightweight" ID="RadFormDecorator1" runat="server" DecoratedControls="All" EnableRoundedCorners="true" />
        <eluc:TabStrip ID="MenuTitle" runat="server" Title="SignOn Reason"></eluc:TabStrip>
        <telerik:RadAjaxPanel ID="RadAjaxPanel" runat="server" Height="95%">
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
            <eluc:Status runat="server" ID="ucStatus" />
            <eluc:TabStrip ID="MenuRegistersReasonsSignOn" runat="server" OnTabStripCommand="RegistersReasonSignOn_TabStripCommand"></eluc:TabStrip>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvReasonSignOn" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                CellSpacing="0" GridLines="None" OnItemCommand="gvReasonSignOn_ItemCommand" OnNeedDataSource="gvReasonSignOn_NeedDataSource" Height="85%"
                OnItemDataBound="gvReasonSignOn_ItemDataBound" EnableViewState="false" GroupingEnabled="false" EnableHeaderContextMenu="true" ShowFooter="true">
                ...
                <MasterTableView EditMode="InPlace" InsertItemPageIndexAction="ShowItemOnCurrentPage" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Group" HeaderStyle-Width="200px">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <HeaderTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Sort" CommandArgument="FLDGROUP">Group&nbsp;</asp:LinkButton>
                            ...
                            <FooterTemplate>
                                <telerik:RadTextBox ID="txtGroupAdd" runat="server" Width="98%" CssClass="gridinput_mandatory" MaxLength="50"
                                    ToolTip="Enter Group">
                                </telerik:RadTextBox>
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
