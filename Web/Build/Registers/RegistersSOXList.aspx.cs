...
public partial class RegistersSOXList : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                toolbar.AddImageButton("../Registers/RegistersSOXList.aspx", "Export to Excel", "icon_xls.png", "Excel");
                toolbar.AddImageLink("javascript:CallPrint('gvSOx')", "Print Grid", "icon_print.png", "PRINT");
                //toolbar.AddImageButton("../Registers/RegistersSOXList.aspx", "Find", "search.png", "FIND");
                //toolbar.AddImageButton("../Registers/RegistersSOXList.aspx", "Clear Filter", "clear-filter.png", "RESET");
                toolbar.AddImageLink("javascript:Openpopup('codehelp1','','RegistersSOX.aspx')", "Add", "add.png", "ADDCOMPANY");
    ...
    protected void ShowExcel()
    {
        ...
        string[] alColumns = {  "FLDBSOUT", "FLDBSIN", "FLDBSBERTH" };
        string[] alCaptions = {  "BSout", "BSin", "BSberth" };
    ...
    private void BindData()
    {
        ...
        General.SetPrintOptions("gvSOx", "SOx", alCaptions, alColumns, ds);
    ...
    protected void gvSOx_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                PhoenixRegistersSOX.DeleteSOX(
                    PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                    new Guid((((Label)_gridView.Rows[nCurrentRow].FindControl("lblSOxId")).Text)));
            }
            else
            {
                _gridView.EditIndex = -1;
    ...
    protected void gvSOx_ItemDataBound(Object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (!e.Row.RowState.Equals(DataControlRowState.Alternate | DataControlRowState.Edit) && !e.Row.RowState.Equals(DataControlRowState.Edit))
            {
                ...
                Label l = (Label)e.Row.FindControl("lblSOxId");

                LinkButton lb = (LinkButton)e.Row.FindControl("lblVesselName");
                lb.Attributes.Add("onclick", "Openpopup('codehelp1', '', 'RegistersSOX.aspx?SOxId=" + l.Text + "');return false;");

                ImageButton db1 = (ImageButton)e.Row.FindControl("cmdEdit");
                db1.Attributes.Add("onclick", "Openpopup('codehelp1', '', 'RegistersSOX.aspx?SOxId=" + l.Text + "');return false;");
            }
        }
    }
