...
public partial class RegistersUsageSupplier : PhoenixBasePage
{ 
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        toolbargrid.AddFontAwesomeButton("../Registers/RegistersUsageSupplier.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
        ...
        toolbargrid.AddFontAwesomeButton("../Registers/RegistersUsageSupplier.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
