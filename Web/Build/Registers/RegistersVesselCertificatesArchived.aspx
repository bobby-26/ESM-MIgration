<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistersVesselCertificatesArchived.aspx.cs" Inherits="RegistersVesselCertificatesArchieve" %>
...
<head runat="server">
    <title>Archieved Documents</title>
...
<body>
    ...
    <telerik:RadFormDecorator ID="RadFormDecorator1" runat="server" DecorationZoneID="frmVesselCertificateArchieved" DecoratedControls="All" />
    <form id="frmVesselCertificateArchieved" runat="server">
        <telerik:RadScriptManager runat="server" ID="RadScriptManager1">
        </telerik:RadScriptManager>
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="94%">
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
            <telerik:RadGrid RenderMode="Lightweight" ID="gvVesselCertificatesArchieve" Height="95%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" OnItemCommand="gvVesselCertificatesArchieve_ItemCommand" OnItemDataBound="gvVesselCertificatesArchieve_ItemDataBound" EnableViewState="false" ShowFooter="false" ShowHeader="true" OnNeedDataSource="gvVesselCertificatesArchieve_NeedDataSource">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Authority">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblIssuingAuthority" runat="server" CommandName="EDIT" Text='<%# DataBinder.Eval(Container,"DataItem.FLDISSUINGAUTHORITYNAME") %>' ToolTip='<%# DataBinder.Eval(Container,"DataItem.FLDISSUINGAUTHORITYNAME") %>'></telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
