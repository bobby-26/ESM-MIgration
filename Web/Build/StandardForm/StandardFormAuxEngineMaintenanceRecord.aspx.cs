...
public partial class StandardFormAuxEngineMaintenanceRecord : PhoenixBasePage
{
    ...
    private void LoadVesselData(Guid WorkOrderId)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            txtVesselType.Text = dt.Rows[0]["FLDENGINETYPE"].ToString();
            txtMake.Text = dt.Rows[0]["FLDAUXENGINE"].ToString();
        }
    }
