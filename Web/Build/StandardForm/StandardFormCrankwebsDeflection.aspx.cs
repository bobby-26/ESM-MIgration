...
public partial class StandardFormCrankwebsDeflection : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            string companyname = PhoenixStandardForm.CompanyName();
            lblCompanyName.Text = companyname;
            //lblCompanyFooter.Text = companyname;
    ...
    private void LoadVesselData(Guid WorkOrderId)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            //txtEnginType.Text = dt.Rows[0]["FLDENGINETYPE"].ToString();
            txtMainEngineAuxEngine.Text = dt.Rows[0]["FLDCOMPONENTNAME"].ToString();
            ...
            if (dt.Rows[0]["FLDMAKER"].ToString() != DBNull.Value.ToString() && dt.Rows[0]["FLDTYPE"].ToString() != DBNull.Value.ToString())
                txtEnginType.Text = dt.Rows[0]["FLDMAKER"].ToString() + "/" + dt.Rows[0]["FLDTYPE"].ToString();
            else
                txtEnginType.Text = dt.Rows[0]["FLDMAKER"].ToString() + dt.Rows[0]["FLDTYPE"].ToString();
