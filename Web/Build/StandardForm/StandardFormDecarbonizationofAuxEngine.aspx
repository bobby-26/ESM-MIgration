<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StandardFormDecarbonizationofAuxEngine.aspx.cs"
    Inherits="StandardFormDecarbonizationofAuxEngine" %>
                ...
                <table style="width: 1650px" cellspacing="0px">
                    <tr>
                        <td colspan="12" align="left">
                            <b><asp:Literal ID="lblCompany" runat="server" Text="EXECUTIVE SHIP MANAGEMENT PTE LTD"></asp:Literal></b>
                        </td>
                        <td align="left">
                           <asp:Literal ID="lblFileRef" runat="server" Text="File Ref - 151.11"></asp:Literal>
                        </td>
                        <td align="right">
                    ...
                    <tr>
                        ...
                        <td align="left">
                           <asp:Literal ID="lblCE22" runat="server" Text="C/E 22"></asp:Literal>
                        </td>
                        <td align="right">
                    ...
                    <tr>
                        <td colspan="14" align="right">
                            <asp:Literal ID="lbl903Rev1" runat="server" Text="(9/03 Rev 1)"></asp:Literal>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="14">
                            <table class="Sftblclass" cellpadding="1px" cellspacing="1px" width="100%">
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        <asp:CheckBox ID="chyes" runat="server" Text="Yes" />&nbsp;&nbsp;
                                        <asp:CheckBox ID="chNo" runat="server" Text="No" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        <asp:CheckBox ID="chZineYes" runat="server" Text="Yes" />&nbsp;&nbsp;
                                        <asp:CheckBox ID="chZineNo" runat="server" Text="No" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2">
                                        <asp:CheckBox ID="chTuOverYes" runat="server" Text="Yes" />&nbsp;&nbsp;
                                        <asp:CheckBox ID="chTuOverNo" runat="server" Text="No" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                ...
                                <tr>
                                    ...
                                    <td align="center" rowspan="2">
                                        <asp:Literal ID="lblTurboChargerDateLastOhauld" runat="server" Text="Turbo-Charger Date<br />&nbsp;&nbsp;&nbsp;Last O’hauled&nbsp;Last O’hauled&nbsp;&nbsp;&nbsp;Last O’hauled&nbsp;Last O’hauled"></asp:Literal>
                                    </td>
                                    <td rowspan="2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chYesAirCooler" runat="server" Text="Yes" />&nbsp;&nbsp;&nbsp;
                                        <asp:CheckBox ID="chNoAirCooler" runat="server" Text="No" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chYesAnode" runat="server" Text="Yes" />&nbsp;&nbsp;&nbsp;
                                        <asp:CheckBox ID="chNoAnode" runat="server" Text="No" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chYesGovernor" runat="server" Text="Yes" />&nbsp;&nbsp;&nbsp;
                                        <asp:CheckBox ID="chNoGovernor" runat="server" Text="No" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                    ...
                                    <td colspan="21" align="center">
                                        <h3>
                                            <asp:Literal ID="lblPistonsRings" runat="server" Text="PISTONS RINGS"></asp:Literal></h3>         </td>
                                    <td align="center">
                    ...
                    <tr>
                        <td colspan="14">
                            <table width="100%" cellpadding="1px" cellspacing="1px" class="Sftblclass">
                                ...
                                <tr>
                                    <td align="center">
                                       <asp:Literal ID="lblsix6" runat="server" Text="c"></asp:Literal>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" align="center">
                                        <asp:Literal ID="lblno1" runat="server" Text="2"></asp:Literal>
                                    </td>
                                    <td colspan="2" align="center">
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <asp:Literal ID="lblNow11" runat="server" Text="c"></asp:Literal>
                                    </td>
                                    <td align="center">
                    ...
                    <tr>
                        ...
                        <td colspan="13">
                           <asp:Literal ID="lblClearanceOvalityAllowedTobeMentionedWhereapplicable" runat="server" Text="1.&nbsp;&nbsp;Max clearance, ovality allowed, to be mentioned where applicable."></asp:Literal>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="6">
                            <asp:Literal ID="lblOriginalCopy" runat="server" Text="Original : EXECUTIVE SHIP MANAGEMENT PTE LTD<br />Copy : Chief Engineer"></asp:Literal>
                        </td>
                    </tr>
                </table>
                <br />
