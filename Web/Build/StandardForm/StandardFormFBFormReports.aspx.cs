...
public partial class StandardForm_StandardFormFBFormReports : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbargrid.AddFontAwesomeButton("../StandardForm/StandardFormFBFormReports.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbargrid.AddFontAwesomeButton("javascript:CallPrint('gvFormList')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbargrid.AddFontAwesomeButton("../StandardForm/StandardFormFBFormReports.aspx", "Search", "<i class=\"fas fa-search\"></i>", "FIND");
        ...
        try
        {
            ...
            if (e.Item is GridDataItem)
            {
                ...
                if (lnkReportName != null)
                {
                    ...
                    lnkReportName.Attributes.Add("onclick", "javascript:return openNewWindow('codehelp1','','" + Session["sitepath"] + "/StandardForm/StandardFormFBformView.aspx?ReportId=" + reportId + "'); return false;");
