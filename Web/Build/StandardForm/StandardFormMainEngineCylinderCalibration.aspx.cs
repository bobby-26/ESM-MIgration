...
using System.Web;
public partial class StandardFormMainEngineCylinderCalibration : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            lblCompanyName.Text = PhoenixStandardForm.CompanyName();    
    ...
    protected void StandardForm_TabStripCommand(object sender, EventArgs e)
    {
        ...
        DateTime resultDate;
        if (DateTime.TryParse(txtDateCalibration1.Text, out resultDate)
        ...
        {
            if (string.IsNullOrEmpty(txtDateCalibration1.Text))
            {
