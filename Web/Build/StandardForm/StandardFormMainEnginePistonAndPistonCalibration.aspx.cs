...
using System.Web;
public partial class StandardFormMainEnginePistonAndPistonCalibration : PhoenixBasePage
{
    ...
    {
        if (string.IsNullOrEmpty(txtEngineTye.Text))
        {
            ucError.ErrorMessage = "EngineType is required.";
            ucError.Visible = true;
        }
        else
        {
