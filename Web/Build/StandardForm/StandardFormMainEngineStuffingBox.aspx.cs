...
public partial class StandardFormMainEngineStuffingBox : PhoenixBasePage
{
    ...
    {
        DateTime resultDate;
        if (DateTime.TryParse(txtDatePort.Text, out resultDate)
        ...
        {
            if (string.IsNullOrEmpty(txtDatePort.Text))
            {
