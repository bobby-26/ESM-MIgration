<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StandardFormTankValvesMaintenanceRecord.aspx.cs" Inherits="StandardForm_StandardFormTankValvesMaintenanceRecord" %>
...
<head id="Head1" runat="server">
    <title>Tank Valves Maintenance Record</title><telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
...
<body>
    <form id="frmTVMRecord" runat="server" autocomplete="off">
    ...
    <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
        ...
        <div class="subHeader" style="position: relative">
            <eluc:Title runat="server" ID="Title1" Text="Tanker Valves Maintenance Record" ShowMenu="false">
            </eluc:Title>
            ...
            <ContentTemplate>
               ...
               <table width="95%">
                <tr>
                        ...
                        <td align="right">
                            <asp:Literal ID="lblPB14" runat="server" Text="PB 14"></asp:Literal>
                        </td>
                    </tr>
                      <tr>
                        <td colspan="6" align="left">
                ...
                <table width="95%" class="tblclass" cellpadding="1" cellspacing="1">
                    <tr>
                        <td align="center" colspan="8">
                            <h3>
                                <asp:Literal ID="lblTankValvesMaintenanceRecord" runat="server" Text="Tanker Valves Maintenance Record"></asp:Literal></h3>
                        </td>
                    </tr>    
                    <tr>
                    ...
                    <td width="18%">
                        <asp:Literal ID="lblName" runat="server" Text="Name"
                        ></asp:Literal>
                    </td>
                    <td width="15%">
                        <asp:Literal ID="lblValuveNo" runat="server" runat="server" Text="Valve Number"></asp:Literal>
                    </td>
                    <td width="18%">
                       <asp:Literal ID="lblValueLocation" runat="server" Text="Valve Location"></asp:Literal>
                    </td>
                    <td width="12%">
