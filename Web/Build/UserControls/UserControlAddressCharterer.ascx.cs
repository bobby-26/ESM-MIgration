...
public partial class UserControlAddressCharterer : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            DataTable ds = PhoenixRegistersAddress.ChartererAddress();
            ds.Rows.Add("0", "Offhire-Awaiting Instructions");
            ddlAddressType.DataSource = ds;
