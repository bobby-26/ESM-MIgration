...
public partial class UserControlCourse : System.Web.UI.UserControl
{
	...
	public string SelectedName
	{
		get
		{
			...
			return ddlCourse.SelectedItem.Text;
		}
		set
		{
			ddlCourse.SelectedIndex = -1;
			if (value != null && value != "" && value != "0")
				ddlCourse.SelectedItem.Text = value;
		}
	}
    ...
    protected void ddlCourse_DataBound(object sender, EventArgs e)
    {
        if (_appenddatabounditems)
			if (!string.IsNullOrEmpty(DataBoundItemName))
			{
                ddlCourse.Items.Insert(0, new RadComboBoxItem("Direct Entry", ""));
			}
    ...
    public Unit Width
    {
        get
        {
            return ddlCourse.Width;
        }
        set
        {
            ddlCourse.Width = value;
        }
    }
}
