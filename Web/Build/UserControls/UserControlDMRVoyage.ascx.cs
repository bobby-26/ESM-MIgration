...
public partial class UserControls_UserControlDMRVoyage : System.Web.UI.UserControl
{
    ...
    protected void ddlDMRCharter_DataBound(object sender, EventArgs e)
    {
        if (_appenddatabounditems)
        {
            if (!_corporate)
            {
                ...
                ddlDMRCharter.Items.Insert(1, new RadComboBoxItem("Offhire -Awaiting Instructions", "Offhire"));
            }
            else
            {
