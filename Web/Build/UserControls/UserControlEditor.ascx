...
<%@ Register  Namespace="SouthNests.Phoenix.Custom" TagPrefix="Custom" %>
  <style type="text/css">
...
<Custom:CustomEditor ID="ucCustomEditor" runat="server" Height="400px" Width="100%" />
<div id="dv" class="ajax__htmleditor_attachedpopup_default" style="position: absolute;
