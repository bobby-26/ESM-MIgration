...
public partial class UserControlLatitude : System.Web.UI.UserControl
{
    string _dummy = null;
    ...
    public  void txtDegree_OnTextChangedEvent(object sender, EventArgs e)
    {
        ...
        if (Convert.ToInt32(txtDegree.Text) < 0 || Convert.ToInt32(txtDegree.Text) > 90)
        {
            ucError.HeaderMessage="";
            ucError.ErrorMessage="Latitude value should not exceed 90&deg";
    ...
    public void txtMinute_OnTextChangedEvent(object sender, EventArgs e)
    {
        ...
        {
            ucError.HeaderMessage = "";
            ucError.ErrorMessage = "Latitude value should not equal to or  exceed 60 minutes ";
            ucError.Visible = true;
            txtMinute.Text = "";
        }        
    }
    public void txtSecond_OnTextChangedEvent(object sender, EventArgs e)
    {
        ...
        {
            ucError.HeaderMessage = "";
            ucError.ErrorMessage = "Latitude value should not equal to or exceed 60 seconds";
            ucError.Visible = true;
            txtSecond.Text = "";
        }
    }
