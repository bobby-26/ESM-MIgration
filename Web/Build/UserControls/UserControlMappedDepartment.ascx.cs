...
public partial class UserControlMappedDepartment : System.Web.UI.UserControl
{
    ...
    private void bind()
    {
        ddlDepartment.DataSource = PhoenixRegistersDepartment.ListMappedDepartment(PhoenixSecurityContext.CurrentSecurityContext.UserCode, departmentFilter);
        ddlDepartment.DataBind();
        foreach (RadComboBoxItem item in ddlDepartment.Items)
        {
            if (item.Value == _selectedValue.ToString())
