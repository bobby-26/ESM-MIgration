...
public partial class UserControlMoreLinks : System.Web.UI.UserControl
{
    ...
    {
        dlstMenu.Visible = true;
        imgmoreclose.Visible = true;
    }
    ...
    protected void imgmoreclose_Click(object sender, EventArgs e)
    {
        dlstMenu.Visible = false;
        imgmoreclose.Visible = false;      
    }
}
