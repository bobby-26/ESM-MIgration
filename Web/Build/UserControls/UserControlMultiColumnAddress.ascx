<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserControlMultiColumnAddress.ascx.cs"
    Inherits="UserControlMultiColumnAddress" %>
...
<telerik:RadComboBox RenderMode="Lightweight" ID="gvMulticolumn" runat="server" Width="200" Height="150" NoWrap="true"
    DataTextField="FLDNAME" DataValueField="FLDADDRESSCODE" HighlightTemplatedItems="true" DropDownWidth="300" EnableScreenBoundaryDetection="true"
