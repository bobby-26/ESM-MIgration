...
public partial class UserControlMultiColumnComponentModel : System.Web.UI.UserControl
{
    ...
    protected void gvMulticolumn_ItemsRequested(object sender, Telerik.Web.UI.RadComboBoxItemsRequestedEventArgs e)
    {
        ...
        ds = PhoenixPlannedMaintenanceGlobalComponent.RegisterModelSearch(null, null, null, null, null
                                                    , pageNumber
                                                    , ItemsPerRequest
                                                    , ref iRowCount
                                                    , ref iTotalPageCount
        ...
        if (ds.Tables.Count > 0)
        {
            ...
            {
                ddl.Items.Add(new RadComboBoxItem(dr["FLDMAKE"].ToString(), dr["FLDMODELID"].ToString()));
            }
        }
        ddl.DataSource = ds;
        ddl.DataBind();
