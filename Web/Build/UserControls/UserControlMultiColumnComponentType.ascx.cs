...
public partial class UserControlMultiColumnComponentType : System.Web.UI.UserControl
{
    ...
    protected void gvMulticolumn_ItemsRequested(object sender, Telerik.Web.UI.RadComboBoxItemsRequestedEventArgs e)
    {
        ...
        ds = PhoenixPlannedMaintenanceGlobalComponent.GlobalComponentTypeFilterSearch( 
                    null,null,null,General.GetNullableString(e.Text),null, null,
                    pageNumber,
                    ItemsPerRequest,
                    ref iRowCount,
                    ref iTotalPageCount,
        ...
        if (ds.Tables.Count > 0)
        {
            ...
            {
                ddl.Items.Add(new RadComboBoxItem(dr["FLDCOMPONENTNAME"].ToString(), dr["FLDCOMPONENTNUMBER"].ToString()));
            }
        }
        ddl.DataSource = ds;
        ddl.DataBind();
