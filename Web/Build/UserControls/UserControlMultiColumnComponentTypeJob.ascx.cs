...
public partial class UserControlMultiColumnComponentTypeJob : System.Web.UI.UserControl
{
    ...
    protected void gvMulticolumn_ItemsRequested(object sender, Telerik.Web.UI.RadComboBoxItemsRequestedEventArgs e)
    {
        ...
        if (ds.Tables.Count > 0)
        {
            ...
            {
                ddl.Items.Add(new RadComboBoxItem(dr["FLDJOBTITLE"].ToString(), dr["FLDGLOBALCOMPONENTTYPEJOBMAPID"].ToString()));
            }
        }
        ddl.DataSource = ds;
        ddl.DataBind();
