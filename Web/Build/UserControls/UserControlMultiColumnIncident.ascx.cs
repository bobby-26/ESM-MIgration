...
public partial class UserControlMultiColumnIncident : System.Web.UI.UserControl
{
    ...
    protected void gvMulticolumn_ItemsRequested(object sender, RadComboBoxItemsRequestedEventArgs e)
    {
        ...
        if (ds.Tables.Count > 0)
        {
            ...
            {
                ddl.Items.Add(new RadComboBoxItem(dr["FLDINCIDENTREFNO"].ToString(), dr["FLDINSPECTIONINCIDENTID"].ToString()));
            }
        }
        ddl.DataSource = ds;
        ddl.DataBind();
