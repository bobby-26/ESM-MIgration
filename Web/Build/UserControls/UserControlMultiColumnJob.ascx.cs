...
public partial class UserControlMultiColumnJob : System.Web.UI.UserControl
{
    ...
    private void showbtn()
    {
        if (!panel1.Visible)
        {
            ...
            btnmulticolumn.ToolTip = "Show All Job";
        }
        else
        {
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixCommonPlannedMaintenance.JobSearch(General.GetNullableString(txtJobCode.Text),
    ...
    protected void gvMulticolumn_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                panel1.Visible = false;
                txtmuticolumn.Text = ((Label)_gridView.Rows[nCurrentRow].FindControl("lblTitle")).Text.ToString();
                txtmultivalue.Text = ((Label)_gridView.Rows[nCurrentRow].FindControl("lbljobid")).Text.ToString();
                showbtn();
            }
        }
        catch (Exception ex)
