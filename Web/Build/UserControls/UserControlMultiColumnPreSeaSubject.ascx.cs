...
public partial class UserControlMultiColumnPreSeaSubject : System.Web.UI.UserControl
{
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixPreSeaSubject.PreSeaSubjectSearch(searchtext
    ...
    protected void gvMulticolumn_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                panel1.Visible = false;
                txtmuticolumn.Text = ((LinkButton)_gridView.Rows[nCurrentRow].FindControl("lnkSubjectName")).Text.ToString();
                txtmultivalue.Text = ((Label)_gridView.Rows[nCurrentRow].FindControl("lblSubjectId")).Text.ToString();
