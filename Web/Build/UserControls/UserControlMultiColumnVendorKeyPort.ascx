<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserControlMultiColumnVendorKeyPort.ascx.cs" Inherits="UserControlMultiColumnVendorKeyPort" %>
...
<div style="position: relative; z-index: 1;">  
    <asp:Panel ScrollBars="Both" ID="panel1" runat="server" BackColor="White" Visible="false"
        ...
        <asp:GridView ID="gvMulticolumn" runat="server" AutoGenerateColumns="False" Font-Size="11px" AllowSorting="true"
            Width="100%" CellPadding="3" ShowHeader="true" EnableViewState="false" OnRowDataBound="gvMulticolumn_RowDataBound"
            OnRowCreated="gvMulticolumn_RowCreated" OnSelectedIndexChanging="gvMulticolumn_SelectedIndexChanging"
             OnSorting="gvMulticolumn_Sorting" OnRowCommand="gvMulticolumn_RowCommand">
            ...
            <Columns>                                            
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblIsKeyPort" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDKEYPORTYN") %>'></asp:Label>                                    
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>                               
                                  <HeaderTemplate>
                                    <asp:LinkButton ID="lnkSeaportNameHeader" runat="server" CommandName="Sort" CommandArgument="FLDSEAPORTNAME"
                            ...
                            <asp:TemplateField>
                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                <HeaderTemplate>
                                    <asp:Label ID="lblCountryNameHeader" runat="server">
                                    Country
                                    </asp:Label>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:Label ID="lblCountryCode" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOUNTRYCODE") %>'></asp:Label>
                                    <asp:Label ID="lblCountryName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCOUNTRYNAME") %>'></asp:Label>
                                </ItemTemplate>                                
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Airport">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lnkairportName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDAIRPORTNAME") %>'></asp:Label>
                                </ItemTemplate>                               
                            </asp:TemplateField>                     
        ...
        <div id="div2" style="position: relative;">
                    <table width="100%" border="0" cellpadding="1" cellspacing="1">
                        <tr>
                            <td>
                                <asp:ImageButton ID="imgKeyPortExists" runat="server" Enabled="false" ImageUrl="<%$ PhoenixTheme:images/contract-exist.png %>" /><asp:Label
                                    ID="lblKeyPort" runat="server" ForeColor="Red"> Key Port for selected vendor. </asp:Label>
                            </td>
                        </tr>
                    </table>
                </div>
