...
public partial class UserControlMultiColumnVendorKeyPort : System.Web.UI.UserControl
{
    public Int64 _vendorid; 
    ...
    public string VendorId
    {
        get
        {
            return hdnVendorId.Value.ToString();
        }
        set
        {
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixCommonRegisters.VendorKeyportSearch(PhoenixSecurityContext.CurrentSecurityContext.UserCode, null, searchtext,
            General.GetNullableInteger(ddlcountrylist.SelectedCountry), null, sortexpression, sortdirection,
            (int)ViewState["PAGENUMBER"],
            General.ShowRecords(null),
            ref iRowCount,
            ref iTotalPageCount,
            General.GetNullableInteger(hdnVendorId.Value));
    ...
    protected void gvMulticolumn_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label lblIsKeyPort = (Label)e.Row.FindControl("lblIsKeyPort");
            ImageButton imgContractFlag = (ImageButton)e.Row.FindControl("imgContractFlag");
            imgContractFlag.ImageUrl = lblIsKeyPort.Text.ToUpper().Equals("1") ? Session["images"] + "/contract-exist.png" : Session["images"] + "/spacer.gif";
    ...
    protected void gvMulticolumn_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName.ToUpper().Equals("SELECT"))
            {
                ...
                txtmultivalue.Text = ((Label)_gridView.Rows[nCurrentRow].FindControl("lblSeaportid")).Text.ToString();
                showbtn();
            }                  
        }
        catch (Exception ex)
