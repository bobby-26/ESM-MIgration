<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserControlMultipleColumnOwnerBudgetCode.ascx.cs" Inherits="UserControlMultipleColumnOwnerBudgetCode" %>
...
<div id="div1" style="width: auto; padding: 0; position: relative; height: auto">
    <asp:Panel ID="pnlcover" runat="server" DefaultButton="btnsearch" CssClass="input"
        ...
        <asp:ImageButton ID="btnmulticolumn" runat="server" ImageUrl="<%$ PhoenixTheme:images/dropdown_mouseout.png %>"
            Width="14px" OnClick="btnmulticolumn_OnClick" ToolTip="Show Owner Budget Code" Style="cursor: pointer"
            ...
            <RowStyle Height="10px" />
                    <Columns>
                        <asp:TemplateField>
                            ...
                            <HeaderTemplate>
                                <asp:LinkButton ID="lblBudgetHeader" runat="server" CommandName="Sort" CommandArgument="FLDSUBACCOUNT"
                                    ForeColor="White">Owner Budget Code&nbsp;</asp:LinkButton>
                                <img id="FLDSUBACCOUNT" runat="server" visible="false" />
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblOwnerBudgetId" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDOWNERBUDGETCODEMAPID") %>'
                                    Visible="false"></asp:Label>
                                <asp:LinkButton ID="lnkOwnerBudget" runat="server" CommandName ="SELECT" CommandArgument='<%# Container.DataItemIndex %>'
                        ...
                        <asp:TemplateField>
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <HeaderTemplate>
                                <asp:Label ID="lblDescriptionHeader" runat="server">Owner Budget Group</asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblOwnerBudgetGroupId" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDOWNERBUDGETGROUPID") %>'
                                    Visible="false"></asp:Label>
                                <asp:Label runat="server" ID="lblOwnerBudgetCodeId" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDOWNERBUDGETCODEID") %>'
                                    Visible="false"></asp:Label>
                                <asp:Label runat="server" ID="lblOwnerBudgetGroup" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDOWNERBUDGETGROUP") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            <HeaderTemplate>
                                <asp:Label ID="lblBudgetGroupHeader" runat="server">Mapped Budget Code</asp:Label>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblBudgetId" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDBUDGETID") %>'
                                    Visible="false"></asp:Label>
                                <asp:Label runat="server" ID="lblBudgetGroup" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDSUBACCOUNT") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField>
                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                            ...
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblDescription" Text='<%#  DataBinder.Eval(Container,"DataItem.FLDOWNERCODEDESCRIPTION") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
        </asp:GridView>
