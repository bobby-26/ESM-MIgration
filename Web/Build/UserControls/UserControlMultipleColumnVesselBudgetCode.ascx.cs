...
public partial class UserControlMultipleColumnVesselBudgetCode : System.Web.UI.UserControl

{
    ...
    private void BindData()
    {
        ...
        DataSet ds = PhoenixCommonRegisters.BudgetSearch(
                1
                , null
                , null
                , null
                , General.GetNullableInteger((ucBudgetGroup.SelectedHard == "") ? null:ucBudgetGroup.SelectedHard)
                , null 
                , vesselid 
    ...
    protected void gvMulticolumn_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                panel1.Visible = false;
                txtmuticolumn.Text = ((LinkButton)_gridView.Rows[nCurrentRow].FindControl("lnkBudget")).Text.ToString();
                txtmultivalue.Text = ((Label)_gridView.Rows[nCurrentRow].FindControl("lblBudgetId")).Text.ToString();
