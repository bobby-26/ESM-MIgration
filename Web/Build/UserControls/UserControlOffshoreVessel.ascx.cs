...
public partial class UserControlOffshoreVessel : System.Web.UI.UserControl
{
   public event EventHandler TextChangedEvent;
    ...
    public void bind()
    {
        ...
        {
            if (_selecteduser == -1)
                ddlVessel.DataSource = PhoenixRegistersVessel.ListAssignedOffshoreVessel(PhoenixSecurityContext.CurrentSecurityContext.UserCode, General.GetNullableInteger(Flag));
            else
                ddlVessel.DataSource = PhoenixRegistersVessel.ListAssignedOffshoreVessel(_selecteduser, General.GetNullableInteger(Flag));
            ddlVessel.DataBind();
        }
        else
        {
            ...
            {
                ddlVessel.DataSource = PhoenixRegistersVessel.ListOffshoreVessel(General.GetNullableInteger(Flag), General.GetNullableString(Principal), vessel, string.Empty, null, null, null, General.GetNullableInteger(_PlannedDays));
                ddlVessel.DataBind();
            }
            else
            {
                ddlVessel.DataSource = PhoenixRegistersVessel.ListOffshoreVessel(General.GetNullableInteger(Flag), General.GetNullableString(Principal), vessel);
                ddlVessel.DataBind();
            }
        }
