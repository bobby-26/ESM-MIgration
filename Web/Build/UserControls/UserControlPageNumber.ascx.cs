...
public partial class UserControlPageNumber : System.Web.UI.UserControl
{
    ...
    public string Text
    {
        ...
        set
        {
            if (value.Trim().Equals("") && !IsInteger && DefaultZero)
                ...
                txtNumber.Text =Convert.ToString(int.Parse(value));
            else
    ...
    {
        txtNumber.Attributes.Add("onDrop", "return false;");
        txtNumber.Attributes.Add("onPaste", "return false;");
        txtNumber.Attributes.Add("onkeydown", "return txtkeypress(event, this, false, " + _positive.ToString().ToLower() + ");");
        if (!IsInteger)
