...
public partial class UserControlPreSeaBatchList : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            lstBatch.DataSource = PhoenixRegistersBatch.ListBatch(General.GetNullableInteger(CourseId), General.GetNullableInteger(batchstatus),1);
            lstBatch.DataBind();
    ...
    protected void lstFleet_DataBound(object sender, EventArgs e)
    {
        ...
        if (!isoutside && lstBatch.Items.Count > 0)
