...
public partial class UserControlPreSeaMultiColApplicants : System.Web.UI.UserControl
{
    ...
    private void BindData()
    {
        ...
        string sortexpression = (ViewState["SORTEXPRESSION"] == null) ? "FLDNAME" : (ViewState["SORTEXPRESSION"].ToString());
        ...
        DataSet ds = PhoenixPreSeaCommon.SearchPreSeaConfirmedCandidates(General.GetNullableInteger(_batch),null,searchtext,null, null,sortexpression, sortdirection,
    ...
    protected void gvMulticolumn_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            {
                panel1.Visible = false;
                txtmuticolumn.Text = ((LinkButton)_gridView.Rows[nCurrentRow].FindControl("lnkCandidateName")).Text.ToString();
                txtmultivalue.Text = ((Label)_gridView.Rows[nCurrentRow].FindControl("lblInterViewId")).Text.ToString();
                showbtn();
            }
        }
        catch (Exception ex)
