...
public partial class UserControlRACategory : System.Web.UI.UserControl
{
	...
	private void bind()
	{
		ddlCategory.DataSource = PhoenixInspectionRiskAssessmentCategory.ListRiskAssessmentCategory();
		ddlCategory.DataBind();
        foreach (RadComboBoxItem item in ddlCategory.Items)
		{
			if (item.Value == _selectedValue.ToString())
