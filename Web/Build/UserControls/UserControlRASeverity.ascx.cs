...
public partial class UserControlRASeverity : System.Web.UI.UserControl
{
	...
	private void bind()
	{
		ddlSeverity.DataSource = PhoenixInspectionRiskAssessmentSeverity.ListRiskAssessmentSeverity();
		ddlSeverity.DataBind();
		foreach (RadComboBoxItem item in ddlSeverity.Items)
		{
			if (item.Value == _selectedValue.ToString())
