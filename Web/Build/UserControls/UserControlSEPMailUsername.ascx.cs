...
public partial class UserControlSEPMailUsername : System.Web.UI.UserControl
{
    ...
    private void bind()
    {
        ddlModuleList.DataSource = PhoenixMailManager.MailConfigurationList(null);
          ddlModuleList.DataBind();
        foreach (RadComboBoxItem item in   ddlModuleList.Items)
        {
            if (item.Value == _selectedValue.ToString())
