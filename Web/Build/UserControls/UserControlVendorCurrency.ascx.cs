...
public partial class UserControlVendorCurrency : System.Web.UI.UserControl
{
    ...
    public void bind()
    {
        ddlCurrency.DataSource = PhoenixRegistersCurrency.vendorCurrencyList(null,null, PhoenixSecurityContext.CurrentSecurityContext.UserCode, _vendor);
        ddlCurrency.DataBind();
        foreach (RadComboBoxItem item in ddlCurrency.Items)
        {
            if (item.Value == _selectedValue.ToString())
