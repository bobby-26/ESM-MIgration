...
public partial class UserControlVesselByCompany : System.Web.UI.UserControl
{
    ...
    public void bind()
    {
        ...
        {
            if (_selecteduser == -1)
                ddlVessel.DataSource = PhoenixRegistersVessel.ListAssignedVessel(PhoenixSecurityContext.CurrentSecurityContext.UserCode, General.GetNullableInteger(Flag), General.GetNullableInteger(Company));
            else
                ddlVessel.DataSource = PhoenixRegistersVessel.ListAssignedVessel(_selecteduser, General.GetNullableInteger(Flag), General.GetNullableInteger(Company));
            ddlVessel.DataBind();
        }
        else
        {
            ...
            if (_vesselsonly == true)
                ...
                vessel = 0;
            ddlVessel.DataSource = PhoenixRegistersVessel.ListVessel(General.GetNullableInteger(Flag), General.GetNullableString(Principal), vessel, null, null, General.GetNullableInteger(Company));
            ddlVessel.DataBind();
        }
