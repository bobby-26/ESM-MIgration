...
public partial class UserControlWorkPermit : System.Web.UI.UserControl
{
    int _categorynumber;
    ...
    public void bind()
    {
        ddlWorkPermit.DataSource = PhoenixInspectionDailyWorkPlanActivity.WorkPermitList(_categorynumber);
        ddlWorkPermit.DataBind();
        foreach (RadComboBoxItem item in ddlWorkPermit.Items)
        {
            if (item.Value == _selectedValue.ToString())
