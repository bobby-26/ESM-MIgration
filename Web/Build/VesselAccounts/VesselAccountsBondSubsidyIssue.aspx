<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsBondSubsidyIssue.aspx.cs"
    Inherits="VesselAccountsBondSubsidyIssue" %>
        ...
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <eluc:Title runat="server" ID="Title1" Text="Issue of Bonded Stores" ShowMenu="false">
                    </eluc:Title>
                ...
                <div id="divGrid" style="position: relative; z-index: 0; width: 100%;">
                    <asp:GridView ID="gvCrewSearch" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        ShowHeader="true" ShowFooter="true" EnableViewState="false" DataKeyNames="FLDISSUEITEMID">
                        <FooterStyle CssClass="datagrid_footerstyle"></FooterStyle>
                        <HeaderStyle CssClass="DataGrid-HeaderStyle" />
                        <AlternatingRowStyle CssClass="datagrid_alternatingstyle" />
                        <SelectedRowStyle CssClass="datagrid_selectedstyle" Font-Bold="true" />
                        <Columns>
                            <asp:TemplateField HeaderText="On Account For">
                            ...
                            <asp:TemplateField HeaderText="Sold Quantity">
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:Label ID="lblEmpId" Visible="false" runat="server" Text='<%#((DataRowView)Container.DataItem)["FLDEMPLOYEEID"]%>'></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="No of Cans">
                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                <ItemTemplate>
                                    <%#((DataRowView)Container.DataItem)["FLDSUBSIDYQTY"]%>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <eluc:Number ID="txtSubsidyQtyEdit" runat="server" CssClass="input_mandatory" Width="90px"
                                        Text='<%#((DataRowView)Container.DataItem)["FLDSUBSIDYQTY"] %>' IsInteger="true"
                                        IsPositive="true" />
                                </EditItemTemplate>
                            </asp:TemplateField>
