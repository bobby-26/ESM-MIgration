...
public partial class VesselAccounts_VesselAccountsBondedSummary : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../VesselAccounts/VesselAccountsBondedSummary.aspx?fromdate=" + Request.QueryString["fromdate"].ToString() + "&todate=" + Request.QueryString["todate"].ToString(), "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
    ...
    public void BindData()
    {
        ...
        try
        {
            DataTable dt = PhoenixVesselAccountsCTM.CaptainCashBondedSummary(int.Parse(ViewState["vesselid"].ToString())
            ...
            General.SetPrintOptions("gvBondReq", "Bond", alCaptions, alColumns, ds);
        }
    ...
    protected void MenuCTM_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("EXCEL"))
            {
                ...
                General.ShowExcel("Bond", dt, alColumns, alCaptions, null, null);
            }
        }
        catch (Exception ex)
        {
