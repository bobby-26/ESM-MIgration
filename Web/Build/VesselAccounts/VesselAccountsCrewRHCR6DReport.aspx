<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsCrewRHCR6DReport.aspx.cs" Inherits="VesselAccountsCrewRHCR6DReport" %>
...
<head runat="server">
    <title>Rest Hours NonCompliance Summary</title>
...
<body onresize="PaneResized()" onload="PaneResized()">
    <form id="frmNonComplianceSummary" runat="server">
        ...
        <eluc:TabStrip ID="MenuReportNonCompliance" runat="server" OnTabStripCommand="MenuReportNonCompliance_TabStripCommand"></eluc:TabStrip>
        <table width="60%">
            <tr>
                <td>
                ...
                <td>
                    <telerik:RadComboBox ID="ddlMonth" runat="server" CssClass="input_mandatory" AutoPostBack="true" Filter="Contains" OnSelectedIndexChanged="ddlMonth_SelectedIndexChanged">
                        <Items>
