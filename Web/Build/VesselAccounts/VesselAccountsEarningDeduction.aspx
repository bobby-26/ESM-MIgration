<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsEarningDeduction.aspx.cs"
    Inherits="VesselAccountsEarningDeduction" %>
        ...
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <eluc:Title runat="server" ID="Title1" Text="Earnings/Deductions" ShowMenu="true">
                    </eluc:Title>
                    <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
                        <eluc:TabStrip ID="MenuEarDedGeneral" runat="server" TabStrip="true" OnTabStripCommand="MenuEarDedGeneral_TabStripCommand">
                        </eluc:TabStrip>
                    </div>
                    <div class="subHeader" style="position: relative;">
                        <span class="navSelect" style="margin-top: 0px; float: right; width: auto;">
                            <eluc:TabStrip ID="MenuEarDed" runat="server" OnTabStripCommand="MenuEarDed_TabStripCommand"
                                TabStrip="false"></eluc:TabStrip>   <eluc:Status runat="server" ID="ucStatus" />
                        </span>
                    </div>
                ...
                <%--<table id="Table2" width="100%" style="color: Blue">
                    <tr>
                        <td>
                            <asp:Literal ID="lblNotes" runat="server" Text="<b>Note :</b>  &nbsp; Confirm all applicable only if type is Allotment."></asp:Literal>
                        </td>
                    </tr>
                </table>--%>
                <table width="70%">
                    ...
                    <tr runat="server" id="trErD">
                        ...
                        <td>
                            <eluc:EntryType ID="ddlEntryTypeEarning" runat="server" CssClass="input" AppendDataBoundItems="true"
                                ...
                                Visible="true" OnTextChangedEvent="ddlEntryTypeEarning_ChangedEvent" />
                            <eluc:EntryType ID="ddlEntryTypeDeduction" runat="server" CssClass="input" AppendDataBoundItems="true"
                                ...
                                OnTextChangedEvent="ddlEntryTypeDeduction_ChangedEvent" />
                        </td>
                    </tr>
                </table>
                <br />
                <div class="navSelect" style="position: relative; clear: both; width: 15px">
                    <eluc:TabStrip ID="MenuBondIssue" runat="server" OnTabStripCommand="MenuBondIssue_TabStripCommand">
                    </eluc:TabStrip>
                </div>
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Employee Code">
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblSignonoffIdHeader" runat="server" Visible="false" Text='<% #((DataRowView)Container.DataItem)["FLDSIGNONOFFID"] %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Email">
                                ...
                                <EditItemTemplate>
                                    <asp:Label ID="lblEmail" runat="server" Visible="true" Enabled="false" Text='<%#((DataRowView)Container.DataItem)["FLDEMAIL"] %>'></asp:Label>
                                </EditItemTemplate>
                            </asp:TemplateField>
