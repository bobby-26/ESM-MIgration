<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsEmployeeQueryDashboard.aspx.cs"
    Inherits="VesselAccountsEmployeeQueryDashboard" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="90%">
            ...
            <table style="width:50%;">
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblDate" Text="Date" runat="server"></telerik:RadLabel>
                    </td>
                    <td>
                        <%--<eluc:Date runat="server" ID="ucDate" OnTextChangedEvent="ucDate_TextChangedEvent" AutoPostBack="true" />--%>
                        <telerik:RadDatePicker runat="server" ID="ucDate" OnSelectedDateChanged="ucDate_SelectedDateChanged" AutoPostBack="true" RenderMode="Lightweight">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvCrewSearch" Height="99%" runat="server" EnableViewState="true"
                AllowCustomPaging="false" AllowSorting="false" AllowPaging="false" CellSpacing="0" GridLines="None" GroupingEnabled="false"
