<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsEmployeeStoreSelection.aspx.cs" Inherits="VesselAccountsEmployeeStoreSelection" %>
            ...
            <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false" GroupsDefaultExpanded="true"
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Quantity">
                        ...
                        <EditItemTemplate>
                            <telerik:RadNumericTextBox ID="txtQuantity" runat="server" CssClass="txtNumber" Width="100%" NumberFormat-DecimalDigits="0" IncrementSettings-InterceptArrowKeys="false"></telerik:RadNumericTextBox>
                        </EditItemTemplate>
                    </telerik:GridTemplateColumn>
