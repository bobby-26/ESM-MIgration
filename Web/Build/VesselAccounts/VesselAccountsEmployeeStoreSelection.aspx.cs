...
public partial class VesselAccountsEmployeeStoreSelection : PhoenixBasePage
{
    ...
    protected void gvStoreItem_UpdateCommand(object sender, GridCommandEventArgs e)
    {
        try
        {
            ...
            if (IsValidIssue(quantity))
            {
                NameValueCollection nvc = new NameValueCollection();
                nvc.Add("StoreItemId", storeitem);
                nvc.Add("Quantity", quantity);
                nvc.Add("UnitPrice", unitprice);

                Filter.EmployeeRequisitionPickListSelection = nvc;
        ...
        try
        {
            if (e.Item is GridDataItem)
            {
                ...
                if (Int64.TryParse(drv["FLDISINMARKET"].ToString(), out result))
                {
                    ...
                    if (result == 0)
                    {
                        //lblMakerdesc.ForeColor = System.Drawing.Color.Red;
                        lblStockItemNumber.ForeColor = System.Drawing.Color.Red;
                        lblNamedesc.ForeColor = System.Drawing.Color.Red;
                    }
                    else
                    {
                        //lblMakerdesc.ForeColor = System.Drawing.Color.Black;
                        lblStockItemNumber.ForeColor = System.Drawing.Color.Black;
                        lblNamedesc.ForeColor = System.Drawing.Color.Black;
                    }
                }
    ...
    private bool IsValidIssue(string quantity)
    {
