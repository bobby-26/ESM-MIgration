<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsExtraMealsEdit.aspx.cs" Inherits="VesselAccountsExtraMealsEdit" %>
...
<body>
    ...
    <form id="frmRegistersRank" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="94%">
            ...
            <eluc:TabStrip ID="MenuExtraMealsEdit" runat="server" OnTabStripCommand="MenuExtraMealsEdit_TabStripCommand"></eluc:TabStrip>
            ...
            <table width="50%">
                ...
                <tr>
                    <td colspan="5">
                        <telerik:RadTextBox ID="txtServedTo" runat="server" MaxLength="500" TextMode="MultiLine" Width="800px" Height="200px" CssClass="input_mandatory"
