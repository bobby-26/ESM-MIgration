<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsOffshoreEarningDeduction.aspx.cs"
    Inherits="VesselAccountsOffshoreEarningDeduction" %>
            ...
            <ContentTemplate>
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    ...
                    <div class="subHeader" style="position: relative">
                        <eluc:Title runat="server" ID="Title1" Text="Earnings/Deductions" ShowMenu="true"></eluc:Title>
                    ...
                    <table width="70%" cellpadding="1" cellspacing="1">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="ddlEmployee" runat="server" CssClass="input" AppendDataBoundItems="true"
                                    AutoPostBack="true" OnTextChangedEvent="ddlEmployee_TextChangedEvent">
                                </asp:DropDownList>
                            </td>
                            <td>
                        ...
                        <asp:GridView ID="gvCrewSearch" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Currency">
                                    ...
                                    <ItemTemplate>
                                        <asp:Literal ID="lblUSD" runat="server" Text='<%#((DataRowView)Container.DataItem)["FLDCURRENCYCODE"] %>'></asp:Literal>
                                    </ItemTemplate>
                                </asp:TemplateField>
