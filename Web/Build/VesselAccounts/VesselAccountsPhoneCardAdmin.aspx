<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsPhoneCardAdmin.aspx.cs"
    Inherits="VesselAccountsPhoneCardAdmin" %>
                ...
                <div style="top: 100px; margin-left: auto; margin-right: auto; width: 100%;">
                    <div style="top: 100px; margin-left: auto; margin-right: auto; vertical-align: middle;">
                        ...
                        <div class="subHeader" style="position: relative; right: 0px">
                            <eluc:Title runat="server" ID="Title1" Text="Phone Card Requisition" ShowMenu="false"></eluc:Title>
                        ...
                        <asp:GridView ID="gvPhonReq" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <HeaderTemplate>
                                        <asp:LinkButton ID="lnkRefNoHeader" runat="server" CommandName="Sort" CommandArgument="FLDREFERENCENO"
                                            ForeColor="White">Request No</asp:LinkButton>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <HeaderTemplate>
                                        <asp:LinkButton ID="lblOrderDate" runat="server" CommandName="Sort" CommandArgument="FLDREQUESTDATE"
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                    <HeaderTemplate>
                                        <asp:LinkButton ID="lblOrderStatus" runat="server" CommandName="Sort" CommandArgument="FLDREQUESTSTATUS"
                                            ForeColor="White">Request Status</asp:LinkButton>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server" AlternateText="Delete Duplicate Line Item" ImageUrl="<%$ PhoenixTheme:images/save.png %>"
