...
public partial class VesselAccountsPhoneCardArrange : PhoenixBasePage
{
    ...
    protected void ShowExcel()
    {
        try
        {
            ...
            DataSet ds = PhoenixVesselAccountsPhoneCardRequisition.SearchPhoneCardArrange(General.GetNullableInteger(nvc != null ? nvc["ddlVessel"] : string.Empty)
