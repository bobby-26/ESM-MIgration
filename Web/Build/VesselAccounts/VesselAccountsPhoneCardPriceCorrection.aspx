<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsPhoneCardPriceCorrection.aspx.cs"
    Inherits="VesselAccountsPhoneCardPriceCorrection" %>
                ...
                <div style="top: 100px; margin-left: auto; margin-right: auto; width: 100%;">
                    ...
                    <div id="divGrid" style="position: relative; z-index: 0; width: 100%;">
                        <asp:GridView ID="gvPhoneReqLine" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            GridLines="None" Width="100%" CellPadding="3" OnRowDataBound="gvPhoneReqLine_RowDataBound" ShowHeader="true"
                            EnableViewState="false" AllowSorting="true" ShowFooter="true" OnRowEditing="gvPhoneReqLine_RowEditing"
                            OnSorting="gvPhoneReqLine_Sorting" OnRowCancelingEdit="gvPhoneReqLine_RowCancelingEdit"
                            OnRowDeleting="gvPhoneReqLine_RowDeleting" DataKeyNames="FLDSTOREITEMID" OnRowCommand="gvPhoneReqLine_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemStyle Wrap="true" HorizontalAlign="Left"></ItemStyle>
                                    <HeaderTemplate>
                                        <asp:Label ID="lblHdrIssueDate" runat="server" Text="Actual Unit Price"></asp:Label>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <eluc:Number ID="txtUnitPrice" runat="server" CssClass="input_mandatory"
                                            DecimalPlace="2" />
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
