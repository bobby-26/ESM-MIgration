<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsRemoveTransactionlog.aspx.cs"
    Inherits="VesselAccountsRemoveTransactionlog" %>
...
<body>
    ...
    <form id="frmRegistersRank" runat="server">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="96%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvTransactionLog" Height="100%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true" CellSpacing="0" GridLines="None" OnItemCommand="gvTransactionLog_ItemCommand" OnItemDataBound="gvTransactionLog_ItemDataBound" EnableViewState="false"
                ShowFooter="false" ShowHeader="true" OnNeedDataSource="gvTransactionLog_NeedDataSource">
                <SortingSettings SortedBackColor="#FFF6D6" EnableSkinSortStyles="false"></SortingSettings>
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    AutoGenerateColumns="false" DataKeyNames="FLDLOGID">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Month">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container, "DataItem.FLDMONTH")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Year">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <%# DataBinder.Eval(Container, "DataItem.FLDYEAR")%>
                            </ItemTemplate>
