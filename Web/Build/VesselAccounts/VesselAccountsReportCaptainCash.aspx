<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsReportCaptainCash.aspx.cs" Inherits="VesselAccountsReportCaptainCash" %>
...
<body onload="resize();" onresize="resize();">
    <form id="frmCaptainCash" runat="server" autocomplete="off">
        <telerik:RadScriptManager runat="server" ID="RadScriptManager1">
        </telerik:RadScriptManager>
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="85%">
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
            <eluc:TabStrip ID="MenuReportCaptainCash" runat="server" OnTabStripCommand="MenuReportCaptainCash_TabStripCommand"></eluc:TabStrip>
            <table width="60%">
                <tr>
                    <td>
