<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsReportPhoneCardNew.aspx.cs"
    Inherits="VesselAccountsReportPhoneCardNew" %>
...
<head id="Head1" runat="server">
    ...
    <title>Phone Cards Issued</title>
...
<body>
    <form id="frmPhnCrdPinNo" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="95%">
            ...
            <telerik:RadGrid RenderMode="Lightweight" ID="gvPhnCrdPinNo" Height="90%" runat="server" AllowCustomPaging="true" AllowSorting="true" AllowPaging="true"
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false" GroupsDefaultExpanded="true"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Request No.">
                            ...
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblRequestId" runat="server" Visible="false"
                                    Text='<%# ((DataRowView)Container.DataItem)["FLDREQUESTID"] %>'>
                                </telerik:RadLabel>
                                <telerik:RadLabel ID="lnkRefNo" runat="server"
                                    Text='<%# ((DataRowView)Container.DataItem)["FLDREFERENCENO"] %>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Phone Card">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblpinid" runat="server" Text='<%# ((DataRowView)Container.DataItem)["FLDPINNUMBERID"]%>' Visible="false"></telerik:RadLabel>
                        ...
                        <telerik:GridTemplateColumn HeaderText="PIN No.">
                            ...
                            <ItemTemplate>
                                ...
                                <telerik:RadLabel ID="lblPinNoId" runat="server" Visible="false" Text='<%# ((DataRowView)Container.DataItem)["FLDPINNUMBERID"] %>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                        <telerik:GridTemplateColumn HeaderText="Employee">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblempid" runat="server" Visible="false" Text='<%# ((DataRowView)Container.DataItem)["FLDEMPLOYEEID"] %>'>
                                </telerik:RadLabel>
                                <telerik:RadLabel ID="lnkEmpName" runat="server" CommandName="select">
                        ...
                        <telerik:GridTemplateColumn HeaderText="Issued On">
                            ...
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblIssueDate" runat="server"
                                    Text='<%# string.Format("{0:dd/MMM/yyyy}", ((DataRowView)Container.DataItem)["FLDISSUEDATE"]) %>'>
                                </telerik:RadLabel>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
