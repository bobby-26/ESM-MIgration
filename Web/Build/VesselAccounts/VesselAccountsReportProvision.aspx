<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsReportProvision.aspx.cs" Inherits="VesselAccountsReportProvision" %>
...
<body onload="resize();" onresize="resize();">
    <form id="frmBond" runat="server" autocomplete="off">
        ...
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="85%">
            ...
            <eluc:TabStrip ID="MenuReportProvision" runat="server" OnTabStripCommand="MenuReportProvision_TabStripCommand"></eluc:TabStrip>
