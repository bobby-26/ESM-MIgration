<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsReportProvisionBondInventory.aspx.cs" Inherits="VesselAccountsReportProvisionBondInventory" %>
...
<head id="Head1" runat="server">
    <title>Month End Inventory</title>
...
<body onload="resize();" onresize="resize();">
    <form id="frmMonthEndInventory" runat="server" autocomplete="off">
        <telerik:RadScriptManager runat="server" ID="RadScriptManager1">
        </telerik:RadScriptManager>
        <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="85%">
            <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>

            <eluc:TabStrip ID="MenuReportMonthEndInventory" runat="server" OnTabStripCommand="MenuReportMonthEndInventory_TabStripCommand"></eluc:TabStrip>

            <table width="60%">
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblReportFor" runat="server" Text="Report For :"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadComboBox DropDownPosition="Static" ID="ddlReportFor" runat="server" EnableLoadOnDemand="True"
                            ...
                            <Items>
                                <telerik:RadComboBoxItem Text="Provision" Value="PRV" />
                                <telerik:RadComboBoxItem Text="Bonded Stores" Value="BND" />
                            </Items>
                        </telerik:RadComboBox>
                    </td>
                    <td>
