...
public partial class VesselAccountsReportRHNonComplianceSummary : PhoenixBasePage
{
    ...
    protected void MenuReportNonCompliance_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ifMoreInfo.Attributes["src"] = ViewState["REPORTPAGEURL"].ToString() + "?applicationcode=7&reportcode=RESTHOURSNCSUMMARY&showmenu=false&showexcel=no&showword=no&vesselid="
