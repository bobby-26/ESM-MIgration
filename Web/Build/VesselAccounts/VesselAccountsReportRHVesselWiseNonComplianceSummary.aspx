<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsReportRHVesselWiseNonComplianceSummary.aspx.cs"
    Inherits="VesselAccountsReportRHVesselWiseNonComplianceSummary" %>
...
<head id="Head1" runat="server">
    <title>Rest Hours Vessel Wise NonCompliance Summary</title>
...
<body>
    <form id="frmVesselWiseNonComplianceSummary" runat="server" autocomplete="off">
        <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" CombineScripts="false">
        </ajaxToolkit:ToolkitScriptManager>
        <asp:UpdatePanel runat="server" ID="pnlVesselWiseNonCompliance">
            <ContentTemplate>
                <eluc:Error ID="ucError" runat="server" Text="" Visible="false"></eluc:Error>
                <div class="subHeader" style="position: relative">
                    <div id="div2" style="vertical-align: top">
                        <eluc:Title runat="server" ID="Title1" Text="Vessel Wise NonCompliance Summary" ShowMenu="True"></eluc:Title>
                    </div>
                </div>
                <div class="navSelect" style="top: 0px; right: 0px; position: absolute">
                    <eluc:TabStrip ID="MenuReportVesselWiseNonCompliance" runat="server" OnTabStripCommand="MenuReportVesselWiseNonCompliance_TabStripCommand"></eluc:TabStrip>
                </div>
