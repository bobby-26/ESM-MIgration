...
public partial class VesselAccountsReportRHVesselWiseNonComplianceSummary : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            MenuReportVesselWiseNonCompliance.AccessRights = this.ViewState;
            MenuReportVesselWiseNonCompliance.MenuList = toolbar.Show();
            if (!IsPostBack)
            {
    ...
    protected void MenuReportVesselWiseNonCompliance_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dce.CommandName.ToUpper().Equals("SHOWREPORT"))
            {
                ...
                Response.Redirect("../Reports/ReportsView.aspx?applicationcode=7&reportcode=RESTHOURSVESSELWISENCSUMMARY&showmenu=false&showexcel=no&showword=no" + parameters);
            }
        }
        catch (Exception ex)
        {
