...
public partial class VesselAccountsReportUSListPage2 : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=7&reportcode=USCREWLIST1&showmenu=0";
        }
        catch (Exception ex)
        {
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=7&reportcode=USCREWLIST1&showexcel=no&showword=no&showmenu=0";
            }
        }
        catch (Exception ex)
        {
