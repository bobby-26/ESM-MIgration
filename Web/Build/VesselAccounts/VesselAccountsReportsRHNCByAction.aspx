<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsReportsRHNCByAction.aspx.cs" Inherits="VesselAccountsReportsRHNCByAction" %>
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC/Action" ShowMenu="true"></eluc:Title>
                    ...
                    <table id="tblNC" width="100%" align="center" runat="server">
                        ...
                        <tr>
                            ...
                            <td style="width: 15px">
                                <asp:Literal ID="lblOfficeAction" runat="server" Text="Office Action"></asp:Literal>
                            </td>
                            <td style="width: 35px">
                                <eluc:Quick ID="ucAction" runat="server" AppendDataBoundItems="true" CssClass="input_mandatory" Width="250px" QuickTypeCode="82" />
                            </td>
                        </tr>
                    </table>
                        ...
                        <asp:GridView ID="gvNC" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblReason" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDOFFICEACTIONNAME") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
