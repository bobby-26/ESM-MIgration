...
public partial class VesselAccountsReportsRHNCByAction :  PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string jvscript = "javascript:parent.Openpopup('codehelp1','','../VesselAccounts/VesselAccountsExport2XL.aspx?fleetid=" + ucFleet.SelectedFleet + "&fromdate=" + ucFromDate.Text + "&todate=" + ucToDate.Text + "&for=report6&actionid=" + ucAction.SelectedQuick + "'); return false;";
            //toolbar.AddImageLink(jvscript, "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("../VesselAccounts/VesselAccountsReportsRHNCByAction.aspx", "Export to Excel", "icon_xls.png", "Excel");
            //toolbar.AddImageLink("javascript:CallPrint('gvNC')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageButton("../VesselAccounts/VesselAccountsReportsRHNCByAction.aspx", "Search", "search.png", "FIND");
            toolbar.AddImageButton("../VesselAccounts/VesselAccountsReportsRHNCByAction.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            ...
            MenuNCGeneral.SelectedMenuIndex = 5;
    ...
    protected void MenuNC_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //ShowExcel();
                PhoenixVesselAccounts2XL.Export2XLVesselAccountsRHNCCountByAction(General.GetNullableInteger(ucFleet.SelectedFleet),
                    General.GetNullableDateTime(ucFromDate.Text), General.GetNullableDateTime(ucToDate.Text),
                    General.GetNullableInteger(ucAction.SelectedQuick));
            }
    ...
    private void BindData()
    {
        ...
        string[] alColumns = { "FLDOFFICEACTIONNAME", "FLDMONTH", "FLDNCCOUNT" };
        string[] alCaptions = { "Office Action", "Month", "No. of NCs" };

        DataSet ds = new DataSet();

        ds = PhoenixVesselAccountsRHReports.SearchRHNCByAction(
        ...
        General.SetPrintOptions("gvNC", "NCs by Office Action", alCaptions, alColumns, ds);
    ...
    private bool IsValidInput()
    {
        ...
        if (General.GetNullableInteger(ucAction.SelectedQuick) == null)
            ucError.ErrorMessage = "Office Action is required.";
