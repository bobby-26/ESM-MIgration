...
public partial class VesselAccountsReportsRHNCByOwner :  PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string jvscript = "javascript:parent.Openpopup('codehelp1','','../VesselAccounts/VesselAccountsExport2XL.aspx?ownerid=" + ucPrincipal.SelectedAddress + "&fromdate=" + ucFromDate.Text + "&todate=" + ucToDate.Text + "&for=report7'); return false;";
            //toolbar.AddImageLink(jvscript, "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("../VesselAccounts/VesselAccountsReportsRHNCByOwner.aspx", "Export to Excel", "icon_xls.png", "Excel");
            //toolbar.AddImageLink("javascript:CallPrint('gvNC')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageButton("../VesselAccounts/VesselAccountsReportsRHNCByOwner.aspx", "Search", "search.png", "FIND");
            toolbar.AddImageButton("../VesselAccounts/VesselAccountsReportsRHNCByOwner.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            ...
            MenuNCGeneral.SelectedMenuIndex = 6;
    ...
    protected void MenuNC_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //ShowExcel();
                PhoenixVesselAccounts2XL.Export2XLVesselAccountsRHNCCountByOwner(General.GetNullableInteger(ucPrincipal.SelectedAddress),
    ...
    private void BindData()
    {
        ...
        string[] alColumns = { "FLDOWNERNAME", "FLDMONTH", "FLDNCCOUNT" };
        string[] alCaptions = { "Owner", "Month", "No. of NCs" };

        DataSet ds = new DataSet();

        ds = PhoenixVesselAccountsRHReports.SearchRHNCByOwner(
        ...
        General.SetPrintOptions("gvNC", "NCs by Owner", alCaptions, alColumns, ds);
