<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsReportsRHNCByRank.aspx.cs"
    Inherits="VesselAccountsReportsRHNCByRank" %>
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC/Rank" ShowMenu="true"></eluc:Title>
                    ...
                    <table id="tblNC" width="100%" align="center" runat="server">
                        ...
                        <tr>
                            ...
                            <td style="width: 35px">
                                <asp:DropDownList ID="ddlGroupRank" runat="server" CssClass="input" />
                            </td>
                        </tr>
                    </table>
