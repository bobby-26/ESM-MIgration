...
public partial class VesselAccountsReportsRHNCByRank :  PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string jvscript = "javascript:parent.Openpopup('codehelp1','','../VesselAccounts/VesselAccountsExport2XL.aspx?fleetid=" + ucFleet.SelectedFleet + "&fromdate=" + ucFromDate.Text + "&todate=" + ucToDate.Text + "&rank=" + ddlGroupRank.SelectedValue + "&for=report1'); return false;";
            //toolbar.AddImageLink(jvscript, "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("../VesselAccounts/VesselAccountsReportsRHNCByRank.aspx", "Export to Excel", "icon_xls.png", "Excel");
            //toolbar.AddImageLink("javascript:CallPrint('gvNC')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageButton("../VesselAccounts/VesselAccountsReportsRHNCByRank.aspx", "Search", "search.png", "FIND");
            toolbar.AddImageButton("../VesselAccounts/VesselAccountsReportsRHNCByRank.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            ...
            MenuNCGeneral.SelectedMenuIndex = 0;
    ...
    private void BindGroupRank()
    {
        ...
        ddlGroupRank.DataTextField = "FLDGROUPRANK";
        ddlGroupRank.DataValueField = "FLDGROUPRANKID";
        ddlGroupRank.DataBind();
        ddlGroupRank.Items.Insert(0, new ListItem("--Select--", "Dummy"));
    }
    ...
    protected void MenuNC_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //ShowExcel();
                PhoenixVesselAccounts2XL.Export2XLVesselAccountsRHNCCountByRank(General.GetNullableInteger(ucFleet.SelectedFleet),
            ...
            else if (dce.CommandName.ToUpper().Equals("CLEAR"))
            {
                ...
                ucFromDate.Text = "";
                ucToDate.Text = "";
                ddlGroupRank.SelectedValue = null;
                BindData();
                SetPageNavigator();
            }
        }
    ...
    private void BindData()
    {
        ...
        string[] alColumns = { "FLDRANKNAME", "FLDMONTH", "FLDNCCOUNT" };
        string[] alCaptions = { "Rank", "Month", "No. of NCs" };
       
        DataSet ds = new DataSet();

        ds = PhoenixVesselAccountsRHReports.SearchRHNCByRank(
        ...
        General.SetPrintOptions("gvNC", "NCs by Rank", alCaptions, alColumns, ds);
