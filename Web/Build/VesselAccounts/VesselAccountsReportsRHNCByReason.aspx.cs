...
public partial class VesselAccountsReportsRHNCByReason : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string jvscript = "javascript:parent.Openpopup('codehelp1','','../VesselAccounts/VesselAccountsExport2XL.aspx?fleetid=" + ucFleet.SelectedFleet + "&fromdate=" + ucFromDate.Text + "&todate=" + ucToDate.Text + "&for=report5&reasonid=" + ucReason.SelectedQuick + "'); return false;";
            //toolbar.AddImageLink(jvscript, "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("../VesselAccounts/VesselAccountsReportsRHNCByReason.aspx", "Export to Excel", "icon_xls.png", "Excel");
            //toolbar.AddImageLink("javascript:CallPrint('gvNC')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageButton("../VesselAccounts/VesselAccountsReportsRHNCByReason.aspx", "Search", "search.png", "FIND");
            toolbar.AddImageButton("../VesselAccounts/VesselAccountsReportsRHNCByReason.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
            ...
            MenuNCGeneral.SelectedMenuIndex = 4;
    ...
    protected void MenuNC_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //ShowExcel();
                PhoenixVesselAccounts2XL.Export2XLVesselAccountsRHNCCountByReason(General.GetNullableInteger(ucFleet.SelectedFleet),
    ...
    private void BindData()
    {
        ...
        string[] alColumns = { "FLDREASONNAME", "FLDMONTH", "FLDNCCOUNT" };
        string[] alCaptions = { "Reason", "Month", "No. of NCs" };

        DataSet ds = new DataSet();

        ds = PhoenixVesselAccountsRHReports.SearchRHNCByReason(
        ...
        General.SetPrintOptions("gvNC", "NCs by Reason", alCaptions, alColumns, ds);
    ...
    private bool IsValidInput()
    {
        ...
        if (General.GetNullableInteger(ucReason.SelectedQuick) == null)
