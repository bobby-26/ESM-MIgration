<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsReportsRHNCBySystemCause.aspx.cs" Inherits="VesselAccountsReportsRHNCBySystemCause" %>
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC/System Cause" ShowMenu="true"></eluc:Title>
                    ...
                    <table id="tblNC" width="100%" align="center" runat="server">
                        ...
                        <tr>
                            ...
                            <td style="width: 15px">
                                <asp:Literal ID="lblSystemCause" runat="server" Text="System Cause"></asp:Literal>
                            </td>
                            <td style="width: 35px">
                                <eluc:Quick ID="ucCause" runat="server" AppendDataBoundItems="true" CssClass="input_mandatory" Width="250px" QuickTypeCode="86" />
                            </td>
                        </tr>
                    </table>
                        ...
                        <asp:GridView ID="gvNC" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <HeaderTemplate>
                                        <asp:Literal ID="lblSystemCauseCaption" runat="server" Text="System Cause"></asp:Literal>
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="lblSystemCause" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSYSTEMCAUSENAME") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                    <HeaderTemplate>
                                        <asp:Literal ID="lblMonthCaption" runat="server" Text="Month"></asp:Literal>
                                    </HeaderTemplate>
                                    <ItemTemplate>
