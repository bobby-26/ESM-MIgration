<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsReportsRHNCByVesselType.aspx.cs" Inherits="VesselAccountsReportsRHNCByVesselType" %>
            ...
            <ContentTemplate>
                ...
                <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                    <div class="subHeader" style="position: relative">
                        <div id="divHeading">
                            <eluc:Title runat="server" ID="ucTitle" Text="NC/Vessel Type" ShowMenu="true"></eluc:Title>
