...
public partial class VesselAccountsReportsRHNCByVesselType :  PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            string jvscript = "javascript:parent.Openpopup('codehelp1','','../VesselAccounts/VesselAccountsExport2XL.aspx?vesseltype=" + ucVesselType.SelectedHard + "&fromdate=" + ucFromDate.Text + "&todate=" + ucToDate.Text + "&for=report2'); return false;";
            //toolbar.AddImageLink(jvscript, "Export to Excel", "icon_xls.png", "Excel");
            toolbar.AddImageLink("../VesselAccounts/VesselAccountsReportsRHNCByVesselType.aspx", "Export to Excel", "icon_xls.png", "Excel");
            //toolbar.AddImageLink("javascript:CallPrint('gvNC')", "Print Grid", "icon_print.png", "PRINT");
            toolbar.AddImageButton("../VesselAccounts/VesselAccountsReportsRHNCByVesselType.aspx", "Search", "search.png", "FIND");
            toolbar.AddImageButton("../VesselAccounts/VesselAccountsReportsRHNCByVesselType.aspx", "Clear Filter", "clear-filter.png", "CLEAR");
    ...
    protected void MenuNC_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //ShowExcel();
                PhoenixVesselAccounts2XL.Export2XLVesselAccountsRHNCCountByVesseltype(General.GetNullableInteger(ucVesselType.SelectedHard),
    ...
    private void BindData()
    {
        ...
        string[] alColumns = { "FLDVESSELTYPENAME", "FLDMONTH", "FLDNCCOUNT" };
        string[] alCaptions = { "Vessel Type", "Month", "No. of NCs" };

        DataSet ds = new DataSet();

        ds = PhoenixVesselAccountsRHReports.SearchRHNCByVesseltype(
        ...
        General.SetPrintOptions("gvNC", "NCs by Vessel Type", alCaptions, alColumns, ds);
