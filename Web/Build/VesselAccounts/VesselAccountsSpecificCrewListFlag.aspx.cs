...
public partial class VesselAccountsSpecificCrewListFlag : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=7&reportcode=SPECIFICLIST&vesselid=" + PhoenixSecurityContext.CurrentSecurityContext.VesselID + "&showexcel=no&showword=no&showmenu=0";
    ...
    protected void ReportsFilter_TabStripCommand(object sender, EventArgs e)
    {
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SHOWREPORT"))
            {
                ...
                {
                    ifMoreInfo.Attributes["src"] = ViewState["PAGEURL"].ToString() + "?applicationcode=7&reportcode=SPECIFICLIST&vesselid=" + ucVessel.SelectedVessel.ToString() + "&showmenu=0";
                }
            }
