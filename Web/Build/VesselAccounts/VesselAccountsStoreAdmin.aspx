<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselAccountsStoreAdmin.aspx.cs"
    Inherits="VesselAccountsStoreAdmin" %>
            ...
            <div class="navigation" id="navigation" style="margin-left: auto; margin-right: auto; width: 100%;">
                ...
                <div class="subHeader" style="position: relative">
                    <div id="divHeading" style="vertical-align: top">
                        <eluc:Title runat="server" ID="ucTitle" Text="Store Admin" ShowMenu="false"></eluc:Title>
                    </div>
                </div>
                <div style="top: 0px; right: 0px; position: absolute">
                    <eluc:TabStrip ID="MenuStoreAdmin" runat="server" OnTabStripCommand="MenuStoreAdmin_TabStripCommand"
