...
public partial class VesselPosition_VesselPositionArrivalReportFilter : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ArrivalReportFilterMain.AccessRights = this.ViewState;
        ArrivalReportFilterMain.MenuList = toolbar.Show();
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        if (nvc != null && !IsPostBack)
        {
            ...
            UcArrivalPort.SelectedValue = (nvc.Get("UcArrivalPort") == null) ? "" : nvc.Get("UcArrivalPort").ToString();
    ...
    protected void ArrivalReportFilterMain_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("GO"))
        {
            ...
            criteria.Add("UcArrivalPort", UcArrivalPort.SelectedValue);
