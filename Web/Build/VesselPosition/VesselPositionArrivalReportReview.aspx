<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionArrivalReportReview.aspx.cs" Inherits="VesselPositionArrivalReportReview" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%">
            <tr>
                ...
                <td style="text-align-last:center"><telerik:RadLabel ID="lblReportType" Text="Arrival Report" runat="server"></telerik:RadLabel></td>
