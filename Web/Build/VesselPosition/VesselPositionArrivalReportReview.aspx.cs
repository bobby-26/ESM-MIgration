...
public partial class VesselPositionArrivalReportReview : PhoenixBasePage
{
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("MAIL"))
            {
                String scriptpopup = String.Format(
                 "javascript:parent.openNewWindow('Filter', '', '" + Session["sitepath"] + "/VesselPosition/VesselPositionArrivalReviewMail.aspx?VesselId="
