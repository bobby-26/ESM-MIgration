<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionBunkerReceiptMaster.aspx.cs"
    Inherits="VesselPositionBunkerReceiptMaster" %>
        ...
        <ContentTemplate>
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top;
                ...
                <div class="subHeader" style="position: relative">
                    <eluc:Title runat="server" ID="frmTitle" Text="Bunker Delivery Note" ShowMenu="false"></eluc:Title>
