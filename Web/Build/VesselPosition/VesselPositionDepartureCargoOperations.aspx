<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionDepartureCargoOperations.aspx.cs" Inherits="VesselPositionDepartureCargoOperations" MaintainScrollPositionOnPostback="true" %>
...
<body>
    <form id="frmCargoOperations" runat="server">
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server" CssClass="scrolpan" Height="100%">
                ...
                <tr>
                    <td runat="server" id="divDischarge" style="width: 100%">
                        ...
                        <telerik:RadGrid ID="gvDischarge" runat="server" AutoGenerateColumns="false" Font-Size="11px" Width="100%" Height="100%"
                            OnItemCommand="gvDischarge_RowCommand" OnItemDataBound="gvDischarge_ItemDataBound" AllowSorting="false" EnableHeaderContextMenu="true" GroupingEnabled="false"
                            CellPadding="3" ShowFooter="false" ShowHeader="true" EnableViewState="false" OnNeedDataSource="gvDischarge_NeedDataSource">
                        ...
                        <table cellpadding="1" cellspacing="1" width="100%">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <telerik:RadCheckBox ID="chkOilMajor" runat="server" AutoPostBack="true" Visible="false" />
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 15%;">
            ...
            <table cellpadding="1" cellspacing="1" width="75%" style="display: none;">
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server" ID="ddlCargoOperation" AutoPostBack="true" CssClass="dropdown_mandatory" AppendDataBoundItems="true" Visible="false">
                            <asp:ListItem Text="--Select--" Value=""></asp:ListItem>
                            <asp:ListItem Text="Loading" Value="LOAD" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="Discharging" Value="DISCH"></asp:ListItem>
                        </asp:DropDownList>
