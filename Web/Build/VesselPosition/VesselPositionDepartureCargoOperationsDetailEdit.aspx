<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionDepartureCargoOperationsDetailEdit.aspx.cs" Inherits="VesselPositionDepartureCargoOperations" MaintainScrollPositionOnPostback="true" %>
    ...
    <form id="frmCargoOperations" runat="server">
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
            ...
            <telerik:RadGrid ID="gvCargoOperation" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                ...
                ShowFooter="false" ShowHeader="true" OnNeedDataSource="gvCargoOperation_NeedDataSource" EnableHeaderContextMenu="true" GroupingEnabled="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Time / Value">
                            ...
                            <EditItemTemplate>
                                ...
                                <telerik:RadTextBox runat="server" ID="txtValueFreeTextEdit" CssClass="input"  Width="100%"
                        ...
                        <telerik:GridTemplateColumn HeaderText="Remarks">
                            ...
                            <EditItemTemplate>
                                <telerik:RadTextBox runat="server" ID="txtRemarksEdit" CssClass="input"  Width="100%"
            ...
            <table cellpadding="1" cellspacing="1" width="75%" style="visibility: hidden; display: none;">
                <tr>
                    <td style="width: 40%">
                        <asp:Literal ID="lblCargoOperation" runat="server" Text="Cargo Operation"></asp:Literal>
                    </td>
                    <td>
                        <telerik:RadComboBox runat="server" ID="ddlCargoOperation" AutoPostBack="true" CssClass="dropdown_mandatory" AppendDataBoundItems="true">
                            <Items>
