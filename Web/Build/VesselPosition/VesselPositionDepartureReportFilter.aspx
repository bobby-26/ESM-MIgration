<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionDepartureReportFilter.aspx.cs" Inherits="VesselPosition_VesselPositionDepartureReportFilter" %>
...
<head id="Head1" runat="server">
    <title>Departure Report Filter</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <eluc:TabStrip ID="DepartureReportFilterMain" runat="server" OnTabStripCommand="DepartureReportFilterMain_TabStripCommand"></eluc:TabStrip>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlPlanReliever">
            <table cellpadding="2" cellspacing="2" width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Vessel ID="ddlVessel" runat="server" CssClass="input" VesselsOnly="true" AutoPostBack="true" SyncActiveVesselsOnly="True" OnTextChangedEvent="ddlVessel_Changed" AppendDataBoundItems="true" AssignedVessels="true" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <eluc:Voyage ID="ucVoyage" runat="server" AppendDataBoundItems="true"
                            CssClass="input"></eluc:Voyage>
                    </td>
                </tr>
                <tr>
                    <td>
