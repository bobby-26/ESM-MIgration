<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionDepartureReportMRVSummary.aspx.cs" Inherits="VesselPositionDepartureReportMRVSummary" %>
            ...
            <eluc:TabStrip ID="DepartureSummary" TabStrip="true" runat="server" OnTabStripCommand="DepartureSummary_TabStripCommand"></eluc:TabStrip>
                <table width="50%" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            &nbsp;<telerik:RadLabel ID="lblArrivalUTC" runat="server" Text="UTC"></telerik:RadLabel>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            &nbsp;<telerik:RadLabel ID="lblDepartureUTC" runat="server" Text="UTC"></telerik:RadLabel>
                ...
                <telerik:RadGrid ID="gvConsumption" runat="server" AutoGenerateColumns="False" Font-Size="11px" 
                    ...
                    <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Fuel Type" HeaderStyle-Wrap="false">
