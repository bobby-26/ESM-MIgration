...
public partial class VesselPositionDepartureReportMRVSummary : PhoenixBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddButton("Departure", "DEPARTURE");
    ...
    {
        DataSet ds = PhoenixVesselPositionDepartureReport.DepartureMRVSummary(General.GetNullableGuid(Filter.CurrentVPRSDepartureReportSelection));
