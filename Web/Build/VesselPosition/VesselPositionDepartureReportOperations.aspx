<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionDepartureReportOperations.aspx.cs" Inherits="VesselPositionDepartureReportOperations" %>
...
<body>
    <form id="frmDepartureReport" runat="server">
        ...
        <telerik:RadAjaxPanel ID="panel1" runat="server">
                ...
                <MasterTableView EditMode="InPlace" HeaderStyle-Font-Bold="true" ShowHeadersWhenNoRecords="true" AllowNaturalSort="false"
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Vapour Qty (MT)" HeaderStyle-Wrap="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                            <ItemTemplate>
                                <telerik:RadLabel ID="lblVapourQty" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDVAPOURQUANTITY") %>'></telerik:RadLabel>
                            </ItemTemplate>
                            <EditItemTemplate>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Commenced" HeaderStyle-Wrap="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                        ...
                        <telerik:GridTemplateColumn HeaderText="Completed" HeaderStyle-Wrap="false">
                            <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                            <FooterStyle Wrap="false" HorizontalAlign="Right" />
                            <ItemTemplate>
            ...
            <br />
            <b>
                <telerik:RadLabel ID="lblmBallastDeballasting" runat="server" Text="Ballasting / Deballasting"></telerik:RadLabel>
            </b>
            <table cellpadding="1" cellspacing="1">
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblmCommencedBallasting" runat="server" Text="Commenced Ballasting"></telerik:RadLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblmCompletedBallasting" runat="server" Text="Completed Ballasting"></telerik:RadLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblmQuantityBallasted" runat="server" Text="Quantity Ballasted"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Number runat="server" ID="txtVolumeBallasted" CssClass="input" DecimalPlace="2" Width="80px"
                            MaxLength="8" />
                        &nbsp;
                                    <telerik:RadLabel ID="lblmQuantityBallastedMT" runat="server" Text="MT"></telerik:RadLabel>
                    </td>
                </tr>
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblmCommencedDeballasting" runat="server" Text="Commenced Deballasting"></telerik:RadLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblmCompletedDeballasting" runat="server" Text="Completed Deballasting"></telerik:RadLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel ID="lblmQuantityDeballasted" runat="server" Text="Quantity Deballasted"></telerik:RadLabel>
                    </td>
                    <td>
                        <eluc:Number runat="server" ID="txtVolumeDeballasted" CssClass="input" DecimalPlace="2" Width="80px"
                            MaxLength="8" />
                        &nbsp;
                                    <telerik:RadLabel ID="lblmQuantityDeballastedMT" runat="server" Text="MT"></telerik:RadLabel>
                    </td>
                </tr>
            </table>
            <br />
            <b>
                <telerik:RadLabel ID="lblmOtherOperations" runat="server" Text="Other Operations"></telerik:RadLabel>
            </b>
            <telerik:RadGrid ID="gvOtherOpr" runat="server" AutoGenerateColumns="False" Font-Size="11px" OnNeedDataSource="gvOtherOpr_NeedDataSource"
                Width="100%" CellPadding="3" OnItemCommand="gvOtherOpr_RowCommand" OnItemDataBound="gvOtherOpr_ItemDataBound"
                 OnUpdateCommand="gvOtherOpr_RowUpdating" EnableHeaderContextMenu="true" GroupingEnabled="false" AllowSorting="false"
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Description">
                            ...
                            <EditItemTemplate>
                                ...
                                <telerik:RadTextBox runat="server" ID="txtDescriptionEdit" CssClass="input" 
                                    Width="450px" TextMode="MultiLine" Resize="Both" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDESCRIPTION") %>'>
                                </telerik:RadTextBox>
                            </EditItemTemplate>
                            <FooterTemplate>
                                <telerik:RadTextBox runat="server" ID="txtDescriptionAdd" CssClass="input"
                                    Width="450px" TextMode="MultiLine" Resize="Both">
                                </telerik:RadTextBox>
                            </FooterTemplate>
                        </telerik:GridTemplateColumn>
                        ...
                        <telerik:GridTemplateColumn Visible="false" HeaderText="Date and Time">
                            <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                             <FooterStyle Wrap="false" />
                            <ItemTemplate>
