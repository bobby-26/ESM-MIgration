...
public partial class VesselPositionDepartureReportReview : PhoenixBasePage
{
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("MAIL"))
            {
                String scriptpopup = String.Format(
                 "javascript:parent.openNewWindow('Filter', '', '" + Session["sitepath"] + "/VesselPosition/VesselPositionDepartureReviewMail.aspx?VesselId="
