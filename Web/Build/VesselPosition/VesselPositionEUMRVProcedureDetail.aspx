<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetail.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetail" %>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td style="width: 70%">
                        ...
                        <b>
                            <asp:Label ID="lblProceduretxt" runat="server"></asp:Label></b>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span id="spnPickListDocument">
                            <telerik:RadTextBox ID="txtDocumentName" runat="server" Width="260px" CssClass="input" AutoPostBack="true" Enabled="false" OnDataBinding="txtDocumentName_OnTextChanged"></telerik:RadTextBox>
                ...
                <tr>
                    ...
                    <td>
                        <b>
                            <telerik:RadLabel runat="server" ID="txtVersion" Text="0" Visible="false"></telerik:RadLabel>
                            <asp:Label runat="server" ID="txtDocumentRevision"></asp:Label>
                        </b>
                    </td>
                </tr>
                <tr>
