<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailC210.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailC210" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVPRSLocation">
            ...
            <table width="100%">
                    ...
                    <td>
                       <%--   <a id="link" href="#" class="applinks"> <hyperlink id="txtDocumentNameEdit" runat="server"></hyperlink></a> --%>
                        <span id="spnPickListDocument">
                            <telerik:RadTextBox ID="txtDocumentName" runat="server" Width="260px" CssClass="input" Enabled="false" AutoPostBack="true" OnDataBinding="txtDocumentName_OnTextChanged"></telerik:RadTextBox>
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadTextBox ID="txteuprocedure" runat="server" CssClass="input" Height="70px" TextMode="MultiLine" Resize="Both"
                            Width="70%" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel runat="server" ID="lblFormulae" Text="Formulae and data sources"></telerik:RadLabel>
                    </td>
                    <td>
            ...
            <table width="100%">
                <tr>
                    ...
                    <td style="width: 70%">
                        <asp:CheckBox ID="chkapplicableYN" runat="server" AutoPostBack="true" OnCheckedChanged="chkapplicableYN_CheckedChanged" />
                    </td>
                </tr>
            </table>
