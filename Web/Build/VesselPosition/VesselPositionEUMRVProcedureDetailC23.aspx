<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailC23.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailC23" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span id="spnPickListDocument">
                            <telerik:RadTextBox ID="txtDocumentName" runat="server" Width="260px" CssClass="input" AutoPostBack="true" OnDataBinding="txtDocumentName_OnTextChanged"></telerik:RadTextBox>
