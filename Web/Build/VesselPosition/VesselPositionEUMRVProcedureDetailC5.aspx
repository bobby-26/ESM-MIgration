<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailC5.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailC5" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVPRSLocation">
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                        <b>
                            <telerik:RadLabel runat="server" ID="txtVersion" Text="0"></telerik:RadLabel>
                        </b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel runat="server" ID="lblUnitofcagopassengers" Text="Unit of cargo / passengers"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtUnitofcagopassengers" CssClass="input" Width="360px"></telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    <td>
