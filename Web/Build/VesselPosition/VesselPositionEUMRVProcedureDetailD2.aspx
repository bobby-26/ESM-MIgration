<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailD2.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailD2" %>
    ...
    <form id="frmVPRSLocation" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVPRSLocation">
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        <telerik:RadLabel runat="server" ID="lblMethodTreat" Text="Description of method to treat data gaps"></telerik:RadLabel>
                    </td>
                    <td>
