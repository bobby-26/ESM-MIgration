<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailE2.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailE2" %>
    ...
    <form id="frmVPRSLocation" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVPRSLocation">
            ...
            <table width="100%">
                ...
                <tr>
                    <td>
                        <telerik:RadLabel runat="server" ID="lbleuprocedure" Text="Brief description of procedure"></telerik:RadLabel>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <telerik:RadLabel runat="server" ID="lbllistexistingmgntsystem" Text="List of relevant existing management system"></telerik:RadLabel>
                    </td>
                    <td>
                        <telerik:RadTextBox runat="server" ID="txtlistexistingmgntsystem" CssClass="input" Width="360px"></telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <b>
                            <telerik:RadLabel runat="server" ID="txtVersion" Visible="false" Text="0"></telerik:RadLabel>
                        </b>
                    </td>
                </tr>
            </table>
