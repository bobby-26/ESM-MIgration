...
public partial class VesselPositionEUMRVProcedureDetailE2 : PhoenixBasePage
{
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("SAVE"))
            {
                   PhoenixVesselPositionEUMRV.InsertEUMRVProcedureDetail(PhoenixSecurityContext.CurrentSecurityContext.UserCode,
                                                                            ...
                                                                            , null, null, null, null, General.GetNullableString(txtlistexistingmgntsystem.Text), null);
        ...
        if (Request.QueryString["Table"] != null && General.GetNullableString(Request.QueryString["Table"].ToString()) != null)
        {
            ...
            }else
            {
                if (dt2.Rows.Count > 0)
                {
                    ...
                    //string Guidance = dt.Rows[0]["FLDCODE"].ToString() + "-" + General.GetNullableString(dt.Rows[0]["FLDGUIDANCE"].ToString()) != null ? " (" + dt.Rows[0]["FLDGUIDANCE"].ToString() + ")" : "";
