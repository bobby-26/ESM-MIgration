<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailHistoryList.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailHistoryList" %>
        ...
        <ContentTemplate>
            ...
            <div class="navigation" id="navigation" style="top: 0px; margin-left: 0px; vertical-align: top; width: 100%">
                <div class="subHeader" style="position: relative">
                    <div id="divHeading">
                        <eluc:Title runat="server" ID="ucTitle" Text="Company Procedure History"></eluc:Title>
                    </div>
                    ...
                    <asp:GridView ID="gvProcedure" runat="server" AutoGenerateColumns="False" Font-Size="11px"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                     <asp:Label ID="lblProcedure" runat="server"  Text='<%# DataBinder.Eval(Container,"DataItem.FLDPROCEDUREGUIDANCE") %>'></asp:Label>
