<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailRevise.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailRevise" %>
    ...
    <asp:UpdatePanel runat="server" ID="pnlVPRSLocation">
        <ContentTemplate>
           ...
           <div class="subHeader" style="position: relative">
                    <div class="subHeader" style="position: relative">
                        <eluc:Title runat="server" ID="Title1" Text="Company Procedure Revise" ShowMenu="true">
                        </eluc:Title>
                    ...
                    <div class="subHeader" style="top: 27px; position: absolute;">
                        <div class="navSelect" style="top: 0px; right: 0px; position: absolute;">
                            <eluc:TabStrip ID="TabProcedure" runat="server" OnTabStripCommand="TabProcedure_TabStripCommand">
                            </eluc:TabStrip>
                        </div>
                    </div>
                </div>
            <div id="maindiv" style="top: 27px; position: relative; z-index: +2">
                <table width="100%">
                    <tr>
                        <td style=" width:30%">
                    ...
                    <tr>
                        ...
                        <td>
                         <span id="spnPickListDocument">
                            ...
                            <asp:TextBox ID="txtReferencetoExisting" runat="server" CssClass="input" Height="70px" Visible="false" TextMode="MultiLine"
                                    Width="70%" />
                        </td>
                    </tr>
                    <tr>
