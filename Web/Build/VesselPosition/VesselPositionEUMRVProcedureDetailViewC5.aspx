<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailViewC5.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailViewC5" %>
           ...
           <div class="subHeader" style="position: relative">
            ...
            <div id="maindiv" style="top: 0px; position: relative; z-index: +2">
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            <asp:Literal runat="server" ID="lblUnitofcagopassengers" Text="Unit of cargo / passengers"></asp:Literal>
                        </td>
                        <td>
                             <asp:TextBox runat="server" ID="txtUnitofcagopassengers" CssClass="input"  Width="360px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
