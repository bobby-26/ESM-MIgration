<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailViewD1.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailViewD1" %>
           ...
           <div class="subHeader" style="position: relative">
            ...
            <div id="maindiv" style="top: 0px; position: relative; z-index: +2">
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            <asp:Literal runat="server" ID="lblBackupmethod" Text="Back-up monitoring method (A/B/C/D)"></asp:Literal>
                        </td>
                        <td>
                             <asp:TextBox runat="server" ID="txtBackupmethod" CssClass="input" Width="360px"></asp:TextBox>
                             
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Literal runat="server" ID="lblMethodTreat" Text="Description of method to estimate fuel consumption"></asp:Literal>
                        </td>
                        <td>
                              <asp:TextBox ID="txtMethodTreat" runat="server" CssClass="input" Height="70px" TextMode="MultiLine"
                                    Width="70%" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <asp:Literal runat="server" ID="lblFormulae" Text="Formulae"></asp:Literal>
                        </td>
                        <td>
                             <asp:TextBox runat="server" ID="txtFormulae" CssClass="input" Width="360px"></asp:TextBox>
                    ...
                    <tr>
                        <td>
                            <asp:Literal runat="server" ID="lblVersion" Visible="false" Text="Version of Existing Procedure"></asp:Literal>
                        </td>
                        <td>
                           <b> <asp:Literal runat="server" ID="txtVersion" Visible="false" Text="0"></asp:Literal></b>
                        </td>
                    </tr>
                </table>
