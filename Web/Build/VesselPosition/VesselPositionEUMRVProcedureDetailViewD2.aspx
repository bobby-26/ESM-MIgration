<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailViewD2.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailViewD2" %>
           ...
           <div class="subHeader" style="position: relative">
            ...
            <div id="maindiv" style="top: 0px; position: relative; z-index: +2">
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            <asp:Literal runat="server" ID="lblMethodTreat" Text="Description of method to treat data gaps"></asp:Literal>
                        </td>
                        <td>
