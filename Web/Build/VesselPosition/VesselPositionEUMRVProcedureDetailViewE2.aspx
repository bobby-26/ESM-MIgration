<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUMRVProcedureDetailViewE2.aspx.cs" Inherits="VesselPositionEUMRVProcedureDetailViewE2" %>
           ...
           <div class="subHeader" style="position: relative">
            ...
            <div id="maindiv" style="top: 0px; position: relative; z-index: +2">
                <table width="100%">
                    ...
                    <tr>
                        <td>
                            <asp:Literal runat="server" ID="lbllistexistingmgntsystem" Text="List of relevant existing management system"></asp:Literal>
                        </td>
                        <td>
                             <asp:TextBox runat="server" ID="txtlistexistingmgntsystem" CssClass="input" Width="360px"></asp:TextBox>
                        </td>
                    </tr>
                     <tr>
                        <td>
