<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUVoyageMRVDepartureSummary.aspx.cs" Inherits="VesselPositionEUVoyageMRVDepartureSummary" %>
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Vessel">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblDepartureSummaryID" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDDEPARTUREMRVSUMMARYID") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFromtem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDSEAPORTNAME") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCommencedItem" runat="server" Text='<%# General.GetDateTimeToString(DataBinder.Eval(Container,"DataItem.FLDARRIVALDATE")) + " " + DataBinder.Eval(Container,"DataItem.FLDARRIVALDATE", "{0:HH:mm}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCompletedItem" runat="server" Text='<%# General.GetDateTimeToString(DataBinder.Eval(Container,"DataItem.FLDDEPARTUREDATE")) + " " + DataBinder.Eval(Container,"DataItem.FLDDEPARTUREDATE", "{0:HH:mm}") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTimeInportItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDTOTALTIMESPENTINPORT") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDistanceItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCARGOONARRIVAL") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTimeAtSeaItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCARGOLOADED") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCargoQtyItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCARGODISCHARGED") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTransportWorkItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCARGOONDEPARTURE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAggCo2EmittedItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDAGGCO2EMISSION") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                     <asp:TemplateField>
