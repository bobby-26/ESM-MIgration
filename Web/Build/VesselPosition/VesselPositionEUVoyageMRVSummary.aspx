<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionEUVoyageMRVSummary.aspx.cs" Inherits="VesselPositionEUVoyageMRVSummary" %>
            ...
            <ContentTemplate>
                ...
                <table width ="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Literal ID="lblCompletedFrom" runat="server" Text="Completed From - To" Visible="false"></asp:Literal>
                            &nbsp;&nbsp;
                        </td>
                        <td>
                            <eluc:Date runat="server" ID="txtCompletedFrom" CssClass="input" DatePicker="true" Visible="false" />
                            <asp:Literal ID="lblCompletedTo" runat="server" Text=" - " Visible="false"></asp:Literal>
                            <eluc:Date runat="server" ID="txtCompletedTo" CssClass="input" DatePicker="true" Visible="false" />
                        </td>
                    </tr>
                </table>
                <br />
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="Vessel">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblArrivalSummaryID" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container,"DataItem.FLDARRIVALMRVSUMMARYID") %>'></asp:Label>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFromtem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDFROMPORT") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTotem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDTOPORT") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Left"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblBallastLadenItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDBALLASTORLADEN") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                            ...
                                            <asp:TemplateField>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTimeAtSeaItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPRETIMESPENTATSEA") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCargoQtyItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDCARGOQUANTITY") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTransportWorkItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDPRETOTALTRANSPORTWORK") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAggCo2EmittedItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDAGGCO2EMITTED") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPerDistco2Item" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDAVGCO2DISTANCE") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPerTransportWorkItem" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FLDAVGCO2TRANSPORTWORK") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                             <asp:TemplateField>
