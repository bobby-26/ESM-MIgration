...
public partial class VesselPositionEUVoyageReportingSummaryInport : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            toolbar.AddFontAwesomeButton("../VesselPosition/VesselPositionEUVoyageReportingSummaryInport.aspx", "Export to Excel", "<i class=\"fas fa-file-excel\"></i>", "Excel");
            toolbar.AddFontAwesomeButton("javascript:CallPrint('gvConsumption')", "Print Grid", "<i class=\"fas fa-print\"></i>", "PRINT");
            toolbar.AddFontAwesomeButton("../VesselPosition/VesselPositionEUVoyageReportingSummaryInport.aspx", "Search", "<i class=\"fas fa-search\"></i>", "SEARCH");
            toolbar.AddFontAwesomeButton("../VesselPosition/VesselPositionEUVoyageReportingSummaryInport.aspx", "Clear-Filter", "<i class=\"fas fa-eraser\"></i>", "CLEAR");
    ...
    private void SetFilter()
    {
        ...
        criteria.Add("chkShowNonEU", chkShowNonEU.Checked == true ? "1" : "0");
    ...
    protected void MenuDepartureReport_TabStripCommand(object sender, EventArgs e)
    {
        ...
        if (CommandName.ToUpper().Equals("ATSEA"))
        {
            Response.Redirect("../VesselPosition/VesselPositionEUVoyageReportingSummary.aspx");
        }
    ...
    private void ShowExcel()
    {
        ...
        NameValueCollection nvc = Filter.CurrentEUVoyageListFilter;
        DataSet ds = PhoenixVesselPositionEUMRVSummaryReport.EUReportingSummarySearch(General.GetNullableInteger(PhoenixSecurityContext.CurrentSecurityContext.VesselID == 0 ? ((nvc.Get("ddlVessel") == null) ? "" : nvc.Get("ddlVessel").ToString()) : PhoenixSecurityContext.CurrentSecurityContext.VesselID.ToString())
                                                                                , sortexpression
                                                                                 , sortdirection
                                                                                 , 1
    ...
    protected void gvConsumption_ItemDataBound(Object sender, GridItemEventArgs e)
    {
        try
        {
            ...
            RadLabel lblAggCo2EmittedItem = (RadLabel)e.Item.FindControl("lblAggCo2EmittedItem");
