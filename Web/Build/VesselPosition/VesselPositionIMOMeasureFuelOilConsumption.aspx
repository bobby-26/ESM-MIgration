<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionIMOMeasureFuelOilConsumption.aspx.cs" Inherits="VesselPositionIMOMeasureFuelOilConsumption" %>
...
<body>
    <form id="frmVPRSLocation" runat="server">
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlVPRSLocation">
            ...
            <eluc:TabStrip ID="MenuProcedureDetailList" Title="Methods to measure fuel oil consumption" runat="server" OnTabStripCommand="MenuProcedureDetailList_TabStripCommand"
            ...
            <table width="100%">
                <tr>
                    ...
                    <td>
                        <telerik:RadComboBox ID="ddlmethod" runat="server" CssClass="input" Width="360px"></telerik:RadComboBox>
