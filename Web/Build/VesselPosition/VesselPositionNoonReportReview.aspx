<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionNoonReportReview.aspx.cs" Inherits="VesselPositionNoonReportReview" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%">
            <tr>
                ...
                <td style="text-align-last:center"><telerik:RadLabel ID="lblReportType" Text="Noon Report" runat="server"></telerik:RadLabel></td>
        ...
        <telerik:RadAjaxPanel runat="server" ID="pnlPlanReliever">
            ...
            <table>
             ...
             <br /><br />
            <h3><telerik:RadLabel ID="lblalert" runat="server" Text="Alert Msg : "></telerik:RadLabel></h3>
