...
public partial class VesselPositionNoonReportReview : PhoenixBasePage
{
        ...
        try
        {
            ...
            if (CommandName.ToUpper().Equals("MAIL"))
            {
                String scriptpopup = String.Format(
                 "javascript:parent.openNewWindow('Filter', '', '" + Session["sitepath"] + "/VesselPosition/VesselPositionNoonReportReviewMail.aspx?VesselId="
