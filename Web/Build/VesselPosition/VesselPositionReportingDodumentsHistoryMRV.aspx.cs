...
public partial class VesselPositionReportingDodumentsHistoryMRV : PhoenixBasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            MenuTab.SelectedMenuIndex = 2;

            PhoenixToolbar toolbarvoyagelist = new PhoenixToolbar();
            toolbarvoyagelist.AddFontAwesomeButton("../VesselPosition/VesselPositionReportingDodumentsHistoryMRV.aspx", "Search", "<i class=\"fas fa-search\"></i>", "SEARCH");
            toolbarvoyagelist.AddFontAwesomeButton("../VesselPosition/VesselPositionReportingDodumentsHistoryMRV.aspx", "Clear Filter", "<i class=\"fas fa-eraser\"></i>", "RESET");
            toolbarvoyagelist.AddFontAwesomeButton("../VesselPosition/VesselPositionReportingDodumentsHistoryMRV.aspx", "Add", "<i class=\"fa fa-plus-circle\"></i>", "ADD");
    ...
    {
        PhoenixVesselPositionReportingdocumentsHistory.ReportingdocumentsHistoryInsert(General.GetNullableInteger(UcVessel.SelectedVessel),2);
        Rebind();
    }
