...
public partial class VesselPositionShiftingCargoOperationsDetailEdit : PhoenixBasePage
{
        ...
        try
        {
            ...
            if (e.CommandName.ToUpper().Equals("DELETE"))
            {
                PhoenixVesselPositionDepartureReport.DeleteDepartureCargoOperation(
                    ...
                    , General.GetNullableGuid((((RadLabel)e.Item.FindControl("lblDepCargoOprId")).Text)));
