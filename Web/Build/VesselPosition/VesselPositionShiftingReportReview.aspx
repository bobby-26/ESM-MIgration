<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselPositionShiftingReportReview.aspx.cs" Inherits="VesselPositionShiftingReportReview" %>
    ...
    <form id="form1" runat="server">
        ...
        <table width="100%">
            <tr>
                ...
                <td style="text-align-last:center"><telerik:RadLabel ID="lblReportType" Text="Shifting Report" runat="server"></telerik:RadLabel></td>
