...
public partial class VesselPositionShiftingReviewMail : PhoenixBasePage
{
    ...
    protected void bind()
    {
        ...
        string html = "";
        html = "<html>Dear Captain,<br /><br />Your Shifting Report of " + DateTime.Parse( ds.Tables[1].Rows[0]["FLDDATE"].ToString()).ToString("dd MMM yyyy") + " has been well received. We note the following parameters are not within limits.<br /><br />";
           ...
           if (CommandName.ToUpper().Equals("MAIL"))
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    string subject = "Shifting Report " + DateTime.Parse(ViewState["date"].ToString()).ToString("dd MMM yyyy hh:mm") + "- Review";
