...
function OpenPopupWindow(name, strTitle, strURL, type, predefinedsize, content, posx, posy, callback) /*type: alert, filter, codehelp,datepicker*/
{
    ...
    if (type == "alert") {
        ...
        new xFenster(name, '<table><tr><td>' + XF_Icon('processes.png') + '</td><td valign="top">' + strTitle + '</td></tr></table>', strURL, x, y, w, h,
				150, null, 1, 1, 1,
				true, true, true, true, true, false, false,
        ...
        CloseCodeHelpWindow(name);
        new xFenster(name, XF_Icon('rte_icon.gif') + strTitle, strURL, x, y, w, h,
					150, null, 1, 1, 1,
					true, true, true, true, true, false, false,
					null, null, null, null, null, null, null, fensterresize,
					'xafCon', 'xafClient', 'xafTBar', 'xafTBarF', 'xafSBar', 'xafSBarF',
    ...
    yCurrent = y;
        ...
        new xFenster(name, '<table><tr><td valign="top">' + XF_Icon('cal.gif') + '</td><td valign="top">' + strTitle + '</td></tr></table>', strURL, Number(xCurrent), Number(yCurrent), w, h,
			150, null, 1, 1, 1,
...
function XF_Icon(fileName) {
    return '<img valign="top" style="padding-bottom:2px;" border="0" height="14" width="14" src="' + SitePath + '/js/images/' + fileName + '" />&nbsp;'
}
...
function xEnableDrag(id, fS, fD, fE) {
    ...
    function dragStart(e) {
    	if (el.xDragEnabled) {
    		var d = document.getElementById("dragBG");
...
function xFenster(clientId, iniTitle, iniUrl, iniX, iniY, iniW, iniH,
    ...
    me.href = function(s) {
        ...
        if (me.isIFrame) {
            ...
            else if (typeof me.client.src == 'string') { 
